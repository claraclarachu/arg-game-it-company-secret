...
`,Rs=`export default function Home(){
  return (
    <div>
...
+ export function computeFee(amount, opts) {}`}],Ha={"/customer-portal/src/billing/service.js":[{line:1,commit:"4c2a1e0",author:"dev"},{line:5,commit:"4c2a1e0",author:"dev"},{line:9,commit:"9f8e7d6",author:"qa-lee"},{line:12,commit:"9f8e7d6",author:"qa-lee"},{line:14,commit:"a1b2c3d",author:"finance@internal"}],"/customer-portal/src/main/java/com/nori/OrderService.java":[{line:1,commit:"4c2a1e0",author:"dev"},{line:12,commit:"9f8e7d6",author:"qa-lee"},{line:15,commit:"a1b2c3d",author:"finance@internal"}]},ge="__GIT_GRAPH__",ve=!1,Xe=null,Va={main:"#89d185","feature/vip-discount":"#4da3ff","feature/crypto-mixer":"#dcdcaa","feature/billing-fix":"#ce9178","feature/home-copyfix":"#4ec9b0",develop:"#c586c0"},ie=[{hash:"a1b2c3d",branch:"feature/crypto-mixer",author:"finance@internal",date:"2024-08-12",msg:"(INV-2024-0040) feat: integrate crypto-mixer (legacy)",diff:`+ import { cryptoMixer } from '@shady/crypto-mixer'
    ...
    <div class="gitgraph-editor">
      <div class="gitgraph-editor__header">
        ...
        <div class="gitgraph-legend">
          ${Object.entries(Va).map(([n,i])=>`<span class="gitgraph-branch" style="background:${i}22;color:${i};border-color:${i}44">${h(n)}</span>`).join("")}
        </div>
      </div>
...
`).forEach(n=>{L(n)}),L("hint: 點擊 Source Control 右上角的 Git Graph 按鈕查看完整圖像化歷史");else if(a[0]==="blame"){const n=a[1]||F;L(`blame ${n}:`),(Ha[n]||Ha["/customer-portal/src/billing/service.js"]).forEach(i=>L(`${String(i.line).padStart(3)} ${i.commit} ${i.author}`))}else a[0]==="graph"?(fn(),L("→ 已開啟 Git Graph 編輯器分頁")):L("git: 未知子指令，試 help (支援: git log / git diff / git blame / git graph)");break;case"clear":{const n=document.getElementById("vsTerminalHist");n&&(n.innerHTML="");break}case"echo":L(s);break;default:L(`zsh: command not found: ${t} (試 help)`)}}function ai(){document.addEventListener("keydown",e=>{const t=e.ctrlKey||e.metaKey;if(e.key==="F1"){e.preventDefault();const a=document.getElementById("vsHelpOverlay");a&&(a.style.display=a.style.display==="flex"?"none":"flex");return}if(t&&e.key.toLowerCase()==="p"&&!e.shiftKey)e.preventDefault(),ni();else if(t&&e.shiftKey&&e.key.toLowerCase()==="f")e.preventDefault(),ee="search",Rt(),document.getElementById("vsSearchInput")?.focus();else if(t&&e.shiftKey&&e.key.toLowerCase()==="g")e.preventDefault(),ee="scm",Rt();else if(t&&e.shiftKey&&e.key.toLowerCase()==="d")e.preventDefault(),ee="debug",Rt();else if(e.key==="Escape"){wt();const a=document.getElementById("vsHelpOverlay");a&&(a.style.display="none");const s=document.getElementById("sonarModal");s&&(s.style.display="none")}else t&&e.key==="/"&&(e.preventDefault(),document.getElementById("vsTerminalInput")?.focus())})}function ni(){const e=document.getElementById("quickOpen"),t=document.getElementById("quickOpenInput");!e||!t||(e.classList.add("open"),t.value="",t.focus(),yn(""))}function wt(){document.getElementById("quickOpen")?.classList.remove("open")}function yn(e){const t=document.getElementById("quickOpenList");if(!t)return;const a=(e||"").trim().toLowerCase();let s=S.listFiles("/customer-portal").filter(i=>!Ee(i.path)),n=null;if(a.includes(":")){const[i,r]=a.split(":");n=parseInt(r,10),s=s.filter(d=>d.path.toLowerCase().includes(i))}else a&&(s=s.filter(i=>i.path.toLowerCase().includes(a)));if(s=s.slice(0,10),!s.length){t.innerHTML='<div class="quickopen__item muted">無符合檔案 — 試輸入 OrderService / billing</div>';return}t.innerHTML=s.map((i,r)=>`
...
JQL: sprint = 24 AND status != Done`,comments:[],attachments:[],history:[]},{key:"INV-2020-0003",title:"人力資源系統 — 關閉系統",status:"Done",assignee:"deleted user",priority:"High",points:3,epic:"HR",desc:"人力資源管理系統將遷移到Zero System, 此系統將永久關閉。關閉前需確保所有資料已成功備份到新系統",comments:["deleted user: 已完成關閉"],attachments:[],history:[{from:"To Do",to:"Done",by:"deleted user",at:"2020-02-28"}]}],Ht=null,xt="all",kt="";function Oe(){try{l.set("jiraTicketsData",JSON.parse(JSON.stringify(ne))),l.set("jiraMeta",{activeSwimlane:xt,currentFilter:kt}),l.save(!0)}catch{}}function ri(){try{const e=l.get("jiraTicketsData");if(Array.isArray(e)&&e.length){ne.length=0;for(const a of e)ne.push(a)}else if((l.hasFlag("ch1_event1_triggered")||l.get("jiraTickets")&&l.get("jiraTickets")["INV-2024-0043"])&&!ne.some(a=>a.key==="INV-2024-0043")){_n();return}const t=l.get("jiraMeta");if(t&&typeof t=="object"&&(typeof t.activeSwimlane=="string"&&(xt=t.activeSwimlane),typeof t.currentFilter=="string"&&(kt=t.currentFilter)),l.hasFlag("ch0_vip_fixed")){const a=ne.find(s=>s.key==="INV-2024-0042");a&&a.status!=="Done"&&(a.status="Done")}if(l.hasFlag("ch1_0043_committed")){const a=ne.find(s=>s.key==="INV-2024-0043");a&&a.status!=="Done"&&(a.status="Done")}}catch{}}function _a(){ri();const e=document.getElementById("view-jira");e&&(e.innerHTML=`
  ...
  `,oi(),He(),document.getElementById("jiraDetailBackdrop")?.addEventListener("click",()=>{document.getElementById("jiraDetail").style.display="none",document.getElementById("jiraDetailBackdrop").style.display="none"}))}function oi(){document.getElementById("jiraSearch")?.addEventListener("input",e=>{kt=e.target.value,Oe(),He()}),document.getElementById("jiraAssignee")?.addEventListener("change",e=>{kt=document.getElementById("jiraSearch").value,Oe(),He()}),document.getElementById("jiraSwimlane")?.addEventListener("change",e=>{xt=e.target.value,Oe(),He()})}function li(e){if(!e.trim())return()=>!0;const t=e.split(/\s+AND\s+/i).map(a=>{const s=a.match(/^\s*(status|assignee|key|epic|text|priority)\s*(=|~)\s*"?([^"]+)"?\s*$/i);if(!s){const o=a.toLowerCase().replace(/["']/g,"");return c=>(c.key+c.title+c.desc+c.assignee+c.epic).toLowerCase().includes(o)}const[,n,i,r]=s,d=r.trim().replace(/^"|"$/g,"").toLowerCase();return o=>{const c=n.toLowerCase();let m="";return c==="status"?m=o.status.toLowerCase():c==="assignee"?m=o.assignee.toLowerCase():c==="key"?m=o.key.toLowerCase():c==="epic"?m=o.epic.toLowerCase():c==="priority"?m=o.priority.toLowerCase():c==="text"&&(m=(o.key+" "+o.title+" "+o.desc).toLowerCase()),i==="="?m===d:m.includes(d)}});return a=>t.every(s=>s(a))}function He(){const e=document.getElementById("jiraBoard");if(!e)return;const t=document.getElementById("jiraAssignee")?.value||"",a=li(kt);let s=ne.filter(n=>a(n));if(t&&(s=s.filter(n=>n.assignee===t)),xt!=="all"){const n=xt,i={};s.forEach(r=>{const d=r[n]||"未分類";i[d]||(i[d]=[]),i[d].push(r)}),e.innerHTML=Object.entries(i).map(([r,d])=>{const o={"To Do":[],"In Progress":[],Done:[]};return d.forEach(c=>o[c.status]?.push(c)),`
      ...
      `}).join("")||'<div class="muted small" style="padding:12px">無符合條件的票據 — 試 JQL: status = "To Do"</div>'}else{const n={"To Do":[],"In Progress":[],Done:[]};s.forEach(i=>n[i.status]?.push(i)),e.innerHTML=Object.entries(n).map(([i,r])=>Ra(i,r)).join("")}di()}function Ra(e,t){return`
...
commit => 提交變更
revert => 撤銷變更
查看Git Graph => 列表形式展示所有變更記錄`,time:"2024-07-15",read:"read",type:"text"},{id:"m13",from:"Maggie",text:"",media:"/arg-game-it-company-secret/assets/data/files/wts/sourceControlPage.png",time:"2024-07-15",read:"read",type:"image"},{id:"m14",from:"Maggie",text:"",media:"/arg-game-it-company-secret/assets/data/files/wts/sourceControlPage-revert.png",time:"2024-07-15",read:"read",type:"image"},{id:"m15",from:"Maggie",text:"如果修改有誤的話，提交時結果會經過檢查，然後報錯，這時候就要重新修改",time:"2024-07-15",read:"read",type:"text"},{id:"m0",from:"Maggie",text:"Hi @Casey, 有新的工單INV-2024-0042, 請協助處理一下。詳細資訊在Jiua可以找到, 有問題再找我。",time:"今天",read:"delivered",type:"text"}]},{id:"dev-team",name:"Dev Team",avatar:"👩‍💻",desc:"Nori網站和內網的開發團隊群組",members:["Maggie","Casey","pm","Taylor","ops"],preview:"",locked:!1,pinned:!0,muted:!1,archived:!1,unread:0,lastTime:"2024-07-15",messages:[]},{id:"lunch-team",name:"午餐小隊",avatar:"🍽️",desc:"午餐小隊",members:["Parker","Grace","Hugo","Alex","Casey"],preview:"Alex: 好啊！",locked:!1,pinned:!1,muted:!1,archived:!1,unread:0,lastTime:"2024-09-01",messages:[{id:"m1",from:"Hugo",text:"大新聞！聽說老闆父母車禍身亡了！",time:"2023-04-29",read:"read",type:"text"},{id:"m2",from:"Parker",text:"？！",time:"2023-04-29",read:"read",type:"text"},{id:"m3",from:"Grace",text:"真的嗎？太難過了",time:"2023-04-29",read:"read",type:"text"},{id:"m4",from:"Hugo",text:"對啊，所以才請了一個禮拜假吧",time:"2023-04-29",read:"read",type:"text"},{id:"m5",from:"Hugo",text:"有人覺得近期的老闆很怪嗎？",time:"2023-10-19",read:"read",type:"text"},{id:"m6",from:"Parker",text:"怎麼說？！",time:"2023-10-19",read:"read",type:"text"},{id:"m7",from:"Alex",text:"變開朗了，也變得愛請客了！",time:"2023-10-19",read:"read",type:"text"},{id:"m8",from:"Grace",text:"對啊，之前都挺嚴肅的",time:"2023-10-19",read:"read",type:"text"},{id:"m9",from:"Hugo",text:"對啊！！！",time:"2023-10-19",read:"read",type:"text"},{id:"m10",from:"Hugo",text:"歡迎Casey！！以後帶你吃附近好吃的！",time:"2024-07-16",read:"read",type:"text"},{id:"m11",from:"Parker",text:"歡迎歡迎",time:"2024-07-16",read:"read",type:"text"},{id:"m12",from:"Grace",text:"歡迎~",time:"2024-07-16",read:"read",type:"text"},{id:"m13",from:"Alex",text:"歡迎~~",time:"2024-07-16",read:"read",type:"text"},{id:"m14",from:"Hugo",text:"今天要吃米當當嗎？",time:"2024-09-01",read:"read",type:"text"},{id:"m15",from:"Alex",text:"好啊",time:"2024-09-01",read:"read",type:"text"}]}],U="dev-team",Gt="",ot="all",xe=!1,Ue="",ut="chat",We=!0,Q=0,ka=!1;function V(){try{const e=j.map(t=>({id:t.id,name:t.name,avatar:t.avatar,desc:t.desc,members:t.members,preview:t.preview,lastTime:t.lastTime,unread:t.unread,pinned:t.pinned,muted:t.muted,archived:t.archived,messages:t.messages}));l.set("whatsappChats",e),l.set("whatsappMeta",{activeId:U,ch1Event1Triggered:De,ch1Event2Triggered:Re,sawyerSeq:Q,sawyerSeqLocked:ka}),l.save(!0)}catch{}}function aa(e,t){try{l.incrementWhatsappSent()}catch{}try{const a=(t||"").toLowerCase(),s=["rubbish","垃圾","dumb","笨","蠢","stupid","傻","笨蛋","白癡","idiot","fool","傻瓜","die","dead","死","shit","fuck","屎"],n=e==="sawyer",i=s.some(r=>a.includes(r.toLowerCase()));n&&i&&l.setFlag("sawyer_abuse_sent",!0)}catch{}}function Et(e){try{const t=j.find(a=>a.id===e);return!!(t&&t.muted)}catch{return!1}}function Si(e){return e.time==="剛剛"&&(e.time="今天"),e}function Ua(e){const t=Date.now();e.messages.forEach((a,s)=>{if(Si(a),typeof a.ts!="number")if(/^\d{4}-\d{2}-\d{2}$/.test(a.time))a.ts=new Date(a.time+"T00:00:00").getTime()+s*10;else if(a.time&&a.time.includes(":")){const n=new Date().toISOString().slice(0,10),i=new Date(n+"T"+a.time).getTime();a.ts=Number.isNaN(i)?t-(e.messages.length-s)*1e3:i+s}else a.ts=t-(e.messages.length-s+10)*1e3}),e.lastTime==="剛剛"&&(e.lastTime="今天")}function Ei(){try{const e=l.get("whatsappChats");if(Array.isArray(e)&&e.length){for(const n of e){const i=j.find(r=>r.id===n.id);i&&(i.messages=Array.isArray(n.messages)?n.messages:i.messages,i.preview=n.preview??i.preview,i.lastTime=n.lastTime??i.lastTime,i.unread=typeof n.unread=="number"?n.unread:i.unread,i.pinned=typeof n.pinned=="boolean"?n.pinned:i.pinned,i.muted=typeof n.muted=="boolean"?n.muted:i.muted,i.archived=typeof n.archived=="boolean"?n.archived:i.archived)}for(const n of e)j.some(i=>i.id===n.id)||j.push(n)}const t=l.get("whatsappMeta");t&&typeof t=="object"&&(t.activeId&&j.some(n=>n.id===t.activeId)&&(U=t.activeId),typeof t.ch1Event1Triggered=="boolean"&&(De=t.ch1Event1Triggered),typeof t.ch1Event2Triggered=="boolean"&&(Re=t.ch1Event2Triggered),typeof t.sawyerSeq=="number"&&(Q=t.sawyerSeq),typeof t.sawyerSeqLocked=="boolean"&&(ka=t.sawyerSeqLocked)),l.hasFlag("ch1_event1_triggered")&&(De=!0);const a=j.find(n=>n.id==="nori-all");a&&a.messages.some(n=>n.text&&n.text.includes("發財樹"))&&(De=!0,l.hasFlag("ch1_event1_triggered")||l.setFlag("ch1_event1_triggered",!0));const s=j.find(n=>n.id==="maggie");s&&s.messages.some(n=>n.text&&n.text.includes("INV-2024-0043"))&&(Re=!0);for(const n of j)Ua(n)}catch{}De&&!l.hasFlag("ch1_event1_triggered")&&l.setFlag("ch1_event1_triggered",!0);try{for(const e of j)Ua(e)}catch{}}function at(e){if(!j.some(s=>s.id===e))return;U=e;const t=j.find(s=>s.id===e);t&&(t.unread=0),V(),e==="nori-all"&&setTimeout(()=>Ea(),100);const a=document.getElementById("view-whatsapp");a&&a.innerHTML&&(ut="chat",Fn(),mt(),Y(U))}function Dn(){Ei();const e=document.getElementById("view-whatsapp");if(e){e.innerHTML=`<div class="wa">
  ...
  `,document.getElementById("waChatHeader")?.addEventListener("click",()=>{xe=!xe,document.getElementById("waInfoPanel")?.classList.toggle("open",xe)}),document.getElementById("waInfoBtn")?.addEventListener("click",u=>{u.stopPropagation(),xe=!xe,document.getElementById("waInfoPanel")?.classList.toggle("open",xe)}),document.getElementById("waInfoClose")?.addEventListener("click",()=>{xe=!1,document.getElementById("waInfoPanel")?.classList.remove("open")}),document.getElementById("waToggleMute")?.addEventListener("click",()=>{r.muted=!r.muted,V(),J(),Y(e)}),document.getElementById("waTogglePin")?.addEventListener("click",()=>{r.pinned=!r.pinned,V(),J(),Y(e)}),document.getElementById("waToggleArchive")?.addEventListener("click",()=>{r.archived=!r.archived,V(),J(),Y(e)}),document.getElementById("waMsgSearchBtn")?.addEventListener("click",()=>{Ue="",document.getElementById("waMsgSearchBar").style.display="flex",document.getElementById("waMsgSearchInput")?.focus()}),document.getElementById("waMsgSearchInput")?.addEventListener("input",u=>{Ue=u.target.value,Y(e)}),document.getElementById("waMsgSearchClear")?.addEventListener("click",()=>{Ue="",Y(e)}),document.getElementById("waExportBtn")?.addEventListener("click",()=>Ja(r)),document.getElementById("waMoreBtn")?.addEventListener("click",()=>Ja(r)),document.getElementById("waSendBtn")?.addEventListener("click",()=>Ga(r)),document.getElementById("waComposerInput")?.addEventListener("keydown",u=>{u.key==="Enter"&&Ga(r)}),document.querySelectorAll("[data-play]").forEach(u=>{u.addEventListener("click",()=>{const v=u.textContent;u.textContent="⏸️",setTimeout(()=>u.textContent=v,1800)})}),document.querySelectorAll("[data-img]").forEach(u=>{u.addEventListener("click",()=>Hn(u.src))}),On();try{const u=document.getElementById("waMessages");u&&!u._waScrollBound&&(u._waScrollBound=!0,u.addEventListener("scroll",()=>{const v=u.scrollHeight,g=u.scrollTop,y=u.clientHeight;We=v-g-y<80}))}catch{}const m=i,p=a;requestAnimationFrame(()=>{requestAnimationFrame(()=>{const u=document.getElementById("waMessages");if(u)if(m||p===0&&u.scrollHeight>u.clientHeight+20&&We)u.scrollTop=u.scrollHeight,We=!0,u.scrollTop;else if(p!==null){const v=Math.max(0,u.scrollHeight-u.clientHeight);u.scrollTop=Math.min(p,v),u.scrollTop,We=u.scrollHeight-u.scrollTop-u.clientHeight<80}else u.scrollTop=u.scrollHeight,We=!0,u.scrollTop})})}function Nn(e){return e?e==="you"||e==="你"?"你":e.trim().charAt(0).toUpperCase():"?"}function Wa(e){if(!e)return 0;if(e==="剛剛"||e==="今天")return Number.MAX_SAFE_INTEGER;if(/^\d{4}-\d{2}-\d{2}$/.test(e))return new Date(e+"T00:00:00").getTime();if(/^\d{1,2}\/\d{1,2}$/.test(e))return new Date("2024/"+e+"T00:00:00").getTime();const t=new Date().toISOString().slice(0,10);try{const a=new Date(t+"T"+e).getTime();return Number.isNaN(a)?Number.MAX_SAFE_INTEGER:a}catch{return Number.MAX_SAFE_INTEGER}}function Sa(e){const t=["#1f7aec","#e542a3","#00a884","#ff8c00","#6a5acd","#d93025","#0d9488","#7c3aed"];let a=0;for(let s=0;s<e.length;s++)a=a*31+e.charCodeAt(s)>>>0;return t[a%t.length]}function Ti(e,t){const a=e.from==="you",s=a?e.read==="read"?'<span class="bubble__check read">✓✓</span>':e.read==="delivered"?'<span class="bubble__check">✓✓</span>':'<span class="bubble__check">✓</span>':"";let n="";e.type==="image"?n=`<div class="wa__media"><img data-img src="${e.media}" alt="image" /></div>`:e.type==="voice"?n=`<div class="wa__voice"><span class="wa__play" data-play>▶️</span><div class="wa__wave">${Array.from({length:12},(m,p)=>`<span style="height:${8+Math.random()*14}px"></span>`).join("")}</div><span class="small muted">${e.duration}</span></div>`:e.type==="file"&&(n=`<div class="wa__file"><div class="wa__file-icon">📄</div><div style="flex:1;min-width:0"><div style="font-weight:600;font-size:13px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">${h(e.fileName)}</div><div class="small muted">${h(e.fileSize)}</div></div><button class="btn" style="padding:4px 8px">下載</button></div>`);const i=e.text?`<div class="bubble__text">${h(e.text).replace(/\n/g,"<br>")}</div>`:"",r=`<div class="bubble__time">${h(e.time)} ${s}</div>`;if(a)return`<div class="wa__msg-row me">
    ...
    `,a.style.cssText="position:fixed;right:16px;bottom:60px;width:360px;background:#2d2d2d;color:#f0f0f0;border:1px solid rgba(255,255,255,.12);border-radius:8px;box-shadow:0 8px 28px rgba(0,0,0,.45);z-index:1100;overflow:hidden;cursor:pointer;opacity:0;transform:translateY(12px);transition:opacity .28s,transform .28s;",a.addEventListener("click",s=>{s.target.closest(".win-notif__close")||(a.remove(),M(()=>Promise.resolve().then(()=>re).then(n=>{n.setActiveView&&(n.setActiveView("whatsapp"),localStorage.setItem("cc_active_view","whatsapp"))}),void 0),at("nori-all"))}),a.querySelector(".win-notif__close")?.addEventListener("click",s=>{s.stopPropagation(),a.remove()}),document.body.appendChild(a),requestAnimationFrame(()=>{a.style.opacity="1",a.style.transform="none"}),setTimeout(()=>{a.style.opacity="0",setTimeout(()=>a.remove(),300)},1e4),setTimeout(()=>{Re||Jt()},1e4)},1e4)}function Jt(){if(Re)return;Re=!0,V();const e=j.find(t=>t.id==="maggie");e&&setTimeout(()=>{e.messages.push({id:"m-0043-"+Date.now(),from:"Maggie",text:"Hi @Casey, 有新的工單 INV-2024-0043, 請協助處理一下",time:"今天",ts:Date.now(),read:"delivered",type:"text"}),e.preview="Hi @Casey, 有新的工單 INV-2024-0043",e.lastTime="今天",e.unread=(e.unread||0)+1,V(),window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"maggie"}})),M(()=>Promise.resolve().then(()=>ft).then(s=>{s.addTicket0043&&s.addTicket0043(),document.getElementById("jiraBoard")&&window.dispatchEvent(new CustomEvent("jira:ticketAdded"))}),void 0);const t=document.getElementById("view-whatsapp");if(t&&t.innerHTML&&J(),Et("maggie")||U==="maggie")return;const a=document.createElement("div");a.id="wa-win-notification-maggie-0043",a.setAttribute("role","alert"),a.innerHTML=`
      <div class="win-notif__app">
        <img src="/arg-game-it-company-secret/icon/whatsup.svg" alt="WhatUp" width="20" height="20" style="width:20px;height:20px;object-fit:contain" />
        <span class="win-notif__app-name">WhatUp</span>
