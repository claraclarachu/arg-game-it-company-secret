var $a=Object.defineProperty,ya=(e,t)=>{let a={};for(var s in e)$a(a,s,{get:e[s],enumerable:!0});return t||$a(a,Symbol.toStringTag,{value:"Module"}),a};(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function a(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=a(n);fetch(n.href,i)}})();var Ba="code_conspiracy_state",sn="1.0.0",K={version:sn,currentChapter:0,unlockedInterfaces:["vscode","jira","whatsapp","search"],discoveredFiles:[],collectedEvidence:[],whatsappChats:null,whatsappMeta:null,jiraTickets:{},jiraTicketsData:null,vscodeState:null,intranetState:null,darknetState:null,searchHistory:[],readArticles:[],whatsappSentCount:0,flags:{},endings:[],settings:{language:"zh-TW",theme:"dark",sound:!0,reducedMotion:!1,bgmVolume:.25,bgmMuted:!1},playtime:0,lastSaved:null,persistentStats:{unlockedEndings:[],readArticles:[],darkFileCount:0,whatsappSentCount:0,searchHistoryCount:0,flags:{}}},Wn=class{constructor(){this.state=this.load(),this.listeners=new Map,this.saveDebounce=null,this.playtimeInterval=null,this.startPlaytimeTracking()}load(){try{const e=localStorage.getItem(Ba);if(e){const t=JSON.parse(e);return this.migrateState(t)}}catch(e){console.warn("Failed to load game state:",e)}return JSON.parse(JSON.stringify(K))}migrateState(e){e.version||(e.version=sn);const t={...K,...e};if(t.flags={...K.flags||{},...e.flags||{}},t.endings=Array.isArray(e.endings)?[...e.endings]:[...K.endings],t.discoveredFiles=Array.isArray(e.discoveredFiles)?[...e.discoveredFiles]:[],t.collectedEvidence=Array.isArray(e.collectedEvidence)?[...e.collectedEvidence]:[],t.searchHistory=Array.isArray(e.searchHistory)?[...e.searchHistory]:[],t.readArticles=Array.isArray(e.readArticles)?[...e.readArticles]:[],t.whatsappSentCount=typeof e.whatsappSentCount=="number"?e.whatsappSentCount:0,!t.settings||typeof t.settings!="object"?t.settings={...K.settings}:t.settings={...K.settings,...e.settings},!Array.isArray(t.unlockedInterfaces)||!t.unlockedInterfaces.length)t.unlockedInterfaces=[...K.unlockedInterfaces];else for(const i of K.unlockedInterfaces)t.unlockedInterfaces.includes(i)||t.unlockedInterfaces.push(i);e.whatsappChats!==void 0&&(t.whatsappChats=e.whatsappChats),e.whatsappMeta!==void 0&&(t.whatsappMeta=e.whatsappMeta),e.jiraTicketsData!==void 0&&(t.jiraTicketsData=e.jiraTicketsData),e.jiraTickets!==void 0&&(t.jiraTickets={...e.jiraTickets||{}}),e.vscodeState!==void 0&&(t.vscodeState=e.vscodeState),e.intranetState!==void 0&&(t.intranetState=e.intranetState),e.darknetState!==void 0&&(t.darknetState=e.darknetState),e.readArticles!==void 0&&(t.readArticles=Array.isArray(e.readArticles)?[...e.readArticles]:[]),typeof e.whatsappSentCount=="number"&&(t.whatsappSentCount=e.whatsappSentCount),typeof e.currentChapter=="number"&&(t.currentChapter=e.currentChapter),typeof e.playtime=="number"&&(t.playtime=e.playtime);const a=Array.isArray(e.persistentStats?.unlockedEndings)?[...e.persistentStats.unlockedEndings]:[...K.persistentStats.unlockedEndings],s=Array.isArray(e.endings)?e.endings:Array.isArray(e.unlockedEndings)?e.unlockedEndings:[],n=[...new Set([...a,...s])];return t.persistentStats={unlockedEndings:n,readArticles:Array.isArray(e.persistentStats?.readArticles)?[...e.persistentStats.readArticles]:[...K.persistentStats.readArticles],darkFileCount:typeof e.persistentStats?.darkFileCount=="number"?e.persistentStats.darkFileCount:0,whatsappSentCount:typeof e.persistentStats?.whatsappSentCount=="number"?e.persistentStats.whatsappSentCount:0,searchHistoryCount:typeof e.persistentStats?.searchHistoryCount=="number"?e.persistentStats.searchHistoryCount:0,flags:{...K.persistentStats.flags||{},...e.persistentStats?.flags||{}}},n.length&&(t.unlockedEndings=[...n]),t}save(e=!1){if(e){this._doSave();return}clearTimeout(this.saveDebounce),this.saveDebounce=setTimeout(()=>this._doSave(),500)}_doSave(){this.state.lastSaved=new Date().toISOString();try{localStorage.setItem(Ba,JSON.stringify(this.state)),this.emit("save",this.state)}catch(e){console.error("Failed to save game state:",e),this.emit("saveError",e)}}get(e){return e?e.split(".").reduce((t,a)=>t?.[a],this.state):this.state}set(e,t){const a=e.split("."),s=a.pop(),n=a.reduce((i,r)=>(i[r]||(i[r]={}),i[r]),this.state);if(n[s]=t,e==="endings"&&Array.isArray(t)){this.state.persistentStats||(this.state.persistentStats=JSON.parse(JSON.stringify(K.persistentStats)));const i=this.state.persistentStats;i.unlockedEndings=[...new Set([...i.unlockedEndings||[],...t])],this.state.unlockedEndings=[...i.unlockedEndings]}if(e==="unlockedEndings"&&Array.isArray(t)){this.state.persistentStats||(this.state.persistentStats=JSON.parse(JSON.stringify(K.persistentStats)));const i=this.state.persistentStats;i.unlockedEndings=[...new Set([...i.unlockedEndings||[],...t])]}this.emit("change",{path:e,value:t,state:this.state}),e.startsWith("flags.")||e==="currentChapter"||e==="endings"||e.startsWith("endings")||e==="unlockedEndings"||e.startsWith("unlockedEndings")||e==="persistentStats"||e.startsWith("persistentStats")||e==="readArticles"||e.startsWith("readArticles")||e==="whatsappSentCount"?this.save(!0):this.save()}update(e,t){const a=this.get(e);this.set(e,t(a))}push(e,t){const a=this.get(e)||[];this.set(e,[...a,t])}remove(e,t){const a=this.get(e)||[];this.set(e,a.filter(s=>!t(s)))}hasFlag(e){return!!this.state.flags[e]}setFlag(e,t=!0){this.set(`flags.${e}`,t),this.save(!0)}addEvidence(e){this.state.collectedEvidence.some(t=>t.id===e.id)||(this.push("collectedEvidence",{...e,discoveredAt:new Date().toISOString()}),this.emit("evidence",e),this.save(!0))}unlockInterface(e){this.state.unlockedInterfaces.includes(e)||(this.push("unlockedInterfaces",e),this.emit("interfaceUnlocked",e))}discoverFile(e){this.state.discoveredFiles.includes(e)||(this.push("discoveredFiles",e),this.emit("fileDiscovered",e),this.save(!0))}markArticleRead(e){e&&(this.state.readArticles||(this.state.readArticles=[]),this.state.readArticles.includes(e)||(this.push("readArticles",e),this.save(!0)))}incrementWhatsappSent(){const e=typeof this.state.whatsappSentCount=="number"?this.state.whatsappSentCount:0;this.set("whatsappSentCount",e+1),this.save(!0)}startPlaytimeTracking(){this.playtimeInterval=setInterval(()=>{this.state.playtime+=1,this.state.playtime%60===0&&this.save(!0)},1e3)}stopPlaytimeTracking(){clearInterval(this.playtimeInterval),this.save(!0)}exportSave(){return JSON.stringify(this.state,null,2)}importSave(e){try{const t=JSON.parse(e);return this.state=this.migrateState(t),this.save(!0),this.emit("load",this.state),!0}catch(t){return console.error("Failed to import save:",t),!1}}reset(){try{clearTimeout(this.saveDebounce)}catch{}try{clearInterval(this.playtimeInterval)}catch{}const e=this.state.persistentStats||{unlockedEndings:[],readArticles:[],darkFileCount:0,whatsappSentCount:0,searchHistoryCount:0,flags:{}};e.unlockedEndings=[...new Set([...e.unlockedEndings||[],...this.state.endings||[]])],e.readArticles=[...new Set([...e.readArticles||[],...this.state.readArticles||[]])];const t=(this.state.discoveredFiles||[]).filter(n=>n.startsWith("/darknet")).length;e.darkFileCount=Math.max(e.darkFileCount||0,t),e.whatsappSentCount=Math.max(e.whatsappSentCount||0,this.state.whatsappSentCount||0);const a=(this.state.searchHistory||[]).length;e.searchHistoryCount=Math.max(e.searchHistoryCount||0,a),e.flags={...e.flags||{}},this.state.flags.portal_simple_entered&&(e.flags.portal_simple_entered=!0),this.state.flags.portal_hash_entered&&(e.flags.portal_hash_entered=!0),this.state.flags.sawyer_abuse_sent&&(e.flags.sawyer_abuse_sent=!0);const s=JSON.parse(JSON.stringify(e));this.state=JSON.parse(JSON.stringify(K)),this.state.unlockedInterfaces=[...K.unlockedInterfaces],this.state.flags={},this.state.collectedEvidence=[],this.state.discoveredFiles=[],this.state.endings=[],this.state.searchHistory=[],this.state.readArticles=[],this.state.whatsappSentCount=0,this.state.jiraTickets={},this.state.whatsappChats=null,this.state.whatsappMeta=null,this.state.jiraTicketsData=null,this.state.vscodeState=null,this.state.playtime=0,this.state.persistentStats=s,this.save(!0),this.emit("reset",this.state),this.startPlaytimeTracking()}on(e,t){return this.listeners.has(e)||this.listeners.set(e,new Set),this.listeners.get(e).add(t),()=>this.off(e,t)}off(e,t){this.listeners.get(e)?.delete(t)}emit(e,t){this.listeners.get(e)?.forEach(a=>a(t))}},l=new Wn,Gn=class{constructor(){this.events=new Map,this.onceEvents=new Map}on(e,t,a=null){this.events.has(e)||this.events.set(e,new Set);const s=a?t.bind(a):t;return this.events.get(e).add(s),()=>this.off(e,s)}once(e,t,a=null){const s=a?t.bind(a):t,n=(...i)=>{this.off(e,n),s(...i)};return this.onceEvents.has(e)||this.onceEvents.set(e,new Set),this.onceEvents.get(e).add(n),()=>this.off(e,n)}off(e,t){this.events.get(e)?.delete(t),this.onceEvents.get(e)?.delete(t)}emit(e,...t){this.events.get(e)?.forEach(a=>{try{a(...t)}catch(s){console.error(`Error in event handler for "${e}":`,s)}}),this.onceEvents.get(e)?.forEach(a=>{try{a(...t)}catch(s){console.error(`Error in once handler for "${e}":`,s)}}),this.onceEvents.get(e)?.clear()}clear(e){e?(this.events.delete(e),this.onceEvents.delete(e)):(this.events.clear(),this.onceEvents.clear())}},W=new Gn,et=new Map,wt=new Map,Zt=new Map,rn="https://nori-intranet/internal/portal?";function on(e,t){Zt.set(e,t)}function Jn(e){return Zt.get(e)||null}function Yn(){return Array.from(Zt.entries()).map(([e,t])=>({key:e,...t}))}function Kn(e){for(const[t,a]of Zt.entries())if(e(a,t))return{key:t,...a};return null}on("nori-portal-2023",{domain:rn,historical:!0,description:"Nori 內網舊版 portal 路由（2023 前由 generateSecretPath 動態產生）",generateSecretPath:"function generateSecretPath(domain){ const cid = redis.get('companyId'); const y = redis.get('year'); const k='70BTa3A1a13ad4212GHdybJmn'; return domain + 'hash=' + md5(`companyId=${cid}&year=${y}&key=${k}`); }",key:"70BTa3A1a13ad4212GHdybJmn",companyIdSource:"redis.get('companyId')",yearSource:"redis.get('year')",_hash:"f665a7117959b667b7f283eaebf69cae",_fullUrl:"https://nori-intranet/internal/portal?hash=f665a7117959b667b7f283eaebf69cae"});function me(e,t){wt.set(e,t)}function ln(e){return wt.get(e)||null}function Qn(e="/"){const t=[];for(const[a,s]of wt.entries())a.startsWith(e)&&t.push({path:a,...s});return t.sort((a,s)=>a.path.localeCompare(s.path))}function Xn(){const e={name:"/",path:"/",children:[],type:"dir"},t=new Map;t.set("/",e);for(const[s]of wt.entries()){const n=s.split("/").filter(Boolean);let i="",r=e;for(let d=0;d<n.length;d++){i+="/"+n[d];const o=d===n.length-1;if(t.has(i)){const c=t.get(i);!o&&c.type==="file"&&(c.type="dir",c.children=c.children||[])}else{const c={name:n[d],path:i,type:o?"file":"dir",children:o?void 0:[]};if(o){const m=wt.get(s);c.ext=s.split(".").pop(),c.meta=m.meta||{}}t.set(i,c),r.children||(r.children=[]),r.children.push(c)}r=t.get(i)}}function a(s){s.children&&(s.children.sort((n,i)=>n.type!==i.type?n.type==="dir"?-1:1:n.name.localeCompare(i.name)),s.children.forEach(a))}return a(e),e}function Zn(e){const t=ln(e);return t?t.content:null}function x(e,t){et.set(e,t)}function cn(e){return et.get(e)||null}function es(e="/"){const t=[];for(const[a,s]of et.entries())a.startsWith(e)&&t.push({path:a,...s});return t.sort((a,s)=>a.path.localeCompare(s.path))}function ts(){const e={name:"/",path:"/",children:[],type:"dir"},t=new Map;t.set("/",e);for(const[s]of et.entries()){const n=s.split("/").filter(Boolean);let i="",r=e;for(let d=0;d<n.length;d++){i+="/"+n[d];const o=d===n.length-1;if(t.has(i)){const c=t.get(i);!o&&c.type==="file"&&(c.type="dir",c.children=c.children||[])}else{const c={name:n[d],path:i,type:o?"file":"dir",children:o?void 0:[]};if(o){const m=et.get(s);c.ext=s.split(".").pop(),c.meta=m.meta||{}}t.set(i,c),r.children||(r.children=[]),r.children.push(c)}r=t.get(i)}}function a(s){s.children&&(s.children.sort((n,i)=>n.type!==i.type?n.type==="dir"?-1:1:n.name.localeCompare(i.name)),s.children.forEach(a))}return a(e),e}function as(e){const t=cn(e);return!t||t.hidden&&!l.hasFlag(`discovered:${e}`)?null:(l.discoverFile(e),e==="/customer-portal/src/payment/mixer.js"&&l.setFlag("found_crypto_mixer",!0),e==="/customer-portal/src/payment/gateway.js"&&l.setFlag("found_fee_mapping",!0),e==="/customer-portal/src/payment/cryptoConfig.json"&&l.setFlag("found_mixer_config",!0),e==="/customer-portal/ledger.db"&&l.setFlag("ledger_exported",!0),e==="/customer-portal/docs/arch.pdf"&&l.setFlag("sql_injected",!0),e==="/customer-portal/data/ledger_export.csv"&&l.setFlag("found_coordinates",!0),e==="/customer-portal/src/main/resources/application.properties"&&l.setFlag("found_ssh_trace",!0),e==="/customer-portal/src/main/java/com/nori/OrderService.java"&&l.setFlag("found_fee_mapping",!0),W.emit("vfs:read",e),t.content)}function ns(e){return et.has(e)}function ss(e){const t=e.toLowerCase(),a=[];for(const[s,n]of et.entries())typeof n.content=="string"&&n.content.toLowerCase().includes(t)&&a.push({path:s,snippet:is(n.content,t)});return a}function is(e,t){const a=e.toLowerCase().indexOf(t),s=Math.max(0,a-40),n=Math.min(e.length,a+t.length+40);return e.slice(s,n).replace(/\n/g," ")}function ba(){return l.hasFlag("ch1_0043_committed")&&!l.hasFlag("ch1_revert_done")}function rs(){return ba()?!1:l.hasFlag("hidden_portal_accessed")}function os(e){return ba()?!1:e&&e.hash==="f665a7117959b667b7f283eaebf69cae"?(l.setFlag("hidden_portal_accessed",!0),l.setFlag("portal_auth_bypassed",!1),W.emit("portal:discovered"),!0):!1}function ls(e){return ba()?!1:(e?.["X-Internal-Token"]||e?.["x-internal-token"])==="nori-drinks-token-2024"?(l.hasFlag("hidden_portal_accessed")||(l.setFlag("hidden_portal_accessed",!0),W.emit("portal:discovered")),l.setFlag("portal_auth_bypassed",!0),W.emit("portal:bypassed"),!0):!1}function cs(){x("/customer-portal/package.json",{content:JSON.stringify({name:"nori-drinks-supply",version:"3.5.0",private:!0,description:"Nori 飲品供應 — 招牌冰釀茶酒 / 原物料管理 / 訂單銷售 / 內部系統",scripts:{dev:"vite",build:"vite build",test:"jest","db:migrate":"node scripts/migrate.js"},dependencies:{vite:"^5.0.0",vue:"^3.4.0"}},null,2),meta:{lang:"json"}}),x("/customer-portal/README.md",{content:`# Nori外部網頁
...
`,meta:{portal:!0}}),x("/internal/portal/export",{hidden:!1,content:"SQLite export endpoint - 需要 portalAuth 通過 (Nori 訂單匯出)",meta:{portal:!0}})}function ds(){me("/darknet/全結構圖/drug-route-graph.md",{content:`# 全結構圖
...
`,meta:{lang:"markdown"}})}ds();cs();var k={registerFile:x,getFile:cn,listFiles:es,buildTree:ts,readFile:as,exists:ns,searchContent:ss,canAccessPortal:rs,tryAccessPortal:os,bypassPortalAuth:ls,registerDarkFile:me,getDarkFile:ln,listDarkFiles:Qn,buildDarkTree:Xn,readDarkFile:Zn,registerLegacyRoute:on,getLegacyRoute:Jn,listLegacyRoutes:Yn,findLegacyRoute:Kn,internalPathDomain:rn},ps=[{id:"ch0_vip_fix",chapter:0,check:()=>l.hasFlag("ch0_vip_fixed"),reward:{},title:"修正 VIP 折扣計算 (INV-2024-0042)"},{id:"ch1_system_alert",chapter:1,check:()=>l.hasFlag("ch1_system_down"),reward:{evidence:{id:"e001",title:"INV-2024-0043 系統警報",chapter:1,type:"anomaly"}},title:"觸發系統警報 (INV-2024-0043)"},{id:"ch1_feng_shui_tree",chapter:1,check:()=>l.hasFlag("ch1_tree_seen"),reward:{evidence:{id:"e002",title:"老闆的風水樹",chapter:1,type:"behavior"}},title:"發現老闆的風水樹"},{id:"ch2_accident_news",chapter:2,check:()=>l.get("searchHistory")?.some(e=>e.includes("Sawyer")||e.includes("Choi")||e.includes("車禍")),reward:{evidence:{id:"e003",title:"車禍新聞 — 父母雙亡",chapter:2,type:"news"}},title:"搜尋到車禍新聞"},{id:"ch2_insurance_blog",chapter:2,check:()=>l.get("discoveredFiles")?.includes("https://sawyer-blog.example/2012-07-07")||l.get("searchHistory")?.some(e=>e.includes("保險")),reward:{evidence:{id:"e004",title:"保險受益人 Blog",chapter:2,type:"blog"}},title:"發現保險受益人文章"},{id:"ch2_lottery_lie",chapter:2,check:()=>l.hasFlag("lottery_lie_seen"),reward:{evidence:{id:"e005",title:"六合彩謊言",chapter:2,type:"lie"}},title:"發現六合彩謊言紀錄"},{id:"ch2_dark_blog",chapter:2,check:()=>l.get("discoveredFiles")?.includes("https://sawyer-blog.example/2023-12-20"),reward:{evidence:{id:"e006",title:"Sawyer 暗示文字",chapter:2,type:"blog"}},title:"發現 2023-12-20 Blog"},{id:"ch3_git_secret",chapter:3,check:()=>l.hasFlag("git_secret_found"),reward:{evidence:{id:"e007",title:"Git 刪除的 secret path",chapter:3,type:"code"}},title:"在 Git 歷史找到刪除的 secret path"},{id:"ch3_darknet_url",chapter:3,check:()=>l.hasFlag("dark_entered")||l.hasFlag("hidden_portal_accessed"),reward:{evidence:{id:"e008",title:"暗網入口 URL",chapter:3,type:"portal"}},title:"找到暗網完整入口"},{id:"ch4_drug_transactions",chapter:4,check:()=>l.hasFlag("ch4_all_opened")||l.get("discoveredFiles")?.some(e=>e.includes("/darknet/")),reward:{evidence:{id:"e009",title:"毒品交易紀錄",chapter:4,type:"darknet"}},title:"開啟毒品交易列表"},{id:"ch4_drug_route",chapter:4,check:()=>l.hasFlag("ch4_all_opened")||l.get("discoveredFiles")?.some(e=>e.includes("drug-route")),reward:{evidence:{id:"e010",title:"毒品結構圖",chapter:4,type:"darknet"}},title:"開啟毒品結構圖"},{id:"ch4_sawyer_expenses",chapter:4,check:()=>l.hasFlag("ch4_all_opened")||l.get("discoveredFiles")?.some(e=>e.includes("sawyer_expenses")),reward:{evidence:{id:"e011",title:"Sawyer 個人支出",chapter:4,type:"darknet"}},title:"發現 Sawyer 與 FredyArc 金流"},{id:"ch4_travel_records",chapter:4,check:()=>l.hasFlag("ch4_all_opened")||l.get("discoveredFiles")?.some(e=>e.includes("travel_records")),reward:{evidence:{id:"e012",title:"Travel 紀錄",chapter:4,type:"darknet"}},title:"發現 Sawyer 多次前往毒品路線城市"},{id:"ch4_meeting_minutes",chapter:4,check:()=>l.hasFlag("ch4_all_opened")||l.get("discoveredFiles")?.some(e=>e.includes("meeting_minutes")),reward:{evidence:{id:"e013",title:"Sawyer × Fredy 會議紀錄",chapter:4,type:"darknet"}},title:"發現定期會議紀錄"},{id:"ch5_choose_ending",chapter:5,check:()=>(l.get("endings")||[]).length>0,reward:{},title:"選擇結局"}];function it(){for(const t of ps)l.hasFlag(`puzzle:${t.id}`)||t.check()&&(l.setFlag(`puzzle:${t.id}`,!0),t.reward?.evidence&&l.addEvidence(t.reward.evidence),t.reward?.unlock&&t.reward.unlock.forEach(a=>l.unlockInterface(a)),W.emit("puzzle:solved",t));let e=0;l.hasFlag("ch0_vip_fixed")&&(e=1),l.hasFlag("ch1_revert_done")&&(e=2),(l.hasFlag("dark_entered")||l.hasFlag("hidden_portal_accessed"))&&(e=3),l.hasFlag("ch4_all_opened")&&(e=4),(l.get("endings")||[]).length>0&&(e=5),e!==l.get("currentChapter")&&(l.set("currentChapter",e),W.emit("chapter:changed",e))}var us=null;function ms(){W.on("change",it),W.on("vfs:read",it),W.on("portal:discovered",it),W.on("portal:bypassed",it),us=setInterval(it,800),it()}var Ma={"zh-TW":{"app.title":"聽日辭職","app.subtitle":"編程人生模擬 · 離線 ARG","dock.vscode":"Vizual Studio Code","dock.intranet":"內網","dock.jira":"Jiua","dock.whatsapp":"WhatUp","dock.search":"Search","dock.notebook":"筆記本","dock.settings":"設定","settings.theme":"主題","settings.language":"語言","settings.export":"匯出存檔","settings.import":"匯入存檔","settings.reset":"重置進度","toast.saved":"已儲存","toast.evidence":"發現新證據","toast.unlocked":"解鎖新介面"},en:{"app.title":"聽日辭職","app.subtitle":"Dev Life Sim · Offline ARG","dock.vscode":"Vizual Studio Code","dock.intranet":"Intranet","dock.jira":"Jiua","dock.whatsapp":"WhatUp","dock.search":"Search","dock.notebook":"Notebook","dock.settings":"Settings","settings.theme":"Theme","settings.language":"Language","settings.export":"Export Save","settings.import":"Import Save","settings.reset":"Reset Progress","toast.saved":"Saved","toast.evidence":"New evidence","toast.unlocked":"Interface unlocked"}};function he(e){const t=l.get("settings.language")||"zh-TW";return Ma[t]?.[e]??Ma["zh-TW"][e]??e}var oe=ya({renderDock:()=>Be,setActiveView:()=>dn,setDockVisible:()=>vs});function Be({onSwitch:e,onOpenSettings:t,onOpenNotebook:a,t:s}){const n=document.getElementById("dock");if(!n)return;function i(p){return p==="email"?l.hasFlag("ch5_triggered"):!0}const r=localStorage.getItem("cc_active_view")||"vscode",d={vscode:"/arg-game-it-company-secret/icon/vizual-studio-code.svg",intranet:"/arg-game-it-company-secret/icon/file-system.svg",jira:"/arg-game-it-company-secret/icon/jiua.svg",whatsapp:"/arg-game-it-company-secret/icon/whatsup.svg",search:"/arg-game-it-company-secret/icon/browser.svg",email:"/arg-game-it-company-secret/icon/mail.svg"},o={notebook:"/arg-game-it-company-secret/icon/notepad.png"};function c(p,u,f){const v=!i(p),b=r===p?"active":"",T=d[p];let M;return T&&T.startsWith("/icon/")?M=`<img class="taskbar__app-icon-img" src="${T}" alt="${f}" width="22" height="22" loading="eager" />`:T&&T.startsWith("fa-")?p==="jira"?M=`<i class="${T}" aria-hidden="true" style="font-size:22px;line-height:1;--fa-primary-color:rgba(19,91,205,1);--fa-secondary-color:rgba(19,91,205,0.4);color:rgba(19,91,205,1)"></i>`:p==="vscode"?M=`<i class="${T}" aria-hidden="true" style="font-size:22px;line-height:1;--fa-primary-color:rgba(87,165,229,1);--fa-secondary-color:rgba(87,165,229,0.4);color:rgba(87,165,229,1)"></i>`:p==="whatsapp"?M=`<i class="${T}" aria-hidden="true" style="font-size:22px;line-height:1;--fa-primary-color:rgba(0,203,90,1);--fa-secondary-color:rgba(0,203,90,0.4);color:rgba(0,203,90,1)"></i>`:M=`<i class="${T}" aria-hidden="true" style="font-size:22px;line-height:1;color:currentColor"></i>`:T?M=`<img class="taskbar__app-icon-img" src="${T}" alt="${f}" width="22" height="22" loading="eager" />`:M=`<span class="taskbar__app-icon" aria-hidden="true">${u}</span>`,`<button class="taskbar__app ${b}" data-view="${p}" ${v?'disabled title="尚未解鎖"':`title="${f}"`}>
  ...
  `,n.querySelectorAll("[data-view]").forEach(p=>{p.addEventListener("click",()=>{if(p.dataset.view==="email"){const u=document.getElementById("mailDialog");if(u){const f=document.getElementById("mailTitle"),v=document.getElementById("mailTo");if(f&&v){const b=f.value;b==="Report"?v.value="DEA <dea@world.example>":(b==="Coperation"||b==="Resign")&&(v.value="Sawyer <sawyer@nori-drinks.example>")}u.showModal()}return}e(p.dataset.view)})}),n.querySelector('[data-action="settings"]')?.addEventListener("click",t),n.querySelector('[data-action="notebook"]')?.addEventListener("click",a),gs()}var aa=null;function gs(){function e(){const t=new Date,a=document.getElementById("taskbarTime"),s=document.getElementById("taskbarDate");if(!a||!s)return;const n=t.toLocaleTimeString("zh-TW",{hour:"numeric",minute:"2-digit",hour12:!0}),i="2024/09/02";a.textContent=n,s.textContent=i}e(),aa&&clearInterval(aa),aa=setInterval(e,6e4)}function hs(){document.querySelectorAll("dialog[open]").forEach(n=>{try{n.close()}catch{}n.style.removeProperty("display")});const e=document.getElementById("startMenu");e&&(e.style.display="none");const t=document.getElementById("intraPreview");t&&(t.style.display="none");const a=document.getElementById("darkPreview");a&&(a.style.display="none");const s=document.getElementById("waLightbox");s&&s.classList.remove("open")}function dn(e){hs(),localStorage.setItem("cc_active_view",e),document.querySelectorAll(".taskbar__app[data-view]").forEach(t=>{t.classList.toggle("active",t.dataset.view===e)}),document.querySelectorAll(".view").forEach(t=>{t.classList.toggle("active",t.id===`view-${e}`)})}function vs(e){const t=document.getElementById("dock");t&&(t.style.display=e?"":"none")}function U(e,t={}){const a=document.getElementById("toasts");if(!a)return;const s=document.createElement("div");s.className="toast",s.textContent=e,t.variant==="error"&&(s.style.background="#7a1f1f"),a.appendChild(s),setTimeout(()=>{s.style.opacity="0",s.style.transform="translateY(4px)",s.style.transition="all .25s",setTimeout(()=>s.remove(),260)},t.duration||2200)}function fs(e,t){const a=new Blob([t],{type:"application/json;charset=utf-8"}),s=URL.createObjectURL(a),n=document.createElement("a");n.href=s,n.download=e,n.click(),URL.revokeObjectURL(s)}function ys(e){return new Promise((t,a)=>{const s=new FileReader;s.onload=()=>t(s.result),s.onerror=a,s.readAsText(e)})}var bs={default:"/arg-game-it-company-secret/assets/data/music/Teacup Corridor (warmer).mp3",darknet:"/arg-game-it-company-secret/assets/data/music/Teacup Corridor.mp3",cooperate:"/arg-game-it-company-secret/assets/data/music/bgm_cowork.mp3",flee:"/arg-game-it-company-secret/assets/data/music/bgm_flee.mp3",fried:"/arg-game-it-company-secret/assets/data/music/bgm_fried.mp3",report:"/arg-game-it-company-secret/assets/data/music/bgm_report.mp3",resign:"/arg-game-it-company-secret/assets/data/music/bgm_resign.mp3"},_s=.25,Pa=1500,ws=class{constructor(){this.audio=null,this.currentBgm=null,this.isMuted=!1,this.volume=_s,this.fadeTimer=null,this._loadSettings()}_loadSettings(){const e=l.get("settings");e&&(typeof e.bgmVolume=="number"&&(this.volume=e.bgmVolume),typeof e.bgmMuted=="boolean"&&(this.isMuted=e.bgmMuted))}_saveSettings(){l.set("settings.bgmVolume",this.volume),l.set("settings.bgmMuted",this.isMuted)}_createAudio(e){const t=new Audio(e);return t.loop=!0,t.preload="auto",t.volume=this.isMuted?0:this.volume,t}_fadeVolume(e,t,a,s){this.fadeTimer&&cancelAnimationFrame(this.fadeTimer);const n=performance.now(),i=r=>{const d=r-n,o=Math.min(d/a,1),c=e+(t-e)*o;this.audio&&(this.audio.volume=this.isMuted?0:c),o<1?this.fadeTimer=requestAnimationFrame(i):(this.fadeTimer=null,s&&s())};this.fadeTimer=requestAnimationFrame(i)}_stopCurrent(e=!0){if(!this.audio)return Promise.resolve();const t=this.audio,a=t.volume;return e&&a>0?new Promise(s=>{this._fadeVolume(a,0,Pa,()=>{t.pause(),t.src="",s()})}):(t.pause(),t.src="",Promise.resolve())}async play(e){const t=bs[e];if(t&&this.currentBgm!==e){await this._stopCurrent(!0),this.currentBgm=e,this.audio=this._createAudio(t);try{await this.audio.play(),this._fadeVolume(0,this.volume,Pa)}catch(a){console.warn("BGM play failed:",a)}}}async stop(e=!0){await this._stopCurrent(e),this.audio=null,this.currentBgm=null}setVolume(e){this.volume=Math.max(0,Math.min(1,e)),this.audio&&!this.isMuted&&(this.audio.volume=this.volume),this._saveSettings()}getVolume(){return this.volume}toggleMute(){return this.isMuted=!this.isMuted,this.audio&&(this.audio.volume=this.isMuted?0:this.volume),this._saveSettings(),this.isMuted}setMuted(e){this.isMuted=e,this.audio&&(this.audio.volume=this.isMuted?0:this.volume),this._saveSettings()}isMutedState(){return this.isMuted}getCurrentBgm(){return this.currentBgm}},ie=new ws;function We(){const e=document.getElementById("settingsDialog");e&&(typeof e.showModal=="function"?e.open||e.showModal():typeof e.show=="function"?e.open||e.show():(e.style.display="block",e.setAttribute("open","")),e.style.removeProperty("display"),xs())}function xs(){const e=document.getElementById("settingTheme");e&&(e.value=l.get("settings.theme"));const t=document.getElementById("settingPlaytime");t&&(t.textContent=String(l.get("playtime"))+"s")}function ks(){document.getElementById("settingTheme")?.addEventListener("change",s=>{const n=s.target.value;l.set("settings.theme",n),document.documentElement.setAttribute("data-theme",n),U(he("toast.saved"))});const e=document.getElementById("bgmMuteBtn"),t=document.getElementById("bgmVolumeSlider"),a=document.getElementById("bgmVolumePct");e&&!e._bound&&(e._bound=!0,e.addEventListener("click",()=>{const s=ie.toggleMute();e.textContent=s?"🔇":"🔊",a&&(a.textContent=s?"靜音":Math.round(ie.getVolume()*100)+"%")})),t&&!t._bound&&(t._bound=!0,t.addEventListener("input",s=>{const n=parseInt(s.target.value)/100;ie.setVolume(n),ie.setMuted(!1),e&&(e.textContent="🔊"),a&&(a.textContent=Math.round(n*100)+"%")})),document.getElementById("btnExport")?.addEventListener("click",()=>{fs("code-conspiracy-save.json",l.exportSave())}),document.getElementById("btnImport")?.addEventListener("change",async s=>{const n=s.target.files?.[0];if(!n)return;const i=await ys(n),r=l.importSave(i);U(r?he("toast.saved"):"Import failed",{variant:r?void 0:"error"}),r&&location.reload()}),document.getElementById("btnReset")?.addEventListener("click",async()=>{if(confirm("Reset all progress?")){try{l.reset()}catch{}try{localStorage.removeItem("code_conspiracy_state")}catch{}try{localStorage.clear()}catch{}const s=document.getElementById("settingsDialog");if(s&&s.open)try{s.close()}catch{}s&&(s.style.removeProperty("display"),s.removeAttribute("open"));try{if("caches"in window){const n=await caches.keys();await Promise.all(n.map(i=>caches.delete(i)))}if("serviceWorker"in navigator){const n=await navigator.serviceWorker.getRegistrations();await Promise.all(n.map(i=>i.unregister()))}}catch{}setTimeout(()=>{window.location.href=window.location.pathname+"?reset="+Date.now(),window.location.reload(!0)},150)}}),document.getElementById("settingsDialog")?.addEventListener("close",()=>{})}var ja=["教學","異常發現","自由探索","暗網入口","秘密曝光","抉擇"],Ss=13,Es={vscode:"Vizual",jira:"Jiua",whatsapp:"WhatUp",search:"Search",intranet:"Intranet",darknet:"Darknet",email:"Email"};function Is(e){return!e||!e.length?"—":e.map(t=>Es[t]||t).join(", ")}function Cs(e){return e=Number(e)||0,e<=59?`${e} 秒`:e<3600?`${Math.floor(e/60)} 分鐘`:e<86400?`${Math.floor(e/3600)} 小時`:`${Math.floor(e/86400)} 日`}function Ls(){const e=l.get("readArticles")||[],t=l.get("discoveredFiles")||[],a=l.get("endings")||l.get("unlockedEndings")||[],s=l.get("whatsappSentCount")||0,n=l.get("persistentStats")||{},i=n.readArticles||[],r=n.darkFileCount||0,d=n.whatsappSentCount||0,o=n.searchHistoryCount||0,c=n.flags||{},m=["https://sawyer-blog.example/2001-10-18","https://sawyer-blog.example/2003-04-27","https://sawyer-blog.example/2004-11-13","https://sawyer-blog.example/2006-09-01","https://sawyer-blog.example/2007-01-11","https://sawyer-blog.example/2007-01-12","https://sawyer-blog.example/2010-06-06","https://sawyer-blog.example/2012-07-07","https://sawyer-blog.example/2013-01-01","https://sawyer-blog.example/2023-04-25","https://sawyer-blog.example/2023-05-01","https://sawyer-blog.example/2023-05-10","https://sawyer-blog.example/2023-12-20","https://sawyer-blog.example/2024-01-15","https://sawyer-blog.example/2024-03-20"],p=["https://school.example/guangzhi-essay-sawyer"],u=["https://news.example/car-accident-2023","https://news.example/car-accident-investigation-2023","https://news.example/ping-wo-suspicious-man-2023","https://news.example/police-clarification-2023"],f=[...m,...p,...u],v=[...m,"https://mary-blog.example/kyoto-sakura-2024","https://mary-blog.example/one-person-kitchen","https://mary-blog.example/danshari-half-year","https://peter-blog.example/python-one-year","https://peter-blog.example/vim-vs-vscode","https://peter-blog.example/nas-ds220","https://peter-blog.example/code-easter-eggs","https://paul-blog.example/tainan-beef-soup","https://paul-blog.example/hand-drip-coffee","https://paul-blog.example/keelung-night-market","https://emma-blog.example/contax-t2-taipei","https://emma-blog.example/iceland-aurora","https://david-blog.example/vinyl-jazz-20","https://david-blog.example/livehouse-map"];let b=10;try{const h=k.listDarkFiles?k.listDarkFiles("/darknet"):[];h.length&&(b=h.length)}catch{}const T=Math.max(t.filter(h=>h.startsWith("/darknet")).length,r),M=Math.max(l.hasFlag("portal_simple_entered")?1:0,c.portal_simple_entered?1:0),ee=Math.max(l.hasFlag("portal_hash_entered")?1:0,c.portal_hash_entered?1:0),E=[...new Set([...e,...i])],_=Math.max(s,d),w=Math.max((l.get("searchHistory")||[]).length,o),y=[...new Set([...a,...l.get("unlockedEndings")||[],...n.unlockedEndings||[]])];return[{id:"secret_entry",title:"解鎖秘密入口",desc:"進入公司秘密內部系統入口",total:2,current:M+ee,isSecret:!1},{id:"boss_whisper",title:"老闆知音",desc:"已了解老闆的一切",total:20,current:f.filter(h=>E.includes(h)).length,isSecret:!1},{id:"too_much",title:"你知道得太多了",desc:"閱讀所有秘密檔案",total:b,current:Math.min(T,b),isSecret:!1},{id:"all_endings",title:"作者感謝您",desc:"解鎖全結局",total:5,current:y.length,isSecret:!1},{id:"social",title:"社牛",desc:"在 WhatUp 發送超過 10 條訊息",total:10,current:Math.min(_,10),isSecret:!0},{id:"reader",title:"閱讀達人",desc:"閱讀 BlogWorld 上的所有部落格",total:29,current:v.filter(h=>E.includes(h)).length,isSecret:!0},{id:"miracle",title:"你沒有被解僱是奇蹟",desc:"向 Sawyer 發送帶有「垃圾」「蠢」等字眼的訊息",total:1,current:Math.max(l.hasFlag("sawyer_abuse_sent")?1:0,c.sawyer_abuse_sent?1:0),isSecret:!0},{id:"net_addict",title:"網路成癮",desc:"在搜尋引擎搜尋超過 50 次",total:50,current:Math.min(w,50),isSecret:!0}].map(h=>({...h,done:h.current>=h.total,progress:`${h.current}/${h.total}`,pct:Math.round(h.current/h.total*100)}))}var Da=[{id:"flee",idx:1,title:"平凡的日常",desc:"完成工作後登出，回到平凡重複的日常。",color:"#6b778c"},{id:"cooperate",idx:2,title:"共犯",desc:"與老闆合作，踏入充滿刺激與風險的新生活。",color:"#d93025"},{id:"report",idx:3,title:"舉報",desc:"向警方舉報，目睹公司倒閉與風波後的平靜。",color:"#0d9488"},{id:"resign",idx:4,title:"辭職",desc:"遠離是非，主動辭職尋找新的工作與記憶。",color:"#6554c0"},{id:"fried",idx:5,title:"做對了嗎？",desc:"公司已發現你。",color:"#ff991f"}];function Ge(){const e=document.getElementById("notebookDialog");e&&(Ts(),typeof e.showModal=="function"?e.open||e.showModal():typeof e.show=="function"?e.open||e.show():(e.setAttribute("open",""),e.style.display="block"),e.style.removeProperty("display"),e._boundClose||(e.addEventListener("close",()=>{e.style.removeProperty("display"),e.removeAttribute("open")}),e._boundClose=!0))}function Ts(){const e=document.getElementById("notebookContent");if(!e)return;const t=l.get("collectedEvidence")||[];l.get("flags");const a=l.get("currentChapter")??0,s=Ls(),n=s.filter(c=>c.done).length,i=l.get("persistentStats")?.unlockedEndings||[],r=l.get("endings")||l.get("unlockedEndings")||[],d=[...new Set([...r,...i])],o=(()=>{const c=Da.map(m=>{const p=d.includes(m.id),u="？".repeat([...m.title].length);return`
    ...
    <div class="card">
      ...
      <div class="small muted" style="margin-top:6px">遊玩時長 ${Cs(l.get("playtime"))} · 已解鎖 ${Is(l.get("unlockedInterfaces"))}</div>
    </div>

    <div class="card" style="margin-top:12px">
      <h3 style="margin:0 0 8px">證據板 (${t.length}/${Ss})</h3>
      ${t.length?`
  ...
  `,setTimeout(()=>{const c=document.getElementById("notebookResetBtn");!c||c._bound||(c._bound=!0,c.addEventListener("click",async()=>{if(!confirm("重置後將失去證據，確定？"))return;const m=document.getElementById("notebookDialog");try{m&&m.open&&m.close()}catch{}m&&(m.style.removeProperty("display"),m.removeAttribute("open"));let p=null;try{p=JSON.parse(JSON.stringify(l.get("persistentStats")||{}))}catch{}try{l.reset()}catch{}try{if(p){const u=l.get("persistentStats")||{},f={unlockedEndings:[...new Set([...u.unlockedEndings||[],...p.unlockedEndings||[]])],readArticles:[...new Set([...u.readArticles||[],...p.readArticles||[]])],darkFileCount:Math.max(u.darkFileCount||0,p.darkFileCount||0),whatsappSentCount:Math.max(u.whatsappSentCount||0,p.whatsappSentCount||0),searchHistoryCount:Math.max(u.searchHistoryCount||0,p.searchHistoryCount||0),flags:{...u.flags||{},...p.flags||{}}};l.set("persistentStats",f),l.set("unlockedEndings",f.unlockedEndings)}}catch{}try{if("caches"in window){const u=await caches.keys();await Promise.all(u.map(f=>caches.delete(f)))}if("serviceWorker"in navigator){const u=await navigator.serviceWorker.getRegistrations();await Promise.all(u.map(f=>f.unregister()))}}catch{}setTimeout(()=>{window.location.href=window.location.pathname+"?reset="+Date.now(),window.location.reload(!0)},150)}))},0),setTimeout(()=>{const c=document.querySelector(".nb-endings-grid");c&&c.querySelectorAll(".nb-ending-card.unlocked").forEach(m=>{m.addEventListener("click",()=>{const p=m.dataset.ending,u=Da.find(f=>f.id===p);if(u){try{const f=new CustomEvent("nb:endingPreview",{detail:u});window.dispatchEvent(f)}catch{}m.classList.add("pulse"),setTimeout(()=>m.classList.remove("pulse"),600)}})})},0)}function g(e){return e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var As="modulepreload",$s=function(e){return"/arg-game-it-company-secret/"+e},Fa={},B=function(t,a,s){let n=Promise.resolve();if(a&&a.length>0){let c=function(p){return Promise.all(p.map(u=>Promise.resolve(u).then(f=>({status:"fulfilled",value:f}),f=>({status:"rejected",reason:f}))))},m=function(p){return import.meta.resolve?import.meta.resolve(p):new URL(p,import.meta.url).href};const r=document.getElementsByTagName("link"),d=document.querySelector("meta[property=csp-nonce]"),o=d?.nonce||d?.getAttribute("nonce");n=c(a.map(p=>{if(p=$s(p,s),p=m(p),p in Fa)return;Fa[p]=!0;const u=p.endsWith(".css");for(let v=r.length-1;v>=0;v--){const b=r[v];if(b.href===p&&(!u||b.rel==="stylesheet"))return}const f=document.createElement("link");if(f.rel=u?"stylesheet":As,u||(f.as="script"),f.crossOrigin="",f.href=p,o&&f.setAttribute("nonce",o),document.head.appendChild(f),u)return new Promise((v,b)=>{f.addEventListener("load",v),f.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${p}`)))})}))}function i(r){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=r,window.dispatchEvent(d),!d.defaultPrevented)throw r}return n.then(r=>{for(const d of r||[])d.status==="rejected"&&i(d.reason);return t().catch(i)})},F="/customer-portal/src/main/java/com/nori/OrderService.java",te="explorer",$e=[],ue=-1,Vt="",Bs=new Set(["/customer-portal/src/frontend/src/pages/Home.jsx","/customer-portal/src/main/java/com/nori/controller/OrderController.java","/customer-portal/scripts/reconcile.py","/customer-portal/src/payment/gateway.js","/customer-portal/src/main/java/com/nori/service/PaymentService.java","/customer-portal/src/main/java/com/nori/controller/PaymentController.java"]);function Ee(e){return Bs.has(e)}var V=new Map,Fe=null,Na=null;function ut(e){const t=k.getFile(e);return t?t.content:null}function ua(e){return V.has(e)?V.get(e):ut(e)}function pn(e){return V.has(e)?V.get(e)!==ut(e):!1}function Ms(e,t){t===ut(e)?V.delete(e):V.set(e,t),Ce(),ye(),Ne()}function _a(){if(!Fe){const e=k.getFile("/file-system/src/components/SearchBar.jsx");e&&(Fe=e.content)}}function Ps(){if(!Na){const e=k.getFile("/customer-portal/src/frontend/src/pages/Home.jsx");e&&(Na=e.content)}}var js=`export default function Home(){
  return (
    <div>
      <h1>Nori 飲品供應 — 用一杯冰釀茶酒，連結人與希望</h1>
      <p>創辦人 蔡梓掦 · 2018 創立 · 招牌冰釀茶酒最暢銷</p>
...
`,Ds=`export default function Home(){
  return (
    <div>
...
`;function un(){return l.hasFlag("ch1_0043_committed")&&!l.hasFlag("ch1_revert_done")}function mn(e="revert"){l.hasFlag("ch1_revert_done")||(l.setFlag("ch1_revert_done",!0),l.setFlag("ch1_system_down",!1),setTimeout(()=>{B(()=>Promise.resolve().then(()=>ce).then(t=>{const a=(t.getChats?t.getChats():[]).find(s=>s.id==="system-alert");if(a){a.messages.push({id:"health-"+Date.now(),from:"system",text:"✅ 系統健康 — 所有服務已恢復正常",time:new Date().toLocaleTimeString("zh-TW",{hour:"2-digit",minute:"2-digit"}),read:"delivered",type:"text"}),a.preview="✅ 系統健康",a.unread=(a.unread||0)+1,window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"system-alert"}}));const s=document.createElement("div");if(hn("system-alert"))return;s.id="wa-win-notif-health-"+Date.now(),s.setAttribute("role","alert"),s.innerHTML='<div class="win-notif__app"><img src="/arg-game-it-company-secret/icon/whatsup.svg" alt="WhatUp" width="20" height="20" style="width:20px;height:20px;object-fit:contain" /><span class="win-notif__app-name">WhatUp</span><span class="win-notif__app-sub">System Alert</span><button class="win-notif__close" aria-label="關閉">✕</button></div><div class="win-notif__body"><div class="win-notif__avatar" style="background:linear-gradient(135deg, #0d9488, #25D366)">✓</div><div class="win-notif__text"><div class="win-notif__sender">System Alert</div><div class="win-notif__msg">✅ 系統健康 — 所有服務已恢復正常</div><div class="win-notif__time">剛剛 · 點擊開啟對話</div></div></div><div class="win-notif__progress" style="animation: winNotifShrink 10000ms linear forwards"></div>',s.style.cssText="position:fixed;right:16px;bottom:60px;width:360px;background:#2d2d2d;color:#f0f0f0;border:1px solid rgba(255,255,255,.12);border-radius:8px;box-shadow:0 8px 28px rgba(0,0,0,.45);z-index:1100;overflow:hidden;cursor:pointer;opacity:0;transform:translateY(12px);transition:opacity .28s,transform .28s;",s.addEventListener("click",n=>{n.target.closest(".win-notif__close")||(s.remove(),B(()=>Promise.resolve().then(()=>oe).then(i=>{i.setActiveView&&(i.setActiveView("whatsapp"),localStorage.setItem("cc_active_view","whatsapp"))}),void 0),B(()=>Promise.resolve().then(()=>ce).then(i=>i.openChat("system-alert")),void 0))}),s.querySelector(".win-notif__close")?.addEventListener("click",n=>{n.stopPropagation(),s.remove()}),document.body.appendChild(s),requestAnimationFrame(()=>{s.style.opacity="1",s.style.transform="none"}),setTimeout(()=>{s.style.opacity="0",s.style.transform="translateY(8px)",setTimeout(()=>s.remove(),300)},1e4)}}),void 0)},500))}function Fs(e){const t=re.find(i=>i.hash===e)||de.find(i=>i.hash===e);if(!t)return;if(t.msg.includes("INV-2024-0017")||t.hash==="3f2a9c1"){const i=k.getFile("/customer-portal/src/frontend/src/pages/Home.jsx")?.content||"",r=i.includes("連結人與希望")||i.includes("2018 創立"),d=r?Ds:js;k.registerFile("/customer-portal/src/frontend/src/pages/Home.jsx",{content:d,meta:{lang:"javascript"}});const o=k.getFile("/customer-portal/src/frontend/src/pages/Home.jsx");o&&(o.content=d),V.delete("/customer-portal/src/frontend/src/pages/Home.jsx");const c=Math.random().toString(36).slice(2,8),m=r?`revert: restore Home.jsx fix (revert ${e} — apply Parker fix)`:`revert: revert Home.jsx fix (revert ${e} — back to bug)`,p=r?`M /customer-portal/src/frontend/src/pages/Home.jsx
- 連結人與希望 / 2018
+ 連結人與風味 / 2019 (revert apply)`:`M /customer-portal/src/frontend/src/pages/Home.jsx
- 連結人與風味 / 2019
+ 連結人與希望 / 2018 (revert)`;de.unshift({hash:c,author:"Parker",date:new Date().toISOString().slice(0,10),msg:m,diff:p}),re.unshift({hash:c,branch:"main",author:"Parker",date:new Date().toISOString().slice(0,10),msg:m,diff:p});const u=document.getElementById("scmCommitStatus");u&&(u.innerHTML=`<span style="color:var(--success)">✓ Revert 成功: ${c} (from ${e}) — ${r?"已套用 Parker 修復":"已回退至 bug 版"}</span>`),C(`✓ revert ${c} — ${m}`),Ce(),ye(),Le(),Ne(),fe&&je();return}if(!un())return;if(_a(),Fe){k.registerFile("/file-system/src/components/SearchBar.jsx",{content:Fe,meta:{lang:"javascript"}});const i=k.getFile("/file-system/src/components/SearchBar.jsx");i&&(i.content=Fe)}V.delete("/file-system/src/components/SearchBar.jsx");const a=Math.random().toString(36).slice(2,8),s=`revert: restore SearchBar legacyRoutes (revert ${e})`;de.unshift({hash:a,author:"Casey",date:new Date().toISOString().slice(0,10),msg:s,diff:`M /file-system/src/components/SearchBar.jsx
+ restored legacyRoutes / resolveLegacyPath`}),re.unshift({hash:a,branch:"main",author:"Casey",date:new Date().toISOString().slice(0,10),msg:s,diff:`M /file-system/src/components/SearchBar.jsx
+ restored legacyRoutes`});const n=document.getElementById("scmCommitStatus");n&&(n.innerHTML=`<span style="color:var(--success)">✓ Revert 成功: ${a} (from ${e})</span>`),C(`✓ revert ${a} — ${s}`),Ce(),ye(),Le(),Ne(),fe&&je(),mn("git-graph")}var de=[{hash:"a1b2c3d",author:"finance@internal",date:"2024-08-12",msg:"feat: integrate crypto-mixer (legacy)",diff:`+ import { cryptoMixer } from '@shady/crypto-mixer'
...
+ export function computeFee(amount, opts) {}`}],Oa={"/customer-portal/src/billing/service.js":[{line:1,commit:"4c2a1e0",author:"dev"},{line:5,commit:"4c2a1e0",author:"dev"},{line:9,commit:"9f8e7d6",author:"qa-lee"},{line:12,commit:"9f8e7d6",author:"qa-lee"},{line:14,commit:"a1b2c3d",author:"finance@internal"}],"/customer-portal/src/main/java/com/nori/OrderService.java":[{line:1,commit:"4c2a1e0",author:"dev"},{line:12,commit:"9f8e7d6",author:"qa-lee"},{line:15,commit:"a1b2c3d",author:"finance@internal"}]},ve="__GIT_GRAPH__",fe=!1,Qe=null,Ha={main:"#89d185","feature/vip-discount":"#4da3ff","feature/crypto-mixer":"#dcdcaa","feature/billing-fix":"#ce9178","feature/home-copyfix":"#4ec9b0",develop:"#c586c0"},re=[{hash:"a1b2c3d",branch:"feature/crypto-mixer",author:"finance@internal",date:"2024-08-12",msg:"(INV-2024-0040) feat: integrate crypto-mixer (legacy)",diff:`+ import { cryptoMixer } from '@shady/crypto-mixer'
...
+ <h1>Nori 飲品供應 — 用一杯冰釀茶酒，連結人與風味</h1>
- <p>創辦人 蔡梓掦 · 2018 創立</p>
+ <p>創辦人 蔡梓掦 · 2019 創立</p>`},{hash:"d4e5f6a",branch:"main",author:"dev-chen",date:"2023-11-20",msg:"(INV-2023-0039) refactor: simplify portal auth (remove dynamic generator)",diff:"- function generateInternalPortalPath(internalPortalDomain){ \n-     const cid = redis.get('companyId'); \n-     const y = redis.get('year'); \n-     const k = import.meta.env.MD5_KEY; \n-     return internalPortalDomain + '?hash=' + md5(`companyId=${cid}&year=${y}&key=${k}`); // e.g. https://google.com/internal?hash=be78e7542cd6d04e31e80fa8b741aad4\n-     }"}];function gn(){const e=re.find(a=>a.hash==="d4e5f6a");e&&!e.diff.includes("e.g. https://google.com/internal?hash=")&&(e.diff=e.diff.replace("md5(`companyId=${cid}&year=${y}&key=${k}`);","md5(`companyId=${cid}&year=${y}&key=${k}`); // e.g. https://google.com/internal?hash=be78e7542cd6d04e31e80fa8b741aad4"));const t=de.find(a=>a.hash==="d4e5f6a");t&&t.diff&&!t.diff.includes("e.g. https://google.com")&&(t.diff=e.diff)}gn();function Ce(){try{const e=Array.from(V.entries());l.set("vscodeState",{editedFiles:e,gitCommits:de.slice(0,20),gitGraphCommits:re.slice(0,20),currentFile:F,activeActivity:te,gitGraphOpen:fe,expandedGraphHash:Qe}),l.save(!0)}catch{}}function hn(e){try{const t=JSON.parse(localStorage.getItem("code_conspiracy_state")||"{}").whatsappChats;if(Array.isArray(t)){const a=t.find(s=>s.id===e);if(a)return!!a.muted}return!1}catch{return!1}}function Ns(){try{const e=l.get("vscodeState");if(!e||typeof e!="object")return;if(Array.isArray(e.editedFiles))for(const[t,a]of e.editedFiles){V.set(t,a);const s=k.getFile(t);s?s.content=a:k.registerFile(t,{content:a,meta:{lang:t.endsWith(".java")?"java":t.endsWith(".js")?"javascript":"text"}})}if(Array.isArray(e.gitCommits)&&e.gitCommits.length){de.length=0;for(const t of e.gitCommits)de.push(t)}if(Array.isArray(e.gitGraphCommits)&&e.gitGraphCommits.length){re.length=0;for(const t of e.gitGraphCommits)re.push(t)}try{gn()}catch{}typeof e.currentFile=="string"&&e.currentFile&&(F=e.currentFile),typeof e.activeActivity=="string"&&(te=e.activeActivity),typeof e.gitGraphOpen=="boolean"&&(fe=e.gitGraphOpen),e.expandedGraphHash&&(Qe=e.expandedGraphHash)}catch{}}function Os(){Ns();const e=document.getElementById("view-vscode");e&&(e.innerHTML=`
    <div class="vscode">
...
`).map(p=>{const u=g(p);return p.startsWith("+")?`<div class="diff-add">${u}</div>`:p.startsWith("-")?`<div class="diff-del">${u}</div>`:`<div>${u}</div>`}).join(""),c=n.author==="Casey"&&(n.diff.includes("SearchBar")||n.diff.includes("legacyRoutes")||n.msg.includes("0043"));(n.hash==="3f2a9c1"||n.msg.includes("INV-2024-0017"))&&n.author;const m=a&&c&&!l.hasFlag("ch1_revert_done")&&l.hasFlag("sawyer_seq_started");return`
      <div class="gitgraph-row ${d?"expanded":""}" data-hash="${n.hash}">
        <div class="gitgraph-row__main">
          <div class="gitgraph-graph-col">
            ...
            ${i<re.length-1?'<span class="gitgraph-vline"></span>':""}
          </div>
    ...
    <div class="gitgraph-editor">
      <div class="gitgraph-editor__header">
        <div style="display:flex;align-items:center;gap:8px">
          ...
          <b>Git Graph</b>
          <span class="small muted">${re.length} commits — 5 branches</span>
        </div>
        <div class="gitgraph-legend">
          ${Object.entries(Ha).map(([n,i])=>`<span class="gitgraph-branch" style="background:${i}22;color:${i};border-color:${i}44">${g(n)}</span>`).join("")}
        </div>
      </div>
  ...
  `,e.querySelectorAll(".gitgraph-row__main").forEach(n=>{n.addEventListener("click",i=>{if(i.target.closest(".gitgraph-revert-btn"))return;const r=n.closest(".gitgraph-row")?.dataset.hash;r&&(Qe=Qe===r?null:r,je())})}),e.querySelectorAll(".gitgraph-revert-btn").forEach(n=>{n.addEventListener("click",i=>{i.stopPropagation();const r=n.dataset.revert;r&&Fs(r)})}),C("$ open Git Graph")}function Vs(e){const t=e.split(`
`).filter(s=>s.trim()!=="");if(!t.length)return{header:[],rows:[]};const a=s=>{const n=[];let i="",r=!1;for(let d=0;d<s.length;d++){const o=s[d];o==='"'?r&&s[d+1]==='"'?(i+='"',d++):r=!r:o===","&&!r?(n.push(i),i=""):i+=o}return n.push(i),n};return{header:a(t[0]),rows:t.slice(1).map(a)}}function qs(e,t){const{header:a,rows:s}=Vs(t),n=`<thead><tr>${a.map(r=>`<th>${g(r)}</th>`).join("")}</tr></thead>`,i=`<tbody>${s.map((r,d)=>`<tr>${r.map(o=>`<td>${g(o)}</td>`).join("")}${r.length<a.length?`<td colspan="${a.length-r.length}"></td>`:""}</tr>`).join("")}</tbody>`;return`
    <div class="csv-view">
  ...
  `}function pe(e){if(Ee(e)){const i=document.getElementById("vsEditor");i&&(i.innerHTML='<div class="editor__lines" style="padding:16px;color:var(--fg-muted)">檔案不存在或尚未解鎖 — 嘗試 Search 搜尋 "Sawyer" 或觸發隱藏邏輯</div>');return}if(e===ve){F=e,Ce(),je(),Le(document.getElementById("vsQuickOpen")?.value.trim().toLowerCase()||"");return}F=e,Ce();const t=k.getFile(e),a=ua(e),s=document.getElementById("vsEditor");if(!s)return;if((e==="/customer-portal/src/main/java/com/nori/OrderService.java"||e==="/customer-portal/src/billing/service.js")&&zn("vscode_viewed"),a==null)s.innerHTML='<div class="editor__lines" style="padding:16px;color:var(--fg-muted)">檔案不存在或尚未解鎖 — 嘗試 Search 搜尋 "Sawyer" 或觸發隱藏邏輯</div>';else if(e.toLowerCase().endsWith(".csv"))s.innerHTML=qs(e,a);else{const i=t?.meta?.lang||(e.endsWith(".py")?"python":e.endsWith(".java")?"java":"javascript");s.innerHTML=`
...
`).map((d,o)=>`<div class="editor__gutter-line" style="height:20px;line-height:20px">${o+1}</div>`).join("")}</div>
        <textarea id="vsEditorArea" class="editor__textarea" spellcheck="false" data-path="${g(e)}" data-lang="${i}">${g(a)}</textarea>
      </div>
    `;const r=document.getElementById("vsEditorArea");r&&(r.addEventListener("input",d=>{const o=d.target.value;Ms(e,o);const c=o.split(`
`).length,m=s.querySelector(".editor__gutter");m&&(m.innerHTML=Array.from({length:c},(T,M)=>`<div class="editor__gutter-line" style="height:20px;line-height:20px">${M+1}</div>`).join(""));const p=r.selectionStart,u=o.slice(0,p),f=u.split(`
`).length,v=u.split(`
`).pop().length+1,b=document.getElementById("vsCursorInfo");b&&(b.textContent=`Ln ${f}, Col ${v}`)}),r.addEventListener("click",d=>{const o=r.selectionStart,c=r.value.slice(0,o),m=c.split(`
`).length,p=c.split(`
`).pop().length+1,u=document.getElementById("vsCursorInfo");u&&(u.textContent=`Ln ${m}, Col ${p}`)}),r.addEventListener("keydown",d=>{if(d.key==="Tab"){d.preventDefault();const o=r.selectionStart,c=r.selectionEnd;r.value=r.value.substring(0,o)+"  "+r.value.substring(c),r.selectionStart=r.selectionEnd=o+2,r.dispatchEvent(new Event("input"))}}),e.includes("OrderService")&&setTimeout(()=>r.focus(),50))}const n=document.getElementById("vsTitle");n&&(n.textContent=`${e.split("/").pop()} — ${e} — nori-system — Vizual Studio Code`),Le(document.getElementById("vsQuickOpen")?.value.trim().toLowerCase()||""),ye(),C(`$ open ${e}`)}function Ne(){const e=document.getElementById("scmChanges");if(!e)return;const t=[...V.entries()].filter(([a,s])=>s!==ut(a));if(!t.length){e.innerHTML=`<div class="small muted" style="padding:8px 0">修改完成後在這邊提交
 目前沒有變更 — 編輯後的改動會顯示於此</div>`;return}e.innerHTML=`
    <div class="small" style="font-weight:600;margin:10px 0 6px">變更 (${t.length})</div>
    ${t.map(([a])=>{const s=a.split("/").pop();return`<div class="scm__file" data-path="${g(a)}" title="${g(a)}">
        <span style="color:var(--warning)">M</span> ${g(s)} <span class="small muted" style="margin-left:auto">${g(a)}</span>
      </div>`}).join("")}
  `,e.querySelectorAll(".scm__file").forEach(a=>a.addEventListener("click",()=>pe(a.dataset.path)))}function zs(e){const t={1:.9,2:.85,3:.8,4:.75,5:.7},a=e.split(`
`),s={};let n=null,i="";a.forEach((r,d)=>{const o=r.match(/case\s*([1-5])\s*:\s*price\s*\*=\s*([0-9.]+%?)/i);if(o){const c=parseInt(o[1],10);let m=o[2].replace("%","").trim(),p=parseFloat(m);p>1&&(p=p/100),s[c]={val:p,line:d+1,raw:r.trim()}}else{const c=r.match(/case\s*([1-5])\s*:\s*price\s*=\s*price\s*\*\s*([0-9.]+)/i);if(c){const m=parseInt(c[1],10);let p=parseFloat(c[2]);p>1&&(p=p/100),s[m]={val:p,line:d+1,raw:r.trim()}}}});for(let r=1;r<=5;r++){const d=t[r],o=s[r];if(!o)return n=a.findIndex(c=>c.includes(`case ${r}:`))+1||18+r,i=`缺少 case ${r} 或格式無法解析`,{ok:!1,line:n,detail:i,found:s};if(Math.abs(o.val-d)>.001)return{ok:!1,line:o.line,detail:`VIP${r} 應為 ${(d*100).toFixed(0)}% (0.${String(d).split(".")[1].padEnd(2,"0")})，目前為 ${(o.val*100).toFixed(0)}%`,found:s}}return{ok:!0,found:s}}function Us(){const e=document.getElementById("scmCommitMsg"),t=document.getElementById("scmCommitStatus"),a=e?.value.trim()||"fix: correct VIP discount";if(![...V.entries()].filter(([E,_])=>_!==ut(E)).length){t&&(t.textContent="沒有變更可提交 — 請先編輯 OrderService.java");return}const s="/customer-portal/src/main/java/com/nori/OrderService.java",n=ua(s);if(n==null){t&&(t.textContent="找不到 OrderService.java");return}const i=zs(n);if(!i.ok){const E=document.getElementById("sonarModal"),_=document.getElementById("sonarModalBody");_&&(_.textContent=`SonarQube 掃描失敗 — 計算錯誤
...
請修正後重新 Commit。`),E&&(E.style.display="flex"),t&&(t.innerHTML=`<span style="color:var(--error)">✕ SonarQube: 行 ${i.line} 計算錯誤</span>`),C(`✕ commit 失敗 — SonarQube 行 ${i.line}: ${i.detail}`);return}const r="/file-system/src/components/SearchBar.jsx",d=ut(r)||"",o=ua(r)||d,c=o.includes("legacyRoutes"),m=o.includes("resolveLegacyPath"),p=d.includes("legacyRoutes")&&!c&&!m;if(Array.from(V.keys()).includes(r),l.hasFlag("ch0_vip_fixed")&&!l.hasFlag("ch1_0043_committed")&&!p){const E=document.getElementById("sonarModal"),_=document.getElementById("sonarModalBody");_&&(_.textContent=`SonarQube 掃描失敗 — 未移除已棄用的 legacy 入口

檔案: ${r}
錯誤: 偵測到未移除的 legacyRoutes / resolveLegacyPath 區塊`),E&&(E.style.display="flex"),t&&(t.innerHTML='<span style="color:var(--error)">✕ SonarQube: 尚未移除 legacyRoutes 區塊 (SearchBar.jsx)</span>');return}if(p&&l.hasFlag("ch0_vip_fixed")&&!l.hasFlag("ch1_0043_committed")){let w=function({appSub:y,sender:h,avatarBg:$,avatarText:L,msg:z,chatId:_e,duration:st}){if(_e&&hn(_e))return;const qe=st||4e3,N=document.createElement("div");return N.id="wa-win-notif-"+Date.now()+"-"+Math.random().toString(36).slice(2,6),N.setAttribute("role","alert"),N.innerHTML=`<div class="win-notif__app"><img src="/arg-game-it-company-secret/icon/whatsup.svg" alt="WhatUp" width="20" height="20" style="width:20px;height:20px;object-fit:contain" /><span class="win-notif__app-name">WhatUp</span><span class="win-notif__app-sub">${g(y)}</span><button class="win-notif__close" aria-label="關閉">✕</button></div><div class="win-notif__body"><div class="win-notif__avatar" style="background:${$}">${g(L)}</div><div class="win-notif__text"><div class="win-notif__sender">${g(h)}</div><div class="win-notif__msg">${g(z)}</div><div class="win-notif__time">剛剛 · 點擊開啟對話</div></div></div><div class="win-notif__progress" style="animation: winNotifShrink ${qe}ms linear forwards"></div>`,N.style.cssText="position:fixed;right:16px;bottom:60px;width:360px;background:#2d2d2d;color:#f0f0f0;border:1px solid rgba(255,255,255,.12);border-radius:8px;box-shadow:0 8px 28px rgba(0,0,0,.45);z-index:1100;overflow:hidden;cursor:pointer;opacity:0;transform:translateY(12px);transition:opacity .28s,transform .28s;",N.addEventListener("click",Ae=>{Ae.target.closest(".win-notif__close")||(N.remove(),B(()=>Promise.resolve().then(()=>oe).then(we=>{we.setActiveView&&(we.setActiveView("whatsapp"),localStorage.setItem("cc_active_view","whatsapp"))}),void 0),_e&&B(()=>Promise.resolve().then(()=>ce).then(we=>we.openChat(_e)),void 0))}),N.querySelector(".win-notif__close")?.addEventListener("click",Ae=>{Ae.stopPropagation(),N.remove()}),document.body.appendChild(N),requestAnimationFrame(()=>{N.style.opacity="1",N.style.transform="none"}),setTimeout(()=>{N.style.opacity="0",N.style.transform="translateY(8px)",setTimeout(()=>N.remove(),300)},qe),N};l.setFlag("ch1_0043_committed",!0);const E=Math.random().toString(36).slice(2,8),_=Array.from(V.entries()).map(([y,h])=>`M ${y}`).join(`
`);de.unshift({hash:E,author:"Casey",date:new Date().toISOString().slice(0,10),msg:a,diff:_}),re.unshift({hash:E,branch:"main",author:"Casey",date:new Date().toISOString().slice(0,10),msg:a,diff:_});for(const[y,h]of V.entries()){const $=k.getFile(y);$&&($.content=h),k.registerFile(y,{content:h,meta:{lang:y.endsWith(".java")?"java":y.endsWith(".js")?"javascript":"text"}})}V.clear(),e&&(e.value=""),t&&(t.innerHTML=`<span style="color:var(--success)">✓ Commit 成功: ${E}</span>`),C(`✓ commit ${E} — ${a}`),Ce(),ye(),Le(),Ne(),fe&&F===ve&&je();try{B(()=>Promise.resolve().then(()=>ft).then(y=>y.markTicketDone&&y.markTicketDone("INV-2024-0043")),void 0)}catch{}setTimeout(()=>{l.setFlag("ch1_system_down",!0);let y=0;const h=setInterval(()=>{if(!l.hasFlag("ch1_system_down")||l.hasFlag("ch1_revert_done")){clearInterval(h);return}y++,B(()=>Promise.resolve().then(()=>ce).then($=>{const L=($.getChats?$.getChats():[]).find(z=>z.id==="system-alert");if(L){const z=`⚠️ 警告 #${y}: 系統異常 — 檢測到異常，請檢查最近變更`;L.messages.push({id:"alert-"+Date.now()+"-"+y,from:"system",text:z,time:"今天",ts:Date.now(),read:"delivered",type:"text"}),L.preview=`⚠️ 警告 #${y}: 系統異常`,L.unread=(L.unread||0)+1,L.lastTime="今天",window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"system-alert"}}))}w({appSub:"System Alert",sender:"System Alert",avatarBg:"linear-gradient(135deg, #d93025, #fbbc05)",avatarText:"!",msg:`⚠️ 警告 #${y}: 系統異常 — 檢測到異常`,chatId:"system-alert",duration:4e3})}),void 0),y===5&&(setTimeout(()=>{B(()=>Promise.resolve().then(()=>ce).then($=>{const L=($.getChats?$.getChats():[]).find(z=>z.id==="dev-team");L&&(L.messages.push({id:"sawyer-dev-"+Date.now(),from:"Sawyer",text:"各位，系統怎麼一直在告警？發生什麼事了？是誰剛才改了什麼？",time:"今天",ts:Date.now(),read:"delivered",type:"text"}),L.preview="Sawyer: 系統怎麼一直在告警？",L.lastTime="今天",L.unread=(L.unread||0)+1,window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"dev-team"}})),w({appSub:"Dev Team",sender:"Sawyer",avatarBg:"linear-gradient(135deg, #722F37, #8B1A1A)",avatarText:"S",msg:"各位，系統怎麼一直在告警？發生什麼事了？",chatId:"dev-team",duration:4e3}))}),void 0)},500),setTimeout(()=>{B(()=>Promise.resolve().then(()=>ce).then($=>{const L=($.getChats?$.getChats():[]).find(z=>z.id==="dev-team");L&&(L.messages.push({id:"maggie-dev-"+Date.now(),from:"Maggie",text:"好像是剛才 INV-2024-0043 的修改，應該是最後一次變更就是這個任務",time:"今天",ts:Date.now(),read:"delivered",type:"text"}),L.preview="Maggie: 好像是 0043 的修改...",L.lastTime="今天",L.unread=(L.unread||0)+1,window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"dev-team"}})),w({appSub:"Dev Team",sender:"Maggie",avatarBg:"linear-gradient(135deg, #25D366, #128C7E)",avatarText:"M",msg:"好像是 INV-2024-0043 的修改，最後一次變更就是這個",chatId:"dev-team",duration:4e3}))}),void 0)},5500),setTimeout(()=>{B(()=>Promise.resolve().then(()=>ce).then($=>{const L=($.getChats?$.getChats():[]).find(z=>z.id==="sawyer");L&&(L.messages.push({id:"sawyer-pm-"+Date.now(),from:"Sawyer",text:"Casey，麻煩你先把 0043 的改動 revert 吧，系統要緊，先回滾再說",time:"今天",ts:Date.now(),read:"delivered",type:"text"}),L.preview="Sawyer: 麻煩你先把 0043 revert",L.lastTime="今天",L.unread=(L.unread||0)+1,window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"sawyer"}})),w({appSub:"Sawyer",sender:"Sawyer",avatarBg:"linear-gradient(135deg, #722F37, #8B1A1A)",avatarText:"S",msg:"Casey，麻煩你先把 0043 的改動 revert 吧",chatId:"sawyer",duration:4e3}),$.startSawyerRevertSeq&&($.startSawyerRevertSeq(),fe&&setTimeout(()=>je(),200)))}),void 0)},10500))},5e3)},5e3);return}const u=c&&m&&l.hasFlag("ch1_system_down")&&!l.hasFlag("ch1_revert_done"),f=a.toLowerCase().includes("revert")&&l.hasFlag("ch1_system_down")&&!l.hasFlag("ch1_revert_done");if(u||f){if(u)for(const[y,h]of V.entries()){k.registerFile(y,{content:h,meta:{lang:y.endsWith(".js")?"javascript":y.endsWith(".java")?"java":"text"}});const $=k.getFile(y);$&&($.content=h)}else if(_a(),Fe){k.registerFile("/file-system/src/components/SearchBar.jsx",{content:Fe,meta:{lang:"javascript"}});const y=k.getFile("/file-system/src/components/SearchBar.jsx");y&&(y.content=Fe)}l.setFlag("ch1_revert_done",!0),l.setFlag("ch1_system_down",!1);const E=Math.random().toString(36).slice(2,8),_=u,w=_?`M /file-system/src/components/SearchBar.jsx
+ restored legacyRoutes / resolveLegacyPath (paste back)`:"M revert 0043";de.unshift({hash:E,author:"Casey",date:new Date().toISOString().slice(0,10),msg:a,diff:w}),re.unshift({hash:E,branch:"main",author:"Casey",date:new Date().toISOString().slice(0,10),msg:a,diff:w}),V.clear(),t&&(t.innerHTML=`<span style="color:var(--success)">✓ Commit 成功 (revert): ${E}</span>`),C(`✓ commit ${E} — ${a} (revert)`),Ce(),ye(),Le(),Ne(),fe&&je(),mn(_?"paste-back":"keyword");try{B(()=>Promise.resolve().then(()=>ft).then(y=>{const h=y.getTickets().find($=>$.key==="INV-2024-0043");h&&(h.status="Done",h.history.push({from:"To Do",to:"Done",by:"Casey",at:new Date().toISOString().slice(0,10)}))}),void 0)}catch{}return}const v=Math.random().toString(36).slice(2,8),b=new Date().toISOString().slice(0,10),T="Casey",M=`M ${s}
`+Object.entries(i.found).map(([E,_])=>`  case ${E}: price*=${_.val.toFixed(2)}`).join(`
`);de.unshift({hash:v,author:T,date:b,msg:a,diff:M}),re.unshift({hash:v,branch:"main",author:T,date:b,msg:a,diff:M});const ee=k.getFile(s);ee&&(ee.content=n),k.registerFile(s,{content:n,meta:{lang:"java"}}),V.clear(),e&&(e.value=""),t&&(t.innerHTML=`<span style="color:var(--success)">✓ Commit 成功: ${v}</span>`),C(`✓ commit ${v} — ${a}`),Ce(),ye(),Le(),Ne(),fe&&F===ve&&je();try{B(()=>Promise.resolve().then(()=>ft).then(E=>{E.markTicketDone?E.markTicketDone("INV-2024-0042"):E.completeVipTicket&&E.completeVipTicket()}),void 0)}catch{}l.setFlag("ch0_vip_fixed",!0),l.setFlag("onboarding_done",!0),setTimeout(()=>{B(()=>Promise.resolve().then(()=>oe).then(E=>{E.setActiveView&&(E.setActiveView("jira"),localStorage.setItem("cc_active_view","jira"))}),void 0).catch(()=>{localStorage.setItem("cc_active_view","jira"),document.querySelectorAll(".view").forEach(E=>E.classList.toggle("active",E.id==="view-jira")),document.querySelectorAll(".taskbar__app").forEach(E=>E.classList.toggle("active",E.dataset.view==="jira"))}),setTimeout(()=>{const E=new CustomEvent("jira:refresh");window.dispatchEvent(E)},100)},400)}function Ws(){C('tip: 在 editor 搜尋 "calculateVipPrice" 找到 VIP 折扣邏輯'),C("tip: 編輯 OrderService.java 後至 Source Control 提交"),C("輸入 help 查看可用指令 · Tab 補全 · ↑↓ 歷史")}function C(e){const t=document.getElementById("vsTerminalHist"),a=document.getElementById("vsTerminal"),s=t||a;if(!s)return;const n=document.createElement("div");n.className="terminal__line",n.textContent=e,s.appendChild(n),t&&(t.scrollTop=t.scrollHeight),a&&(a.scrollTop=a.scrollHeight)}function Gs(e){const t=e.target,a=t.value;if(e.key==="Enter"){const s=a.trim();if(!s)return;$e.push(s),ue=$e.length,C(`➜ ${s}`),Ys(s),t.value="",Vt=""}else if(e.key==="ArrowUp")e.preventDefault(),ue<=0?ue=0:ue--,Vt===""&&$e[ue]!==void 0&&(Vt=a),$e[ue]!==void 0&&(t.value=$e[ue]);else if(e.key==="ArrowDown")e.preventDefault(),ue++,ue>=$e.length?(ue=$e.length,t.value=Vt):t.value=$e[ue];else if(e.key==="Tab"){e.preventDefault();const s=Js(a);s&&(t.value=s)}}function Js(e){const t=["help","ls","cat ","grep ","git log","git diff","git blame","clear","echo "],a=k.listFiles("/customer-portal").filter(o=>!Ee(o.path)).map(o=>o.path),s=[...t,...a,...a.map(o=>o.split("/").pop())];if(!e)return e;const n=s.find(o=>o.startsWith(e));if(n)return n;const i=e.split(" "),r=i[i.length-1];if(!r)return e;const d=s.find(o=>o.endsWith(r)||o.includes(r));return d?(i[i.length-1]=d.split(" ").pop(),i.join(" ")):e}function Ys(e){const[t,...a]=e.split(/\s+/),s=a.join(" ");switch(t){case"help":C("可用指令: ls [path], cat <file>, grep <keyword>, git log, git diff, git blame <file>, clear, echo <text>"),C("範例: cat /customer-portal/src/main/java/com/nori/OrderService.java");break;case"ls":{const n=a[0]||"/customer-portal";if(n.startsWith("/intranet")||n==="/intranet"){C(`ls: ${n}: 權限不足（內網資料已從 Vizual Studio Code 隱藏）`);break}const i=k.listFiles(n).filter(r=>r.path.startsWith("/customer-portal")&&!Ee(r.path));i.length?i.slice(0,20).forEach(r=>C(r.path)):C(`ls: ${n}: No such directory`),i.length>20&&C(`... ${i.length-20} more`);break}case"cat":{const n=a[0];if(!n){C("cat: 缺少檔案路徑");break}if(n.startsWith("/intranet")){C(`cat: ${n}: 權限不足（內網資料已從 Vizual Studio Code 隱藏，僅顯示官網系統）`);break}if(Ee(n)||Ee("/customer-portal"+(n.startsWith("/")?"":"/")+n)){C(`cat: ${n}: 檔案不存在或尚未解鎖`);break}const i=k.readFile(n)||k.readFile("/customer-portal"+(n.startsWith("/")?"":"/")+n);i==null?C(`cat: ${n}: 檔案不存在或尚未解鎖`):i.split(`
`).slice(0,80).forEach(r=>C(r));break}case"grep":{const n=s||a[0];if(!n){C("grep: 缺少關鍵字");break}const i=k.searchContent(n).filter(r=>r.path.startsWith("/customer-portal")&&!Ee(r.path));i.length?(C(`grep "${n}" 找到 ${i.length} 筆:`),i.slice(0,10).forEach(r=>C(`${r.path}: ${r.snippet.slice(0,80)}...`))):C(`grep: "${n}" 無結果（僅搜尋 customer-portal/file-system 官網系統）`);break}case"git":if(a[0]==="log")de.forEach(n=>{C(`commit ${n.hash} (${n.date}) ${n.author}`),C(`    ${n.msg}`)});else if(a[0]==="diff")de[1].diff.split(`
`).forEach(n=>{C(n)}),C("hint: 點擊 Source Control 右上角的 Git Graph 按鈕查看完整圖像化歷史");else if(a[0]==="blame"){const n=a[1]||F;C(`blame ${n}:`),(Oa[n]||Oa["/customer-portal/src/billing/service.js"]).forEach(i=>C(`${String(i.line).padStart(3)} ${i.commit} ${i.author}`))}else a[0]==="graph"?(vn(),C("→ 已開啟 Git Graph 編輯器分頁")):C("git: 未知子指令，試 help (支援: git log / git diff / git blame / git graph)");break;case"clear":{const n=document.getElementById("vsTerminalHist");n&&(n.innerHTML="");break}case"echo":C(s);break;default:C(`zsh: command not found: ${t} (試 help)`)}}function Ks(){document.addEventListener("keydown",e=>{const t=e.ctrlKey||e.metaKey;if(e.key==="F1"){e.preventDefault();const a=document.getElementById("vsHelpOverlay");a&&(a.style.display=a.style.display==="flex"?"none":"flex");return}if(t&&e.key.toLowerCase()==="p"&&!e.shiftKey)e.preventDefault(),Qs();else if(t&&e.shiftKey&&e.key.toLowerCase()==="f")e.preventDefault(),te="search",Ut(),document.getElementById("vsSearchInput")?.focus();else if(t&&e.shiftKey&&e.key.toLowerCase()==="g")e.preventDefault(),te="scm",Ut();else if(t&&e.shiftKey&&e.key.toLowerCase()==="d")e.preventDefault(),te="debug",Ut();else if(e.key==="Escape"){xt();const a=document.getElementById("vsHelpOverlay");a&&(a.style.display="none");const s=document.getElementById("sonarModal");s&&(s.style.display="none")}else t&&e.key==="/"&&(e.preventDefault(),document.getElementById("vsTerminalInput")?.focus())})}function Qs(){const e=document.getElementById("quickOpen"),t=document.getElementById("quickOpenInput");!e||!t||(e.classList.add("open"),t.value="",t.focus(),fn(""))}function xt(){document.getElementById("quickOpen")?.classList.remove("open")}function fn(e){const t=document.getElementById("quickOpenList");if(!t)return;const a=(e||"").trim().toLowerCase();let s=k.listFiles("/customer-portal").filter(i=>!Ee(i.path)),n=null;if(a.includes(":")){const[i,r]=a.split(":");n=parseInt(r,10),s=s.filter(d=>d.path.toLowerCase().includes(i))}else a&&(s=s.filter(i=>i.path.toLowerCase().includes(a)));if(s=s.slice(0,10),!s.length){t.innerHTML='<div class="quickopen__item muted">無符合檔案 — 試輸入 OrderService / billing</div>';return}t.innerHTML=s.map((i,r)=>`
    <div class="quickopen__item ${r===0?"active":""}" data-path="${i.path}">
      <span>${g(i.path)}</span>
      <span class="quickopen__kbd">${i.path.split(".").pop()}</span>
    </div>
  `).join(""),t.querySelectorAll(".quickopen__item").forEach(i=>{i.addEventListener("click",()=>{pe(i.dataset.path),n&&Zs(n),xt()})})}function Xs(e){if(e.key==="Escape"){xt();return}if(e.key==="Enter"){const t=document.querySelector("#quickOpenList .quickopen__item.active")||document.querySelector("#quickOpenList .quickopen__item");t&&(pe(t.dataset.path),xt());return}if(e.key==="ArrowDown"||e.key==="ArrowUp"){e.preventDefault();const t=[...document.querySelectorAll("#quickOpenList .quickopen__item")];if(!t.length)return;let a=t.findIndex(s=>s.classList.contains("active"));t[a]?.classList.remove("active"),a=e.key==="ArrowDown"?Math.min(a+1,t.length-1):Math.max(a-1,0),a<0&&(a=0),t[a]?.classList.add("active")}}function Zs(e){const t=document.getElementById("vsEditorArea");if(t){const n=t.value.split(`
`);let i=0;for(let r=0;r<Math.min(e-1,n.length);r++)i+=n[r].length+1;t.focus(),t.setSelectionRange(i,i);return}const a=document.getElementById("vsEditor");if(!a)return;const s=a.querySelector(`[data-ln="${e}"]`);s&&s.scrollIntoView({behavior:"smooth",block:"center"})}var ft=ya({addTicket0043:()=>bn,getTickets:()=>ri,markTicketDone:()=>ii,mountJira:()=>wa}),se=[{key:"INV-2024-0017",title:"官網首頁文案顯示錯誤 — Hero 標語與成立年份顯示錯誤",status:"Done",assignee:"Parker",priority:"Medium",points:2,epic:"Frontend",desc:`【問題描述】
...
JQL: sprint = 24 AND status != Done`,comments:[],attachments:[],history:[]},{key:"INV-2020-0003",title:"人力資源系統 — 關閉系統",status:"Done",assignee:"deleted user",priority:"High",points:3,epic:"HR",desc:"人力資源管理系統將遷移到Zero System, 此系統將永久關閉。關閉前需確保所有資料已成功備份到新系統",comments:["deleted user: 已完成關閉"],attachments:[],history:[{from:"To Do",to:"Done",by:"deleted user",at:"2020-02-28"}]}],qt=null,kt="all",St="";function Oe(){try{l.set("jiraTicketsData",JSON.parse(JSON.stringify(se))),l.set("jiraMeta",{activeSwimlane:kt,currentFilter:St}),l.save(!0)}catch{}}function ei(){try{const e=l.get("jiraTicketsData");if(Array.isArray(e)&&e.length){se.length=0;for(const a of e)se.push(a)}else if((l.hasFlag("ch1_event1_triggered")||l.get("jiraTickets")&&l.get("jiraTickets")["INV-2024-0043"])&&!se.some(a=>a.key==="INV-2024-0043")){bn();return}const t=l.get("jiraMeta");if(t&&typeof t=="object"&&(typeof t.activeSwimlane=="string"&&(kt=t.activeSwimlane),typeof t.currentFilter=="string"&&(St=t.currentFilter)),l.hasFlag("ch0_vip_fixed")){const a=se.find(s=>s.key==="INV-2024-0042");a&&a.status!=="Done"&&(a.status="Done")}if(l.hasFlag("ch1_0043_committed")){const a=se.find(s=>s.key==="INV-2024-0043");a&&a.status!=="Done"&&(a.status="Done")}}catch{}}function wa(){ei();const e=document.getElementById("view-jira");e&&(e.innerHTML=`
    <div class="jira">
      <div class="jira__app">
  ...
  `,ti(),He(),document.getElementById("jiraDetailBackdrop")?.addEventListener("click",()=>{document.getElementById("jiraDetail").style.display="none",document.getElementById("jiraDetailBackdrop").style.display="none"}))}function ti(){document.getElementById("jiraSearch")?.addEventListener("input",e=>{St=e.target.value,Oe(),He()}),document.getElementById("jiraAssignee")?.addEventListener("change",e=>{St=document.getElementById("jiraSearch").value,Oe(),He()}),document.getElementById("jiraSwimlane")?.addEventListener("change",e=>{kt=e.target.value,Oe(),He()})}function ai(e){if(!e.trim())return()=>!0;const t=e.split(/\s+AND\s+/i).map(a=>{const s=a.match(/^\s*(status|assignee|key|epic|text|priority)\s*(=|~)\s*"?([^"]+)"?\s*$/i);if(!s){const o=a.toLowerCase().replace(/["']/g,"");return c=>(c.key+c.title+c.desc+c.assignee+c.epic).toLowerCase().includes(o)}const[,n,i,r]=s,d=r.trim().replace(/^"|"$/g,"").toLowerCase();return o=>{const c=n.toLowerCase();let m="";return c==="status"?m=o.status.toLowerCase():c==="assignee"?m=o.assignee.toLowerCase():c==="key"?m=o.key.toLowerCase():c==="epic"?m=o.epic.toLowerCase():c==="priority"?m=o.priority.toLowerCase():c==="text"&&(m=(o.key+" "+o.title+" "+o.desc).toLowerCase()),i==="="?m===d:m.includes(d)}});return a=>t.every(s=>s(a))}function He(){const e=document.getElementById("jiraBoard");if(!e)return;const t=document.getElementById("jiraAssignee")?.value||"",a=ai(St);let s=se.filter(n=>a(n));if(t&&(s=s.filter(n=>n.assignee===t)),kt!=="all"){const n=kt,i={};s.forEach(r=>{const d=r[n]||"未分類";i[d]||(i[d]=[]),i[d].push(r)}),e.innerHTML=Object.entries(i).map(([r,d])=>{const o={"To Do":[],"In Progress":[],Done:[]};return d.forEach(c=>o[c.status]?.push(c)),`
        <div class="jira__swimlane">
          <div class="jira__swimlane-header">Group：${r} (${d.length})</div>
          <div class="jira__board">
            ${Object.entries(o).map(([c,m])=>Ra(c,m)).join("")}
          </div>
        </div>
      `}).join("")||'<div class="muted small" style="padding:12px">無符合條件的票據 — 試 JQL: status = "To Do"</div>'}else{const n={"To Do":[],"In Progress":[],Done:[]};s.forEach(i=>n[i.status]?.push(i)),e.innerHTML=Object.entries(n).map(([i,r])=>Ra(i,r)).join("")}si()}function Ra(e,t){return`
    <div class="jira__col" data-col="${e}">
      ...
      <div class="jira__dropzone" data-col="${e}">
        ${t.map(a=>ni(a)).join("")||'<div class="jira__empty">拖曳至此</div>'}
      </div>
    </div>
  `}function yn(e){return e.key.includes("0042")||e.epic==="Billing"?{cls:"story",icon:"fa-solid fa-bookmark",label:"Story"}:e.epic==="HR"||e.key.includes("0003")?{cls:"task",icon:"fa-solid fa-square-check",label:"Task"}:e.epic==="Frontend"?{cls:"task",icon:"fa-solid fa-square-check",label:"Task"}:e.priority==="High"&&e.status!=="Done"?{cls:"bug",icon:"fa-solid fa-bug",label:"Bug"}:{cls:"story",icon:"fa-solid fa-bookmark",label:"Story"}}function ni(e){const t=yn(e),a=e.priority==="High"?"High":e.priority==="Medium"?"Medium":"Low",s=e.priority==="High"?"fa-solid fa-angle-up":e.priority==="Medium"?"fa-solid fa-equals":"fa-solid fa-angle-down",n=e.assignee?e.assignee.charAt(0).toUpperCase():"?",i=e.assignee==="Casey"?"#0052cc":e.assignee==="Parker"?"#0065ff":e.assignee==="Jessie"?"#6554c0":"#6b778c";return`
  ...
  `}function si(){document.querySelectorAll(".ticket").forEach(e=>{e.addEventListener("dragstart",t=>{qt=e.dataset.key,e.classList.add("dragging"),t.dataTransfer.effectAllowed="move"}),e.addEventListener("dragend",t=>{e.classList.remove("dragging"),qt=null}),e.addEventListener("click",()=>Et(e.dataset.key))}),document.querySelectorAll(".jira__dropzone").forEach(e=>{e.addEventListener("dragover",t=>{t.preventDefault(),e.classList.add("drag-over")}),e.addEventListener("dragleave",()=>{e.classList.remove("drag-over")}),e.addEventListener("drop",t=>{t.preventDefault(),e.classList.remove("drag-over");const a=e.dataset.col;if(!qt)return;const s=se.find(i=>i.key===qt);if(!s||s.status===a)return;const n=s.status;s.status=a,s.history.push({from:n,to:a,by:"你",at:new Date().toISOString().slice(0,10)}),l.set("jiraTickets."+s.key,!0),Oe(),He(),Et(s.key)})})}function Et(e){const t=se.find(o=>o.key===e),a=document.getElementById("jiraDetail"),s=document.getElementById("jiraDetailBackdrop");if(!t||!a)return;l.set("jiraTickets."+e,!0),e==="INV-2024-0042"&&zn("jiua_viewed"),s&&(s.style.display="block"),a.style.display="flex";const n=yn(t),i=t.status==="Done"?"badge--done":t.status==="In Progress"?"badge--inprogress":"badge--todo";a.innerHTML=`
...
${m.snippet}`)})}),a.querySelectorAll("[data-move]").forEach(o=>{o.addEventListener("click",()=>{const c=o.dataset.move,m=t.status;t.status=c,t.history.push({from:m,to:c,by:"你",at:new Date().toISOString().slice(0,10)}),Oe(),He(),Et(e)})}),document.getElementById("jiraAddComment")?.addEventListener("click",()=>{const o=document.getElementById("jiraCommentInput"),c=o?.value.trim();c&&(t.comments.push(`你: ${c}`),o.value="",Oe(),Et(e),He())});function r(){a.style.display="none";const o=document.getElementById("jiraDetailBackdrop");o&&(o.style.display="none")}document.getElementById("jiraDetailClose")?.addEventListener("click",r),document.getElementById("jiraDetailClose2")?.addEventListener("click",r),document.getElementById("jiraCommentInput")?.addEventListener("keydown",o=>{o.key==="Enter"&&(o.preventDefault(),document.getElementById("jiraAddComment")?.click())});const d=o=>{o.key==="Escape"&&(r(),document.removeEventListener("keydown",d))};document.addEventListener("keydown",d)}function ii(e){const t=se.find(s=>s.key===e);if(!t)return!1;if(t.status==="Done")return e==="INV-2024-0042"&&!l.hasFlag("ch0_vip_fixed")&&l.setFlag("ch0_vip_fixed",!0),!0;const a=t.status;return t.status="Done",t.history.push({from:a,to:"Done",by:"Casey",at:new Date().toISOString().slice(0,10)}),l.set("jiraTickets."+e,!0),e==="INV-2024-0042"&&l.setFlag("ch0_vip_fixed",!0),e==="INV-2024-0043"&&l.setFlag("ch1_0043_committed",!0),Oe(),document.getElementById("jiraBoard")&&(He(),Et(e)),!0}function bn(){if(!se.some(e=>e.key==="INV-2024-0043")){se.push({key:"INV-2024-0043",title:"移除內網系統異常網頁的入口",status:"To Do",assignee:"Casey",priority:"Medium",points:2,epic:"internal system",desc:`【問題描述】使用內網系統時進入到異常網頁，移除不明網頁導向
...
const legacyRoutes = { archive: "/internal/portal" ... } // No longer used`}],history:[{from:"—",to:"To Do",by:"Maggie",at:new Date().toISOString().slice(0,10)}]}),Oe(),document.getElementById("jiraBoard")&&window.dispatchEvent(new CustomEvent("jira:ticketAdded",{detail:"INV-2024-0043"}));try{const e=new CustomEvent("jira:refresh");window.dispatchEvent(e)}catch{}}}function ri(){return se}var Ie="";try{Ie="https://script.google.com/macros/s/AKfycbwjzxPakm5HKw4hJGJWw7AZmNZSpVR28QCcxmJr7KPKCSjLcG2_Da7LgBuuGJwVruSU/exec"}catch{}try{typeof window<"u"&&window.__GAS_URL&&(Ie=window.__GAS_URL)}catch{}var oi="https://script.google.com/macros/s/REPLACE_WITH_YOUR_DEPLOY_ID/exec",li="REPLACE_WITH_YOUR_DEPLOY_ID";function yt(e){return e?e.includes(li):!0}function Xe(){try{const e=localStorage.getItem("cc_gas_url")||"";if(e&&e.startsWith("https://")&&!yt(e))return e.trim()}catch{}try{if(typeof window<"u"&&window.__GAS_URL&&window.__GAS_URL.startsWith("https://")&&!yt(window.__GAS_URL))return window.__GAS_URL.trim()}catch{}return Ie&&Ie.startsWith("https://")&&!yt(Ie)?Ie.trim():oi}function _n(e){try{const t=(e||"").trim();t?localStorage.setItem("cc_gas_url",t):localStorage.removeItem("cc_gas_url");try{typeof window<"u"&&(window.__GAS_URL=t)}catch{}}catch{}}function Te(){const e=Xe();return e&&e.startsWith("https://")&&!yt(e)}var Jt="cc_analytics_consent",Va="cc_sid",wn="cc_analytics_queue",xn="cc_game_session",qa="cc_game_session_history";function nt(){try{const e=localStorage.getItem(xn);if(!e)return null;const t=JSON.parse(e);return t&&t.id&&t.startAt?t:null}catch{return null}}function Mt(e){try{localStorage.setItem(xn,JSON.stringify(e))}catch{}}function ci(){try{if(crypto.randomUUID)return"gs_"+crypto.randomUUID().slice(0,8)+"_"+Date.now().toString(36)}catch{}return"gs_"+Math.random().toString(36).slice(2,10)+"_"+Date.now().toString(36)}function tt(){return nt()}function ma(){console.log("[analytics] createNewGameSession");const e=new Date,t=(()=>{try{return l.get("playtime")??0}catch{return 0}})(),a=(()=>{try{return l.get("currentChapter")??0}catch{return 0}})(),s={id:ci(),startAt:e.toISOString(),startAtMs:e.getTime(),startPlaytime:t,lastChapter:a,lastChapterEnterAtPlaytime:t,lastChapterEnterAtMs:e.getTime(),chapterTimes:{},whatsappLog:[],emailLog:[],ended:!1,endedAt:null};Mt(s);try{l.set("__gameSessionId",s.id)}catch{}try{G("session_start",{game_session_id:s.id,game_session_start:s.startAt,chapter:a,playtime:t})}catch{}return s}function ga(){let e=nt();return(!e||e.ended)&&(e=ma()),e}function kn(e){(!e.chapterTimes||typeof e.chapterTimes!="object")&&(e.chapterTimes={})}function Sn(e){try{const t=nt();if(!t||t.ended)return;const a=(()=>{try{return l.get("playtime")??0}catch{return 0}})(),s=Date.now();kn(t);const n=t.lastChapter,i=Math.max(0,a-(t.lastChapterEnterAtPlaytime??a));if(n!=null){const r=String(n);t.chapterTimes[r]=(t.chapterTimes[r]||0)+i}t.lastChapter=e,t.lastChapterEnterAtPlaytime=a,t.lastChapterEnterAtMs=s,Mt(t)}catch{}}function di(e){try{const t=(()=>{try{return l.get("playtime")??0}catch{return 0}})(),a=Date.now();kn(e);const s=e.lastChapter,n=Math.max(0,t-(e.lastChapterEnterAtPlaytime??t));if(s!=null){const i=String(s);e.chapterTimes[i]=(e.chapterTimes[i]||0)+n}e.lastChapterEnterAtPlaytime=t,e.lastChapterEnterAtMs=a}catch{}}function pi({chatId:e,chatName:t,text:a,to:s}){try{const n=nt();if(!n||n.ended)return;const i=(()=>{try{return l.get("playtime")??0}catch{return 0}})(),r={chatId:e||"",chatName:t||e||"",to:s||"",preview:(a||"").slice(0,80),hash:Pt(a||""),len:(a||"").length,body:(a||"").slice(0,500),ts:new Date().toISOString(),playtime:i};n.whatsappLog.push(r),n.whatsappLog.length>100&&(n.whatsappLog=n.whatsappLog.slice(-100)),Mt(n)}catch{}}function ui({title:e,to:t,body:a}){try{const s=nt();if(!s||s.ended)return;const n=(()=>{try{return l.get("playtime")??0}catch{return 0}})(),i={title:e||"",to:(t||"").slice(0,100),preview:(a||"").slice(0,80),hash:Pt(a||""),len:(a||"").length,body:(a||"").slice(0,1e3),ts:new Date().toISOString(),playtime:n};s.emailLog.push(i),s.emailLog.length>50&&(s.emailLog=s.emailLog.slice(-50)),Mt(s)}catch{}}function mi(){try{const e=l.get("readArticles")||[],t=l.get("discoveredFiles")||[],a=l.get("endings")||l.get("unlockedEndings")||[],s=l.get("whatsappSentCount")||0,n=l.get("persistentStats")||{},i=n.readArticles||[],r=n.darkFileCount||0,d=n.whatsappSentCount||0,o=n.searchHistoryCount||0,c=n.flags||{};let m=10;try{const h=window.__vfs||null;if(h&&h.listDarkFiles){const $=h.listDarkFiles("/darknet");$.length&&(m=$.length)}}catch{}const p=[...new Set([...e,...i])],u=Math.max(s,d),f=Math.max((l.get("searchHistory")||[]).length,o),v=[...new Set([...a,...l.get("unlockedEndings")||[],...n.unlockedEndings||[]])],b=["https://sawyer-blog.example/2001-10-18","https://sawyer-blog.example/2003-04-27","https://sawyer-blog.example/2004-11-13","https://sawyer-blog.example/2006-09-01","https://sawyer-blog.example/2007-01-11","https://sawyer-blog.example/2007-01-12","https://sawyer-blog.example/2010-06-06","https://sawyer-blog.example/2012-07-07","https://sawyer-blog.example/2013-01-01","https://sawyer-blog.example/2023-04-25","https://sawyer-blog.example/2023-05-01","https://sawyer-blog.example/2023-05-10","https://sawyer-blog.example/2023-12-20","https://sawyer-blog.example/2024-01-15","https://sawyer-blog.example/2024-03-20"],T=["https://school.example/guangzhi-essay-sawyer"],M=["https://news.example/car-accident-2023","https://news.example/car-accident-investigation-2023","https://news.example/ping-wo-suspicious-man-2023","https://news.example/police-clarification-2023"],ee=[...b,...T,...M],E=[...b,"https://mary-blog.example/kyoto-sakura-2024","https://mary-blog.example/one-person-kitchen","https://mary-blog.example/danshari-half-year","https://peter-blog.example/python-one-year","https://peter-blog.example/vim-vs-vscode","https://peter-blog.example/nas-ds220","https://peter-blog.example/code-easter-eggs","https://paul-blog.example/tainan-beef-soup","https://paul-blog.example/hand-drip-coffee","https://paul-blog.example/keelung-night-market","https://emma-blog.example/contax-t2-taipei","https://emma-blog.example/iceland-aurora","https://david-blog.example/vinyl-jazz-20","https://david-blog.example/livehouse-map"],_=Math.max(t.filter(h=>h.startsWith("/darknet")).length,r),w=[{id:"secret_entry",title:"解鎖秘密入口",total:2,current:Math.max(l.hasFlag("portal_simple_entered")?1:0,c.portal_simple_entered?1:0)+Math.max(l.hasFlag("portal_hash_entered")?1:0,c.portal_hash_entered?1:0)},{id:"boss_whisper",title:"老闆知音",total:20,current:ee.filter(h=>p.includes(h)).length},{id:"too_much",title:"你知道得太多了",total:m,current:Math.min(_,m)},{id:"all_endings",title:"作者感謝您",total:5,current:v.length},{id:"social",title:"社牛",total:10,current:Math.min(u,10)},{id:"reader",title:"閱讀達人",total:29,current:E.filter(h=>p.includes(h)).length},{id:"miracle",title:"你沒有被解僱是奇蹟",total:1,current:Math.max(l.hasFlag("sawyer_abuse_sent")?1:0,c.sawyer_abuse_sent?1:0)},{id:"net_addict",title:"網路成癮",total:50,current:Math.min(f,50)}],y=w.filter(h=>h.current>=h.total).map(h=>({id:h.id,title:h.title}));return{gained:y,all:w.map(h=>({id:h.id,title:h.title,done:h.current>=h.total,progress:`${h.current}/${h.total}`,pct:Math.round(h.current/h.total*100)})),gainedIds:y.map(h=>h.id)}}catch{return{gained:[],all:[],gainedIds:[]}}}function En(e){const t=nt()||ga();di(t);const a=new Date,s=(()=>{try{return l.get("playtime")??0}catch{return 0}})(),n=Math.max(0,s-(t.startPlaytime||0)),i=Math.max(0,Math.floor((a.getTime()-(t.startAtMs||a.getTime()))/1e3)),r=mi(),d=(()=>{try{return l.get("endings")||[]}catch{return[]}})();let o=Array.isArray(t.whatsappLog)?[...t.whatsappLog]:[];if(!o.length)try{const c=l.get("whatsappChats");if(Array.isArray(c)){const m=[];for(const p of c)for(const u of p.messages||[])u.from==="you"&&m.push({chatId:p.id,chatName:p.name,preview:(u.text||"").slice(0,80),len:(u.text||"").length,ts:u.ts?new Date(u.ts).toISOString():new Date().toISOString(),body:(u.text||"").slice(0,500)});m.length&&(o=m.slice(-100))}}catch{}return{game_session_id:t.id,game_session_start:t.startAt,game_session_end:a.toISOString(),ending:e||"",endings:d.join(","),total_time_sec:n,wall_time_sec:i,playtime:s,chapter_times_sec:t.chapterTimes||{},whatsapp_records:o,whatsapp_count:o.length,email_records:Array.isArray(t.emailLog)?[...t.emailLog]:[],email_count:(t.emailLog||[]).length,achievements_gained:r.gained,achievements_gained_ids:r.gainedIds,achievements_all:r.all,lang:(()=>{try{return l.get("settings.language")||"zh-TW"}catch{return"zh-TW"}})(),chapter:(()=>{try{return l.get("currentChapter")??0}catch{return 0}})()}}function In(e){try{const t=nt();if(!t||t.ended)return;const a=En(e),s=new Date;t.ended=!0,t.endedAt=s.toISOString(),t.lastEnding=e||"";try{const i=localStorage.getItem(qa),r=i?JSON.parse(i):[];r.push({id:t.id,ending:e,endedAt:t.endedAt,total_time_sec:a.total_time_sec}),localStorage.setItem(qa,JSON.stringify(r.slice(-20)))}catch{}Mt(t);const n=JSON.stringify(a);if(G("session_end",{game_session_id:a.game_session_id,game_session_start:a.game_session_start,game_session_end:a.game_session_end,ending:a.ending,endings:a.endings,total_time_sec:a.total_time_sec,wall_time_sec:a.wall_time_sec,chapter_times_sec:JSON.stringify(a.chapter_times_sec),whatsapp_count:a.whatsapp_count,email_count:a.email_count,achievements_gained:a.achievements_gained_ids.join(","),payload_json:n.slice(0,4e3)}),n.length>4e3){const i={game_session_id:a.game_session_id,part:2,whatsapp_records:JSON.stringify(a.whatsapp_records).slice(0,3800),email_records:JSON.stringify(a.email_records).slice(0,3800)};setTimeout(()=>G("session_end_part2",{game_session_id:a.game_session_id,payload_json:JSON.stringify(i).slice(0,4e3)}),800)}}catch(t){console.warn("[analytics] sendSessionEnd failed",t)}}function Re(){try{return localStorage.getItem(Jt)==="1"}catch{return!1}}function Wt(e){try{e?localStorage.setItem(Jt,"1"):localStorage.setItem(Jt,"0")}catch{}e&&setTimeout(()=>Ze(),500)}function Cn(){try{const e=localStorage.getItem(Jt);return e==="1"||e==="0"}catch{return!1}}function bt(){try{let e=localStorage.getItem(Va);return e||(e=crypto.randomUUID&&crypto.randomUUID()||"sid_"+Date.now()+"_"+Math.random().toString(36).slice(2,9),localStorage.setItem(Va,e)),e}catch{return"anon_"+Date.now()}}function Pt(e){if(!e)return"";let t=5381;for(let a=0;a<e.length;a++)t=(t<<5)+t^e.charCodeAt(a);return(t>>>0).toString(16).padStart(8,"0")}function gi(){let e=0,t=0,a="zh-TW";try{e=l.get("currentChapter")??0}catch{}try{t=l.get("playtime")??0}catch{}try{a=l.get("settings.language")||"zh-TW"}catch{}return{chapter:e,playtime:t,lang:a}}function Ye(){try{const e=localStorage.getItem(wn);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t:[]}catch{return[]}}function Ke(e){try{localStorage.setItem(wn,JSON.stringify(e.slice(-50)))}catch{}}function Ze(){if(!Te()||!Re())return;const e=Ye();if(!e.length)return;const t=e.slice(0,10);Ke(e.slice(10)),t.forEach(a=>Ln(a,!0))}function Ln(e,t=!1){const a=Xe();if(console.log(`url : ${a}`),!Te()){console.warn("[analytics] GAS_URL 未設定，跳過上報",e);return}if(!Re()){if(!t){const n=Ye();n.push(e),Ke(n)}return}const s=JSON.stringify(e);try{if(navigator.sendBeacon){const n=new Blob([s],{type:"text/plain;charset=utf-8"});if(navigator.sendBeacon(a,n))return}}catch{}try{fetch(a,{method:"POST",headers:{"Content-Type":"text/plain;charset=utf-8"},body:s,keepalive:!0,redirect:"follow",mode:"cors"}).then(n=>{if(!n.ok)throw new Error("GAS status "+n.status);t||setTimeout(()=>Ze(),1e3)}).catch(n=>{if(console.warn("[analytics] 發送失敗，已入隊重試",n),t){const i=Ye();i.unshift(e),Ke(i)}else{const i=Ye();i.push(e),Ke(i)}})}catch{const i=Ye();i.push(e),Ke(i)}}function G(e,t={}){const a=gi(),s=bt(),n={timestamp:new Date().toISOString(),session_id:s,event_type:e,chapter:a.chapter,playtime:a.playtime,lang:a.lang,ua:typeof navigator<"u"?navigator.userAgent.slice(0,200):"",url:typeof location<"u"?location.href.slice(0,300):"",...t};if(n.payload_json&&typeof n.payload_json=="string"&&n.payload_json.length>4e3&&(n.payload_json=n.payload_json.slice(0,4e3)),!Re()){const i=Ye();i.push(n),Ke(i);return}if(!Te()){const i=Ye();i.push(n),Ke(i),console.warn("[analytics] 已記錄至本地隊列，待設定 GAS_URL 後自動上報",n);return}Ln(n)}function na({chatId:e,chatName:t,text:a,to:s}){try{pi({chatId:e,chatName:t,text:a,to:s})}catch{}const n=(a||"").slice(0,80),i=Pt(a||""),r=(()=>{try{return tt()}catch{return null}})();G("whatsapp_send",{game_session_id:r?r.id:"",whatsapp_chat_id:e,whatsapp_chat_name:t||e,whatsapp_to:s||"",whatsapp_preview:n,whatsapp_hash:i,whatsapp_len:(a||"").length,payload_json:JSON.stringify({chatId:e,preview:n,len:(a||"").length,game_session_id:r?r.id:""})})}function hi({title:e,to:t,body:a}){try{ui({title:e,to:t,body:a})}catch{}const s=(a||"").slice(0,80),n=Pt(a||""),i=(()=>{try{return tt()}catch{return null}})();G("email_submit",{game_session_id:i?i.id:"",email_title:e||"",email_to:(t||"").slice(0,100),email_body_preview:s,email_body_hash:n,email_body_len:(a||"").length,payload_json:JSON.stringify({title:e,preview:s,len:(a||"").length,game_session_id:i?i.id:""})})}function Tn(e){const t=(()=>{try{return tt()}catch{return null}})();G("ending_unlocked",{game_session_id:t?t.id:"",ending:e,endings:(l.get("endings")||[]).join(","),payload_json:JSON.stringify({ending:e,all:l.get("endings"),game_session_id:t?t.id:""})});try{In(e)}catch{}}function vi(e){try{Sn(e)}catch{}const t=(()=>{try{return tt()}catch{return null}})();G("chapter_changed",{game_session_id:t?t.id:"",chapter:e,payload_json:JSON.stringify({chapter:e,game_session_id:t?t.id:""})})}function fi(){try{const e=localStorage.getItem("cc_gas_url")||"";e&&yt(e)&&localStorage.removeItem("cc_gas_url")}catch{}try{ga()}catch{}try{l.on("change",e=>{if(e&&e.path==="currentChapter")try{Sn(e.value)}catch{}})}catch{}try{l.on("reset",()=>{try{ma()}catch{}})}catch{}try{window.__analytics={track:G,getConsent:Re,setConsent:Wt,getGasUrl:Xe,setGasUrl:_n,isGasConfigured:Te,flushQueue:Ze,hashText:Pt,ENV_GAS_URL:Ie||"(empty)",getGameSession:tt,createNewGameSession:ma,ensureGameSession:ga,collectSessionData:En,sendSessionEnd:In,getSessionId:bt}}catch{}try{const e=(()=>{try{return tt()}catch{return null}})();console.log("[analytics] init",{hasConsent:Re(),hasChoice:Cn(),gasConfigured:Te(),gasUrl:Xe().slice(0,60)+(Xe().length>60?"...":""),envGasUrl:Ie?Ie.slice(0,30)+"...":"(empty - 需要在 build 時注入 VITE_GAS_URL)",localStorageUrl:typeof localStorage<"u"&&localStorage.getItem("cc_gas_url")?"已設定":"(empty)",gameSession:e?{id:e.id,startAt:e.startAt,chapterTimes:e.chapterTimes,whatsapp:(e.whatsappLog||[]).length,email:(e.emailLog||[]).length}:null}),Te()||console.warn(`[analytics] GAS_URL 未設定 → 請用以下任一方式設定:
  1) 遊戲內 設定 → 數據追蹤 貼上 URL (立即生效)
  2) 瀏覽器 Console: localStorage.setItem("cc_gas_url","你的exec URL"); location.reload()
  3) GitHub Secrets VITE_GAS_URL (需透過 workflow 在 build 時注入，見 gas/README.md)`)}catch{}setTimeout(()=>Ze(),1500);try{window.addEventListener("online",()=>Ze())}catch{}}var ce=ya({closeWaLightbox:()=>Gt,getChats:()=>Ii,markNoriAllRead:()=>Sa,mountWhatsApp:()=>An,openChat:()=>at,openWaLightbox:()=>Pn,startSawyerRevertSeq:()=>Ci,triggerCh1Event1:()=>Si,triggerCh1Event2:()=>Kt,triggerCh2LunchSequence:()=>Ea}),j=[{id:"nori-all",name:"Nori 全體",avatar:"🏢",desc:"Nori 全體員工群組",members:["Sawyer","Casey","Maggie","Taylor","Aiko","all"],preview:"Leo:謝謝安排！",locked:!1,pinned:!0,muted:!1,archived:!1,unread:0,lastTime:"2023-06-15",messages:[{id:"m1",from:"Sawyer",text:"各位同事，好消息！我中了六合彩二獎，決定將獎金全數投入公司資金，一起加油！",time:"2023-06-15",read:"read",type:"text"},{id:"m2",from:"Taylor",text:"恭喜老闆！祝以後都順順利利！",time:"2023-06-15",read:"read",type:"text"},{id:"m3",from:"Aiko",text:"太棒了！老闆威武！",time:"2023-06-15",read:"read",type:"text"},{id:"m4",from:"Maggie",text:"恭喜老闆！",time:"2023-06-15",read:"read",type:"text"},{id:"m5",from:"Parker",text:"運也太好了吧？！",time:"2023-06-15",read:"read",type:"text"},{id:"m6",from:"Sawyer",text:"各位同事，告訴大家一個好消息，剛跟可樂樂公司談成一大生意，結為長期合作伙伴。為慶祝近來公司發展順利，決定舉辦晚上派對，詳細資訊稍後公布！",time:"2023-11-01",read:"read",type:"text"},{id:"m7",from:"Aiko",text:"哇！！太好了，一定會去！",time:"2023-11-01",read:"read",type:"text"},{id:"m8",from:"Taylor",text:"太棒了！",time:"2023-11-01",read:"read",type:"text"},{id:"m9",from:"Maggie",text:"恭喜老闆！",time:"2023-11-01",read:"read",type:"text"},{id:"m10",from:"Hugo",text:"一輩子跟隨您！",time:"2023-11-01",read:"read",type:"text"},{id:"m11",from:"Taylor",text:`各位同事，慶祝公司發展順利, 將於11月22日下班後舉辦派對
以下為詳細資訊：
日期：11月22日（五） 
時間：19:00-23:00
...
commit => 提交變更
revert => 撤銷變更
查看Git Graph => 列表形式展示所有變更記錄`,time:"2024-07-15",read:"read",type:"text"},{id:"m13",from:"Maggie",text:"",media:"/arg-game-it-company-secret/assets/data/files/wts/sourceControlPage.png",time:"2024-07-15",read:"read",type:"image"},{id:"m14",from:"Maggie",text:"",media:"/arg-game-it-company-secret/assets/data/files/wts/sourceControlPage-revert.png",time:"2024-07-15",read:"read",type:"image"},{id:"m15",from:"Maggie",text:"如果修改有誤的話，提交時結果會經過檢查，然後報錯，這時候就要重新修改",time:"2024-07-15",read:"read",type:"text"},{id:"m0",from:"Maggie",text:"Hi @Casey, 有新的工單INV-2024-0042, 請協助處理一下。詳細資訊在Jiua可以找到, 有問題再找我。",time:"今天",read:"delivered",type:"text"}]},{id:"dev-team",name:"Dev Team",avatar:"👩‍💻",desc:"Nori網站和內網的開發團隊群組",members:["Maggie","Casey","pm","Taylor","ops"],preview:"",locked:!1,pinned:!0,muted:!1,archived:!1,unread:0,lastTime:"2024-07-15",messages:[]},{id:"lunch-team",name:"午餐小隊",avatar:"🍽️",desc:"午餐小隊",members:["Parker","Grace","Hugo","Alex","Casey"],preview:"Alex: 好啊！",locked:!1,pinned:!1,muted:!1,archived:!1,unread:0,lastTime:"2024-09-01",messages:[{id:"m1",from:"Hugo",text:"大新聞！聽說老闆父母車禍身亡了！",time:"2023-04-29",read:"read",type:"text"},{id:"m2",from:"Parker",text:"？！",time:"2023-04-29",read:"read",type:"text"},{id:"m3",from:"Grace",text:"真的嗎？太難過了",time:"2023-04-29",read:"read",type:"text"},{id:"m4",from:"Hugo",text:"對啊，所以才請了一個禮拜假吧",time:"2023-04-29",read:"read",type:"text"},{id:"m5",from:"Hugo",text:"有人覺得近期的老闆很怪嗎？",time:"2023-10-19",read:"read",type:"text"},{id:"m6",from:"Parker",text:"怎麼說？！",time:"2023-10-19",read:"read",type:"text"},{id:"m7",from:"Alex",text:"變開朗了，也變得愛請客了！",time:"2023-10-19",read:"read",type:"text"},{id:"m8",from:"Grace",text:"對啊，之前都挺嚴肅的",time:"2023-10-19",read:"read",type:"text"},{id:"m9",from:"Hugo",text:"對啊！！！",time:"2023-10-19",read:"read",type:"text"},{id:"m10",from:"Hugo",text:"歡迎Casey！！以後帶你吃附近好吃的！",time:"2024-07-16",read:"read",type:"text"},{id:"m11",from:"Parker",text:"歡迎歡迎",time:"2024-07-16",read:"read",type:"text"},{id:"m12",from:"Grace",text:"歡迎~",time:"2024-07-16",read:"read",type:"text"},{id:"m13",from:"Alex",text:"歡迎~~",time:"2024-07-16",read:"read",type:"text"},{id:"m14",from:"Hugo",text:"今天要吃米當當嗎？",time:"2024-09-01",read:"read",type:"text"},{id:"m15",from:"Alex",text:"好啊",time:"2024-09-01",read:"read",type:"text"}]}],q="dev-team",Yt="",lt="all",ke=!1,ze="",mt="chat",Ue=!0,Q=0,xa=!1;function H(){try{const e=j.map(t=>({id:t.id,name:t.name,avatar:t.avatar,desc:t.desc,members:t.members,preview:t.preview,lastTime:t.lastTime,unread:t.unread,pinned:t.pinned,muted:t.muted,archived:t.archived,messages:t.messages}));l.set("whatsappChats",e),l.set("whatsappMeta",{activeId:q,ch1Event1Triggered:De,ch1Event2Triggered:Ve,sawyerSeq:Q,sawyerSeqLocked:xa}),l.save(!0)}catch{}}function sa(e,t){try{l.incrementWhatsappSent()}catch{}try{const a=(t||"").toLowerCase(),s=["rubbish","垃圾","dumb","笨","蠢","stupid","傻","笨蛋","白癡","idiot","fool","傻瓜","die","dead","死","shit","fuck","屎"],n=e==="sawyer",i=s.some(r=>a.includes(r.toLowerCase()));n&&i&&l.setFlag("sawyer_abuse_sent",!0)}catch{}}function It(e){try{const t=j.find(a=>a.id===e);return!!(t&&t.muted)}catch{return!1}}function yi(e){return e.time==="剛剛"&&(e.time="今天"),e}function za(e){const t=Date.now();e.messages.forEach((a,s)=>{if(yi(a),typeof a.ts!="number")if(/^\d{4}-\d{2}-\d{2}$/.test(a.time))a.ts=new Date(a.time+"T00:00:00").getTime()+s*10;else if(a.time&&a.time.includes(":")){const n=new Date().toISOString().slice(0,10),i=new Date(n+"T"+a.time).getTime();a.ts=Number.isNaN(i)?t-(e.messages.length-s)*1e3:i+s}else a.ts=t-(e.messages.length-s+10)*1e3}),e.lastTime==="剛剛"&&(e.lastTime="今天")}function bi(){try{const e=l.get("whatsappChats");if(Array.isArray(e)&&e.length){for(const n of e){const i=j.find(r=>r.id===n.id);i&&(i.messages=Array.isArray(n.messages)?n.messages:i.messages,i.preview=n.preview??i.preview,i.lastTime=n.lastTime??i.lastTime,i.unread=typeof n.unread=="number"?n.unread:i.unread,i.pinned=typeof n.pinned=="boolean"?n.pinned:i.pinned,i.muted=typeof n.muted=="boolean"?n.muted:i.muted,i.archived=typeof n.archived=="boolean"?n.archived:i.archived)}for(const n of e)j.some(i=>i.id===n.id)||j.push(n)}const t=l.get("whatsappMeta");t&&typeof t=="object"&&(t.activeId&&j.some(n=>n.id===t.activeId)&&(q=t.activeId),typeof t.ch1Event1Triggered=="boolean"&&(De=t.ch1Event1Triggered),typeof t.ch1Event2Triggered=="boolean"&&(Ve=t.ch1Event2Triggered),typeof t.sawyerSeq=="number"&&(Q=t.sawyerSeq),typeof t.sawyerSeqLocked=="boolean"&&(xa=t.sawyerSeqLocked)),l.hasFlag("ch1_event1_triggered")&&(De=!0);const a=j.find(n=>n.id==="nori-all");a&&a.messages.some(n=>n.text&&n.text.includes("發財樹"))&&(De=!0,l.hasFlag("ch1_event1_triggered")||l.setFlag("ch1_event1_triggered",!0));const s=j.find(n=>n.id==="maggie");s&&s.messages.some(n=>n.text&&n.text.includes("INV-2024-0043"))&&(Ve=!0);for(const n of j)za(n)}catch{}De&&!l.hasFlag("ch1_event1_triggered")&&l.setFlag("ch1_event1_triggered",!0);try{for(const e of j)za(e)}catch{}}function at(e){if(!j.some(s=>s.id===e))return;q=e;const t=j.find(s=>s.id===e);t&&(t.unread=0),H(),e==="nori-all"&&setTimeout(()=>Sa(),100);const a=document.getElementById("view-whatsapp");a&&a.innerHTML&&(mt="chat",$n(),gt(),Y(q))}function An(){bi();const e=document.getElementById("view-whatsapp");if(e){e.innerHTML=`<div class="wa">
  ...
  </div>`,_i(),gt(),Y(q);try{if(l.get("currentChapter")===2&&!l.hasFlag("ch2_lunch_seq_done")){const t=j.find(a=>a.id==="lunch-team");t&&t.messages.some(a=>a.text&&a.text.includes("剛剛嚇壞了吧"))?l.hasFlag("ch2_lunch_seq_done")||l.setFlag("ch2_lunch_seq_done",!0):setTimeout(()=>{try{Ea()}catch{}},900)}}catch{}}}function _i(){const e=document.getElementById("view-whatsapp");e&&e.querySelectorAll(".wa__sidebar-tab[data-wa-tab]").forEach(t=>{t.addEventListener("click",()=>{const a=t.dataset.waTab;a!==mt&&(mt=a,$n(),gt())})})}function $n(){document.querySelectorAll(".wa__sidebar-tab[data-wa-tab]").forEach(e=>{const t=e.dataset.waTab===mt;e.classList.toggle("active",t),e.setAttribute("aria-selected",t?"true":"false")})}function gt(){mt==="account"?wi():J()}function wi(){const e=document.getElementById("waList");e&&(e.innerHTML=`
  ...
  `)}function _t(e){return!0}function xi(){let e=[...j];if(Yt){const a=Yt.toLowerCase();e=e.filter(s=>s.name.toLowerCase().includes(a)||s.preview.toLowerCase().includes(a)||s.desc.toLowerCase().includes(a))}lt==="unread"?e=e.filter(a=>a.unread>0&&_t(a.id)):lt==="archived"?e=e.filter(a=>a.archived):e=e.filter(a=>!a.archived);const t=["nori-all","dev-team","sawyer","maggie","system-alert","lunch-team"];return e.sort((a,s)=>{const n=t.indexOf(a.id),i=t.indexOf(s.id),r=n===-1?999:n,d=i===-1?999:i;return r!==d?r-d:0}),e}function J(){if(mt!=="chat")return;const e=document.getElementById("waList");if(!e)return;const t=xi();e.innerHTML=`
    <div class="wa__list-header">
      <div class="wa__search"><input id="waSearch" class="input" placeholder="搜尋聊天" value="${Yt}" disabled readonly style="opacity:0.6;pointer-events:none;cursor:not-allowed" title="搜尋已停用" /></div>
      <div class="wa__filters">
        <button class="wa__filter ${lt==="all"?"active":""}" data-tab="all">全部</button>
        <button class="wa__filter ${lt==="unread"?"active":""}" data-tab="unread">未讀</button>
        <button class="wa__filter ${lt==="archived"?"active":""}" data-tab="archived">封存</button>
        <span class="small muted" style="margin-left:auto">${t.length} 對話</span>
      </div>
    </div>
    <div class="wa__list-scroll" id="waListScroll">
      ${t.map(a=>{const s=!_t(a.id);return`<div class="wa__item ${a.id===q?"active":""} ${a.muted?"muted":""}" data-id="${a.id}" style="${s?"opacity:.5":""}">
  ...
  `,e.querySelector("#waSearch")?.addEventListener("input",a=>{Yt=a.target.value,J()}),e.querySelectorAll(".wa__filter").forEach(a=>a.addEventListener("click",()=>{lt=a.dataset.tab,J()})),e.querySelectorAll(".wa__item").forEach(a=>a.addEventListener("click",()=>{if(!_t(a.dataset.id))return;q=a.dataset.id;const s=j.find(n=>n.id===q);s&&(s.unread=0),H(),a.dataset.id==="nori-all"&&setTimeout(()=>Sa(),100),ke=!1,J(),Y(q)})),e.querySelectorAll(".wa__item").forEach(a=>{a.addEventListener("contextmenu",s=>{s.preventDefault();const n=j.find(i=>i.id===a.dataset.id);!n||!_t(n.id)||(n.pinned=!n.pinned,H(),J())})})}function Y(e){const t=document.getElementById("waMessages"),a=t?t.scrollTop:null,s=t?t.scrollHeight:null,n=t?s-a-t.clientHeight<80:!0,i=a===0&&Ue&&t&&s>t.clientHeight+80?!0:n;t&&(Ue=i);const r=j.find(u=>u.id===e),d=document.getElementById("waChat");if(!r||!d)return;if(!_t(e)){d.innerHTML='<div class="view__placeholder"><h2>🔒 未解鎖</h2><div class="muted">先去 Vizual Studio Code 觸發 420.69 隱藏路由</div></div>';return}e==="supplier"&&l.setFlag("found_supplier",!0),e==="backend-team"&&l.setFlag("found_supplier",!0);let o=r.messages;if(ze){const u=ze.toLowerCase();o=o.filter(f=>(f.text||"").toLowerCase().includes(u)||(f.fileName||"").toLowerCase().includes(u))}o=[...o].map((u,f)=>({m:u,idx:f})).sort((u,f)=>{const v=typeof u.m.ts=="number"?u.m.ts:Ua(u.m.time),b=typeof f.m.ts=="number"?f.m.ts:Ua(f.m.time);return v!==b?v-b:u.idx-f.idx}).map(u=>u.m);const c={};o.forEach(u=>{const f=u.time.includes(":")?"今天":u.time;c[f]||(c[f]=[]),c[f].push(u)}),d.innerHTML=`
    ...
    ${(()=>{let u="",f=!1;return e==="sawyer"&&(Q===1?(u="但是我查過這段code已經沒在用才對，所以不是這個問題影響的啊",f=!0):Q===2?(u="",f=!0):Q===3&&(u="但是",f=!0)),`<div class="wa__composer">
      ...
      <input id="waComposerInput" class="input" placeholder="輸入訊息" style="flex:1" value="${g(u)}" ${f?"readonly disabled":""} />
  ...
  `,document.getElementById("waChatHeader")?.addEventListener("click",()=>{ke=!ke,document.getElementById("waInfoPanel")?.classList.toggle("open",ke)}),document.getElementById("waInfoBtn")?.addEventListener("click",u=>{u.stopPropagation(),ke=!ke,document.getElementById("waInfoPanel")?.classList.toggle("open",ke)}),document.getElementById("waInfoClose")?.addEventListener("click",()=>{ke=!1,document.getElementById("waInfoPanel")?.classList.remove("open")}),document.getElementById("waToggleMute")?.addEventListener("click",()=>{r.muted=!r.muted,H(),J(),Y(e)}),document.getElementById("waTogglePin")?.addEventListener("click",()=>{r.pinned=!r.pinned,H(),J(),Y(e)}),document.getElementById("waToggleArchive")?.addEventListener("click",()=>{r.archived=!r.archived,H(),J(),Y(e)}),document.getElementById("waMsgSearchBtn")?.addEventListener("click",()=>{ze="",document.getElementById("waMsgSearchBar").style.display="flex",document.getElementById("waMsgSearchInput")?.focus()}),document.getElementById("waMsgSearchInput")?.addEventListener("input",u=>{ze=u.target.value,Y(e)}),document.getElementById("waMsgSearchClear")?.addEventListener("click",()=>{ze="",Y(e)}),document.getElementById("waExportBtn")?.addEventListener("click",()=>Ga(r)),document.getElementById("waMoreBtn")?.addEventListener("click",()=>Ga(r)),document.getElementById("waSendBtn")?.addEventListener("click",()=>Wa(r)),document.getElementById("waComposerInput")?.addEventListener("keydown",u=>{u.key==="Enter"&&Wa(r)}),document.querySelectorAll("[data-play]").forEach(u=>{u.addEventListener("click",()=>{const f=u.textContent;u.textContent="⏸️",setTimeout(()=>u.textContent=f,1800)})}),document.querySelectorAll("[data-img]").forEach(u=>{u.addEventListener("click",()=>Pn(u.src))}),Mn();try{const u=document.getElementById("waMessages");u&&!u._waScrollBound&&(u._waScrollBound=!0,u.addEventListener("scroll",()=>{const f=u.scrollHeight,v=u.scrollTop,b=u.clientHeight;Ue=f-v-b<80}))}catch{}const m=i,p=a;requestAnimationFrame(()=>{requestAnimationFrame(()=>{const u=document.getElementById("waMessages");if(u)if(m||p===0&&u.scrollHeight>u.clientHeight+20&&Ue)u.scrollTop=u.scrollHeight,Ue=!0,u.scrollTop;else if(p!==null){const f=Math.max(0,u.scrollHeight-u.clientHeight);u.scrollTop=Math.min(p,f),u.scrollTop,Ue=u.scrollHeight-u.scrollTop-u.clientHeight<80}else u.scrollTop=u.scrollHeight,Ue=!0,u.scrollTop})})}function Bn(e){return e?e==="you"||e==="你"?"你":e.trim().charAt(0).toUpperCase():"?"}function Ua(e){if(!e)return 0;if(e==="剛剛"||e==="今天")return Number.MAX_SAFE_INTEGER;if(/^\d{4}-\d{2}-\d{2}$/.test(e))return new Date(e+"T00:00:00").getTime();if(/^\d{1,2}\/\d{1,2}$/.test(e))return new Date("2024/"+e+"T00:00:00").getTime();const t=new Date().toISOString().slice(0,10);try{const a=new Date(t+"T"+e).getTime();return Number.isNaN(a)?Number.MAX_SAFE_INTEGER:a}catch{return Number.MAX_SAFE_INTEGER}}function ka(e){const t=["#1f7aec","#e542a3","#00a884","#ff8c00","#6a5acd","#d93025","#0d9488","#7c3aed"];let a=0;for(let s=0;s<e.length;s++)a=a*31+e.charCodeAt(s)>>>0;return t[a%t.length]}function ki(e,t){const a=e.from==="you",s=a?e.read==="read"?'<span class="bubble__check read">✓✓</span>':e.read==="delivered"?'<span class="bubble__check">✓✓</span>':'<span class="bubble__check">✓</span>':"";let n="";e.type==="image"?n=`<div class="wa__media"><img data-img src="${e.media}" alt="image" /></div>`:e.type==="voice"?n=`<div class="wa__voice"><span class="wa__play" data-play>▶️</span><div class="wa__wave">${Array.from({length:12},(m,p)=>`<span style="height:${8+Math.random()*14}px"></span>`).join("")}</div><span class="small muted">${e.duration}</span></div>`:e.type==="file"&&(n=`<div class="wa__file"><div class="wa__file-icon">📄</div><div style="flex:1;min-width:0"><div style="font-weight:600;font-size:13px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">${g(e.fileName)}</div><div class="small muted">${g(e.fileSize)}</div></div><button class="btn" style="padding:4px 8px">下載</button></div>`);const i=e.text?`<div class="bubble__text">${g(e.text).replace(/\n/g,"<br>")}</div>`:"",r=`<div class="bubble__time">${g(e.time)} ${s}</div>`;if(a)return`<div class="wa__msg-row me">
      <div class="bubble me">${i}${n}${r}</div>
    </div>`;const d=Bn(e.from),o=ka(e.from),c=Array.isArray(t?.members)&&t.members.length>2?`<div class="bubble__sender" style="color:${o}">${g(e.from)}</div>`:"";return`<div class="wa__msg-row other">
    <div class="wa__msg-avatar" style="background:${o}" aria-label="${g(e.from)}" title="${g(e.from)}">${g(d)}</div>
    <div class="bubble other">${c}${i}${n}${r}</div>
  </div>`}function Wa(e){if(e.id==="sawyer"&&Q===1){const n="但是我查過這段code已經沒在用才對，所以不是這個問題影響的啊";e.messages.push({id:"m"+Date.now(),from:"you",text:n,time:"今天",ts:Date.now(),read:"sent",type:"text"}),e.preview=n,e.lastTime="今天",e.unread=0,Q=2,sa(e.id,n);try{na({chatId:e.id,chatName:e.name,text:n,to:"Sawyer"})}catch{}H(),Y(e.id),J(),setTimeout(()=>{if(Q=3,e.messages.push({id:"sawyer-reply2-"+Date.now(),from:"Sawyer",text:"先別管，肯定是這段的影響，已經在影響我工作了",time:"今天",ts:Date.now(),read:"delivered",type:"text"}),e.preview="Sawyer: 先別管，肯定是這段的影響...",e.unread=(e.unread||0)+1,H(),window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"sawyer"}})),Y(e.id),J(),It("sawyer")||q==="sawyer")return;const i=document.createElement("div");i.id="wa-win-notif-sawyer-seq2-"+Date.now(),i.setAttribute("role","alert"),i.innerHTML='<div class="win-notif__app"><img src="/arg-game-it-company-secret/icon/whatsup.svg" alt="WhatUp" width="20" height="20" style="width:20px;height:20px;object-fit:contain" /><span class="win-notif__app-name">WhatUp</span><span class="win-notif__app-sub">Sawyer</span><button class="win-notif__close" aria-label="關閉">✕</button></div><div class="win-notif__body"><div class="win-notif__avatar" style="background:linear-gradient(135deg, #722F37, #8B1A1A)">S</div><div class="win-notif__text"><div class="win-notif__sender">Sawyer</div><div class="win-notif__msg">先別管，肯定是這段的影響，已經在影響我工作了</div><div class="win-notif__time">剛剛</div></div></div><div class="win-notif__progress" style="animation: winNotifShrink 4000ms linear forwards"></div>',i.style.cssText="position:fixed;right:16px;bottom:60px;width:360px;background:#2d2d2d;color:#f0f0f0;border:1px solid rgba(255,255,255,.12);border-radius:8px;box-shadow:0 8px 28px rgba(0,0,0,.45);z-index:1100;overflow:hidden;cursor:pointer;opacity:1;transform:none;",i.addEventListener("click",r=>{r.target.closest(".win-notif__close")||(i.remove(),B(()=>Promise.resolve().then(()=>oe).then(d=>{d.setActiveView&&(d.setActiveView("whatsapp"),localStorage.setItem("cc_active_view","whatsapp"))}),void 0),at("sawyer"))}),i.querySelector(".win-notif__close")?.addEventListener("click",r=>{r.stopPropagation(),i.remove()}),document.body.appendChild(i),setTimeout(()=>i.remove(),4e3)},3e3);return}if(e.id==="sawyer"&&Q===2)return;if(e.id==="sawyer"&&Q===3){e.messages.push({id:"m"+Date.now(),from:"you",text:"但是",time:"今天",ts:Date.now(),read:"sent",type:"text"}),e.preview="但是",e.lastTime="今天",e.unread=0,sa(e.id,"但是");try{na({chatId:e.id,chatName:e.name,text:"但是",to:"Sawyer"})}catch{}H(),Y(e.id),J(),setTimeout(()=>{if(e.messages.push({id:"sawyer-reply3-"+Date.now(),from:"Sawyer",text:"趕快revert！",time:"今天",ts:Date.now(),read:"delivered",type:"text"}),e.preview="Sawyer: 趕快revert！",e.unread=(e.unread||0)+1,Q=4,xa=!1,H(),window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"sawyer"}})),Y(e.id),J(),It("sawyer")||q==="sawyer")return;const i=document.createElement("div");i.id="wa-win-notif-sawyer-seq3-"+Date.now(),i.setAttribute("role","alert"),i.innerHTML='<div class="win-notif__app"><img src="/arg-game-it-company-secret/icon/whatsup.svg" alt="WhatUp" width="20" height="20" style="width:20px;height:20px;object-fit:contain" /><span class="win-notif__app-name">WhatUp</span><span class="win-notif__app-sub">Sawyer</span><button class="win-notif__close" aria-label="關閉">✕</button></div><div class="win-notif__body"><div class="wa__msg-avatar" style="background:linear-gradient(135deg, #722F37, #8B1A1A)">S</div><div class="win-notif__text"><div class="win-notif__sender">Sawyer</div><div class="win-notif__msg">趕快revert！</div><div class="win-notif__time">剛剛</div></div></div><div class="win-notif__progress" style="animation: winNotifShrink 4000ms linear forwards"></div>',i.innerHTML='<div class="win-notif__app"><img src="/arg-game-it-company-secret/icon/whatsup.svg" alt="WhatUp" width="20" height="20" style="width:20px;height:20px;object-fit:contain" /><span class="win-notif__app-name">WhatUp</span><span class="win-notif__app-sub">Sawyer</span><button class="win-notif__close" aria-label="關閉">✕</button></div><div class="win-notif__body"><div class="win-notif__avatar" style="background:linear-gradient(135deg, #722F37, #8B1A1A)">S</div><div class="win-notif__text"><div class="win-notif__sender">Sawyer</div><div class="win-notif__msg">趕快revert！</div><div class="win-notif__time">剛剛</div></div></div><div class="win-notif__progress" style="animation: winNotifShrink 4000ms linear forwards"></div>',i.style.cssText="position:fixed;right:16px;bottom:60px;width:360px;background:#2d2d2d;color:#f0f0f0;border:1px solid rgba(255,255,255,.12);border-radius:8px;box-shadow:0 8px 28px rgba(0,0,0,.45);z-index:1100;overflow:hidden;cursor:pointer;opacity:1;transform:none;",i.addEventListener("click",r=>{r.target.closest(".win-notif__close")||(i.remove(),B(()=>Promise.resolve().then(()=>oe).then(d=>{d.setActiveView&&(d.setActiveView("whatsapp"),localStorage.setItem("cc_active_view","whatsapp"))}),void 0),at("sawyer"))}),i.querySelector(".win-notif__close")?.addEventListener("click",r=>{r.stopPropagation(),i.remove()}),document.body.appendChild(i),setTimeout(()=>i.remove(),4e3)},200);return}const t=document.getElementById("waComposerInput"),a=t?.value.trim();if(!a)return;const s=e.id==="sawyer"&&Q===4;e.messages.push({id:"m"+Date.now(),from:"you",text:a,time:"今天",ts:Date.now(),read:"sent",type:"text"}),e.preview=a,e.lastTime="今天",e.unread=0,t.value="",sa(e.id,a);try{na({chatId:e.id,chatName:e.name,text:a,to:e.name})}catch{}H(),Y(e.id),J()}var De=!1,Ve=!1;function Si(){if(De)return;De=!0,H(),l.setFlag("ch1_event1_triggered",!0);const e=j.find(t=>t.id==="nori-all");e&&setTimeout(()=>{e.messages.push({id:"m-tree-"+Date.now(),from:"Sawyer",text:"聽從風水師建議，已在 Lobby 擺放一棵發財樹擋災，請大家切勿觸碰，否則運氣會散。",time:"今天",ts:Date.now(),read:"delivered",type:"text"}),e.preview="Sawyer: 聽從風水師建議，已在 Lobby 擺放",e.lastTime="今天",e.unread=(e.unread||0)+1,H(),window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"nori-all"}}));const t=document.getElementById("view-whatsapp");if(t&&t.innerHTML&&J(),setTimeout(()=>{e.messages.push({id:"m-tree-img-"+Date.now(),from:"Sawyer",text:"",media:"/arg-game-it-company-secret/assets/data/files/office.png",type:"image",time:"今天",ts:Date.now(),read:"delivered"}),e.preview="Sawyer: [圖片]",e.lastTime="今天",e.unread=(e.unread||0)+1,H(),window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"nori-all"}}));const s=document.getElementById("view-whatsapp");s&&s.innerHTML&&J()},1500),It("nori-all")){setTimeout(()=>{Ve||Kt()},1e4);return}const a=document.createElement("div");a.id="wa-win-notification-sawyer-tree",a.setAttribute("role","alert"),a.innerHTML=`
    ...
    `,a.style.cssText="position:fixed;right:16px;bottom:60px;width:360px;background:#2d2d2d;color:#f0f0f0;border:1px solid rgba(255,255,255,.12);border-radius:8px;box-shadow:0 8px 28px rgba(0,0,0,.45);z-index:1100;overflow:hidden;cursor:pointer;opacity:0;transform:translateY(12px);transition:opacity .28s,transform .28s;",a.addEventListener("click",s=>{s.target.closest(".win-notif__close")||(a.remove(),B(()=>Promise.resolve().then(()=>oe).then(n=>{n.setActiveView&&(n.setActiveView("whatsapp"),localStorage.setItem("cc_active_view","whatsapp"))}),void 0),at("nori-all"))}),a.querySelector(".win-notif__close")?.addEventListener("click",s=>{s.stopPropagation(),a.remove()}),document.body.appendChild(a),requestAnimationFrame(()=>{a.style.opacity="1",a.style.transform="none"}),setTimeout(()=>{a.style.opacity="0",setTimeout(()=>a.remove(),300)},1e4),setTimeout(()=>{Ve||Kt()},1e4)},1e4)}function Kt(){if(Ve)return;Ve=!0,H();const e=j.find(t=>t.id==="maggie");e&&setTimeout(()=>{e.messages.push({id:"m-0043-"+Date.now(),from:"Maggie",text:"Hi @Casey, 有新的工單 INV-2024-0043, 請協助處理一下",time:"今天",ts:Date.now(),read:"delivered",type:"text"}),e.preview="Hi @Casey, 有新的工單 INV-2024-0043",e.lastTime="今天",e.unread=(e.unread||0)+1,H(),window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"maggie"}})),B(()=>Promise.resolve().then(()=>ft).then(s=>{s.addTicket0043&&s.addTicket0043(),document.getElementById("jiraBoard")&&window.dispatchEvent(new CustomEvent("jira:ticketAdded"))}),void 0);const t=document.getElementById("view-whatsapp");if(t&&t.innerHTML&&J(),It("maggie")||q==="maggie")return;const a=document.createElement("div");a.id="wa-win-notification-maggie-0043",a.setAttribute("role","alert"),a.innerHTML=`
      <div class="win-notif__app">
        <img src="/arg-game-it-company-secret/icon/whatsup.svg" alt="WhatUp" width="20" height="20" style="width:20px;height:20px;object-fit:contain" />
        <span class="win-notif__app-name">WhatUp</span>
      ...
      <div class="win-notif__progress"></div>
    `,a.style.cssText="position:fixed;right:16px;bottom:60px;width:360px;background:#2d2d2d;color:#f0f0f0;border:1px solid rgba(255,255,255,.12);border-radius:8px;box-shadow:0 8px 28px rgba(0,0,0,.45);z-index:1100;overflow:hidden;cursor:pointer;opacity:0;transform:translateY(12px);transition:opacity .28s,transform .28s;",a.addEventListener("click",s=>{s.target.closest(".win-notif__close")||(a.remove(),B(()=>Promise.resolve().then(()=>oe).then(n=>{n.setActiveView&&(n.setActiveView("whatsapp"),localStorage.setItem("cc_active_view","whatsapp"))}),void 0),at("maggie"))}),a.querySelector(".win-notif__close")?.addEventListener("click",s=>{s.stopPropagation(),a.remove()}),document.body.appendChild(a),requestAnimationFrame(()=>{a.style.opacity="1",a.style.transform="none"}),setTimeout(()=>{a.style.opacity="0",setTimeout(()=>a.remove(),300)},1e4)},1e4)}function Sa(){j.find(e=>e.id==="nori-all")&&De&&!Ve&&Kt()}var ia=[{from:"Parker",text:"@Casey 剛剛嚇壞了吧 哈哈 估計是你進來以來第一次遇到系統爆炸了"},{from:"Parker",text:"不過說來也奇怪 這個入口應該搬移了才對"},{from:"Parker",text:"啊對了 這裡應該也沒多少人知道 那個原本是HR系統的入口"},{from:"Hugo",text:"對！！那個超難用的 系統不完善沒有適當防呆 他們又常常笨手笨腳刪掉資料 要找我們恢復"},{from:"Parker",text:"對啊 浪費我們人力 老闆就乾脆換系統了"},{from:"Hugo",text:"那為什麼代碼沒有隱藏入口？"},{from:"Parker",text:"不知道欸 這個不能動 一動就會大爆炸"},{from:"Hugo",text:"難不成有人偷用這個系統來偷藏色色的東西！"},{from:"Parker",text:"什麼鬼"}];function Ei(e,t){if(It("lunch-team")||q==="lunch-team")return;const a=ka(e),s=Bn(e),n=document.createElement("div");n.className="win-notif",n.id="wa-win-notif-lunch-"+Date.now()+"-"+Math.random().toString(36).slice(2,6),n.setAttribute("role","alert"),n.innerHTML=`
      <div class="win-notif__app">
        <img src="/arg-game-it-company-secret/icon/whatsup.svg" alt="WhatUp" width="20" height="20" style="width:20px;height:20px;object-fit:contain" />
        <span class="win-notif__app-name">WhatUp</span>
      ...
      <div class="win-notif__body">
        <div class="win-notif__avatar" style="background:${a}">${g(s)}</div>
        <div class="win-notif__text">
  ...
  `,n.style.cssText="position:fixed;right:16px;bottom:60px;width:360px;background:#2d2d2d;color:#f0f0f0;border:1px solid rgba(255,255,255,.12);border-radius:8px;box-shadow:0 8px 28px rgba(0,0,0,.45);z-index:1100;overflow:hidden;cursor:pointer;opacity:0;transform:translateY(12px);transition:opacity .28s,transform .28s;",n.addEventListener("click",i=>{i.target.closest(".win-notif__close")||(n.remove(),B(()=>Promise.resolve().then(()=>oe).then(r=>{r.setActiveView&&(r.setActiveView("whatsapp"),localStorage.setItem("cc_active_view","whatsapp"))}),void 0),at("lunch-team"))}),n.querySelector(".win-notif__close")?.addEventListener("click",i=>{i.stopPropagation(),n.remove()}),document.body.appendChild(n),requestAnimationFrame(()=>{n.style.opacity="1",n.style.transform="none"}),setTimeout(()=>{n.style.opacity="0",n.style.transform="translateY(8px)",setTimeout(()=>n.remove(),300)},4e3)}function Ea(){if(l.hasFlag("ch2_lunch_seq_done"))return;const e=j.find(s=>s.id==="lunch-team");if(!e)return;if(e.messages.some(s=>s.text&&s.text.includes("剛剛嚇壞了吧"))){l.hasFlag("ch2_lunch_seq_done")||l.setFlag("ch2_lunch_seq_done",!0);return}l.setFlag("ch2_lunch_seq_done",!0),H();let t=0;const a=()=>{if(t>=ia.length)return;const{from:s,text:n}=ia[t],i=Date.now();e.messages.push({id:"lunch-ch2-"+i+"-"+t,from:s,text:n,time:"今天",ts:i+t,read:"delivered",type:"text"}),e.preview=`${s}: ${n.slice(0,20)}`,e.lastTime="今天",q!=="lunch-team"?e.unread=(e.unread||0)+1:e.unread=0,H(),window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"lunch-team"}})),Ei(s,n),t+=1,t<ia.length&&setTimeout(a,5e3)};setTimeout(a,800)}function Ga(e){const t=`WhatUp 匯出 — ${e.name}
${e.messages.map(i=>`[${i.time}] ${i.from}: ${i.text||i.fileName||i.type}`).join(`
`)}`,a=new Blob([t],{type:"text/plain"}),s=URL.createObjectURL(a),n=document.createElement("a");n.href=s,n.download=`${e.id}-chat.txt`,n.click(),URL.revokeObjectURL(s)}function Ii(){return j}function Ci(){if(Q!==0)return;Q=1,H();const e=document.getElementById("view-whatsapp");if(e&&e.classList.contains("active")||localStorage.getItem("cc_active_view"),e&&e.innerHTML){try{Y(q)}catch{}try{gt()}catch{}}try{l.setFlag("sawyer_seq_started",!0)}catch{}}var ge=1,rt=0,ot=0,zt=!1,Ja=0,Ya=0,Ka=0,Qa=0;function Mn(){if(document.getElementById("waLightbox"))return;const e=document.createElement("div");e.id="waLightbox",e.className="wa-lightbox",e.setAttribute("aria-hidden","true"),e.innerHTML=`
  ...
  `,document.body.appendChild(e);const t=e.querySelector("#waLightboxImg"),a=e.querySelector("#waLightboxBody"),s=e.querySelector("#waLightboxScale");function n(){t&&(t.style.transform=`translate(${rt}px, ${ot}px) scale(${ge})`,s&&(s.textContent=Math.round(ge*100)+"%"),a.style.cursor=ge>1?zt?"grabbing":"grab":"zoom-in")}function i(c,m,p){ge=Math.max(.5,Math.min(4,c)),ge===1&&(rt=0,ot=0),n()}e.querySelector('[data-wa-zoom="in"]')?.addEventListener("click",()=>i(ge+.25)),e.querySelector('[data-wa-zoom="out"]')?.addEventListener("click",()=>i(ge-.25)),e.querySelector('[data-wa-zoom="reset"]')?.addEventListener("click",()=>{ge=1,rt=0,ot=0,n()}),e.querySelector("#waLightboxClose")?.addEventListener("click",()=>Gt()),e.querySelector("[data-wa-close]")?.addEventListener("click",()=>Gt()),a?.addEventListener("wheel",c=>{c.preventDefault();const m=c.deltaY>0?-.1:.1;i(ge+m)},{passive:!1});function r(c){ge<=1||(zt=!0,t.classList.add("dragging"),Ja=c.clientX,Ya=c.clientY,Ka=rt,Qa=ot,a.setPointerCapture?.(c.pointerId))}function d(c){zt&&(rt=Ka+(c.clientX-Ja),ot=Qa+(c.clientY-Ya),n())}function o(c){zt=!1,t.classList.remove("dragging");try{a.releasePointerCapture?.(c.pointerId)}catch{}}a?.addEventListener("pointerdown",r),a?.addEventListener("pointermove",d),a?.addEventListener("pointerup",o),a?.addEventListener("pointercancel",o),document.addEventListener("keydown",c=>{c.key==="Escape"&&e.classList.contains("open")&&Gt()}),e._updateTransform=n,e._setScale=i}function Pn(e){Mn();const t=document.getElementById("waLightbox"),a=document.getElementById("waLightboxImg");!t||!a||(a.src=e,ge=1,rt=0,ot=0,t._updateTransform?.(),t.classList.add("open"),t.setAttribute("aria-hidden","false"))}function Gt(){const e=document.getElementById("waLightbox");e&&(e.classList.remove("open"),e.setAttribute("aria-hidden","true"))}try{W.on("chapter:changed",e=>{e===2&&setTimeout(()=>{try{Ea()}catch{}},600)})}catch{}typeof window<"u"&&!window.__waListenerBound&&(window.__waListenerBound=!0,window.addEventListener("whatsapp:newMessage",e=>{try{H()}catch{}const t=document.getElementById("view-whatsapp");if(!(!t||!t.innerHTML)){try{gt()}catch{}try{Y(q)}catch{}}}),window.addEventListener("whatsapp:refresh",()=>{const e=document.getElementById("view-whatsapp");if(!(!e||!e.innerHTML)){try{gt()}catch{}try{Y(q)}catch{}}}));var pt=[{title:"Java switch-case 語法詳解 — 基礎教學 (繁中)",url:"https://java-tutorial.example/switch-case",snippet:"【switch 用法】switch 會依變數值跳到對應 case，需搭配 break 避免貫穿。範例：switch(vipLv){ case 1: price *= 0.90; break; case 2: price *= 0.85; break; case 3: price *= 0.80; break; case 4: price *= 0.75; break; case 5: price *= 0.70; break; default: break; } 注意：若缺少 break 會繼續執行下一個 case。常與 if-else 比較，適用於枚舉分級如 VIP 折扣。",type:"web",image:null},{title:"【StackOverflow】VIP 等級折扣用 switch 寫，VIP1 被算成 60% 而不是 50% 該怎麼修？",url:"https://stackoverflow.com/questions/789421/vip-discount-switch-case-wrong-percentage",snippet:`發問：我的 switch(vipLv) 中 case 1 寫成 price*=0.95，但需求是 VIP1 60%、VIP2 65%。已嘗試修改但 Sonar 仍報錯... 
...
`,type:"news",image:null},{title:"那些藏在程式碼裡的小彩蛋：我在小團隊看到的開發者塗鴉 — Peter Lin",url:"https://peter-blog.example/code-easter-eggs",snippet:"待過幾間中小企業後發現，只要沒有嚴格的 code quality 流程，程式碼裡總會冒出一些跟公司或產品完全無關的東西——註解裡的粗口、對工作的抱怨、整段國歌歌詞，甚至藏得很深的小遊戲。我對這些小彩蛋的看法是：只要不影響功能與效能，算是工作中找到的小樂趣。 — Peter Lin",type:"web",image:"https://picsum.photos/seed/codeeggs/600/400"},{title:"給完全不懂程式的人：MD5 是什麼？把一句話變成一串亂碼的小魔法 — Peter Lin",url:"https://peter-blog.example/md5-for-beginners",snippet:"完全不懂程式也看得懂。MD5 就像一台指紋機：你丟一句話進去，它永遠吐出 32 個字由 0-9、a-f 組成的亂碼。同樣輸入永遠得到同樣輸出，改一個字結果就完全不同。例如 hello → 5d41402abc4b2a76b9719d911017c592，平常看到的 ?hash=be78e754... 就是典型例子。— Peter Lin",type:"web",image:"https://picsum.photos/seed/md5/600/400"}],jn={sawyer:{id:"sawyer",name:"Sawyer Choi",handle:"@sawyerchoi",displayName:"Sawyer Choi / 蔡梓掦",bio:"喜歡把日常小事寫成文字的人。從2001年開始在 BlogWorld 記錄生活，覺得能把想法寫下來，好像就能更理解自己一點。",avatar:"/arg-game-it-company-secret/lemon_tea.jpg",cover:"/arg-game-it-company-secret/lemon_tea.jpg",followers:842,following:37,joined:"2001-10-01",verified:!1},mary:{id:"mary",name:"Mary Chen",handle:"@marychen",displayName:"Mary Chen · 陳曉玲",bio:"旅遊 × 攝影 × 生活手帳。走過 27 個城市，喜歡在咖啡香裡寫明信片。",avatar:"https://i.pravatar.cc/150?u=mary",cover:"https://picsum.photos/seed/marycover/900/240",followers:12430,following:210,joined:"2018-03-12",verified:!0},peter:{id:"peter",name:"Peter Lin",handle:"@peterlin",displayName:"Peter Lin · 林柏安",bio:"後端工程師 / 開源愛好者。分享 Python、NAS、自架服務與踩坑筆記。",avatar:"https://i.pravatar.cc/150?u=peter",cover:"https://picsum.photos/seed/petercover/900/240",followers:8930,following:96,joined:"2019-07-20",verified:!0},paul:{id:"paul",name:"Paul Wang",handle:"@paulwang",displayName:"Paul Wang · 王志豪",bio:"台南胃、台北心。專門挖掘巷弄美食與手沖咖啡，記錄每一口幸福。",avatar:"https://i.pravatar.cc/150?u=paul",cover:"https://picsum.photos/seed/paulcover/900/240",followers:15600,following:143,joined:"2017-11-05",verified:!0},emma:{id:"emma",name:"Emma Wu",handle:"@emmaw",displayName:"Emma Wu · 吳思敏",bio:"底片攝影 / 極地旅人。想用快門留住光線的溫度。",avatar:"https://i.pravatar.cc/150?u=emma",cover:"https://picsum.photos/seed/emmacover/900/240",followers:6720,following:78,joined:"2020-01-18",verified:!1},david:{id:"david",name:"David Chang",handle:"@davidchang",displayName:"David Chang · 張大衛",bio:"黑膠收藏家 / Live House 常客。寫音樂，也寫城市的聲音。",avatar:"https://i.pravatar.cc/150?u=david",cover:"https://picsum.photos/seed/davidcover/900/240",followers:4210,following:52,joined:"2019-09-03",verified:!1}},ae=[{url:"https://sawyer-blog.example/2001-10-18",title:"Sawyer Choi — 2001-10-18",excerpt:"今天和好多朋友一起玩，大家都玩得很開心。我把自己的食物分給大家吃，他們笑得很開心。",content:`2001-10-18
...
<p>除錯技巧：在 <code>vite.config.js</code> 設 <code>publicDir</code> 或用 <code>console.log(import.meta.env)</code> 印出所有 <code>VITE_</code> 變數。</p>`}],commentsQ:[{user:"發問者",text:"原來只有 VITE_ 才會到前端，難怪 DATABASE_URL 一直 undefined",time:"2024-08-12 12:30"},{user:"路人",text:"推，之前把 MD5_KEY 放 VITE_ 被老師罵",time:"2024-08-13 08:20"}]}};function Ai(e){return e&&e.includes("stackoverflow.com")&&Dn[e]}function $i(e){return Dn[e]||null}function Bi(e){function t(I,S){return I<<S|I>>>32-S}function a(I,S){var A,P,D=I&2147483648,O=S&2147483648,R;return A=I&1073741824,P=S&1073741824,R=(I&1073741823)+(S&1073741823),A&P?R^2147483648^D^O:A|P?R&1073741824?R^3221225472^D^O:R^1073741824^D^O:R^D^O}function s(I,S,A){return I&S|~I&A}function n(I,S,A){return I&A|S&~A}function i(I,S,A){return I^S^A}function r(I,S,A){return S^(I|~A)}function d(I,S,A,P,D,O,R){return I=a(I,a(a(s(S,A,P),D),R)),a(t(I,O),S)}function o(I,S,A,P,D,O,R){return I=a(I,a(a(n(S,A,P),D),R)),a(t(I,O),S)}function c(I,S,A,P,D,O,R){return I=a(I,a(a(i(S,A,P),D),R)),a(t(I,O),S)}function m(I,S,A,P,D,O,R){return I=a(I,a(a(r(S,A,P),D),R)),a(t(I,O),S)}function p(I){for(var S,A=I.length,P=A+8,D=((P-P%64)/64+1)*16,O=Array(D-1),R=0,xe=0;xe<A;)S=(xe-xe%4)/4,R=xe%4*8,O[S]=O[S]|I.charCodeAt(xe)<<R,xe++;return S=(xe-xe%4)/4,R=xe%4*8,O[S]=O[S]|128<<R,O[D-2]=A<<3,O[D-1]=A>>>29,O}function u(I){var S="",A="",P,D;for(D=0;D<=3;D++)P=I>>>D*8&255,A="0"+P.toString(16),S=S+A.substr(A.length-2,2);return S}function f(I){I=I.replace(/\r\n/g,`
`);for(var S="",A=0;A<I.length;A++){var P=I.charCodeAt(A);P<128?S+=String.fromCharCode(P):P>127&&P<2048?(S+=String.fromCharCode(P>>6|192),S+=String.fromCharCode(P&63|128)):(S+=String.fromCharCode(P>>12|224),S+=String.fromCharCode(P>>6&63|128),S+=String.fromCharCode(P&63|128))}return S}var v=Array(),b,T,M,ee,E,_,w,y,h,$=7,L=12,z=17,_e=22,st=5,qe=9,N=14,Ae=20,we=4,jt=11,Dt=16,Ft=23,Nt=6,Ot=10,Ht=15,Rt=21;for(e=f(e),v=p(e),_=1732584193,w=4023233417,y=2562383102,h=271733878,b=0;b<v.length;b+=16)T=_,M=w,ee=y,E=h,_=d(_,w,y,h,v[b+0],$,3614090360),h=d(h,_,w,y,v[b+1],L,3905402710),y=d(y,h,_,w,v[b+2],z,606105819),w=d(w,y,h,_,v[b+3],_e,3250441966),_=d(_,w,y,h,v[b+4],$,4118548399),h=d(h,_,w,y,v[b+5],L,1200080426),y=d(y,h,_,w,v[b+6],z,2821735955),w=d(w,y,h,_,v[b+7],_e,4249261313),_=d(_,w,y,h,v[b+8],$,1770035416),h=d(h,_,w,y,v[b+9],L,2336552879),y=d(y,h,_,w,v[b+10],z,4294925233),w=d(w,y,h,_,v[b+11],_e,2304563134),_=d(_,w,y,h,v[b+12],$,1804603682),h=d(h,_,w,y,v[b+13],L,4254626195),y=d(y,h,_,w,v[b+14],z,2792965006),w=d(w,y,h,_,v[b+15],_e,1236535329),_=o(_,w,y,h,v[b+1],st,4129170786),h=o(h,_,w,y,v[b+6],qe,3225465664),y=o(y,h,_,w,v[b+11],N,643717713),w=o(w,y,h,_,v[b+0],Ae,3921069994),_=o(_,w,y,h,v[b+5],st,3593408605),h=o(h,_,w,y,v[b+10],qe,38016083),y=o(y,h,_,w,v[b+15],N,3634488961),w=o(w,y,h,_,v[b+4],Ae,3889429448),_=o(_,w,y,h,v[b+9],st,568446438),h=o(h,_,w,y,v[b+14],qe,3275163606),y=o(y,h,_,w,v[b+3],N,4107603335),w=o(w,y,h,_,v[b+8],Ae,1163531501),_=o(_,w,y,h,v[b+13],st,2850285829),h=o(h,_,w,y,v[b+2],qe,4243563512),y=o(y,h,_,w,v[b+7],N,1735328473),w=o(w,y,h,_,v[b+12],Ae,2368359562),_=c(_,w,y,h,v[b+5],we,4294588738),h=c(h,_,w,y,v[b+8],jt,2272392833),y=c(y,h,_,w,v[b+11],Dt,1839030562),w=c(w,y,h,_,v[b+14],Ft,4259657740),_=c(_,w,y,h,v[b+1],we,2763975236),h=c(h,_,w,y,v[b+4],jt,1272893353),y=c(y,h,_,w,v[b+7],Dt,4139469664),w=c(w,y,h,_,v[b+10],Ft,3200236656),_=c(_,w,y,h,v[b+13],we,681279174),h=c(h,_,w,y,v[b+0],jt,3936430074),y=c(y,h,_,w,v[b+3],Dt,3572445317),w=c(w,y,h,_,v[b+6],Ft,76029189),_=c(_,w,y,h,v[b+9],we,3654602809),h=c(h,_,w,y,v[b+12],jt,3873151461),y=c(y,h,_,w,v[b+15],Dt,530742520),w=c(w,y,h,_,v[b+2],Ft,3299628645),_=m(_,w,y,h,v[b+0],Nt,4096336452),h=m(h,_,w,y,v[b+7],Ot,1126891415),y=m(y,h,_,w,v[b+14],Ht,2878612391),w=m(w,y,h,_,v[b+5],Rt,4237533241),_=m(_,w,y,h,v[b+12],Nt,1700485571),h=m(h,_,w,y,v[b+3],Ot,2399980690),y=m(y,h,_,w,v[b+10],Ht,4293915773),w=m(w,y,h,_,v[b+1],Rt,2240044497),_=m(_,w,y,h,v[b+8],Nt,1873313359),h=m(h,_,w,y,v[b+15],Ot,4264355552),y=m(y,h,_,w,v[b+6],Ht,2734768916),w=m(w,y,h,_,v[b+13],Rt,1309151649),_=m(_,w,y,h,v[b+4],Nt,4149444226),h=m(h,_,w,y,v[b+11],Ot,3174756917),y=m(y,h,_,w,v[b+2],Ht,718787259),w=m(w,y,h,_,v[b+9],Rt,3951481745),_=a(_,T),w=a(w,M),y=a(y,ee),h=a(h,E);return(u(_)+u(w)+u(y)+u(h)).toLowerCase()}function Mi(e){if(!e)return[];const t=e.toLowerCase(),a=new Set,s=[];return pt.forEach(n=>{n.title.toLowerCase().includes(t)&&!a.has(n.title)&&(a.add(n.title),s.push({text:n.title,kind:n.type}))}),(l.get("searchHistory")||[]).slice(-5).reverse().forEach(n=>{n.q.toLowerCase().includes(t)&&!a.has(n.q)&&(a.add(n.q),s.push({text:n.q,kind:"history"}))}),s.slice(0,8)}function Pi(e){let t=e;const a={site:null,filetype:null,before:null,after:null},s=t.match(/site:([^\s]+)/i);s&&(a.site=s[1].toLowerCase(),t=t.replace(s[0],"").trim());const n=t.match(/filetype:([^\s]+)/i);n&&(a.filetype=n[1].toLowerCase(),t=t.replace(n[0],"").trim());const i=t.match(/before:([^\s]+)/i);i&&(a.before=i[1],t=t.replace(i[0],"").trim());const r=t.match(/after:([^\s]+)/i);return r&&(a.after=r[1],t=t.replace(r[0],"").trim()),{base:t.trim(),filters:a}}function ji(e){return e.toLowerCase().includes("md5")}function Di(e){const t=document.getElementById("md5Tool");if(!t)return;const a=document.getElementById("searchLayout"),s=document.getElementById("searchDetail");a&&(a.style.display="none"),s&&(s.style.display="none",s.innerHTML="",s.classList.remove("open"));let n="";if(e){const p=e.match(/md5\s*(.*)/i);p&&p[1]&&(n=p[1].trim())}t.innerHTML=`
  ...
  `,Ni(),ha(),Oi(),Me(""))}function Ni(){const e=document.getElementById("searchInput"),t=document.getElementById("suggestBox");e?.addEventListener("input",a=>{const s=a.target.value,n=Mi(s);if(!s||!n.length){t.classList.remove("open"),t.innerHTML="";return}t.innerHTML=n.map(i=>`<div class="suggest-item" data-q="${g(i.text)}"><span>${g(i.text)}</span><span class="small">${i.kind}</span></div>`).join(""),t.classList.add("open"),t.querySelectorAll(".suggest-item").forEach(i=>i.addEventListener("click",()=>{e.value=i.dataset.q,t.classList.remove("open"),Me(i.dataset.q)}))}),e?.addEventListener("keydown",a=>{if(a.key==="Enter"&&(document.getElementById("suggestBox")?.classList.remove("open"),Me(a.target.value)),a.key==="Escape"&&document.getElementById("suggestBox")?.classList.remove("open"),a.key==="ArrowDown"){const s=document.querySelector("#suggestBox .suggest-item");s&&(a.preventDefault(),s.classList.add("active"),e.value=s.dataset.q)}}),e?.addEventListener("blur",()=>setTimeout(()=>t?.classList.remove("open"),150)),document.getElementById("searchBtn")?.addEventListener("click",()=>Me(document.getElementById("searchInput").value)),document.querySelectorAll(".chip").forEach(a=>a.addEventListener("click",()=>Me(a.dataset.q))),document.querySelectorAll(".search__tab").forEach(a=>{a.addEventListener("click",()=>{document.querySelectorAll(".search__tab").forEach(s=>s.classList.remove("active")),a.classList.add("active"),le=a.dataset.tab,Me(Ct||"Sawyer")})})}function ha(){const e=document.getElementById("searchHistoryList");if(!e)return;const t=(l.get("searchHistory")||[]).slice(-8).reverse();if(!t.length){e.innerHTML='<div class="small muted">尚無歷史</div>';return}e.innerHTML=t.map(a=>`<div class="history-item" data-q="${g(a.q)}"><span>${g(a.q)}</span><span class="small">${new Date(a.at).toLocaleTimeString("zh-TW",{hour:"2-digit",minute:"2-digit"})}</span></div>`).join(""),e.querySelectorAll(".history-item").forEach(a=>a.addEventListener("click",()=>Me(a.dataset.q)))}function Oi(){const e=document.getElementById("searchTrendList");e&&(e.innerHTML=Ti.map(t=>`<div class="trend-item" data-q="${g(t)}"><span>🔥 ${g(t)}</span><span class="small">›</span></div>`).join(""),e.querySelectorAll(".trend-item").forEach(t=>t.addEventListener("click",()=>Me(t.dataset.q))))}function Me(e){const t=document.getElementById("searchInput");t&&e&&(t.value=e);const a=(e||"").trim();if(!a)return;if(Ct=a,a.includes("hash=")&&a.includes("f665a7117959b667b7f283eaebf69cae")){const p=document.getElementById("searchResults");if(p){be(),p.innerHTML='<div class="card" style="padding:16px"><div class="small muted">此為暗網路徑的 hash，請至 <b>正常內網</b> 搜尋框輸入完整 URL：<br><code style="word-break:break-all">https://nori-intranet/internal/portal?hash=f665a7117959b667b7f283eaebf69cae</code><br><br>提示：可在 Vizual Studio Code 的 Git Graph 找到 <code>generateSecretPath</code> 歷史與 <code>.env.example</code> 的 key，自行組合 md5。</div></div>';const u=document.getElementById("md5Tool");u&&(u.style.display="none",u.innerHTML=""),l.push("searchHistory",{q:a,at:new Date().toISOString()}),ha();return}}const s=document.getElementById("md5Tool");s&&(s.style.display="none",s.innerHTML="");const n=document.getElementById("searchLayout");n&&(n.style.display=""),l.push("searchHistory",{q:a,at:new Date().toISOString()}),(a.toLowerCase().includes("package")||a.toLowerCase().includes("image"))&&l.setFlag("reverse_image_done",!0),(a.toLowerCase().includes("shell")||a.toLowerCase().includes("site:nori"))&&l.setFlag("found_shell_company",!0),(a.toLowerCase().includes("drink")||a.toLowerCase().includes("nori"))&&l.setFlag("found_supplier",!0),ha();const{base:i,filters:r}=Pi(a);Ia=i;const d=document.getElementById("searchAdvancedHint");if(d){const p=[];r.site&&p.push(`site:${r.site}`),r.filetype&&p.push(`filetype:${r.filetype}`),r.before&&p.push(`before:${r.before}`),r.after&&p.push(`after:${r.after}`),d.textContent=p.length?`進階語法生效：${p.join(" · ")} ｜ 基礎查詢：${i||"(空)"}`:""}let o=[];const c=i.toLowerCase().trim().replace(/\s+/g," ");if(c==="sawyer"||c==="sawyer choi"){const p=["https://sawyer-blog.example/2024-03-20","https://sawyer-blog.example/2024-01-15","https://sawyer-blog.example/2023-12-20","https://sawyer-blog.example/2023-05-10","https://sawyer-blog.example/2023-05-01"],u="https://news.example/sawyer-statement-2023",f="https://school.example/guangzhi-essay-sawyer",v=new Map(pt.map(M=>[M.url,M]));for(const M of p){const ee=v.get(M);if(ee){if(le!=="all"&&ee.type!==le||r.site&&!ee.url.toLowerCase().includes(r.site))continue;o.push(ee)}}const b=v.get(u);b&&(le==="all"||b.type===le)&&(!r.site||b.url.toLowerCase().includes(r.site))&&o.push(b);const T=v.get(f);T&&(le==="all"||T.type===le)&&(!r.site||T.url.toLowerCase().includes(r.site))&&o.push(T)}else for(const p of pt){if(le!=="all"&&p.type!==le)continue;const u=(p.title+" "+p.snippet+" "+p.url).toLowerCase(),f=i.toLowerCase();(!i||u.includes(f)||i.split(/\s+/).some(v=>u.includes(v.toLowerCase())))&&(r.site&&!p.url.toLowerCase().includes(r.site)||r.filetype&&p.type==="image"&&r.filetype!=="image"||o.push(p))}if(le==="image"&&o.some(p=>p.image),ji(a)){const p={title:"MD5 加密工具 — 線上 MD5 產生器 / 轉換器",url:"md5-tool",snippet:"輸入任意字串，一鍵轉換為 32 位小寫 MD5。支援即時轉換、複製與清空。",type:"tool",image:null,isMD5Tool:!0};o.some(f=>f.isMD5Tool||f.url==="md5-tool")||o.unshift(p);const u="https://peter-blog.example/md5-for-beginners";if(!o.some(f=>f.url===u)){const f=pt.find(v=>v.url===u);if(f&&(le==="all"||f.type===le)){const v=o.findIndex(b=>b.url==="md5-tool");o.splice(v+1,0,f)}}}ct=o.slice(0,12);const m=document.getElementById("searchResults");if(m){if(be(),!ct.length){m.innerHTML='<div class="muted small" style="margin-top:12px">無結果 — 嘗試輸入相關字眼 </code></div>';return}m.innerHTML=ct.map((p,u)=>`
  ...
  `).join(""),m.querySelectorAll("[data-open]").forEach(p=>p.addEventListener("click",()=>{const u=Number(p.dataset.open),f=ct[u];if(f){if(f.url.startsWith("file://")||f.url.startsWith("/customer-portal")){const v=f.url.replace("file://","");k.exists(v)&&l.setFlag("found_code_map",!0);const b=new CustomEvent("search:openFile",{detail:v});window.dispatchEvent(b)}Wi(u)}}))}}function be(){const e=document.getElementById("md5Tool");e&&(e.style.display="none",e.innerHTML="");const t=document.getElementById("searchLayout"),a=document.getElementById("searchDetail");t&&(t.style.display=""),a&&(a.style.display="none",a.innerHTML="",a.classList.remove("open"));const s=document.querySelector(".search");s&&(s.scrollTop=0);const n=document.getElementById("view-search");n&&(n.scrollTop=0)}function X(e){return e>=1e4?(e/1e4).toFixed(1)+"萬":e>=1e3?(e/1e3).toFixed(1)+"k":String(e)}function Qt(e){return ae.find(t=>t.url===e)||null}function Pe(e){return jn[e]||null}function Hi(e){return ae.filter(t=>t.authorId===e).sort((t,a)=>a.views-t.views)}function Ri(e){const t=ae.filter(n=>n.authorId===e.authorId&&n.url!==e.url).sort((n,i)=>i.views-n.views).slice(0,2);let a=ae.filter(n=>n.topic===e.topic&&n.url!==e.url&&n.authorId!==e.authorId);if(a.length<3){const n=ae.filter(i=>i.url!==e.url&&!t.includes(i)&&!a.includes(i)&&i.tags.some(r=>e.tags.includes(r)));a=[...a,...n]}a=a.slice(0,3);let s=[...t,...a];if(s.length<5){const n=ae.filter(i=>i.url!==e.url&&!s.includes(i)).sort(()=>.5-Math.random()).slice(0,5-s.length);s=s.concat(n)}return s.slice(0,5)}function La(e){return`
  ...
  `}function Ta(e){e.querySelector("[data-blog-home]")?.addEventListener("click",()=>Lt()),e.querySelectorAll("[data-blog-nav]").forEach(t=>{t.addEventListener("click",()=>{(t.dataset.blogNav==="home"||t.dataset.blogNav==="trending")&&Lt()})}),e.querySelector("[data-blog-back-search]")?.addEventListener("click",()=>be())}function Lt(){const e=document.getElementById("searchDetail"),t=document.getElementById("searchLayout");if(!e||!t)return;t.style.display="none",e.style.display="block",e.classList.add("open");const a=document.getElementById("md5Tool");a&&(a.style.display="none",a.innerHTML="");const s=[...ae].sort((p,u)=>u.views-p.views).slice(0,1)[0],n=[...ae].sort((p,u)=>u.views-p.views).slice(1,4),i=ae.find(p=>p.url==="https://peter-blog.example/code-easter-eggs"),r=[...ae.filter(p=>p.url!=="https://peter-blog.example/code-easter-eggs")].sort(()=>.5-Math.random()),d=(i?[i,...r].slice(0,6):[...ae].sort(()=>.5-Math.random()).slice(0,6)).slice(0,6),o=Object.values(jn).sort((p,u)=>u.followers-p.followers).slice(0,4);e.innerHTML=`
        ...
        <div class="blog-home__layout">
          <div class="blog-home__main">
            <div class="blog-featured">
              <div class="blog-featured__main" data-blog-url="${g(s.url)}">
                <div class="blog-card__cover"><img src="${g(s.cover||`https://picsum.photos/seed/${s.authorId}feat/600/400`)}" alt="" onerror="this.src='https://picsum.photos/600/400?random=1'" />
                  <span class="blog-card__cover-tag"><i class="fa-solid fa-crown" style="color:#ffb347"></i> 今日精選</span></div>
                <div class="blog-card__body">
                  <div class="blog-card__title" style="font-size:17px;min-height:auto">${g(s.title)}</div>
                  <div class="blog-card__excerpt">${g(s.excerpt)}</div>
                  <div class="blog-card__meta"><span class="blog-card__author"><img src="${g(Pe(s.authorId).avatar)}" alt="" />${g(Pe(s.authorId).displayName)}</span><span class="blog-card__dot"></span><span>${g(s.date)}</span><span class="blog-card__dot"></span><span><i class="fa-solid fa-eye"></i> ${X(s.views)}</span></div>
                </div>
              </div>
                ...
                ${n.map(p=>`
                  <div class="blog-mini" data-blog-url="${g(p.url)}">
                    ...
                    <div style="flex:1;min-width:0">
                      ...
                      <div class="blog-mini__meta"><span>${g(Pe(p.authorId).displayName.split("·")[0].trim())}</span><span>·</span><span><i class="fa-solid fa-eye"></i> ${X(p.views)}</span></div>
              ...
              ${d.map(p=>`
                <div class="blog-card" data-blog-url="${g(p.url)}">
                  ...
                  <div class="blog-card__body">
                    ...
                    <div class="blog-card__meta"><span class="blog-card__author"><img src="${g(Pe(p.authorId).avatar)}" alt="" />${g(Pe(p.authorId).name)}</span><span class="blog-card__dot"></span><span>${g(p.date)}</span><span class="blog-card__dot"></span><span><i class="fa-solid fa-eye"></i> ${X(p.views)}</span></div>
                  </div>
                </div>
              `).join("")}
            </div>
  ...
  `,Ta(e),e.querySelector("[data-blog-back-search]")?.addEventListener("click",()=>be()),e.querySelectorAll("[data-blog-url]").forEach(p=>{p.addEventListener("click",()=>Tt(p.dataset.blogUrl))}),e.querySelectorAll("[data-blog-author]").forEach(p=>{p.addEventListener("click",()=>Fn(p.dataset.blogAuthor))}),e.querySelectorAll("[data-blog-tag]").forEach(p=>{p.addEventListener("click",()=>{const u=p.dataset.blogTag,f=ae.find(v=>v.tags.includes(u)||v.topic===u);f&&Tt(f.url)})});const c=document.getElementById("view-search");c&&(c.scrollTop=0);const m=e.querySelector(".blog-body");m&&(m.scrollTop=0)}function Fn(e){const t=Pe(e);if(!t)return;const a=document.getElementById("searchDetail"),s=document.getElementById("searchLayout");if(!a||!s)return;s.style.display="none",a.style.display="block",a.classList.add("open");const n=Hi(e),i=n.reduce((o,c)=>o+c.views,0),r=n.reduce((o,c)=>o+c.likes,0);a.innerHTML=`
    <div class="blog-platform">
      ${La("profile")}
      <div class="blog-body">
  ...
  `,Ta(a),a.querySelector("[data-blog-back-search]")?.addEventListener("click",()=>be()),a.querySelectorAll("[data-blog-url]").forEach(o=>{o.addEventListener("click",()=>Tt(o.dataset.blogUrl))}),a.querySelector("[data-blog-home]")?.addEventListener("click",()=>Lt()),a.querySelector("a[data-blog-home]")?.addEventListener("click",()=>Lt());const d=document.getElementById("view-search");d&&(d.scrollTop=0)}function Tt(e){let t=Qt(e);if(!t){const m=pt.find(p=>p.url===e);m&&m.url.includes("sawyer-blog.example")&&(t=Qt(m.url))}if(!t)return;try{l.markArticleRead(t.url)}catch{}const a=Pe(t.authorId),s=document.getElementById("searchDetail"),n=document.getElementById("searchLayout");if(!s||!n)return;n.style.display="none",s.style.display="block",s.classList.add("open");const i=document.getElementById("md5Tool");i&&(i.style.display="none",i.innerHTML="");const r=Ri(t),d=Li[t.url]||[];t.cover&&t.cover.includes("sawyer_blog_pic"),s.innerHTML=`
    <div class="blog-platform">
      ${La("article")}
      <div class="blog-body">
        <div class="blog-article__layout">
              ...
              <div class="blog-article__head">
                ...
                <div class="blog-article__meta">
                  ...
                  <div style="line-height:1.3">
                    ...
                    <div style="font-size:11px;color:#9aa0a6">${g(t.date)} · <i class="fa-solid fa-eye"></i> ${X(t.views)} 瀏覽 · <i class="fa-regular fa-heart"></i> ${X(t.likes)} 喜歡 · 閱讀約 ${Math.max(1,Math.ceil(t.content.length/400))} 分鐘</div>
                  </div>
                  <span class="dot"></span>
          ...
          <aside class="blog-sidebar">
            <div class="blog-widget">
              ...
              <div style="margin-top:10px;display:flex;gap:14px;font-size:11px;color:#9aa0a6"><span><b style="color:#1f2328">${X(a.followers)}</b> 追蹤者</span><span><b style="color:#1f2328">${a.following}</b> 追蹤中</span><span style="margin-left:auto;cursor:pointer;color:var(--blog-accent);font-weight:700" data-blog-author="${g(a.id)}">前往主頁 →</span></div>
            </div>
            <div class="blog-widget">
              ...
              <div class="blog-rec-list">
                ${r.map((m,p)=>{const u=Pe(m.authorId),f=m.authorId===t.authorId;return`
                  <div class="blog-rec" data-blog-url="${g(m.url)}">
                    ...
                    <div style="flex:1;min-width:0">
                      ...
                      <div class="blog-rec__meta"><span>${g(u.name)}</span><span>·</span><span><i class="fa-solid fa-eye"></i> ${X(m.views)}</span></div>
                      <div style="margin-top:4px">${f?'<span class="blog-rec__badge">同作者</span>':`<span class="blog-rec__badge" style="background:#eef2ff;border-color:#c7d2fe;color:#4338ca">相似話題 · ${g(m.topic)}</span>`}</div>
                    </div>
                  </div>
                  `}).join("")}
              </div>
  ...
  `,Ta(s),s.querySelector("[data-blog-back-home]")?.addEventListener("click",()=>Lt()),s.querySelector("[data-blog-back-search]")?.addEventListener("click",()=>be()),s.querySelectorAll("[data-blog-author]").forEach(m=>{m.addEventListener("click",()=>Fn(m.dataset.blogAuthor))}),s.querySelectorAll("[data-blog-url]").forEach(m=>{m.addEventListener("click",()=>Tt(m.dataset.blogUrl))});const o=document.getElementById("view-search");o&&(o.scrollTop=0);const c=s.querySelector(".blog-body");c&&(c.scrollTop=0),s.scrollIntoView({behavior:"auto",block:"start"})}function Nn(e){return e==="https://school.example/guangzhi-essay-sawyer"||e.includes("school.example/guangzhi")}function Vi(e){return`
  ...
  `}function qi(e){e.querySelectorAll("[data-school-back-search]").forEach(t=>t.addEventListener("click",()=>be())),e.querySelectorAll("[data-school-home]").forEach(t=>t.addEventListener("click",()=>be()))}function zi(e){const t=e||pt.find(o=>o.url==="https://school.example/guangzhi-essay-sawyer")||ct.find(o=>Nn(o.url));if(!t)return;try{l.markArticleRead(t.url)}catch{}const a=document.getElementById("searchDetail"),s=document.getElementById("searchLayout");if(!a||!s)return;s.style.display="none",a.style.display="block",a.classList.add("open");const n=document.getElementById("md5Tool");n&&(n.style.display="none",n.innerHTML="");const i=t.images||(t.image?[t.image]:[]);a.innerHTML=`
  ...
  `,a.querySelector("[data-so-back-search]")?.addEventListener("click",()=>be());const i=document.getElementById("view-search");i&&(i.scrollTop=0),a.scrollIntoView({behavior:"auto",block:"start"})}function Wi(e){const t=ct[e];if(!t)return;if(t.isMD5Tool||t.url==="md5-tool"){Di(Ct);return}const a=document.getElementById("md5Tool");if(a&&(a.style.display="none",a.innerHTML=""),Ai(t.url)){Ui(t.url);return}const s=t.url;if(ae.some(u=>u.url===s)||s.includes("sawyer-blog.example")||s.includes("mary-blog.example")||s.includes("peter-blog.example")||s.includes("paul-blog.example")||s.includes("emma-blog.example")||s.includes("david-blog.example")){let u=s;if(!Qt(u)){const f=ae.find(v=>v.title===t.title);f&&(u=f.url)}if(Qt(u)){Tt(u);return}}if(Nn(t.url)||t.title.includes("廣志中學")){zi(t);return}const n=document.getElementById("searchLayout"),i=document.getElementById("searchDetail");if(!n||!i)return;try{t.url&&(t.type==="news"||t.url.includes("news.example"))&&l.markArticleRead(t.url)}catch{}n.style.display="none",i.style.display="block",i.classList.add("open");let r="",d=null;if(t.url.startsWith("/customer-portal")||t.url.startsWith("file://")){d=t.url.replace("file://","");const u=k.getFile(d);u&&typeof u.content=="string"&&(r=u.content,k.readFile(d))}else if(k.exists(t.url)){d=t.url;const u=k.getFile(d);u&&typeof u.content=="string"&&(r=u.content)}if(!r&&t.title.startsWith("/customer-portal")){const u=k.getFile(t.title);u&&typeof u.content=="string"&&(r=u.content)}const o=r||t.snippet||"無內容",c=t.images?t.images.map(u=>`<div class="detail__image"><img src="${g(u)}" alt="preview" style="width:100%;display:block" onerror="this.src='https://via.placeholder.com/320x480?text=Sawyer+Writing'" /></div>`).join(""):t.image?`<div class="detail__image"><img src="${g(t.image)}" alt="preview" onerror="this.src='https://via.placeholder.com/320x180?text=Preview'" /></div>`:"";i.innerHTML=`
  ...
  `,i.querySelector("#searchBackBtn")?.addEventListener("click",()=>be());const m=document.querySelector(".search");m&&(m.scrollTop=0);const p=document.getElementById("view-search");p&&(p.scrollTop=0),i.scrollIntoView({behavior:"auto",block:"start"})}var vt=0,ra=null,Gi=!1,Z="/darknet/全結構圖",ht="secret",At=!1;function Ji(){return k.buildDarkTree?k.buildDarkTree():k.buildTree()}function Yi(e){const t=Ji();function a(n,i){if(n.path===i)return n;if(!n.children)return null;for(const r of n.children){const d=a(r,i);if(d)return d}return null}const s=a(t,e);return!s||!s.children?[]:s.children}function On(){document.getElementById("view-darknet")&&(Z==="/darknet"&&(Z="/darknet/全結構圖"),l.hasFlag("dark_entered"),ea())}function Xa(){const e=document.getElementById("dock");e&&(e.style.display="none"),B(()=>Promise.resolve().then(()=>oe).then(t=>{t.setDockVisible&&t.setDockVisible(!1)}),void 0).catch(()=>{})}function Xt(){const e=document.getElementById("dock");e&&(e.style.display=""),B(()=>Promise.resolve().then(()=>oe).then(t=>{t.setDockVisible&&t.setDockVisible(!0)}),void 0).catch(()=>{})}function ea(){const e=document.getElementById("view-darknet");if(e)if(ht==="secret"){const t=$t,a=l.hasFlag("dark_secret_active");!t&&At||a?Xa():Xt(),e.innerHTML=`
      <div class="darknet">
    ...
    `,Ki()}else{Z==="/darknet"&&(Z="/darknet/全結構圖");const t=l.hasFlag("dark_secret_active");!$t&&At||t?Xa():Xt();const a=Yi(Z),s=a.filter(i=>i.type==="dir"),n=a.filter(i=>i.type==="file");e.innerHTML=`
      <div class="darknet">
        <div style="height:40px;display:flex;align-items:center;justify-content:space-between;padding:0 12px;border-bottom:1px solid #1a0a0c;background:#0a0a0a;flex-shrink:0">
          <span class="small muted" style="color:#8b6a6e">機密文件庫 · ${g(Z)}</span>
    ...
    `,Xi(),Zi(s,n),tr()}}function Ki(){const e=document.getElementById("darkTitle");document.getElementById("darkSearchInput");const t=document.getElementById("darkBackBtn");t&&t.addEventListener("click",()=>{Xt();try{l.setFlag("dark_secret_active",!1)}catch{}B(()=>Promise.resolve().then(()=>oe).then(s=>{s.setActiveView&&(s.setActiveView("intranet"),localStorage.setItem("cc_active_view","intranet"))}),void 0),ht="secret",$t=!1,At=!1;const a=document.getElementById("view-darknet");a&&(a.innerHTML="")}),e&&(e.style.cursor="default",!$t&&e.addEventListener("click",()=>{vt++,ra&&clearTimeout(ra),ra=setTimeout(()=>{vt=0},2e3),vt>=6&&(vt=0,Qi())}))}function Qi(){Gi=!0,ht="files",Z==="/darknet"&&(Z="/darknet/全結構圖"),l.setFlag("dark_entered",!0),l.setFlag("ch3_entered_secret",!0),l.setFlag("hidden_portal_accessed",!0),ea(),l.setFlag("found_code_map",!0)}function Xi(){const e=document.getElementById("darkNav");e&&(e.innerHTML=[{path:"/darknet/全結構圖",label:"全結構圖",icon:"🗺️"},{path:"/darknet/交易列表",label:"交易列表",icon:"📋"},{path:"/darknet/合作公司列表",label:"合作公司",icon:"🏢"},{path:"/darknet/流量",label:"流量",icon:"📦"},{path:"/darknet/月結單",label:"月結單",icon:"💰"},{path:"/darknet/Sawyer支出",label:"Sawyer支出",icon:"💸"},{path:"/darknet/出差紀錄",label:"出差紀錄",icon:"✈️"},{path:"/darknet/會議紀錄",label:"會議記錄",icon:"📝"}].map(t=>`<div class="darknet__nav-item ${Z===t.path||Z.startsWith(t.path+"/")?"active":""}" data-path="${t.path}"><span>${t.icon}</span><span>${t.label}</span></div>`).join(""),e.querySelectorAll(".darknet__nav-item").forEach(t=>t.addEventListener("click",()=>{Z=t.dataset.path,ea()})))}function Zi(e,t){const a=document.getElementById("darkMain");if(a){if(!e.length&&!t.length){const s=k.getDarkFile?k.getDarkFile(Z):null;if(s&&s.content){a.innerHTML=`<pre style="white-space:pre-wrap;word-break:break-word;font-family:var(--font-mono);font-size:13px;color:#e9edef">${g(s.content.slice(0,8e3))}</pre>`,l.discoverFile(Z),Aa();return}a.innerHTML='<div style="padding:24px;text-align:center;color:#5a3a3e">此資料夾為空</div>';return}a.innerHTML=`
    <div style="font-size:11px;font-weight:700;letter-spacing:.6px;color:#5a3a3e;margin-bottom:8px">${g(Z)} — ${e.length} 資料夾，${t.length} 檔案</div>
    ${e.length?`<div style="margin-bottom:12px">${e.map(s=>`<div class="darknet__file-row is-dir" data-path="${g(s.path)}" data-type="dir">📁 ${g(s.name)}</div>`).join("")}</div>`:""}
    ${t.length?`<div>${t.map(s=>`<div class="darknet__file-row" data-path="${g(s.path)}" data-type="file">📄 ${g(s.name)}</div>`).join("")}</div>`:""}
  `,a.querySelectorAll(".darknet__file-row").forEach(s=>{s.addEventListener("click",()=>{const n=s.dataset.path;s.dataset.type==="dir"?(Z=n,ea()):er(n)})})}}function er(e){const t=k.getDarkFile?k.getDarkFile(e):k.getFile(e);if(!t)return;const a=document.getElementById("darkPreview"),s=document.getElementById("darkPreviewName"),n=document.getElementById("darkPreviewContent");if(!a||!s||!n)return;s.textContent=e;let i=t.content||"";if(e.toLowerCase().endsWith(".csv")){const r=i.split(`
`).filter(u=>u.trim()!==""),d=u=>{const f=[];let v="",b=!1;for(let T=0;T<u.length;T++){const M=u[T];M==='"'?b&&u[T+1]==='"'?(v+='"',T++):b=!b:M===","&&!b?(f.push(v),v=""):v+=M}return f.push(v),f},o=d(r[0]||""),c=r.slice(1).map(d),m=`<thead><tr>${o.map(u=>`<th style="padding:8px 10px;border:1px solid #722F37;background:#1a0a0c;color:#a67c81;text-align:left">${g(u)}</th>`).join("")}</tr></thead>`,p=`<tbody>${c.map(u=>`<tr>${u.map(f=>`<td style="padding:7px 10px;border:1px solid #1a0a0c;color:#e9edef">${g(f)}</td>`).join("")}</tr>`).join("")}</tbody>`;n.innerHTML=`<div style="padding:8px 12px;border-bottom:1px solid #1a0a0c;background:#1a0a0c;display:flex;justify-content:space-between"><span class="small muted" style="color:#8b6a6e">${g(e)} — 表格檢視</span><span class="small muted" style="color:#8b6a6e">${c.length} 列</span></div><div style="overflow:auto;max-height:60vh"><table style="width:100%;border-collapse:collapse;font-size:13px">${m}${p}</table></div>`,n.style.whiteSpace="normal"}else i.length>12e3&&(i=i.slice(0,12e3)+`
...`),n.textContent=i,n.style.whiteSpace="pre-wrap";a.style.display="flex",l.discoverFile(e),l.setFlag("dark_opened:"+e,!0),Aa()}function tr(){document.getElementById("darkExitBtn")?.addEventListener("click",()=>{ht="secret",At=!1;try{l.setFlag("dark_secret_active",!1)}catch{}Xt(),Aa(!0),B(()=>Promise.resolve().then(()=>oe).then(t=>{t.setActiveView&&(t.setActiveView("intranet"),localStorage.setItem("cc_active_view","intranet"))}),void 0);const e=document.getElementById("view-darknet");e&&(e.innerHTML=""),l.hasFlag("ch4_all_opened")&&setTimeout(()=>{window.dispatchEvent(new CustomEvent("darknet:exit"))},300)}),document.getElementById("darkPreviewClose")?.addEventListener("click",()=>{const e=document.getElementById("darkPreview");e&&(e.style.display="none")}),document.getElementById("darkPreview")?.addEventListener("click",e=>{e.target.id==="darkPreview"&&(e.target.style.display="none")})}function Aa(e=!1){const t=k.listDarkFiles?k.listDarkFiles("/darknet"):[];if(!t.length)return;const a=t.filter(s=>l.hasFlag("dark_opened:"+s.path)||l.hasFlag("discovered:"+s.path)||l.get("discoveredFiles")?.includes(s.path));a.length>=t.length?(l.hasFlag("ch4_all_opened")||l.setFlag("ch4_all_opened",!0),e&&!l.hasFlag("ch5_triggered")&&(l.setFlag("ch5_triggered",!0),window.dispatchEvent(new CustomEvent("ch4:complete")),setTimeout(()=>{const s=document.getElementById("mailDialog");if(s&&!s.open)try{s.showModal()}catch{s.style.display="block",s.setAttribute("open","")}},500))):e&&a.length>=t.length,a.length>=t.length&&!l.hasFlag("ch4_all_opened")&&l.setFlag("ch4_all_opened",!0)}var $t=!1;function oa(e={}){if(!(l.hasFlag("ch1_0043_committed")&&!l.hasFlag("ch1_revert_done"))&&document.getElementById("view-darknet")){if($t=!!e.simple,At=!0,e.simple)try{l.setFlag("dark_secret_active",!1)}catch{}else try{l.setFlag("dark_secret_active",!0)}catch{}ht="secret",vt=0,B(()=>Promise.resolve().then(()=>oe).then(t=>{t.setActiveView&&(t.setActiveView("darknet"),localStorage.setItem("cc_active_view","darknet"))}),void 0),On()}}var ne="/intranet",Je="",Za="/intranet/client_info";function Bt(e){return e===Za||e.startsWith(Za+"/")}function en(e){const t=k.buildTree();function a(n,i){if(n.path===i)return n;if(!n.children)return null;for(const r of n.children){const d=a(r,i);if(d)return d}return null}const s=a(t,e);return!s||!s.children?[]:s.children}function ar(){const e=document.getElementById("view-intranet");e&&(e.innerHTML=`
    <div class="intranet">
  ...
  `,nr(),Hn())}function nr(){const e=k.internalPathDomain||"https://nori-intranet/internal/portal?",t=k.getLegacyRoute&&k.getLegacyRoute("nori-portal-2023")?._hash||"f665a7117959b667b7f283eaebf69cae",a=e+"hash="+t,s="https://nori-intranet/internal/portal";function n(r){if(!r)return!1;const d=r.trim();return!!(d===a||d.startsWith("https://nori-intranet/internal/portal?hash="+t))}function i(){const r=document.getElementById("intraSearch"),d=r?r.value.trim():"",o=d===s||d===s+"/"||d.includes("nori-intranet/internal/portal")&&!d.includes("hash="),c=n(d);if(l.hasFlag("ch1_0043_committed")&&!l.hasFlag("ch1_revert_done")&&(o||c)){Je=d.toLowerCase(),va();return}if(o){l.setFlag("portal_simple_entered",!0),oa({simple:!0});return}if(c){l.setFlag("portal_hash_entered",!0);const m=d.match(/hash=([a-f0-9]{32})/i),p=m?m[1]:t;if(k.tryAccessPortal&&k.tryAccessPortal({hash:p})){oa({simple:!1});return}else if(d===a){oa({simple:!1});return}}Je=d.toLowerCase(),va()}document.getElementById("intraSearchBtn")?.addEventListener("click",i),document.getElementById("intraSearch")?.addEventListener("keydown",r=>{r.key==="Enter"&&(r.preventDefault(),i())}),document.getElementById("intraPreviewClose")?.addEventListener("click",da),document.getElementById("intraPreview")?.addEventListener("click",r=>{r.target.id==="intraPreview"&&da()}),document.addEventListener("keydown",r=>{r.key==="Escape"&&da()})}function Hn(){sr(),ir(),va();const e=k.listFiles("/intranet").length,t=document.getElementById("intraCount");t&&(t.textContent=`內網共 ${e} 個檔案`)}function sr(){const e=document.getElementById("intraBreadcrumb");if(!e)return;const t=ne.split("/").filter(Boolean);let a='<span class="intra-bc__item" data-path="/intranet">🏠 內網首頁</span>',s="/intranet";const n=t[0]==="intranet"?1:0;t.slice(n).forEach(i=>{s+="/"+i;const r=Bt(s);a+=` <span class="muted">›</span> <span class="intra-bc__item ${s===ne?"active":""} ${r?"locked":""}" data-path="${g(s)}">${g(i)}${r?" 🔒":""}</span>`}),ne==="/intranet"&&(a='<span class="intra-bc__item active" data-path="/intranet">🏠 內網首頁</span>'),e.innerHTML=a,e.querySelectorAll(".intra-bc__item").forEach(i=>{i.addEventListener("click",()=>ta(i.dataset.path))})}function ir(){const e=document.getElementById("intraNav");e&&(e.innerHTML=[{path:"/intranet",label:"內網首頁",icon:"🏠",desc:"總覽"},{path:"/intranet/company_public",label:"公司公開資訊",icon:"🏢",desc:"名稱・Logo・大樓名錄"},{path:"/intranet/client_info",label:"客戶資料",icon:"🔒",desc:"權限管制（鎖定）",locked:!0},{path:"/intranet/business_plans",label:"業務計畫",icon:"📊",desc:"完整流程結構"},{path:"/intranet/staff",label:"員工資料",icon:"👥",desc:"50 人名錄"}].map(t=>`<div class="intra-nav__item ${ne===t.path||t.path!=="/"&&ne.startsWith(t.path+"/")?"active":""} ${t.locked?"locked":""}" data-path="${t.path}" title="${t.path}">
  ...
  `,e.querySelectorAll(".intra-nav__item").forEach(t=>{t.addEventListener("click",()=>ta(t.dataset.path))}))}function va(){const e=document.getElementById("intraMain");if(!e)return;if(Je){const n=k.searchContent(Je).filter(o=>o.path.startsWith("/intranet")).slice(0,40),i=k.listFiles("/intranet").filter(o=>o.path.toLowerCase().includes(Je)).slice(0,40),r=new Map;n.forEach(o=>r.set(o.path,o)),i.forEach(o=>{r.has(o.path)||r.set(o.path,{path:o.path,snippet:""})});const d=[...r.values()];if(!d.length){e.innerHTML='<div class="intra-empty">無搜尋結果 — 試試「Nori」「冰釀茶酒」「業務流程」「Sawyer」</div>';return}e.innerHTML=`
      <div class="intra-section__title">搜尋結果「${g(Je)}」— ${d.length} 筆</div>
      <div class="intra-file__list">
        ${d.map(o=>{const c=k.getFile(o.path)?.meta?.locked||Bt(o.path);return`<div class="intra-file__row ${c?"locked":""}" data-path="${g(o.path)}" title="${g(o.path)}">
            <span class="intra-file__icon">${c?"🔒":fa(o.path)}</span>
    ...
    `,ca(e);return}if(Bt(ne)){e.innerHTML=`
      <div class="intra-locked">
        ...
        <div class="intra-locked__files">
          ...
          ${en(ne).map(n=>`<div class="intra-file__row locked" title="${g(n.path)}"><span>${fa(n.path)}</span><span>${g(n.name)}</span><span class="small muted" style="margin-left:auto">🔒 鎖定</span></div>`).join("")}
        </div>
        <button class="btn" style="margin-top:12px" onclick="document.querySelector('[data-path='/intranet']')?.click()">返回內網首頁</button>
      </div>
    `;return}const t=en(ne),a=t.filter(n=>n.type==="dir"),s=t.filter(n=>n.type==="file");if(ne==="/intranet"&&!Je){e.innerHTML=`
    ...
    `,e.querySelectorAll("[data-path]").forEach(n=>n.addEventListener("click",i=>{i.stopPropagation();const r=n.getAttribute("data-path");r&&ta(r)})),ca(e);return}if(!t.length){const n=k.getFile(ne);if(n&&n.content!=null){e.innerHTML=`<div class="intra-section__title">${g(ne)}</div><pre class="intra-file__preview mono">${g(n.content.slice(0,8e3))}</pre>`;return}e.innerHTML='<div class="intra-empty">此資料夾為空</div>';return}e.innerHTML=`
    <div class="intra-section__title">${g(ne)} — ${a.length} 個資料夾，${s.length} 個檔案</div>
    ${a.length?`<div class="intra-file__list"><div class="small muted" style="padding:4px 8px">資料夾</div>${a.map(n=>la(n)).join("")}</div>`:""}
    ${s.length?`<div class="intra-file__list"><div class="small muted" style="padding:4px 8px">檔案</div>${s.map(n=>la(n)).join("")}</div>`:""}
  `,ca(e)}function la(e){const t=e.path&&Bt(e.path),a=(e.path?k.getFile(e.path):null)?.meta?.locked||t,s=a?"🔒":e.type==="dir"?"📁":fa(e.path||e.name);return`<div class="intra-file__row ${e.type==="dir"?"is-dir":""} ${a?"locked":""}" data-path="${g(e.path)}" data-type="${e.type}" title="${g(e.path)}">
  ...
  </div>`}function fa(e){return e?e.endsWith(".md")?"📝":e.endsWith(".csv")?"📊":e.endsWith(".svg")?"🖼️":e.endsWith(".json")?"🧩":e.endsWith(".js")||e.endsWith(".java")?"💻":e.endsWith(".html")?"🌐":e.endsWith(".pdf")?"📕":"📄":"📄"}function ca(e){e.querySelectorAll(".intra-file__row").forEach(t=>{t.addEventListener("click",()=>{const a=t.dataset.path,s=t.dataset.type;if(t.classList.contains("locked")){if(document.getElementById("intraMain")){const n=document.createElement("div");n.className="toast",n.style.cssText="position:fixed;right:12px;bottom:64px;background:#323232;color:#fff;padding:10px 12px;border-radius:8px;z-index:999",n.textContent="🔒 權限不足 — 客戶資料受保護，遊戲內無需存取",document.body.appendChild(n),setTimeout(()=>n.remove(),2200)}return}s==="dir"?ta(a):or(a)})})}function ta(e){e&&(ne=e,Hn())}function rr(e){const t=e.split(`
`).filter(s=>s.trim()!=="");if(!t.length)return{header:[],rows:[]};const a=s=>{const n=[];let i="",r=!1;for(let d=0;d<s.length;d++){const o=s[d];o==='"'?r&&s[d+1]==='"'?(i+='"',d++):r=!r:o===","&&!r?(n.push(i),i=""):i+=o}return n.push(i),n};return{header:a(t[0]),rows:t.slice(1).map(a)}}function or(e){const t=k.getFile(e);if(!t||t.meta?.locked||Bt(e))return;const a=document.getElementById("intraPreview"),s=document.getElementById("intraPreviewName"),n=document.getElementById("intraPreviewContent");if(!a||!s||!n)return;s.textContent=e;let i=t.content||"";if(e.toLowerCase().endsWith(".csv")){const{header:r,rows:d}=rr(i),o=`<thead><tr>${r.map(m=>`<th>${g(m)}</th>`).join("")}</tr></thead>`,c=`<tbody>${d.map(m=>`<tr>${m.map(p=>`<td>${g(p)}</td>`).join("")}</tr>`).join("")}</tbody>`;n.innerHTML=`
...
...（內容已截斷，完整請於 Vizual Studio Code 開啟）`),n.textContent=i,n.style.whiteSpace="pre-wrap";a.style.display="flex"}function da(){const e=document.getElementById("intraPreview");e&&(e.style.display="none")}function tn(){const e=l.get("settings.theme")||"dark";document.documentElement.setAttribute("data-theme",e)}function Rn(){return!!document.fullscreenElement}function Vn(){Rn()?document.exitFullscreen().catch(()=>{}):document.documentElement.requestFullscreen().catch(()=>{})}function dt(e){e&&(e.textContent=Rn()?"關閉全螢幕":"開啟全螢幕")}function lr(){document.querySelectorAll("dialog[open]").forEach(n=>{try{n.close()}catch{}});const e=document.getElementById("startMenu");e&&(e.style.display="none");const t=document.getElementById("intraPreview");t&&(t.style.display="none");const a=document.getElementById("darkPreview");a&&(a.style.display="none");const s=document.getElementById("waLightbox");s&&s.classList.remove("open"),document.querySelectorAll("dialog").forEach(n=>{n.open||n.style.removeProperty("display")})}function Se(e){lr(),dn(e),localStorage.setItem("cc_active_view",e)}function cr(){Os(),wa(),An(),Fi(),ar(),On(),ur(),mr(),gr()}var qn=null;function dr(e){try{const t=JSON.parse(localStorage.getItem("code_conspiracy_state")||"{}").whatsappChats;if(Array.isArray(t)){const a=t.find(s=>s.id===e);if(a)return!!a.muted}return!1}catch{return!1}}function pr(){try{const t=JSON.parse(localStorage.getItem("code_conspiracy_state")||"{}");if(t.flags&&t.flags.ch0_maggie_notified||t.flags&&t.flags.ch0_vip_fixed||t.currentChapter&&t.currentChapter!==0)return}catch{}if(l.hasFlag("ch0_maggie_notified")||l.hasFlag("ch0_vip_fixed")||(l.get("currentChapter")??0)!==0||dr("maggie")||document.getElementById("wa-win-notification"))return;const e=document.createElement("div");e.id="wa-win-notification",e.setAttribute("role","alert"),e.setAttribute("aria-live","polite"),e.innerHTML=`
    <div class="win-notif__app">
      <img src="/arg-game-it-company-secret/icon/whatsup.svg" alt="WhatUp" width="20" height="20" style="width:20px;height:20px;object-fit:contain" />
      <span class="win-notif__app-name">WhatUp</span>
      <span class="win-notif__app-sub">主管 - Maggie</span>
    ...
    <div class="win-notif__progress"></div>
  `,e.addEventListener("click",t=>{if(!t.target.closest(".win-notif__close")){pa();try{at("maggie")}catch{}Se("whatsapp")}}),e.querySelector(".win-notif__close")?.addEventListener("click",t=>{t.stopPropagation(),pa()}),document.body.appendChild(e),l.setFlag("ch0_maggie_notified",!0),requestAnimationFrame(()=>e.classList.add("show")),qn=setTimeout(()=>pa(),1e4)}function pa(){const e=document.getElementById("wa-win-notification");e&&(clearTimeout(qn),e.classList.remove("show"),e.classList.add("hide"),setTimeout(()=>e.remove(),280))}function zn(e){e==="jira_viewed"&&l.setFlag("onb_jira_viewed",!0),e==="vscode_viewed"&&l.setFlag("onb_vscode_viewed",!0),l.hasFlag("onboarding_done")||l.setFlag("onboarding_done",!0)}function ur(){const e=document.getElementById("mailDialog"),t=document.getElementById("mailTitle"),a=document.getElementById("mailTo"),s=document.getElementById("mailSend"),n=document.getElementById("mailTempExit");function i(){if(!t||!a)return;const r=t.value;r==="Report"?a.value="Drug Enforcement Administration <dea@email.us>":(r==="Coperation"||r==="Resign")&&(a.value="Sawyer <sawyer@nori.com>")}t?.addEventListener("change",i),i(),n?.addEventListener("click",()=>{e?.close(),Be({onSwitch:Se,onOpenSettings:We,onOpenNotebook:Ge,t:he})}),s?.addEventListener("click",()=>{const r=t?.value,d=document.getElementById("mailBody")?.value||"",o=document.getElementById("mailTo")?.value||"";try{hi({title:r,to:o,body:d})}catch{}let c=null;if(r==="Report"?c="report":r==="Coperation"?c="cooperate":r==="Resign"&&(c="resign"),c){const m=l.get("endings")||[];m.includes(c)||(m.push(c),l.set("endings",m),l.setFlag("ending_"+c,!0));try{Tn(c)}catch{}}else try{G("email_submit_no_ending",{email_title:r,email_body_preview:d.slice(0,80)})}catch{}e?.close(),Be({onSwitch:Se,onOpenSettings:We,onOpenNotebook:Ge,t:he}),c?setTimeout(()=>Un(c),300):U("郵件已寄送: "+r)})}function mr(){const e=document.getElementById("startMenu");e&&document.addEventListener("click",t=>{const a=t.target.closest&&t.target.closest(".taskbar__start"),s=t.target.closest&&t.target.closest("#startShutdown"),n=t.target.closest&&t.target.closest("#startLogout");if(a){t.stopPropagation();const i=e.style.display==="none"||!e.style.display||e.style.display==="";e.style.display=i?"block":"none";return}if(s){t.stopPropagation(),e.style.display="none",an("shutdown");return}if(n){t.stopPropagation(),e.style.display="none",an("logout");return}e.contains(t.target)||(e.style.display="none")})}function an(e){const t=l.get("endings")||[],a=l.hasFlag("ch4_all_opened"),s=t[0];let n=null;!s&&!a?n="flee":!s&&a?n="fried":s==="report"?n="report":s==="cooperate"?n="cooperate":s==="resign"?n="resign":n="flee";const i=l.get("endings")||[];i.includes(n)||(i.push(n),l.set("endings",i));try{Tn(n),G("shutdown",{action:e,ending:n})}catch{}Un(n)}function Un(e){const t=document.getElementById("endingScreen"),a=document.getElementById("endingTitle"),s=document.getElementById("endingDesc"),n=document.getElementById("endingRestart");if(!t||!a||!s)return;const i={flee:"flee",cooperate:"cooperate",report:"report",resign:"resign",fried:"fried"}[e];i&&ie.play(i);const r={flee:{title:"平凡的日常",desc:`你已完成了工作，登出了電腦，走出辨公室，回到家中安心睡一覺。
...
`).replace(/\n+/g,`
`).split(/([，。、！？；\n\s]+)/).filter(Boolean);for(const f of c)if(/^[\n\s]+$/.test(f))o.push(f);else if(/^[，。、！？；]+$/.test(f))o.push(f);else for(let v=0;v<f.length;v+=1)o.push(f.slice(v,v+1));let m=0,p="";function u(){if(m>=o.length){n&&(n.style.display="block");return}const f=o[m];p+=f,s.textContent=p,m++;let v=100;(/[，。、！？；]$/.test(f)||f===`
`||f.includes(`
`))&&(v+=200),/^\s+$/.test(f)&&(v=100),e==="fried"&&(f==="其"||f==="實"||p.includes("其實"))&&(v=420),setTimeout(u,v)}u()},500)}function gr(){document.getElementById("endingRestart")?.addEventListener("click",async()=>{ie.stop(!1);let e=null;try{e=JSON.parse(JSON.stringify(l.get("persistentStats")||{}))}catch{}try{l.reset()}catch{}try{if(e){const a=l.get("persistentStats")||{},s={unlockedEndings:[...new Set([...a.unlockedEndings||[],...e.unlockedEndings||[]])],readArticles:[...new Set([...a.readArticles||[],...e.readArticles||[]])],darkFileCount:Math.max(a.darkFileCount||0,e.darkFileCount||0),whatsappSentCount:Math.max(a.whatsappSentCount||0,e.whatsappSentCount||0),searchHistoryCount:Math.max(a.searchHistoryCount||0,e.searchHistoryCount||0),flags:{...a.flags||{},...e.flags||{}}};l.set("persistentStats",s),l.set("unlockedEndings",s.unlockedEndings)}}catch{}const t=document.getElementById("endingScreen");t&&(t.style.display="none"),document.querySelectorAll("dialog[open]").forEach(a=>{try{a.close()}catch{}a.style.display="none"});try{if("caches"in window){const a=await caches.keys();await Promise.all(a.map(s=>caches.delete(s)))}if("serviceWorker"in navigator){const a=await navigator.serviceWorker.getRegistrations();await Promise.all(a.map(s=>s.unregister()))}}catch{}setTimeout(()=>{window.location.href=window.location.pathname+"?reset="+Date.now(),window.location.reload(!0)},150)}),document.getElementById("endingClose")?.addEventListener("click",()=>{document.getElementById("endingScreen").style.display="none"})}function hr(){const e=document.getElementById("welcomeDialog");if(!e)return;const t=document.getElementById("welcomeFullscreenBtn"),a=document.getElementById("welcomeMuteBtn"),s=document.getElementById("welcomeVolumeSlider"),n=document.getElementById("welcomeVolumePct"),i=document.getElementById("welcomeStartBtn");dt(t),t?.addEventListener("click",()=>{Vn(),dt(t)}),document.addEventListener("fullscreenchange",()=>{dt(t),dt(document.getElementById("settingFullscreenBtn"))}),a&&a.addEventListener("click",()=>{const r=ie.toggleMute();a.textContent=r?"🔇":"🔊",n&&(n.textContent=r?"靜音":Math.round(ie.getVolume()*100)+"%")}),s&&s.addEventListener("input",r=>{const d=parseInt(r.target.value)/100;ie.setVolume(d),ie.setMuted(!1),a&&(a.textContent="🔊"),n&&(n.textContent=Math.round(d*100)+"%")}),i?.addEventListener("click",()=>{e.close()}),typeof e.showModal=="function"?e.showModal():e.show()}function vr(){const e=document.getElementById("settingFullscreenBtn");e&&(dt(e),e.addEventListener("click",()=>{Vn(),dt(e)}))}function fr(){const e=document.getElementById("analyticsBanner"),t=document.getElementById("analyticsAccept"),a=document.getElementById("analyticsDecline"),s=document.getElementById("analyticsConsentToggle"),n=document.getElementById("analyticsGasUrl"),i=document.getElementById("analyticsSaveBtn"),r=document.getElementById("analyticsTestBtn"),d=document.getElementById("analyticsFlushBtn"),o=document.getElementById("analyticsStatus"),c=document.getElementById("analyticsQueueCount"),m=document.getElementById("analyticsSessionId");try{e&&!Cn()&&(e.style.display="flex")}catch{}const p=()=>{try{const u=JSON.parse(localStorage.getItem("cc_analytics_queue")||"[]");if(c&&(c.textContent=String(u.length)),m){const f=(()=>{try{return tt()}catch{return null}})(),v=bt().slice(0,8),b=f?f.id.slice(0,12):"-";m.textContent=v+" / "+b,m.title="SID: "+bt()+`
GameSession: `+(f?f.id+" ("+f.startAt+")":"-")}if(o&&(Te()?Re()?o.textContent="就緒（所有玩家自動共用此 URL，無需各自輸入）":o.textContent="已設定，等待玩家同意":o.textContent="尚未設定 GAS URL（需部署時設定 VITE_GAS_URL，其他玩家才會自動生效）"),s&&(s.checked=Re()),n){let f=!1;try{f=!0}catch{}if(Te())if(n.value=Xe(),n.disabled=!1,f){try{localStorage.getItem("cc_gas_url")||(n.title="已由 GitHub Secrets VITE_GAS_URL 注入，所有玩家共用，無需各自輸入")}catch{}n.placeholder="已由部署設定（所有玩家自動共用）"}else n.placeholder="https://script.google.com/macros/s/.../exec";else n.value="",n.disabled=!1,n.placeholder="https://script.google.com/macros/s/.../exec"}}catch{}};p(),t?.addEventListener("click",()=>{Wt(!0),e&&(e.style.display="none"),p(),U("已啟用匿名數據收集"),Ze()}),a?.addEventListener("click",()=>{Wt(!1),e&&(e.style.display="none"),p(),U("已拒絕數據收集")}),s?.addEventListener("change",u=>{Wt(u.target.checked),p(),U(u.target.checked?"已啟用":"已停用")}),i?.addEventListener("click",()=>{const u=n?.value.trim()||"";if(u&&!u.startsWith("https://script.google.com/")){o&&(o.textContent="URL 需為 https://script.google.com/.../exec");return}_n(u),p(),U("已儲存 GAS URL")}),r?.addEventListener("click",async()=>{if(!Te()){U("請先設定 GAS URL"),o&&(o.textContent="未設定：請貼上你部署的 exec URL");return}if(!Re()){U("請先勾選 同意匿名收集"),o&&(o.textContent="等待同意：請先勾選同意");return}o&&(o.textContent="發送中...");const u=Xe(),f={timestamp:new Date().toISOString(),session_id:bt(),event_type:"test_ping",chapter:0,payload_json:JSON.stringify({test:!0,from:"settings_test_btn"})};try{const v=await(await fetch(u,{method:"POST",headers:{"Content-Type":"text/plain;charset=utf-8"},body:JSON.stringify(f),redirect:"follow",mode:"cors"})).text();let b=null;try{b=JSON.parse(v)}catch{}b&&b.ok?(U("測試成功！Sheets 已新增一列"),o&&(o.textContent="成功：Sheets 已寫入 test_ping")):(U("GAS 回應異常："+v.slice(0,120)),o&&(o.textContent="GAS 回應："+(b?.error||v.slice(0,80))),console.warn("[analytics] test response",v))}catch(v){console.warn("[analytics] test fetch 失敗",v),G("test_ping",{payload_json:JSON.stringify({test:!0,fallback:!0})}),o&&(o.textContent="網路錯誤，已入隊（查看 Console）"),U("網路錯誤，已入隊重試")}p()}),d?.addEventListener("click",()=>{Ze(),p(),U("已嘗試補送，查看 Console 與 Sheets"),setTimeout(p,800)}),setInterval(p,2e3);try{window.__analyticsRefresh=p}catch{}}function nn(){tn(),Be({onSwitch:Se,onOpenSettings:We,onOpenNotebook:Ge,t:he}),ks(),vr();try{fi()}catch{}fr(),cr();const e=localStorage.getItem("cc_active_view")||"vscode";Se(l.get("unlockedInterfaces").includes(e)?e:"vscode"),ms(),ie.play("default"),l.hasFlag("onboarding_done")||l.setFlag("onboarding_done",!0),l.hasFlag("welcome_dialog_shown")||(l.setFlag("welcome_dialog_shown",!0),setTimeout(()=>hr(),400)),setTimeout(()=>pr(),800),W.on("puzzle:solved",t=>{U("✓ "+t.title);try{G("puzzle_solved",{puzzle:t.id,chapter:t.chapter})}catch{}}),W.on("interfaceUnlocked",t=>{U(he("toast.unlocked")+": "+t),Be({onSwitch:Se,onOpenSettings:We,onOpenNotebook:Ge,t:he});try{G("interface_unlocked",{iface:t})}catch{}}),W.on("evidence",t=>{U(he("toast.evidence")+": "+t.title);try{G("evidence_collected",{evidence:t.id})}catch{}}),l.on("change",()=>tn()),window.addEventListener("ch4:complete",()=>{l.setFlag("ch5_triggered",!0),Be({onSwitch:Se,onOpenSettings:We,onOpenNotebook:Ge,t:he}),setTimeout(()=>{const t=document.getElementById("mailDialog");if(t&&!t.open){const a=document.getElementById("mailTitle"),s=document.getElementById("mailTo");if(a&&s){const n=a.value;n==="Report"?s.value="DEA <dea@world.example>":(n==="Coperation"||n==="Resign")&&(s.value="Sawyer <sawyer@nori-drinks.example>")}t.showModal()}},600)}),window.addEventListener("darknet:exit",()=>{ie.play("default"),l.hasFlag("ch4_all_opened")&&!l.hasFlag("ch5_triggered")?(l.setFlag("ch5_triggered",!0),Be({onSwitch:Se,onOpenSettings:We,onOpenNotebook:Ge,t:he}),setTimeout(()=>{const t=document.getElementById("mailDialog");t&&!t.open&&t.showModal()},400)):l.hasFlag("ch5_triggered")&&((l.get("endings")||[]).length||setTimeout(()=>{const t=document.getElementById("mailDialog");t&&!t.open&&t.showModal()},400))}),l.on("change",t=>{if(t&&t.path&&t.path.includes("ch5_triggered")&&Be({onSwitch:Se,onOpenSettings:We,onOpenNotebook:Ge,t:he}),t&&t.path&&t.path.includes("dark_entered")&&ie.play("darknet"),t&&t.path&&t.path.includes("ch0_vip_fixed")&&!l.hasFlag("ch1_event1_triggered")&&(l.setFlag("ch1_event1_triggered",!0),setTimeout(()=>{B(()=>Promise.resolve().then(()=>ce).then(a=>{a.triggerCh1Event1&&a.triggerCh1Event1()}),void 0)},1e4)),t&&t.path==="currentChapter"&&t.value===2&&!l.hasFlag("ch2_lunch_seq_done")&&setTimeout(()=>{B(()=>Promise.resolve().then(()=>ce).then(a=>{a.triggerCh2LunchSequence&&a.triggerCh2LunchSequence()}),void 0)},600),t&&t.path==="currentChapter")try{vi(t.value),G("chapter_progress",{chapter:t.value})}catch{}if(t&&t.path&&t.path.includes("ch4_all_opened")&&t.value)try{G("ch4_all_opened",{chapter:4})}catch{}}),l.hasFlag("ch0_vip_fixed")&&!l.hasFlag("ch1_event1_triggered")&&(l.setFlag("ch1_event1_triggered",!0),setTimeout(()=>{B(()=>Promise.resolve().then(()=>ce).then(t=>{t.triggerCh1Event1&&t.triggerCh1Event1()}),void 0)},1e4)),l.get("currentChapter")===2&&!l.hasFlag("ch2_lunch_seq_done")&&setTimeout(()=>{B(()=>Promise.resolve().then(()=>ce).then(t=>{t.triggerCh2LunchSequence&&t.triggerCh2LunchSequence()}),void 0)},900),W.on("chapter:changed",t=>{t===2&&!l.hasFlag("ch2_lunch_seq_done")&&setTimeout(()=>{B(()=>Promise.resolve().then(()=>ce).then(a=>{a.triggerCh2LunchSequence&&a.triggerCh2LunchSequence()}),void 0)},600)}),window.addEventListener("jira:ticketAdded",()=>{document.getElementById("jiraBoard")&&B(()=>Promise.resolve().then(()=>ft).then(t=>{W.emit("jira:refresh")}),void 0)}),window.addEventListener("jira:refresh",()=>{try{wa()}catch{}}),document.querySelectorAll("dialog").forEach(t=>{t.addEventListener("click",a=>{a.target===t&&t.close()}),t.addEventListener("cancel",a=>{a.preventDefault(),t.close()}),t.addEventListener("close",()=>{t.style.removeProperty("display")})})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",nn):nn();

//# sourceMappingURL=main-CWUGpo1m.js.map