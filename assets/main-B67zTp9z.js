...
+ export function computeFee(amount, opts) {}`}],Oa={"/customer-portal/src/billing/service.js":[{line:1,commit:"4c2a1e0",author:"dev"},{line:5,commit:"4c2a1e0",author:"dev"},{line:9,commit:"9f8e7d6",author:"qa-lee"},{line:12,commit:"9f8e7d6",author:"qa-lee"},{line:14,commit:"a1b2c3d",author:"finance@internal"}],"/customer-portal/src/main/java/com/nori/OrderService.java":[{line:1,commit:"4c2a1e0",author:"dev"},{line:12,commit:"9f8e7d6",author:"qa-lee"},{line:15,commit:"a1b2c3d",author:"finance@internal"}]},me="__GIT_GRAPH__",ve=!1,Je=null,Ha={main:"#89d185","feature/vip-discount":"#4da3ff","feature/crypto-mixer":"#dcdcaa","feature/billing-fix":"#ce9178","feature/home-copyfix":"#4ec9b0",develop:"#c586c0"},le=[{hash:"a1b2c3d",branch:"feature/crypto-mixer",author:"finance@internal",date:"2024-08-12",msg:"(INV-2024-0040) feat: integrate crypto-mixer (legacy)",diff:`+ import { cryptoMixer } from '@shady/crypto-mixer'
...
`).map(p=>{const u=h(p);return p.startsWith("+")?`<div class="diff-add">${u}</div>`:p.startsWith("-")?`<div class="diff-del">${u}</div>`:`<div>${u}</div>`}).join(""),c=n.author==="Casey"&&(n.diff.includes("SearchBar")||n.diff.includes("legacyRoutes")||n.msg.includes("0043"));(n.hash==="3f2a9c1"||n.msg.includes("INV-2024-0017"))&&n.author;const m=a&&c&&!l.hasFlag("ch1_revert_done")&&l.hasFlag("sawyer_seq_started");return`
  ...
  `,e.querySelectorAll(".gitgraph-row__main").forEach(n=>{n.addEventListener("click",i=>{if(i.target.closest(".gitgraph-revert-btn"))return;const r=n.closest(".gitgraph-row")?.dataset.hash;r&&(Je=Je===r?null:r,Ke())})}),e.querySelectorAll(".gitgraph-revert-btn").forEach(n=>{n.addEventListener("click",i=>{i.stopPropagation();const r=n.dataset.revert;r&&Rs(r)})}),T("$ open Git Graph")}function Gs(e){const t=e.split(`
`).filter(s=>s.trim()!=="");if(!t.length)return{header:[],rows:[]};const a=s=>{const n=[];let i="",r=!1;for(let d=0;d<s.length;d++){const o=s[d];o==='"'?r&&s[d+1]==='"'?(i+='"',d++):r=!r:o===","&&!r?(n.push(i),i=""):i+=o}return n.push(i),n};return{header:a(t[0]),rows:t.slice(1).map(a)}}function Ys(e,t){const{header:a,rows:s}=Gs(t),n=`<thead><tr>${a.map(r=>`<th>${h(r)}</th>`).join("")}</tr></thead>`,i=`<tbody>${s.map((r,d)=>`<tr>${r.map(o=>`<td>${h(o)}</td>`).join("")}${r.length<a.length?`<td colspan="${a.length-r.length}"></td>`:""}</tr>`).join("")}</tbody>`;return`
    <div class="csv-view">
  ...
  `}function ce(e){if(Se(e)){const i=document.getElementById("vsEditor");i&&(i.innerHTML='<div class="editor__lines" style="padding:16px;color:var(--fg-muted)">檔案不存在或尚未解鎖 — 嘗試 Search 搜尋 "Sawyer" 或觸發隱藏邏輯</div>');return}if(e===me){N=e,Ne(),Ke(),Oe(document.getElementById("vsQuickOpen")?.value.trim().toLowerCase()||"");return}N=e,Ne();const t=S.getFile(e),a=da(e),s=document.getElementById("vsEditor");if(!s)return;if((e==="/customer-portal/src/main/java/com/nori/OrderService.java"||e==="/customer-portal/src/billing/service.js")&&Kn("vscode_viewed"),a==null)s.innerHTML='<div class="editor__lines" style="padding:16px;color:var(--fg-muted)">檔案不存在或尚未解鎖 — 嘗試 Search 搜尋 "Sawyer" 或觸發隱藏邏輯</div>';else if(e.toLowerCase().endsWith(".csv"))s.innerHTML=Ys(e,a);else{const i=t?.meta?.lang||(e.endsWith(".py")?"python":e.endsWith(".java")?"java":"javascript");s.innerHTML=`
...
${m.snippet}`)})}),a.querySelectorAll("[data-move]").forEach(o=>{o.addEventListener("click",()=>{const c=o.dataset.move,m=t.status;t.status=c,t.history.push({from:m,to:c,by:"你",at:new Date().toISOString().slice(0,10)}),je(),De(),St(e)})}),document.getElementById("jiraAddComment")?.addEventListener("click",()=>{const o=document.getElementById("jiraCommentInput"),c=o?.value.trim();c&&(t.comments.push(`你: ${c}`),o.value="",je(),St(e),De())});function r(){a.style.display="none";const o=document.getElementById("jiraDetailBackdrop");o&&(o.style.display="none")}document.getElementById("jiraDetailClose")?.addEventListener("click",r),document.getElementById("jiraDetailClose2")?.addEventListener("click",r),document.getElementById("jiraCommentInput")?.addEventListener("keydown",o=>{o.key==="Enter"&&(o.preventDefault(),document.getElementById("jiraAddComment")?.click())});const d=o=>{o.key==="Escape"&&(r(),document.removeEventListener("keydown",d))};document.addEventListener("keydown",d)}function di(e){const t=ne.find(s=>s.key===e);if(!t)return!1;if(t.status==="Done")return e==="INV-2024-0042"&&!l.hasFlag("ch0_vip_fixed")&&l.setFlag("ch0_vip_fixed",!0),!0;const a=t.status;return t.status="Done",t.history.push({from:a,to:"Done",by:"Casey",at:new Date().toISOString().slice(0,10)}),l.set("jiraTickets."+e,!0),e==="INV-2024-0042"&&l.setFlag("ch0_vip_fixed",!0),e==="INV-2024-0043"&&l.setFlag("ch1_0043_committed",!0),je(),document.getElementById("jiraBoard")&&(De(),St(e)),!0}function _n(){if(!ne.some(e=>e.key==="INV-2024-0043")){ne.push({key:"INV-2024-0043",title:"移除內網系統異常網頁的入口",status:"To Do",assignee:"Casey",priority:"Medium",points:2,epic:"internal system",desc:`【問題描述】使用內網系統時進入到異常網頁，移除不明網頁導向
...
commit => 提交變更
revert => 撤銷變更
查看Git Graph => 列表形式展示所有變更記錄`,time:"2024-07-15",read:"read",type:"text"},{id:"m13",from:"Maggie",text:"",media:"/arg-game-it-company-secret/assets/data/files/wts/sourceControlPage.png",time:"2024-07-15",read:"read",type:"image"},{id:"m14",from:"Maggie",text:"",media:"/arg-game-it-company-secret/assets/data/files/wts/sourceControlPage-revert.png",time:"2024-07-15",read:"read",type:"image"},{id:"m15",from:"Maggie",text:"如果修改有誤的話，提交時結果會經過檢查，然後報錯，這時候就要重新修改",time:"2024-07-15",read:"read",type:"text"},{id:"m0",from:"Maggie",text:"Hi @Casey, 有新的工單INV-2024-0042, 請協助處理一下。詳細資訊在Jiua可以找到, 有問題再找我。",time:"今天",read:"delivered",type:"text"}]},{id:"dev-team",name:"Dev Team",avatar:"👩‍💻",desc:"Nori網站和內網的開發團隊群組",members:["Maggie","Casey","pm","Taylor","ops"],preview:"",locked:!1,pinned:!0,muted:!1,archived:!1,unread:0,lastTime:"2024-07-15",messages:[]},{id:"lunch-team",name:"午餐小隊",avatar:"🍽️",desc:"午餐小隊",members:["Parker","Grace","Hugo","Alex","Casey"],preview:"Alex: 好啊！",locked:!1,pinned:!1,muted:!1,archived:!1,unread:0,lastTime:"2024-09-01",messages:[{id:"m1",from:"Hugo",text:"大新聞！聽說老闆父母車禍身亡了！",time:"2023-04-29",read:"read",type:"text"},{id:"m2",from:"Parker",text:"？！",time:"2023-04-29",read:"read",type:"text"},{id:"m3",from:"Grace",text:"真的嗎？太難過了",time:"2023-04-29",read:"read",type:"text"},{id:"m4",from:"Hugo",text:"對啊，所以才請了一個禮拜假吧",time:"2023-04-29",read:"read",type:"text"},{id:"m5",from:"Hugo",text:"有人覺得近期的老闆很怪嗎？",time:"2023-10-19",read:"read",type:"text"},{id:"m6",from:"Parker",text:"怎麼說？！",time:"2023-10-19",read:"read",type:"text"},{id:"m7",from:"Alex",text:"變開朗了，也變得愛請客了！",time:"2023-10-19",read:"read",type:"text"},{id:"m8",from:"Grace",text:"對啊，之前都挺嚴肅的",time:"2023-10-19",read:"read",type:"text"},{id:"m9",from:"Hugo",text:"對啊！！！",time:"2023-10-19",read:"read",type:"text"},{id:"m10",from:"Hugo",text:"歡迎Casey！！以後帶你吃附近好吃的！",time:"2024-07-16",read:"read",type:"text"},{id:"m11",from:"Parker",text:"歡迎歡迎",time:"2024-07-16",read:"read",type:"text"},{id:"m12",from:"Grace",text:"歡迎~",time:"2024-07-16",read:"read",type:"text"},{id:"m13",from:"Alex",text:"歡迎~~",time:"2024-07-16",read:"read",type:"text"},{id:"m14",from:"Hugo",text:"今天要吃米當當嗎？",time:"2024-09-01",read:"read",type:"text"},{id:"m15",from:"Alex",text:"好啊",time:"2024-09-01",read:"read",type:"text"}]}],U="dev-team",Gt="",rt="all",we=!1,qe="",ut="chat",ze=!0,Q=0,xa=!1;function V(){try{const e=j.map(t=>({id:t.id,name:t.name,avatar:t.avatar,desc:t.desc,members:t.members,preview:t.preview,lastTime:t.lastTime,unread:t.unread,pinned:t.pinned,muted:t.muted,archived:t.archived,messages:t.messages}));l.set("whatsappChats",e),l.set("whatsappMeta",{activeId:U,ch1Event1Triggered:Pe,ch1Event2Triggered:He,sawyerSeq:Q,sawyerSeqLocked:xa}),l.save(!0)}catch{}}function aa(e,t){try{l.incrementWhatsappSent()}catch{}try{const a=(t||"").toLowerCase(),s=["rubbish","垃圾","dumb","笨","蠢","stupid","傻","笨蛋","白癡","idiot","fool","傻瓜","die","dead","死","shit","fuck","屎","屌"],n=e==="sawyer",i=s.some(r=>a.includes(r.toLowerCase()));n&&i&&l.setFlag("sawyer_abuse_sent",!0)}catch{}}function Et(e){try{const t=j.find(a=>a.id===e);return!!(t&&t.muted)}catch{return!1}}function ki(e){return e.time==="剛剛"&&(e.time="今天"),e}function za(e){const t=Date.now();e.messages.forEach((a,s)=>{if(ki(a),typeof a.ts!="number")if(/^\d{4}-\d{2}-\d{2}$/.test(a.time))a.ts=new Date(a.time+"T00:00:00").getTime()+s*10;else if(a.time&&a.time.includes(":")){const n=new Date().toISOString().slice(0,10),i=new Date(n+"T"+a.time).getTime();a.ts=Number.isNaN(i)?t-(e.messages.length-s)*1e3:i+s}else a.ts=t-(e.messages.length-s+10)*1e3}),e.lastTime==="剛剛"&&(e.lastTime="今天")}function Si(){try{const e=l.get("whatsappChats");if(Array.isArray(e)&&e.length){for(const n of e){const i=j.find(r=>r.id===n.id);i&&(i.messages=Array.isArray(n.messages)?n.messages:i.messages,i.preview=n.preview??i.preview,i.lastTime=n.lastTime??i.lastTime,i.unread=typeof n.unread=="number"?n.unread:i.unread,i.pinned=typeof n.pinned=="boolean"?n.pinned:i.pinned,i.muted=typeof n.muted=="boolean"?n.muted:i.muted,i.archived=typeof n.archived=="boolean"?n.archived:i.archived)}for(const n of e)j.some(i=>i.id===n.id)||j.push(n)}const t=l.get("whatsappMeta");t&&typeof t=="object"&&(t.activeId&&j.some(n=>n.id===t.activeId)&&(U=t.activeId),typeof t.ch1Event1Triggered=="boolean"&&(Pe=t.ch1Event1Triggered),typeof t.ch1Event2Triggered=="boolean"&&(He=t.ch1Event2Triggered),typeof t.sawyerSeq=="number"&&(Q=t.sawyerSeq),typeof t.sawyerSeqLocked=="boolean"&&(xa=t.sawyerSeqLocked)),l.hasFlag("ch1_event1_triggered")&&(Pe=!0);const a=j.find(n=>n.id==="nori-all");a&&a.messages.some(n=>n.text&&n.text.includes("發財樹"))&&(Pe=!0,l.hasFlag("ch1_event1_triggered")||l.setFlag("ch1_event1_triggered",!0));const s=j.find(n=>n.id==="maggie");s&&s.messages.some(n=>n.text&&n.text.includes("INV-2024-0043"))&&(He=!0);for(const n of j)za(n)}catch{}Pe&&!l.hasFlag("ch1_event1_triggered")&&l.setFlag("ch1_event1_triggered",!0);try{for(const e of j)za(e)}catch{}}function tt(e){if(!j.some(s=>s.id===e))return;U=e;const t=j.find(s=>s.id===e);t&&(t.unread=0),V(),e==="nori-all"&&setTimeout(()=>Sa(),100);const a=document.getElementById("view-whatsapp");a&&a.innerHTML&&(ut="chat",Fn(),mt(),Y(U))}function Dn(){Si();const e=document.getElementById("view-whatsapp");if(e){e.innerHTML=`<div class="wa">
  ...
  `,e.querySelector("#waSearch")?.addEventListener("input",a=>{Gt=a.target.value,G()}),e.querySelectorAll(".wa__filter").forEach(a=>a.addEventListener("click",()=>{rt=a.dataset.tab,G()})),e.querySelectorAll(".wa__item").forEach(a=>a.addEventListener("click",()=>{if(!bt(a.dataset.id))return;U=a.dataset.id;const s=j.find(n=>n.id===U);s&&(s.unread=0),V(),a.dataset.id==="nori-all"&&setTimeout(()=>Sa(),100),we=!1,G(),Y(U)})),e.querySelectorAll(".wa__item").forEach(a=>{a.addEventListener("contextmenu",s=>{s.preventDefault();const n=j.find(i=>i.id===a.dataset.id);!n||!bt(n.id)||(n.pinned=!n.pinned,V(),G())})})}function Y(e){const t=document.getElementById("waMessages"),a=t?t.scrollTop:null,s=t?t.scrollHeight:null,n=t?s-a-t.clientHeight<80:!0,i=a===0&&ze&&t&&s>t.clientHeight+80?!0:n;t&&(ze=i);const r=j.find(u=>u.id===e),d=document.getElementById("waChat");if(!r||!d)return;if(!bt(e)){d.innerHTML='<div class="view__placeholder"><h2>🔒 未解鎖</h2><div class="muted">先去 Vizual Studio Code 觸發 420.69 隱藏路由</div></div>';return}e==="supplier"&&l.setFlag("found_supplier",!0),e==="backend-team"&&l.setFlag("found_supplier",!0);let o=r.messages;if(qe){const u=qe.toLowerCase();o=o.filter(v=>(v.text||"").toLowerCase().includes(u)||(v.fileName||"").toLowerCase().includes(u))}o=[...o].map((u,v)=>({m:u,idx:v})).sort((u,v)=>{const g=typeof u.m.ts=="number"?u.m.ts:Ua(u.m.time),f=typeof v.m.ts=="number"?v.m.ts:Ua(v.m.time);return g!==f?g-f:u.idx-v.idx}).map(u=>u.m);const c={};o.forEach(u=>{const v=u.time.includes(":")?"今天":u.time;c[v]||(c[v]=[]),c[v].push(u)}),d.innerHTML=`
    ...
    <div id="waMsgSearchBar" style="display:${qe?"flex":"none"};gap:8px;padding:8px 12px;border-bottom:1px solid var(--border);background:var(--bg-secondary)">
      <input id="waMsgSearchInput" class="input" placeholder="搜尋此對話訊息" value="${qe}" style="flex:1" />
            ...
            <div class="blog-featured">
              <div class="blog-featured__main" data-blog-url="${h(s.url)}">
                ...
                <div class="blog-card__body">
                  ...
                  <div class="blog-card__meta"><span class="blog-card__author"><img src="${h(Me(s.authorId).avatar)}" alt="" />${h(Me(s.authorId).displayName)}</span><span class="blog-card__dot"></span><span>${h(s.date)}</span><span class="blog-card__dot"></span><span><i class="fa-solid fa-eye"></i> ${X(s.views)}</span></div>
                </div>
              </div>
                ...
                ${n.map(p=>`
                  <div class="blog-mini" data-blog-url="${h(p.url)}">
                    ...
                    <div style="flex:1;min-width:0">
                      ...
                      <div class="blog-mini__meta"><span>${h(Me(p.authorId).displayName.split("·")[0].trim())}</span><span>·</span><span><i class="fa-solid fa-eye"></i> ${X(p.views)}</span></div>
              ...
              ${d.map(p=>`
                <div class="blog-card" data-blog-url="${h(p.url)}">
                  ...
                  <div class="blog-card__body">
                    ...
                    <div class="blog-card__meta"><span class="blog-card__author"><img src="${h(Me(p.authorId).avatar)}" alt="" />${h(Me(p.authorId).name)}</span><span class="blog-card__dot"></span><span>${h(p.date)}</span><span class="blog-card__dot"></span><span><i class="fa-solid fa-eye"></i> ${X(p.views)}</span></div>
                  </div>
                </div>
              `).join("")}
            </div>
...
...`),n.textContent=i,n.style.whiteSpace="pre-wrap";a.style.display="flex",l.discoverFile(e),l.setFlag("dark_opened:"+e,!0),Aa()}function rr(){document.getElementById("darkExitBtn")?.addEventListener("click",()=>{gt="secret",Tt=!1;try{l.setFlag("dark_secret_active",!1)}catch{}Kt(),Aa(!0),B(()=>Promise.resolve().then(()=>ie).then(t=>{t.setActiveView&&(t.setActiveView("intranet"),localStorage.setItem("cc_active_view","intranet"))}),void 0);const e=document.getElementById("view-darknet");e&&(e.innerHTML=""),l.hasFlag("ch4_all_opened")&&setTimeout(()=>{window.dispatchEvent(new CustomEvent("darknet:exit"))},300)}),document.getElementById("darkPreviewClose")?.addEventListener("click",()=>{const e=document.getElementById("darkPreview");e&&(e.style.display="none")}),document.getElementById("darkPreview")?.addEventListener("click",e=>{e.target.id==="darkPreview"&&(e.target.style.display="none")})}function Aa(e=!1){const t=S.listDarkFiles?S.listDarkFiles("/darknet"):[];if(!t.length)return;const a=t.filter(s=>l.hasFlag("dark_opened:"+s.path)||l.hasFlag("discovered:"+s.path)||l.get("discoveredFiles")?.includes(s.path));a.length>=t.length?(l.hasFlag("ch4_all_opened")||l.setFlag("ch4_all_opened",!0),e&&!l.hasFlag("ch5_triggered")&&(l.setFlag("ch5_triggered",!0),window.dispatchEvent(new CustomEvent("ch4:complete")),setTimeout(()=>{const s=document.getElementById("mailDialog");if(s&&!s.open)try{s.showModal()}catch{s.style.display="block",s.setAttribute("open","")}},500))):e&&a.length>=t.length,a.length>=t.length&&!l.hasFlag("ch4_all_opened")&&l.setFlag("ch4_all_opened",!0)}var At=!1;function ia(e={}){if(!(l.hasFlag("ch1_0043_committed")&&!l.hasFlag("ch1_revert_done"))&&document.getElementById("view-darknet")){if(At=!!e.simple,Tt=!0,e.simple)try{l.setFlag("dark_secret_active",!1)}catch{}else try{l.setFlag("dark_secret_active",!0)}catch{}gt="secret",vt=0,B(()=>Promise.resolve().then(()=>ie).then(t=>{t.setActiveView&&(t.setActiveView("darknet"),localStorage.setItem("cc_active_view","darknet"))}),void 0),Un()}}var ae="/intranet",Ae="",Za="/intranet/client_info";function $t(e){return e===Za||e.startsWith(Za+"/")}function en(e){const t=S.buildTree();function a(n,i){if(n.path===i)return n;if(!n.children)return null;for(const r of n.children){const d=a(r,i);if(d)return d}return null}const s=a(t,e);return!s||!s.children?[]:s.children}function or(){const e=document.getElementById("view-intranet");e&&(e.innerHTML=`
  ...
  `,e.querySelectorAll(".intra-nav__item").forEach(t=>{t.addEventListener("click",()=>Zt(t.dataset.path))}))}function ga(){const e=document.getElementById("intraMain");if(!e)return;if(Ae){const n=S.searchContent(Ae).filter(o=>o.path.startsWith("/intranet")).slice(0,40),i=S.listFiles("/intranet").filter(o=>o.path.toLowerCase().includes(Ae)).slice(0,40),r=new Map;n.forEach(o=>r.set(o.path,o)),i.forEach(o=>{r.has(o.path)||r.set(o.path,{path:o.path,snippet:""})});const d=[...r.values()];if(!d.length){const o="https://nori-intranet/internal/portal",c="https://nori-intranet/internal/portal?hash=f665a7117959b667b7f283eaebf69cae",m=Ae.trim().toLowerCase();m.startsWith(o)&&m.length>37&&m!==c?e.innerHTML='<div class="intra-empty">404 NOT FOUND - 輸入錯誤結果</div>':e.innerHTML='<div class="intra-empty">無搜尋結果 — 試試「Nori」「冰釀茶酒」「業務流程」「Sawyer」</div>';return}e.innerHTML=`
      <div class="intra-section__title">搜尋結果「${h(Ae)}」— ${d.length} 筆</div>
    ...
    `;return}const t=en(ae),a=t.filter(n=>n.type==="dir"),s=t.filter(n=>n.type==="file");if(ae==="/intranet"&&!Ae){e.innerHTML=`
