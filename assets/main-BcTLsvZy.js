  ...
  `,n.querySelectorAll("[data-view]").forEach(p=>{p.addEventListener("click",()=>{if(p.dataset.view==="email"){const u=document.getElementById("mailDialog");if(u){const v=document.getElementById("mailTitle"),h=document.getElementById("mailTo");if(v&&h){const b=v.value;b==="Report"?h.value="DEA <dea@world.example>":(b==="Coperation"||b==="Resign")&&(h.value="Sawyer <sawyer@nori-drinks.example>")}u.showModal()}return}e(p.dataset.view)})}),n.querySelector('[data-action="settings"]')?.addEventListener("click",t),n.querySelector('[data-action="notebook"]')?.addEventListener("click",a),ni()}var Qt=null;function ni(){function e(){const t=new Date,a=document.getElementById("taskbarTime"),i=document.getElementById("taskbarDate");if(!a||!i)return;const n=t.toLocaleTimeString("zh-TW",{hour:"numeric",minute:"2-digit",hour12:!0}),s="2024/09/02";a.textContent=n,i.textContent=s}e(),Qt&&clearInterval(Qt),Qt=setInterval(e,6e4)}function ii(){document.querySelectorAll("dialog[open]").forEach(n=>{try{n.close()}catch{}n.style.removeProperty("display")});const e=document.getElementById("startMenu");e&&(e.style.display="none");const t=document.getElementById("intraPreview");t&&(t.style.display="none");const a=document.getElementById("darkPreview");a&&(a.style.display="none");const i=document.getElementById("waLightbox");i&&i.classList.remove("open")}function an(e){ii(),localStorage.setItem("cc_active_view",e),document.querySelectorAll(".taskbar__app[data-view]").forEach(t=>{t.classList.toggle("active",t.dataset.view===e)}),document.querySelectorAll(".view").forEach(t=>{t.classList.toggle("active",t.id===`view-${e}`)})}function si(e){const t=document.getElementById("dock");t&&(t.style.display=e?"":"none")}function X(e,t={}){const a=document.getElementById("toasts");if(!a)return;const i=document.createElement("div");i.className="toast",i.textContent=e,t.variant==="error"&&(i.style.background="#7a1f1f"),a.appendChild(i),setTimeout(()=>{i.style.opacity="0",i.style.transform="translateY(4px)",i.style.transition="all .25s",setTimeout(()=>i.remove(),260)},t.duration||2200)}function ri(e,t){const a=new Blob([t],{type:"application/json;charset=utf-8"}),i=URL.createObjectURL(a),n=document.createElement("a");n.href=i,n.download=e,n.click(),URL.revokeObjectURL(i)}function oi(e){return new Promise((t,a)=>{const i=new FileReader;i.onload=()=>t(i.result),i.onerror=a,i.readAsText(e)})}var li={default:"/arg-game-it-company-secret/assets/data/music/Teacup Corridor (warmer).mp3",darknet:"/arg-game-it-company-secret/assets/data/music/Teacup Corridor.mp3",cooperate:"/arg-game-it-company-secret/assets/data/music/bgm_cowork.mp3",flee:"/arg-game-it-company-secret/assets/data/music/bgm_flee.mp3",fried:"/arg-game-it-company-secret/assets/data/music/bgm_fried.mp3",report:"/arg-game-it-company-secret/assets/data/music/bgm_report.mp3",resign:"/arg-game-it-company-secret/assets/data/music/bgm_resign.mp3"},ci=.25,La=1500,di=class{constructor(){this.audio=null,this.currentBgm=null,this.isMuted=!1,this.volume=ci,this.fadeTimer=null,this._loadSettings()}_loadSettings(){const e=l.get("settings");e&&(typeof e.bgmVolume=="number"&&(this.volume=e.bgmVolume),typeof e.bgmMuted=="boolean"&&(this.isMuted=e.bgmMuted))}_saveSettings(){l.set("settings.bgmVolume",this.volume),l.set("settings.bgmMuted",this.isMuted)}_createAudio(e){const t=new Audio(e);return t.loop=!0,t.preload="auto",t.volume=this.isMuted?0:this.volume,t}_fadeVolume(e,t,a,i){this.fadeTimer&&cancelAnimationFrame(this.fadeTimer);const n=performance.now(),s=r=>{const d=r-n,o=Math.min(d/a,1),c=e+(t-e)*o;this.audio&&(this.audio.volume=this.isMuted?0:c),o<1?this.fadeTimer=requestAnimationFrame(s):(this.fadeTimer=null,i&&i())};this.fadeTimer=requestAnimationFrame(s)}_stopCurrent(e=!0){if(!this.audio)return Promise.resolve();const t=this.audio,a=t.volume;return e&&a>0?new Promise(i=>{this._fadeVolume(a,0,La,()=>{t.pause(),t.src="",i()})}):(t.pause(),t.src="",Promise.resolve())}async play(e){const t=li[e];if(t&&this.currentBgm!==e){await this._stopCurrent(!0),this.currentBgm=e,this.audio=this._createAudio(t);try{await this.audio.play(),this._fadeVolume(0,this.volume,La)}catch(a){console.warn("BGM play failed:",a)}}}async stop(e=!0){await this._stopCurrent(e),this.audio=null,this.currentBgm=null}setVolume(e){this.volume=Math.max(0,Math.min(1,e)),this.audio&&!this.isMuted&&(this.audio.volume=this.volume),this._saveSettings()}getVolume(){return this.volume}toggleMute(){return this.isMuted=!this.isMuted,this.audio&&(this.audio.volume=this.isMuted?0:this.volume),this._saveSettings(),this.isMuted}setMuted(e){this.isMuted=e,this.audio&&(this.audio.volume=this.isMuted?0:this.volume),this._saveSettings()}isMutedState(){return this.isMuted}getCurrentBgm(){return this.currentBgm}},ie=new di;function We(){const e=document.getElementById("settingsDialog");e&&(typeof e.showModal=="function"?e.open||e.showModal():typeof e.show=="function"?e.open||e.show():(e.style.display="block",e.setAttribute("open","")),e.style.removeProperty("display"),pi())}function pi(){const e=document.getElementById("settingTheme");e&&(e.value=l.get("settings.theme"));const t=document.getElementById("settingPlaytime");t&&(t.textContent=String(l.get("playtime"))+"s")}function ui(){document.getElementById("settingTheme")?.addEventListener("change",i=>{const n=i.target.value;l.set("settings.theme",n),document.documentElement.setAttribute("data-theme",n),X(he("toast.saved"))});const e=document.getElementById("bgmMuteBtn"),t=document.getElementById("bgmVolumeSlider"),a=document.getElementById("bgmVolumePct");e&&!e._bound&&(e._bound=!0,e.addEventListener("click",()=>{const i=ie.toggleMute();e.textContent=i?"🔇":"🔊",a&&(a.textContent=i?"靜音":Math.round(ie.getVolume()*100)+"%")})),t&&!t._bound&&(t._bound=!0,t.addEventListener("input",i=>{const n=parseInt(i.target.value)/100;ie.setVolume(n),ie.setMuted(!1),e&&(e.textContent="🔊"),a&&(a.textContent=Math.round(n*100)+"%")})),document.getElementById("btnExport")?.addEventListener("click",()=>{ri("code-conspiracy-save.json",l.exportSave())}),document.getElementById("btnImport")?.addEventListener("change",async i=>{const n=i.target.files?.[0];if(!n)return;const s=await oi(n),r=l.importSave(s);X(r?he("toast.saved"):"Import failed",{variant:r?void 0:"error"}),r&&location.reload()}),document.getElementById("btnReset")?.addEventListener("click",async()=>{if(confirm("Reset all progress?")){try{l.reset()}catch{}try{localStorage.removeItem("code_conspiracy_state")}catch{}try{localStorage.clear()}catch{}const i=document.getElementById("settingsDialog");if(i&&i.open)try{i.close()}catch{}i&&(i.style.removeProperty("display"),i.removeAttribute("open"));try{if("caches"in window){const n=await caches.keys();await Promise.all(n.map(s=>caches.delete(s)))}if("serviceWorker"in navigator){const n=await navigator.serviceWorker.getRegistrations();await Promise.all(n.map(s=>s.unregister()))}}catch{}setTimeout(()=>{window.location.href=window.location.pathname+"?reset="+Date.now(),window.location.reload(!0)},150)}}),document.getElementById("settingsDialog")?.addEventListener("close",()=>{})}var Ta=["教學","異常發現","自由探索","暗網入口","秘密曝光","抉擇"],mi=13,gi={vscode:"Vizual",jira:"Jiua",whatsapp:"WhatUp",search:"Search",intranet:"Intranet",darknet:"Darknet",email:"Email"};function hi(e){return!e||!e.length?"—":e.map(t=>gi[t]||t).join(", ")}function vi(e){return e=Number(e)||0,e<=59?`${e} 秒`:e<3600?`${Math.floor(e/60)} 分鐘`:e<86400?`${Math.floor(e/3600)} 小時`:`${Math.floor(e/86400)} 日`}function fi(){const e=l.get("readArticles")||[],t=l.get("discoveredFiles")||[],a=l.get("endings")||l.get("unlockedEndings")||[],i=l.get("whatsappSentCount")||0,n=l.get("persistentStats")||{},s=n.readArticles||[],r=n.darkFileCount||0,d=n.whatsappSentCount||0,o=n.searchHistoryCount||0,c=n.flags||{},m=["https://sawyer-blog.example/2001-10-18","https://sawyer-blog.example/2003-04-27","https://sawyer-blog.example/2004-11-13","https://sawyer-blog.example/2006-09-01","https://sawyer-blog.example/2007-01-11","https://sawyer-blog.example/2007-01-12","https://sawyer-blog.example/2010-06-06","https://sawyer-blog.example/2012-07-07","https://sawyer-blog.example/2013-01-01","https://sawyer-blog.example/2023-04-25","https://sawyer-blog.example/2023-05-01","https://sawyer-blog.example/2023-05-10","https://sawyer-blog.example/2023-12-20","https://sawyer-blog.example/2024-01-15","https://sawyer-blog.example/2024-03-20"],p=["https://school.example/guangzhi-essay-sawyer"],u=["https://news.example/car-accident-2023","https://news.example/car-accident-investigation-2023","https://news.example/ping-wo-suspicious-man-2023","https://news.example/police-clarification-2023"],v=[...m,...p,...u],h=[...m,"https://mary-blog.example/kyoto-sakura-2024","https://mary-blog.example/one-person-kitchen","https://mary-blog.example/danshari-half-year","https://peter-blog.example/python-one-year","https://peter-blog.example/vim-vs-vscode","https://peter-blog.example/nas-ds220","https://peter-blog.example/code-easter-eggs","https://paul-blog.example/tainan-beef-soup","https://paul-blog.example/hand-drip-coffee","https://paul-blog.example/keelung-night-market","https://emma-blog.example/contax-t2-taipei","https://emma-blog.example/iceland-aurora","https://david-blog.example/vinyl-jazz-20","https://david-blog.example/livehouse-map"];let b=10;try{const f=k.listDarkFiles?k.listDarkFiles("/darknet"):[];f.length&&(b=f.length)}catch{}const A=Math.max(t.filter(f=>f.startsWith("/darknet")).length,r),P=Math.max(l.hasFlag("portal_simple_entered")?1:0,c.portal_simple_entered?1:0),oe=Math.max(l.hasFlag("portal_hash_entered")?1:0,c.portal_hash_entered?1:0),E=[...new Set([...e,...s])],_=Math.max(i,d),w=Math.max((l.get("searchHistory")||[]).length,o),y=[...new Set([...a,...l.get("unlockedEndings")||[],...n.unlockedEndings||[]])];return[{id:"secret_entry",title:"解鎖秘密入口",desc:"進入公司秘密內部系統入口",total:2,current:P+oe,isSecret:!1},{id:"boss_whisper",title:"老闆知音",desc:"已了解老闆的一切",total:20,current:v.filter(f=>E.includes(f)).length,isSecret:!1},{id:"too_much",title:"你知道得太多了",desc:"閱讀所有秘密檔案",total:b,current:Math.min(A,b),isSecret:!1},{id:"all_endings",title:"作者感謝您",desc:"解鎖全結局",total:5,current:y.length,isSecret:!1},{id:"social",title:"社牛",desc:"在 WhatUp 發送超過 10 條訊息",total:10,current:Math.min(_,10),isSecret:!0},{id:"reader",title:"閱讀達人",desc:"閱讀 BlogWorld 上的所有部落格",total:29,current:h.filter(f=>E.includes(f)).length,isSecret:!0},{id:"miracle",title:"你沒有被解僱是奇蹟",desc:"向 Sawyer 發送帶有「垃圾」「蠢」等字眼的訊息",total:1,current:Math.max(l.hasFlag("sawyer_abuse_sent")?1:0,c.sawyer_abuse_sent?1:0),isSecret:!0},{id:"net_addict",title:"網路成癮",desc:"在搜尋引擎搜尋超過 50 次",total:50,current:Math.min(w,50),isSecret:!0}].map(f=>({...f,done:f.current>=f.total,progress:`${f.current}/${f.total}`,pct:Math.round(f.current/f.total*100)}))}var Aa=[{id:"flee",idx:1,title:"平凡的日常",desc:"完成工作後登出，回到平凡重複的日常。",color:"#6b778c"},{id:"cooperate",idx:2,title:"共犯",desc:"與老闆合作，踏入充滿刺激與風險的新生活。",color:"#d93025"},{id:"report",idx:3,title:"舉報",desc:"向警方舉報，目睹公司倒閉與風波後的平靜。",color:"#0d9488"},{id:"resign",idx:4,title:"辭職",desc:"遠離是非，主動辭職尋找新的工作與記憶。",color:"#6554c0"},{id:"fried",idx:5,title:"做對了嗎？",desc:"公司已發現你。",color:"#ff991f"}];function Ge(){const e=document.getElementById("notebookDialog");e&&(yi(),typeof e.showModal=="function"?e.open||e.showModal():typeof e.show=="function"?e.open||e.show():(e.setAttribute("open",""),e.style.display="block"),e.style.removeProperty("display"),e._boundClose||(e.addEventListener("close",()=>{e.style.removeProperty("display"),e.removeAttribute("open")}),e._boundClose=!0))}function yi(){const e=document.getElementById("notebookContent");if(!e)return;const t=l.get("collectedEvidence")||[];l.get("flags");const a=l.get("currentChapter")??0,i=fi(),n=i.filter(c=>c.done).length,s=l.get("persistentStats")?.unlockedEndings||[],r=l.get("endings")||l.get("unlockedEndings")||[],d=[...new Set([...r,...s])],o=(()=>{const c=Aa.map(m=>{const p=d.includes(m.id),u="？".repeat([...m.title].length);return`
    ...
    <div class="card" style="margin-top:12px">
      ...
      <div style="display:grid;gap:4px">
        ${Ta.map((c,m)=>`<div style="display:flex;justify-content:space-between;padding:6px 8px;border-radius:6px;background:${m<=a?"var(--bg-tertiary)":"var(--bg-primary)"};border:1px solid var(--border)"><span>Ch${m} ${c}</span><span class="small ${m<a?"":m===a?"badge":""}" style="${m===a?"background:var(--accent);color:#fff":""}">${m<a?"完成":m===a?"進行中":"未開始"}</span></div>`).join("")}
      </div>
    </div>
    ${o}
...
+ restored legacyRoutes`});const n=document.getElementById("scmCommitStatus");n&&(n.innerHTML=`<span style="color:var(--success)">✓ Revert 成功: ${a} (from ${e})</span>`),C(`✓ revert ${a} — ${i}`),Ce(),ye(),Le(),Ne(),fe&&je(),rn("git-graph")}var de=[{hash:"a1b2c3d",author:"finance@internal",date:"2024-08-12",msg:"feat: integrate crypto-mixer (legacy)",diff:`+ import { cryptoMixer } from '@shady/crypto-mixer'
...
+ <h1>Nori 飲品供應 — 用一杯冰釀茶酒，連結人與風味</h1>
- <p>創辦人 蔡梓掦 · 2018 創立</p>
+ <p>創辦人 蔡梓掦 · 2019 創立</p>`},{hash:"d4e5f6a",branch:"main",author:"dev-chen",date:"2023-11-20",msg:"(INV-2023-0039) refactor: simplify portal auth (remove dynamic generator)",diff:"- function generateInternalPortalPath(internalPortalDomain){ \n-     const cid = redis.get('companyId'); \n-     const y = redis.get('year'); \n-     const k = import.meta.env.MD5_KEY; \n-     return internalPortalDomain + '?hash=' + md5(`companyId=${cid}&year=${y}&key=${k}`); // e.g. https://google.com/internal?hash=be78e7542cd6d04e31e80fa8b741aad4\n-     }"}];function on(){const e=se.find(a=>a.hash==="d4e5f6a");e&&!e.diff.includes("e.g. https://google.com/internal?hash=")&&(e.diff=e.diff.replace("md5(`companyId=${cid}&year=${y}&key=${k}`);","md5(`companyId=${cid}&year=${y}&key=${k}`); // e.g. https://google.com/internal?hash=be78e7542cd6d04e31e80fa8b741aad4"));const t=de.find(a=>a.hash==="d4e5f6a");t&&t.diff&&!t.diff.includes("e.g. https://google.com")&&(t.diff=e.diff)}on();function Ce(){try{const e=Array.from(R.entries());l.set("vscodeState",{editedFiles:e,gitCommits:de.slice(0,20),gitGraphCommits:se.slice(0,20),currentFile:F,activeActivity:Z,gitGraphOpen:fe,expandedGraphHash:Qe}),l.save(!0)}catch{}}function ln(e){try{const t=JSON.parse(localStorage.getItem("code_conspiracy_state")||"{}").whatsappChats;if(Array.isArray(t)){const a=t.find(i=>i.id===e);if(a)return!!a.muted}return!1}catch{return!1}}function Ci(){try{const e=l.get("vscodeState");if(!e||typeof e!="object")return;if(Array.isArray(e.editedFiles))for(const[t,a]of e.editedFiles){R.set(t,a);const i=k.getFile(t);i?i.content=a:k.registerFile(t,{content:a,meta:{lang:t.endsWith(".java")?"java":t.endsWith(".js")?"javascript":"text"}})}if(Array.isArray(e.gitCommits)&&e.gitCommits.length){de.length=0;for(const t of e.gitCommits)de.push(t)}if(Array.isArray(e.gitGraphCommits)&&e.gitGraphCommits.length){se.length=0;for(const t of e.gitGraphCommits)se.push(t)}try{on()}catch{}typeof e.currentFile=="string"&&e.currentFile&&(F=e.currentFile),typeof e.activeActivity=="string"&&(Z=e.activeActivity),typeof e.gitGraphOpen=="boolean"&&(fe=e.gitGraphOpen),e.expandedGraphHash&&(Qe=e.expandedGraphHash)}catch{}}function Li(){Ci();const e=document.getElementById("view-vscode");e&&(e.innerHTML=`
    <div class="vscode">
...
`).map(p=>{const u=g(p);return p.startsWith("+")?`<div class="diff-add">${u}</div>`:p.startsWith("-")?`<div class="diff-del">${u}</div>`:`<div>${u}</div>`}).join(""),c=n.author==="Casey"&&(n.diff.includes("SearchBar")||n.diff.includes("legacyRoutes")||n.msg.includes("0043"));(n.hash==="3f2a9c1"||n.msg.includes("INV-2024-0017"))&&n.author;const m=a&&c&&!l.hasFlag("ch1_revert_done")&&l.hasFlag("sawyer_seq_started");return`
  ...
  `,e.querySelectorAll(".gitgraph-row__main").forEach(n=>{n.addEventListener("click",s=>{if(s.target.closest(".gitgraph-revert-btn"))return;const r=n.closest(".gitgraph-row")?.dataset.hash;r&&(Qe=Qe===r?null:r,je())})}),e.querySelectorAll(".gitgraph-revert-btn").forEach(n=>{n.addEventListener("click",s=>{s.stopPropagation();const r=n.dataset.revert;r&&Ii(r)})}),C("$ open Git Graph")}function $i(e){const t=e.split(`
...
`);let s=0;for(let r=0;r<Math.min(e-1,n.length);r++)s+=n[r].length+1;t.focus(),t.setSelectionRange(s,s);return}const a=document.getElementById("vsEditor");if(!a)return;const i=a.querySelector(`[data-ln="${e}"]`);i&&i.scrollIntoView({behavior:"smooth",block:"center"})}var ht=pa({addTicket0043:()=>un,getTickets:()=>Ji,markTicketDone:()=>Yi,mountJira:()=>ga}),ae=[{key:"INV-2024-0017",title:"官網首頁文案顯示錯誤 — Hero 標語與成立年份顯示錯誤",status:"Done",assignee:"Parker",priority:"Medium",points:2,epic:"Frontend",desc:`【問題描述】
...
JQL: sprint = 24 AND status != Done`,comments:[],attachments:[],history:[]},{key:"INV-2020-0003",title:"人力資源系統 — 關閉系統",status:"Done",assignee:"deleted user",priority:"High",points:3,epic:"HR",desc:"人力資源管理系統將遷移到Zero System, 此系統將永久關閉。關閉前需確保所有資料已成功備份到新系統",comments:["deleted user: 已完成關閉"],attachments:[],history:[{from:"To Do",to:"Done",by:"deleted user",at:"2020-02-28"}]}],Nt=null,_t="all",wt="";function Oe(){try{l.set("jiraTicketsData",JSON.parse(JSON.stringify(ae))),l.set("jiraMeta",{activeSwimlane:_t,currentFilter:wt}),l.save(!0)}catch{}}function qi(){try{const e=l.get("jiraTicketsData");if(Array.isArray(e)&&e.length){ae.length=0;for(const a of e)ae.push(a)}else if((l.hasFlag("ch1_event1_triggered")||l.get("jiraTickets")&&l.get("jiraTickets")["INV-2024-0043"])&&!ae.some(a=>a.key==="INV-2024-0043")){un();return}const t=l.get("jiraMeta");if(t&&typeof t=="object"&&(typeof t.activeSwimlane=="string"&&(_t=t.activeSwimlane),typeof t.currentFilter=="string"&&(wt=t.currentFilter)),l.hasFlag("ch0_vip_fixed")){const a=ae.find(i=>i.key==="INV-2024-0042");a&&a.status!=="Done"&&(a.status="Done")}if(l.hasFlag("ch1_0043_committed")){const a=ae.find(i=>i.key==="INV-2024-0043");a&&a.status!=="Done"&&(a.status="Done")}}catch{}}function ga(){qi();const e=document.getElementById("view-jira");e&&(e.innerHTML=`
  ...
  `,zi(),He(),document.getElementById("jiraDetailBackdrop")?.addEventListener("click",()=>{document.getElementById("jiraDetail").style.display="none",document.getElementById("jiraDetailBackdrop").style.display="none"}))}function zi(){document.getElementById("jiraSearch")?.addEventListener("input",e=>{wt=e.target.value,Oe(),He()}),document.getElementById("jiraAssignee")?.addEventListener("change",e=>{wt=document.getElementById("jiraSearch").value,Oe(),He()}),document.getElementById("jiraSwimlane")?.addEventListener("change",e=>{_t=e.target.value,Oe(),He()})}function Ui(e){if(!e.trim())return()=>!0;const t=e.split(/\s+AND\s+/i).map(a=>{const i=a.match(/^\s*(status|assignee|key|epic|text|priority)\s*(=|~)\s*"?([^"]+)"?\s*$/i);if(!i){const o=a.toLowerCase().replace(/["']/g,"");return c=>(c.key+c.title+c.desc+c.assignee+c.epic).toLowerCase().includes(o)}const[,n,s,r]=i,d=r.trim().replace(/^"|"$/g,"").toLowerCase();return o=>{const c=n.toLowerCase();let m="";return c==="status"?m=o.status.toLowerCase():c==="assignee"?m=o.assignee.toLowerCase():c==="key"?m=o.key.toLowerCase():c==="epic"?m=o.epic.toLowerCase():c==="priority"?m=o.priority.toLowerCase():c==="text"&&(m=(o.key+" "+o.title+" "+o.desc).toLowerCase()),s==="="?m===d:m.includes(d)}});return a=>t.every(i=>i(a))}function He(){const e=document.getElementById("jiraBoard");if(!e)return;const t=document.getElementById("jiraAssignee")?.value||"",a=Ui(wt);let i=ae.filter(n=>a(n));if(t&&(i=i.filter(n=>n.assignee===t)),_t!=="all"){const n=_t,s={};i.forEach(r=>{const d=r[n]||"未分類";s[d]||(s[d]=[]),s[d].push(r)}),e.innerHTML=Object.entries(s).map(([r,d])=>{const o={"To Do":[],"In Progress":[],Done:[]};return d.forEach(c=>o[c.status]?.push(c)),`
        <div class="jira__swimlane">
          ...
          <div class="jira__board">
            ${Object.entries(o).map(([c,m])=>ja(c,m)).join("")}
          </div>
        </div>
      `}).join("")||'<div class="muted small" style="padding:12px">無符合條件的票據 — 試 JQL: status = "To Do"</div>'}else{const n={"To Do":[],"In Progress":[],Done:[]};i.forEach(s=>n[s.status]?.push(s)),e.innerHTML=Object.entries(n).map(([s,r])=>ja(s,r)).join("")}Gi()}function ja(e,t){return`
  ...
  `}function pn(e){return e.key.includes("0042")||e.epic==="Billing"?{cls:"story",icon:"fa-solid fa-bookmark",label:"Story"}:e.epic==="HR"||e.key.includes("0003")?{cls:"task",icon:"fa-solid fa-square-check",label:"Task"}:e.epic==="Frontend"?{cls:"task",icon:"fa-solid fa-square-check",label:"Task"}:e.priority==="High"&&e.status!=="Done"?{cls:"bug",icon:"fa-solid fa-bug",label:"Bug"}:{cls:"story",icon:"fa-solid fa-bookmark",label:"Story"}}function Wi(e){const t=pn(e),a=e.priority==="High"?"High":e.priority==="Medium"?"Medium":"Low",i=e.priority==="High"?"fa-solid fa-angle-up":e.priority==="Medium"?"fa-solid fa-equals":"fa-solid fa-angle-down",n=e.assignee?e.assignee.charAt(0).toUpperCase():"?",s=e.assignee==="Casey"?"#0052cc":e.assignee==="Parker"?"#0065ff":e.assignee==="Jessie"?"#6554c0":"#6b778c";return`
...
${m.snippet}`)})}),a.querySelectorAll("[data-move]").forEach(o=>{o.addEventListener("click",()=>{const c=o.dataset.move,m=t.status;t.status=c,t.history.push({from:m,to:c,by:"你",at:new Date().toISOString().slice(0,10)}),Oe(),He(),xt(e)})}),document.getElementById("jiraAddComment")?.addEventListener("click",()=>{const o=document.getElementById("jiraCommentInput"),c=o?.value.trim();c&&(t.comments.push(`你: ${c}`),o.value="",Oe(),xt(e),He())});function r(){a.style.display="none";const o=document.getElementById("jiraDetailBackdrop");o&&(o.style.display="none")}document.getElementById("jiraDetailClose")?.addEventListener("click",r),document.getElementById("jiraDetailClose2")?.addEventListener("click",r),document.getElementById("jiraCommentInput")?.addEventListener("keydown",o=>{o.key==="Enter"&&(o.preventDefault(),document.getElementById("jiraAddComment")?.click())});const d=o=>{o.key==="Escape"&&(r(),document.removeEventListener("keydown",d))};document.addEventListener("keydown",d)}function Yi(e){const t=ae.find(i=>i.key===e);if(!t)return!1;if(t.status==="Done")return e==="INV-2024-0042"&&!l.hasFlag("ch0_vip_fixed")&&l.setFlag("ch0_vip_fixed",!0),!0;const a=t.status;return t.status="Done",t.history.push({from:a,to:"Done",by:"Casey",at:new Date().toISOString().slice(0,10)}),l.set("jiraTickets."+e,!0),e==="INV-2024-0042"&&l.setFlag("ch0_vip_fixed",!0),e==="INV-2024-0043"&&l.setFlag("ch1_0043_committed",!0),Oe(),document.getElementById("jiraBoard")&&(He(),xt(e)),!0}function un(){if(!ae.some(e=>e.key==="INV-2024-0043")){ae.push({key:"INV-2024-0043",title:"移除內網系統異常網頁的入口",status:"To Do",assignee:"Casey",priority:"Medium",points:2,epic:"internal system",desc:`【問題描述】使用內網系統時進入到異常網頁，移除不明網頁導向
...
const legacyRoutes = { archive: "/internal/portal" ... } // No longer used`}],history:[{from:"—",to:"To Do",by:"Maggie",at:new Date().toISOString().slice(0,10)}]}),Oe(),document.getElementById("jiraBoard")&&window.dispatchEvent(new CustomEvent("jira:ticketAdded",{detail:"INV-2024-0043"}));try{const e=new CustomEvent("jira:refresh");window.dispatchEvent(e)}catch{}}}function Ji(){return ae}var Ie="";try{Ie=""}catch{}try{typeof window<"u"&&window.__GAS_URL&&(Ie=window.__GAS_URL)}catch{}var Ki="https://script.google.com/macros/s/REPLACE_WITH_YOUR_DEPLOY_ID/exec",Qi="REPLACE_WITH_YOUR_DEPLOY_ID",Xi="AKfycbwjzxPakm5HKw4hJGJWw7AZmNZSpVR28QCcxmJr7KPKCSjLcG2_Da7LgBuuGJwVruSU";function vt(e){return e?e.includes(Qi)||e.includes(Xi):!0}function lt(){try{const e=localStorage.getItem("cc_gas_url")||"";if(e&&e.startsWith("https://")&&!vt(e))return e.trim()}catch{}try{if(typeof window<"u"&&window.__GAS_URL&&window.__GAS_URL.startsWith("https://")&&!vt(window.__GAS_URL))return window.__GAS_URL.trim()}catch{}return Ie&&Ie.startsWith("https://")&&!vt(Ie)?Ie.trim():Ki}function mn(e){try{const t=(e||"").trim();t?localStorage.setItem("cc_gas_url",t):localStorage.removeItem("cc_gas_url");try{typeof window<"u"&&(window.__GAS_URL=t)}catch{}}catch{}}function Te(){const e=lt();return e&&e.startsWith("https://")&&!vt(e)}var qt="cc_analytics_consent",Da="cc_sid",gn="cc_analytics_queue";function Ve(){try{return localStorage.getItem(qt)==="1"}catch{return!1}}function Vt(e){try{e?localStorage.setItem(qt,"1"):localStorage.setItem(qt,"0")}catch{}e&&setTimeout(()=>Xe(),500)}function hn(){try{const e=localStorage.getItem(qt);return e==="1"||e==="0"}catch{return!1}}function vn(){try{let e=localStorage.getItem(Da);return e||(e=crypto.randomUUID&&crypto.randomUUID()||"sid_"+Date.now()+"_"+Math.random().toString(36).slice(2,9),localStorage.setItem(Da,e)),e}catch{return"anon_"+Date.now()}}function ha(e){if(!e)return"";let t=5381;for(let a=0;a<e.length;a++)t=(t<<5)+t^e.charCodeAt(a);return(t>>>0).toString(16).padStart(8,"0")}function Zi(){let e=0,t=0,a="zh-TW";try{e=l.get("currentChapter")??0}catch{}try{t=l.get("playtime")??0}catch{}try{a=l.get("settings.language")||"zh-TW"}catch{}return{chapter:e,playtime:t,lang:a}}function Je(){try{const e=localStorage.getItem(gn);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t:[]}catch{return[]}}function Ke(e){try{localStorage.setItem(gn,JSON.stringify(e.slice(-50)))}catch{}}function Xe(){if(!Te()||!Ve())return;const e=Je();if(!e.length)return;const t=e.slice(0,10);Ke(e.slice(10)),t.forEach(a=>fn(a,!0))}function fn(e,t=!1){const a=lt();if(!Te()){console.warn("[analytics] GAS_URL 未設定，跳過上報",e);return}if(!Ve()){if(!t){const n=Je();n.push(e),Ke(n)}return}const i=JSON.stringify(e);try{if(navigator.sendBeacon){const n=new Blob([i],{type:"text/plain;charset=utf-8"});if(navigator.sendBeacon(a,n))return}}catch{}try{fetch(a,{method:"POST",headers:{"Content-Type":"text/plain;charset=utf-8"},body:i,keepalive:!0,redirect:"follow",mode:"cors"}).then(n=>{if(!n.ok)throw new Error("GAS status "+n.status);t||setTimeout(()=>Xe(),1e3)}).catch(n=>{if(console.warn("[analytics] 發送失敗，已入隊重試",n),t){const s=Je();s.unshift(e),Ke(s)}else{const s=Je();s.push(e),Ke(s)}})}catch{const s=Je();s.push(e),Ke(s)}}function ne(e,t={}){const a=Zi(),i=vn(),n={timestamp:new Date().toISOString(),session_id:i,event_type:e,chapter:a.chapter,playtime:a.playtime,lang:a.lang,ua:typeof navigator<"u"?navigator.userAgent.slice(0,200):"",url:typeof location<"u"?location.href.slice(0,300):"",...t};if(n.payload_json&&typeof n.payload_json=="string"&&n.payload_json.length>4e3&&(n.payload_json=n.payload_json.slice(0,4e3)),!Ve()){const s=Je();s.push(n),Ke(s);return}if(!Te()){const s=Je();s.push(n),Ke(s),console.warn("[analytics] 已記錄至本地隊列，待設定 GAS_URL 後自動上報",n);return}fn(n)}function Xt({chatId:e,chatName:t,text:a,to:i}){const n=(a||"").slice(0,80),s=ha(a||"");ne("whatsapp_send",{whatsapp_chat_id:e,whatsapp_chat_name:t||e,whatsapp_to:i||"",whatsapp_preview:n,whatsapp_hash:s,whatsapp_len:(a||"").length,payload_json:JSON.stringify({chatId:e,preview:n,len:(a||"").length})})}function es({title:e,to:t,body:a}){const i=(a||"").slice(0,80),n=ha(a||"");ne("email_submit",{email_title:e||"",email_to:(t||"").slice(0,100),email_body_preview:i,email_body_hash:n,email_body_len:(a||"").length,payload_json:JSON.stringify({title:e,preview:i,len:(a||"").length})})}function yn(e){ne("ending_unlocked",{ending:e,endings:(l.get("endings")||[]).join(","),payload_json:JSON.stringify({ending:e,all:l.get("endings")})})}function ts(e){ne("chapter_changed",{chapter:e,payload_json:JSON.stringify({chapter:e})})}function as(){try{const e=localStorage.getItem("cc_gas_url")||"";e&&vt(e)&&localStorage.removeItem("cc_gas_url")}catch{}try{window.__analytics={track:ne,getConsent:Ve,setConsent:Vt,getGasUrl:lt,setGasUrl:mn,isGasConfigured:Te,flushQueue:Xe,hashText:ha,ENV_GAS_URL:Ie||"(empty)"}}catch{}try{console.log("[analytics] init",{hasConsent:Ve(),hasChoice:hn(),gasConfigured:Te(),gasUrl:lt().slice(0,60)+(lt().length>60?"...":""),envGasUrl:Ie?Ie.slice(0,30)+"...":"(empty - 需要在 build 時注入 VITE_GAS_URL)",localStorageUrl:typeof localStorage<"u"&&localStorage.getItem("cc_gas_url")?"已設定":"(empty)"}),Te()||console.warn(`[analytics] GAS_URL 未設定 → 請用以下任一方式設定:
  1) 遊戲內 設定 → 數據追蹤 貼上 URL (立即生效)
  2) 瀏覽器 Console: localStorage.setItem("cc_gas_url","你的exec URL"); location.reload()
  3) GitHub Secrets VITE_GAS_URL (需透過 workflow 在 build 時注入，見 gas/README.md)`)}catch{}setTimeout(()=>Xe(),1500);try{window.addEventListener("online",()=>Xe())}catch{}}var ce=pa({closeWaLightbox:()=>Rt,getChats:()=>ps,markNoriAllRead:()=>ya,mountWhatsApp:()=>bn,openChat:()=>et,openWaLightbox:()=>kn,startSawyerRevertSeq:()=>us,triggerCh1Event1:()=>cs,triggerCh1Event2:()=>Ut,triggerCh2LunchSequence:()=>ba}),j=[{id:"nori-all",name:"Nori 全體",avatar:"🏢",desc:"Nori 全體員工群組",members:["Sawyer","Casey","Maggie","Taylor","Aiko","all"],preview:"Leo:謝謝安排！",locked:!1,pinned:!0,muted:!1,archived:!1,unread:0,lastTime:"2023-06-15",messages:[{id:"m1",from:"Sawyer",text:"各位同事，好消息！我中了六合彩二獎，決定將獎金全數投入公司資金，一起加油！",time:"2023-06-15",read:"read",type:"text"},{id:"m2",from:"Taylor",text:"恭喜老闆！祝以後都順順利利！",time:"2023-06-15",read:"read",type:"text"},{id:"m3",from:"Aiko",text:"太棒了！老闆威武！",time:"2023-06-15",read:"read",type:"text"},{id:"m4",from:"Maggie",text:"恭喜老闆！",time:"2023-06-15",read:"read",type:"text"},{id:"m5",from:"Parker",text:"運也太好了吧？！",time:"2023-06-15",read:"read",type:"text"},{id:"m6",from:"Sawyer",text:"各位同事，告訴大家一個好消息，剛跟可樂樂公司談成一大生意，結為長期合作伙伴。為慶祝近來公司發展順利，決定舉辦晚上派對，詳細資訊稍後公布！",time:"2023-11-01",read:"read",type:"text"},{id:"m7",from:"Aiko",text:"哇！！太好了，一定會去！",time:"2023-11-01",read:"read",type:"text"},{id:"m8",from:"Taylor",text:"太棒了！",time:"2023-11-01",read:"read",type:"text"},{id:"m9",from:"Maggie",text:"恭喜老闆！",time:"2023-11-01",read:"read",type:"text"},{id:"m10",from:"Hugo",text:"一輩子跟隨您！",time:"2023-11-01",read:"read",type:"text"},{id:"m11",from:"Taylor",text:`各位同事，慶祝公司發展順利, 將於11月22日下班後舉辦派對
以下為詳細資訊：
日期：11月22日（五） 
時間：19:00-23:00
...
commit => 提交變更
revert => 撤銷變更
查看Git Graph => 列表形式展示所有變更記錄`,time:"2024-07-15",read:"read",type:"text"},{id:"m13",from:"Maggie",text:"",media:"/arg-game-it-company-secret/assets/data/files/wts/sourceControlPage.png",time:"2024-07-15",read:"read",type:"image"},{id:"m14",from:"Maggie",text:"",media:"/arg-game-it-company-secret/assets/data/files/wts/sourceControlPage-revert.png",time:"2024-07-15",read:"read",type:"image"},{id:"m15",from:"Maggie",text:"如果修改有誤的話，提交時結果會經過檢查，然後報錯，這時候就要重新修改",time:"2024-07-15",read:"read",type:"text"},{id:"m0",from:"Maggie",text:"Hi @Casey, 有新的工單INV-2024-0042, 請協助處理一下。詳細資訊在Jiua可以找到, 有問題再找我。",time:"今天",read:"delivered",type:"text"}]},{id:"dev-team",name:"Dev Team",avatar:"👩‍💻",desc:"Nori網站和內網的開發團隊群組",members:["Maggie","Casey","pm","Taylor","ops"],preview:"",locked:!1,pinned:!0,muted:!1,archived:!1,unread:0,lastTime:"2024-07-15",messages:[]},{id:"lunch-team",name:"午餐小隊",avatar:"🍽️",desc:"午餐小隊",members:["Parker","Grace","Hugo","Alex","Casey"],preview:"Alex: 好啊！",locked:!1,pinned:!1,muted:!1,archived:!1,unread:0,lastTime:"2024-09-01",messages:[{id:"m1",from:"Hugo",text:"大新聞！聽說老闆父母車禍身亡了！",time:"2023-04-29",read:"read",type:"text"},{id:"m2",from:"Parker",text:"？！",time:"2023-04-29",read:"read",type:"text"},{id:"m3",from:"Grace",text:"真的嗎？太難過了",time:"2023-04-29",read:"read",type:"text"},{id:"m4",from:"Hugo",text:"對啊，所以才請了一個禮拜假吧",time:"2023-04-29",read:"read",type:"text"},{id:"m5",from:"Hugo",text:"有人覺得近期的老闆很怪嗎？",time:"2023-10-19",read:"read",type:"text"},{id:"m6",from:"Parker",text:"怎麼說？！",time:"2023-10-19",read:"read",type:"text"},{id:"m7",from:"Alex",text:"變開朗了，也變得愛請客了！",time:"2023-10-19",read:"read",type:"text"},{id:"m8",from:"Grace",text:"對啊，之前都挺嚴肅的",time:"2023-10-19",read:"read",type:"text"},{id:"m9",from:"Hugo",text:"對啊！！！",time:"2023-10-19",read:"read",type:"text"},{id:"m10",from:"Hugo",text:"歡迎Casey！！以後帶你吃附近好吃的！",time:"2024-07-16",read:"read",type:"text"},{id:"m11",from:"Parker",text:"歡迎歡迎",time:"2024-07-16",read:"read",type:"text"},{id:"m12",from:"Grace",text:"歡迎~",time:"2024-07-16",read:"read",type:"text"},{id:"m13",from:"Alex",text:"歡迎~~",time:"2024-07-16",read:"read",type:"text"},{id:"m14",from:"Hugo",text:"今天要吃米當當嗎？",time:"2024-09-01",read:"read",type:"text"},{id:"m15",from:"Alex",text:"好啊",time:"2024-09-01",read:"read",type:"text"}]}],q="dev-team",zt="",st="all",ke=!1,ze="",pt="chat",Ue=!0,J=0,va=!1;function H(){try{const e=j.map(t=>({id:t.id,name:t.name,avatar:t.avatar,desc:t.desc,members:t.members,preview:t.preview,lastTime:t.lastTime,unread:t.unread,pinned:t.pinned,muted:t.muted,archived:t.archived,messages:t.messages}));l.set("whatsappChats",e),l.set("whatsappMeta",{activeId:q,ch1Event1Triggered:De,ch1Event2Triggered:Re,sawyerSeq:J,sawyerSeqLocked:va}),l.save(!0)}catch{}}function Zt(e,t){try{l.incrementWhatsappSent()}catch{}try{const a=(t||"").toLowerCase(),i=["rubbish","垃圾","dumb","笨","蠢","stupid","傻","笨蛋","白癡","idiot","fool","傻瓜","die","dead","死","shit","fuck","屎"],n=e==="sawyer",s=i.some(r=>a.includes(r.toLowerCase()));n&&s&&l.setFlag("sawyer_abuse_sent",!0)}catch{}}function kt(e){try{const t=j.find(a=>a.id===e);return!!(t&&t.muted)}catch{return!1}}function ns(e){return e.time==="剛剛"&&(e.time="今天"),e}function Fa(e){const t=Date.now();e.messages.forEach((a,i)=>{if(ns(a),typeof a.ts!="number")if(/^\d{4}-\d{2}-\d{2}$/.test(a.time))a.ts=new Date(a.time+"T00:00:00").getTime()+i*10;else if(a.time&&a.time.includes(":")){const n=new Date().toISOString().slice(0,10),s=new Date(n+"T"+a.time).getTime();a.ts=Number.isNaN(s)?t-(e.messages.length-i)*1e3:s+i}else a.ts=t-(e.messages.length-i+10)*1e3}),e.lastTime==="剛剛"&&(e.lastTime="今天")}function is(){try{const e=l.get("whatsappChats");if(Array.isArray(e)&&e.length){for(const n of e){const s=j.find(r=>r.id===n.id);s&&(s.messages=Array.isArray(n.messages)?n.messages:s.messages,s.preview=n.preview??s.preview,s.lastTime=n.lastTime??s.lastTime,s.unread=typeof n.unread=="number"?n.unread:s.unread,s.pinned=typeof n.pinned=="boolean"?n.pinned:s.pinned,s.muted=typeof n.muted=="boolean"?n.muted:s.muted,s.archived=typeof n.archived=="boolean"?n.archived:s.archived)}for(const n of e)j.some(s=>s.id===n.id)||j.push(n)}const t=l.get("whatsappMeta");t&&typeof t=="object"&&(t.activeId&&j.some(n=>n.id===t.activeId)&&(q=t.activeId),typeof t.ch1Event1Triggered=="boolean"&&(De=t.ch1Event1Triggered),typeof t.ch1Event2Triggered=="boolean"&&(Re=t.ch1Event2Triggered),typeof t.sawyerSeq=="number"&&(J=t.sawyerSeq),typeof t.sawyerSeqLocked=="boolean"&&(va=t.sawyerSeqLocked)),l.hasFlag("ch1_event1_triggered")&&(De=!0);const a=j.find(n=>n.id==="nori-all");a&&a.messages.some(n=>n.text&&n.text.includes("發財樹"))&&(De=!0,l.hasFlag("ch1_event1_triggered")||l.setFlag("ch1_event1_triggered",!0));const i=j.find(n=>n.id==="maggie");i&&i.messages.some(n=>n.text&&n.text.includes("INV-2024-0043"))&&(Re=!0);for(const n of j)Fa(n)}catch{}De&&!l.hasFlag("ch1_event1_triggered")&&l.setFlag("ch1_event1_triggered",!0);try{for(const e of j)Fa(e)}catch{}}function et(e){if(!j.some(i=>i.id===e))return;q=e;const t=j.find(i=>i.id===e);t&&(t.unread=0),H(),e==="nori-all"&&setTimeout(()=>ya(),100);const a=document.getElementById("view-whatsapp");a&&a.innerHTML&&(pt="chat",_n(),ut(),G(q))}function bn(){is();const e=document.getElementById("view-whatsapp");if(e){e.innerHTML=`<div class="wa">
  ...
  </div>`,ss(),ut(),G(q);try{if(l.get("currentChapter")===2&&!l.hasFlag("ch2_lunch_seq_done")){const t=j.find(a=>a.id==="lunch-team");t&&t.messages.some(a=>a.text&&a.text.includes("剛剛嚇壞了吧"))?l.hasFlag("ch2_lunch_seq_done")||l.setFlag("ch2_lunch_seq_done",!0):setTimeout(()=>{try{ba()}catch{}},900)}}catch{}}}function ss(){const e=document.getElementById("view-whatsapp");e&&e.querySelectorAll(".wa__sidebar-tab[data-wa-tab]").forEach(t=>{t.addEventListener("click",()=>{const a=t.dataset.waTab;a!==pt&&(pt=a,_n(),ut())})})}function _n(){document.querySelectorAll(".wa__sidebar-tab[data-wa-tab]").forEach(e=>{const t=e.dataset.waTab===pt;e.classList.toggle("active",t),e.setAttribute("aria-selected",t?"true":"false")})}function ut(){pt==="account"?rs():W()}function rs(){const e=document.getElementById("waList");e&&(e.innerHTML=`
  ...
  `)}function ft(e){return!0}function os(){let e=[...j];if(zt){const a=zt.toLowerCase();e=e.filter(i=>i.name.toLowerCase().includes(a)||i.preview.toLowerCase().includes(a)||i.desc.toLowerCase().includes(a))}st==="unread"?e=e.filter(a=>a.unread>0&&ft(a.id)):st==="archived"?e=e.filter(a=>a.archived):e=e.filter(a=>!a.archived);const t=["nori-all","dev-team","sawyer","maggie","system-alert","lunch-team"];return e.sort((a,i)=>{const n=t.indexOf(a.id),s=t.indexOf(i.id),r=n===-1?999:n,d=s===-1?999:s;return r!==d?r-d:0}),e}function W(){if(pt!=="chat")return;const e=document.getElementById("waList");if(!e)return;const t=os();e.innerHTML=`
    <div class="wa__list-header">
      ...
      <div class="wa__filters">
        <button class="wa__filter ${st==="all"?"active":""}" data-tab="all">全部</button>
        <button class="wa__filter ${st==="unread"?"active":""}" data-tab="unread">未讀</button>
        <button class="wa__filter ${st==="archived"?"active":""}" data-tab="archived">封存</button>
  ...
  `,e.querySelector("#waSearch")?.addEventListener("input",a=>{zt=a.target.value,W()}),e.querySelectorAll(".wa__filter").forEach(a=>a.addEventListener("click",()=>{st=a.dataset.tab,W()})),e.querySelectorAll(".wa__item").forEach(a=>a.addEventListener("click",()=>{if(!ft(a.dataset.id))return;q=a.dataset.id;const i=j.find(n=>n.id===q);i&&(i.unread=0),H(),a.dataset.id==="nori-all"&&setTimeout(()=>ya(),100),ke=!1,W(),G(q)})),e.querySelectorAll(".wa__item").forEach(a=>{a.addEventListener("contextmenu",i=>{i.preventDefault();const n=j.find(s=>s.id===a.dataset.id);!n||!ft(n.id)||(n.pinned=!n.pinned,H(),W())})})}function G(e){const t=document.getElementById("waMessages"),a=t?t.scrollTop:null,i=t?t.scrollHeight:null,n=t?i-a-t.clientHeight<80:!0,s=a===0&&Ue&&t&&i>t.clientHeight+80?!0:n;t&&(Ue=s);const r=j.find(u=>u.id===e),d=document.getElementById("waChat");if(!r||!d)return;if(!ft(e)){d.innerHTML='<div class="view__placeholder"><h2>🔒 未解鎖</h2><div class="muted">先去 Vizual Studio Code 觸發 420.69 隱藏路由</div></div>';return}e==="supplier"&&l.setFlag("found_supplier",!0),e==="backend-team"&&l.setFlag("found_supplier",!0);let o=r.messages;if(ze){const u=ze.toLowerCase();o=o.filter(v=>(v.text||"").toLowerCase().includes(u)||(v.fileName||"").toLowerCase().includes(u))}o=[...o].map((u,v)=>({m:u,idx:v})).sort((u,v)=>{const h=typeof u.m.ts=="number"?u.m.ts:Na(u.m.time),b=typeof v.m.ts=="number"?v.m.ts:Na(v.m.time);return h!==b?h-b:u.idx-v.idx}).map(u=>u.m);const c={};o.forEach(u=>{const v=u.time.includes(":")?"今天":u.time;c[v]||(c[v]=[]),c[v].push(u)}),d.innerHTML=`
    ...
    <div class="wa__messages" id="waMessages">
      ${Object.entries(c).map(([u,v])=>`
        ...
        ${v.map(h=>ls(h,r)).join("")}
      `).join("")}
      ${e==="sawyer"&&J===2?`<div class="wa__msg-row other" id="sawyerTyping"><div class="wa__msg-avatar" style="background:${fa("Sawyer")}">S</div><div class="bubble other"><span class="small muted">輸入中...</span></div></div>`:""}
    </div>
  ...
  `,document.getElementById("waChatHeader")?.addEventListener("click",()=>{ke=!ke,document.getElementById("waInfoPanel")?.classList.toggle("open",ke)}),document.getElementById("waInfoBtn")?.addEventListener("click",u=>{u.stopPropagation(),ke=!ke,document.getElementById("waInfoPanel")?.classList.toggle("open",ke)}),document.getElementById("waInfoClose")?.addEventListener("click",()=>{ke=!1,document.getElementById("waInfoPanel")?.classList.remove("open")}),document.getElementById("waToggleMute")?.addEventListener("click",()=>{r.muted=!r.muted,H(),W(),G(e)}),document.getElementById("waTogglePin")?.addEventListener("click",()=>{r.pinned=!r.pinned,H(),W(),G(e)}),document.getElementById("waToggleArchive")?.addEventListener("click",()=>{r.archived=!r.archived,H(),W(),G(e)}),document.getElementById("waMsgSearchBtn")?.addEventListener("click",()=>{ze="",document.getElementById("waMsgSearchBar").style.display="flex",document.getElementById("waMsgSearchInput")?.focus()}),document.getElementById("waMsgSearchInput")?.addEventListener("input",u=>{ze=u.target.value,G(e)}),document.getElementById("waMsgSearchClear")?.addEventListener("click",()=>{ze="",G(e)}),document.getElementById("waExportBtn")?.addEventListener("click",()=>Ha(r)),document.getElementById("waMoreBtn")?.addEventListener("click",()=>Ha(r)),document.getElementById("waSendBtn")?.addEventListener("click",()=>Oa(r)),document.getElementById("waComposerInput")?.addEventListener("keydown",u=>{u.key==="Enter"&&Oa(r)}),document.querySelectorAll("[data-play]").forEach(u=>{u.addEventListener("click",()=>{const v=u.textContent;u.textContent="⏸️",setTimeout(()=>u.textContent=v,1800)})}),document.querySelectorAll("[data-img]").forEach(u=>{u.addEventListener("click",()=>kn(u.src))}),xn();try{const u=document.getElementById("waMessages");u&&!u._waScrollBound&&(u._waScrollBound=!0,u.addEventListener("scroll",()=>{const v=u.scrollHeight,h=u.scrollTop,b=u.clientHeight;Ue=v-h-b<80}))}catch{}const m=s,p=a;requestAnimationFrame(()=>{requestAnimationFrame(()=>{const u=document.getElementById("waMessages");if(u)if(m||p===0&&u.scrollHeight>u.clientHeight+20&&Ue)u.scrollTop=u.scrollHeight,Ue=!0,u.scrollTop;else if(p!==null){const v=Math.max(0,u.scrollHeight-u.clientHeight);u.scrollTop=Math.min(p,v),u.scrollTop,Ue=u.scrollHeight-u.scrollTop-u.clientHeight<80}else u.scrollTop=u.scrollHeight,Ue=!0,u.scrollTop})})}function wn(e){return e?e==="you"||e==="你"?"你":e.trim().charAt(0).toUpperCase():"?"}function Na(e){if(!e)return 0;if(e==="剛剛"||e==="今天")return Number.MAX_SAFE_INTEGER;if(/^\d{4}-\d{2}-\d{2}$/.test(e))return new Date(e+"T00:00:00").getTime();if(/^\d{1,2}\/\d{1,2}$/.test(e))return new Date("2024/"+e+"T00:00:00").getTime();const t=new Date().toISOString().slice(0,10);try{const a=new Date(t+"T"+e).getTime();return Number.isNaN(a)?Number.MAX_SAFE_INTEGER:a}catch{return Number.MAX_SAFE_INTEGER}}function fa(e){const t=["#1f7aec","#e542a3","#00a884","#ff8c00","#6a5acd","#d93025","#0d9488","#7c3aed"];let a=0;for(let i=0;i<e.length;i++)a=a*31+e.charCodeAt(i)>>>0;return t[a%t.length]}function ls(e,t){const a=e.from==="you",i=a?e.read==="read"?'<span class="bubble__check read">✓✓</span>':e.read==="delivered"?'<span class="bubble__check">✓✓</span>':'<span class="bubble__check">✓</span>':"";let n="";e.type==="image"?n=`<div class="wa__media"><img data-img src="${e.media}" alt="image" /></div>`:e.type==="voice"?n=`<div class="wa__voice"><span class="wa__play" data-play>▶️</span><div class="wa__wave">${Array.from({length:12},(m,p)=>`<span style="height:${8+Math.random()*14}px"></span>`).join("")}</div><span class="small muted">${e.duration}</span></div>`:e.type==="file"&&(n=`<div class="wa__file"><div class="wa__file-icon">📄</div><div style="flex:1;min-width:0"><div style="font-weight:600;font-size:13px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">${g(e.fileName)}</div><div class="small muted">${g(e.fileSize)}</div></div><button class="btn" style="padding:4px 8px">下載</button></div>`);const s=e.text?`<div class="bubble__text">${g(e.text).replace(/\n/g,"<br>")}</div>`:"",r=`<div class="bubble__time">${g(e.time)} ${i}</div>`;if(a)return`<div class="wa__msg-row me">
    ...
    `,a.style.cssText="position:fixed;right:16px;bottom:60px;width:360px;background:#2d2d2d;color:#f0f0f0;border:1px solid rgba(255,255,255,.12);border-radius:8px;box-shadow:0 8px 28px rgba(0,0,0,.45);z-index:1100;overflow:hidden;cursor:pointer;opacity:0;transform:translateY(12px);transition:opacity .28s,transform .28s;",a.addEventListener("click",i=>{i.target.closest(".win-notif__close")||(a.remove(),$(()=>Promise.resolve().then(()=>re).then(n=>{n.setActiveView&&(n.setActiveView("whatsapp"),localStorage.setItem("cc_active_view","whatsapp"))}),void 0),et("nori-all"))}),a.querySelector(".win-notif__close")?.addEventListener("click",i=>{i.stopPropagation(),a.remove()}),document.body.appendChild(a),requestAnimationFrame(()=>{a.style.opacity="1",a.style.transform="none"}),setTimeout(()=>{a.style.opacity="0",setTimeout(()=>a.remove(),300)},1e4),setTimeout(()=>{Re||Ut()},1e4)},1e4)}function Ut(){if(Re)return;Re=!0,H();const e=j.find(t=>t.id==="maggie");e&&setTimeout(()=>{e.messages.push({id:"m-0043-"+Date.now(),from:"Maggie",text:"Hi @Casey, 有新的工單 INV-2024-0043, 請協助處理一下",time:"今天",ts:Date.now(),read:"delivered",type:"text"}),e.preview="Hi @Casey, 有新的工單 INV-2024-0043",e.lastTime="今天",e.unread=(e.unread||0)+1,H(),window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"maggie"}})),$(()=>Promise.resolve().then(()=>ht).then(i=>{i.addTicket0043&&i.addTicket0043(),document.getElementById("jiraBoard")&&window.dispatchEvent(new CustomEvent("jira:ticketAdded"))}),void 0);const t=document.getElementById("view-whatsapp");if(t&&t.innerHTML&&W(),kt("maggie")||q==="maggie")return;const a=document.createElement("div");a.id="wa-win-notification-maggie-0043",a.setAttribute("role","alert"),a.innerHTML=`
      ...
      <div class="win-notif__progress"></div>
    `,a.style.cssText="position:fixed;right:16px;bottom:60px;width:360px;background:#2d2d2d;color:#f0f0f0;border:1px solid rgba(255,255,255,.12);border-radius:8px;box-shadow:0 8px 28px rgba(0,0,0,.45);z-index:1100;overflow:hidden;cursor:pointer;opacity:0;transform:translateY(12px);transition:opacity .28s,transform .28s;",a.addEventListener("click",i=>{i.target.closest(".win-notif__close")||(a.remove(),$(()=>Promise.resolve().then(()=>re).then(n=>{n.setActiveView&&(n.setActiveView("whatsapp"),localStorage.setItem("cc_active_view","whatsapp"))}),void 0),et("maggie"))}),a.querySelector(".win-notif__close")?.addEventListener("click",i=>{i.stopPropagation(),a.remove()}),document.body.appendChild(a),requestAnimationFrame(()=>{a.style.opacity="1",a.style.transform="none"}),setTimeout(()=>{a.style.opacity="0",setTimeout(()=>a.remove(),300)},1e4)},1e4)}function ya(){j.find(e=>e.id==="nori-all")&&De&&!Re&&Ut()}var ea=[{from:"Parker",text:"@Casey 剛剛嚇壞了吧 哈哈 估計是你進來以來第一次遇到系統爆炸了"},{from:"Parker",text:"不過說來也奇怪 這個入口應該搬移了才對"},{from:"Parker",text:"啊對了 這裡應該也沒多少人知道 那個原本是HR系統的入口"},{from:"Hugo",text:"對！！那個超難用的 系統不完善沒有適當防呆 他們又常常笨手笨腳刪掉資料 要找我們恢復"},{from:"Parker",text:"對啊 浪費我們人力 老闆就乾脆換系統了"},{from:"Hugo",text:"那為什麼代碼沒有隱藏入口？"},{from:"Parker",text:"不知道欸 這個不能動 一動就會大爆炸"},{from:"Hugo",text:"難不成有人偷用這個系統來偷藏色色的東西！"},{from:"Parker",text:"什麼鬼"}];function ds(e,t){if(kt("lunch-team")||q==="lunch-team")return;const a=fa(e),i=wn(e),n=document.createElement("div");n.className="win-notif",n.id="wa-win-notif-lunch-"+Date.now()+"-"+Math.random().toString(36).slice(2,6),n.setAttribute("role","alert"),n.innerHTML=`
      <div class="win-notif__app">
        <img src="/arg-game-it-company-secret/icon/whatsup.svg" alt="WhatUp" width="20" height="20" style="width:20px;height:20px;object-fit:contain" />
        <span class="win-notif__app-name">WhatUp</span>
  ...
  `,n.style.cssText="position:fixed;right:16px;bottom:60px;width:360px;background:#2d2d2d;color:#f0f0f0;border:1px solid rgba(255,255,255,.12);border-radius:8px;box-shadow:0 8px 28px rgba(0,0,0,.45);z-index:1100;overflow:hidden;cursor:pointer;opacity:0;transform:translateY(12px);transition:opacity .28s,transform .28s;",n.addEventListener("click",s=>{s.target.closest(".win-notif__close")||(n.remove(),$(()=>Promise.resolve().then(()=>re).then(r=>{r.setActiveView&&(r.setActiveView("whatsapp"),localStorage.setItem("cc_active_view","whatsapp"))}),void 0),et("lunch-team"))}),n.querySelector(".win-notif__close")?.addEventListener("click",s=>{s.stopPropagation(),n.remove()}),document.body.appendChild(n),requestAnimationFrame(()=>{n.style.opacity="1",n.style.transform="none"}),setTimeout(()=>{n.style.opacity="0",n.style.transform="translateY(8px)",setTimeout(()=>n.remove(),300)},4e3)}function ba(){if(l.hasFlag("ch2_lunch_seq_done"))return;const e=j.find(i=>i.id==="lunch-team");if(!e)return;if(e.messages.some(i=>i.text&&i.text.includes("剛剛嚇壞了吧"))){l.hasFlag("ch2_lunch_seq_done")||l.setFlag("ch2_lunch_seq_done",!0);return}l.setFlag("ch2_lunch_seq_done",!0),H();let t=0;const a=()=>{if(t>=ea.length)return;const{from:i,text:n}=ea[t],s=Date.now();e.messages.push({id:"lunch-ch2-"+s+"-"+t,from:i,text:n,time:"今天",ts:s+t,read:"delivered",type:"text"}),e.preview=`${i}: ${n.slice(0,20)}`,e.lastTime="今天",q!=="lunch-team"?e.unread=(e.unread||0)+1:e.unread=0,H(),window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"lunch-team"}})),ds(i,n),t+=1,t<ea.length&&setTimeout(a,5e3)};setTimeout(a,800)}function Ha(e){const t=`WhatUp 匯出 — ${e.name}
${e.messages.map(s=>`[${s.time}] ${s.from}: ${s.text||s.fileName||s.type}`).join(`
`)}`,a=new Blob([t],{type:"text/plain"}),i=URL.createObjectURL(a),n=document.createElement("a");n.href=i,n.download=`${e.id}-chat.txt`,n.click(),URL.revokeObjectURL(i)}function ps(){return j}function us(){if(J!==0)return;J=1,H();const e=document.getElementById("view-whatsapp");if(e&&e.classList.contains("active")||localStorage.getItem("cc_active_view"),e&&e.innerHTML){try{G(q)}catch{}try{ut()}catch{}}try{l.setFlag("sawyer_seq_started",!0)}catch{}}var ge=1,nt=0,it=0,Ot=!1,Va=0,Ra=0,qa=0,za=0;function xn(){if(document.getElementById("waLightbox"))return;const e=document.createElement("div");e.id="waLightbox",e.className="wa-lightbox",e.setAttribute("aria-hidden","true"),e.innerHTML=`
  ...
  `,document.body.appendChild(e);const t=e.querySelector("#waLightboxImg"),a=e.querySelector("#waLightboxBody"),i=e.querySelector("#waLightboxScale");function n(){t&&(t.style.transform=`translate(${nt}px, ${it}px) scale(${ge})`,i&&(i.textContent=Math.round(ge*100)+"%"),a.style.cursor=ge>1?Ot?"grabbing":"grab":"zoom-in")}function s(c,m,p){ge=Math.max(.5,Math.min(4,c)),ge===1&&(nt=0,it=0),n()}e.querySelector('[data-wa-zoom="in"]')?.addEventListener("click",()=>s(ge+.25)),e.querySelector('[data-wa-zoom="out"]')?.addEventListener("click",()=>s(ge-.25)),e.querySelector('[data-wa-zoom="reset"]')?.addEventListener("click",()=>{ge=1,nt=0,it=0,n()}),e.querySelector("#waLightboxClose")?.addEventListener("click",()=>Rt()),e.querySelector("[data-wa-close]")?.addEventListener("click",()=>Rt()),a?.addEventListener("wheel",c=>{c.preventDefault();const m=c.deltaY>0?-.1:.1;s(ge+m)},{passive:!1});function r(c){ge<=1||(Ot=!0,t.classList.add("dragging"),Va=c.clientX,Ra=c.clientY,qa=nt,za=it,a.setPointerCapture?.(c.pointerId))}function d(c){Ot&&(nt=qa+(c.clientX-Va),it=za+(c.clientY-Ra),n())}function o(c){Ot=!1,t.classList.remove("dragging");try{a.releasePointerCapture?.(c.pointerId)}catch{}}a?.addEventListener("pointerdown",r),a?.addEventListener("pointermove",d),a?.addEventListener("pointerup",o),a?.addEventListener("pointercancel",o),document.addEventListener("keydown",c=>{c.key==="Escape"&&e.classList.contains("open")&&Rt()}),e._updateTransform=n,e._setScale=s}function kn(e){xn();const t=document.getElementById("waLightbox"),a=document.getElementById("waLightboxImg");!t||!a||(a.src=e,ge=1,nt=0,it=0,t._updateTransform?.(),t.classList.add("open"),t.setAttribute("aria-hidden","false"))}function Rt(){const e=document.getElementById("waLightbox");e&&(e.classList.remove("open"),e.setAttribute("aria-hidden","true"))}try{U.on("chapter:changed",e=>{e===2&&setTimeout(()=>{try{ba()}catch{}},600)})}catch{}typeof window<"u"&&!window.__waListenerBound&&(window.__waListenerBound=!0,window.addEventListener("whatsapp:newMessage",e=>{try{H()}catch{}const t=document.getElementById("view-whatsapp");if(!(!t||!t.innerHTML)){try{ut()}catch{}try{G(q)}catch{}}}),window.addEventListener("whatsapp:refresh",()=>{const e=document.getElementById("view-whatsapp");if(!(!e||!e.innerHTML)){try{ut()}catch{}try{G(q)}catch{}}}));var ct=[{title:"Java switch-case 語法詳解 — 基礎教學 (繁中)",url:"https://java-tutorial.example/switch-case",snippet:"【switch 用法】switch 會依變數值跳到對應 case，需搭配 break 避免貫穿。範例：switch(vipLv){ case 1: price *= 0.90; break; case 2: price *= 0.85; break; case 3: price *= 0.80; break; case 4: price *= 0.75; break; case 5: price *= 0.70; break; default: break; } 注意：若缺少 break 會繼續執行下一個 case。常與 if-else 比較，適用於枚舉分級如 VIP 折扣。",type:"web",image:null},{title:"【StackOverflow】VIP 等級折扣用 switch 寫，VIP1 被算成 60% 而不是 50% 該怎麼修？",url:"https://stackoverflow.com/questions/789421/vip-discount-switch-case-wrong-percentage",snippet:`發問：我的 switch(vipLv) 中 case 1 寫成 price*=0.95，但需求是 VIP1 60%、VIP2 65%。已嘗試修改但 Sonar 仍報錯... 
...
`);for(var S="",T=0;T<I.length;T++){var M=I.charCodeAt(T);M<128?S+=String.fromCharCode(M):M>127&&M<2048?(S+=String.fromCharCode(M>>6|192),S+=String.fromCharCode(M&63|128)):(S+=String.fromCharCode(M>>12|224),S+=String.fromCharCode(M>>6&63|128),S+=String.fromCharCode(M&63|128))}return S}var h=Array(),b,A,P,oe,E,_,w,y,f,B=7,L=12,z=17,_e=22,tt=5,qe=9,N=14,Ae=20,we=4,At=11,$t=16,Bt=23,Pt=6,Mt=10,jt=15,Dt=21;for(e=v(e),h=p(e),_=1732584193,w=4023233417,y=2562383102,f=271733878,b=0;b<h.length;b+=16)A=_,P=w,oe=y,E=f,_=d(_,w,y,f,h[b+0],B,3614090360),f=d(f,_,w,y,h[b+1],L,3905402710),y=d(y,f,_,w,h[b+2],z,606105819),w=d(w,y,f,_,h[b+3],_e,3250441966),_=d(_,w,y,f,h[b+4],B,4118548399),f=d(f,_,w,y,h[b+5],L,1200080426),y=d(y,f,_,w,h[b+6],z,2821735955),w=d(w,y,f,_,h[b+7],_e,4249261313),_=d(_,w,y,f,h[b+8],B,1770035416),f=d(f,_,w,y,h[b+9],L,2336552879),y=d(y,f,_,w,h[b+10],z,4294925233),w=d(w,y,f,_,h[b+11],_e,2304563134),_=d(_,w,y,f,h[b+12],B,1804603682),f=d(f,_,w,y,h[b+13],L,4254626195),y=d(y,f,_,w,h[b+14],z,2792965006),w=d(w,y,f,_,h[b+15],_e,1236535329),_=o(_,w,y,f,h[b+1],tt,4129170786),f=o(f,_,w,y,h[b+6],qe,3225465664),y=o(y,f,_,w,h[b+11],N,643717713),w=o(w,y,f,_,h[b+0],Ae,3921069994),_=o(_,w,y,f,h[b+5],tt,3593408605),f=o(f,_,w,y,h[b+10],qe,38016083),y=o(y,f,_,w,h[b+15],N,3634488961),w=o(w,y,f,_,h[b+4],Ae,3889429448),_=o(_,w,y,f,h[b+9],tt,568446438),f=o(f,_,w,y,h[b+14],qe,3275163606),y=o(y,f,_,w,h[b+3],N,4107603335),w=o(w,y,f,_,h[b+8],Ae,1163531501),_=o(_,w,y,f,h[b+13],tt,2850285829),f=o(f,_,w,y,h[b+2],qe,4243563512),y=o(y,f,_,w,h[b+7],N,1735328473),w=o(w,y,f,_,h[b+12],Ae,2368359562),_=c(_,w,y,f,h[b+5],we,4294588738),f=c(f,_,w,y,h[b+8],At,2272392833),y=c(y,f,_,w,h[b+11],$t,1839030562),w=c(w,y,f,_,h[b+14],Bt,4259657740),_=c(_,w,y,f,h[b+1],we,2763975236),f=c(f,_,w,y,h[b+4],At,1272893353),y=c(y,f,_,w,h[b+7],$t,4139469664),w=c(w,y,f,_,h[b+10],Bt,3200236656),_=c(_,w,y,f,h[b+13],we,681279174),f=c(f,_,w,y,h[b+0],At,3936430074),y=c(y,f,_,w,h[b+3],$t,3572445317),w=c(w,y,f,_,h[b+6],Bt,76029189),_=c(_,w,y,f,h[b+9],we,3654602809),f=c(f,_,w,y,h[b+12],At,3873151461),y=c(y,f,_,w,h[b+15],$t,530742520),w=c(w,y,f,_,h[b+2],Bt,3299628645),_=m(_,w,y,f,h[b+0],Pt,4096336452),f=m(f,_,w,y,h[b+7],Mt,1126891415),y=m(y,f,_,w,h[b+14],jt,2878612391),w=m(w,y,f,_,h[b+5],Dt,4237533241),_=m(_,w,y,f,h[b+12],Pt,1700485571),f=m(f,_,w,y,h[b+3],Mt,2399980690),y=m(y,f,_,w,h[b+10],jt,4293915773),w=m(w,y,f,_,h[b+1],Dt,2240044497),_=m(_,w,y,f,h[b+8],Pt,1873313359),f=m(f,_,w,y,h[b+15],Mt,4264355552),y=m(y,f,_,w,h[b+6],jt,2734768916),w=m(w,y,f,_,h[b+13],Dt,1309151649),_=m(_,w,y,f,h[b+4],Pt,4149444226),f=m(f,_,w,y,h[b+11],Mt,3174756917),y=m(y,f,_,w,h[b+2],jt,718787259),w=m(w,y,f,_,h[b+9],Dt,3951481745),_=a(_,A),w=a(w,P),y=a(y,oe),f=a(f,E);return(u(_)+u(w)+u(y)+u(f)).toLowerCase()}function ys(e){if(!e)return[];const t=e.toLowerCase(),a=new Set,i=[];return ct.forEach(n=>{n.title.toLowerCase().includes(t)&&!a.has(n.title)&&(a.add(n.title),i.push({text:n.title,kind:n.type}))}),(l.get("searchHistory")||[]).slice(-5).reverse().forEach(n=>{n.q.toLowerCase().includes(t)&&!a.has(n.q)&&(a.add(n.q),i.push({text:n.q,kind:"history"}))}),i.slice(0,8)}function bs(e){let t=e;const a={site:null,filetype:null,before:null,after:null},i=t.match(/site:([^\s]+)/i);i&&(a.site=i[1].toLowerCase(),t=t.replace(i[0],"").trim());const n=t.match(/filetype:([^\s]+)/i);n&&(a.filetype=n[1].toLowerCase(),t=t.replace(n[0],"").trim());const s=t.match(/before:([^\s]+)/i);s&&(a.before=s[1],t=t.replace(s[0],"").trim());const r=t.match(/after:([^\s]+)/i);return r&&(a.after=r[1],t=t.replace(r[0],"").trim()),{base:t.trim(),filters:a}}function _s(e){return e.toLowerCase().includes("md5")}function ws(e){const t=document.getElementById("md5Tool");if(!t)return;const a=document.getElementById("searchLayout"),i=document.getElementById("searchDetail");a&&(a.style.display="none"),i&&(i.style.display="none",i.innerHTML="",i.classList.remove("open"));let n="";if(e){const p=e.match(/md5\s*(.*)/i);p&&p[1]&&(n=p[1].trim())}t.innerHTML=`
            ...
            <div class="blog-featured">
              <div class="blog-featured__main" data-blog-url="${g(i.url)}">
                ...
                <div class="blog-card__body">
                  ...
                  <div class="blog-card__meta"><span class="blog-card__author"><img src="${g(Me(i.authorId).avatar)}" alt="" />${g(Me(i.authorId).displayName)}</span><span class="blog-card__dot"></span><span>${g(i.date)}</span><span class="blog-card__dot"></span><span><i class="fa-solid fa-eye"></i> ${K(i.views)}</span></div>
                </div>
              </div>
                ...
                ${n.map(p=>`
                  <div class="blog-mini" data-blog-url="${g(p.url)}">
                    ...
                    <div style="flex:1;min-width:0">
                      ...
                      <div class="blog-mini__meta"><span>${g(Me(p.authorId).displayName.split("·")[0].trim())}</span><span>·</span><span><i class="fa-solid fa-eye"></i> ${K(p.views)}</span></div>
              ...
              ${d.map(p=>`
                <div class="blog-card" data-blog-url="${g(p.url)}">
                  ...
                  <div class="blog-card__body">
                    ...
                    <div class="blog-card__meta"><span class="blog-card__author"><img src="${g(Me(p.authorId).avatar)}" alt="" />${g(Me(p.authorId).name)}</span><span class="blog-card__dot"></span><span>${g(p.date)}</span><span class="blog-card__dot"></span><span><i class="fa-solid fa-eye"></i> ${K(p.views)}</span></div>
                  </div>
                </div>
              `).join("")}
            </div>
        ...
        <div class="blog-article__layout">
          <div class="blog-article__main">
            <div class="blog-article__card">
              ...
              <div class="blog-article__content">${wa(t.content,_a)}</div>
          ...
          <aside class="blog-sidebar">
            ...
            <div class="blog-widget">
              ...
              <div class="blog-rec-list">
                ${r.map((m,p)=>{const u=Me(m.authorId),v=m.authorId===t.authorId;return`
  ...
  `,a.querySelector("[data-so-back-search]")?.addEventListener("click",()=>be());const s=document.getElementById("view-search");s&&(s.scrollTop=0),a.scrollIntoView({behavior:"auto",block:"start"})}function $s(e){const t=rt[e];if(!t)return;if(t.isMD5Tool||t.url==="md5-tool"){ws(St);return}const a=document.getElementById("md5Tool");if(a&&(a.style.display="none",a.innerHTML=""),hs(t.url)){As(t.url);return}const i=t.url;if(ee.some(u=>u.url===i)||i.includes("sawyer-blog.example")||i.includes("mary-blog.example")||i.includes("peter-blog.example")||i.includes("paul-blog.example")||i.includes("emma-blog.example")||i.includes("david-blog.example")){let u=i;if(!Wt(u)){const v=ee.find(h=>h.title===t.title);v&&(u=v.url)}if(Wt(u)){It(u);return}}if(Cn(t.url)||t.title.includes("廣志中學")){Ts(t);return}const n=document.getElementById("searchLayout"),s=document.getElementById("searchDetail");if(!n||!s)return;try{t.url&&(t.type==="news"||t.url.includes("news.example"))&&l.markArticleRead(t.url)}catch{}n.style.display="none",s.style.display="block",s.classList.add("open");let r="",d=null;if(t.url.startsWith("/customer-portal")||t.url.startsWith("file://")){d=t.url.replace("file://","");const u=k.getFile(d);u&&typeof u.content=="string"&&(r=u.content,k.readFile(d))}else if(k.exists(t.url)){d=t.url;const u=k.getFile(d);u&&typeof u.content=="string"&&(r=u.content)}if(!r&&t.title.startsWith("/customer-portal")){const u=k.getFile(t.title);u&&typeof u.content=="string"&&(r=u.content)}const o=r||t.snippet||"無內容",c=t.images?t.images.map(u=>`<div class="detail__image"><img src="${g(u)}" alt="preview" style="width:100%;display:block" onerror="this.src='https://via.placeholder.com/320x480?text=Sawyer+Writing'" /></div>`).join(""):t.image?`<div class="detail__image"><img src="${g(t.image)}" alt="preview" onerror="this.src='https://via.placeholder.com/320x180?text=Preview'" /></div>`:"";s.innerHTML=`
    ...
    <div class="detail__card">
      ...
      ${c}
      <div class="detail__snippet">${wa(o,_a)}</div>
      ${r?`<pre class="detail__pre">${g(r)}</pre>`:""}
      <div class="result__meta" style="margin-top:12px">
        <span class="result__tag">${t.type}</span>
      </div>
    </div>
  `,s.querySelector("#searchBackBtn")?.addEventListener("click",()=>be());const m=document.querySelector(".search");m&&(m.scrollTop=0);const p=document.getElementById("view-search");p&&(p.scrollTop=0),s.scrollIntoView({behavior:"auto",block:"start"})}var gt=0,ta=null,Bs=!1,Q="/darknet/全結構圖",mt="secret",Ct=!1;function Ps(){return k.buildDarkTree?k.buildDarkTree():k.buildTree()}function Ms(e){const t=Ps();function a(n,s){if(n.path===s)return n;if(!n.children)return null;for(const r of n.children){const d=a(r,s);if(d)return d}return null}const i=a(t,e);return!i||!i.children?[]:i.children}function Ln(){document.getElementById("view-darknet")&&(Q==="/darknet"&&(Q="/darknet/全結構圖"),l.hasFlag("dark_entered"),Jt())}function Ua(){const e=document.getElementById("dock");e&&(e.style.display="none"),$(()=>Promise.resolve().then(()=>re).then(t=>{t.setDockVisible&&t.setDockVisible(!1)}),void 0).catch(()=>{})}function Gt(){const e=document.getElementById("dock");e&&(e.style.display=""),$(()=>Promise.resolve().then(()=>re).then(t=>{t.setDockVisible&&t.setDockVisible(!0)}),void 0).catch(()=>{})}function Jt(){const e=document.getElementById("view-darknet");if(e)if(mt==="secret"){const t=Lt,a=l.hasFlag("dark_secret_active");!t&&Ct||a?Ua():Gt(),e.innerHTML=`
      <div class="darknet">
    ...
    `,js()}else{Q==="/darknet"&&(Q="/darknet/全結構圖");const t=l.hasFlag("dark_secret_active");!Lt&&Ct||t?Ua():Gt();const a=Ms(Q),i=a.filter(s=>s.type==="dir"),n=a.filter(s=>s.type==="file");e.innerHTML=`
      <div class="darknet">
    ...
    `,Fs(),Ns(i,n),Hs()}}function js(){const e=document.getElementById("darkTitle");document.getElementById("darkSearchInput");const t=document.getElementById("darkBackBtn");t&&t.addEventListener("click",()=>{Gt();try{l.setFlag("dark_secret_active",!1)}catch{}$(()=>Promise.resolve().then(()=>re).then(i=>{i.setActiveView&&(i.setActiveView("intranet"),localStorage.setItem("cc_active_view","intranet"))}),void 0),mt="secret",Lt=!1,Ct=!1;const a=document.getElementById("view-darknet");a&&(a.innerHTML="")}),e&&(e.style.cursor="default",!Lt&&e.addEventListener("click",()=>{gt++,ta&&clearTimeout(ta),ta=setTimeout(()=>{gt=0},2e3),gt>=6&&(gt=0,Ds())}))}function Ds(){Bs=!0,mt="files",Q==="/darknet"&&(Q="/darknet/全結構圖"),l.setFlag("dark_entered",!0),l.setFlag("ch3_entered_secret",!0),l.setFlag("hidden_portal_accessed",!0),Jt(),l.setFlag("found_code_map",!0)}function Fs(){const e=document.getElementById("darkNav");e&&(e.innerHTML=[{path:"/darknet/全結構圖",label:"全結構圖",icon:"🗺️"},{path:"/darknet/交易列表",label:"交易列表",icon:"📋"},{path:"/darknet/合作公司列表",label:"合作公司",icon:"🏢"},{path:"/darknet/流量",label:"流量",icon:"📦"},{path:"/darknet/月結單",label:"月結單",icon:"💰"},{path:"/darknet/Sawyer支出",label:"Sawyer支出",icon:"💸"},{path:"/darknet/出差紀錄",label:"出差紀錄",icon:"✈️"},{path:"/darknet/會議紀錄",label:"會議記錄",icon:"📝"}].map(t=>`<div class="darknet__nav-item ${Q===t.path||Q.startsWith(t.path+"/")?"active":""}" data-path="${t.path}"><span>${t.icon}</span><span>${t.label}</span></div>`).join(""),e.querySelectorAll(".darknet__nav-item").forEach(t=>t.addEventListener("click",()=>{Q=t.dataset.path,Jt()})))}function Ns(e,t){const a=document.getElementById("darkMain");if(a){if(!e.length&&!t.length){const i=k.getDarkFile?k.getDarkFile(Q):null;if(i&&i.content){a.innerHTML=`<pre style="white-space:pre-wrap;word-break:break-word;font-family:var(--font-mono);font-size:13px;color:#e9edef">${g(i.content.slice(0,8e3))}</pre>`,l.discoverFile(Q),Sa();return}a.innerHTML='<div style="padding:24px;text-align:center;color:#5a3a3e">此資料夾為空</div>';return}a.innerHTML=`
...
...`),n.textContent=s,n.style.whiteSpace="pre-wrap";a.style.display="flex",l.discoverFile(e),l.setFlag("dark_opened:"+e,!0),Sa()}function Hs(){document.getElementById("darkExitBtn")?.addEventListener("click",()=>{mt="secret",Ct=!1;try{l.setFlag("dark_secret_active",!1)}catch{}Gt(),Sa(!0),$(()=>Promise.resolve().then(()=>re).then(t=>{t.setActiveView&&(t.setActiveView("intranet"),localStorage.setItem("cc_active_view","intranet"))}),void 0);const e=document.getElementById("view-darknet");e&&(e.innerHTML=""),l.hasFlag("ch4_all_opened")&&setTimeout(()=>{window.dispatchEvent(new CustomEvent("darknet:exit"))},300)}),document.getElementById("darkPreviewClose")?.addEventListener("click",()=>{const e=document.getElementById("darkPreview");e&&(e.style.display="none")}),document.getElementById("darkPreview")?.addEventListener("click",e=>{e.target.id==="darkPreview"&&(e.target.style.display="none")})}function Sa(e=!1){const t=k.listDarkFiles?k.listDarkFiles("/darknet"):[];if(!t.length)return;const a=t.filter(i=>l.hasFlag("dark_opened:"+i.path)||l.hasFlag("discovered:"+i.path)||l.get("discoveredFiles")?.includes(i.path));a.length>=t.length?(l.hasFlag("ch4_all_opened")||l.setFlag("ch4_all_opened",!0),e&&!l.hasFlag("ch5_triggered")&&(l.setFlag("ch5_triggered",!0),window.dispatchEvent(new CustomEvent("ch4:complete")),setTimeout(()=>{const i=document.getElementById("mailDialog");if(i&&!i.open)try{i.showModal()}catch{i.style.display="block",i.setAttribute("open","")}},500))):e&&a.length>=t.length,a.length>=t.length&&!l.hasFlag("ch4_all_opened")&&l.setFlag("ch4_all_opened",!0)}var Lt=!1;function aa(e={}){if(!(l.hasFlag("ch1_0043_committed")&&!l.hasFlag("ch1_revert_done"))&&document.getElementById("view-darknet")){if(Lt=!!e.simple,Ct=!0,e.simple)try{l.setFlag("dark_secret_active",!1)}catch{}else try{l.setFlag("dark_secret_active",!0)}catch{}mt="secret",gt=0,$(()=>Promise.resolve().then(()=>re).then(t=>{t.setActiveView&&(t.setActiveView("darknet"),localStorage.setItem("cc_active_view","darknet"))}),void 0),Ln()}}var te="/intranet",Ye="",Wa="/intranet/client_info";function Tt(e){return e===Wa||e.startsWith(Wa+"/")}function Ga(e){const t=k.buildTree();function a(n,s){if(n.path===s)return n;if(!n.children)return null;for(const r of n.children){const d=a(r,s);if(d)return d}return null}const i=a(t,e);return!i||!i.children?[]:i.children}function Vs(){const e=document.getElementById("view-intranet");e&&(e.innerHTML=`
    <div class="intranet">
  ...
  `,e.querySelectorAll(".intra-nav__item").forEach(t=>{t.addEventListener("click",()=>Kt(t.dataset.path))}))}function ca(){const e=document.getElementById("intraMain");if(!e)return;if(Ye){const n=k.searchContent(Ye).filter(o=>o.path.startsWith("/intranet")).slice(0,40),s=k.listFiles("/intranet").filter(o=>o.path.toLowerCase().includes(Ye)).slice(0,40),r=new Map;n.forEach(o=>r.set(o.path,o)),s.forEach(o=>{r.has(o.path)||r.set(o.path,{path:o.path,snippet:""})});const d=[...r.values()];if(!d.length){e.innerHTML='<div class="intra-empty">無搜尋結果 — 試試「Nori」「冰釀茶酒」「業務流程」「Sawyer」</div>';return}e.innerHTML=`
      <div class="intra-section__title">搜尋結果「${g(Ye)}」— ${d.length} 筆</div>
      <div class="intra-file__list">
        ${d.map(o=>{const c=k.getFile(o.path)?.meta?.locked||Tt(o.path);return`<div class="intra-file__row ${c?"locked":""}" data-path="${g(o.path)}" title="${g(o.path)}">
            <span class="intra-file__icon">${c?"🔒":da(o.path)}</span>
    ...
    `,ia(e);return}if(Tt(te)){e.innerHTML=`
      <div class="intra-locked">
        ...
        <div class="intra-locked__files">
          ...
          ${Ga(te).map(n=>`<div class="intra-file__row locked" title="${g(n.path)}"><span>${da(n.path)}</span><span>${g(n.name)}</span><span class="small muted" style="margin-left:auto">🔒 鎖定</span></div>`).join("")}
        </div>
        <button class="btn" style="margin-top:12px" onclick="document.querySelector('[data-path='/intranet']')?.click()">返回內網首頁</button>
      </div>
    `;return}const t=Ga(te),a=t.filter(n=>n.type==="dir"),i=t.filter(n=>n.type==="file");if(te==="/intranet"&&!Ye){e.innerHTML=`
  ...
  `,ia(e)}function na(e){const t=e.path&&Tt(e.path),a=(e.path?k.getFile(e.path):null)?.meta?.locked||t,i=a?"🔒":e.type==="dir"?"📁":da(e.path||e.name);return`<div class="intra-file__row ${e.type==="dir"?"is-dir":""} ${a?"locked":""}" data-path="${g(e.path)}" data-type="${e.type}" title="${g(e.path)}">
