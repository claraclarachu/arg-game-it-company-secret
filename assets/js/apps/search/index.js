...
const webIndex = [
  ...
  { title: '給完全不懂程式的人：MD5 是什麼？把一句話變成一串亂碼的小魔法 — Peter Lin', url: 'https://peter-blog.example/md5-for-beginners', snippet: '完全不懂程式也看得懂。MD5 就像一台指紋機：你丟一句話進去，它永遠吐出 32 個字由 0-9、a-f 組成的亂碼。同樣輸入永遠得到同樣輸出，改一個字結果就完全不同。例如 hello → 5d41402abc4b2a76b9719d911017c592，平常看到的 ?hash=be78e754... 就是典型例子。— Peter Lin', type: 'web', image: 'https://picsum.photos/seed/md5/600/400' },
];
...
const blogArticles = [
  ...
  { url:'https://sawyer-blog.example/2023-12-20', title:'Sawyer Choi — 2023-12-20', excerpt:'2023估計是我人生中最重要的一年', content:'2023-12-20\n\n2023估計是我人生中最重要的一年', authorId:'sawyer', date:'2023-12-20', views:99, likes:1, topic:'心情', tags:[], cover:null },
