var Sa=Object.defineProperty,da=(e,t)=>{let a={};for(var i in e)Sa(a,i,{get:e[i],enumerable:!0});return t||Sa(a,Symbol.toStringTag,{value:"Module"}),a};(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function a(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(n){if(n.ep)return;n.ep=!0;const s=a(n);fetch(n.href,s)}})();var Ea="code_conspiracy_state",Ka="1.0.0",J={version:Ka,currentChapter:0,unlockedInterfaces:["vscode","jira","whatsapp","search"],discoveredFiles:[],collectedEvidence:[],whatsappChats:null,whatsappMeta:null,jiraTickets:{},jiraTicketsData:null,vscodeState:null,intranetState:null,darknetState:null,searchHistory:[],readArticles:[],whatsappSentCount:0,flags:{},endings:[],settings:{language:"zh-TW",theme:"dark",sound:!0,reducedMotion:!1,bgmVolume:.25,bgmMuted:!1},playtime:0,lastSaved:null,persistentStats:{unlockedEndings:[],readArticles:[],darkFileCount:0,whatsappSentCount:0,searchHistoryCount:0,flags:{}}},jn=class{constructor(){this.state=this.load(),this.listeners=new Map,this.saveDebounce=null,this.playtimeInterval=null,this.startPlaytimeTracking()}load(){try{const e=localStorage.getItem(Ea);if(e){const t=JSON.parse(e);return this.migrateState(t)}}catch(e){console.warn("Failed to load game state:",e)}return JSON.parse(JSON.stringify(J))}migrateState(e){e.version||(e.version=Ka);const t={...J,...e};if(t.flags={...J.flags||{},...e.flags||{}},t.endings=Array.isArray(e.endings)?[...e.endings]:[...J.endings],t.discoveredFiles=Array.isArray(e.discoveredFiles)?[...e.discoveredFiles]:[],t.collectedEvidence=Array.isArray(e.collectedEvidence)?[...e.collectedEvidence]:[],t.searchHistory=Array.isArray(e.searchHistory)?[...e.searchHistory]:[],t.readArticles=Array.isArray(e.readArticles)?[...e.readArticles]:[],t.whatsappSentCount=typeof e.whatsappSentCount=="number"?e.whatsappSentCount:0,!t.settings||typeof t.settings!="object"?t.settings={...J.settings}:t.settings={...J.settings,...e.settings},!Array.isArray(t.unlockedInterfaces)||!t.unlockedInterfaces.length)t.unlockedInterfaces=[...J.unlockedInterfaces];else for(const s of J.unlockedInterfaces)t.unlockedInterfaces.includes(s)||t.unlockedInterfaces.push(s);e.whatsappChats!==void 0&&(t.whatsappChats=e.whatsappChats),e.whatsappMeta!==void 0&&(t.whatsappMeta=e.whatsappMeta),e.jiraTicketsData!==void 0&&(t.jiraTicketsData=e.jiraTicketsData),e.jiraTickets!==void 0&&(t.jiraTickets={...e.jiraTickets||{}}),e.vscodeState!==void 0&&(t.vscodeState=e.vscodeState),e.intranetState!==void 0&&(t.intranetState=e.intranetState),e.darknetState!==void 0&&(t.darknetState=e.darknetState),e.readArticles!==void 0&&(t.readArticles=Array.isArray(e.readArticles)?[...e.readArticles]:[]),typeof e.whatsappSentCount=="number"&&(t.whatsappSentCount=e.whatsappSentCount),typeof e.currentChapter=="number"&&(t.currentChapter=e.currentChapter),typeof e.playtime=="number"&&(t.playtime=e.playtime);const a=Array.isArray(e.persistentStats?.unlockedEndings)?[...e.persistentStats.unlockedEndings]:[...J.persistentStats.unlockedEndings],i=Array.isArray(e.endings)?e.endings:Array.isArray(e.unlockedEndings)?e.unlockedEndings:[],n=[...new Set([...a,...i])];return t.persistentStats={unlockedEndings:n,readArticles:Array.isArray(e.persistentStats?.readArticles)?[...e.persistentStats.readArticles]:[...J.persistentStats.readArticles],darkFileCount:typeof e.persistentStats?.darkFileCount=="number"?e.persistentStats.darkFileCount:0,whatsappSentCount:typeof e.persistentStats?.whatsappSentCount=="number"?e.persistentStats.whatsappSentCount:0,searchHistoryCount:typeof e.persistentStats?.searchHistoryCount=="number"?e.persistentStats.searchHistoryCount:0,flags:{...J.persistentStats.flags||{},...e.persistentStats?.flags||{}}},n.length&&(t.unlockedEndings=[...n]),t}save(e=!1){if(e){this._doSave();return}clearTimeout(this.saveDebounce),this.saveDebounce=setTimeout(()=>this._doSave(),500)}_doSave(){this.state.lastSaved=new Date().toISOString();try{localStorage.setItem(Ea,JSON.stringify(this.state)),this.emit("save",this.state)}catch(e){console.error("Failed to save game state:",e),this.emit("saveError",e)}}get(e){return e?e.split(".").reduce((t,a)=>t?.[a],this.state):this.state}set(e,t){const a=e.split("."),i=a.pop(),n=a.reduce((s,r)=>(s[r]||(s[r]={}),s[r]),this.state);if(n[i]=t,e==="endings"&&Array.isArray(t)){this.state.persistentStats||(this.state.persistentStats=JSON.parse(JSON.stringify(J.persistentStats)));const s=this.state.persistentStats;s.unlockedEndings=[...new Set([...s.unlockedEndings||[],...t])],this.state.unlockedEndings=[...s.unlockedEndings]}if(e==="unlockedEndings"&&Array.isArray(t)){this.state.persistentStats||(this.state.persistentStats=JSON.parse(JSON.stringify(J.persistentStats)));const s=this.state.persistentStats;s.unlockedEndings=[...new Set([...s.unlockedEndings||[],...t])]}this.emit("change",{path:e,value:t,state:this.state}),e.startsWith("flags.")||e==="currentChapter"||e==="endings"||e.startsWith("endings")||e==="unlockedEndings"||e.startsWith("unlockedEndings")||e==="persistentStats"||e.startsWith("persistentStats")||e==="readArticles"||e.startsWith("readArticles")||e==="whatsappSentCount"?this.save(!0):this.save()}update(e,t){const a=this.get(e);this.set(e,t(a))}push(e,t){const a=this.get(e)||[];this.set(e,[...a,t])}remove(e,t){const a=this.get(e)||[];this.set(e,a.filter(i=>!t(i)))}hasFlag(e){return!!this.state.flags[e]}setFlag(e,t=!0){this.set(`flags.${e}`,t),this.save(!0)}addEvidence(e){this.state.collectedEvidence.some(t=>t.id===e.id)||(this.push("collectedEvidence",{...e,discoveredAt:new Date().toISOString()}),this.emit("evidence",e),this.save(!0))}unlockInterface(e){this.state.unlockedInterfaces.includes(e)||(this.push("unlockedInterfaces",e),this.emit("interfaceUnlocked",e))}discoverFile(e){this.state.discoveredFiles.includes(e)||(this.push("discoveredFiles",e),this.emit("fileDiscovered",e),this.save(!0))}markArticleRead(e){e&&(this.state.readArticles||(this.state.readArticles=[]),this.state.readArticles.includes(e)||(this.push("readArticles",e),this.save(!0)))}incrementWhatsappSent(){const e=typeof this.state.whatsappSentCount=="number"?this.state.whatsappSentCount:0;this.set("whatsappSentCount",e+1),this.save(!0)}startPlaytimeTracking(){this.playtimeInterval=setInterval(()=>{this.state.playtime+=1,this.state.playtime%60===0&&this.save(!0)},1e3)}stopPlaytimeTracking(){clearInterval(this.playtimeInterval),this.save(!0)}exportSave(){return JSON.stringify(this.state,null,2)}importSave(e){try{const t=JSON.parse(e);return this.state=this.migrateState(t),this.save(!0),this.emit("load",this.state),!0}catch(t){return console.error("Failed to import save:",t),!1}}reset(){try{clearTimeout(this.saveDebounce)}catch{}try{clearInterval(this.playtimeInterval)}catch{}const e=this.state.persistentStats||{unlockedEndings:[],readArticles:[],darkFileCount:0,whatsappSentCount:0,searchHistoryCount:0,flags:{}};e.unlockedEndings=[...new Set([...e.unlockedEndings||[],...this.state.endings||[]])],e.readArticles=[...new Set([...e.readArticles||[],...this.state.readArticles||[]])];const t=(this.state.discoveredFiles||[]).filter(n=>n.startsWith("/darknet")).length;e.darkFileCount=Math.max(e.darkFileCount||0,t),e.whatsappSentCount=Math.max(e.whatsappSentCount||0,this.state.whatsappSentCount||0);const a=(this.state.searchHistory||[]).length;e.searchHistoryCount=Math.max(e.searchHistoryCount||0,a),e.flags={...e.flags||{}},this.state.flags.portal_simple_entered&&(e.flags.portal_simple_entered=!0),this.state.flags.portal_hash_entered&&(e.flags.portal_hash_entered=!0),this.state.flags.sawyer_abuse_sent&&(e.flags.sawyer_abuse_sent=!0);const i=JSON.parse(JSON.stringify(e));this.state=JSON.parse(JSON.stringify(J)),this.state.unlockedInterfaces=[...J.unlockedInterfaces],this.state.flags={},this.state.collectedEvidence=[],this.state.discoveredFiles=[],this.state.endings=[],this.state.searchHistory=[],this.state.readArticles=[],this.state.whatsappSentCount=0,this.state.jiraTickets={},this.state.whatsappChats=null,this.state.whatsappMeta=null,this.state.jiraTicketsData=null,this.state.vscodeState=null,this.state.playtime=0,this.state.persistentStats=i,this.save(!0),this.emit("reset",this.state),this.startPlaytimeTracking()}on(e,t){return this.listeners.has(e)||this.listeners.set(e,new Set),this.listeners.get(e).add(t),()=>this.off(e,t)}off(e,t){this.listeners.get(e)?.delete(t)}emit(e,t){this.listeners.get(e)?.forEach(a=>a(t))}},l=new jn,Pn=class{constructor(){this.events=new Map,this.onceEvents=new Map}on(e,t,a=null){this.events.has(e)||this.events.set(e,new Set);const i=a?t.bind(a):t;return this.events.get(e).add(i),()=>this.off(e,i)}once(e,t,a=null){const i=a?t.bind(a):t,n=(...s)=>{this.off(e,n),i(...s)};return this.onceEvents.has(e)||this.onceEvents.set(e,new Set),this.onceEvents.get(e).add(n),()=>this.off(e,n)}off(e,t){this.events.get(e)?.delete(t),this.onceEvents.get(e)?.delete(t)}emit(e,...t){this.events.get(e)?.forEach(a=>{try{a(...t)}catch(i){console.error(`Error in event handler for "${e}":`,i)}}),this.onceEvents.get(e)?.forEach(a=>{try{a(...t)}catch(i){console.error(`Error in once handler for "${e}":`,i)}}),this.onceEvents.get(e)?.clear()}clear(e){e?(this.events.delete(e),this.onceEvents.delete(e)):(this.events.clear(),this.onceEvents.clear())}},W=new Pn,Qe=new Map,ht=new Map,Gt=new Map,Qa="https://nori-intranet/internal/portal?";function Xa(e,t){Gt.set(e,t)}function Mn(e){return Gt.get(e)||null}function Dn(){return Array.from(Gt.entries()).map(([e,t])=>({key:e,...t}))}function Fn(e){for(const[t,a]of Gt.entries())if(e(a,t))return{key:t,...a};return null}Xa("nori-portal-2023",{domain:Qa,historical:!0,description:"Nori 內網舊版 portal 路由（2023 前由 generateSecretPath 動態產生）",generateSecretPath:"function generateSecretPath(domain){ const cid = redis.get('companyId'); const y = redis.get('year'); const k='70BTa3A1a13ad4212GHdybJmn'; return domain + 'hash=' + md5(`companyId=${cid}&year=${y}&key=${k}`); }",key:"70BTa3A1a13ad4212GHdybJmn",companyIdSource:"redis.get('companyId')",yearSource:"redis.get('year')",_hash:"f665a7117959b667b7f283eaebf69cae",_fullUrl:"https://nori-intranet/internal/portal?hash=f665a7117959b667b7f283eaebf69cae"});function me(e,t){ht.set(e,t)}function Za(e){return ht.get(e)||null}function Nn(e="/"){const t=[];for(const[a,i]of ht.entries())a.startsWith(e)&&t.push({path:a,...i});return t.sort((a,i)=>a.path.localeCompare(i.path))}function On(){const e={name:"/",path:"/",children:[],type:"dir"},t=new Map;t.set("/",e);for(const[i]of ht.entries()){const n=i.split("/").filter(Boolean);let s="",r=e;for(let d=0;d<n.length;d++){s+="/"+n[d];const o=d===n.length-1;if(t.has(s)){const c=t.get(s);!o&&c.type==="file"&&(c.type="dir",c.children=c.children||[])}else{const c={name:n[d],path:s,type:o?"file":"dir",children:o?void 0:[]};if(o){const m=ht.get(i);c.ext=i.split(".").pop(),c.meta=m.meta||{}}t.set(s,c),r.children||(r.children=[]),r.children.push(c)}r=t.get(s)}}function a(i){i.children&&(i.children.sort((n,s)=>n.type!==s.type?n.type==="dir"?-1:1:n.name.localeCompare(s.name)),i.children.forEach(a))}return a(e),e}function Hn(e){const t=Za(e);return t?t.content:null}function x(e,t){Qe.set(e,t)}function en(e){return Qe.get(e)||null}function Vn(e="/"){const t=[];for(const[a,i]of Qe.entries())a.startsWith(e)&&t.push({path:a,...i});return t.sort((a,i)=>a.path.localeCompare(i.path))}function Rn(){const e={name:"/",path:"/",children:[],type:"dir"},t=new Map;t.set("/",e);for(const[i]of Qe.entries()){const n=i.split("/").filter(Boolean);let s="",r=e;for(let d=0;d<n.length;d++){s+="/"+n[d];const o=d===n.length-1;if(t.has(s)){const c=t.get(s);!o&&c.type==="file"&&(c.type="dir",c.children=c.children||[])}else{const c={name:n[d],path:s,type:o?"file":"dir",children:o?void 0:[]};if(o){const m=Qe.get(i);c.ext=i.split(".").pop(),c.meta=m.meta||{}}t.set(s,c),r.children||(r.children=[]),r.children.push(c)}r=t.get(s)}}function a(i){i.children&&(i.children.sort((n,s)=>n.type!==s.type?n.type==="dir"?-1:1:n.name.localeCompare(s.name)),i.children.forEach(a))}return a(e),e}function qn(e){const t=en(e);return!t||t.hidden&&!l.hasFlag(`discovered:${e}`)?null:(l.discoverFile(e),e==="/customer-portal/src/payment/mixer.js"&&l.setFlag("found_crypto_mixer",!0),e==="/customer-portal/src/payment/gateway.js"&&l.setFlag("found_fee_mapping",!0),e==="/customer-portal/src/payment/cryptoConfig.json"&&l.setFlag("found_mixer_config",!0),e==="/customer-portal/ledger.db"&&l.setFlag("ledger_exported",!0),e==="/customer-portal/docs/arch.pdf"&&l.setFlag("sql_injected",!0),e==="/customer-portal/data/ledger_export.csv"&&l.setFlag("found_coordinates",!0),e==="/customer-portal/src/main/resources/application.properties"&&l.setFlag("found_ssh_trace",!0),e==="/customer-portal/src/main/java/com/nori/OrderService.java"&&l.setFlag("found_fee_mapping",!0),W.emit("vfs:read",e),t.content)}function zn(e){return Qe.has(e)}function Wn(e){const t=e.toLowerCase(),a=[];for(const[i,n]of Qe.entries())typeof n.content=="string"&&n.content.toLowerCase().includes(t)&&a.push({path:i,snippet:Un(n.content,t)});return a}function Un(e,t){const a=e.toLowerCase().indexOf(t),i=Math.max(0,a-40),n=Math.min(e.length,a+t.length+40);return e.slice(i,n).replace(/\n/g," ")}function pa(){return l.hasFlag("ch1_0043_committed")&&!l.hasFlag("ch1_revert_done")}function Gn(){return pa()?!1:l.hasFlag("hidden_portal_accessed")}function Jn(e){return pa()?!1:e&&e.hash==="f665a7117959b667b7f283eaebf69cae"?(l.setFlag("hidden_portal_accessed",!0),l.setFlag("portal_auth_bypassed",!1),W.emit("portal:discovered"),!0):!1}function Yn(e){return pa()?!1:(e?.["X-Internal-Token"]||e?.["x-internal-token"])==="nori-drinks-token-2024"?(l.hasFlag("hidden_portal_accessed")||(l.setFlag("hidden_portal_accessed",!0),W.emit("portal:discovered")),l.setFlag("portal_auth_bypassed",!0),W.emit("portal:bypassed"),!0):!1}function Kn(){x("/customer-portal/package.json",{content:JSON.stringify({name:"nori-drinks-supply",version:"3.5.0",private:!0,description:"Nori 飲品供應 — 招牌冰釀茶酒 / 原物料管理 / 訂單銷售 / 內部系統",scripts:{dev:"vite",build:"vite build",test:"jest","db:migrate":"node scripts/migrate.js"},dependencies:{vite:"^5.0.0",vue:"^3.4.0"}},null,2),meta:{lang:"json"}}),x("/customer-portal/README.md",{content:`# Nori外部網頁
...
`,meta:{portal:!0}}),x("/internal/portal/export",{hidden:!1,content:"SQLite export endpoint - 需要 portalAuth 通過 (Nori 訂單匯出)",meta:{portal:!0}})}function Qn(){me("/darknet/全結構圖/drug-route-graph.md",{content:`# 全結構圖
...
`,meta:{lang:"markdown"}})}Qn();Kn();var k={registerFile:x,getFile:en,listFiles:Vn,buildTree:Rn,readFile:qn,exists:zn,searchContent:Wn,canAccessPortal:Gn,tryAccessPortal:Jn,bypassPortalAuth:Yn,registerDarkFile:me,getDarkFile:Za,listDarkFiles:Nn,buildDarkTree:On,readDarkFile:Hn,registerLegacyRoute:Xa,getLegacyRoute:Mn,listLegacyRoutes:Dn,findLegacyRoute:Fn,internalPathDomain:Qa},Xn=[{id:"ch0_vip_fix",chapter:0,check:()=>l.hasFlag("ch0_vip_fixed"),reward:{},title:"修正 VIP 折扣計算 (INV-2024-0042)"},{id:"ch1_system_alert",chapter:1,check:()=>l.hasFlag("ch1_system_down"),reward:{evidence:{id:"e001",title:"INV-2024-0043 系統警報",chapter:1,type:"anomaly"}},title:"觸發系統警報 (INV-2024-0043)"},{id:"ch1_feng_shui_tree",chapter:1,check:()=>l.hasFlag("ch1_tree_seen"),reward:{evidence:{id:"e002",title:"老闆的風水樹",chapter:1,type:"behavior"}},title:"發現老闆的風水樹"},{id:"ch2_accident_news",chapter:2,check:()=>l.get("searchHistory")?.some(e=>e.includes("Sawyer")||e.includes("Choi")||e.includes("車禍")),reward:{evidence:{id:"e003",title:"車禍新聞 — 父母雙亡",chapter:2,type:"news"}},title:"搜尋到車禍新聞"},{id:"ch2_insurance_blog",chapter:2,check:()=>l.get("discoveredFiles")?.includes("https://sawyer-blog.example/2012-07-07")||l.get("searchHistory")?.some(e=>e.includes("保險")),reward:{evidence:{id:"e004",title:"保險受益人 Blog",chapter:2,type:"blog"}},title:"發現保險受益人文章"},{id:"ch2_lottery_lie",chapter:2,check:()=>l.hasFlag("lottery_lie_seen"),reward:{evidence:{id:"e005",title:"六合彩謊言",chapter:2,type:"lie"}},title:"發現六合彩謊言紀錄"},{id:"ch2_dark_blog",chapter:2,check:()=>l.get("discoveredFiles")?.includes("https://sawyer-blog.example/2023-12-20"),reward:{evidence:{id:"e006",title:"Sawyer 暗示文字",chapter:2,type:"blog"}},title:"發現 2023-12-20 Blog"},{id:"ch3_git_secret",chapter:3,check:()=>l.hasFlag("git_secret_found"),reward:{evidence:{id:"e007",title:"Git 刪除的 secret path",chapter:3,type:"code"}},title:"在 Git 歷史找到刪除的 secret path"},{id:"ch3_darknet_url",chapter:3,check:()=>l.hasFlag("dark_entered")||l.hasFlag("hidden_portal_accessed"),reward:{evidence:{id:"e008",title:"暗網入口 URL",chapter:3,type:"portal"}},title:"找到暗網完整入口"},{id:"ch4_drug_transactions",chapter:4,check:()=>l.hasFlag("ch4_all_opened")||l.get("discoveredFiles")?.some(e=>e.includes("/darknet/")),reward:{evidence:{id:"e009",title:"毒品交易紀錄",chapter:4,type:"darknet"}},title:"開啟毒品交易列表"},{id:"ch4_drug_route",chapter:4,check:()=>l.hasFlag("ch4_all_opened")||l.get("discoveredFiles")?.some(e=>e.includes("drug-route")),reward:{evidence:{id:"e010",title:"毒品結構圖",chapter:4,type:"darknet"}},title:"開啟毒品結構圖"},{id:"ch4_sawyer_expenses",chapter:4,check:()=>l.hasFlag("ch4_all_opened")||l.get("discoveredFiles")?.some(e=>e.includes("sawyer_expenses")),reward:{evidence:{id:"e011",title:"Sawyer 個人支出",chapter:4,type:"darknet"}},title:"發現 Sawyer 與 FredyArc 金流"},{id:"ch4_travel_records",chapter:4,check:()=>l.hasFlag("ch4_all_opened")||l.get("discoveredFiles")?.some(e=>e.includes("travel_records")),reward:{evidence:{id:"e012",title:"Travel 紀錄",chapter:4,type:"darknet"}},title:"發現 Sawyer 多次前往毒品路線城市"},{id:"ch4_meeting_minutes",chapter:4,check:()=>l.hasFlag("ch4_all_opened")||l.get("discoveredFiles")?.some(e=>e.includes("meeting_minutes")),reward:{evidence:{id:"e013",title:"Sawyer × Fredy 會議紀錄",chapter:4,type:"darknet"}},title:"發現定期會議紀錄"},{id:"ch5_choose_ending",chapter:5,check:()=>(l.get("endings")||[]).length>0,reward:{},title:"選擇結局"}];function et(){for(const t of Xn)l.hasFlag(`puzzle:${t.id}`)||t.check()&&(l.setFlag(`puzzle:${t.id}`,!0),t.reward?.evidence&&l.addEvidence(t.reward.evidence),t.reward?.unlock&&t.reward.unlock.forEach(a=>l.unlockInterface(a)),W.emit("puzzle:solved",t));let e=0;l.hasFlag("ch0_vip_fixed")&&(e=1),l.hasFlag("ch1_revert_done")&&(e=2),(l.hasFlag("dark_entered")||l.hasFlag("hidden_portal_accessed"))&&(e=3),l.hasFlag("ch4_all_opened")&&(e=4),(l.get("endings")||[]).length>0&&(e=5),e!==l.get("currentChapter")&&(l.set("currentChapter",e),W.emit("chapter:changed",e))}var Zn=null;function ei(){W.on("change",et),W.on("vfs:read",et),W.on("portal:discovered",et),W.on("portal:bypassed",et),Zn=setInterval(et,800),et()}var Ia={"zh-TW":{"app.title":"聽日辭職","app.subtitle":"編程人生模擬 · 離線 ARG","dock.vscode":"Vizual Studio Code","dock.intranet":"內網","dock.jira":"Jiua","dock.whatsapp":"WhatUp","dock.search":"Search","dock.notebook":"筆記本","dock.settings":"設定","settings.theme":"主題","settings.language":"語言","settings.export":"匯出存檔","settings.import":"匯入存檔","settings.reset":"重置進度","toast.saved":"已儲存","toast.evidence":"發現新證據","toast.unlocked":"解鎖新介面"},en:{"app.title":"聽日辭職","app.subtitle":"Dev Life Sim · Offline ARG","dock.vscode":"Vizual Studio Code","dock.intranet":"Intranet","dock.jira":"Jiua","dock.whatsapp":"WhatUp","dock.search":"Search","dock.notebook":"Notebook","dock.settings":"Settings","settings.theme":"Theme","settings.language":"Language","settings.export":"Export Save","settings.import":"Import Save","settings.reset":"Reset Progress","toast.saved":"Saved","toast.evidence":"New evidence","toast.unlocked":"Interface unlocked"}};function he(e){const t=l.get("settings.language")||"zh-TW";return Ia[t]?.[e]??Ia["zh-TW"][e]??e}var re=da({renderDock:()=>$e,setActiveView:()=>tn,setDockVisible:()=>ni});function $e({onSwitch:e,onOpenSettings:t,onOpenNotebook:a,t:i}){const n=document.getElementById("dock");if(!n)return;function s(p){return p==="email"?l.hasFlag("ch5_triggered"):!0}const r=localStorage.getItem("cc_active_view")||"vscode",d={vscode:"/arg-game-it-company-secret/icon/vizual-studio-code.svg",intranet:"/arg-game-it-company-secret/icon/file-system.svg",jira:"/arg-game-it-company-secret/icon/jiua.svg",whatsapp:"/arg-game-it-company-secret/icon/whatsup.svg",search:"/arg-game-it-company-secret/icon/browser.svg",email:"/arg-game-it-company-secret/icon/mail.svg"},o={notebook:"/arg-game-it-company-secret/icon/notepad.png"};function c(p,u,v){const h=!s(p),b=r===p?"active":"",$=d[p];let j;return $&&$.startsWith("/icon/")?j=`<img class="taskbar__app-icon-img" src="${$}" alt="${v}" width="22" height="22" loading="eager" />`:$&&$.startsWith("fa-")?p==="jira"?j=`<i class="${$}" aria-hidden="true" style="font-size:22px;line-height:1;--fa-primary-color:rgba(19,91,205,1);--fa-secondary-color:rgba(19,91,205,0.4);color:rgba(19,91,205,1)"></i>`:p==="vscode"?j=`<i class="${$}" aria-hidden="true" style="font-size:22px;line-height:1;--fa-primary-color:rgba(87,165,229,1);--fa-secondary-color:rgba(87,165,229,0.4);color:rgba(87,165,229,1)"></i>`:p==="whatsapp"?j=`<i class="${$}" aria-hidden="true" style="font-size:22px;line-height:1;--fa-primary-color:rgba(0,203,90,1);--fa-secondary-color:rgba(0,203,90,0.4);color:rgba(0,203,90,1)"></i>`:j=`<i class="${$}" aria-hidden="true" style="font-size:22px;line-height:1;color:currentColor"></i>`:$?j=`<img class="taskbar__app-icon-img" src="${$}" alt="${v}" width="22" height="22" loading="eager" />`:j=`<span class="taskbar__app-icon" aria-hidden="true">${u}</span>`,`<button class="taskbar__app ${b}" data-view="${p}" ${h?'disabled title="尚未解鎖"':`title="${v}"`}>
  ...
  `,n.querySelectorAll("[data-view]").forEach(p=>{p.addEventListener("click",()=>{if(p.dataset.view==="email"){const u=document.getElementById("mailDialog");if(u){const v=document.getElementById("mailTitle"),h=document.getElementById("mailTo");if(v&&h){const b=v.value;b==="Report"?h.value="DEA <dea@world.example>":(b==="Coperation"||b==="Resign")&&(h.value="Sawyer <sawyer@nori-drinks.example>")}u.showModal()}return}e(p.dataset.view)})}),n.querySelector('[data-action="settings"]')?.addEventListener("click",t),n.querySelector('[data-action="notebook"]')?.addEventListener("click",a),ti()}var Kt=null;function ti(){function e(){const t=new Date,a=document.getElementById("taskbarTime"),i=document.getElementById("taskbarDate");if(!a||!i)return;const n=t.toLocaleTimeString("zh-TW",{hour:"numeric",minute:"2-digit",hour12:!0}),s="2024/09/02";a.textContent=n,i.textContent=s}e(),Kt&&clearInterval(Kt),Kt=setInterval(e,6e4)}function ai(){document.querySelectorAll("dialog[open]").forEach(n=>{try{n.close()}catch{}n.style.removeProperty("display")});const e=document.getElementById("startMenu");e&&(e.style.display="none");const t=document.getElementById("intraPreview");t&&(t.style.display="none");const a=document.getElementById("darkPreview");a&&(a.style.display="none");const i=document.getElementById("waLightbox");i&&i.classList.remove("open")}function tn(e){ai(),localStorage.setItem("cc_active_view",e),document.querySelectorAll(".taskbar__app[data-view]").forEach(t=>{t.classList.toggle("active",t.dataset.view===e)}),document.querySelectorAll(".view").forEach(t=>{t.classList.toggle("active",t.id===`view-${e}`)})}function ni(e){const t=document.getElementById("dock");t&&(t.style.display=e?"":"none")}function X(e,t={}){const a=document.getElementById("toasts");if(!a)return;const i=document.createElement("div");i.className="toast",i.textContent=e,t.variant==="error"&&(i.style.background="#7a1f1f"),a.appendChild(i),setTimeout(()=>{i.style.opacity="0",i.style.transform="translateY(4px)",i.style.transition="all .25s",setTimeout(()=>i.remove(),260)},t.duration||2200)}function ii(e,t){const a=new Blob([t],{type:"application/json;charset=utf-8"}),i=URL.createObjectURL(a),n=document.createElement("a");n.href=i,n.download=e,n.click(),URL.revokeObjectURL(i)}function si(e){return new Promise((t,a)=>{const i=new FileReader;i.onload=()=>t(i.result),i.onerror=a,i.readAsText(e)})}var ri={default:"/arg-game-it-company-secret/assets/data/music/Teacup Corridor (warmer).mp3",darknet:"/arg-game-it-company-secret/assets/data/music/Teacup Corridor.mp3",cooperate:"/arg-game-it-company-secret/assets/data/music/bgm_cowork.mp3",flee:"/arg-game-it-company-secret/assets/data/music/bgm_flee.mp3",fried:"/arg-game-it-company-secret/assets/data/music/bgm_fried.mp3",report:"/arg-game-it-company-secret/assets/data/music/bgm_report.mp3",resign:"/arg-game-it-company-secret/assets/data/music/bgm_resign.mp3"},oi=.25,Ca=1500,li=class{constructor(){this.audio=null,this.currentBgm=null,this.isMuted=!1,this.volume=oi,this.fadeTimer=null,this._loadSettings()}_loadSettings(){const e=l.get("settings");e&&(typeof e.bgmVolume=="number"&&(this.volume=e.bgmVolume),typeof e.bgmMuted=="boolean"&&(this.isMuted=e.bgmMuted))}_saveSettings(){l.set("settings.bgmVolume",this.volume),l.set("settings.bgmMuted",this.isMuted)}_createAudio(e){const t=new Audio(e);return t.loop=!0,t.preload="auto",t.volume=this.isMuted?0:this.volume,t}_fadeVolume(e,t,a,i){this.fadeTimer&&cancelAnimationFrame(this.fadeTimer);const n=performance.now(),s=r=>{const d=r-n,o=Math.min(d/a,1),c=e+(t-e)*o;this.audio&&(this.audio.volume=this.isMuted?0:c),o<1?this.fadeTimer=requestAnimationFrame(s):(this.fadeTimer=null,i&&i())};this.fadeTimer=requestAnimationFrame(s)}_stopCurrent(e=!0){if(!this.audio)return Promise.resolve();const t=this.audio,a=t.volume;return e&&a>0?new Promise(i=>{this._fadeVolume(a,0,Ca,()=>{t.pause(),t.src="",i()})}):(t.pause(),t.src="",Promise.resolve())}async play(e){const t=ri[e];if(t&&this.currentBgm!==e){await this._stopCurrent(!0),this.currentBgm=e,this.audio=this._createAudio(t);try{await this.audio.play(),this._fadeVolume(0,this.volume,Ca)}catch(a){console.warn("BGM play failed:",a)}}}async stop(e=!0){await this._stopCurrent(e),this.audio=null,this.currentBgm=null}setVolume(e){this.volume=Math.max(0,Math.min(1,e)),this.audio&&!this.isMuted&&(this.audio.volume=this.volume),this._saveSettings()}getVolume(){return this.volume}toggleMute(){return this.isMuted=!this.isMuted,this.audio&&(this.audio.volume=this.isMuted?0:this.volume),this._saveSettings(),this.isMuted}setMuted(e){this.isMuted=e,this.audio&&(this.audio.volume=this.isMuted?0:this.volume),this._saveSettings()}isMutedState(){return this.isMuted}getCurrentBgm(){return this.currentBgm}},ie=new li;function qe(){const e=document.getElementById("settingsDialog");e&&(typeof e.showModal=="function"?e.open||e.showModal():typeof e.show=="function"?e.open||e.show():(e.style.display="block",e.setAttribute("open","")),e.style.removeProperty("display"),ci())}function ci(){const e=document.getElementById("settingTheme");e&&(e.value=l.get("settings.theme"));const t=document.getElementById("settingPlaytime");t&&(t.textContent=String(l.get("playtime"))+"s")}function di(){document.getElementById("settingTheme")?.addEventListener("change",i=>{const n=i.target.value;l.set("settings.theme",n),document.documentElement.setAttribute("data-theme",n),X(he("toast.saved"))});const e=document.getElementById("bgmMuteBtn"),t=document.getElementById("bgmVolumeSlider"),a=document.getElementById("bgmVolumePct");e&&!e._bound&&(e._bound=!0,e.addEventListener("click",()=>{const i=ie.toggleMute();e.textContent=i?"🔇":"🔊",a&&(a.textContent=i?"靜音":Math.round(ie.getVolume()*100)+"%")})),t&&!t._bound&&(t._bound=!0,t.addEventListener("input",i=>{const n=parseInt(i.target.value)/100;ie.setVolume(n),ie.setMuted(!1),e&&(e.textContent="🔊"),a&&(a.textContent=Math.round(n*100)+"%")})),document.getElementById("btnExport")?.addEventListener("click",()=>{ii("code-conspiracy-save.json",l.exportSave())}),document.getElementById("btnImport")?.addEventListener("change",async i=>{const n=i.target.files?.[0];if(!n)return;const s=await si(n),r=l.importSave(s);X(r?he("toast.saved"):"Import failed",{variant:r?void 0:"error"}),r&&location.reload()}),document.getElementById("btnReset")?.addEventListener("click",async()=>{if(confirm("Reset all progress?")){try{l.reset()}catch{}try{localStorage.removeItem("code_conspiracy_state")}catch{}try{localStorage.clear()}catch{}const i=document.getElementById("settingsDialog");if(i&&i.open)try{i.close()}catch{}i&&(i.style.removeProperty("display"),i.removeAttribute("open"));try{if("caches"in window){const n=await caches.keys();await Promise.all(n.map(s=>caches.delete(s)))}if("serviceWorker"in navigator){const n=await navigator.serviceWorker.getRegistrations();await Promise.all(n.map(s=>s.unregister()))}}catch{}setTimeout(()=>{window.location.href=window.location.pathname+"?reset="+Date.now(),window.location.reload(!0)},150)}}),document.getElementById("settingsDialog")?.addEventListener("close",()=>{})}var La=["教學","異常發現","自由探索","暗網入口","秘密曝光","抉擇"],pi=13,ui={vscode:"Vizual",jira:"Jiua",whatsapp:"WhatUp",search:"Search",intranet:"Intranet",darknet:"Darknet",email:"Email"};function mi(e){return!e||!e.length?"—":e.map(t=>ui[t]||t).join(", ")}function gi(e){return e=Number(e)||0,e<=59?`${e} 秒`:e<3600?`${Math.floor(e/60)} 分鐘`:e<86400?`${Math.floor(e/3600)} 小時`:`${Math.floor(e/86400)} 日`}function hi(){const e=l.get("readArticles")||[],t=l.get("discoveredFiles")||[],a=l.get("endings")||l.get("unlockedEndings")||[],i=l.get("whatsappSentCount")||0,n=l.get("persistentStats")||{},s=n.readArticles||[],r=n.darkFileCount||0,d=n.whatsappSentCount||0,o=n.searchHistoryCount||0,c=n.flags||{},m=["https://sawyer-blog.example/2001-10-18","https://sawyer-blog.example/2003-04-27","https://sawyer-blog.example/2004-11-13","https://sawyer-blog.example/2006-09-01","https://sawyer-blog.example/2007-01-11","https://sawyer-blog.example/2007-01-12","https://sawyer-blog.example/2010-06-06","https://sawyer-blog.example/2012-07-07","https://sawyer-blog.example/2013-01-01","https://sawyer-blog.example/2023-04-25","https://sawyer-blog.example/2023-05-01","https://sawyer-blog.example/2023-05-10","https://sawyer-blog.example/2023-12-20","https://sawyer-blog.example/2024-01-15","https://sawyer-blog.example/2024-03-20"],p=["https://school.example/guangzhi-essay-sawyer"],u=["https://news.example/car-accident-2023","https://news.example/car-accident-investigation-2023","https://news.example/ping-wo-suspicious-man-2023","https://news.example/police-clarification-2023"],v=[...m,...p,...u],h=[...m,"https://mary-blog.example/kyoto-sakura-2024","https://mary-blog.example/one-person-kitchen","https://mary-blog.example/danshari-half-year","https://peter-blog.example/python-one-year","https://peter-blog.example/vim-vs-vscode","https://peter-blog.example/nas-ds220","https://peter-blog.example/code-easter-eggs","https://paul-blog.example/tainan-beef-soup","https://paul-blog.example/hand-drip-coffee","https://paul-blog.example/keelung-night-market","https://emma-blog.example/contax-t2-taipei","https://emma-blog.example/iceland-aurora","https://david-blog.example/vinyl-jazz-20","https://david-blog.example/livehouse-map"];let b=10;try{const f=k.listDarkFiles?k.listDarkFiles("/darknet"):[];f.length&&(b=f.length)}catch{}const $=Math.max(t.filter(f=>f.startsWith("/darknet")).length,r),j=Math.max(l.hasFlag("portal_simple_entered")?1:0,c.portal_simple_entered?1:0),oe=Math.max(l.hasFlag("portal_hash_entered")?1:0,c.portal_hash_entered?1:0),E=[...new Set([...e,...s])],_=Math.max(i,d),w=Math.max((l.get("searchHistory")||[]).length,o),y=[...new Set([...a,...l.get("unlockedEndings")||[],...n.unlockedEndings||[]])];return[{id:"secret_entry",title:"解鎖秘密入口",desc:"進入公司秘密內部系統入口",total:2,current:j+oe,isSecret:!1},{id:"boss_whisper",title:"老闆知音",desc:"已了解老闆的一切",total:20,current:v.filter(f=>E.includes(f)).length,isSecret:!1},{id:"too_much",title:"你知道得太多了",desc:"閱讀所有秘密檔案",total:b,current:Math.min($,b),isSecret:!1},{id:"all_endings",title:"作者感謝您",desc:"解鎖全結局",total:5,current:y.length,isSecret:!1},{id:"social",title:"社牛",desc:"在 WhatUp 發送超過 10 條訊息",total:10,current:Math.min(_,10),isSecret:!0},{id:"reader",title:"閱讀達人",desc:"閱讀 BlogWorld 上的所有部落格",total:29,current:h.filter(f=>E.includes(f)).length,isSecret:!0},{id:"miracle",title:"你沒有被解僱是奇蹟",desc:"向 Sawyer 發送帶有「垃圾」「蠢」等字眼的訊息",total:1,current:Math.max(l.hasFlag("sawyer_abuse_sent")?1:0,c.sawyer_abuse_sent?1:0),isSecret:!0},{id:"net_addict",title:"網路成癮",desc:"在搜尋引擎搜尋超過 50 次",total:50,current:Math.min(w,50),isSecret:!0}].map(f=>({...f,done:f.current>=f.total,progress:`${f.current}/${f.total}`,pct:Math.round(f.current/f.total*100)}))}var Ta=[{id:"flee",idx:1,title:"平凡的日常",desc:"完成工作後登出，回到平凡重複的日常。",color:"#6b778c"},{id:"cooperate",idx:2,title:"共犯",desc:"與老闆合作，踏入充滿刺激與風險的新生活。",color:"#d93025"},{id:"report",idx:3,title:"舉報",desc:"向警方舉報，目睹公司倒閉與風波後的平靜。",color:"#0d9488"},{id:"resign",idx:4,title:"辭職",desc:"遠離是非，主動辭職尋找新的工作與記憶。",color:"#6554c0"},{id:"fried",idx:5,title:"做對了嗎？",desc:"公司已發現你。",color:"#ff991f"}];function ze(){const e=document.getElementById("notebookDialog");e&&(vi(),typeof e.showModal=="function"?e.open||e.showModal():typeof e.show=="function"?e.open||e.show():(e.setAttribute("open",""),e.style.display="block"),e.style.removeProperty("display"),e._boundClose||(e.addEventListener("close",()=>{e.style.removeProperty("display"),e.removeAttribute("open")}),e._boundClose=!0))}function vi(){const e=document.getElementById("notebookContent");if(!e)return;const t=l.get("collectedEvidence")||[];l.get("flags");const a=l.get("currentChapter")??0,i=hi(),n=i.filter(c=>c.done).length,s=l.get("persistentStats")?.unlockedEndings||[],r=l.get("endings")||l.get("unlockedEndings")||[],d=[...new Set([...r,...s])],o=(()=>{const c=Ta.map(m=>{const p=d.includes(m.id),u="？".repeat([...m.title].length);return`
    ...
    <div class="card">
      <div style="display:flex;justify-content:space-between;align-items:center">
        <h3 style="margin:0">進度 · Chapter ${a} / 5 — ${La[a]||"—"}</h3>
      ...
      <div class="small muted" style="margin-top:6px">遊玩時長 ${gi(l.get("playtime"))} · 已解鎖 ${mi(l.get("unlockedInterfaces"))}</div>
    </div>

    <div class="card" style="margin-top:12px">
      <h3 style="margin:0 0 8px">證據板 (${t.length}/${pi})</h3>
      ${t.length?`
    ...
    <div class="card" style="margin-top:12px">
      ...
      <div style="display:grid;gap:4px">
        ${La.map((c,m)=>`<div style="display:flex;justify-content:space-between;padding:6px 8px;border-radius:6px;background:${m<=a?"var(--bg-tertiary)":"var(--bg-primary)"};border:1px solid var(--border)"><span>Ch${m} ${c}</span><span class="small ${m<a?"":m===a?"badge":""}" style="${m===a?"background:var(--accent);color:#fff":""}">${m<a?"完成":m===a?"進行中":"未開始"}</span></div>`).join("")}
      </div>
    </div>
    ${o}
  ...
  `,setTimeout(()=>{const c=document.getElementById("notebookResetBtn");!c||c._bound||(c._bound=!0,c.addEventListener("click",async()=>{if(!confirm("重置後將失去證據，確定？"))return;const m=document.getElementById("notebookDialog");try{m&&m.open&&m.close()}catch{}m&&(m.style.removeProperty("display"),m.removeAttribute("open"));let p=null;try{p=JSON.parse(JSON.stringify(l.get("persistentStats")||{}))}catch{}try{l.reset()}catch{}try{if(p){const u=l.get("persistentStats")||{},v={unlockedEndings:[...new Set([...u.unlockedEndings||[],...p.unlockedEndings||[]])],readArticles:[...new Set([...u.readArticles||[],...p.readArticles||[]])],darkFileCount:Math.max(u.darkFileCount||0,p.darkFileCount||0),whatsappSentCount:Math.max(u.whatsappSentCount||0,p.whatsappSentCount||0),searchHistoryCount:Math.max(u.searchHistoryCount||0,p.searchHistoryCount||0),flags:{...u.flags||{},...p.flags||{}}};l.set("persistentStats",v),l.set("unlockedEndings",v.unlockedEndings)}}catch{}try{if("caches"in window){const u=await caches.keys();await Promise.all(u.map(v=>caches.delete(v)))}if("serviceWorker"in navigator){const u=await navigator.serviceWorker.getRegistrations();await Promise.all(u.map(v=>v.unregister()))}}catch{}setTimeout(()=>{window.location.href=window.location.pathname+"?reset="+Date.now(),window.location.reload(!0)},150)}))},0),setTimeout(()=>{const c=document.querySelector(".nb-endings-grid");c&&c.querySelectorAll(".nb-ending-card.unlocked").forEach(m=>{m.addEventListener("click",()=>{const p=m.dataset.ending,u=Ta.find(v=>v.id===p);if(u){try{const v=new CustomEvent("nb:endingPreview",{detail:u});window.dispatchEvent(v)}catch{}m.classList.add("pulse"),setTimeout(()=>m.classList.remove("pulse"),600)}})})},0)}function g(e){return e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var fi="modulepreload",yi=function(e){return"/arg-game-it-company-secret/"+e},$a={},A=function(t,a,i){let n=Promise.resolve();if(a&&a.length>0){let c=function(p){return Promise.all(p.map(u=>Promise.resolve(u).then(v=>({status:"fulfilled",value:v}),v=>({status:"rejected",reason:v}))))},m=function(p){return import.meta.resolve?import.meta.resolve(p):new URL(p,import.meta.url).href};const r=document.getElementsByTagName("link"),d=document.querySelector("meta[property=csp-nonce]"),o=d?.nonce||d?.getAttribute("nonce");n=c(a.map(p=>{if(p=yi(p,i),p=m(p),p in $a)return;$a[p]=!0;const u=p.endsWith(".css");for(let h=r.length-1;h>=0;h--){const b=r[h];if(b.href===p&&(!u||b.rel==="stylesheet"))return}const v=document.createElement("link");if(v.rel=u?"stylesheet":fi,u||(v.as="script"),v.crossOrigin="",v.href=p,o&&v.setAttribute("nonce",o),document.head.appendChild(v),u)return new Promise((h,b)=>{v.addEventListener("load",h),v.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${p}`)))})}))}function s(r){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=r,window.dispatchEvent(d),!d.defaultPrevented)throw r}return n.then(r=>{for(const d of r||[])d.status==="rejected"&&s(d.reason);return t().catch(s)})},F="/customer-portal/src/main/java/com/nori/OrderService.java",Z="explorer",Te=[],ue=-1,Mt="",bi=new Set(["/customer-portal/src/frontend/src/pages/Home.jsx","/customer-portal/src/main/java/com/nori/controller/OrderController.java","/customer-portal/scripts/reconcile.py","/customer-portal/src/payment/gateway.js","/customer-portal/src/main/java/com/nori/service/PaymentService.java","/customer-portal/src/main/java/com/nori/controller/PaymentController.java"]);function Ee(e){return bi.has(e)}var R=new Map,Me=null,Aa=null;function ot(e){const t=k.getFile(e);return t?t.content:null}function ra(e){return R.has(e)?R.get(e):ot(e)}function an(e){return R.has(e)?R.get(e)!==ot(e):!1}function _i(e,t){t===ot(e)?R.delete(e):R.set(e,t),Ie(),ye(),De()}function ua(){if(!Me){const e=k.getFile("/file-system/src/components/SearchBar.jsx");e&&(Me=e.content)}}function wi(){if(!Aa){const e=k.getFile("/customer-portal/src/frontend/src/pages/Home.jsx");e&&(Aa=e.content)}}var xi=`export default function Home(){
  return (
    <div>
      <h1>Nori 飲品供應 — 用一杯冰釀茶酒，連結人與希望</h1>
      <p>創辦人 蔡梓掦 · 2018 創立 · 招牌冰釀茶酒最暢銷</p>
...
`,ki=`export default function Home(){
  return (
    <div>
...
+ restored legacyRoutes`});const n=document.getElementById("scmCommitStatus");n&&(n.innerHTML=`<span style="color:var(--success)">✓ Revert 成功: ${a} (from ${e})</span>`),C(`✓ revert ${a} — ${i}`),Ie(),ye(),Ce(),De(),fe&&je(),sn("git-graph")}var de=[{hash:"a1b2c3d",author:"finance@internal",date:"2024-08-12",msg:"feat: integrate crypto-mixer (legacy)",diff:`+ import { cryptoMixer } from '@shady/crypto-mixer'
...
+ export function computeFee(amount, opts) {}`}],Ba={"/customer-portal/src/billing/service.js":[{line:1,commit:"4c2a1e0",author:"dev"},{line:5,commit:"4c2a1e0",author:"dev"},{line:9,commit:"9f8e7d6",author:"qa-lee"},{line:12,commit:"9f8e7d6",author:"qa-lee"},{line:14,commit:"a1b2c3d",author:"finance@internal"}],"/customer-portal/src/main/java/com/nori/OrderService.java":[{line:1,commit:"4c2a1e0",author:"dev"},{line:12,commit:"9f8e7d6",author:"qa-lee"},{line:15,commit:"a1b2c3d",author:"finance@internal"}]},ve="__GIT_GRAPH__",fe=!1,Je=null,ja={main:"#89d185","feature/vip-discount":"#4da3ff","feature/crypto-mixer":"#dcdcaa","feature/billing-fix":"#ce9178","feature/home-copyfix":"#4ec9b0",develop:"#c586c0"},se=[{hash:"a1b2c3d",branch:"feature/crypto-mixer",author:"finance@internal",date:"2024-08-12",msg:"(INV-2024-0040) feat: integrate crypto-mixer (legacy)",diff:`+ import { cryptoMixer } from '@shady/crypto-mixer'
...
+ <h1>Nori 飲品供應 — 用一杯冰釀茶酒，連結人與風味</h1>
- <p>創辦人 蔡梓掦 · 2018 創立</p>
+ <p>創辦人 蔡梓掦 · 2019 創立</p>`},{hash:"d4e5f6a",branch:"main",author:"dev-chen",date:"2023-11-20",msg:"(INV-2023-0039) refactor: simplify portal auth (remove dynamic generator)",diff:"- function generateInternalPortalPath(internalPortalDomain){ \n-     const cid = redis.get('companyId'); \n-     const y = redis.get('year'); \n-     const k = import.meta.env.MD5_KEY; \n-     return internalPortalDomain + '?hash=' + md5(`companyId=${cid}&year=${y}&key=${k}`); // e.g. https://google.com/internal?hash=be78e7542cd6d04e31e80fa8b741aad4\n-     }"}];function rn(){const e=se.find(a=>a.hash==="d4e5f6a");e&&!e.diff.includes("e.g. https://google.com/internal?hash=")&&(e.diff=e.diff.replace("md5(`companyId=${cid}&year=${y}&key=${k}`);","md5(`companyId=${cid}&year=${y}&key=${k}`); // e.g. https://google.com/internal?hash=be78e7542cd6d04e31e80fa8b741aad4"));const t=de.find(a=>a.hash==="d4e5f6a");t&&t.diff&&!t.diff.includes("e.g. https://google.com")&&(t.diff=e.diff)}rn();function Ie(){try{const e=Array.from(R.entries());l.set("vscodeState",{editedFiles:e,gitCommits:de.slice(0,20),gitGraphCommits:se.slice(0,20),currentFile:F,activeActivity:Z,gitGraphOpen:fe,expandedGraphHash:Je}),l.save(!0)}catch{}}function on(e){try{const t=JSON.parse(localStorage.getItem("code_conspiracy_state")||"{}").whatsappChats;if(Array.isArray(t)){const a=t.find(i=>i.id===e);if(a)return!!a.muted}return!1}catch{return!1}}function Ei(){try{const e=l.get("vscodeState");if(!e||typeof e!="object")return;if(Array.isArray(e.editedFiles))for(const[t,a]of e.editedFiles){R.set(t,a);const i=k.getFile(t);i?i.content=a:k.registerFile(t,{content:a,meta:{lang:t.endsWith(".java")?"java":t.endsWith(".js")?"javascript":"text"}})}if(Array.isArray(e.gitCommits)&&e.gitCommits.length){de.length=0;for(const t of e.gitCommits)de.push(t)}if(Array.isArray(e.gitGraphCommits)&&e.gitGraphCommits.length){se.length=0;for(const t of e.gitGraphCommits)se.push(t)}try{rn()}catch{}typeof e.currentFile=="string"&&e.currentFile&&(F=e.currentFile),typeof e.activeActivity=="string"&&(Z=e.activeActivity),typeof e.gitGraphOpen=="boolean"&&(fe=e.gitGraphOpen),e.expandedGraphHash&&(Je=e.expandedGraphHash)}catch{}}function Ii(){Ei();const e=document.getElementById("view-vscode");e&&(e.innerHTML=`
    <div class="vscode">
...
`).map(p=>{const u=g(p);return p.startsWith("+")?`<div class="diff-add">${u}</div>`:p.startsWith("-")?`<div class="diff-del">${u}</div>`:`<div>${u}</div>`}).join(""),c=n.author==="Casey"&&(n.diff.includes("SearchBar")||n.diff.includes("legacyRoutes")||n.msg.includes("0043"));(n.hash==="3f2a9c1"||n.msg.includes("INV-2024-0017"))&&n.author;const m=a&&c&&!l.hasFlag("ch1_revert_done")&&l.hasFlag("sawyer_seq_started");return`
    ...
    <div class="gitgraph-editor">
      <div class="gitgraph-editor__header">
        ...
        <div class="gitgraph-legend">
          ${Object.entries(ja).map(([n,s])=>`<span class="gitgraph-branch" style="background:${s}22;color:${s};border-color:${s}44">${g(n)}</span>`).join("")}
        </div>
      </div>
  ...
  `,e.querySelectorAll(".gitgraph-row__main").forEach(n=>{n.addEventListener("click",s=>{if(s.target.closest(".gitgraph-revert-btn"))return;const r=n.closest(".gitgraph-row")?.dataset.hash;r&&(Je=Je===r?null:r,je())})}),e.querySelectorAll(".gitgraph-revert-btn").forEach(n=>{n.addEventListener("click",s=>{s.stopPropagation();const r=n.dataset.revert;r&&Si(r)})}),C("$ open Git Graph")}function Ti(e){const t=e.split(`
`).filter(i=>i.trim()!=="");if(!t.length)return{header:[],rows:[]};const a=i=>{const n=[];let s="",r=!1;for(let d=0;d<i.length;d++){const o=i[d];o==='"'?r&&i[d+1]==='"'?(s+='"',d++):r=!r:o===","&&!r?(n.push(s),s=""):s+=o}return n.push(s),n};return{header:a(t[0]),rows:t.slice(1).map(a)}}function $i(e,t){const{header:a,rows:i}=Ti(t),n=`<thead><tr>${a.map(r=>`<th>${g(r)}</th>`).join("")}</tr></thead>`,s=`<tbody>${i.map((r,d)=>`<tr>${r.map(o=>`<td>${g(o)}</td>`).join("")}${r.length<a.length?`<td colspan="${a.length-r.length}"></td>`:""}</tr>`).join("")}</tbody>`;return`
    <div class="csv-view">
  ...
  `}function pe(e){if(Ee(e)){const s=document.getElementById("vsEditor");s&&(s.innerHTML='<div class="editor__lines" style="padding:16px;color:var(--fg-muted)">檔案不存在或尚未解鎖 — 嘗試 Search 搜尋 "Sawyer" 或觸發隱藏邏輯</div>');return}if(e===ve){F=e,Ie(),je(),Ce(document.getElementById("vsQuickOpen")?.value.trim().toLowerCase()||"");return}F=e,Ie();const t=k.getFile(e),a=ra(e),i=document.getElementById("vsEditor");if(!i)return;if((e==="/customer-portal/src/main/java/com/nori/OrderService.java"||e==="/customer-portal/src/billing/service.js")&&An("vscode_viewed"),a==null)i.innerHTML='<div class="editor__lines" style="padding:16px;color:var(--fg-muted)">檔案不存在或尚未解鎖 — 嘗試 Search 搜尋 "Sawyer" 或觸發隱藏邏輯</div>';else if(e.toLowerCase().endsWith(".csv"))i.innerHTML=$i(e,a);else{const s=t?.meta?.lang||(e.endsWith(".py")?"python":e.endsWith(".java")?"java":"javascript");i.innerHTML=`
...
`).map((d,o)=>`<div class="editor__gutter-line" style="height:20px;line-height:20px">${o+1}</div>`).join("")}</div>
    ...
    `;const r=document.getElementById("vsEditorArea");r&&(r.addEventListener("input",d=>{const o=d.target.value;_i(e,o);const c=o.split(`
`).length,m=i.querySelector(".editor__gutter");m&&(m.innerHTML=Array.from({length:c},($,j)=>`<div class="editor__gutter-line" style="height:20px;line-height:20px">${j+1}</div>`).join(""));const p=r.selectionStart,u=o.slice(0,p),v=u.split(`
`).length,h=u.split(`
...
`).length,p=c.split(`
`).pop().length+1,u=document.getElementById("vsCursorInfo");u&&(u.textContent=`Ln ${m}, Col ${p}`)}),r.addEventListener("keydown",d=>{if(d.key==="Tab"){d.preventDefault();const o=r.selectionStart,c=r.selectionEnd;r.value=r.value.substring(0,o)+"  "+r.value.substring(c),r.selectionStart=r.selectionEnd=o+2,r.dispatchEvent(new Event("input"))}}),e.includes("OrderService")&&setTimeout(()=>r.focus(),50))}const n=document.getElementById("vsTitle");n&&(n.textContent=`${e.split("/").pop()} — ${e} — nori-system — Vizual Studio Code`),Ce(document.getElementById("vsQuickOpen")?.value.trim().toLowerCase()||""),ye(),C(`$ open ${e}`)}function De(){const e=document.getElementById("scmChanges");if(!e)return;const t=[...R.entries()].filter(([a,i])=>i!==ot(a));if(!t.length){e.innerHTML=`<div class="small muted" style="padding:8px 0">修改完成後在這邊提交
 目前沒有變更 — 編輯後的改動會顯示於此</div>`;return}e.innerHTML=`
  ...
  `,e.querySelectorAll(".scm__file").forEach(a=>a.addEventListener("click",()=>pe(a.dataset.path)))}function Ai(e){const t={1:.9,2:.85,3:.8,4:.75,5:.7},a=e.split(`
`),i={};let n=null,s="";a.forEach((r,d)=>{const o=r.match(/case\s*([1-5])\s*:\s*price\s*\*=\s*([0-9.]+%?)/i);if(o){const c=parseInt(o[1],10);let m=o[2].replace("%","").trim(),p=parseFloat(m);p>1&&(p=p/100),i[c]={val:p,line:d+1,raw:r.trim()}}else{const c=r.match(/case\s*([1-5])\s*:\s*price\s*=\s*price\s*\*\s*([0-9.]+)/i);if(c){const m=parseInt(c[1],10);let p=parseFloat(c[2]);p>1&&(p=p/100),i[m]={val:p,line:d+1,raw:r.trim()}}}});for(let r=1;r<=5;r++){const d=t[r],o=i[r];if(!o)return n=a.findIndex(c=>c.includes(`case ${r}:`))+1||18+r,s=`缺少 case ${r} 或格式無法解析`,{ok:!1,line:n,detail:s,found:i};if(Math.abs(o.val-d)>.001)return{ok:!1,line:o.line,detail:`VIP${r} 應為 ${(d*100).toFixed(0)}% (0.${String(d).split(".")[1].padEnd(2,"0")})，目前為 ${(o.val*100).toFixed(0)}%`,found:i}}return{ok:!0,found:i}}function Bi(){const e=document.getElementById("scmCommitMsg"),t=document.getElementById("scmCommitStatus"),a=e?.value.trim()||"fix: correct VIP discount";if(![...R.entries()].filter(([E,_])=>_!==ot(E)).length){t&&(t.textContent="沒有變更可提交 — 請先編輯 OrderService.java");return}const i="/customer-portal/src/main/java/com/nori/OrderService.java",n=ra(i);if(n==null){t&&(t.textContent="找不到 OrderService.java");return}const s=Ai(n);if(!s.ok){const E=document.getElementById("sonarModal"),_=document.getElementById("sonarModalBody");_&&(_.textContent=`SonarQube 掃描失敗 — 計算錯誤
...
請修正後重新 Commit。`),E&&(E.style.display="flex"),t&&(t.innerHTML=`<span style="color:var(--error)">✕ SonarQube: 行 ${s.line} 計算錯誤</span>`),C(`✕ commit 失敗 — SonarQube 行 ${s.line}: ${s.detail}`);return}const r="/file-system/src/components/SearchBar.jsx",d=ot(r)||"",o=ra(r)||d,c=o.includes("legacyRoutes"),m=o.includes("resolveLegacyPath"),p=d.includes("legacyRoutes")&&!c&&!m;if(Array.from(R.keys()).includes(r),l.hasFlag("ch0_vip_fixed")&&!l.hasFlag("ch1_0043_committed")&&!p){const E=document.getElementById("sonarModal"),_=document.getElementById("sonarModalBody");_&&(_.textContent=`SonarQube 掃描失敗 — 未移除已棄用的 legacy 入口

檔案: ${r}
錯誤: 偵測到未移除的 legacyRoutes / resolveLegacyPath 區塊`),E&&(E.style.display="flex"),t&&(t.innerHTML='<span style="color:var(--error)">✕ SonarQube: 尚未移除 legacyRoutes 區塊 (SearchBar.jsx)</span>');return}if(p&&l.hasFlag("ch0_vip_fixed")&&!l.hasFlag("ch1_0043_committed")){let w=function({appSub:y,sender:f,avatarBg:B,avatarText:L,msg:z,chatId:_e,duration:Ze}){if(_e&&on(_e))return;const He=Ze||4e3,N=document.createElement("div");return N.id="wa-win-notif-"+Date.now()+"-"+Math.random().toString(36).slice(2,6),N.setAttribute("role","alert"),N.innerHTML=`<div class="win-notif__app"><img src="/arg-game-it-company-secret/icon/whatsup.svg" alt="WhatUp" width="20" height="20" style="width:20px;height:20px;object-fit:contain" /><span class="win-notif__app-name">WhatUp</span><span class="win-notif__app-sub">${g(y)}</span><button class="win-notif__close" aria-label="關閉">✕</button></div><div class="win-notif__body"><div class="win-notif__avatar" style="background:${B}">${g(L)}</div><div class="win-notif__text"><div class="win-notif__sender">${g(f)}</div><div class="win-notif__msg">${g(z)}</div><div class="win-notif__time">剛剛 · 點擊開啟對話</div></div></div><div class="win-notif__progress" style="animation: winNotifShrink ${He}ms linear forwards"></div>`,N.style.cssText="position:fixed;right:16px;bottom:60px;width:360px;background:#2d2d2d;color:#f0f0f0;border:1px solid rgba(255,255,255,.12);border-radius:8px;box-shadow:0 8px 28px rgba(0,0,0,.45);z-index:1100;overflow:hidden;cursor:pointer;opacity:0;transform:translateY(12px);transition:opacity .28s,transform .28s;",N.addEventListener("click",Le=>{Le.target.closest(".win-notif__close")||(N.remove(),A(()=>Promise.resolve().then(()=>re).then(we=>{we.setActiveView&&(we.setActiveView("whatsapp"),localStorage.setItem("cc_active_view","whatsapp"))}),void 0),_e&&A(()=>Promise.resolve().then(()=>ce).then(we=>we.openChat(_e)),void 0))}),N.querySelector(".win-notif__close")?.addEventListener("click",Le=>{Le.stopPropagation(),N.remove()}),document.body.appendChild(N),requestAnimationFrame(()=>{N.style.opacity="1",N.style.transform="none"}),setTimeout(()=>{N.style.opacity="0",N.style.transform="translateY(8px)",setTimeout(()=>N.remove(),300)},He),N};l.setFlag("ch1_0043_committed",!0);const E=Math.random().toString(36).slice(2,8),_=Array.from(R.entries()).map(([y,f])=>`M ${y}`).join(`
`);de.unshift({hash:E,author:"Casey",date:new Date().toISOString().slice(0,10),msg:a,diff:_}),se.unshift({hash:E,branch:"main",author:"Casey",date:new Date().toISOString().slice(0,10),msg:a,diff:_});for(const[y,f]of R.entries()){const B=k.getFile(y);B&&(B.content=f),k.registerFile(y,{content:f,meta:{lang:y.endsWith(".java")?"java":y.endsWith(".js")?"javascript":"text"}})}R.clear(),e&&(e.value=""),t&&(t.innerHTML=`<span style="color:var(--success)">✓ Commit 成功: ${E}</span>`),C(`✓ commit ${E} — ${a}`),Ie(),ye(),Ce(),De(),fe&&F===ve&&je();try{A(()=>Promise.resolve().then(()=>mt).then(y=>y.markTicketDone&&y.markTicketDone("INV-2024-0043")),void 0)}catch{}setTimeout(()=>{l.setFlag("ch1_system_down",!0);let y=0;const f=setInterval(()=>{if(!l.hasFlag("ch1_system_down")||l.hasFlag("ch1_revert_done")){clearInterval(f);return}y++,A(()=>Promise.resolve().then(()=>ce).then(B=>{const L=(B.getChats?B.getChats():[]).find(z=>z.id==="system-alert");if(L){const z=`⚠️ 警告 #${y}: 系統異常 — 檢測到異常，請檢查最近變更`;L.messages.push({id:"alert-"+Date.now()+"-"+y,from:"system",text:z,time:"今天",ts:Date.now(),read:"delivered",type:"text"}),L.preview=`⚠️ 警告 #${y}: 系統異常`,L.unread=(L.unread||0)+1,L.lastTime="今天",window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"system-alert"}}))}w({appSub:"System Alert",sender:"System Alert",avatarBg:"linear-gradient(135deg, #d93025, #fbbc05)",avatarText:"!",msg:`⚠️ 警告 #${y}: 系統異常 — 檢測到異常`,chatId:"system-alert",duration:4e3})}),void 0),y===5&&(setTimeout(()=>{A(()=>Promise.resolve().then(()=>ce).then(B=>{const L=(B.getChats?B.getChats():[]).find(z=>z.id==="dev-team");L&&(L.messages.push({id:"sawyer-dev-"+Date.now(),from:"Sawyer",text:"各位，系統怎麼一直在告警？發生什麼事了？是誰剛才改了什麼？",time:"今天",ts:Date.now(),read:"delivered",type:"text"}),L.preview="Sawyer: 系統怎麼一直在告警？",L.lastTime="今天",L.unread=(L.unread||0)+1,window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"dev-team"}})),w({appSub:"Dev Team",sender:"Sawyer",avatarBg:"linear-gradient(135deg, #722F37, #8B1A1A)",avatarText:"S",msg:"各位，系統怎麼一直在告警？發生什麼事了？",chatId:"dev-team",duration:4e3}))}),void 0)},500),setTimeout(()=>{A(()=>Promise.resolve().then(()=>ce).then(B=>{const L=(B.getChats?B.getChats():[]).find(z=>z.id==="dev-team");L&&(L.messages.push({id:"maggie-dev-"+Date.now(),from:"Maggie",text:"好像是剛才 INV-2024-0043 的修改，應該是最後一次變更就是這個任務",time:"今天",ts:Date.now(),read:"delivered",type:"text"}),L.preview="Maggie: 好像是 0043 的修改...",L.lastTime="今天",L.unread=(L.unread||0)+1,window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"dev-team"}})),w({appSub:"Dev Team",sender:"Maggie",avatarBg:"linear-gradient(135deg, #25D366, #128C7E)",avatarText:"M",msg:"好像是 INV-2024-0043 的修改，最後一次變更就是這個",chatId:"dev-team",duration:4e3}))}),void 0)},5500),setTimeout(()=>{A(()=>Promise.resolve().then(()=>ce).then(B=>{const L=(B.getChats?B.getChats():[]).find(z=>z.id==="sawyer");L&&(L.messages.push({id:"sawyer-pm-"+Date.now(),from:"Sawyer",text:"Casey，麻煩你先把 0043 的改動 revert 吧，系統要緊，先回滾再說",time:"今天",ts:Date.now(),read:"delivered",type:"text"}),L.preview="Sawyer: 麻煩你先把 0043 revert",L.lastTime="今天",L.unread=(L.unread||0)+1,window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"sawyer"}})),w({appSub:"Sawyer",sender:"Sawyer",avatarBg:"linear-gradient(135deg, #722F37, #8B1A1A)",avatarText:"S",msg:"Casey，麻煩你先把 0043 的改動 revert 吧",chatId:"sawyer",duration:4e3}),B.startSawyerRevertSeq&&(B.startSawyerRevertSeq(),fe&&setTimeout(()=>je(),200)))}),void 0)},10500))},5e3)},5e3);return}const u=c&&m&&l.hasFlag("ch1_system_down")&&!l.hasFlag("ch1_revert_done"),v=a.toLowerCase().includes("revert")&&l.hasFlag("ch1_system_down")&&!l.hasFlag("ch1_revert_done");if(u||v){if(u)for(const[y,f]of R.entries()){k.registerFile(y,{content:f,meta:{lang:y.endsWith(".js")?"javascript":y.endsWith(".java")?"java":"text"}});const B=k.getFile(y);B&&(B.content=f)}else if(ua(),Me){k.registerFile("/file-system/src/components/SearchBar.jsx",{content:Me,meta:{lang:"javascript"}});const y=k.getFile("/file-system/src/components/SearchBar.jsx");y&&(y.content=Me)}l.setFlag("ch1_revert_done",!0),l.setFlag("ch1_system_down",!1);const E=Math.random().toString(36).slice(2,8),_=u,w=_?`M /file-system/src/components/SearchBar.jsx
+ restored legacyRoutes / resolveLegacyPath (paste back)`:"M revert 0043";de.unshift({hash:E,author:"Casey",date:new Date().toISOString().slice(0,10),msg:a,diff:w}),se.unshift({hash:E,branch:"main",author:"Casey",date:new Date().toISOString().slice(0,10),msg:a,diff:w}),R.clear(),t&&(t.innerHTML=`<span style="color:var(--success)">✓ Commit 成功 (revert): ${E}</span>`),C(`✓ commit ${E} — ${a} (revert)`),Ie(),ye(),Ce(),De(),fe&&je(),sn(_?"paste-back":"keyword");try{A(()=>Promise.resolve().then(()=>mt).then(y=>{const f=y.getTickets().find(B=>B.key==="INV-2024-0043");f&&(f.status="Done",f.history.push({from:"To Do",to:"Done",by:"Casey",at:new Date().toISOString().slice(0,10)}))}),void 0)}catch{}return}const h=Math.random().toString(36).slice(2,8),b=new Date().toISOString().slice(0,10),$="Casey",j=`M ${i}
`+Object.entries(s.found).map(([E,_])=>`  case ${E}: price*=${_.val.toFixed(2)}`).join(`
`);de.unshift({hash:h,author:$,date:b,msg:a,diff:j}),se.unshift({hash:h,branch:"main",author:$,date:b,msg:a,diff:j});const oe=k.getFile(i);oe&&(oe.content=n),k.registerFile(i,{content:n,meta:{lang:"java"}}),R.clear(),e&&(e.value=""),t&&(t.innerHTML=`<span style="color:var(--success)">✓ Commit 成功: ${h}</span>`),C(`✓ commit ${h} — ${a}`),Ie(),ye(),Ce(),De(),fe&&F===ve&&je();try{A(()=>Promise.resolve().then(()=>mt).then(E=>{E.markTicketDone?E.markTicketDone("INV-2024-0042"):E.completeVipTicket&&E.completeVipTicket()}),void 0)}catch{}l.setFlag("ch0_vip_fixed",!0),l.setFlag("onboarding_done",!0),setTimeout(()=>{A(()=>Promise.resolve().then(()=>re).then(E=>{E.setActiveView&&(E.setActiveView("jira"),localStorage.setItem("cc_active_view","jira"))}),void 0).catch(()=>{localStorage.setItem("cc_active_view","jira"),document.querySelectorAll(".view").forEach(E=>E.classList.toggle("active",E.id==="view-jira")),document.querySelectorAll(".taskbar__app").forEach(E=>E.classList.toggle("active",E.dataset.view==="jira"))}),setTimeout(()=>{const E=new CustomEvent("jira:refresh");window.dispatchEvent(E)},100)},400)}function ji(){C('tip: 在 editor 搜尋 "calculateVipPrice" 找到 VIP 折扣邏輯'),C("tip: 編輯 OrderService.java 後至 Source Control 提交"),C("輸入 help 查看可用指令 · Tab 補全 · ↑↓ 歷史")}function C(e){const t=document.getElementById("vsTerminalHist"),a=document.getElementById("vsTerminal"),i=t||a;if(!i)return;const n=document.createElement("div");n.className="terminal__line",n.textContent=e,i.appendChild(n),t&&(t.scrollTop=t.scrollHeight),a&&(a.scrollTop=a.scrollHeight)}function Pi(e){const t=e.target,a=t.value;if(e.key==="Enter"){const i=a.trim();if(!i)return;Te.push(i),ue=Te.length,C(`➜ ${i}`),Di(i),t.value="",Mt=""}else if(e.key==="ArrowUp")e.preventDefault(),ue<=0?ue=0:ue--,Mt===""&&Te[ue]!==void 0&&(Mt=a),Te[ue]!==void 0&&(t.value=Te[ue]);else if(e.key==="ArrowDown")e.preventDefault(),ue++,ue>=Te.length?(ue=Te.length,t.value=Mt):t.value=Te[ue];else if(e.key==="Tab"){e.preventDefault();const i=Mi(a);i&&(t.value=i)}}function Mi(e){const t=["help","ls","cat ","grep ","git log","git diff","git blame","clear","echo "],a=k.listFiles("/customer-portal").filter(o=>!Ee(o.path)).map(o=>o.path),i=[...t,...a,...a.map(o=>o.split("/").pop())];if(!e)return e;const n=i.find(o=>o.startsWith(e));if(n)return n;const s=e.split(" "),r=s[s.length-1];if(!r)return e;const d=i.find(o=>o.endsWith(r)||o.includes(r));return d?(s[s.length-1]=d.split(" ").pop(),s.join(" ")):e}function Di(e){const[t,...a]=e.split(/\s+/),i=a.join(" ");switch(t){case"help":C("可用指令: ls [path], cat <file>, grep <keyword>, git log, git diff, git blame <file>, clear, echo <text>"),C("範例: cat /customer-portal/src/main/java/com/nori/OrderService.java");break;case"ls":{const n=a[0]||"/customer-portal";if(n.startsWith("/intranet")||n==="/intranet"){C(`ls: ${n}: 權限不足（內網資料已從 Vizual Studio Code 隱藏）`);break}const s=k.listFiles(n).filter(r=>r.path.startsWith("/customer-portal")&&!Ee(r.path));s.length?s.slice(0,20).forEach(r=>C(r.path)):C(`ls: ${n}: No such directory`),s.length>20&&C(`... ${s.length-20} more`);break}case"cat":{const n=a[0];if(!n){C("cat: 缺少檔案路徑");break}if(n.startsWith("/intranet")){C(`cat: ${n}: 權限不足（內網資料已從 Vizual Studio Code 隱藏，僅顯示官網系統）`);break}if(Ee(n)||Ee("/customer-portal"+(n.startsWith("/")?"":"/")+n)){C(`cat: ${n}: 檔案不存在或尚未解鎖`);break}const s=k.readFile(n)||k.readFile("/customer-portal"+(n.startsWith("/")?"":"/")+n);s==null?C(`cat: ${n}: 檔案不存在或尚未解鎖`):s.split(`
...
`).forEach(n=>{C(n)}),C("hint: 點擊 Source Control 右上角的 Git Graph 按鈕查看完整圖像化歷史");else if(a[0]==="blame"){const n=a[1]||F;C(`blame ${n}:`),(Ba[n]||Ba["/customer-portal/src/billing/service.js"]).forEach(s=>C(`${String(s.line).padStart(3)} ${s.commit} ${s.author}`))}else a[0]==="graph"?(ln(),C("→ 已開啟 Git Graph 編輯器分頁")):C("git: 未知子指令，試 help (支援: git log / git diff / git blame / git graph)");break;case"clear":{const n=document.getElementById("vsTerminalHist");n&&(n.innerHTML="");break}case"echo":C(i);break;default:C(`zsh: command not found: ${t} (試 help)`)}}function Fi(){document.addEventListener("keydown",e=>{const t=e.ctrlKey||e.metaKey;if(e.key==="F1"){e.preventDefault();const a=document.getElementById("vsHelpOverlay");a&&(a.style.display=a.style.display==="flex"?"none":"flex");return}if(t&&e.key.toLowerCase()==="p"&&!e.shiftKey)e.preventDefault(),Ni();else if(t&&e.shiftKey&&e.key.toLowerCase()==="f")e.preventDefault(),Z="search",Nt(),document.getElementById("vsSearchInput")?.focus();else if(t&&e.shiftKey&&e.key.toLowerCase()==="g")e.preventDefault(),Z="scm",Nt();else if(t&&e.shiftKey&&e.key.toLowerCase()==="d")e.preventDefault(),Z="debug",Nt();else if(e.key==="Escape"){vt();const a=document.getElementById("vsHelpOverlay");a&&(a.style.display="none");const i=document.getElementById("sonarModal");i&&(i.style.display="none")}else t&&e.key==="/"&&(e.preventDefault(),document.getElementById("vsTerminalInput")?.focus())})}function Ni(){const e=document.getElementById("quickOpen"),t=document.getElementById("quickOpenInput");!e||!t||(e.classList.add("open"),t.value="",t.focus(),cn(""))}function vt(){document.getElementById("quickOpen")?.classList.remove("open")}function cn(e){const t=document.getElementById("quickOpenList");if(!t)return;const a=(e||"").trim().toLowerCase();let i=k.listFiles("/customer-portal").filter(s=>!Ee(s.path)),n=null;if(a.includes(":")){const[s,r]=a.split(":");n=parseInt(r,10),i=i.filter(d=>d.path.toLowerCase().includes(s))}else a&&(i=i.filter(s=>s.path.toLowerCase().includes(a)));if(i=i.slice(0,10),!i.length){t.innerHTML='<div class="quickopen__item muted">無符合檔案 — 試輸入 OrderService / billing</div>';return}t.innerHTML=i.map((s,r)=>`
    <div class="quickopen__item ${r===0?"active":""}" data-path="${s.path}">
      <span>${g(s.path)}</span>
      <span class="quickopen__kbd">${s.path.split(".").pop()}</span>
    </div>
  `).join(""),t.querySelectorAll(".quickopen__item").forEach(s=>{s.addEventListener("click",()=>{pe(s.dataset.path),n&&Hi(n),vt()})})}function Oi(e){if(e.key==="Escape"){vt();return}if(e.key==="Enter"){const t=document.querySelector("#quickOpenList .quickopen__item.active")||document.querySelector("#quickOpenList .quickopen__item");t&&(pe(t.dataset.path),vt());return}if(e.key==="ArrowDown"||e.key==="ArrowUp"){e.preventDefault();const t=[...document.querySelectorAll("#quickOpenList .quickopen__item")];if(!t.length)return;let a=t.findIndex(i=>i.classList.contains("active"));t[a]?.classList.remove("active"),a=e.key==="ArrowDown"?Math.min(a+1,t.length-1):Math.max(a-1,0),a<0&&(a=0),t[a]?.classList.add("active")}}function Hi(e){const t=document.getElementById("vsEditorArea");if(t){const n=t.value.split(`
`);let s=0;for(let r=0;r<Math.min(e-1,n.length);r++)s+=n[r].length+1;t.focus(),t.setSelectionRange(s,s);return}const a=document.getElementById("vsEditor");if(!a)return;const i=a.querySelector(`[data-ln="${e}"]`);i&&i.scrollIntoView({behavior:"smooth",block:"center"})}var mt=da({addTicket0043:()=>pn,getTickets:()=>Gi,markTicketDone:()=>Ui,mountJira:()=>ma}),ae=[{key:"INV-2024-0017",title:"官網首頁文案顯示錯誤 — Hero 標語與成立年份顯示錯誤",status:"Done",assignee:"Parker",priority:"Medium",points:2,epic:"Frontend",desc:`【問題描述】
...
JQL: sprint = 24 AND status != Done`,comments:[],attachments:[],history:[]},{key:"INV-2020-0003",title:"人力資源系統 — 關閉系統",status:"Done",assignee:"deleted user",priority:"High",points:3,epic:"HR",desc:"人力資源管理系統將遷移到Zero System, 此系統將永久關閉。關閉前需確保所有資料已成功備份到新系統",comments:["deleted user: 已完成關閉"],attachments:[],history:[{from:"To Do",to:"Done",by:"deleted user",at:"2020-02-28"}]}],Dt=null,ft="all",yt="";function Fe(){try{l.set("jiraTicketsData",JSON.parse(JSON.stringify(ae))),l.set("jiraMeta",{activeSwimlane:ft,currentFilter:yt}),l.save(!0)}catch{}}function Vi(){try{const e=l.get("jiraTicketsData");if(Array.isArray(e)&&e.length){ae.length=0;for(const a of e)ae.push(a)}else if((l.hasFlag("ch1_event1_triggered")||l.get("jiraTickets")&&l.get("jiraTickets")["INV-2024-0043"])&&!ae.some(a=>a.key==="INV-2024-0043")){pn();return}const t=l.get("jiraMeta");if(t&&typeof t=="object"&&(typeof t.activeSwimlane=="string"&&(ft=t.activeSwimlane),typeof t.currentFilter=="string"&&(yt=t.currentFilter)),l.hasFlag("ch0_vip_fixed")){const a=ae.find(i=>i.key==="INV-2024-0042");a&&a.status!=="Done"&&(a.status="Done")}if(l.hasFlag("ch1_0043_committed")){const a=ae.find(i=>i.key==="INV-2024-0043");a&&a.status!=="Done"&&(a.status="Done")}}catch{}}function ma(){Vi();const e=document.getElementById("view-jira");e&&(e.innerHTML=`
    <div class="jira">
      <div class="jira__app">
  ...
  `,Ri(),Ne(),document.getElementById("jiraDetailBackdrop")?.addEventListener("click",()=>{document.getElementById("jiraDetail").style.display="none",document.getElementById("jiraDetailBackdrop").style.display="none"}))}function Ri(){document.getElementById("jiraSearch")?.addEventListener("input",e=>{yt=e.target.value,Fe(),Ne()}),document.getElementById("jiraAssignee")?.addEventListener("change",e=>{yt=document.getElementById("jiraSearch").value,Fe(),Ne()}),document.getElementById("jiraSwimlane")?.addEventListener("change",e=>{ft=e.target.value,Fe(),Ne()})}function qi(e){if(!e.trim())return()=>!0;const t=e.split(/\s+AND\s+/i).map(a=>{const i=a.match(/^\s*(status|assignee|key|epic|text|priority)\s*(=|~)\s*"?([^"]+)"?\s*$/i);if(!i){const o=a.toLowerCase().replace(/["']/g,"");return c=>(c.key+c.title+c.desc+c.assignee+c.epic).toLowerCase().includes(o)}const[,n,s,r]=i,d=r.trim().replace(/^"|"$/g,"").toLowerCase();return o=>{const c=n.toLowerCase();let m="";return c==="status"?m=o.status.toLowerCase():c==="assignee"?m=o.assignee.toLowerCase():c==="key"?m=o.key.toLowerCase():c==="epic"?m=o.epic.toLowerCase():c==="priority"?m=o.priority.toLowerCase():c==="text"&&(m=(o.key+" "+o.title+" "+o.desc).toLowerCase()),s==="="?m===d:m.includes(d)}});return a=>t.every(i=>i(a))}function Ne(){const e=document.getElementById("jiraBoard");if(!e)return;const t=document.getElementById("jiraAssignee")?.value||"",a=qi(yt);let i=ae.filter(n=>a(n));if(t&&(i=i.filter(n=>n.assignee===t)),ft!=="all"){const n=ft,s={};i.forEach(r=>{const d=r[n]||"未分類";s[d]||(s[d]=[]),s[d].push(r)}),e.innerHTML=Object.entries(s).map(([r,d])=>{const o={"To Do":[],"In Progress":[],Done:[]};return d.forEach(c=>o[c.status]?.push(c)),`
        <div class="jira__swimlane">
          <div class="jira__swimlane-header">Group：${r} (${d.length})</div>
          <div class="jira__board">
            ${Object.entries(o).map(([c,m])=>Pa(c,m)).join("")}
          </div>
        </div>
      `}).join("")||'<div class="muted small" style="padding:12px">無符合條件的票據 — 試 JQL: status = "To Do"</div>'}else{const n={"To Do":[],"In Progress":[],Done:[]};i.forEach(s=>n[s.status]?.push(s)),e.innerHTML=Object.entries(n).map(([s,r])=>Pa(s,r)).join("")}Wi()}function Pa(e,t){return`
    <div class="jira__col" data-col="${e}">
      ...
      <div class="jira__dropzone" data-col="${e}">
        ${t.map(a=>zi(a)).join("")||'<div class="jira__empty">拖曳至此</div>'}
      </div>
    </div>
  `}function dn(e){return e.key.includes("0042")||e.epic==="Billing"?{cls:"story",icon:"fa-solid fa-bookmark",label:"Story"}:e.epic==="HR"||e.key.includes("0003")?{cls:"task",icon:"fa-solid fa-square-check",label:"Task"}:e.epic==="Frontend"?{cls:"task",icon:"fa-solid fa-square-check",label:"Task"}:e.priority==="High"&&e.status!=="Done"?{cls:"bug",icon:"fa-solid fa-bug",label:"Bug"}:{cls:"story",icon:"fa-solid fa-bookmark",label:"Story"}}function zi(e){const t=dn(e),a=e.priority==="High"?"High":e.priority==="Medium"?"Medium":"Low",i=e.priority==="High"?"fa-solid fa-angle-up":e.priority==="Medium"?"fa-solid fa-equals":"fa-solid fa-angle-down",n=e.assignee?e.assignee.charAt(0).toUpperCase():"?",s=e.assignee==="Casey"?"#0052cc":e.assignee==="Parker"?"#0065ff":e.assignee==="Jessie"?"#6554c0":"#6b778c";return`
  ...
  `}function Wi(){document.querySelectorAll(".ticket").forEach(e=>{e.addEventListener("dragstart",t=>{Dt=e.dataset.key,e.classList.add("dragging"),t.dataTransfer.effectAllowed="move"}),e.addEventListener("dragend",t=>{e.classList.remove("dragging"),Dt=null}),e.addEventListener("click",()=>bt(e.dataset.key))}),document.querySelectorAll(".jira__dropzone").forEach(e=>{e.addEventListener("dragover",t=>{t.preventDefault(),e.classList.add("drag-over")}),e.addEventListener("dragleave",()=>{e.classList.remove("drag-over")}),e.addEventListener("drop",t=>{t.preventDefault(),e.classList.remove("drag-over");const a=e.dataset.col;if(!Dt)return;const i=ae.find(s=>s.key===Dt);if(!i||i.status===a)return;const n=i.status;i.status=a,i.history.push({from:n,to:a,by:"你",at:new Date().toISOString().slice(0,10)}),l.set("jiraTickets."+i.key,!0),Fe(),Ne(),bt(i.key)})})}function bt(e){const t=ae.find(o=>o.key===e),a=document.getElementById("jiraDetail"),i=document.getElementById("jiraDetailBackdrop");if(!t||!a)return;l.set("jiraTickets."+e,!0),e==="INV-2024-0042"&&An("jiua_viewed"),i&&(i.style.display="block"),a.style.display="flex";const n=dn(t),s=t.status==="Done"?"badge--done":t.status==="In Progress"?"badge--inprogress":"badge--todo";a.innerHTML=`
...
${m.snippet}`)})}),a.querySelectorAll("[data-move]").forEach(o=>{o.addEventListener("click",()=>{const c=o.dataset.move,m=t.status;t.status=c,t.history.push({from:m,to:c,by:"你",at:new Date().toISOString().slice(0,10)}),Fe(),Ne(),bt(e)})}),document.getElementById("jiraAddComment")?.addEventListener("click",()=>{const o=document.getElementById("jiraCommentInput"),c=o?.value.trim();c&&(t.comments.push(`你: ${c}`),o.value="",Fe(),bt(e),Ne())});function r(){a.style.display="none";const o=document.getElementById("jiraDetailBackdrop");o&&(o.style.display="none")}document.getElementById("jiraDetailClose")?.addEventListener("click",r),document.getElementById("jiraDetailClose2")?.addEventListener("click",r),document.getElementById("jiraCommentInput")?.addEventListener("keydown",o=>{o.key==="Enter"&&(o.preventDefault(),document.getElementById("jiraAddComment")?.click())});const d=o=>{o.key==="Escape"&&(r(),document.removeEventListener("keydown",d))};document.addEventListener("keydown",d)}function Ui(e){const t=ae.find(i=>i.key===e);if(!t)return!1;if(t.status==="Done")return e==="INV-2024-0042"&&!l.hasFlag("ch0_vip_fixed")&&l.setFlag("ch0_vip_fixed",!0),!0;const a=t.status;return t.status="Done",t.history.push({from:a,to:"Done",by:"Casey",at:new Date().toISOString().slice(0,10)}),l.set("jiraTickets."+e,!0),e==="INV-2024-0042"&&l.setFlag("ch0_vip_fixed",!0),e==="INV-2024-0043"&&l.setFlag("ch1_0043_committed",!0),Fe(),document.getElementById("jiraBoard")&&(Ne(),bt(e)),!0}function pn(){if(!ae.some(e=>e.key==="INV-2024-0043")){ae.push({key:"INV-2024-0043",title:"移除內網系統異常網頁的入口",status:"To Do",assignee:"Casey",priority:"Medium",points:2,epic:"internal system",desc:`【問題描述】使用內網系統時進入到異常網頁，移除不明網頁導向
...
const legacyRoutes = { archive: "/internal/portal" ... } // No longer used`}],history:[{from:"—",to:"To Do",by:"Maggie",at:new Date().toISOString().slice(0,10)}]}),Fe(),document.getElementById("jiraBoard")&&window.dispatchEvent(new CustomEvent("jira:ticketAdded",{detail:"INV-2024-0043"}));try{const e=new CustomEvent("jira:refresh");window.dispatchEvent(e)}catch{}}}function Gi(){return ae}var Ot="";try{Ot=""}catch{}var Ji="https://script.google.com/macros/s/AKfycbwjzxPakm5HKw4hJGJWw7AZmNZSpVR28QCcxmJr7KPKCSjLcG2_Da7LgBuuGJwVruSU/exec";function _t(){try{const e=localStorage.getItem("cc_gas_url")||"";if(e&&e.startsWith("https://"))return e}catch{}return Ot&&Ot.startsWith("https://")?Ot:Ji}function un(e){try{e?localStorage.setItem("cc_gas_url",e):localStorage.removeItem("cc_gas_url")}catch{}}function lt(){const e=_t();return e&&e.startsWith("https://")&&!e.includes("AKfycbwjzxPakm5HKw4hJGJWw7AZmNZSpVR28QCcxmJr7KPKCSjLcG2_Da7LgBuuGJwVruSU")}var Rt="cc_analytics_consent",Ma="cc_sid",mn="cc_analytics_queue";function Ye(){try{return localStorage.getItem(Rt)==="1"}catch{return!1}}function Ht(e){try{e?localStorage.setItem(Rt,"1"):localStorage.setItem(Rt,"0")}catch{}e&&setTimeout(()=>Ke(),500)}function Yi(){try{const e=localStorage.getItem(Rt);return e==="1"||e==="0"}catch{return!1}}function gn(){try{let e=localStorage.getItem(Ma);return e||(e=crypto.randomUUID&&crypto.randomUUID()||"sid_"+Date.now()+"_"+Math.random().toString(36).slice(2,9),localStorage.setItem(Ma,e)),e}catch{return"anon_"+Date.now()}}function ga(e){if(!e)return"";let t=5381;for(let a=0;a<e.length;a++)t=(t<<5)+t^e.charCodeAt(a);return(t>>>0).toString(16).padStart(8,"0")}function Ki(){let e=0,t=0,a="zh-TW";try{e=l.get("currentChapter")??0}catch{}try{t=l.get("playtime")??0}catch{}try{a=l.get("settings.language")||"zh-TW"}catch{}return{chapter:e,playtime:t,lang:a}}function Ue(){try{const e=localStorage.getItem(mn);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t:[]}catch{return[]}}function Ge(e){try{localStorage.setItem(mn,JSON.stringify(e.slice(-50)))}catch{}}function Ke(){if(!lt()||!Ye())return;const e=Ue();if(!e.length)return;const t=e.slice(0,10);Ge(e.slice(10)),t.forEach(a=>hn(a,!0))}function hn(e,t=!1){const a=_t();if(!lt()){console.warn("[analytics] GAS_URL 未設定，跳過上報",e);return}if(!Ye()){if(!t){const n=Ue();n.push(e),Ge(n)}return}const i=JSON.stringify(e);try{if(navigator.sendBeacon){const n=new Blob([i],{type:"text/plain;charset=utf-8"});if(navigator.sendBeacon(a,n))return}}catch{}try{fetch(a,{method:"POST",headers:{"Content-Type":"text/plain;charset=utf-8"},body:i,keepalive:!0,redirect:"follow",mode:"cors"}).then(n=>{if(!n.ok)throw new Error("GAS status "+n.status);t||setTimeout(()=>Ke(),1e3)}).catch(n=>{if(console.warn("[analytics] 發送失敗，已入隊重試",n),t){const s=Ue();s.unshift(e),Ge(s)}else{const s=Ue();s.push(e),Ge(s)}})}catch{const s=Ue();s.push(e),Ge(s)}}function ne(e,t={}){const a=Ki(),i=gn(),n={timestamp:new Date().toISOString(),session_id:i,event_type:e,chapter:a.chapter,playtime:a.playtime,lang:a.lang,ua:typeof navigator<"u"?navigator.userAgent.slice(0,200):"",url:typeof location<"u"?location.href.slice(0,300):"",...t};if(n.payload_json&&typeof n.payload_json=="string"&&n.payload_json.length>4e3&&(n.payload_json=n.payload_json.slice(0,4e3)),!Ye()){const s=Ue();s.push(n),Ge(s);return}if(!lt()){const s=Ue();s.push(n),Ge(s),console.warn("[analytics] 已記錄至本地隊列，待設定 GAS_URL 後自動上報",n);return}hn(n)}function Qt({chatId:e,chatName:t,text:a,to:i}){const n=(a||"").slice(0,80),s=ga(a||"");ne("whatsapp_send",{whatsapp_chat_id:e,whatsapp_chat_name:t||e,whatsapp_to:i||"",whatsapp_preview:n,whatsapp_hash:s,whatsapp_len:(a||"").length,payload_json:JSON.stringify({chatId:e,preview:n,len:(a||"").length})})}function Qi({title:e,to:t,body:a}){const i=(a||"").slice(0,80),n=ga(a||"");ne("email_submit",{email_title:e||"",email_to:(t||"").slice(0,100),email_body_preview:i,email_body_hash:n,email_body_len:(a||"").length,payload_json:JSON.stringify({title:e,preview:i,len:(a||"").length})})}function vn(e){ne("ending_unlocked",{ending:e,endings:(l.get("endings")||[]).join(","),payload_json:JSON.stringify({ending:e,all:l.get("endings")})})}function Xi(e){ne("chapter_changed",{chapter:e,payload_json:JSON.stringify({chapter:e})})}function Zi(){try{window.__analytics={track:ne,getConsent:Ye,setConsent:Ht,getGasUrl:_t,setGasUrl:un,isGasConfigured:lt,flushQueue:Ke,hashText:ga}}catch{}setTimeout(()=>Ke(),1500);try{window.addEventListener("online",()=>Ke())}catch{}}var ce=da({closeWaLightbox:()=>Vt,getChats:()=>ls,markNoriAllRead:()=>fa,mountWhatsApp:()=>fn,openChat:()=>Xe,openWaLightbox:()=>wn,startSawyerRevertSeq:()=>cs,triggerCh1Event1:()=>rs,triggerCh1Event2:()=>zt,triggerCh2LunchSequence:()=>ya}),M=[{id:"nori-all",name:"Nori 全體",avatar:"🏢",desc:"Nori 全體員工群組",members:["Sawyer","Casey","Maggie","Taylor","Aiko","all"],preview:"Leo:謝謝安排！",locked:!1,pinned:!0,muted:!1,archived:!1,unread:0,lastTime:"2023-06-15",messages:[{id:"m1",from:"Sawyer",text:"各位同事，好消息！我中了六合彩二獎，決定將獎金全數投入公司資金，一起加油！",time:"2023-06-15",read:"read",type:"text"},{id:"m2",from:"Taylor",text:"恭喜老闆！祝以後都順順利利！",time:"2023-06-15",read:"read",type:"text"},{id:"m3",from:"Aiko",text:"太棒了！老闆威武！",time:"2023-06-15",read:"read",type:"text"},{id:"m4",from:"Maggie",text:"恭喜老闆！",time:"2023-06-15",read:"read",type:"text"},{id:"m5",from:"Parker",text:"運也太好了吧？！",time:"2023-06-15",read:"read",type:"text"},{id:"m6",from:"Sawyer",text:"各位同事，告訴大家一個好消息，剛跟可樂樂公司談成一大生意，結為長期合作伙伴。為慶祝近來公司發展順利，決定舉辦晚上派對，詳細資訊稍後公布！",time:"2023-11-01",read:"read",type:"text"},{id:"m7",from:"Aiko",text:"哇！！太好了，一定會去！",time:"2023-11-01",read:"read",type:"text"},{id:"m8",from:"Taylor",text:"太棒了！",time:"2023-11-01",read:"read",type:"text"},{id:"m9",from:"Maggie",text:"恭喜老闆！",time:"2023-11-01",read:"read",type:"text"},{id:"m10",from:"Hugo",text:"一輩子跟隨您！",time:"2023-11-01",read:"read",type:"text"},{id:"m11",from:"Taylor",text:`各位同事，慶祝公司發展順利, 將於11月22日下班後舉辦派對
以下為詳細資訊：
日期：11月22日（五） 
時間：19:00-23:00
...
commit => 提交變更
revert => 撤銷變更
查看Git Graph => 列表形式展示所有變更記錄`,time:"2024-07-15",read:"read",type:"text"},{id:"m13",from:"Maggie",text:"",media:"/arg-game-it-company-secret/assets/data/files/wts/sourceControlPage.png",time:"2024-07-15",read:"read",type:"image"},{id:"m14",from:"Maggie",text:"",media:"/arg-game-it-company-secret/assets/data/files/wts/sourceControlPage-revert.png",time:"2024-07-15",read:"read",type:"image"},{id:"m15",from:"Maggie",text:"如果修改有誤的話，提交時結果會經過檢查，然後報錯，這時候就要重新修改",time:"2024-07-15",read:"read",type:"text"},{id:"m0",from:"Maggie",text:"Hi @Casey, 有新的工單INV-2024-0042, 請協助處理一下。詳細資訊在Jiua可以找到, 有問題再找我。",time:"今天",read:"delivered",type:"text"}]},{id:"dev-team",name:"Dev Team",avatar:"👩‍💻",desc:"Nori網站和內網的開發團隊群組",members:["Maggie","Casey","pm","Taylor","ops"],preview:"",locked:!1,pinned:!0,muted:!1,archived:!1,unread:0,lastTime:"2024-07-15",messages:[]},{id:"lunch-team",name:"午餐小隊",avatar:"🍽️",desc:"午餐小隊",members:["Parker","Grace","Hugo","Alex","Casey"],preview:"Alex: 好啊！",locked:!1,pinned:!1,muted:!1,archived:!1,unread:0,lastTime:"2024-09-01",messages:[{id:"m1",from:"Hugo",text:"大新聞！聽說老闆父母車禍身亡了！",time:"2023-04-29",read:"read",type:"text"},{id:"m2",from:"Parker",text:"？！",time:"2023-04-29",read:"read",type:"text"},{id:"m3",from:"Grace",text:"真的嗎？太難過了",time:"2023-04-29",read:"read",type:"text"},{id:"m4",from:"Hugo",text:"對啊，所以才請了一個禮拜假吧",time:"2023-04-29",read:"read",type:"text"},{id:"m5",from:"Hugo",text:"有人覺得近期的老闆很怪嗎？",time:"2023-10-19",read:"read",type:"text"},{id:"m6",from:"Parker",text:"怎麼說？！",time:"2023-10-19",read:"read",type:"text"},{id:"m7",from:"Alex",text:"變開朗了，也變得愛請客了！",time:"2023-10-19",read:"read",type:"text"},{id:"m8",from:"Grace",text:"對啊，之前都挺嚴肅的",time:"2023-10-19",read:"read",type:"text"},{id:"m9",from:"Hugo",text:"對啊！！！",time:"2023-10-19",read:"read",type:"text"},{id:"m10",from:"Hugo",text:"歡迎Casey！！以後帶你吃附近好吃的！",time:"2024-07-16",read:"read",type:"text"},{id:"m11",from:"Parker",text:"歡迎歡迎",time:"2024-07-16",read:"read",type:"text"},{id:"m12",from:"Grace",text:"歡迎~",time:"2024-07-16",read:"read",type:"text"},{id:"m13",from:"Alex",text:"歡迎~~",time:"2024-07-16",read:"read",type:"text"},{id:"m14",from:"Hugo",text:"今天要吃米當當嗎？",time:"2024-09-01",read:"read",type:"text"},{id:"m15",from:"Alex",text:"好啊",time:"2024-09-01",read:"read",type:"text"}]}],q="dev-team",qt="",nt="all",ke=!1,Ve="",ct="chat",Re=!0,Y=0,ha=!1;function H(){try{const e=M.map(t=>({id:t.id,name:t.name,avatar:t.avatar,desc:t.desc,members:t.members,preview:t.preview,lastTime:t.lastTime,unread:t.unread,pinned:t.pinned,muted:t.muted,archived:t.archived,messages:t.messages}));l.set("whatsappChats",e),l.set("whatsappMeta",{activeId:q,ch1Event1Triggered:Pe,ch1Event2Triggered:Oe,sawyerSeq:Y,sawyerSeqLocked:ha}),l.save(!0)}catch{}}function Xt(e,t){try{l.incrementWhatsappSent()}catch{}try{const a=(t||"").toLowerCase(),i=["rubbish","垃圾","dumb","笨","蠢","stupid","傻","笨蛋","白癡","idiot","fool","傻瓜","die","dead","死","shit","fuck","屎"],n=e==="sawyer",s=i.some(r=>a.includes(r.toLowerCase()));n&&s&&l.setFlag("sawyer_abuse_sent",!0)}catch{}}function wt(e){try{const t=M.find(a=>a.id===e);return!!(t&&t.muted)}catch{return!1}}function es(e){return e.time==="剛剛"&&(e.time="今天"),e}function Da(e){const t=Date.now();e.messages.forEach((a,i)=>{if(es(a),typeof a.ts!="number")if(/^\d{4}-\d{2}-\d{2}$/.test(a.time))a.ts=new Date(a.time+"T00:00:00").getTime()+i*10;else if(a.time&&a.time.includes(":")){const n=new Date().toISOString().slice(0,10),s=new Date(n+"T"+a.time).getTime();a.ts=Number.isNaN(s)?t-(e.messages.length-i)*1e3:s+i}else a.ts=t-(e.messages.length-i+10)*1e3}),e.lastTime==="剛剛"&&(e.lastTime="今天")}function ts(){try{const e=l.get("whatsappChats");if(Array.isArray(e)&&e.length){for(const n of e){const s=M.find(r=>r.id===n.id);s&&(s.messages=Array.isArray(n.messages)?n.messages:s.messages,s.preview=n.preview??s.preview,s.lastTime=n.lastTime??s.lastTime,s.unread=typeof n.unread=="number"?n.unread:s.unread,s.pinned=typeof n.pinned=="boolean"?n.pinned:s.pinned,s.muted=typeof n.muted=="boolean"?n.muted:s.muted,s.archived=typeof n.archived=="boolean"?n.archived:s.archived)}for(const n of e)M.some(s=>s.id===n.id)||M.push(n)}const t=l.get("whatsappMeta");t&&typeof t=="object"&&(t.activeId&&M.some(n=>n.id===t.activeId)&&(q=t.activeId),typeof t.ch1Event1Triggered=="boolean"&&(Pe=t.ch1Event1Triggered),typeof t.ch1Event2Triggered=="boolean"&&(Oe=t.ch1Event2Triggered),typeof t.sawyerSeq=="number"&&(Y=t.sawyerSeq),typeof t.sawyerSeqLocked=="boolean"&&(ha=t.sawyerSeqLocked)),l.hasFlag("ch1_event1_triggered")&&(Pe=!0);const a=M.find(n=>n.id==="nori-all");a&&a.messages.some(n=>n.text&&n.text.includes("發財樹"))&&(Pe=!0,l.hasFlag("ch1_event1_triggered")||l.setFlag("ch1_event1_triggered",!0));const i=M.find(n=>n.id==="maggie");i&&i.messages.some(n=>n.text&&n.text.includes("INV-2024-0043"))&&(Oe=!0);for(const n of M)Da(n)}catch{}Pe&&!l.hasFlag("ch1_event1_triggered")&&l.setFlag("ch1_event1_triggered",!0);try{for(const e of M)Da(e)}catch{}}function Xe(e){if(!M.some(i=>i.id===e))return;q=e;const t=M.find(i=>i.id===e);t&&(t.unread=0),H(),e==="nori-all"&&setTimeout(()=>fa(),100);const a=document.getElementById("view-whatsapp");a&&a.innerHTML&&(ct="chat",yn(),dt(),G(q))}function fn(){ts();const e=document.getElementById("view-whatsapp");if(e){e.innerHTML=`<div class="wa">
  ...
  </div>`,as(),dt(),G(q);try{if(l.get("currentChapter")===2&&!l.hasFlag("ch2_lunch_seq_done")){const t=M.find(a=>a.id==="lunch-team");t&&t.messages.some(a=>a.text&&a.text.includes("剛剛嚇壞了吧"))?l.hasFlag("ch2_lunch_seq_done")||l.setFlag("ch2_lunch_seq_done",!0):setTimeout(()=>{try{ya()}catch{}},900)}}catch{}}}function as(){const e=document.getElementById("view-whatsapp");e&&e.querySelectorAll(".wa__sidebar-tab[data-wa-tab]").forEach(t=>{t.addEventListener("click",()=>{const a=t.dataset.waTab;a!==ct&&(ct=a,yn(),dt())})})}function yn(){document.querySelectorAll(".wa__sidebar-tab[data-wa-tab]").forEach(e=>{const t=e.dataset.waTab===ct;e.classList.toggle("active",t),e.setAttribute("aria-selected",t?"true":"false")})}function dt(){ct==="account"?ns():U()}function ns(){const e=document.getElementById("waList");e&&(e.innerHTML=`
  ...
  `)}function gt(e){return!0}function is(){let e=[...M];if(qt){const a=qt.toLowerCase();e=e.filter(i=>i.name.toLowerCase().includes(a)||i.preview.toLowerCase().includes(a)||i.desc.toLowerCase().includes(a))}nt==="unread"?e=e.filter(a=>a.unread>0&&gt(a.id)):nt==="archived"?e=e.filter(a=>a.archived):e=e.filter(a=>!a.archived);const t=["nori-all","dev-team","sawyer","maggie","system-alert","lunch-team"];return e.sort((a,i)=>{const n=t.indexOf(a.id),s=t.indexOf(i.id),r=n===-1?999:n,d=s===-1?999:s;return r!==d?r-d:0}),e}function U(){if(ct!=="chat")return;const e=document.getElementById("waList");if(!e)return;const t=is();e.innerHTML=`
    <div class="wa__list-header">
      <div class="wa__search"><input id="waSearch" class="input" placeholder="搜尋聊天" value="${qt}" disabled readonly style="opacity:0.6;pointer-events:none;cursor:not-allowed" title="搜尋已停用" /></div>
      <div class="wa__filters">
        <button class="wa__filter ${nt==="all"?"active":""}" data-tab="all">全部</button>
        <button class="wa__filter ${nt==="unread"?"active":""}" data-tab="unread">未讀</button>
        <button class="wa__filter ${nt==="archived"?"active":""}" data-tab="archived">封存</button>
        <span class="small muted" style="margin-left:auto">${t.length} 對話</span>
      </div>
    </div>
    <div class="wa__list-scroll" id="waListScroll">
      ${t.map(a=>{const i=!gt(a.id);return`<div class="wa__item ${a.id===q?"active":""} ${a.muted?"muted":""}" data-id="${a.id}" style="${i?"opacity:.5":""}">
  ...
  `,e.querySelector("#waSearch")?.addEventListener("input",a=>{qt=a.target.value,U()}),e.querySelectorAll(".wa__filter").forEach(a=>a.addEventListener("click",()=>{nt=a.dataset.tab,U()})),e.querySelectorAll(".wa__item").forEach(a=>a.addEventListener("click",()=>{if(!gt(a.dataset.id))return;q=a.dataset.id;const i=M.find(n=>n.id===q);i&&(i.unread=0),H(),a.dataset.id==="nori-all"&&setTimeout(()=>fa(),100),ke=!1,U(),G(q)})),e.querySelectorAll(".wa__item").forEach(a=>{a.addEventListener("contextmenu",i=>{i.preventDefault();const n=M.find(s=>s.id===a.dataset.id);!n||!gt(n.id)||(n.pinned=!n.pinned,H(),U())})})}function G(e){const t=document.getElementById("waMessages"),a=t?t.scrollTop:null,i=t?t.scrollHeight:null,n=t?i-a-t.clientHeight<80:!0,s=a===0&&Re&&t&&i>t.clientHeight+80?!0:n;t&&(Re=s);const r=M.find(u=>u.id===e),d=document.getElementById("waChat");if(!r||!d)return;if(!gt(e)){d.innerHTML='<div class="view__placeholder"><h2>🔒 未解鎖</h2><div class="muted">先去 Vizual Studio Code 觸發 420.69 隱藏路由</div></div>';return}e==="supplier"&&l.setFlag("found_supplier",!0),e==="backend-team"&&l.setFlag("found_supplier",!0);let o=r.messages;if(Ve){const u=Ve.toLowerCase();o=o.filter(v=>(v.text||"").toLowerCase().includes(u)||(v.fileName||"").toLowerCase().includes(u))}o=[...o].map((u,v)=>({m:u,idx:v})).sort((u,v)=>{const h=typeof u.m.ts=="number"?u.m.ts:Fa(u.m.time),b=typeof v.m.ts=="number"?v.m.ts:Fa(v.m.time);return h!==b?h-b:u.idx-v.idx}).map(u=>u.m);const c={};o.forEach(u=>{const v=u.time.includes(":")?"今天":u.time;c[v]||(c[v]=[]),c[v].push(u)}),d.innerHTML=`
    ...
    <div id="waMsgSearchBar" style="display:${Ve?"flex":"none"};gap:8px;padding:8px 12px;border-bottom:1px solid var(--border);background:var(--bg-secondary)">
      <input id="waMsgSearchInput" class="input" placeholder="搜尋此對話訊息" value="${Ve}" style="flex:1" />
    ...
    <div class="wa__messages" id="waMessages">
      ${Object.entries(c).map(([u,v])=>`
        ...
        ${v.map(h=>ss(h,r)).join("")}
      `).join("")}
      ${e==="sawyer"&&Y===2?`<div class="wa__msg-row other" id="sawyerTyping"><div class="wa__msg-avatar" style="background:${va("Sawyer")}">S</div><div class="bubble other"><span class="small muted">輸入中...</span></div></div>`:""}
    </div>
    ${(()=>{let u="",v=!1;return e==="sawyer"&&(Y===1?(u="但是我查過這段code已經沒在用才對，所以不是這個問題影響的啊",v=!0):Y===2?(u="",v=!0):Y===3&&(u="但是",v=!0)),`<div class="wa__composer">
  ...
  `,document.getElementById("waChatHeader")?.addEventListener("click",()=>{ke=!ke,document.getElementById("waInfoPanel")?.classList.toggle("open",ke)}),document.getElementById("waInfoBtn")?.addEventListener("click",u=>{u.stopPropagation(),ke=!ke,document.getElementById("waInfoPanel")?.classList.toggle("open",ke)}),document.getElementById("waInfoClose")?.addEventListener("click",()=>{ke=!1,document.getElementById("waInfoPanel")?.classList.remove("open")}),document.getElementById("waToggleMute")?.addEventListener("click",()=>{r.muted=!r.muted,H(),U(),G(e)}),document.getElementById("waTogglePin")?.addEventListener("click",()=>{r.pinned=!r.pinned,H(),U(),G(e)}),document.getElementById("waToggleArchive")?.addEventListener("click",()=>{r.archived=!r.archived,H(),U(),G(e)}),document.getElementById("waMsgSearchBtn")?.addEventListener("click",()=>{Ve="",document.getElementById("waMsgSearchBar").style.display="flex",document.getElementById("waMsgSearchInput")?.focus()}),document.getElementById("waMsgSearchInput")?.addEventListener("input",u=>{Ve=u.target.value,G(e)}),document.getElementById("waMsgSearchClear")?.addEventListener("click",()=>{Ve="",G(e)}),document.getElementById("waExportBtn")?.addEventListener("click",()=>Oa(r)),document.getElementById("waMoreBtn")?.addEventListener("click",()=>Oa(r)),document.getElementById("waSendBtn")?.addEventListener("click",()=>Na(r)),document.getElementById("waComposerInput")?.addEventListener("keydown",u=>{u.key==="Enter"&&Na(r)}),document.querySelectorAll("[data-play]").forEach(u=>{u.addEventListener("click",()=>{const v=u.textContent;u.textContent="⏸️",setTimeout(()=>u.textContent=v,1800)})}),document.querySelectorAll("[data-img]").forEach(u=>{u.addEventListener("click",()=>wn(u.src))}),_n();try{const u=document.getElementById("waMessages");u&&!u._waScrollBound&&(u._waScrollBound=!0,u.addEventListener("scroll",()=>{const v=u.scrollHeight,h=u.scrollTop,b=u.clientHeight;Re=v-h-b<80}))}catch{}const m=s,p=a;requestAnimationFrame(()=>{requestAnimationFrame(()=>{const u=document.getElementById("waMessages");if(u)if(m||p===0&&u.scrollHeight>u.clientHeight+20&&Re)u.scrollTop=u.scrollHeight,Re=!0,u.scrollTop;else if(p!==null){const v=Math.max(0,u.scrollHeight-u.clientHeight);u.scrollTop=Math.min(p,v),u.scrollTop,Re=u.scrollHeight-u.scrollTop-u.clientHeight<80}else u.scrollTop=u.scrollHeight,Re=!0,u.scrollTop})})}function bn(e){return e?e==="you"||e==="你"?"你":e.trim().charAt(0).toUpperCase():"?"}function Fa(e){if(!e)return 0;if(e==="剛剛"||e==="今天")return Number.MAX_SAFE_INTEGER;if(/^\d{4}-\d{2}-\d{2}$/.test(e))return new Date(e+"T00:00:00").getTime();if(/^\d{1,2}\/\d{1,2}$/.test(e))return new Date("2024/"+e+"T00:00:00").getTime();const t=new Date().toISOString().slice(0,10);try{const a=new Date(t+"T"+e).getTime();return Number.isNaN(a)?Number.MAX_SAFE_INTEGER:a}catch{return Number.MAX_SAFE_INTEGER}}function va(e){const t=["#1f7aec","#e542a3","#00a884","#ff8c00","#6a5acd","#d93025","#0d9488","#7c3aed"];let a=0;for(let i=0;i<e.length;i++)a=a*31+e.charCodeAt(i)>>>0;return t[a%t.length]}function ss(e,t){const a=e.from==="you",i=a?e.read==="read"?'<span class="bubble__check read">✓✓</span>':e.read==="delivered"?'<span class="bubble__check">✓✓</span>':'<span class="bubble__check">✓</span>':"";let n="";e.type==="image"?n=`<div class="wa__media"><img data-img src="${e.media}" alt="image" /></div>`:e.type==="voice"?n=`<div class="wa__voice"><span class="wa__play" data-play>▶️</span><div class="wa__wave">${Array.from({length:12},(m,p)=>`<span style="height:${8+Math.random()*14}px"></span>`).join("")}</div><span class="small muted">${e.duration}</span></div>`:e.type==="file"&&(n=`<div class="wa__file"><div class="wa__file-icon">📄</div><div style="flex:1;min-width:0"><div style="font-weight:600;font-size:13px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">${g(e.fileName)}</div><div class="small muted">${g(e.fileSize)}</div></div><button class="btn" style="padding:4px 8px">下載</button></div>`);const s=e.text?`<div class="bubble__text">${g(e.text).replace(/\n/g,"<br>")}</div>`:"",r=`<div class="bubble__time">${g(e.time)} ${i}</div>`;if(a)return`<div class="wa__msg-row me">
      <div class="bubble me">${s}${n}${r}</div>
    </div>`;const d=bn(e.from),o=va(e.from),c=Array.isArray(t?.members)&&t.members.length>2?`<div class="bubble__sender" style="color:${o}">${g(e.from)}</div>`:"";return`<div class="wa__msg-row other">
    <div class="wa__msg-avatar" style="background:${o}" aria-label="${g(e.from)}" title="${g(e.from)}">${g(d)}</div>
    <div class="bubble other">${c}${s}${n}${r}</div>
  </div>`}function Na(e){if(e.id==="sawyer"&&Y===1){const n="但是我查過這段code已經沒在用才對，所以不是這個問題影響的啊";e.messages.push({id:"m"+Date.now(),from:"you",text:n,time:"今天",ts:Date.now(),read:"sent",type:"text"}),e.preview=n,e.lastTime="今天",e.unread=0,Y=2,Xt(e.id,n);try{Qt({chatId:e.id,chatName:e.name,text:n,to:"Sawyer"})}catch{}H(),G(e.id),U(),setTimeout(()=>{if(Y=3,e.messages.push({id:"sawyer-reply2-"+Date.now(),from:"Sawyer",text:"先別管，肯定是這段的影響，已經在影響我工作了",time:"今天",ts:Date.now(),read:"delivered",type:"text"}),e.preview="Sawyer: 先別管，肯定是這段的影響...",e.unread=(e.unread||0)+1,H(),window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"sawyer"}})),G(e.id),U(),wt("sawyer")||q==="sawyer")return;const s=document.createElement("div");s.id="wa-win-notif-sawyer-seq2-"+Date.now(),s.setAttribute("role","alert"),s.innerHTML='<div class="win-notif__app"><img src="/arg-game-it-company-secret/icon/whatsup.svg" alt="WhatUp" width="20" height="20" style="width:20px;height:20px;object-fit:contain" /><span class="win-notif__app-name">WhatUp</span><span class="win-notif__app-sub">Sawyer</span><button class="win-notif__close" aria-label="關閉">✕</button></div><div class="win-notif__body"><div class="win-notif__avatar" style="background:linear-gradient(135deg, #722F37, #8B1A1A)">S</div><div class="win-notif__text"><div class="win-notif__sender">Sawyer</div><div class="win-notif__msg">先別管，肯定是這段的影響，已經在影響我工作了</div><div class="win-notif__time">剛剛</div></div></div><div class="win-notif__progress" style="animation: winNotifShrink 4000ms linear forwards"></div>',s.style.cssText="position:fixed;right:16px;bottom:60px;width:360px;background:#2d2d2d;color:#f0f0f0;border:1px solid rgba(255,255,255,.12);border-radius:8px;box-shadow:0 8px 28px rgba(0,0,0,.45);z-index:1100;overflow:hidden;cursor:pointer;opacity:1;transform:none;",s.addEventListener("click",r=>{r.target.closest(".win-notif__close")||(s.remove(),A(()=>Promise.resolve().then(()=>re).then(d=>{d.setActiveView&&(d.setActiveView("whatsapp"),localStorage.setItem("cc_active_view","whatsapp"))}),void 0),Xe("sawyer"))}),s.querySelector(".win-notif__close")?.addEventListener("click",r=>{r.stopPropagation(),s.remove()}),document.body.appendChild(s),setTimeout(()=>s.remove(),4e3)},3e3);return}if(e.id==="sawyer"&&Y===2)return;if(e.id==="sawyer"&&Y===3){e.messages.push({id:"m"+Date.now(),from:"you",text:"但是",time:"今天",ts:Date.now(),read:"sent",type:"text"}),e.preview="但是",e.lastTime="今天",e.unread=0,Xt(e.id,"但是");try{Qt({chatId:e.id,chatName:e.name,text:"但是",to:"Sawyer"})}catch{}H(),G(e.id),U(),setTimeout(()=>{if(e.messages.push({id:"sawyer-reply3-"+Date.now(),from:"Sawyer",text:"趕快revert！",time:"今天",ts:Date.now(),read:"delivered",type:"text"}),e.preview="Sawyer: 趕快revert！",e.unread=(e.unread||0)+1,Y=4,ha=!1,H(),window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"sawyer"}})),G(e.id),U(),wt("sawyer")||q==="sawyer")return;const s=document.createElement("div");s.id="wa-win-notif-sawyer-seq3-"+Date.now(),s.setAttribute("role","alert"),s.innerHTML='<div class="win-notif__app"><img src="/arg-game-it-company-secret/icon/whatsup.svg" alt="WhatUp" width="20" height="20" style="width:20px;height:20px;object-fit:contain" /><span class="win-notif__app-name">WhatUp</span><span class="win-notif__app-sub">Sawyer</span><button class="win-notif__close" aria-label="關閉">✕</button></div><div class="win-notif__body"><div class="wa__msg-avatar" style="background:linear-gradient(135deg, #722F37, #8B1A1A)">S</div><div class="win-notif__text"><div class="win-notif__sender">Sawyer</div><div class="win-notif__msg">趕快revert！</div><div class="win-notif__time">剛剛</div></div></div><div class="win-notif__progress" style="animation: winNotifShrink 4000ms linear forwards"></div>',s.innerHTML='<div class="win-notif__app"><img src="/arg-game-it-company-secret/icon/whatsup.svg" alt="WhatUp" width="20" height="20" style="width:20px;height:20px;object-fit:contain" /><span class="win-notif__app-name">WhatUp</span><span class="win-notif__app-sub">Sawyer</span><button class="win-notif__close" aria-label="關閉">✕</button></div><div class="win-notif__body"><div class="win-notif__avatar" style="background:linear-gradient(135deg, #722F37, #8B1A1A)">S</div><div class="win-notif__text"><div class="win-notif__sender">Sawyer</div><div class="win-notif__msg">趕快revert！</div><div class="win-notif__time">剛剛</div></div></div><div class="win-notif__progress" style="animation: winNotifShrink 4000ms linear forwards"></div>',s.style.cssText="position:fixed;right:16px;bottom:60px;width:360px;background:#2d2d2d;color:#f0f0f0;border:1px solid rgba(255,255,255,.12);border-radius:8px;box-shadow:0 8px 28px rgba(0,0,0,.45);z-index:1100;overflow:hidden;cursor:pointer;opacity:1;transform:none;",s.addEventListener("click",r=>{r.target.closest(".win-notif__close")||(s.remove(),A(()=>Promise.resolve().then(()=>re).then(d=>{d.setActiveView&&(d.setActiveView("whatsapp"),localStorage.setItem("cc_active_view","whatsapp"))}),void 0),Xe("sawyer"))}),s.querySelector(".win-notif__close")?.addEventListener("click",r=>{r.stopPropagation(),s.remove()}),document.body.appendChild(s),setTimeout(()=>s.remove(),4e3)},200);return}const t=document.getElementById("waComposerInput"),a=t?.value.trim();if(!a)return;const i=e.id==="sawyer"&&Y===4;e.messages.push({id:"m"+Date.now(),from:"you",text:a,time:"今天",ts:Date.now(),read:"sent",type:"text"}),e.preview=a,e.lastTime="今天",e.unread=0,t.value="",Xt(e.id,a);try{Qt({chatId:e.id,chatName:e.name,text:a,to:e.name})}catch{}H(),G(e.id),U()}var Pe=!1,Oe=!1;function rs(){if(Pe)return;Pe=!0,H(),l.setFlag("ch1_event1_triggered",!0);const e=M.find(t=>t.id==="nori-all");e&&setTimeout(()=>{e.messages.push({id:"m-tree-"+Date.now(),from:"Sawyer",text:"聽從風水師建議，已在 Lobby 擺放一棵發財樹擋災，請大家切勿觸碰，否則運氣會散。",time:"今天",ts:Date.now(),read:"delivered",type:"text"}),e.preview="Sawyer: 聽從風水師建議，已在 Lobby 擺放",e.lastTime="今天",e.unread=(e.unread||0)+1,H(),window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"nori-all"}}));const t=document.getElementById("view-whatsapp");if(t&&t.innerHTML&&U(),setTimeout(()=>{e.messages.push({id:"m-tree-img-"+Date.now(),from:"Sawyer",text:"",media:"/arg-game-it-company-secret/assets/data/files/office.png",type:"image",time:"今天",ts:Date.now(),read:"delivered"}),e.preview="Sawyer: [圖片]",e.lastTime="今天",e.unread=(e.unread||0)+1,H(),window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"nori-all"}}));const i=document.getElementById("view-whatsapp");i&&i.innerHTML&&U()},1500),wt("nori-all")){setTimeout(()=>{Oe||zt()},1e4);return}const a=document.createElement("div");a.id="wa-win-notification-sawyer-tree",a.setAttribute("role","alert"),a.innerHTML=`
    ...
    `,a.style.cssText="position:fixed;right:16px;bottom:60px;width:360px;background:#2d2d2d;color:#f0f0f0;border:1px solid rgba(255,255,255,.12);border-radius:8px;box-shadow:0 8px 28px rgba(0,0,0,.45);z-index:1100;overflow:hidden;cursor:pointer;opacity:0;transform:translateY(12px);transition:opacity .28s,transform .28s;",a.addEventListener("click",i=>{i.target.closest(".win-notif__close")||(a.remove(),A(()=>Promise.resolve().then(()=>re).then(n=>{n.setActiveView&&(n.setActiveView("whatsapp"),localStorage.setItem("cc_active_view","whatsapp"))}),void 0),Xe("nori-all"))}),a.querySelector(".win-notif__close")?.addEventListener("click",i=>{i.stopPropagation(),a.remove()}),document.body.appendChild(a),requestAnimationFrame(()=>{a.style.opacity="1",a.style.transform="none"}),setTimeout(()=>{a.style.opacity="0",setTimeout(()=>a.remove(),300)},1e4),setTimeout(()=>{Oe||zt()},1e4)},1e4)}function zt(){if(Oe)return;Oe=!0,H();const e=M.find(t=>t.id==="maggie");e&&setTimeout(()=>{e.messages.push({id:"m-0043-"+Date.now(),from:"Maggie",text:"Hi @Casey, 有新的工單 INV-2024-0043, 請協助處理一下",time:"今天",ts:Date.now(),read:"delivered",type:"text"}),e.preview="Hi @Casey, 有新的工單 INV-2024-0043",e.lastTime="今天",e.unread=(e.unread||0)+1,H(),window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"maggie"}})),A(()=>Promise.resolve().then(()=>mt).then(i=>{i.addTicket0043&&i.addTicket0043(),document.getElementById("jiraBoard")&&window.dispatchEvent(new CustomEvent("jira:ticketAdded"))}),void 0);const t=document.getElementById("view-whatsapp");if(t&&t.innerHTML&&U(),wt("maggie")||q==="maggie")return;const a=document.createElement("div");a.id="wa-win-notification-maggie-0043",a.setAttribute("role","alert"),a.innerHTML=`
      <div class="win-notif__app">
        <img src="/arg-game-it-company-secret/icon/whatsup.svg" alt="WhatUp" width="20" height="20" style="width:20px;height:20px;object-fit:contain" />
        <span class="win-notif__app-name">WhatUp</span>
      ...
      <div class="win-notif__progress"></div>
    `,a.style.cssText="position:fixed;right:16px;bottom:60px;width:360px;background:#2d2d2d;color:#f0f0f0;border:1px solid rgba(255,255,255,.12);border-radius:8px;box-shadow:0 8px 28px rgba(0,0,0,.45);z-index:1100;overflow:hidden;cursor:pointer;opacity:0;transform:translateY(12px);transition:opacity .28s,transform .28s;",a.addEventListener("click",i=>{i.target.closest(".win-notif__close")||(a.remove(),A(()=>Promise.resolve().then(()=>re).then(n=>{n.setActiveView&&(n.setActiveView("whatsapp"),localStorage.setItem("cc_active_view","whatsapp"))}),void 0),Xe("maggie"))}),a.querySelector(".win-notif__close")?.addEventListener("click",i=>{i.stopPropagation(),a.remove()}),document.body.appendChild(a),requestAnimationFrame(()=>{a.style.opacity="1",a.style.transform="none"}),setTimeout(()=>{a.style.opacity="0",setTimeout(()=>a.remove(),300)},1e4)},1e4)}function fa(){M.find(e=>e.id==="nori-all")&&Pe&&!Oe&&zt()}var Zt=[{from:"Parker",text:"@Casey 剛剛嚇壞了吧 哈哈 估計是你進來以來第一次遇到系統爆炸了"},{from:"Parker",text:"不過說來也奇怪 這個入口應該搬移了才對"},{from:"Parker",text:"啊對了 這裡應該也沒多少人知道 那個原本是HR系統的入口"},{from:"Hugo",text:"對！！那個超難用的 系統不完善沒有適當防呆 他們又常常笨手笨腳刪掉資料 要找我們恢復"},{from:"Parker",text:"對啊 浪費我們人力 老闆就乾脆換系統了"},{from:"Hugo",text:"那為什麼代碼沒有隱藏入口？"},{from:"Parker",text:"不知道欸 這個不能動 一動就會大爆炸"},{from:"Hugo",text:"難不成有人偷用這個系統來偷藏色色的東西！"},{from:"Parker",text:"什麼鬼"}];function os(e,t){if(wt("lunch-team")||q==="lunch-team")return;const a=va(e),i=bn(e),n=document.createElement("div");n.className="win-notif",n.id="wa-win-notif-lunch-"+Date.now()+"-"+Math.random().toString(36).slice(2,6),n.setAttribute("role","alert"),n.innerHTML=`
      <div class="win-notif__app">
        <img src="/arg-game-it-company-secret/icon/whatsup.svg" alt="WhatUp" width="20" height="20" style="width:20px;height:20px;object-fit:contain" />
        <span class="win-notif__app-name">WhatUp</span>
  ...
  `,n.style.cssText="position:fixed;right:16px;bottom:60px;width:360px;background:#2d2d2d;color:#f0f0f0;border:1px solid rgba(255,255,255,.12);border-radius:8px;box-shadow:0 8px 28px rgba(0,0,0,.45);z-index:1100;overflow:hidden;cursor:pointer;opacity:0;transform:translateY(12px);transition:opacity .28s,transform .28s;",n.addEventListener("click",s=>{s.target.closest(".win-notif__close")||(n.remove(),A(()=>Promise.resolve().then(()=>re).then(r=>{r.setActiveView&&(r.setActiveView("whatsapp"),localStorage.setItem("cc_active_view","whatsapp"))}),void 0),Xe("lunch-team"))}),n.querySelector(".win-notif__close")?.addEventListener("click",s=>{s.stopPropagation(),n.remove()}),document.body.appendChild(n),requestAnimationFrame(()=>{n.style.opacity="1",n.style.transform="none"}),setTimeout(()=>{n.style.opacity="0",n.style.transform="translateY(8px)",setTimeout(()=>n.remove(),300)},4e3)}function ya(){if(l.hasFlag("ch2_lunch_seq_done"))return;const e=M.find(i=>i.id==="lunch-team");if(!e)return;if(e.messages.some(i=>i.text&&i.text.includes("剛剛嚇壞了吧"))){l.hasFlag("ch2_lunch_seq_done")||l.setFlag("ch2_lunch_seq_done",!0);return}l.setFlag("ch2_lunch_seq_done",!0),H();let t=0;const a=()=>{if(t>=Zt.length)return;const{from:i,text:n}=Zt[t],s=Date.now();e.messages.push({id:"lunch-ch2-"+s+"-"+t,from:i,text:n,time:"今天",ts:s+t,read:"delivered",type:"text"}),e.preview=`${i}: ${n.slice(0,20)}`,e.lastTime="今天",q!=="lunch-team"?e.unread=(e.unread||0)+1:e.unread=0,H(),window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"lunch-team"}})),os(i,n),t+=1,t<Zt.length&&setTimeout(a,5e3)};setTimeout(a,800)}function Oa(e){const t=`WhatUp 匯出 — ${e.name}
${e.messages.map(s=>`[${s.time}] ${s.from}: ${s.text||s.fileName||s.type}`).join(`
`)}`,a=new Blob([t],{type:"text/plain"}),i=URL.createObjectURL(a),n=document.createElement("a");n.href=i,n.download=`${e.id}-chat.txt`,n.click(),URL.revokeObjectURL(i)}function ls(){return M}function cs(){if(Y!==0)return;Y=1,H();const e=document.getElementById("view-whatsapp");if(e&&e.classList.contains("active")||localStorage.getItem("cc_active_view"),e&&e.innerHTML){try{G(q)}catch{}try{dt()}catch{}}try{l.setFlag("sawyer_seq_started",!0)}catch{}}var ge=1,tt=0,at=0,Ft=!1,Ha=0,Va=0,Ra=0,qa=0;function _n(){if(document.getElementById("waLightbox"))return;const e=document.createElement("div");e.id="waLightbox",e.className="wa-lightbox",e.setAttribute("aria-hidden","true"),e.innerHTML=`
  ...
  `,document.body.appendChild(e);const t=e.querySelector("#waLightboxImg"),a=e.querySelector("#waLightboxBody"),i=e.querySelector("#waLightboxScale");function n(){t&&(t.style.transform=`translate(${tt}px, ${at}px) scale(${ge})`,i&&(i.textContent=Math.round(ge*100)+"%"),a.style.cursor=ge>1?Ft?"grabbing":"grab":"zoom-in")}function s(c,m,p){ge=Math.max(.5,Math.min(4,c)),ge===1&&(tt=0,at=0),n()}e.querySelector('[data-wa-zoom="in"]')?.addEventListener("click",()=>s(ge+.25)),e.querySelector('[data-wa-zoom="out"]')?.addEventListener("click",()=>s(ge-.25)),e.querySelector('[data-wa-zoom="reset"]')?.addEventListener("click",()=>{ge=1,tt=0,at=0,n()}),e.querySelector("#waLightboxClose")?.addEventListener("click",()=>Vt()),e.querySelector("[data-wa-close]")?.addEventListener("click",()=>Vt()),a?.addEventListener("wheel",c=>{c.preventDefault();const m=c.deltaY>0?-.1:.1;s(ge+m)},{passive:!1});function r(c){ge<=1||(Ft=!0,t.classList.add("dragging"),Ha=c.clientX,Va=c.clientY,Ra=tt,qa=at,a.setPointerCapture?.(c.pointerId))}function d(c){Ft&&(tt=Ra+(c.clientX-Ha),at=qa+(c.clientY-Va),n())}function o(c){Ft=!1,t.classList.remove("dragging");try{a.releasePointerCapture?.(c.pointerId)}catch{}}a?.addEventListener("pointerdown",r),a?.addEventListener("pointermove",d),a?.addEventListener("pointerup",o),a?.addEventListener("pointercancel",o),document.addEventListener("keydown",c=>{c.key==="Escape"&&e.classList.contains("open")&&Vt()}),e._updateTransform=n,e._setScale=s}function wn(e){_n();const t=document.getElementById("waLightbox"),a=document.getElementById("waLightboxImg");!t||!a||(a.src=e,ge=1,tt=0,at=0,t._updateTransform?.(),t.classList.add("open"),t.setAttribute("aria-hidden","false"))}function Vt(){const e=document.getElementById("waLightbox");e&&(e.classList.remove("open"),e.setAttribute("aria-hidden","true"))}try{W.on("chapter:changed",e=>{e===2&&setTimeout(()=>{try{ya()}catch{}},600)})}catch{}typeof window<"u"&&!window.__waListenerBound&&(window.__waListenerBound=!0,window.addEventListener("whatsapp:newMessage",e=>{try{H()}catch{}const t=document.getElementById("view-whatsapp");if(!(!t||!t.innerHTML)){try{dt()}catch{}try{G(q)}catch{}}}),window.addEventListener("whatsapp:refresh",()=>{const e=document.getElementById("view-whatsapp");if(!(!e||!e.innerHTML)){try{dt()}catch{}try{G(q)}catch{}}}));var rt=[{title:"Java switch-case 語法詳解 — 基礎教學 (繁中)",url:"https://java-tutorial.example/switch-case",snippet:"【switch 用法】switch 會依變數值跳到對應 case，需搭配 break 避免貫穿。範例：switch(vipLv){ case 1: price *= 0.90; break; case 2: price *= 0.85; break; case 3: price *= 0.80; break; case 4: price *= 0.75; break; case 5: price *= 0.70; break; default: break; } 注意：若缺少 break 會繼續執行下一個 case。常與 if-else 比較，適用於枚舉分級如 VIP 折扣。",type:"web",image:null},{title:"【StackOverflow】VIP 等級折扣用 switch 寫，VIP1 被算成 60% 而不是 50% 該怎麼修？",url:"https://stackoverflow.com/questions/789421/vip-discount-switch-case-wrong-percentage",snippet:`發問：我的 switch(vipLv) 中 case 1 寫成 price*=0.95，但需求是 VIP1 60%、VIP2 65%。已嘗試修改但 Sonar 仍報錯... 
...
`,type:"news",image:null},{title:"那些藏在程式碼裡的小彩蛋：我在小團隊看到的開發者塗鴉 — Peter Lin",url:"https://peter-blog.example/code-easter-eggs",snippet:"待過幾間中小企業後發現，只要沒有嚴格的 code quality 流程，程式碼裡總會冒出一些跟公司或產品完全無關的東西——註解裡的粗口、對工作的抱怨、整段國歌歌詞，甚至藏得很深的小遊戲。我對這些小彩蛋的看法是：只要不影響功能與效能，算是工作中找到的小樂趣。 — Peter Lin",type:"web",image:"https://picsum.photos/seed/codeeggs/600/400"},{title:"給完全不懂程式的人：MD5 是什麼？把一句話變成一串亂碼的小魔法 — Peter Lin",url:"https://peter-blog.example/md5-for-beginners",snippet:"完全不懂程式也看得懂。MD5 就像一台指紋機：你丟一句話進去，它永遠吐出 32 個字由 0-9、a-f 組成的亂碼。同樣輸入永遠得到同樣輸出，改一個字結果就完全不同。例如 hello → 5d41402abc4b2a76b9719d911017c592，平常看到的 ?hash=be78e754... 就是典型例子。— Peter Lin",type:"web",image:"https://picsum.photos/seed/md5/600/400"}],xn={sawyer:{id:"sawyer",name:"Sawyer Choi",handle:"@sawyerchoi",displayName:"Sawyer Choi / 蔡梓掦",bio:"喜歡把日常小事寫成文字的人。從2001年開始在 BlogWorld 記錄生活，覺得能把想法寫下來，好像就能更理解自己一點。",avatar:"/arg-game-it-company-secret/lemon_tea.jpg",cover:"/arg-game-it-company-secret/lemon_tea.jpg",followers:842,following:37,joined:"2001-10-01",verified:!1},mary:{id:"mary",name:"Mary Chen",handle:"@marychen",displayName:"Mary Chen · 陳曉玲",bio:"旅遊 × 攝影 × 生活手帳。走過 27 個城市，喜歡在咖啡香裡寫明信片。",avatar:"https://i.pravatar.cc/150?u=mary",cover:"https://picsum.photos/seed/marycover/900/240",followers:12430,following:210,joined:"2018-03-12",verified:!0},peter:{id:"peter",name:"Peter Lin",handle:"@peterlin",displayName:"Peter Lin · 林柏安",bio:"後端工程師 / 開源愛好者。分享 Python、NAS、自架服務與踩坑筆記。",avatar:"https://i.pravatar.cc/150?u=peter",cover:"https://picsum.photos/seed/petercover/900/240",followers:8930,following:96,joined:"2019-07-20",verified:!0},paul:{id:"paul",name:"Paul Wang",handle:"@paulwang",displayName:"Paul Wang · 王志豪",bio:"台南胃、台北心。專門挖掘巷弄美食與手沖咖啡，記錄每一口幸福。",avatar:"https://i.pravatar.cc/150?u=paul",cover:"https://picsum.photos/seed/paulcover/900/240",followers:15600,following:143,joined:"2017-11-05",verified:!0},emma:{id:"emma",name:"Emma Wu",handle:"@emmaw",displayName:"Emma Wu · 吳思敏",bio:"底片攝影 / 極地旅人。想用快門留住光線的溫度。",avatar:"https://i.pravatar.cc/150?u=emma",cover:"https://picsum.photos/seed/emmacover/900/240",followers:6720,following:78,joined:"2020-01-18",verified:!1},david:{id:"david",name:"David Chang",handle:"@davidchang",displayName:"David Chang · 張大衛",bio:"黑膠收藏家 / Live House 常客。寫音樂，也寫城市的聲音。",avatar:"https://i.pravatar.cc/150?u=david",cover:"https://picsum.photos/seed/davidcover/900/240",followers:4210,following:52,joined:"2019-09-03",verified:!1}},ee=[{url:"https://sawyer-blog.example/2001-10-18",title:"Sawyer Choi — 2001-10-18",excerpt:"今天和好多朋友一起玩，大家都玩得很開心。我把自己的食物分給大家吃，他們笑得很開心。",content:`2001-10-18
...
<p>除錯技巧：在 <code>vite.config.js</code> 設 <code>publicDir</code> 或用 <code>console.log(import.meta.env)</code> 印出所有 <code>VITE_</code> 變數。</p>`}],commentsQ:[{user:"發問者",text:"原來只有 VITE_ 才會到前端，難怪 DATABASE_URL 一直 undefined",time:"2024-08-12 12:30"},{user:"路人",text:"推，之前把 MD5_KEY 放 VITE_ 被老師罵",time:"2024-08-13 08:20"}]}};function us(e){return e&&e.includes("stackoverflow.com")&&kn[e]}function ms(e){return kn[e]||null}function gs(e){function t(I,S){return I<<S|I>>>32-S}function a(I,S){var T,P,D=I&2147483648,O=S&2147483648,V;return T=I&1073741824,P=S&1073741824,V=(I&1073741823)+(S&1073741823),T&P?V^2147483648^D^O:T|P?V&1073741824?V^3221225472^D^O:V^1073741824^D^O:V^D^O}function i(I,S,T){return I&S|~I&T}function n(I,S,T){return I&T|S&~T}function s(I,S,T){return I^S^T}function r(I,S,T){return S^(I|~T)}function d(I,S,T,P,D,O,V){return I=a(I,a(a(i(S,T,P),D),V)),a(t(I,O),S)}function o(I,S,T,P,D,O,V){return I=a(I,a(a(n(S,T,P),D),V)),a(t(I,O),S)}function c(I,S,T,P,D,O,V){return I=a(I,a(a(s(S,T,P),D),V)),a(t(I,O),S)}function m(I,S,T,P,D,O,V){return I=a(I,a(a(r(S,T,P),D),V)),a(t(I,O),S)}function p(I){for(var S,T=I.length,P=T+8,D=((P-P%64)/64+1)*16,O=Array(D-1),V=0,xe=0;xe<T;)S=(xe-xe%4)/4,V=xe%4*8,O[S]=O[S]|I.charCodeAt(xe)<<V,xe++;return S=(xe-xe%4)/4,V=xe%4*8,O[S]=O[S]|128<<V,O[D-2]=T<<3,O[D-1]=T>>>29,O}function u(I){var S="",T="",P,D;for(D=0;D<=3;D++)P=I>>>D*8&255,T="0"+P.toString(16),S=S+T.substr(T.length-2,2);return S}function v(I){I=I.replace(/\r\n/g,`
`);for(var S="",T=0;T<I.length;T++){var P=I.charCodeAt(T);P<128?S+=String.fromCharCode(P):P>127&&P<2048?(S+=String.fromCharCode(P>>6|192),S+=String.fromCharCode(P&63|128)):(S+=String.fromCharCode(P>>12|224),S+=String.fromCharCode(P>>6&63|128),S+=String.fromCharCode(P&63|128))}return S}var h=Array(),b,$,j,oe,E,_,w,y,f,B=7,L=12,z=17,_e=22,Ze=5,He=9,N=14,Le=20,we=4,Lt=11,Tt=16,$t=23,At=6,Bt=10,jt=15,Pt=21;for(e=v(e),h=p(e),_=1732584193,w=4023233417,y=2562383102,f=271733878,b=0;b<h.length;b+=16)$=_,j=w,oe=y,E=f,_=d(_,w,y,f,h[b+0],B,3614090360),f=d(f,_,w,y,h[b+1],L,3905402710),y=d(y,f,_,w,h[b+2],z,606105819),w=d(w,y,f,_,h[b+3],_e,3250441966),_=d(_,w,y,f,h[b+4],B,4118548399),f=d(f,_,w,y,h[b+5],L,1200080426),y=d(y,f,_,w,h[b+6],z,2821735955),w=d(w,y,f,_,h[b+7],_e,4249261313),_=d(_,w,y,f,h[b+8],B,1770035416),f=d(f,_,w,y,h[b+9],L,2336552879),y=d(y,f,_,w,h[b+10],z,4294925233),w=d(w,y,f,_,h[b+11],_e,2304563134),_=d(_,w,y,f,h[b+12],B,1804603682),f=d(f,_,w,y,h[b+13],L,4254626195),y=d(y,f,_,w,h[b+14],z,2792965006),w=d(w,y,f,_,h[b+15],_e,1236535329),_=o(_,w,y,f,h[b+1],Ze,4129170786),f=o(f,_,w,y,h[b+6],He,3225465664),y=o(y,f,_,w,h[b+11],N,643717713),w=o(w,y,f,_,h[b+0],Le,3921069994),_=o(_,w,y,f,h[b+5],Ze,3593408605),f=o(f,_,w,y,h[b+10],He,38016083),y=o(y,f,_,w,h[b+15],N,3634488961),w=o(w,y,f,_,h[b+4],Le,3889429448),_=o(_,w,y,f,h[b+9],Ze,568446438),f=o(f,_,w,y,h[b+14],He,3275163606),y=o(y,f,_,w,h[b+3],N,4107603335),w=o(w,y,f,_,h[b+8],Le,1163531501),_=o(_,w,y,f,h[b+13],Ze,2850285829),f=o(f,_,w,y,h[b+2],He,4243563512),y=o(y,f,_,w,h[b+7],N,1735328473),w=o(w,y,f,_,h[b+12],Le,2368359562),_=c(_,w,y,f,h[b+5],we,4294588738),f=c(f,_,w,y,h[b+8],Lt,2272392833),y=c(y,f,_,w,h[b+11],Tt,1839030562),w=c(w,y,f,_,h[b+14],$t,4259657740),_=c(_,w,y,f,h[b+1],we,2763975236),f=c(f,_,w,y,h[b+4],Lt,1272893353),y=c(y,f,_,w,h[b+7],Tt,4139469664),w=c(w,y,f,_,h[b+10],$t,3200236656),_=c(_,w,y,f,h[b+13],we,681279174),f=c(f,_,w,y,h[b+0],Lt,3936430074),y=c(y,f,_,w,h[b+3],Tt,3572445317),w=c(w,y,f,_,h[b+6],$t,76029189),_=c(_,w,y,f,h[b+9],we,3654602809),f=c(f,_,w,y,h[b+12],Lt,3873151461),y=c(y,f,_,w,h[b+15],Tt,530742520),w=c(w,y,f,_,h[b+2],$t,3299628645),_=m(_,w,y,f,h[b+0],At,4096336452),f=m(f,_,w,y,h[b+7],Bt,1126891415),y=m(y,f,_,w,h[b+14],jt,2878612391),w=m(w,y,f,_,h[b+5],Pt,4237533241),_=m(_,w,y,f,h[b+12],At,1700485571),f=m(f,_,w,y,h[b+3],Bt,2399980690),y=m(y,f,_,w,h[b+10],jt,4293915773),w=m(w,y,f,_,h[b+1],Pt,2240044497),_=m(_,w,y,f,h[b+8],At,1873313359),f=m(f,_,w,y,h[b+15],Bt,4264355552),y=m(y,f,_,w,h[b+6],jt,2734768916),w=m(w,y,f,_,h[b+13],Pt,1309151649),_=m(_,w,y,f,h[b+4],At,4149444226),f=m(f,_,w,y,h[b+11],Bt,3174756917),y=m(y,f,_,w,h[b+2],jt,718787259),w=m(w,y,f,_,h[b+9],Pt,3951481745),_=a(_,$),w=a(w,j),y=a(y,oe),f=a(f,E);return(u(_)+u(w)+u(y)+u(f)).toLowerCase()}function hs(e){if(!e)return[];const t=e.toLowerCase(),a=new Set,i=[];return rt.forEach(n=>{n.title.toLowerCase().includes(t)&&!a.has(n.title)&&(a.add(n.title),i.push({text:n.title,kind:n.type}))}),(l.get("searchHistory")||[]).slice(-5).reverse().forEach(n=>{n.q.toLowerCase().includes(t)&&!a.has(n.q)&&(a.add(n.q),i.push({text:n.q,kind:"history"}))}),i.slice(0,8)}function vs(e){let t=e;const a={site:null,filetype:null,before:null,after:null},i=t.match(/site:([^\s]+)/i);i&&(a.site=i[1].toLowerCase(),t=t.replace(i[0],"").trim());const n=t.match(/filetype:([^\s]+)/i);n&&(a.filetype=n[1].toLowerCase(),t=t.replace(n[0],"").trim());const s=t.match(/before:([^\s]+)/i);s&&(a.before=s[1],t=t.replace(s[0],"").trim());const r=t.match(/after:([^\s]+)/i);return r&&(a.after=r[1],t=t.replace(r[0],"").trim()),{base:t.trim(),filters:a}}function fs(e){return e.toLowerCase().includes("md5")}function ys(e){const t=document.getElementById("md5Tool");if(!t)return;const a=document.getElementById("searchLayout"),i=document.getElementById("searchDetail");a&&(a.style.display="none"),i&&(i.style.display="none",i.innerHTML="",i.classList.remove("open"));let n="";if(e){const p=e.match(/md5\s*(.*)/i);p&&p[1]&&(n=p[1].trim())}t.innerHTML=`
  ...
  `,_s(),oa(),ws(),Ae(""))}function _s(){const e=document.getElementById("searchInput"),t=document.getElementById("suggestBox");e?.addEventListener("input",a=>{const i=a.target.value,n=hs(i);if(!i||!n.length){t.classList.remove("open"),t.innerHTML="";return}t.innerHTML=n.map(s=>`<div class="suggest-item" data-q="${g(s.text)}"><span>${g(s.text)}</span><span class="small">${s.kind}</span></div>`).join(""),t.classList.add("open"),t.querySelectorAll(".suggest-item").forEach(s=>s.addEventListener("click",()=>{e.value=s.dataset.q,t.classList.remove("open"),Ae(s.dataset.q)}))}),e?.addEventListener("keydown",a=>{if(a.key==="Enter"&&(document.getElementById("suggestBox")?.classList.remove("open"),Ae(a.target.value)),a.key==="Escape"&&document.getElementById("suggestBox")?.classList.remove("open"),a.key==="ArrowDown"){const i=document.querySelector("#suggestBox .suggest-item");i&&(a.preventDefault(),i.classList.add("active"),e.value=i.dataset.q)}}),e?.addEventListener("blur",()=>setTimeout(()=>t?.classList.remove("open"),150)),document.getElementById("searchBtn")?.addEventListener("click",()=>Ae(document.getElementById("searchInput").value)),document.querySelectorAll(".chip").forEach(a=>a.addEventListener("click",()=>Ae(a.dataset.q))),document.querySelectorAll(".search__tab").forEach(a=>{a.addEventListener("click",()=>{document.querySelectorAll(".search__tab").forEach(i=>i.classList.remove("active")),a.classList.add("active"),le=a.dataset.tab,Ae(xt||"Sawyer")})})}function oa(){const e=document.getElementById("searchHistoryList");if(!e)return;const t=(l.get("searchHistory")||[]).slice(-8).reverse();if(!t.length){e.innerHTML='<div class="small muted">尚無歷史</div>';return}e.innerHTML=t.map(a=>`<div class="history-item" data-q="${g(a.q)}"><span>${g(a.q)}</span><span class="small">${new Date(a.at).toLocaleTimeString("zh-TW",{hour:"2-digit",minute:"2-digit"})}</span></div>`).join(""),e.querySelectorAll(".history-item").forEach(a=>a.addEventListener("click",()=>Ae(a.dataset.q)))}function ws(){const e=document.getElementById("searchTrendList");e&&(e.innerHTML=ps.map(t=>`<div class="trend-item" data-q="${g(t)}"><span>🔥 ${g(t)}</span><span class="small">›</span></div>`).join(""),e.querySelectorAll(".trend-item").forEach(t=>t.addEventListener("click",()=>Ae(t.dataset.q))))}function Ae(e){const t=document.getElementById("searchInput");t&&e&&(t.value=e);const a=(e||"").trim();if(!a)return;if(xt=a,a.includes("hash=")&&a.includes("f665a7117959b667b7f283eaebf69cae")){const p=document.getElementById("searchResults");if(p){be(),p.innerHTML='<div class="card" style="padding:16px"><div class="small muted">此為暗網路徑的 hash，請至 <b>正常內網</b> 搜尋框輸入完整 URL：<br><code style="word-break:break-all">https://nori-intranet/internal/portal?hash=f665a7117959b667b7f283eaebf69cae</code><br><br>提示：可在 Vizual Studio Code 的 Git Graph 找到 <code>generateSecretPath</code> 歷史與 <code>.env.example</code> 的 key，自行組合 md5。</div></div>';const u=document.getElementById("md5Tool");u&&(u.style.display="none",u.innerHTML=""),l.push("searchHistory",{q:a,at:new Date().toISOString()}),oa();return}}const i=document.getElementById("md5Tool");i&&(i.style.display="none",i.innerHTML="");const n=document.getElementById("searchLayout");n&&(n.style.display=""),l.push("searchHistory",{q:a,at:new Date().toISOString()}),(a.toLowerCase().includes("package")||a.toLowerCase().includes("image"))&&l.setFlag("reverse_image_done",!0),(a.toLowerCase().includes("shell")||a.toLowerCase().includes("site:nori"))&&l.setFlag("found_shell_company",!0),(a.toLowerCase().includes("drink")||a.toLowerCase().includes("nori"))&&l.setFlag("found_supplier",!0),oa();const{base:s,filters:r}=vs(a);ba=s;const d=document.getElementById("searchAdvancedHint");if(d){const p=[];r.site&&p.push(`site:${r.site}`),r.filetype&&p.push(`filetype:${r.filetype}`),r.before&&p.push(`before:${r.before}`),r.after&&p.push(`after:${r.after}`),d.textContent=p.length?`進階語法生效：${p.join(" · ")} ｜ 基礎查詢：${s||"(空)"}`:""}let o=[];const c=s.toLowerCase().trim().replace(/\s+/g," ");if(c==="sawyer"||c==="sawyer choi"){const p=["https://sawyer-blog.example/2024-03-20","https://sawyer-blog.example/2024-01-15","https://sawyer-blog.example/2023-12-20","https://sawyer-blog.example/2023-05-10","https://sawyer-blog.example/2023-05-01"],u="https://news.example/sawyer-statement-2023",v="https://school.example/guangzhi-essay-sawyer",h=new Map(rt.map(j=>[j.url,j]));for(const j of p){const oe=h.get(j);if(oe){if(le!=="all"&&oe.type!==le||r.site&&!oe.url.toLowerCase().includes(r.site))continue;o.push(oe)}}const b=h.get(u);b&&(le==="all"||b.type===le)&&(!r.site||b.url.toLowerCase().includes(r.site))&&o.push(b);const $=h.get(v);$&&(le==="all"||$.type===le)&&(!r.site||$.url.toLowerCase().includes(r.site))&&o.push($)}else for(const p of rt){if(le!=="all"&&p.type!==le)continue;const u=(p.title+" "+p.snippet+" "+p.url).toLowerCase(),v=s.toLowerCase();(!s||u.includes(v)||s.split(/\s+/).some(h=>u.includes(h.toLowerCase())))&&(r.site&&!p.url.toLowerCase().includes(r.site)||r.filetype&&p.type==="image"&&r.filetype!=="image"||o.push(p))}if(le==="image"&&o.some(p=>p.image),fs(a)){const p={title:"MD5 加密工具 — 線上 MD5 產生器 / 轉換器",url:"md5-tool",snippet:"輸入任意字串，一鍵轉換為 32 位小寫 MD5。支援即時轉換、複製與清空。",type:"tool",image:null,isMD5Tool:!0};o.some(v=>v.isMD5Tool||v.url==="md5-tool")||o.unshift(p);const u="https://peter-blog.example/md5-for-beginners";if(!o.some(v=>v.url===u)){const v=rt.find(h=>h.url===u);if(v&&(le==="all"||v.type===le)){const h=o.findIndex(b=>b.url==="md5-tool");o.splice(h+1,0,v)}}}it=o.slice(0,12);const m=document.getElementById("searchResults");if(m){if(be(),!it.length){m.innerHTML='<div class="muted small" style="margin-top:12px">無結果 — 嘗試輸入相關字眼 </code></div>';return}m.innerHTML=it.map((p,u)=>`
    <div class="result" data-idx="${u}">
      <div class="result__title" data-open="${u}">${g(p.title)}</div>
      <div class="result__url">${g(p.url)}</div>
      <div class="result__snippet">${_a(p.snippet,s)}</div>
  ...
  `).join(""),m.querySelectorAll("[data-open]").forEach(p=>p.addEventListener("click",()=>{const u=Number(p.dataset.open),v=it[u];if(v){if(v.url.startsWith("file://")||v.url.startsWith("/customer-portal")){const h=v.url.replace("file://","");k.exists(h)&&l.setFlag("found_code_map",!0);const b=new CustomEvent("search:openFile",{detail:h});window.dispatchEvent(b)}Ls(u)}}))}}function be(){const e=document.getElementById("md5Tool");e&&(e.style.display="none",e.innerHTML="");const t=document.getElementById("searchLayout"),a=document.getElementById("searchDetail");t&&(t.style.display=""),a&&(a.style.display="none",a.innerHTML="",a.classList.remove("open"));const i=document.querySelector(".search");i&&(i.scrollTop=0);const n=document.getElementById("view-search");n&&(n.scrollTop=0)}function K(e){return e>=1e4?(e/1e4).toFixed(1)+"萬":e>=1e3?(e/1e3).toFixed(1)+"k":String(e)}function Wt(e){return ee.find(t=>t.url===e)||null}function Be(e){return xn[e]||null}function xs(e){return ee.filter(t=>t.authorId===e).sort((t,a)=>a.views-t.views)}function ks(e){const t=ee.filter(n=>n.authorId===e.authorId&&n.url!==e.url).sort((n,s)=>s.views-n.views).slice(0,2);let a=ee.filter(n=>n.topic===e.topic&&n.url!==e.url&&n.authorId!==e.authorId);if(a.length<3){const n=ee.filter(s=>s.url!==e.url&&!t.includes(s)&&!a.includes(s)&&s.tags.some(r=>e.tags.includes(r)));a=[...a,...n]}a=a.slice(0,3);let i=[...t,...a];if(i.length<5){const n=ee.filter(s=>s.url!==e.url&&!i.includes(s)).sort(()=>.5-Math.random()).slice(0,5-i.length);i=i.concat(n)}return i.slice(0,5)}function wa(e){return`
  ...
  `}function xa(e){e.querySelector("[data-blog-home]")?.addEventListener("click",()=>kt()),e.querySelectorAll("[data-blog-nav]").forEach(t=>{t.addEventListener("click",()=>{(t.dataset.blogNav==="home"||t.dataset.blogNav==="trending")&&kt()})}),e.querySelector("[data-blog-back-search]")?.addEventListener("click",()=>be())}function kt(){const e=document.getElementById("searchDetail"),t=document.getElementById("searchLayout");if(!e||!t)return;t.style.display="none",e.style.display="block",e.classList.add("open");const a=document.getElementById("md5Tool");a&&(a.style.display="none",a.innerHTML="");const i=[...ee].sort((p,u)=>u.views-p.views).slice(0,1)[0],n=[...ee].sort((p,u)=>u.views-p.views).slice(1,4),s=ee.find(p=>p.url==="https://peter-blog.example/code-easter-eggs"),r=[...ee.filter(p=>p.url!=="https://peter-blog.example/code-easter-eggs")].sort(()=>.5-Math.random()),d=(s?[s,...r].slice(0,6):[...ee].sort(()=>.5-Math.random()).slice(0,6)).slice(0,6),o=Object.values(xn).sort((p,u)=>u.followers-p.followers).slice(0,4);e.innerHTML=`
            ...
            <div class="blog-featured">
              <div class="blog-featured__main" data-blog-url="${g(i.url)}">
                ...
                <div class="blog-card__body">
                  ...
                  <div class="blog-card__meta"><span class="blog-card__author"><img src="${g(Be(i.authorId).avatar)}" alt="" />${g(Be(i.authorId).displayName)}</span><span class="blog-card__dot"></span><span>${g(i.date)}</span><span class="blog-card__dot"></span><span><i class="fa-solid fa-eye"></i> ${K(i.views)}</span></div>
                </div>
              </div>
                ...
                ${n.map(p=>`
                  <div class="blog-mini" data-blog-url="${g(p.url)}">
                    ...
                    <div style="flex:1;min-width:0">
                      ...
                      <div class="blog-mini__meta"><span>${g(Be(p.authorId).displayName.split("·")[0].trim())}</span><span>·</span><span><i class="fa-solid fa-eye"></i> ${K(p.views)}</span></div>
              ...
              ${d.map(p=>`
                <div class="blog-card" data-blog-url="${g(p.url)}">
                  ...
                  <div class="blog-card__body">
                    ...
                    <div class="blog-card__meta"><span class="blog-card__author"><img src="${g(Be(p.authorId).avatar)}" alt="" />${g(Be(p.authorId).name)}</span><span class="blog-card__dot"></span><span>${g(p.date)}</span><span class="blog-card__dot"></span><span><i class="fa-solid fa-eye"></i> ${K(p.views)}</span></div>
                  </div>
                </div>
              `).join("")}
            </div>
              ...
              <div class="blog-author-list">
                ${o.map(p=>`
                  <div class="blog-author-row" data-blog-author="${g(p.id)}">
                    ...
                    <span style="font-size:11px;color:#9aa0a6">${K(p.followers)} 追蹤</span>
                  </div>
                `).join("")}
              </div>
            </div>
  ...
  `,xa(e),e.querySelector("[data-blog-back-search]")?.addEventListener("click",()=>be()),e.querySelectorAll("[data-blog-url]").forEach(p=>{p.addEventListener("click",()=>St(p.dataset.blogUrl))}),e.querySelectorAll("[data-blog-author]").forEach(p=>{p.addEventListener("click",()=>Sn(p.dataset.blogAuthor))}),e.querySelectorAll("[data-blog-tag]").forEach(p=>{p.addEventListener("click",()=>{const u=p.dataset.blogTag,v=ee.find(h=>h.tags.includes(u)||h.topic===u);v&&St(v.url)})});const c=document.getElementById("view-search");c&&(c.scrollTop=0);const m=e.querySelector(".blog-body");m&&(m.scrollTop=0)}function Sn(e){const t=Be(e);if(!t)return;const a=document.getElementById("searchDetail"),i=document.getElementById("searchLayout");if(!a||!i)return;i.style.display="none",a.style.display="block",a.classList.add("open");const n=xs(e),s=n.reduce((o,c)=>o+c.views,0),r=n.reduce((o,c)=>o+c.likes,0);a.innerHTML=`
    <div class="blog-platform">
      ${wa("profile")}
      <div class="blog-body">
        <div class="blog-profile__head">
          ...
          <div class="blog-profile__info">
            ...
            <div class="blog-profile__stats">
              ...
              <span><b>${K(s)}</b> 總瀏覽</span>
              <span><b>${K(r)}</b> 收到喜歡</span>
              <span><b>${K(t.followers)}</b> 追蹤者</span>
                ...
                <div class="blog-row" data-blog-url="${g(o.url)}">
                  ...
                  <div class="blog-row__main">
                    ...
                    <div class="blog-row__meta">
                      ...
                      <span><i class="fa-solid fa-eye"></i> ${K(o.views)}</span>
                      <span><i class="fa-regular fa-heart"></i> ${K(o.likes)}</span>
              ...
              <div style="display:flex;flex-direction:column;gap:6px">
                ${n.slice(0,3).map((o,c)=>`
                  <div style="display:flex;gap:8px;align-items:center;padding:6px;border-radius:8px;background:${c===0?"var(--blog-accent-bg)":"transparent"};border:1px solid ${c===0?"#ffd8c2":"transparent"};cursor:pointer" data-blog-url="${g(o.url)}">
                    ...
                    <span style="font-size:11px;color:#9aa0a6">${K(o.views)}</span>
                  </div>
                `).join("")}
              </div>
            </div>
  ...
  `,xa(a),a.querySelector("[data-blog-back-search]")?.addEventListener("click",()=>be()),a.querySelectorAll("[data-blog-url]").forEach(o=>{o.addEventListener("click",()=>St(o.dataset.blogUrl))}),a.querySelector("[data-blog-home]")?.addEventListener("click",()=>kt()),a.querySelector("a[data-blog-home]")?.addEventListener("click",()=>kt());const d=document.getElementById("view-search");d&&(d.scrollTop=0)}function St(e){let t=Wt(e);if(!t){const m=rt.find(p=>p.url===e);m&&m.url.includes("sawyer-blog.example")&&(t=Wt(m.url))}if(!t)return;try{l.markArticleRead(t.url)}catch{}const a=Be(t.authorId),i=document.getElementById("searchDetail"),n=document.getElementById("searchLayout");if(!i||!n)return;n.style.display="none",i.style.display="block",i.classList.add("open");const s=document.getElementById("md5Tool");s&&(s.style.display="none",s.innerHTML="");const r=ks(t),d=ds[t.url]||[];t.cover&&t.cover.includes("sawyer_blog_pic"),i.innerHTML=`
    <div class="blog-platform">
      ${wa("article")}
      <div class="blog-body">
        <div class="blog-article__layout">
          <div class="blog-article__main">
            <div class="blog-article__card">
              <div class="blog-article__head">
                ...
                <div class="blog-article__meta">
                  ...
                  <div style="line-height:1.3">
                    ...
                    <div style="font-size:11px;color:#9aa0a6">${g(t.date)} · <i class="fa-solid fa-eye"></i> ${K(t.views)} 瀏覽 · <i class="fa-regular fa-heart"></i> ${K(t.likes)} 喜歡 · 閱讀約 ${Math.max(1,Math.ceil(t.content.length/400))} 分鐘</div>
                  </div>
                  <span class="dot"></span>
              ...
              <div class="blog-article__content">${_a(t.content,ba)}</div>
              <div class="blog-article__tags">
                ${t.tags.map(m=>`<span class="blog-article__tag"># ${g(m)}</span>`).join("")}
                <span class="blog-article__tag" style="background:var(--blog-accent-bg);border-color:#ffd8c2;color:#d45a1f"><i class="fa-solid fa-eye"></i> ${K(t.views)}</span>
              </div>
            </div>
          ...
          <aside class="blog-sidebar">
            <div class="blog-widget">
              ...
              <div style="margin-top:10px;display:flex;gap:14px;font-size:11px;color:#9aa0a6"><span><b style="color:#1f2328">${K(a.followers)}</b> 追蹤者</span><span><b style="color:#1f2328">${a.following}</b> 追蹤中</span><span style="margin-left:auto;cursor:pointer;color:var(--blog-accent);font-weight:700" data-blog-author="${g(a.id)}">前往主頁 →</span></div>
            </div>
            <div class="blog-widget">
                ...
                ${r.map((m,p)=>{const u=Be(m.authorId),v=m.authorId===t.authorId;return`
                  <div class="blog-rec" data-blog-url="${g(m.url)}">
                    ...
                    <div style="flex:1;min-width:0">
                      ...
                      <div class="blog-rec__meta"><span>${g(u.name)}</span><span>·</span><span><i class="fa-solid fa-eye"></i> ${K(m.views)}</span></div>
  ...
  `,xa(i),i.querySelector("[data-blog-back-home]")?.addEventListener("click",()=>kt()),i.querySelector("[data-blog-back-search]")?.addEventListener("click",()=>be()),i.querySelectorAll("[data-blog-author]").forEach(m=>{m.addEventListener("click",()=>Sn(m.dataset.blogAuthor))}),i.querySelectorAll("[data-blog-url]").forEach(m=>{m.addEventListener("click",()=>St(m.dataset.blogUrl))});const o=document.getElementById("view-search");o&&(o.scrollTop=0);const c=i.querySelector(".blog-body");c&&(c.scrollTop=0),i.scrollIntoView({behavior:"auto",block:"start"})}function En(e){return e==="https://school.example/guangzhi-essay-sawyer"||e.includes("school.example/guangzhi")}function Ss(e){return`
  ...
  `}function Es(e){e.querySelectorAll("[data-school-back-search]").forEach(t=>t.addEventListener("click",()=>be())),e.querySelectorAll("[data-school-home]").forEach(t=>t.addEventListener("click",()=>be()))}function Is(e){const t=e||rt.find(o=>o.url==="https://school.example/guangzhi-essay-sawyer")||it.find(o=>En(o.url));if(!t)return;try{l.markArticleRead(t.url)}catch{}const a=document.getElementById("searchDetail"),i=document.getElementById("searchLayout");if(!a||!i)return;i.style.display="none",a.style.display="block",a.classList.add("open");const n=document.getElementById("md5Tool");n&&(n.style.display="none",n.innerHTML="");const s=t.images||(t.image?[t.image]:[]);a.innerHTML=`
  ...
  `,a.querySelector("[data-so-back-search]")?.addEventListener("click",()=>be());const s=document.getElementById("view-search");s&&(s.scrollTop=0),a.scrollIntoView({behavior:"auto",block:"start"})}function Ls(e){const t=it[e];if(!t)return;if(t.isMD5Tool||t.url==="md5-tool"){ys(xt);return}const a=document.getElementById("md5Tool");if(a&&(a.style.display="none",a.innerHTML=""),us(t.url)){Cs(t.url);return}const i=t.url;if(ee.some(u=>u.url===i)||i.includes("sawyer-blog.example")||i.includes("mary-blog.example")||i.includes("peter-blog.example")||i.includes("paul-blog.example")||i.includes("emma-blog.example")||i.includes("david-blog.example")){let u=i;if(!Wt(u)){const v=ee.find(h=>h.title===t.title);v&&(u=v.url)}if(Wt(u)){St(u);return}}if(En(t.url)||t.title.includes("廣志中學")){Is(t);return}const n=document.getElementById("searchLayout"),s=document.getElementById("searchDetail");if(!n||!s)return;try{t.url&&(t.type==="news"||t.url.includes("news.example"))&&l.markArticleRead(t.url)}catch{}n.style.display="none",s.style.display="block",s.classList.add("open");let r="",d=null;if(t.url.startsWith("/customer-portal")||t.url.startsWith("file://")){d=t.url.replace("file://","");const u=k.getFile(d);u&&typeof u.content=="string"&&(r=u.content,k.readFile(d))}else if(k.exists(t.url)){d=t.url;const u=k.getFile(d);u&&typeof u.content=="string"&&(r=u.content)}if(!r&&t.title.startsWith("/customer-portal")){const u=k.getFile(t.title);u&&typeof u.content=="string"&&(r=u.content)}const o=r||t.snippet||"無內容",c=t.images?t.images.map(u=>`<div class="detail__image"><img src="${g(u)}" alt="preview" style="width:100%;display:block" onerror="this.src='https://via.placeholder.com/320x480?text=Sawyer+Writing'" /></div>`).join(""):t.image?`<div class="detail__image"><img src="${g(t.image)}" alt="preview" onerror="this.src='https://via.placeholder.com/320x180?text=Preview'" /></div>`:"";s.innerHTML=`
    ...
    <div class="detail__card">
      ...
      ${c}
      <div class="detail__snippet">${_a(o,ba)}</div>
      ${r?`<pre class="detail__pre">${g(r)}</pre>`:""}
      <div class="result__meta" style="margin-top:12px">
        <span class="result__tag">${t.type}</span>
      </div>
    </div>
  `,s.querySelector("#searchBackBtn")?.addEventListener("click",()=>be());const m=document.querySelector(".search");m&&(m.scrollTop=0);const p=document.getElementById("view-search");p&&(p.scrollTop=0),s.scrollIntoView({behavior:"auto",block:"start"})}var ut=0,ea=null,Ts=!1,Q="/darknet/全結構圖",pt="secret",Et=!1;function $s(){return k.buildDarkTree?k.buildDarkTree():k.buildTree()}function As(e){const t=$s();function a(n,s){if(n.path===s)return n;if(!n.children)return null;for(const r of n.children){const d=a(r,s);if(d)return d}return null}const i=a(t,e);return!i||!i.children?[]:i.children}function In(){document.getElementById("view-darknet")&&(Q==="/darknet"&&(Q="/darknet/全結構圖"),l.hasFlag("dark_entered"),Jt())}function za(){const e=document.getElementById("dock");e&&(e.style.display="none"),A(()=>Promise.resolve().then(()=>re).then(t=>{t.setDockVisible&&t.setDockVisible(!1)}),void 0).catch(()=>{})}function Ut(){const e=document.getElementById("dock");e&&(e.style.display=""),A(()=>Promise.resolve().then(()=>re).then(t=>{t.setDockVisible&&t.setDockVisible(!0)}),void 0).catch(()=>{})}function Jt(){const e=document.getElementById("view-darknet");if(e)if(pt==="secret"){const t=It,a=l.hasFlag("dark_secret_active");!t&&Et||a?za():Ut(),e.innerHTML=`
      <div class="darknet">
    ...
    `,Bs()}else{Q==="/darknet"&&(Q="/darknet/全結構圖");const t=l.hasFlag("dark_secret_active");!It&&Et||t?za():Ut();const a=As(Q),i=a.filter(s=>s.type==="dir"),n=a.filter(s=>s.type==="file");e.innerHTML=`
      <div class="darknet">
        <div style="height:40px;display:flex;align-items:center;justify-content:space-between;padding:0 12px;border-bottom:1px solid #1a0a0c;background:#0a0a0a;flex-shrink:0">
          <span class="small muted" style="color:#8b6a6e">機密文件庫 · ${g(Q)}</span>
    ...
    `,Ps(),Ms(i,n),Fs()}}function Bs(){const e=document.getElementById("darkTitle");document.getElementById("darkSearchInput");const t=document.getElementById("darkBackBtn");t&&t.addEventListener("click",()=>{Ut();try{l.setFlag("dark_secret_active",!1)}catch{}A(()=>Promise.resolve().then(()=>re).then(i=>{i.setActiveView&&(i.setActiveView("intranet"),localStorage.setItem("cc_active_view","intranet"))}),void 0),pt="secret",It=!1,Et=!1;const a=document.getElementById("view-darknet");a&&(a.innerHTML="")}),e&&(e.style.cursor="default",!It&&e.addEventListener("click",()=>{ut++,ea&&clearTimeout(ea),ea=setTimeout(()=>{ut=0},2e3),ut>=6&&(ut=0,js())}))}function js(){Ts=!0,pt="files",Q==="/darknet"&&(Q="/darknet/全結構圖"),l.setFlag("dark_entered",!0),l.setFlag("ch3_entered_secret",!0),l.setFlag("hidden_portal_accessed",!0),Jt(),l.setFlag("found_code_map",!0)}function Ps(){const e=document.getElementById("darkNav");e&&(e.innerHTML=[{path:"/darknet/全結構圖",label:"全結構圖",icon:"🗺️"},{path:"/darknet/交易列表",label:"交易列表",icon:"📋"},{path:"/darknet/合作公司列表",label:"合作公司",icon:"🏢"},{path:"/darknet/流量",label:"流量",icon:"📦"},{path:"/darknet/月結單",label:"月結單",icon:"💰"},{path:"/darknet/Sawyer支出",label:"Sawyer支出",icon:"💸"},{path:"/darknet/出差紀錄",label:"出差紀錄",icon:"✈️"},{path:"/darknet/會議紀錄",label:"會議記錄",icon:"📝"}].map(t=>`<div class="darknet__nav-item ${Q===t.path||Q.startsWith(t.path+"/")?"active":""}" data-path="${t.path}"><span>${t.icon}</span><span>${t.label}</span></div>`).join(""),e.querySelectorAll(".darknet__nav-item").forEach(t=>t.addEventListener("click",()=>{Q=t.dataset.path,Jt()})))}function Ms(e,t){const a=document.getElementById("darkMain");if(a){if(!e.length&&!t.length){const i=k.getDarkFile?k.getDarkFile(Q):null;if(i&&i.content){a.innerHTML=`<pre style="white-space:pre-wrap;word-break:break-word;font-family:var(--font-mono);font-size:13px;color:#e9edef">${g(i.content.slice(0,8e3))}</pre>`,l.discoverFile(Q),ka();return}a.innerHTML='<div style="padding:24px;text-align:center;color:#5a3a3e">此資料夾為空</div>';return}a.innerHTML=`
    <div style="font-size:11px;font-weight:700;letter-spacing:.6px;color:#5a3a3e;margin-bottom:8px">${g(Q)} — ${e.length} 資料夾，${t.length} 檔案</div>
  ...
  `,a.querySelectorAll(".darknet__file-row").forEach(i=>{i.addEventListener("click",()=>{const n=i.dataset.path;i.dataset.type==="dir"?(Q=n,Jt()):Ds(n)})})}}function Ds(e){const t=k.getDarkFile?k.getDarkFile(e):k.getFile(e);if(!t)return;const a=document.getElementById("darkPreview"),i=document.getElementById("darkPreviewName"),n=document.getElementById("darkPreviewContent");if(!a||!i||!n)return;i.textContent=e;let s=t.content||"";if(e.toLowerCase().endsWith(".csv")){const r=s.split(`
`).filter(u=>u.trim()!==""),d=u=>{const v=[];let h="",b=!1;for(let $=0;$<u.length;$++){const j=u[$];j==='"'?b&&u[$+1]==='"'?(h+='"',$++):b=!b:j===","&&!b?(v.push(h),h=""):h+=j}return v.push(h),v},o=d(r[0]||""),c=r.slice(1).map(d),m=`<thead><tr>${o.map(u=>`<th style="padding:8px 10px;border:1px solid #722F37;background:#1a0a0c;color:#a67c81;text-align:left">${g(u)}</th>`).join("")}</tr></thead>`,p=`<tbody>${c.map(u=>`<tr>${u.map(v=>`<td style="padding:7px 10px;border:1px solid #1a0a0c;color:#e9edef">${g(v)}</td>`).join("")}</tr>`).join("")}</tbody>`;n.innerHTML=`<div style="padding:8px 12px;border-bottom:1px solid #1a0a0c;background:#1a0a0c;display:flex;justify-content:space-between"><span class="small muted" style="color:#8b6a6e">${g(e)} — 表格檢視</span><span class="small muted" style="color:#8b6a6e">${c.length} 列</span></div><div style="overflow:auto;max-height:60vh"><table style="width:100%;border-collapse:collapse;font-size:13px">${m}${p}</table></div>`,n.style.whiteSpace="normal"}else s.length>12e3&&(s=s.slice(0,12e3)+`
...`),n.textContent=s,n.style.whiteSpace="pre-wrap";a.style.display="flex",l.discoverFile(e),l.setFlag("dark_opened:"+e,!0),ka()}function Fs(){document.getElementById("darkExitBtn")?.addEventListener("click",()=>{pt="secret",Et=!1;try{l.setFlag("dark_secret_active",!1)}catch{}Ut(),ka(!0),A(()=>Promise.resolve().then(()=>re).then(t=>{t.setActiveView&&(t.setActiveView("intranet"),localStorage.setItem("cc_active_view","intranet"))}),void 0);const e=document.getElementById("view-darknet");e&&(e.innerHTML=""),l.hasFlag("ch4_all_opened")&&setTimeout(()=>{window.dispatchEvent(new CustomEvent("darknet:exit"))},300)}),document.getElementById("darkPreviewClose")?.addEventListener("click",()=>{const e=document.getElementById("darkPreview");e&&(e.style.display="none")}),document.getElementById("darkPreview")?.addEventListener("click",e=>{e.target.id==="darkPreview"&&(e.target.style.display="none")})}function ka(e=!1){const t=k.listDarkFiles?k.listDarkFiles("/darknet"):[];if(!t.length)return;const a=t.filter(i=>l.hasFlag("dark_opened:"+i.path)||l.hasFlag("discovered:"+i.path)||l.get("discoveredFiles")?.includes(i.path));a.length>=t.length?(l.hasFlag("ch4_all_opened")||l.setFlag("ch4_all_opened",!0),e&&!l.hasFlag("ch5_triggered")&&(l.setFlag("ch5_triggered",!0),window.dispatchEvent(new CustomEvent("ch4:complete")),setTimeout(()=>{const i=document.getElementById("mailDialog");if(i&&!i.open)try{i.showModal()}catch{i.style.display="block",i.setAttribute("open","")}},500))):e&&a.length>=t.length,a.length>=t.length&&!l.hasFlag("ch4_all_opened")&&l.setFlag("ch4_all_opened",!0)}var It=!1;function ta(e={}){if(!(l.hasFlag("ch1_0043_committed")&&!l.hasFlag("ch1_revert_done"))&&document.getElementById("view-darknet")){if(It=!!e.simple,Et=!0,e.simple)try{l.setFlag("dark_secret_active",!1)}catch{}else try{l.setFlag("dark_secret_active",!0)}catch{}pt="secret",ut=0,A(()=>Promise.resolve().then(()=>re).then(t=>{t.setActiveView&&(t.setActiveView("darknet"),localStorage.setItem("cc_active_view","darknet"))}),void 0),In()}}var te="/intranet",We="",Wa="/intranet/client_info";function Ct(e){return e===Wa||e.startsWith(Wa+"/")}function Ua(e){const t=k.buildTree();function a(n,s){if(n.path===s)return n;if(!n.children)return null;for(const r of n.children){const d=a(r,s);if(d)return d}return null}const i=a(t,e);return!i||!i.children?[]:i.children}function Ns(){const e=document.getElementById("view-intranet");e&&(e.innerHTML=`
    <div class="intranet">
  ...
  `,Os(),Cn())}function Os(){const e=k.internalPathDomain||"https://nori-intranet/internal/portal?",t=k.getLegacyRoute&&k.getLegacyRoute("nori-portal-2023")?._hash||"f665a7117959b667b7f283eaebf69cae",a=e+"hash="+t,i="https://nori-intranet/internal/portal";function n(r){if(!r)return!1;const d=r.trim();return!!(d===a||d.startsWith("https://nori-intranet/internal/portal?hash="+t))}function s(){const r=document.getElementById("intraSearch"),d=r?r.value.trim():"",o=d===i||d===i+"/"||d.includes("nori-intranet/internal/portal")&&!d.includes("hash="),c=n(d);if(l.hasFlag("ch1_0043_committed")&&!l.hasFlag("ch1_revert_done")&&(o||c)){We=d.toLowerCase(),la();return}if(o){l.setFlag("portal_simple_entered",!0),ta({simple:!0});return}if(c){l.setFlag("portal_hash_entered",!0);const m=d.match(/hash=([a-f0-9]{32})/i),p=m?m[1]:t;if(k.tryAccessPortal&&k.tryAccessPortal({hash:p})){ta({simple:!1});return}else if(d===a){ta({simple:!1});return}}We=d.toLowerCase(),la()}document.getElementById("intraSearchBtn")?.addEventListener("click",s),document.getElementById("intraSearch")?.addEventListener("keydown",r=>{r.key==="Enter"&&(r.preventDefault(),s())}),document.getElementById("intraPreviewClose")?.addEventListener("click",ia),document.getElementById("intraPreview")?.addEventListener("click",r=>{r.target.id==="intraPreview"&&ia()}),document.addEventListener("keydown",r=>{r.key==="Escape"&&ia()})}function Cn(){Hs(),Vs(),la();const e=k.listFiles("/intranet").length,t=document.getElementById("intraCount");t&&(t.textContent=`內網共 ${e} 個檔案`)}function Hs(){const e=document.getElementById("intraBreadcrumb");if(!e)return;const t=te.split("/").filter(Boolean);let a='<span class="intra-bc__item" data-path="/intranet">🏠 內網首頁</span>',i="/intranet";const n=t[0]==="intranet"?1:0;t.slice(n).forEach(s=>{i+="/"+s;const r=Ct(i);a+=` <span class="muted">›</span> <span class="intra-bc__item ${i===te?"active":""} ${r?"locked":""}" data-path="${g(i)}">${g(s)}${r?" 🔒":""}</span>`}),te==="/intranet"&&(a='<span class="intra-bc__item active" data-path="/intranet">🏠 內網首頁</span>'),e.innerHTML=a,e.querySelectorAll(".intra-bc__item").forEach(s=>{s.addEventListener("click",()=>Yt(s.dataset.path))})}function Vs(){const e=document.getElementById("intraNav");e&&(e.innerHTML=[{path:"/intranet",label:"內網首頁",icon:"🏠",desc:"總覽"},{path:"/intranet/company_public",label:"公司公開資訊",icon:"🏢",desc:"名稱・Logo・大樓名錄"},{path:"/intranet/client_info",label:"客戶資料",icon:"🔒",desc:"權限管制（鎖定）",locked:!0},{path:"/intranet/business_plans",label:"業務計畫",icon:"📊",desc:"完整流程結構"},{path:"/intranet/staff",label:"員工資料",icon:"👥",desc:"50 人名錄"}].map(t=>`<div class="intra-nav__item ${te===t.path||t.path!=="/"&&te.startsWith(t.path+"/")?"active":""} ${t.locked?"locked":""}" data-path="${t.path}" title="${t.path}">
  ...
  `,e.querySelectorAll(".intra-nav__item").forEach(t=>{t.addEventListener("click",()=>Yt(t.dataset.path))}))}function la(){const e=document.getElementById("intraMain");if(!e)return;if(We){const n=k.searchContent(We).filter(o=>o.path.startsWith("/intranet")).slice(0,40),s=k.listFiles("/intranet").filter(o=>o.path.toLowerCase().includes(We)).slice(0,40),r=new Map;n.forEach(o=>r.set(o.path,o)),s.forEach(o=>{r.has(o.path)||r.set(o.path,{path:o.path,snippet:""})});const d=[...r.values()];if(!d.length){e.innerHTML='<div class="intra-empty">無搜尋結果 — 試試「Nori」「冰釀茶酒」「業務流程」「Sawyer」</div>';return}e.innerHTML=`
      <div class="intra-section__title">搜尋結果「${g(We)}」— ${d.length} 筆</div>
      <div class="intra-file__list">
        ${d.map(o=>{const c=k.getFile(o.path)?.meta?.locked||Ct(o.path);return`<div class="intra-file__row ${c?"locked":""}" data-path="${g(o.path)}" title="${g(o.path)}">
            <span class="intra-file__icon">${c?"🔒":ca(o.path)}</span>
    ...
    `,na(e);return}if(Ct(te)){e.innerHTML=`
      <div class="intra-locked">
        ...
        <div class="intra-locked__files">
          ...
          ${Ua(te).map(n=>`<div class="intra-file__row locked" title="${g(n.path)}"><span>${ca(n.path)}</span><span>${g(n.name)}</span><span class="small muted" style="margin-left:auto">🔒 鎖定</span></div>`).join("")}
        </div>
        <button class="btn" style="margin-top:12px" onclick="document.querySelector('[data-path='/intranet']')?.click()">返回內網首頁</button>
      </div>
    `;return}const t=Ua(te),a=t.filter(n=>n.type==="dir"),i=t.filter(n=>n.type==="file");if(te==="/intranet"&&!We){e.innerHTML=`
    ...
    `,e.querySelectorAll("[data-path]").forEach(n=>n.addEventListener("click",s=>{s.stopPropagation();const r=n.getAttribute("data-path");r&&Yt(r)})),na(e);return}if(!t.length){const n=k.getFile(te);if(n&&n.content!=null){e.innerHTML=`<div class="intra-section__title">${g(te)}</div><pre class="intra-file__preview mono">${g(n.content.slice(0,8e3))}</pre>`;return}e.innerHTML='<div class="intra-empty">此資料夾為空</div>';return}e.innerHTML=`
    <div class="intra-section__title">${g(te)} — ${a.length} 個資料夾，${i.length} 個檔案</div>
    ${a.length?`<div class="intra-file__list"><div class="small muted" style="padding:4px 8px">資料夾</div>${a.map(n=>aa(n)).join("")}</div>`:""}
    ${i.length?`<div class="intra-file__list"><div class="small muted" style="padding:4px 8px">檔案</div>${i.map(n=>aa(n)).join("")}</div>`:""}
  `,na(e)}function aa(e){const t=e.path&&Ct(e.path),a=(e.path?k.getFile(e.path):null)?.meta?.locked||t,i=a?"🔒":e.type==="dir"?"📁":ca(e.path||e.name);return`<div class="intra-file__row ${e.type==="dir"?"is-dir":""} ${a?"locked":""}" data-path="${g(e.path)}" data-type="${e.type}" title="${g(e.path)}">
  ...
  </div>`}function ca(e){return e?e.endsWith(".md")?"📝":e.endsWith(".csv")?"📊":e.endsWith(".svg")?"🖼️":e.endsWith(".json")?"🧩":e.endsWith(".js")||e.endsWith(".java")?"💻":e.endsWith(".html")?"🌐":e.endsWith(".pdf")?"📕":"📄":"📄"}function na(e){e.querySelectorAll(".intra-file__row").forEach(t=>{t.addEventListener("click",()=>{const a=t.dataset.path,i=t.dataset.type;if(t.classList.contains("locked")){if(document.getElementById("intraMain")){const n=document.createElement("div");n.className="toast",n.style.cssText="position:fixed;right:12px;bottom:64px;background:#323232;color:#fff;padding:10px 12px;border-radius:8px;z-index:999",n.textContent="🔒 權限不足 — 客戶資料受保護，遊戲內無需存取",document.body.appendChild(n),setTimeout(()=>n.remove(),2200)}return}i==="dir"?Yt(a):qs(a)})})}function Yt(e){e&&(te=e,Cn())}function Rs(e){const t=e.split(`
`).filter(i=>i.trim()!=="");if(!t.length)return{header:[],rows:[]};const a=i=>{const n=[];let s="",r=!1;for(let d=0;d<i.length;d++){const o=i[d];o==='"'?r&&i[d+1]==='"'?(s+='"',d++):r=!r:o===","&&!r?(n.push(s),s=""):s+=o}return n.push(s),n};return{header:a(t[0]),rows:t.slice(1).map(a)}}function qs(e){const t=k.getFile(e);if(!t||t.meta?.locked||Ct(e))return;const a=document.getElementById("intraPreview"),i=document.getElementById("intraPreviewName"),n=document.getElementById("intraPreviewContent");if(!a||!i||!n)return;i.textContent=e;let s=t.content||"";if(e.toLowerCase().endsWith(".csv")){const{header:r,rows:d}=Rs(s),o=`<thead><tr>${r.map(m=>`<th>${g(m)}</th>`).join("")}</tr></thead>`,c=`<tbody>${d.map(m=>`<tr>${m.map(p=>`<td>${g(p)}</td>`).join("")}</tr>`).join("")}</tbody>`;n.innerHTML=`
...
...（內容已截斷，完整請於 Vizual Studio Code 開啟）`),n.textContent=s,n.style.whiteSpace="pre-wrap";a.style.display="flex"}function ia(){const e=document.getElementById("intraPreview");e&&(e.style.display="none")}function Ga(){const e=l.get("settings.theme")||"dark";document.documentElement.setAttribute("data-theme",e)}function Ln(){return!!document.fullscreenElement}function Tn(){Ln()?document.exitFullscreen().catch(()=>{}):document.documentElement.requestFullscreen().catch(()=>{})}function st(e){e&&(e.textContent=Ln()?"關閉全螢幕":"開啟全螢幕")}function zs(){document.querySelectorAll("dialog[open]").forEach(n=>{try{n.close()}catch{}});const e=document.getElementById("startMenu");e&&(e.style.display="none");const t=document.getElementById("intraPreview");t&&(t.style.display="none");const a=document.getElementById("darkPreview");a&&(a.style.display="none");const i=document.getElementById("waLightbox");i&&i.classList.remove("open"),document.querySelectorAll("dialog").forEach(n=>{n.open||n.style.removeProperty("display")})}function Se(e){zs(),tn(e),localStorage.setItem("cc_active_view",e)}function Ws(){Ii(),ma(),fn(),bs(),Ns(),In(),Js(),Ys(),Ks()}var $n=null;function Us(e){try{const t=JSON.parse(localStorage.getItem("code_conspiracy_state")||"{}").whatsappChats;if(Array.isArray(t)){const a=t.find(i=>i.id===e);if(a)return!!a.muted}return!1}catch{return!1}}function Gs(){try{const t=JSON.parse(localStorage.getItem("code_conspiracy_state")||"{}");if(t.flags&&t.flags.ch0_maggie_notified||t.flags&&t.flags.ch0_vip_fixed||t.currentChapter&&t.currentChapter!==0)return}catch{}if(l.hasFlag("ch0_maggie_notified")||l.hasFlag("ch0_vip_fixed")||(l.get("currentChapter")??0)!==0||Us("maggie")||document.getElementById("wa-win-notification"))return;const e=document.createElement("div");e.id="wa-win-notification",e.setAttribute("role","alert"),e.setAttribute("aria-live","polite"),e.innerHTML=`
    <div class="win-notif__app">
      <img src="/arg-game-it-company-secret/icon/whatsup.svg" alt="WhatUp" width="20" height="20" style="width:20px;height:20px;object-fit:contain" />
      <span class="win-notif__app-name">WhatUp</span>
      <span class="win-notif__app-sub">主管 - Maggie</span>
    ...
    <div class="win-notif__progress"></div>
  `,e.addEventListener("click",t=>{if(!t.target.closest(".win-notif__close")){sa();try{Xe("maggie")}catch{}Se("whatsapp")}}),e.querySelector(".win-notif__close")?.addEventListener("click",t=>{t.stopPropagation(),sa()}),document.body.appendChild(e),l.setFlag("ch0_maggie_notified",!0),requestAnimationFrame(()=>e.classList.add("show")),$n=setTimeout(()=>sa(),1e4)}function sa(){const e=document.getElementById("wa-win-notification");e&&(clearTimeout($n),e.classList.remove("show"),e.classList.add("hide"),setTimeout(()=>e.remove(),280))}function An(e){e==="jira_viewed"&&l.setFlag("onb_jira_viewed",!0),e==="vscode_viewed"&&l.setFlag("onb_vscode_viewed",!0),l.hasFlag("onboarding_done")||l.setFlag("onboarding_done",!0)}function Js(){const e=document.getElementById("mailDialog"),t=document.getElementById("mailTitle"),a=document.getElementById("mailTo"),i=document.getElementById("mailSend"),n=document.getElementById("mailTempExit");function s(){if(!t||!a)return;const r=t.value;r==="Report"?a.value="Drug Enforcement Administration <dea@email.us>":(r==="Coperation"||r==="Resign")&&(a.value="Sawyer <sawyer@nori.com>")}t?.addEventListener("change",s),s(),n?.addEventListener("click",()=>{e?.close(),$e({onSwitch:Se,onOpenSettings:qe,onOpenNotebook:ze,t:he})}),i?.addEventListener("click",()=>{const r=t?.value,d=document.getElementById("mailBody")?.value||"",o=document.getElementById("mailTo")?.value||"";try{Qi({title:r,to:o,body:d})}catch{}let c=null;if(r==="Report"?c="report":r==="Coperation"?c="cooperate":r==="Resign"&&(c="resign"),c){const m=l.get("endings")||[];m.includes(c)||(m.push(c),l.set("endings",m),l.setFlag("ending_"+c,!0));try{vn(c)}catch{}}else try{ne("email_submit_no_ending",{email_title:r,email_body_preview:d.slice(0,80)})}catch{}e?.close(),$e({onSwitch:Se,onOpenSettings:qe,onOpenNotebook:ze,t:he}),c?setTimeout(()=>Bn(c),300):X("郵件已寄送: "+r)})}function Ys(){const e=document.getElementById("startMenu");e&&document.addEventListener("click",t=>{const a=t.target.closest&&t.target.closest(".taskbar__start"),i=t.target.closest&&t.target.closest("#startShutdown"),n=t.target.closest&&t.target.closest("#startLogout");if(a){t.stopPropagation();const s=e.style.display==="none"||!e.style.display||e.style.display==="";e.style.display=s?"block":"none";return}if(i){t.stopPropagation(),e.style.display="none",Ja("shutdown");return}if(n){t.stopPropagation(),e.style.display="none",Ja("logout");return}e.contains(t.target)||(e.style.display="none")})}function Ja(e){const t=l.get("endings")||[],a=l.hasFlag("ch4_all_opened"),i=t[0];let n=null;!i&&!a?n="flee":!i&&a?n="fried":i==="report"?n="report":i==="cooperate"?n="cooperate":i==="resign"?n="resign":n="flee";const s=l.get("endings")||[];s.includes(n)||(s.push(n),l.set("endings",s));try{vn(n),ne("shutdown",{action:e,ending:n})}catch{}Bn(n)}function Bn(e){const t=document.getElementById("endingScreen"),a=document.getElementById("endingTitle"),i=document.getElementById("endingDesc"),n=document.getElementById("endingRestart");if(!t||!a||!i)return;const s={flee:"flee",cooperate:"cooperate",report:"report",resign:"resign",fried:"fried"}[e];s&&ie.play(s);const r={flee:{title:"平凡的日常",desc:`你已完成了工作，登出了電腦，走出辨公室，回到家中安心睡一覺。
...
`||v.includes(`
`))&&(h+=200),/^\s+$/.test(v)&&(h=100),e==="fried"&&(v==="其"||v==="實"||p.includes("其實"))&&(h=420),setTimeout(u,h)}u()},500)}function Ks(){document.getElementById("endingRestart")?.addEventListener("click",async()=>{ie.stop(!1);let e=null;try{e=JSON.parse(JSON.stringify(l.get("persistentStats")||{}))}catch{}try{l.reset()}catch{}try{if(e){const a=l.get("persistentStats")||{},i={unlockedEndings:[...new Set([...a.unlockedEndings||[],...e.unlockedEndings||[]])],readArticles:[...new Set([...a.readArticles||[],...e.readArticles||[]])],darkFileCount:Math.max(a.darkFileCount||0,e.darkFileCount||0),whatsappSentCount:Math.max(a.whatsappSentCount||0,e.whatsappSentCount||0),searchHistoryCount:Math.max(a.searchHistoryCount||0,e.searchHistoryCount||0),flags:{...a.flags||{},...e.flags||{}}};l.set("persistentStats",i),l.set("unlockedEndings",i.unlockedEndings)}}catch{}const t=document.getElementById("endingScreen");t&&(t.style.display="none"),document.querySelectorAll("dialog[open]").forEach(a=>{try{a.close()}catch{}a.style.display="none"});try{if("caches"in window){const a=await caches.keys();await Promise.all(a.map(i=>caches.delete(i)))}if("serviceWorker"in navigator){const a=await navigator.serviceWorker.getRegistrations();await Promise.all(a.map(i=>i.unregister()))}}catch{}setTimeout(()=>{window.location.href=window.location.pathname+"?reset="+Date.now(),window.location.reload(!0)},150)}),document.getElementById("endingClose")?.addEventListener("click",()=>{document.getElementById("endingScreen").style.display="none"})}function Qs(){const e=document.getElementById("welcomeDialog");if(!e)return;const t=document.getElementById("welcomeFullscreenBtn"),a=document.getElementById("welcomeMuteBtn"),i=document.getElementById("welcomeVolumeSlider"),n=document.getElementById("welcomeVolumePct"),s=document.getElementById("welcomeStartBtn");st(t),t?.addEventListener("click",()=>{Tn(),st(t)}),document.addEventListener("fullscreenchange",()=>{st(t),st(document.getElementById("settingFullscreenBtn"))}),a&&a.addEventListener("click",()=>{const r=ie.toggleMute();a.textContent=r?"🔇":"🔊",n&&(n.textContent=r?"靜音":Math.round(ie.getVolume()*100)+"%")}),i&&i.addEventListener("input",r=>{const d=parseInt(r.target.value)/100;ie.setVolume(d),ie.setMuted(!1),a&&(a.textContent="🔊"),n&&(n.textContent=Math.round(d*100)+"%")}),s?.addEventListener("click",()=>{e.close()}),typeof e.showModal=="function"?e.showModal():e.show()}function Xs(){const e=document.getElementById("settingFullscreenBtn");e&&(st(e),e.addEventListener("click",()=>{Tn(),st(e)}))}function Zs(){const e=document.getElementById("analyticsBanner"),t=document.getElementById("analyticsAccept"),a=document.getElementById("analyticsDecline"),i=document.getElementById("analyticsConsentToggle"),n=document.getElementById("analyticsGasUrl"),s=document.getElementById("analyticsSaveBtn"),r=document.getElementById("analyticsTestBtn"),d=document.getElementById("analyticsFlushBtn"),o=document.getElementById("analyticsStatus"),c=document.getElementById("analyticsQueueCount"),m=document.getElementById("analyticsSessionId");try{e&&!Yi()&&(e.style.display="flex")}catch{}const p=()=>{try{const u=JSON.parse(localStorage.getItem("cc_analytics_queue")||"[]");c&&(c.textContent=String(u.length)),m&&(m.textContent=gn().slice(0,8)),o&&(lt()?Ye()?o.textContent="就緒":o.textContent="已設定，等待同意":o.textContent="尚未設定 GAS URL"),i&&(i.checked=Ye()),n&&(n.value=_t().includes("REPLACE")?"":_t())}catch{}};p(),t?.addEventListener("click",()=>{Ht(!0),e&&(e.style.display="none"),p(),X("已啟用匿名數據收集"),Ke()}),a?.addEventListener("click",()=>{Ht(!1),e&&(e.style.display="none"),p(),X("已拒絕數據收集")}),i?.addEventListener("change",u=>{Ht(u.target.checked),p(),X(u.target.checked?"已啟用":"已停用")}),s?.addEventListener("click",()=>{const u=n?.value.trim()||"";if(u&&!u.startsWith("https://script.google.com/")){o&&(o.textContent="URL 需為 https://script.google.com/.../exec");return}un(u),p(),X("已儲存 GAS URL")}),r?.addEventListener("click",()=>{if(!lt()){X("請先設定 GAS URL");return}if(!Ye()){X("請先同意收集");return}ne("test_ping",{payload_json:JSON.stringify({test:!0})}),setTimeout(()=>{p(),X("已發送測試，查看 Sheets")},600)}),d?.addEventListener("click",()=>{Ke(),p(),X("已嘗試補送"),setTimeout(p,800)}),setInterval(p,2e3);try{window.__analyticsRefresh=p}catch{}}function Ya(){Ga(),$e({onSwitch:Se,onOpenSettings:qe,onOpenNotebook:ze,t:he}),di(),Xs();try{Zi()}catch{}Zs(),Ws();const e=localStorage.getItem("cc_active_view")||"vscode";Se(l.get("unlockedInterfaces").includes(e)?e:"vscode"),ei(),ie.play("default"),l.hasFlag("onboarding_done")||l.setFlag("onboarding_done",!0),l.hasFlag("welcome_dialog_shown")||(l.setFlag("welcome_dialog_shown",!0),setTimeout(()=>Qs(),400)),setTimeout(()=>Gs(),800),W.on("puzzle:solved",t=>{X("✓ "+t.title);try{ne("puzzle_solved",{puzzle:t.id,chapter:t.chapter})}catch{}}),W.on("interfaceUnlocked",t=>{X(he("toast.unlocked")+": "+t),$e({onSwitch:Se,onOpenSettings:qe,onOpenNotebook:ze,t:he});try{ne("interface_unlocked",{iface:t})}catch{}}),W.on("evidence",t=>{X(he("toast.evidence")+": "+t.title);try{ne("evidence_collected",{evidence:t.id})}catch{}}),l.on("change",()=>Ga()),window.addEventListener("ch4:complete",()=>{l.setFlag("ch5_triggered",!0),$e({onSwitch:Se,onOpenSettings:qe,onOpenNotebook:ze,t:he}),setTimeout(()=>{const t=document.getElementById("mailDialog");if(t&&!t.open){const a=document.getElementById("mailTitle"),i=document.getElementById("mailTo");if(a&&i){const n=a.value;n==="Report"?i.value="DEA <dea@world.example>":(n==="Coperation"||n==="Resign")&&(i.value="Sawyer <sawyer@nori-drinks.example>")}t.showModal()}},600)}),window.addEventListener("darknet:exit",()=>{ie.play("default"),l.hasFlag("ch4_all_opened")&&!l.hasFlag("ch5_triggered")?(l.setFlag("ch5_triggered",!0),$e({onSwitch:Se,onOpenSettings:qe,onOpenNotebook:ze,t:he}),setTimeout(()=>{const t=document.getElementById("mailDialog");t&&!t.open&&t.showModal()},400)):l.hasFlag("ch5_triggered")&&((l.get("endings")||[]).length||setTimeout(()=>{const t=document.getElementById("mailDialog");t&&!t.open&&t.showModal()},400))}),l.on("change",t=>{if(t&&t.path&&t.path.includes("ch5_triggered")&&$e({onSwitch:Se,onOpenSettings:qe,onOpenNotebook:ze,t:he}),t&&t.path&&t.path.includes("dark_entered")&&ie.play("darknet"),t&&t.path&&t.path.includes("ch0_vip_fixed")&&!l.hasFlag("ch1_event1_triggered")&&(l.setFlag("ch1_event1_triggered",!0),setTimeout(()=>{A(()=>Promise.resolve().then(()=>ce).then(a=>{a.triggerCh1Event1&&a.triggerCh1Event1()}),void 0)},1e4)),t&&t.path==="currentChapter"&&t.value===2&&!l.hasFlag("ch2_lunch_seq_done")&&setTimeout(()=>{A(()=>Promise.resolve().then(()=>ce).then(a=>{a.triggerCh2LunchSequence&&a.triggerCh2LunchSequence()}),void 0)},600),t&&t.path==="currentChapter")try{Xi(t.value),ne("chapter_progress",{chapter:t.value})}catch{}if(t&&t.path&&t.path.includes("ch4_all_opened")&&t.value)try{ne("ch4_all_opened",{chapter:4})}catch{}}),l.hasFlag("ch0_vip_fixed")&&!l.hasFlag("ch1_event1_triggered")&&(l.setFlag("ch1_event1_triggered",!0),setTimeout(()=>{A(()=>Promise.resolve().then(()=>ce).then(t=>{t.triggerCh1Event1&&t.triggerCh1Event1()}),void 0)},1e4)),l.get("currentChapter")===2&&!l.hasFlag("ch2_lunch_seq_done")&&setTimeout(()=>{A(()=>Promise.resolve().then(()=>ce).then(t=>{t.triggerCh2LunchSequence&&t.triggerCh2LunchSequence()}),void 0)},900),W.on("chapter:changed",t=>{t===2&&!l.hasFlag("ch2_lunch_seq_done")&&setTimeout(()=>{A(()=>Promise.resolve().then(()=>ce).then(a=>{a.triggerCh2LunchSequence&&a.triggerCh2LunchSequence()}),void 0)},600)}),window.addEventListener("jira:ticketAdded",()=>{document.getElementById("jiraBoard")&&A(()=>Promise.resolve().then(()=>mt).then(t=>{W.emit("jira:refresh")}),void 0)}),window.addEventListener("jira:refresh",()=>{try{ma()}catch{}}),document.querySelectorAll("dialog").forEach(t=>{t.addEventListener("click",a=>{a.target===t&&t.close()}),t.addEventListener("cancel",a=>{a.preventDefault(),t.close()}),t.addEventListener("close",()=>{t.style.removeProperty("display")})})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ya):Ya();

//# sourceMappingURL=main-DLTZayE4.js.map