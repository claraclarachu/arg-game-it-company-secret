...
`,meta:{portal:!0}}),x("/internal/portal/export",{hidden:!1,content:"SQLite export endpoint - 需要 portalAuth 通過 (Nori 訂單匯出)",meta:{portal:!0}})}function vs(){ue("/darknet/全結構圖/drug-route-graph.md",{content:`# 全結構圖
...
- alchol 對應 LEAF
- 玻璃瓶 對應 CRYSTAL
- 紙箱 通用`,meta:{lang:"markdown"}}),ue("/darknet/交易列表/drug-transactions.csv",{content:`datetime,location,client_company,traffic_used,drug_code,quantity,status
...
`,meta:{lang:"csv"}}),ue("/darknet/合作公司列表/companies.md",{content:`# 合作公司列表及聯絡方式
...
| FredyArc | 海外組織 | Fredy | +1 415-555-0100 | 毒品來源 |`,meta:{lang:"markdown"}}),ue("/darknet/流量/drug-traffic.csv",{content:`datetime,location,client_company,traffic_used,drug_code,quantity,status
...
`,meta:{lang:"csv"}}),ue("/darknet/月結單/monthly-2023-12.csv",{content:`month,from,to,amount,type,note
2023-12,FredyArc,Nori,125000,收入,合作資金
2023-12,FredyArc,Nori,85000,收入,企業合作
2023-12,Nori,Anonymous,320,支出,小額
`,meta:{lang:"csv"}}),ue("/darknet/月結單/monthly-2024-01.csv",{content:`month,from,to,amount,type,note
2024-01,FredyArc,Nori,320000,收入,季度分潤
2024-01,Nori,Anonymous,750,支出,
`,meta:{lang:"csv"}}),ue("/darknet/月結單/monthly-2024-02.csv",{content:`month,from,to,amount,type,note
2024-02,FredyArc,Nori,450000,收入,
2024-02,FredyArc,Nori,120000,收入,
2024-02,Nori,Anonymous,420,支出,
`,meta:{lang:"csv"}}),ue("/darknet/Sawyer支出/sawyer_expenses.csv",{content:`日期,項目,金額(HKD),備註
...
`,meta:{lang:"csv"}}),ue("/darknet/出差紀錄/travel_records.csv",{content:`日期,目的地,行程目的,天數,同行人員
...
`,meta:{lang:"csv"}}),ue("/darknet/會議紀錄/meeting_minutes.md",{content:`# Nori × FredyArc 定期會議紀錄
...
`,meta:{lang:"markdown"}})}vs();gs();var S={registerFile:x,getFile:dn,listFiles:rs,buildTree:os,readFile:ls,exists:cs,searchContent:ds,canAccessPortal:us,tryAccessPortal:ms,bypassPortalAuth:hs,registerDarkFile:ue,getDarkFile:cn,listDarkFiles:ns,buildDarkTree:ss,readDarkFile:is,registerLegacyRoute:ln,getLegacyRoute:es,listLegacyRoutes:ts,findLegacyRoute:as,internalPathDomain:on},fs=[{id:"ch0_vip_fix",chapter:0,check:()=>l.hasFlag("ch0_vip_fixed"),reward:{},title:"修正 VIP 折扣計算 (INV-2024-0042)"},{id:"ch1_system_alert",chapter:1,check:()=>l.hasFlag("ch1_system_down"),reward:{evidence:{id:"e001",title:"INV-2024-0043 系統警報",chapter:1,type:"anomaly"}},title:"觸發系統警報 (INV-2024-0043)"},{id:"ch1_feng_shui_tree",chapter:1,check:()=>l.hasFlag("ch1_tree_seen"),reward:{evidence:{id:"e002",title:"老闆的風水樹",chapter:1,type:"behavior"}},title:"發現老闆的風水樹"},{id:"ch2_accident_news",chapter:2,check:()=>l.get("searchHistory")?.some(e=>e.includes("Sawyer")||e.includes("Choi")||e.includes("車禍")),reward:{evidence:{id:"e003",title:"車禍新聞 — 父母雙亡",chapter:2,type:"news"}},title:"搜尋到車禍新聞"},{id:"ch2_insurance_blog",chapter:2,check:()=>l.get("discoveredFiles")?.includes("https://sawyer-blog.example/2012-07-07")||l.get("searchHistory")?.some(e=>e.includes("保險")),reward:{evidence:{id:"e004",title:"保險受益人 Blog",chapter:2,type:"blog"}},title:"發現保險受益人文章"},{id:"ch2_lottery_lie",chapter:2,check:()=>l.hasFlag("lottery_lie_seen"),reward:{evidence:{id:"e005",title:"六合彩謊言",chapter:2,type:"lie"}},title:"發現六合彩謊言紀錄"},{id:"ch2_dark_blog",chapter:2,check:()=>l.get("discoveredFiles")?.includes("https://sawyer-blog.example/2023-12-20"),reward:{evidence:{id:"e006",title:"Sawyer 暗示文字",chapter:2,type:"blog"}},title:"發現 2023-12-20 Blog"},{id:"ch3_git_secret",chapter:3,check:()=>l.hasFlag("git_secret_found"),reward:{evidence:{id:"e007",title:"Git 刪除的 secret path",chapter:3,type:"code"}},title:"在 Git 歷史找到刪除的 secret path"},{id:"ch3_darknet_url",chapter:3,check:()=>l.hasFlag("dark_entered")||l.hasFlag("hidden_portal_accessed"),reward:{evidence:{id:"e008",title:"暗網入口 URL",chapter:3,type:"portal"}},title:"找到暗網完整入口"},{id:"ch4_drug_transactions",chapter:4,check:()=>l.hasFlag("ch4_all_opened")||l.get("discoveredFiles")?.some(e=>e.includes("/darknet/")),reward:{evidence:{id:"e009",title:"毒品交易紀錄",chapter:4,type:"darknet"}},title:"開啟毒品交易列表"},{id:"ch4_drug_route",chapter:4,check:()=>l.hasFlag("ch4_all_opened")||l.get("discoveredFiles")?.some(e=>e.includes("drug-route")),reward:{evidence:{id:"e010",title:"毒品結構圖",chapter:4,type:"darknet"}},title:"開啟毒品結構圖"},{id:"ch4_sawyer_expenses",chapter:4,check:()=>l.hasFlag("ch4_all_opened")||l.get("discoveredFiles")?.some(e=>e.includes("sawyer_expenses")),reward:{evidence:{id:"e011",title:"Sawyer 個人支出",chapter:4,type:"darknet"}},title:"發現 Sawyer 與 FredyArc 金流"},{id:"ch4_travel_records",chapter:4,check:()=>l.hasFlag("ch4_all_opened")||l.get("discoveredFiles")?.some(e=>e.includes("travel_records")),reward:{evidence:{id:"e012",title:"Travel 紀錄",chapter:4,type:"darknet"}},title:"發現 Sawyer 多次前往毒品路線城市"},{id:"ch4_meeting_minutes",chapter:4,check:()=>l.hasFlag("ch4_all_opened")||l.get("discoveredFiles")?.some(e=>e.includes("meeting_minutes")),reward:{evidence:{id:"e013",title:"Sawyer × Fredy 會議紀錄",chapter:4,type:"darknet"}},title:"發現定期會議紀錄"},{id:"ch5_choose_ending",chapter:5,check:()=>(l.get("endings")||[]).length>0,reward:{},title:"選擇結局"}];function st(){for(const t of fs)l.hasFlag(`puzzle:${t.id}`)||t.check()&&(l.setFlag(`puzzle:${t.id}`,!0),t.reward?.evidence&&l.addEvidence(t.reward.evidence),t.reward?.unlock&&t.reward.unlock.forEach(a=>l.unlockInterface(a)),G.emit("puzzle:solved",t));let e=0;l.hasFlag("ch0_vip_fixed")&&(e=1),l.hasFlag("ch1_revert_done")&&(e=2),(l.hasFlag("dark_entered")||l.hasFlag("hidden_portal_accessed"))&&(e=3),l.hasFlag("ch4_all_opened")&&(e=4),(l.get("endings")||[]).length>0&&(e=5),e!==l.get("currentChapter")&&(l.set("currentChapter",e),G.emit("chapter:changed",e))}var ys=null;function bs(){G.on("change",st),G.on("vfs:read",st),G.on("portal:discovered",st),G.on("portal:bypassed",st),ys=setInterval(st,800),st()}var Pa={"zh-TW":{"app.title":"聽日辭職","app.subtitle":"編程人生模擬 · 離線 ARG","dock.vscode":"Vizual Studio Code","dock.intranet":"內網","dock.jira":"Jiua","dock.whatsapp":"WhatUp","dock.search":"Search","dock.notebook":"筆記本","dock.settings":"設定","settings.theme":"主題","settings.language":"語言","settings.export":"匯出存檔","settings.import":"匯入存檔","settings.reset":"重置進度","toast.saved":"已儲存","toast.evidence":"發現新證據","toast.unlocked":"解鎖新介面"},en:{"app.title":"聽日辭職","app.subtitle":"Dev Life Sim · Offline ARG","dock.vscode":"Vizual Studio Code","dock.intranet":"Intranet","dock.jira":"Jiua","dock.whatsapp":"WhatUp","dock.search":"Search","dock.notebook":"Notebook","dock.settings":"Settings","settings.theme":"Theme","settings.language":"Language","settings.export":"Export Save","settings.import":"Import Save","settings.reset":"Reset Progress","toast.saved":"Saved","toast.evidence":"New evidence","toast.unlocked":"Interface unlocked"}};function he(e){const t=l.get("settings.language")||"zh-TW";return Pa[t]?.[e]??Pa["zh-TW"][e]??e}var re=fa({renderDock:()=>Be,setActiveView:()=>pn,setDockVisible:()=>xs});function Be({onSwitch:e,onOpenSettings:t,onOpenNotebook:a,t:s}){const n=document.getElementById("dock");if(!n)return;function i(p){return p==="email"?l.hasFlag("ch5_triggered"):!0}const r=localStorage.getItem("cc_active_view")||"vscode",d={vscode:"/arg-game-it-company-secret/icon/vizual-studio-code.svg",intranet:"/arg-game-it-company-secret/icon/file-system.svg",jira:"/arg-game-it-company-secret/icon/jiua.svg",whatsapp:"/arg-game-it-company-secret/icon/whatsup.svg",search:"/arg-game-it-company-secret/icon/browser.svg",email:"/arg-game-it-company-secret/icon/mail.svg"},o={notebook:"/arg-game-it-company-secret/icon/notepad.png"};function c(p,u,v){const g=!i(p),y=r===p?"active":"",T=d[p];let A;return T&&T.startsWith("/icon/")?A=`<img class="taskbar__app-icon-img" src="${T}" alt="${v}" width="22" height="22" loading="eager" />`:T&&T.startsWith("fa-")?p==="jira"?A=`<i class="${T}" aria-hidden="true" style="font-size:22px;line-height:1;--fa-primary-color:rgba(19,91,205,1);--fa-secondary-color:rgba(19,91,205,0.4);color:rgba(19,91,205,1)"></i>`:p==="vscode"?A=`<i class="${T}" aria-hidden="true" style="font-size:22px;line-height:1;--fa-primary-color:rgba(87,165,229,1);--fa-secondary-color:rgba(87,165,229,0.4);color:rgba(87,165,229,1)"></i>`:p==="whatsapp"?A=`<i class="${T}" aria-hidden="true" style="font-size:22px;line-height:1;--fa-primary-color:rgba(0,203,90,1);--fa-secondary-color:rgba(0,203,90,0.4);color:rgba(0,203,90,1)"></i>`:A=`<i class="${T}" aria-hidden="true" style="font-size:22px;line-height:1;color:currentColor"></i>`:T?A=`<img class="taskbar__app-icon-img" src="${T}" alt="${v}" width="22" height="22" loading="eager" />`:A=`<span class="taskbar__app-icon" aria-hidden="true">${u}</span>`,`<button class="taskbar__app ${y}" data-view="${p}" ${g?'disabled title="尚未解鎖"':`title="${v}"`}>
  ...
  `,n.querySelectorAll("[data-view]").forEach(p=>{p.addEventListener("click",()=>{if(p.dataset.view==="email"){const u=document.getElementById("mailDialog");if(u){const v=document.getElementById("mailTitle"),g=document.getElementById("mailTo");if(v&&g){const y=v.value;y==="Report"?g.value="DEA <dea@world.example>":(y==="Coperation"||y==="Resign")&&(g.value="Sawyer <sawyer@nori-drinks.example>")}u.showModal()}return}e(p.dataset.view)})}),n.querySelector('[data-action="settings"]')?.addEventListener("click",t),n.querySelector('[data-action="notebook"]')?.addEventListener("click",a),_s()}var ea=null;function _s(){function e(){const t=new Date,a=document.getElementById("taskbarTime"),s=document.getElementById("taskbarDate");if(!a||!s)return;const n=t.toLocaleTimeString("zh-TW",{hour:"numeric",minute:"2-digit",hour12:!0}),i="2024/09/02";a.textContent=n,s.textContent=i}e(),ea&&clearInterval(ea),ea=setInterval(e,6e4)}function ws(){document.querySelectorAll("dialog[open]").forEach(n=>{try{n.close()}catch{}n.style.removeProperty("display")});const e=document.getElementById("startMenu");e&&(e.style.display="none");const t=document.getElementById("intraPreview");t&&(t.style.display="none");const a=document.getElementById("darkPreview");a&&(a.style.display="none");const s=document.getElementById("waLightbox");s&&s.classList.remove("open")}function pn(e){ws(),localStorage.setItem("cc_active_view",e),document.querySelectorAll(".taskbar__app[data-view]").forEach(t=>{t.classList.toggle("active",t.dataset.view===e)}),document.querySelectorAll(".view").forEach(t=>{t.classList.toggle("active",t.id===`view-${e}`)})}function xs(e){const t=document.getElementById("dock");t&&(t.style.display=e?"":"none")}function W(e,t={}){const a=document.getElementById("toasts");if(!a)return;const s=document.createElement("div");s.className="toast",s.textContent=e,t.variant==="error"&&(s.style.background="#7a1f1f"),a.appendChild(s),setTimeout(()=>{s.style.opacity="0",s.style.transform="translateY(4px)",s.style.transition="all .25s",setTimeout(()=>s.remove(),260)},t.duration||2200)}function ks(e,t){const a=new Blob([t],{type:"application/json;charset=utf-8"}),s=URL.createObjectURL(a),n=document.createElement("a");n.href=s,n.download=e,n.click(),URL.revokeObjectURL(s)}function Ss(e){return new Promise((t,a)=>{const s=new FileReader;s.onload=()=>t(s.result),s.onerror=a,s.readAsText(e)})}var Es={default:"/arg-game-it-company-secret/assets/data/music/Teacup Corridor (warmer).mp3",darknet:"/arg-game-it-company-secret/assets/data/music/Teacup Corridor.mp3",cooperate:"/arg-game-it-company-secret/assets/data/music/bgm_cowork.mp3",flee:"/arg-game-it-company-secret/assets/data/music/bgm_flee.mp3",fried:"/arg-game-it-company-secret/assets/data/music/bgm_fried.mp3",report:"/arg-game-it-company-secret/assets/data/music/bgm_report.mp3",resign:"/arg-game-it-company-secret/assets/data/music/bgm_resign.mp3"},Is=.25,ja=1500,Cs=class{constructor(){this.audio=null,this.currentBgm=null,this.isMuted=!1,this.volume=Is,this.fadeTimer=null,this._loadSettings()}_loadSettings(){const e=l.get("settings");e&&(typeof e.bgmVolume=="number"&&(this.volume=e.bgmVolume),typeof e.bgmMuted=="boolean"&&(this.isMuted=e.bgmMuted))}_saveSettings(){l.set("settings.bgmVolume",this.volume),l.set("settings.bgmMuted",this.isMuted)}_createAudio(e){const t=new Audio(e);return t.loop=!0,t.preload="auto",t.volume=this.isMuted?0:this.volume,t}_fadeVolume(e,t,a,s){this.fadeTimer&&cancelAnimationFrame(this.fadeTimer);const n=performance.now(),i=r=>{const d=r-n,o=Math.min(d/a,1),c=e+(t-e)*o;this.audio&&(this.audio.volume=this.isMuted?0:c),o<1?this.fadeTimer=requestAnimationFrame(i):(this.fadeTimer=null,s&&s())};this.fadeTimer=requestAnimationFrame(i)}_stopCurrent(e=!0){if(!this.audio)return Promise.resolve();const t=this.audio,a=t.volume;return e&&a>0?new Promise(s=>{this._fadeVolume(a,0,ja,()=>{t.pause(),t.src="",s()})}):(t.pause(),t.src="",Promise.resolve())}async play(e){const t=Es[e];if(t&&this.currentBgm!==e){await this._stopCurrent(!0),this.currentBgm=e,this.audio=this._createAudio(t);try{await this.audio.play(),this._fadeVolume(0,this.volume,ja)}catch(a){console.warn("BGM play failed:",a)}}}async stop(e=!0){await this._stopCurrent(e),this.audio=null,this.currentBgm=null}setVolume(e){this.volume=Math.max(0,Math.min(1,e)),this.audio&&!this.isMuted&&(this.audio.volume=this.volume),this._saveSettings()}getVolume(){return this.volume}toggleMute(){return this.isMuted=!this.isMuted,this.audio&&(this.audio.volume=this.isMuted?0:this.volume),this._saveSettings(),this.isMuted}setMuted(e){this.isMuted=e,this.audio&&(this.audio.volume=this.isMuted?0:this.volume),this._saveSettings()}isMutedState(){return this.isMuted}getCurrentBgm(){return this.currentBgm}},se=new Cs;function Ge(){const e=document.getElementById("settingsDialog");e&&(typeof e.showModal=="function"?e.open||e.showModal():typeof e.show=="function"?e.open||e.show():(e.style.display="block",e.setAttribute("open","")),e.style.removeProperty("display"),Ls())}function Ls(){const e=document.getElementById("settingTheme");e&&(e.value=l.get("settings.theme"));const t=document.getElementById("settingPlaytime");t&&(t.textContent=String(l.get("playtime"))+"s")}function Ts(){document.getElementById("settingTheme")?.addEventListener("change",s=>{const n=s.target.value;l.set("settings.theme",n),document.documentElement.setAttribute("data-theme",n),W(he("toast.saved"))});const e=document.getElementById("bgmMuteBtn"),t=document.getElementById("bgmVolumeSlider"),a=document.getElementById("bgmVolumePct");e&&!e._bound&&(e._bound=!0,e.addEventListener("click",()=>{const s=se.toggleMute();e.textContent=s?"🔇":"🔊",a&&(a.textContent=s?"靜音":Math.round(se.getVolume()*100)+"%")})),t&&!t._bound&&(t._bound=!0,t.addEventListener("input",s=>{const n=parseInt(s.target.value)/100;se.setVolume(n),se.setMuted(!1),e&&(e.textContent="🔊"),a&&(a.textContent=Math.round(n*100)+"%")})),document.getElementById("btnExport")?.addEventListener("click",()=>{ks("code-conspiracy-save.json",l.exportSave())}),document.getElementById("btnImport")?.addEventListener("change",async s=>{const n=s.target.files?.[0];if(!n)return;const i=await Ss(n),r=l.importSave(i);W(r?he("toast.saved"):"Import failed",{variant:r?void 0:"error"}),r&&location.reload()}),document.getElementById("btnReset")?.addEventListener("click",async()=>{if(confirm("Reset all progress?")){let s=null;try{s=JSON.parse(JSON.stringify(l.get("persistentStats")||{}))}catch{}try{l.reset()}catch{}try{if(s){const i=l.get("persistentStats")||{},r={unlockedEndings:[...new Set([...i.unlockedEndings||[],...s.unlockedEndings||[]])],readArticles:[...new Set([...i.readArticles||[],...s.readArticles||[]])],darkFileCount:Math.max(i.darkFileCount||0,s.darkFileCount||0),whatsappSentCount:Math.max(i.whatsappSentCount||0,s.whatsappSentCount||0),searchHistoryCount:Math.max(i.searchHistoryCount||0,s.searchHistoryCount||0),flags:{...i.flags||{},...s.flags||{}}};l.set("persistentStats",r),l.set("unlockedEndings",r.unlockedEndings)}}catch{}const n=document.getElementById("settingsDialog");if(n&&n.open)try{n.close()}catch{}n&&(n.style.removeProperty("display"),n.removeAttribute("open"));try{if("caches"in window){const i=await caches.keys();await Promise.all(i.map(r=>caches.delete(r)))}if("serviceWorker"in navigator){const i=await navigator.serviceWorker.getRegistrations();await Promise.all(i.map(r=>r.unregister()))}}catch{}setTimeout(()=>{window.location.href=window.location.pathname+"?reset="+Date.now(),window.location.reload(!0)},150)}}),document.getElementById("settingsDialog")?.addEventListener("close",()=>{})}var Da=["教學","異常發現","自由探索","暗網入口","秘密曝光","抉擇"],As=13,$s={vscode:"Vizual",jira:"Jiua",whatsapp:"WhatUp",search:"Search",intranet:"Intranet",darknet:"Darknet",email:"Email"};function Bs(e){return!e||!e.length?"—":e.map(t=>$s[t]||t).join(", ")}function Ms(e){return e=Number(e)||0,e<=59?`${e} 秒`:e<3600?`${Math.floor(e/60)} 分鐘`:e<86400?`${Math.floor(e/3600)} 小時`:`${Math.floor(e/86400)} 日`}function Ps(){const e=l.get("readArticles")||[],t=l.get("discoveredFiles")||[],a=l.get("endings")||l.get("unlockedEndings")||[],s=l.get("whatsappSentCount")||0,n=l.get("persistentStats")||{},i=n.readArticles||[],r=n.darkFileCount||0,d=n.whatsappSentCount||0,o=n.searchHistoryCount||0,c=n.flags||{},m=["https://sawyer-blog.example/2001-10-18","https://sawyer-blog.example/2003-04-27","https://sawyer-blog.example/2004-11-13","https://sawyer-blog.example/2006-09-01","https://sawyer-blog.example/2007-01-11","https://sawyer-blog.example/2007-01-12","https://sawyer-blog.example/2010-06-06","https://sawyer-blog.example/2012-07-07","https://sawyer-blog.example/2013-01-01","https://sawyer-blog.example/2023-04-25","https://sawyer-blog.example/2023-05-01","https://sawyer-blog.example/2023-05-10","https://sawyer-blog.example/2023-12-20","https://sawyer-blog.example/2024-01-15","https://sawyer-blog.example/2024-03-20"],p=["https://school.example/guangzhi-essay-sawyer"],u=["https://news.example/car-accident-2023","https://news.example/car-accident-investigation-2023","https://news.example/ping-wo-suspicious-man-2023","https://news.example/police-clarification-2023"],v=[...m,...p,...u],g=[...m,"https://mary-blog.example/kyoto-sakura-2024","https://mary-blog.example/one-person-kitchen","https://mary-blog.example/danshari-half-year","https://peter-blog.example/python-one-year","https://peter-blog.example/vim-vs-vscode","https://peter-blog.example/nas-ds220","https://peter-blog.example/code-easter-eggs","https://paul-blog.example/tainan-beef-soup","https://paul-blog.example/hand-drip-coffee","https://paul-blog.example/keelung-night-market","https://emma-blog.example/contax-t2-taipei","https://emma-blog.example/iceland-aurora","https://david-blog.example/vinyl-jazz-20","https://david-blog.example/livehouse-map"];let y=10;try{const f=S.listDarkFiles?S.listDarkFiles("/darknet"):[];f.length&&(y=f.length)}catch{}const T=Math.max(t.filter(f=>f.startsWith("/darknet")).length,r),A=Math.max(l.hasFlag("portal_simple_entered")?1:0,c.portal_simple_entered?1:0),N=Math.max(l.hasFlag("portal_hash_entered")?1:0,c.portal_hash_entered?1:0),E=[...new Set([...e,...i])],_=Math.max(s,d),w=Math.max((l.get("searchHistory")||[]).length,o),b=[...new Set([...a,...l.get("unlockedEndings")||[],...n.unlockedEndings||[]])];return[{id:"secret_entry",title:"解鎖秘密入口",desc:"進入公司秘密內部系統入口",total:2,current:A+N,isSecret:!1},{id:"boss_whisper",title:"老闆知音",desc:"已了解老闆的一切",total:20,current:v.filter(f=>E.includes(f)).length,isSecret:!1},{id:"too_much",title:"你知道得太多了",desc:"閱讀所有秘密檔案",total:y,current:Math.min(T,y),isSecret:!1},{id:"all_endings",title:"作者感謝您",desc:"解鎖全結局",total:5,current:b.length,isSecret:!1},{id:"social",title:"社牛",desc:"在 WhatUp 發送超過 10 條訊息",total:10,current:Math.min(_,10),isSecret:!0},{id:"reader",title:"閱讀達人",desc:"閱讀 BlogWorld 上的所有部落格",total:29,current:g.filter(f=>E.includes(f)).length,isSecret:!0},{id:"miracle",title:"你沒有被解僱是奇蹟",desc:"向 Sawyer 發送帶有「垃圾」「蠢」等字眼的訊息",total:1,current:Math.max(l.hasFlag("sawyer_abuse_sent")?1:0,c.sawyer_abuse_sent?1:0),isSecret:!0},{id:"net_addict",title:"網路成癮",desc:"在搜尋引擎搜尋超過 50 次",total:50,current:Math.min(w,50),isSecret:!0}].map(f=>({...f,done:f.current>=f.total,progress:`${f.current}/${f.total}`,pct:Math.round(f.current/f.total*100)}))}var Fa=[{id:"flee",idx:1,title:"平凡的日常",desc:"完成工作後登出，回到平凡重複的日常。",color:"#6b778c"},{id:"cooperate",idx:2,title:"共犯",desc:"與老闆合作，踏入充滿刺激與風險的新生活。",color:"#d93025"},{id:"report",idx:3,title:"舉報",desc:"向警方舉報，目睹公司倒閉與風波後的平靜。",color:"#0d9488"},{id:"resign",idx:4,title:"辭職",desc:"遠離是非，主動辭職尋找新的工作與記憶。",color:"#6554c0"},{id:"fried",idx:5,title:"做對了嗎？",desc:"公司已發現你。",color:"#ff991f"}];function Je(){const e=document.getElementById("notebookDialog");e&&(js(),typeof e.showModal=="function"?e.open||e.showModal():typeof e.show=="function"?e.open||e.show():(e.setAttribute("open",""),e.style.display="block"),e.style.removeProperty("display"),e._boundClose||(e.addEventListener("close",()=>{e.style.removeProperty("display"),e.removeAttribute("open")}),e._boundClose=!0))}function js(){const e=document.getElementById("notebookContent");if(!e)return;const t=l.get("collectedEvidence")||[];l.get("flags");const a=l.get("currentChapter")??0,s=Ps(),n=s.filter(c=>c.done).length,i=l.get("persistentStats")?.unlockedEndings||[],r=l.get("endings")||l.get("unlockedEndings")||[],d=[...new Set([...r,...i])],o=(()=>{const c=Fa.map(m=>{const p=d.includes(m.id),u="？".repeat([...m.title].length);return`
    ...
    <div class="card">
      <div style="display:flex;justify-content:space-between;align-items:center">
        <h3 style="margin:0">進度 · Chapter ${a} / 5 — ${Da[a]||"—"}</h3>
      ...
      <div class="small muted" style="margin-top:6px">遊玩時長 ${Ms(l.get("playtime"))} · 已解鎖 ${Bs(l.get("unlockedInterfaces"))}</div>
    </div>

    <div class="card" style="margin-top:12px">
      <h3 style="margin:0 0 8px">證據板 (${t.length}/${As})</h3>
      ${t.length?`
    ...
    <div class="card" style="margin-top:12px">
      ...
      <div style="display:grid;gap:4px">
        ${Da.map((c,m)=>`<div style="display:flex;justify-content:space-between;padding:6px 8px;border-radius:6px;background:${m<=a?"var(--bg-tertiary)":"var(--bg-primary)"};border:1px solid var(--border)"><span>Ch${m} ${c}</span><span class="small ${m<a?"":m===a?"badge":""}" style="${m===a?"background:var(--accent);color:#fff":""}">${m<a?"完成":m===a?"進行中":"未開始"}</span></div>`).join("")}
      </div>
    </div>
    ${o}
  ...
  `,setTimeout(()=>{const c=document.getElementById("notebookResetBtn");!c||c._bound||(c._bound=!0,c.addEventListener("click",async()=>{if(!confirm("重置後將失去證據，確定？"))return;const m=document.getElementById("notebookDialog");try{m&&m.open&&m.close()}catch{}m&&(m.style.removeProperty("display"),m.removeAttribute("open"));let p=null;try{p=JSON.parse(JSON.stringify(l.get("persistentStats")||{}))}catch{}try{l.reset()}catch{}try{if(p){const u=l.get("persistentStats")||{},v={unlockedEndings:[...new Set([...u.unlockedEndings||[],...p.unlockedEndings||[]])],readArticles:[...new Set([...u.readArticles||[],...p.readArticles||[]])],darkFileCount:Math.max(u.darkFileCount||0,p.darkFileCount||0),whatsappSentCount:Math.max(u.whatsappSentCount||0,p.whatsappSentCount||0),searchHistoryCount:Math.max(u.searchHistoryCount||0,p.searchHistoryCount||0),flags:{...u.flags||{},...p.flags||{}}};l.set("persistentStats",v),l.set("unlockedEndings",v.unlockedEndings)}}catch{}try{if("caches"in window){const u=await caches.keys();await Promise.all(u.map(v=>caches.delete(v)))}if("serviceWorker"in navigator){const u=await navigator.serviceWorker.getRegistrations();await Promise.all(u.map(v=>v.unregister()))}}catch{}setTimeout(()=>{window.location.href=window.location.pathname+"?reset="+Date.now(),window.location.reload(!0)},150)}))},0),setTimeout(()=>{const c=document.querySelector(".nb-endings-grid");c&&c.querySelectorAll(".nb-ending-card.unlocked").forEach(m=>{m.addEventListener("click",()=>{const p=m.dataset.ending,u=Fa.find(v=>v.id===p);if(u){try{const v=new CustomEvent("nb:endingPreview",{detail:u});window.dispatchEvent(v)}catch{}m.classList.add("pulse"),setTimeout(()=>m.classList.remove("pulse"),600)}})})},0)}function h(e){return e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Ds="modulepreload",Fs=function(e){return"/arg-game-it-company-secret/"+e},Na={},M=function(t,a,s){let n=Promise.resolve();if(a&&a.length>0){let c=function(p){return Promise.all(p.map(u=>Promise.resolve(u).then(v=>({status:"fulfilled",value:v}),v=>({status:"rejected",reason:v}))))},m=function(p){return import.meta.resolve?import.meta.resolve(p):new URL(p,import.meta.url).href};const r=document.getElementsByTagName("link"),d=document.querySelector("meta[property=csp-nonce]"),o=d?.nonce||d?.getAttribute("nonce");n=c(a.map(p=>{if(p=Fs(p,s),p=m(p),p in Na)return;Na[p]=!0;const u=p.endsWith(".css");for(let g=r.length-1;g>=0;g--){const y=r[g];if(y.href===p&&(!u||y.rel==="stylesheet"))return}const v=document.createElement("link");if(v.rel=u?"stylesheet":Ds,u||(v.as="script"),v.crossOrigin="",v.href=p,o&&v.setAttribute("nonce",o),document.head.appendChild(v),u)return new Promise((g,y)=>{v.addEventListener("load",g),v.addEventListener("error",()=>y(new Error(`Unable to preload CSS for ${p}`)))})}))}function i(r){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=r,window.dispatchEvent(d),!d.defaultPrevented)throw r}return n.then(r=>{for(const d of r||[])d.status==="rejected"&&i(d.reason);return t().catch(i)})},F="/customer-portal/src/main/java/com/nori/OrderService.java",ee="explorer",$e=[],pe=-1,Ot="",Ns=new Set(["/customer-portal/src/frontend/src/pages/Home.jsx","/customer-portal/src/main/java/com/nori/controller/OrderController.java","/customer-portal/scripts/reconcile.py","/customer-portal/src/payment/gateway.js","/customer-portal/src/main/java/com/nori/service/PaymentService.java","/customer-portal/src/main/java/com/nori/controller/PaymentController.java"]);function Ee(e){return Ns.has(e)}var z=new Map,Fe=null,Oa=null;function pt(e){const t=S.getFile(e);return t?t.content:null}function da(e){return z.has(e)?z.get(e):pt(e)}function un(e){return z.has(e)?z.get(e)!==pt(e):!1}function Os(e,t){t===pt(e)?z.delete(e):z.set(e,t),Ce(),fe(),Ne()}function ba(){if(!Fe){const e=S.getFile("/file-system/src/components/SearchBar.jsx");e&&(Fe=e.content)}}function Hs(){if(!Oa){const e=S.getFile("/customer-portal/src/frontend/src/pages/Home.jsx");e&&(Oa=e.content)}}var Rs=`export default function Home(){
  return (
    <div>
      <h1>Nori 飲品供應 — 用一杯冰釀茶酒，連結人與希望</h1>
      <p>創辦人 蔡梓掦 · 2018 創立 · 招牌冰釀茶酒最暢銷</p>
...
`,Vs=`export default function Home(){
  return (
    <div>
...
`;function mn(){return l.hasFlag("ch1_0043_committed")&&!l.hasFlag("ch1_revert_done")}function hn(e="revert"){l.hasFlag("ch1_revert_done")||(l.setFlag("ch1_revert_done",!0),l.setFlag("ch1_system_down",!1),setTimeout(()=>{M(()=>Promise.resolve().then(()=>le).then(t=>{const a=(t.getChats?t.getChats():[]).find(s=>s.id==="system-alert");if(a){a.messages.push({id:"health-"+Date.now(),from:"system",text:"✅ 系統健康 — 所有服務已恢復正常",time:new Date().toLocaleTimeString("zh-TW",{hour:"2-digit",minute:"2-digit"}),read:"delivered",type:"text"}),a.preview="✅ 系統健康",a.unread=(a.unread||0)+1,window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"system-alert"}}));const s=document.createElement("div");if(vn("system-alert"))return;s.id="wa-win-notif-health-"+Date.now(),s.setAttribute("role","alert"),s.innerHTML='<div class="win-notif__app"><img src="/arg-game-it-company-secret/icon/whatsup.svg" alt="WhatUp" width="20" height="20" style="width:20px;height:20px;object-fit:contain" /><span class="win-notif__app-name">WhatUp</span><span class="win-notif__app-sub">System Alert</span><button class="win-notif__close" aria-label="關閉">✕</button></div><div class="win-notif__body"><div class="win-notif__avatar" style="background:linear-gradient(135deg, #0d9488, #25D366)">✓</div><div class="win-notif__text"><div class="win-notif__sender">System Alert</div><div class="win-notif__msg">✅ 系統健康 — 所有服務已恢復正常</div><div class="win-notif__time">剛剛 · 點擊開啟對話</div></div></div><div class="win-notif__progress" style="animation: winNotifShrink 10000ms linear forwards"></div>',s.style.cssText="position:fixed;right:16px;bottom:60px;width:360px;background:#2d2d2d;color:#f0f0f0;border:1px solid rgba(255,255,255,.12);border-radius:8px;box-shadow:0 8px 28px rgba(0,0,0,.45);z-index:1100;overflow:hidden;cursor:pointer;opacity:0;transform:translateY(12px);transition:opacity .28s,transform .28s;",s.addEventListener("click",n=>{n.target.closest(".win-notif__close")||(s.remove(),M(()=>Promise.resolve().then(()=>re).then(i=>{i.setActiveView&&(i.setActiveView("whatsapp"),localStorage.setItem("cc_active_view","whatsapp"))}),void 0),M(()=>Promise.resolve().then(()=>le).then(i=>i.openChat("system-alert")),void 0))}),s.querySelector(".win-notif__close")?.addEventListener("click",n=>{n.stopPropagation(),s.remove()}),document.body.appendChild(s),requestAnimationFrame(()=>{s.style.opacity="1",s.style.transform="none"}),setTimeout(()=>{s.style.opacity="0",s.style.transform="translateY(8px)",setTimeout(()=>s.remove(),300)},1e4)}}),void 0)},500))}function qs(e){const t=ie.find(i=>i.hash===e)||ce.find(i=>i.hash===e);if(!t)return;if(t.msg.includes("INV-2024-0017")||t.hash==="3f2a9c1"){const i=S.getFile("/customer-portal/src/frontend/src/pages/Home.jsx")?.content||"",r=i.includes("連結人與希望")||i.includes("2018 創立"),d=r?Vs:Rs;S.registerFile("/customer-portal/src/frontend/src/pages/Home.jsx",{content:d,meta:{lang:"javascript"}});const o=S.getFile("/customer-portal/src/frontend/src/pages/Home.jsx");o&&(o.content=d),z.delete("/customer-portal/src/frontend/src/pages/Home.jsx");const c=Math.random().toString(36).slice(2,8),m=r?`revert: restore Home.jsx fix (revert ${e} — apply Parker fix)`:`revert: revert Home.jsx fix (revert ${e} — back to bug)`,p=r?`M /customer-portal/src/frontend/src/pages/Home.jsx
- 連結人與希望 / 2018
+ 連結人與風味 / 2019 (revert apply)`:`M /customer-portal/src/frontend/src/pages/Home.jsx
- 連結人與風味 / 2019
+ 連結人與希望 / 2018 (revert)`;ce.unshift({hash:c,author:"Parker",date:new Date().toISOString().slice(0,10),msg:m,diff:p}),ie.unshift({hash:c,branch:"main",author:"Parker",date:new Date().toISOString().slice(0,10),msg:m,diff:p});const u=document.getElementById("scmCommitStatus");u&&(u.innerHTML=`<span style="color:var(--success)">✓ Revert 成功: ${c} (from ${e}) — ${r?"已套用 Parker 修復":"已回退至 bug 版"}</span>`),L(`✓ revert ${c} — ${m}`),Ce(),fe(),Le(),Ne(),ve&&je();return}if(!mn())return;if(ba(),Fe){S.registerFile("/file-system/src/components/SearchBar.jsx",{content:Fe,meta:{lang:"javascript"}});const i=S.getFile("/file-system/src/components/SearchBar.jsx");i&&(i.content=Fe)}z.delete("/file-system/src/components/SearchBar.jsx");const a=Math.random().toString(36).slice(2,8),s=`revert: restore SearchBar legacyRoutes (revert ${e})`;ce.unshift({hash:a,author:"Casey",date:new Date().toISOString().slice(0,10),msg:s,diff:`M /file-system/src/components/SearchBar.jsx
+ restored legacyRoutes / resolveLegacyPath`}),ie.unshift({hash:a,branch:"main",author:"Casey",date:new Date().toISOString().slice(0,10),msg:s,diff:`M /file-system/src/components/SearchBar.jsx
+ restored legacyRoutes`});const n=document.getElementById("scmCommitStatus");n&&(n.innerHTML=`<span style="color:var(--success)">✓ Revert 成功: ${a} (from ${e})</span>`),L(`✓ revert ${a} — ${s}`),Ce(),fe(),Le(),Ne(),ve&&je(),hn("git-graph")}var ce=[{hash:"a1b2c3d",author:"finance@internal",date:"2024-08-12",msg:"feat: integrate crypto-mixer (legacy)",diff:`+ import { cryptoMixer } from '@shady/crypto-mixer'
...
+ export function computeFee(amount, opts) {}`}],Ha={"/customer-portal/src/billing/service.js":[{line:1,commit:"4c2a1e0",author:"dev"},{line:5,commit:"4c2a1e0",author:"dev"},{line:9,commit:"9f8e7d6",author:"qa-lee"},{line:12,commit:"9f8e7d6",author:"qa-lee"},{line:14,commit:"a1b2c3d",author:"finance@internal"}],"/customer-portal/src/main/java/com/nori/OrderService.java":[{line:1,commit:"4c2a1e0",author:"dev"},{line:12,commit:"9f8e7d6",author:"qa-lee"},{line:15,commit:"a1b2c3d",author:"finance@internal"}]},ge="__GIT_GRAPH__",ve=!1,Xe=null,Ra={main:"#89d185","feature/vip-discount":"#4da3ff","feature/crypto-mixer":"#dcdcaa","feature/billing-fix":"#ce9178","feature/home-copyfix":"#4ec9b0",develop:"#c586c0"},ie=[{hash:"a1b2c3d",branch:"feature/crypto-mixer",author:"finance@internal",date:"2024-08-12",msg:"(INV-2024-0040) feat: integrate crypto-mixer (legacy)",diff:`+ import { cryptoMixer } from '@shady/crypto-mixer'
...
+ <h1>Nori 飲品供應 — 用一杯冰釀茶酒，連結人與風味</h1>
- <p>創辦人 蔡梓掦 · 2018 創立</p>
+ <p>創辦人 蔡梓掦 · 2019 創立</p>`},{hash:"d4e5f6a",branch:"main",author:"dev-chen",date:"2023-11-20",msg:"(INV-2023-0039) refactor: simplify portal auth (remove dynamic generator)",diff:"- function generateInternalPortalPath(internalPortalDomain){ \n-     const cid = redis.get('companyId'); \n-     const y = redis.get('year'); \n-     const k = import.meta.env.MD5_KEY; \n-     return internalPortalDomain + '?hash=' + md5(`companyId=${cid}&year=${y}&key=${k}`); // e.g. https://google.com/internal?hash=be78e7542cd6d04e31e80fa8b741aad4\n-     }"}];function gn(){const e=ie.find(a=>a.hash==="d4e5f6a");e&&!e.diff.includes("e.g. https://google.com/internal?hash=")&&(e.diff=e.diff.replace("md5(`companyId=${cid}&year=${y}&key=${k}`);","md5(`companyId=${cid}&year=${y}&key=${k}`); // e.g. https://google.com/internal?hash=be78e7542cd6d04e31e80fa8b741aad4"));const t=ce.find(a=>a.hash==="d4e5f6a");t&&t.diff&&!t.diff.includes("e.g. https://google.com")&&(t.diff=e.diff)}gn();function Ce(){try{const e=Array.from(z.entries());l.set("vscodeState",{editedFiles:e,gitCommits:ce.slice(0,20),gitGraphCommits:ie.slice(0,20),currentFile:F,activeActivity:ee,gitGraphOpen:ve,expandedGraphHash:Xe}),l.save(!0)}catch{}}function vn(e){try{const t=JSON.parse(localStorage.getItem("code_conspiracy_state")||"{}").whatsappChats;if(Array.isArray(t)){const a=t.find(s=>s.id===e);if(a)return!!a.muted}return!1}catch{return!1}}function zs(){try{const e=l.get("vscodeState");if(!e||typeof e!="object")return;if(Array.isArray(e.editedFiles))for(const[t,a]of e.editedFiles){z.set(t,a);const s=S.getFile(t);s?s.content=a:S.registerFile(t,{content:a,meta:{lang:t.endsWith(".java")?"java":t.endsWith(".js")?"javascript":"text"}})}if(Array.isArray(e.gitCommits)&&e.gitCommits.length){ce.length=0;for(const t of e.gitCommits)ce.push(t)}if(Array.isArray(e.gitGraphCommits)&&e.gitGraphCommits.length){ie.length=0;for(const t of e.gitGraphCommits)ie.push(t)}try{gn()}catch{}typeof e.currentFile=="string"&&e.currentFile&&(F=e.currentFile),typeof e.activeActivity=="string"&&(ee=e.activeActivity),typeof e.gitGraphOpen=="boolean"&&(ve=e.gitGraphOpen),e.expandedGraphHash&&(Xe=e.expandedGraphHash)}catch{}}function Us(){zs();const e=document.getElementById("view-vscode");e&&(e.innerHTML=`
    <div class="vscode">
  ...
  `,ba(),Hs(),Le(),fe(),de(F),Ws(),Xs(),Ne(),ai())}function Ws(){document.getElementById("vsQuickOpen")?.addEventListener("input",n=>{Le(n.target.value.trim().toLowerCase())});const e=document.getElementById("vsSearchInput"),t=document.getElementById("vsSearchResult");t&&(t.textContent="");function a(n){const i=n.trim().toLowerCase();if(!i){t&&(t.textContent="");return}const r=i.includes("nori-intranet/internal/portal")||i==="https://nori-intranet/internal/portal",d=i.includes("internal/portal")||i==="internal"||i==="portal"||i.includes("internal")&&i.includes("portal")||r,o=i.includes("internal")||i.includes("portal")||r,c=i.includes("switch")||i.includes("case")||i.toLowerCase().includes("vipprice")||i.includes("price")||i.includes("vip"),m=i.includes("md5_key")||i.includes("md5key")||i.includes("md5")||i.includes("key");if(d||o){t&&(t.innerHTML=`<div class="small" style="color:var(--fg-primary);cursor:pointer;padding:6px;border:1px solid var(--border);border-radius:6px;background:var(--bg-tertiary)" data-open="SearchBar">📄 file-system/src/components/SearchBar.jsx — 匹配 "${h(n)}" <span style="color:var(--accent);margin-left:6px">開啟 →</span></div>`,t.querySelector("[data-open]")?.addEventListener("click",()=>{de("/file-system/src/components/SearchBar.jsx"),document.getElementById("vsSearchInput")?.focus()}));return}if(c){t&&(t.innerHTML=`<div class="small" style="color:var(--fg-primary);cursor:pointer;padding:6px;border:1px solid var(--border);border-radius:6px;background:var(--bg-tertiary)" data-open="OrderService">📄 customer-portal/src/main/java/com/nori/OrderService.java — 匹配 "${h(n)}" <span style="color:var(--accent);margin-left:6px">開啟 →</span></div>`,t.querySelector("[data-open]")?.addEventListener("click",()=>{de("/customer-portal/src/main/java/com/nori/OrderService.java")}));return}if(m){t&&(t.innerHTML=`<div class="small" style="color:var(--fg-primary);cursor:pointer;padding:6px;border:1px solid var(--border);border-radius:6px;background:var(--bg-tertiary)" data-open=".env">📄 /customer-portal/.env — 匹配 "${h(n)}" <span style="color:var(--accent);margin-left:6px">開啟 →</span></div>`,t.querySelector("[data-open]")?.addEventListener("click",()=>{de("/customer-portal/.env")}));return}t&&(t.textContent="")}e?.addEventListener("input",n=>a(n.target.value)),e?.addEventListener("keydown",n=>{n.key==="Enter"&&a(n.target.value)}),document.querySelectorAll(".activitybar__btn[data-activity]").forEach(n=>{n.addEventListener("click",()=>{ee=n.dataset.activity,Vt()})}),document.querySelector('[data-help="1"]')?.addEventListener("click",()=>{const n=document.getElementById("vsHelpOverlay");n&&(n.style.display=n.style.display==="none"||!n.style.display?"flex":"none")}),document.getElementById("vsHelpOverlay")?.addEventListener("click",n=>{n.target.id==="vsHelpOverlay"&&(n.target.style.display="none")}),document.getElementById("sonarModalClose")?.addEventListener("click",()=>{document.getElementById("sonarModal").style.display="none"}),document.getElementById("sonarModal")?.addEventListener("click",n=>{n.target.id==="sonarModal"&&(n.target.style.display="none")}),document.getElementById("scmCommitBtn")?.addEventListener("click",Qs),document.getElementById("scmGraphBtn")?.addEventListener("click",fn),document.getElementById("vsTerminalInput")?.addEventListener("keydown",Zs);const s=document.getElementById("quickOpenInput");s?.addEventListener("input",n=>yn(n.target.value)),s?.addEventListener("keydown",si),document.getElementById("quickOpen")?.addEventListener("click",n=>{n.target.id==="quickOpen"&&wt()})}function Vt(){document.querySelectorAll(".activitybar__btn[data-activity]").forEach(a=>{a.classList.toggle("active",a.dataset.activity===ee)});const e=document.getElementById("vsSideTitle"),t={explorer:"EXPLORER",search:"SEARCH",scm:"SOURCE CONTROL",debug:"RUN AND DEBUG",extensions:"EXTENSIONS"};e&&(e.textContent=t[ee]||"EXPLORER"),document.getElementById("vsSideContent").style.display=ee==="explorer"?"flex":"none",document.getElementById("vsPanelSearch").style.display=ee==="search"?"flex":"none",document.getElementById("vsPanelScm").style.display=ee==="scm"?"flex":"none",document.getElementById("vsPanelDebug").style.display=ee==="debug"?"flex":"none",document.getElementById("vsPanelExtensions").style.display=ee==="extensions"?"flex":"none",ee==="scm"&&Ne(),Ce()}function Le(e=""){const t=document.getElementById("vsTree");if(!t)return;const a=S.buildTree(),s=["/file-system","/customer-portal"];function n(d){return Ee(d)?!1:s.some(o=>d===o||d.startsWith(o+"/"))}function i(d,o=0){if(!n(d.path)&&d.path!=="/file-system"&&d.path!=="/customer-portal"&&(d.path==="/"||d.path==="/intranet"||d.path==="/internal"))return"";if(d.type==="dir"){const c=(d.children||[]).filter(m=>n(m.path)&&(!e||m.path.toLowerCase().includes(e)||r(m,e)));return e&&c.length===0&&!d.path.toLowerCase().includes(e)?"":!n(d.path)&&d.path!=="/"?c.map(m=>i(m,o)).join(""):`<div class="tree__node tree__node--dir" style="padding-left:${8+o*8}px" data-path="${d.path}" title="${h(d.path)}">📁 <span class="tree__label">${h(d.name)}</span></div>
        <div class="tree__children">${c.map(m=>i(m,o+1)).join("")}</div>`}else{if(!n(d.path)||e&&!d.path.toLowerCase().includes(e))return"";const c=d.path===F?"active":"",m=un(d.path)?"●":"";return`<div class="tree__node ${c}" data-path="${d.path}" data-file="1" style="padding-left:${8+o*8}px" title="${h(d.path)}">📄 <span class="tree__label">${h(d.name)}</span> <span style="margin-left:auto;font-size:10px;color:var(--warning);flex-shrink:0">${m}</span></div>`}}function r(d,o){return n(d.path)?d.path.toLowerCase().includes(o)?!0:d.children?d.children.some(c=>r(c,o)):!1:!1}t.innerHTML=a.children.filter(d=>n(d.path)).map(d=>i(d,0)).join(""),t.querySelectorAll('[data-file="1"]').forEach(d=>{d.addEventListener("click",()=>de(d.dataset.path))})}function fe(){const e=document.getElementById("vsTabs");if(!e)return;const t=S.listFiles("/customer-portal").filter(a=>!Ee(a.path)).slice(0,8);if(!t.some(a=>a.path===F)&&F!==ge){const a=S.getFile(F);a&&t.unshift({path:F,...a})}if(!t.some(a=>a.path==="/customer-portal/src/main/java/com/nori/OrderService.java")){const a=S.getFile("/customer-portal/src/main/java/com/nori/OrderService.java");a&&t.unshift({path:"/customer-portal/src/main/java/com/nori/OrderService.java",...a})}ve&&!t.some(a=>a.path===ge)&&t.push({path:ge,name:"Git Graph"}),e.innerHTML=t.map(a=>{if(a.path===ge){const n=a.path===F?"active":"";return`<div class="vscode__tab ${n}" data-path="${ge}"><span class="vscode__tab-dot" style="display:${n?"block":"none"}"></span><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" aria-hidden="true" style="flex-shrink:0"><circle cx="6" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><circle cx="18" cy="12" r="3"/><path d="M8.3 7.3L15.7 10.7"/><path d="M8.3 16.7L15.7 13.3"/></svg> Git Graph <span class="vscode__tab-close" data-close-graph="1" title="Close" style="margin-left:6px;opacity:.6;font-size:12px;cursor:pointer">✕</span></div>`}const s=un(a.path)?'<span style="color:var(--warning);font-size:12px">●</span>':"";return`<div class="vscode__tab ${a.path===F?"active":""}" data-path="${a.path}"><span class="vscode__tab-dot"></span>${h(a.path.split("/").pop()||a.path)} ${s} <span style="opacity:.6;font-size:11px;margin-left:4px">${a.path===F?"●":""}</span></div>`}).join(""),e.querySelectorAll(".vscode__tab").forEach(a=>a.addEventListener("click",s=>{if(s.target.closest("[data-close-graph]")){s.stopPropagation(),Gs();return}de(a.dataset.path)}))}function fn(){ve=!0,Xe=null,de(ge)}function Gs(){ve=!1,Xe=null,F===ge&&(F="/customer-portal/src/main/java/com/nori/OrderService.java"),fe(),de(F)}function je(){const e=document.getElementById("vsEditor");if(!e)return;const t=document.getElementById("vsTitle");t&&(t.textContent="Git Graph — nori-system — Vizual Studio Code"),fe();const a=mn(),s=ie.map((n,i)=>{const r=Ra[n.branch]||"var(--accent)",d=Xe===n.hash,o=n.diff.split(`
`).map(p=>{const u=h(p);return p.startsWith("+")?`<div class="diff-add">${u}</div>`:p.startsWith("-")?`<div class="diff-del">${u}</div>`:`<div>${u}</div>`}).join(""),c=n.author==="Casey"&&(n.diff.includes("SearchBar")||n.diff.includes("legacyRoutes")||n.msg.includes("0043"));(n.hash==="3f2a9c1"||n.msg.includes("INV-2024-0017"))&&n.author;const m=a&&c&&!l.hasFlag("ch1_revert_done")&&l.hasFlag("sawyer_seq_started");return`
      <div class="gitgraph-row ${d?"expanded":""}" data-hash="${n.hash}">
        <div class="gitgraph-row__main">
          <div class="gitgraph-graph-col">
            ...
            ${i<ie.length-1?'<span class="gitgraph-vline"></span>':""}
          </div>
    ...
    <div class="gitgraph-editor">
      <div class="gitgraph-editor__header">
        <div style="display:flex;align-items:center;gap:8px">
          ...
          <b>Git Graph</b>
          <span class="small muted">${ie.length} commits — 5 branches</span>
        </div>
        <div class="gitgraph-legend">
          ${Object.entries(Ra).map(([n,i])=>`<span class="gitgraph-branch" style="background:${i}22;color:${i};border-color:${i}44">${h(n)}</span>`).join("")}
        </div>
      </div>
  ...
  `,e.querySelectorAll(".gitgraph-row__main").forEach(n=>{n.addEventListener("click",i=>{if(i.target.closest(".gitgraph-revert-btn"))return;const r=n.closest(".gitgraph-row")?.dataset.hash;r&&(Xe=Xe===r?null:r,je())})}),e.querySelectorAll(".gitgraph-revert-btn").forEach(n=>{n.addEventListener("click",i=>{i.stopPropagation();const r=n.dataset.revert;r&&qs(r)})}),L("$ open Git Graph")}function Js(e){const t=e.split(`
`).filter(s=>s.trim()!=="");if(!t.length)return{header:[],rows:[]};const a=s=>{const n=[];let i="",r=!1;for(let d=0;d<s.length;d++){const o=s[d];o==='"'?r&&s[d+1]==='"'?(i+='"',d++):r=!r:o===","&&!r?(n.push(i),i=""):i+=o}return n.push(i),n};return{header:a(t[0]),rows:t.slice(1).map(a)}}function Ys(e,t){const{header:a,rows:s}=Js(t),n=`<thead><tr>${a.map(r=>`<th>${h(r)}</th>`).join("")}</tr></thead>`,i=`<tbody>${s.map((r,d)=>`<tr>${r.map(o=>`<td>${h(o)}</td>`).join("")}${r.length<a.length?`<td colspan="${a.length-r.length}"></td>`:""}</tr>`).join("")}</tbody>`;return`
    <div class="csv-view">
  ...
  `}function de(e){if(Ee(e)){const i=document.getElementById("vsEditor");i&&(i.innerHTML='<div class="editor__lines" style="padding:16px;color:var(--fg-muted)">檔案不存在或尚未解鎖 — 嘗試 Search 搜尋 "Sawyer" 或觸發隱藏邏輯</div>');return}if(e===ge){F=e,Ce(),je(),Le(document.getElementById("vsQuickOpen")?.value.trim().toLowerCase()||"");return}F=e,Ce();const t=S.getFile(e),a=da(e),s=document.getElementById("vsEditor");if(!s)return;if((e==="/customer-portal/src/main/java/com/nori/OrderService.java"||e==="/customer-portal/src/billing/service.js")&&Kn("vscode_viewed"),a==null)s.innerHTML='<div class="editor__lines" style="padding:16px;color:var(--fg-muted)">檔案不存在或尚未解鎖 — 嘗試 Search 搜尋 "Sawyer" 或觸發隱藏邏輯</div>';else if(e.toLowerCase().endsWith(".csv"))s.innerHTML=Ys(e,a);else{const i=t?.meta?.lang||(e.endsWith(".py")?"python":e.endsWith(".java")?"java":"javascript");s.innerHTML=`
...
`).map((d,o)=>`<div class="editor__gutter-line" style="height:20px;line-height:20px">${o+1}</div>`).join("")}</div>
    ...
    `;const r=document.getElementById("vsEditorArea");r&&(r.addEventListener("input",d=>{const o=d.target.value;Os(e,o);const c=o.split(`
`).length,m=s.querySelector(".editor__gutter");m&&(m.innerHTML=Array.from({length:c},(T,A)=>`<div class="editor__gutter-line" style="height:20px;line-height:20px">${A+1}</div>`).join(""));const p=r.selectionStart,u=o.slice(0,p),v=u.split(`
`).length,g=u.split(`
`).pop().length+1,y=document.getElementById("vsCursorInfo");y&&(y.textContent=`Ln ${v}, Col ${g}`)}),r.addEventListener("click",d=>{const o=r.selectionStart,c=r.value.slice(0,o),m=c.split(`
`).length,p=c.split(`
`).pop().length+1,u=document.getElementById("vsCursorInfo");u&&(u.textContent=`Ln ${m}, Col ${p}`)}),r.addEventListener("keydown",d=>{if(d.key==="Tab"){d.preventDefault();const o=r.selectionStart,c=r.selectionEnd;r.value=r.value.substring(0,o)+"  "+r.value.substring(c),r.selectionStart=r.selectionEnd=o+2,r.dispatchEvent(new Event("input"))}}),e.includes("OrderService")&&setTimeout(()=>r.focus(),50))}const n=document.getElementById("vsTitle");n&&(n.textContent=`${e.split("/").pop()} — ${e} — nori-system — Vizual Studio Code`),Le(document.getElementById("vsQuickOpen")?.value.trim().toLowerCase()||""),fe(),L(`$ open ${e}`)}function Ne(){const e=document.getElementById("scmChanges");if(!e)return;const t=[...z.entries()].filter(([a,s])=>s!==pt(a));if(!t.length){e.innerHTML=`<div class="small muted" style="padding:8px 0">修改完成後在這邊提交
 目前沒有變更 — 編輯後的改動會顯示於此</div>`;return}e.innerHTML=`
  ...
  `,e.querySelectorAll(".scm__file").forEach(a=>a.addEventListener("click",()=>de(a.dataset.path)))}function Ks(e){const t={1:.9,2:.85,3:.8,4:.75,5:.7},a=e.split(`
`),s={};let n=null,i="";a.forEach((r,d)=>{const o=r.match(/case\s*([1-5])\s*:\s*price\s*\*=\s*([0-9.]+%?)/i);if(o){const c=parseInt(o[1],10);let m=o[2].replace("%","").trim(),p=parseFloat(m);p>1&&(p=p/100),s[c]={val:p,line:d+1,raw:r.trim()}}else{const c=r.match(/case\s*([1-5])\s*:\s*price\s*=\s*price\s*\*\s*([0-9.]+)/i);if(c){const m=parseInt(c[1],10);let p=parseFloat(c[2]);p>1&&(p=p/100),s[m]={val:p,line:d+1,raw:r.trim()}}}});for(let r=1;r<=5;r++){const d=t[r],o=s[r];if(!o)return n=a.findIndex(c=>c.includes(`case ${r}:`))+1||18+r,i=`缺少 case ${r} 或格式無法解析`,{ok:!1,line:n,detail:i,found:s};if(Math.abs(o.val-d)>.001)return{ok:!1,line:o.line,detail:`VIP${r} 應為 ${(d*100).toFixed(0)}% (0.${String(d).split(".")[1].padEnd(2,"0")})，目前為 ${(o.val*100).toFixed(0)}%`,found:s}}return{ok:!0,found:s}}function Qs(){const e=document.getElementById("scmCommitMsg"),t=document.getElementById("scmCommitStatus"),a=e?.value.trim()||"fix: correct VIP discount";if(![...z.entries()].filter(([E,_])=>_!==pt(E)).length){t&&(t.textContent="沒有變更可提交 — 請先編輯 OrderService.java");return}const s="/customer-portal/src/main/java/com/nori/OrderService.java",n=da(s);if(n==null){t&&(t.textContent="找不到 OrderService.java");return}const i=Ks(n);if(!i.ok){const E=document.getElementById("sonarModal"),_=document.getElementById("sonarModalBody");_&&(_.textContent=`SonarQube 掃描失敗 — 計算錯誤
...
請修正後重新 Commit。`),E&&(E.style.display="flex"),t&&(t.innerHTML=`<span style="color:var(--error)">✕ SonarQube: 行 ${i.line} 計算錯誤</span>`),L(`✕ commit 失敗 — SonarQube 行 ${i.line}: ${i.detail}`);return}const r="/file-system/src/components/SearchBar.jsx",d=pt(r)||"",o=da(r)||d,c=o.includes("legacyRoutes"),m=o.includes("resolveLegacyPath"),p=d.includes("legacyRoutes")&&!c&&!m;if(Array.from(z.keys()).includes(r),l.hasFlag("ch0_vip_fixed")&&!l.hasFlag("ch1_0043_committed")&&!p){const E=document.getElementById("sonarModal"),_=document.getElementById("sonarModalBody");_&&(_.textContent=`SonarQube 掃描失敗 — 未移除已棄用的 legacy 入口

檔案: ${r}
錯誤: 偵測到未移除的 legacyRoutes / resolveLegacyPath 區塊`),E&&(E.style.display="flex"),t&&(t.innerHTML='<span style="color:var(--error)">✕ SonarQube: 尚未移除 legacyRoutes 區塊 (SearchBar.jsx)</span>');return}if(p&&l.hasFlag("ch0_vip_fixed")&&!l.hasFlag("ch1_0043_committed")){let w=function({appSub:b,sender:f,avatarBg:B,avatarText:k,msg:V,chatId:be,duration:nt}){if(be&&vn(be))return;const ze=nt||4e3,O=document.createElement("div");return O.id="wa-win-notif-"+Date.now()+"-"+Math.random().toString(36).slice(2,6),O.setAttribute("role","alert"),O.innerHTML=`<div class="win-notif__app"><img src="/arg-game-it-company-secret/icon/whatsup.svg" alt="WhatUp" width="20" height="20" style="width:20px;height:20px;object-fit:contain" /><span class="win-notif__app-name">WhatUp</span><span class="win-notif__app-sub">${h(b)}</span><button class="win-notif__close" aria-label="關閉">✕</button></div><div class="win-notif__body"><div class="win-notif__avatar" style="background:${B}">${h(k)}</div><div class="win-notif__text"><div class="win-notif__sender">${h(f)}</div><div class="win-notif__msg">${h(V)}</div><div class="win-notif__time">剛剛 · 點擊開啟對話</div></div></div><div class="win-notif__progress" style="animation: winNotifShrink ${ze}ms linear forwards"></div>`,O.style.cssText="position:fixed;right:16px;bottom:60px;width:360px;background:#2d2d2d;color:#f0f0f0;border:1px solid rgba(255,255,255,.12);border-radius:8px;box-shadow:0 8px 28px rgba(0,0,0,.45);z-index:1100;overflow:hidden;cursor:pointer;opacity:0;transform:translateY(12px);transition:opacity .28s,transform .28s;",O.addEventListener("click",Ae=>{Ae.target.closest(".win-notif__close")||(O.remove(),M(()=>Promise.resolve().then(()=>re).then(_e=>{_e.setActiveView&&(_e.setActiveView("whatsapp"),localStorage.setItem("cc_active_view","whatsapp"))}),void 0),be&&M(()=>Promise.resolve().then(()=>le).then(_e=>_e.openChat(be)),void 0))}),O.querySelector(".win-notif__close")?.addEventListener("click",Ae=>{Ae.stopPropagation(),O.remove()}),document.body.appendChild(O),requestAnimationFrame(()=>{O.style.opacity="1",O.style.transform="none"}),setTimeout(()=>{O.style.opacity="0",O.style.transform="translateY(8px)",setTimeout(()=>O.remove(),300)},ze),O};l.setFlag("ch1_0043_committed",!0);const E=Math.random().toString(36).slice(2,8),_=Array.from(z.entries()).map(([b,f])=>`M ${b}`).join(`
`);ce.unshift({hash:E,author:"Casey",date:new Date().toISOString().slice(0,10),msg:a,diff:_}),ie.unshift({hash:E,branch:"main",author:"Casey",date:new Date().toISOString().slice(0,10),msg:a,diff:_});for(const[b,f]of z.entries()){const B=S.getFile(b);B&&(B.content=f),S.registerFile(b,{content:f,meta:{lang:b.endsWith(".java")?"java":b.endsWith(".js")?"javascript":"text"}})}z.clear(),e&&(e.value=""),t&&(t.innerHTML=`<span style="color:var(--success)">✓ Commit 成功: ${E}</span>`),L(`✓ commit ${E} — ${a}`),Ce(),fe(),Le(),Ne(),ve&&F===ge&&je();try{M(()=>Promise.resolve().then(()=>ft).then(b=>b.markTicketDone&&b.markTicketDone("INV-2024-0043")),void 0)}catch{}setTimeout(()=>{l.setFlag("ch1_system_down",!0);let b=0;const f=setInterval(()=>{if(!l.hasFlag("ch1_system_down")||l.hasFlag("ch1_revert_done")){clearInterval(f);return}b++,M(()=>Promise.resolve().then(()=>le).then(B=>{const k=(B.getChats?B.getChats():[]).find(V=>V.id==="system-alert");if(k){const V=`⚠️ 警告 #${b}: 系統異常 — 檢測到異常，請檢查最近變更`;k.messages.push({id:"alert-"+Date.now()+"-"+b,from:"system",text:V,time:"今天",ts:Date.now(),read:"delivered",type:"text"}),k.preview=`⚠️ 警告 #${b}: 系統異常`,k.unread=(k.unread||0)+1,k.lastTime="今天",window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"system-alert"}}))}w({appSub:"System Alert",sender:"System Alert",avatarBg:"linear-gradient(135deg, #d93025, #fbbc05)",avatarText:"!",msg:`⚠️ 警告 #${b}: 系統異常 — 檢測到異常`,chatId:"system-alert",duration:4e3})}),void 0),b===5&&(setTimeout(()=>{M(()=>Promise.resolve().then(()=>le).then(B=>{const k=(B.getChats?B.getChats():[]).find(V=>V.id==="dev-team");k&&(k.messages.push({id:"sawyer-dev-"+Date.now(),from:"Sawyer",text:"各位，系統怎麼一直在告警？發生什麼事了？是誰剛才改了什麼？",time:"今天",ts:Date.now(),read:"delivered",type:"text"}),k.preview="Sawyer: 系統怎麼一直在告警？",k.lastTime="今天",k.unread=(k.unread||0)+1,window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"dev-team"}})),w({appSub:"Dev Team",sender:"Sawyer",avatarBg:"linear-gradient(135deg, #722F37, #8B1A1A)",avatarText:"S",msg:"各位，系統怎麼一直在告警？發生什麼事了？",chatId:"dev-team",duration:4e3}))}),void 0)},500),setTimeout(()=>{M(()=>Promise.resolve().then(()=>le).then(B=>{const k=(B.getChats?B.getChats():[]).find(V=>V.id==="dev-team");k&&(k.messages.push({id:"maggie-dev-"+Date.now(),from:"Maggie",text:"好像是剛才 INV-2024-0043 的修改，應該是最後一次變更就是這個任務",time:"今天",ts:Date.now(),read:"delivered",type:"text"}),k.preview="Maggie: 好像是 0043 的修改...",k.lastTime="今天",k.unread=(k.unread||0)+1,window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"dev-team"}})),w({appSub:"Dev Team",sender:"Maggie",avatarBg:"linear-gradient(135deg, #25D366, #128C7E)",avatarText:"M",msg:"好像是 INV-2024-0043 的修改，最後一次變更就是這個",chatId:"dev-team",duration:4e3}))}),void 0)},5500),setTimeout(()=>{M(()=>Promise.resolve().then(()=>le).then(B=>{const k=(B.getChats?B.getChats():[]).find(V=>V.id==="sawyer");k&&(k.messages.push({id:"sawyer-pm-"+Date.now(),from:"Sawyer",text:"Casey，麻煩你先把 0043 的改動 revert 吧，系統要緊，先回滾再說",time:"今天",ts:Date.now(),read:"delivered",type:"text"}),k.preview="Sawyer: 麻煩你先把 0043 revert",k.lastTime="今天",k.unread=(k.unread||0)+1,window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"sawyer"}})),w({appSub:"Sawyer",sender:"Sawyer",avatarBg:"linear-gradient(135deg, #722F37, #8B1A1A)",avatarText:"S",msg:"Casey，麻煩你先把 0043 的改動 revert 吧",chatId:"sawyer",duration:4e3}),B.startSawyerRevertSeq&&(B.startSawyerRevertSeq(),ve&&setTimeout(()=>je(),200)))}),void 0)},10500))},5e3)},5e3);return}const u=c&&m&&l.hasFlag("ch1_system_down")&&!l.hasFlag("ch1_revert_done"),v=a.toLowerCase().includes("revert")&&l.hasFlag("ch1_system_down")&&!l.hasFlag("ch1_revert_done");if(u||v){if(u)for(const[b,f]of z.entries()){S.registerFile(b,{content:f,meta:{lang:b.endsWith(".js")?"javascript":b.endsWith(".java")?"java":"text"}});const B=S.getFile(b);B&&(B.content=f)}else if(ba(),Fe){S.registerFile("/file-system/src/components/SearchBar.jsx",{content:Fe,meta:{lang:"javascript"}});const b=S.getFile("/file-system/src/components/SearchBar.jsx");b&&(b.content=Fe)}l.setFlag("ch1_revert_done",!0),l.setFlag("ch1_system_down",!1);const E=Math.random().toString(36).slice(2,8),_=u,w=_?`M /file-system/src/components/SearchBar.jsx
+ restored legacyRoutes / resolveLegacyPath (paste back)`:"M revert 0043";ce.unshift({hash:E,author:"Casey",date:new Date().toISOString().slice(0,10),msg:a,diff:w}),ie.unshift({hash:E,branch:"main",author:"Casey",date:new Date().toISOString().slice(0,10),msg:a,diff:w}),z.clear(),t&&(t.innerHTML=`<span style="color:var(--success)">✓ Commit 成功 (revert): ${E}</span>`),L(`✓ commit ${E} — ${a} (revert)`),Ce(),fe(),Le(),Ne(),ve&&je(),hn(_?"paste-back":"keyword");try{M(()=>Promise.resolve().then(()=>ft).then(b=>{const f=b.getTickets().find(B=>B.key==="INV-2024-0043");f&&(f.status="Done",f.history.push({from:"To Do",to:"Done",by:"Casey",at:new Date().toISOString().slice(0,10)}))}),void 0)}catch{}return}const g=Math.random().toString(36).slice(2,8),y=new Date().toISOString().slice(0,10),T="Casey",A=`M ${s}
`+Object.entries(i.found).map(([E,_])=>`  case ${E}: price*=${_.val.toFixed(2)}`).join(`
`);ce.unshift({hash:g,author:T,date:y,msg:a,diff:A}),ie.unshift({hash:g,branch:"main",author:T,date:y,msg:a,diff:A});const N=S.getFile(s);N&&(N.content=n),S.registerFile(s,{content:n,meta:{lang:"java"}}),z.clear(),e&&(e.value=""),t&&(t.innerHTML=`<span style="color:var(--success)">✓ Commit 成功: ${g}</span>`),L(`✓ commit ${g} — ${a}`),Ce(),fe(),Le(),Ne(),ve&&F===ge&&je();try{M(()=>Promise.resolve().then(()=>ft).then(E=>{E.markTicketDone?E.markTicketDone("INV-2024-0042"):E.completeVipTicket&&E.completeVipTicket()}),void 0)}catch{}l.setFlag("ch0_vip_fixed",!0),l.setFlag("onboarding_done",!0),setTimeout(()=>{M(()=>Promise.resolve().then(()=>re).then(E=>{E.setActiveView&&(E.setActiveView("jira"),localStorage.setItem("cc_active_view","jira"))}),void 0).catch(()=>{localStorage.setItem("cc_active_view","jira"),document.querySelectorAll(".view").forEach(E=>E.classList.toggle("active",E.id==="view-jira")),document.querySelectorAll(".taskbar__app").forEach(E=>E.classList.toggle("active",E.dataset.view==="jira"))}),setTimeout(()=>{const E=new CustomEvent("jira:refresh");window.dispatchEvent(E)},100)},400)}function Xs(){L('tip: 在 editor 搜尋 "calculateVipPrice" 找到 VIP 折扣邏輯'),L("tip: 編輯 OrderService.java 後至 Source Control 提交"),L("輸入 help 查看可用指令 · Tab 補全 · ↑↓ 歷史")}function L(e){const t=document.getElementById("vsTerminalHist"),a=document.getElementById("vsTerminal"),s=t||a;if(!s)return;const n=document.createElement("div");n.className="terminal__line",n.textContent=e,s.appendChild(n),t&&(t.scrollTop=t.scrollHeight),a&&(a.scrollTop=a.scrollHeight)}function Zs(e){const t=e.target,a=t.value;if(e.key==="Enter"){const s=a.trim();if(!s)return;$e.push(s),pe=$e.length,L(`➜ ${s}`),ti(s),t.value="",Ot=""}else if(e.key==="ArrowUp")e.preventDefault(),pe<=0?pe=0:pe--,Ot===""&&$e[pe]!==void 0&&(Ot=a),$e[pe]!==void 0&&(t.value=$e[pe]);else if(e.key==="ArrowDown")e.preventDefault(),pe++,pe>=$e.length?(pe=$e.length,t.value=Ot):t.value=$e[pe];else if(e.key==="Tab"){e.preventDefault();const s=ei(a);s&&(t.value=s)}}function ei(e){const t=["help","ls","cat ","grep ","git log","git diff","git blame","clear","echo "],a=S.listFiles("/customer-portal").filter(o=>!Ee(o.path)).map(o=>o.path),s=[...t,...a,...a.map(o=>o.split("/").pop())];if(!e)return e;const n=s.find(o=>o.startsWith(e));if(n)return n;const i=e.split(" "),r=i[i.length-1];if(!r)return e;const d=s.find(o=>o.endsWith(r)||o.includes(r));return d?(i[i.length-1]=d.split(" ").pop(),i.join(" ")):e}function ti(e){const[t,...a]=e.split(/\s+/),s=a.join(" ");switch(t){case"help":L("可用指令: ls [path], cat <file>, grep <keyword>, git log, git diff, git blame <file>, clear, echo <text>"),L("範例: cat /customer-portal/src/main/java/com/nori/OrderService.java");break;case"ls":{const n=a[0]||"/customer-portal";if(n.startsWith("/intranet")||n==="/intranet"){L(`ls: ${n}: 權限不足（內網資料已從 Vizual Studio Code 隱藏）`);break}const i=S.listFiles(n).filter(r=>r.path.startsWith("/customer-portal")&&!Ee(r.path));i.length?i.slice(0,20).forEach(r=>L(r.path)):L(`ls: ${n}: No such directory`),i.length>20&&L(`... ${i.length-20} more`);break}case"cat":{const n=a[0];if(!n){L("cat: 缺少檔案路徑");break}if(n.startsWith("/intranet")){L(`cat: ${n}: 權限不足（內網資料已從 Vizual Studio Code 隱藏，僅顯示官網系統）`);break}if(Ee(n)||Ee("/customer-portal"+(n.startsWith("/")?"":"/")+n)){L(`cat: ${n}: 檔案不存在或尚未解鎖`);break}const i=S.readFile(n)||S.readFile("/customer-portal"+(n.startsWith("/")?"":"/")+n);i==null?L(`cat: ${n}: 檔案不存在或尚未解鎖`):i.split(`
`).slice(0,80).forEach(r=>L(r));break}case"grep":{const n=s||a[0];if(!n){L("grep: 缺少關鍵字");break}const i=S.searchContent(n).filter(r=>r.path.startsWith("/customer-portal")&&!Ee(r.path));i.length?(L(`grep "${n}" 找到 ${i.length} 筆:`),i.slice(0,10).forEach(r=>L(`${r.path}: ${r.snippet.slice(0,80)}...`))):L(`grep: "${n}" 無結果（僅搜尋 customer-portal/file-system 官網系統）`);break}case"git":if(a[0]==="log")ce.forEach(n=>{L(`commit ${n.hash} (${n.date}) ${n.author}`),L(`    ${n.msg}`)});else if(a[0]==="diff")ce[1].diff.split(`
`).forEach(n=>{L(n)}),L("hint: 點擊 Source Control 右上角的 Git Graph 按鈕查看完整圖像化歷史");else if(a[0]==="blame"){const n=a[1]||F;L(`blame ${n}:`),(Ha[n]||Ha["/customer-portal/src/billing/service.js"]).forEach(i=>L(`${String(i.line).padStart(3)} ${i.commit} ${i.author}`))}else a[0]==="graph"?(fn(),L("→ 已開啟 Git Graph 編輯器分頁")):L("git: 未知子指令，試 help (支援: git log / git diff / git blame / git graph)");break;case"clear":{const n=document.getElementById("vsTerminalHist");n&&(n.innerHTML="");break}case"echo":L(s);break;default:L(`zsh: command not found: ${t} (試 help)`)}}function ai(){document.addEventListener("keydown",e=>{const t=e.ctrlKey||e.metaKey;if(e.key==="F1"){e.preventDefault();const a=document.getElementById("vsHelpOverlay");a&&(a.style.display=a.style.display==="flex"?"none":"flex");return}if(t&&e.key.toLowerCase()==="p"&&!e.shiftKey)e.preventDefault(),ni();else if(t&&e.shiftKey&&e.key.toLowerCase()==="f")e.preventDefault(),ee="search",Vt(),document.getElementById("vsSearchInput")?.focus();else if(t&&e.shiftKey&&e.key.toLowerCase()==="g")e.preventDefault(),ee="scm",Vt();else if(t&&e.shiftKey&&e.key.toLowerCase()==="d")e.preventDefault(),ee="debug",Vt();else if(e.key==="Escape"){wt();const a=document.getElementById("vsHelpOverlay");a&&(a.style.display="none");const s=document.getElementById("sonarModal");s&&(s.style.display="none")}else t&&e.key==="/"&&(e.preventDefault(),document.getElementById("vsTerminalInput")?.focus())})}function ni(){const e=document.getElementById("quickOpen"),t=document.getElementById("quickOpenInput");!e||!t||(e.classList.add("open"),t.value="",t.focus(),yn(""))}function wt(){document.getElementById("quickOpen")?.classList.remove("open")}function yn(e){const t=document.getElementById("quickOpenList");if(!t)return;const a=(e||"").trim().toLowerCase();let s=S.listFiles("/customer-portal").filter(i=>!Ee(i.path)),n=null;if(a.includes(":")){const[i,r]=a.split(":");n=parseInt(r,10),s=s.filter(d=>d.path.toLowerCase().includes(i))}else a&&(s=s.filter(i=>i.path.toLowerCase().includes(a)));if(s=s.slice(0,10),!s.length){t.innerHTML='<div class="quickopen__item muted">無符合檔案 — 試輸入 OrderService / billing</div>';return}t.innerHTML=s.map((i,r)=>`
    <div class="quickopen__item ${r===0?"active":""}" data-path="${i.path}">
      <span>${h(i.path)}</span>
      <span class="quickopen__kbd">${i.path.split(".").pop()}</span>
    </div>
  `).join(""),t.querySelectorAll(".quickopen__item").forEach(i=>{i.addEventListener("click",()=>{de(i.dataset.path),n&&ii(n),wt()})})}function si(e){if(e.key==="Escape"){wt();return}if(e.key==="Enter"){const t=document.querySelector("#quickOpenList .quickopen__item.active")||document.querySelector("#quickOpenList .quickopen__item");t&&(de(t.dataset.path),wt());return}if(e.key==="ArrowDown"||e.key==="ArrowUp"){e.preventDefault();const t=[...document.querySelectorAll("#quickOpenList .quickopen__item")];if(!t.length)return;let a=t.findIndex(s=>s.classList.contains("active"));t[a]?.classList.remove("active"),a=e.key==="ArrowDown"?Math.min(a+1,t.length-1):Math.max(a-1,0),a<0&&(a=0),t[a]?.classList.add("active")}}function ii(e){const t=document.getElementById("vsEditorArea");if(t){const n=t.value.split(`
`);let i=0;for(let r=0;r<Math.min(e-1,n.length);r++)i+=n[r].length+1;t.focus(),t.setSelectionRange(i,i);return}const a=document.getElementById("vsEditor");if(!a)return;const s=a.querySelector(`[data-ln="${e}"]`);s&&s.scrollIntoView({behavior:"smooth",block:"center"})}var ft=fa({addTicket0043:()=>_n,getTickets:()=>ui,markTicketDone:()=>pi,mountJira:()=>_a}),ne=[{key:"INV-2024-0017",title:"官網首頁文案顯示錯誤 — Hero 標語與成立年份顯示錯誤",status:"Done",assignee:"Parker",priority:"Medium",points:2,epic:"Frontend",desc:`【問題描述】
...
JQL: sprint = 24 AND status != Done`,comments:[],attachments:[],history:[]},{key:"INV-2020-0003",title:"人力資源系統 — 關閉系統",status:"Done",assignee:"deleted user",priority:"High",points:3,epic:"HR",desc:"人力資源管理系統將遷移到Zero System, 此系統將永久關閉。關閉前需確保所有資料已成功備份到新系統",comments:["deleted user: 已完成關閉"],attachments:[],history:[{from:"To Do",to:"Done",by:"deleted user",at:"2020-02-28"}]}],Ht=null,xt="all",kt="";function Oe(){try{l.set("jiraTicketsData",JSON.parse(JSON.stringify(ne))),l.set("jiraMeta",{activeSwimlane:xt,currentFilter:kt}),l.save(!0)}catch{}}function ri(){try{const e=l.get("jiraTicketsData");if(Array.isArray(e)&&e.length){ne.length=0;for(const a of e)ne.push(a)}else if((l.hasFlag("ch1_event1_triggered")||l.get("jiraTickets")&&l.get("jiraTickets")["INV-2024-0043"])&&!ne.some(a=>a.key==="INV-2024-0043")){_n();return}const t=l.get("jiraMeta");if(t&&typeof t=="object"&&(typeof t.activeSwimlane=="string"&&(xt=t.activeSwimlane),typeof t.currentFilter=="string"&&(kt=t.currentFilter)),l.hasFlag("ch0_vip_fixed")){const a=ne.find(s=>s.key==="INV-2024-0042");a&&a.status!=="Done"&&(a.status="Done")}if(l.hasFlag("ch1_0043_committed")){const a=ne.find(s=>s.key==="INV-2024-0043");a&&a.status!=="Done"&&(a.status="Done")}}catch{}}function _a(){ri();const e=document.getElementById("view-jira");e&&(e.innerHTML=`
    <div class="jira">
      <div class="jira__app">
  ...
  `,oi(),He(),document.getElementById("jiraDetailBackdrop")?.addEventListener("click",()=>{document.getElementById("jiraDetail").style.display="none",document.getElementById("jiraDetailBackdrop").style.display="none"}))}function oi(){document.getElementById("jiraSearch")?.addEventListener("input",e=>{kt=e.target.value,Oe(),He()}),document.getElementById("jiraAssignee")?.addEventListener("change",e=>{kt=document.getElementById("jiraSearch").value,Oe(),He()}),document.getElementById("jiraSwimlane")?.addEventListener("change",e=>{xt=e.target.value,Oe(),He()})}function li(e){if(!e.trim())return()=>!0;const t=e.split(/\s+AND\s+/i).map(a=>{const s=a.match(/^\s*(status|assignee|key|epic|text|priority)\s*(=|~)\s*"?([^"]+)"?\s*$/i);if(!s){const o=a.toLowerCase().replace(/["']/g,"");return c=>(c.key+c.title+c.desc+c.assignee+c.epic).toLowerCase().includes(o)}const[,n,i,r]=s,d=r.trim().replace(/^"|"$/g,"").toLowerCase();return o=>{const c=n.toLowerCase();let m="";return c==="status"?m=o.status.toLowerCase():c==="assignee"?m=o.assignee.toLowerCase():c==="key"?m=o.key.toLowerCase():c==="epic"?m=o.epic.toLowerCase():c==="priority"?m=o.priority.toLowerCase():c==="text"&&(m=(o.key+" "+o.title+" "+o.desc).toLowerCase()),i==="="?m===d:m.includes(d)}});return a=>t.every(s=>s(a))}function He(){const e=document.getElementById("jiraBoard");if(!e)return;const t=document.getElementById("jiraAssignee")?.value||"",a=li(kt);let s=ne.filter(n=>a(n));if(t&&(s=s.filter(n=>n.assignee===t)),xt!=="all"){const n=xt,i={};s.forEach(r=>{const d=r[n]||"未分類";i[d]||(i[d]=[]),i[d].push(r)}),e.innerHTML=Object.entries(i).map(([r,d])=>{const o={"To Do":[],"In Progress":[],Done:[]};return d.forEach(c=>o[c.status]?.push(c)),`
      ...
      `}).join("")||'<div class="muted small" style="padding:12px">無符合條件的票據 — 試 JQL: status = "To Do"</div>'}else{const n={"To Do":[],"In Progress":[],Done:[]};s.forEach(i=>n[i.status]?.push(i)),e.innerHTML=Object.entries(n).map(([i,r])=>Va(i,r)).join("")}di()}function Va(e,t){return`
    <div class="jira__col" data-col="${e}">
      ...
      <div class="jira__dropzone" data-col="${e}">
        ${t.map(a=>ci(a)).join("")||'<div class="jira__empty">拖曳至此</div>'}
      </div>
    </div>
  `}function bn(e){return e.key.includes("0042")||e.epic==="Billing"?{cls:"story",icon:"fa-solid fa-bookmark",label:"Story"}:e.epic==="HR"||e.key.includes("0003")?{cls:"task",icon:"fa-solid fa-square-check",label:"Task"}:e.epic==="Frontend"?{cls:"task",icon:"fa-solid fa-square-check",label:"Task"}:e.priority==="High"&&e.status!=="Done"?{cls:"bug",icon:"fa-solid fa-bug",label:"Bug"}:{cls:"story",icon:"fa-solid fa-bookmark",label:"Story"}}function ci(e){const t=bn(e),a=e.priority==="High"?"High":e.priority==="Medium"?"Medium":"Low",s=e.priority==="High"?"fa-solid fa-angle-up":e.priority==="Medium"?"fa-solid fa-equals":"fa-solid fa-angle-down",n=e.assignee?e.assignee.charAt(0).toUpperCase():"?",i=e.assignee==="Casey"?"#0052cc":e.assignee==="Parker"?"#0065ff":e.assignee==="Jessie"?"#6554c0":"#6b778c";return`
  ...
  `}function di(){document.querySelectorAll(".ticket").forEach(e=>{e.addEventListener("dragstart",t=>{Ht=e.dataset.key,e.classList.add("dragging"),t.dataTransfer.effectAllowed="move"}),e.addEventListener("dragend",t=>{e.classList.remove("dragging"),Ht=null}),e.addEventListener("click",()=>St(e.dataset.key))}),document.querySelectorAll(".jira__dropzone").forEach(e=>{e.addEventListener("dragover",t=>{t.preventDefault(),e.classList.add("drag-over")}),e.addEventListener("dragleave",()=>{e.classList.remove("drag-over")}),e.addEventListener("drop",t=>{t.preventDefault(),e.classList.remove("drag-over");const a=e.dataset.col;if(!Ht)return;const s=ne.find(i=>i.key===Ht);if(!s||s.status===a)return;const n=s.status;s.status=a,s.history.push({from:n,to:a,by:"你",at:new Date().toISOString().slice(0,10)}),l.set("jiraTickets."+s.key,!0),Oe(),He(),St(s.key)})})}function St(e){const t=ne.find(o=>o.key===e),a=document.getElementById("jiraDetail"),s=document.getElementById("jiraDetailBackdrop");if(!t||!a)return;l.set("jiraTickets."+e,!0),e==="INV-2024-0042"&&Kn("jiua_viewed"),s&&(s.style.display="block"),a.style.display="flex";const n=bn(t),i=t.status==="Done"?"badge--done":t.status==="In Progress"?"badge--inprogress":"badge--todo";a.innerHTML=`
...
${m.snippet}`)})}),a.querySelectorAll("[data-move]").forEach(o=>{o.addEventListener("click",()=>{const c=o.dataset.move,m=t.status;t.status=c,t.history.push({from:m,to:c,by:"你",at:new Date().toISOString().slice(0,10)}),Oe(),He(),St(e)})}),document.getElementById("jiraAddComment")?.addEventListener("click",()=>{const o=document.getElementById("jiraCommentInput"),c=o?.value.trim();c&&(t.comments.push(`你: ${c}`),o.value="",Oe(),St(e),He())});function r(){a.style.display="none";const o=document.getElementById("jiraDetailBackdrop");o&&(o.style.display="none")}document.getElementById("jiraDetailClose")?.addEventListener("click",r),document.getElementById("jiraDetailClose2")?.addEventListener("click",r),document.getElementById("jiraCommentInput")?.addEventListener("keydown",o=>{o.key==="Enter"&&(o.preventDefault(),document.getElementById("jiraAddComment")?.click())});const d=o=>{o.key==="Escape"&&(r(),document.removeEventListener("keydown",d))};document.addEventListener("keydown",d)}function pi(e){const t=ne.find(s=>s.key===e);if(!t)return!1;if(t.status==="Done")return e==="INV-2024-0042"&&!l.hasFlag("ch0_vip_fixed")&&l.setFlag("ch0_vip_fixed",!0),!0;const a=t.status;return t.status="Done",t.history.push({from:a,to:"Done",by:"Casey",at:new Date().toISOString().slice(0,10)}),l.set("jiraTickets."+e,!0),e==="INV-2024-0042"&&l.setFlag("ch0_vip_fixed",!0),e==="INV-2024-0043"&&l.setFlag("ch1_0043_committed",!0),Oe(),document.getElementById("jiraBoard")&&(He(),St(e)),!0}function _n(){if(!ne.some(e=>e.key==="INV-2024-0043")){ne.push({key:"INV-2024-0043",title:"移除內網系統異常網頁的入口",status:"To Do",assignee:"Casey",priority:"Medium",points:2,epic:"internal system",desc:`【問題描述】使用內網系統時進入到異常網頁，移除不明網頁導向
...
const legacyRoutes = { archive: "/internal/portal" ... } // No longer used`}],history:[{from:"—",to:"To Do",by:"Maggie",at:new Date().toISOString().slice(0,10)}]}),Oe(),document.getElementById("jiraBoard")&&window.dispatchEvent(new CustomEvent("jira:ticketAdded",{detail:"INV-2024-0043"}));try{const e=new CustomEvent("jira:refresh");window.dispatchEvent(e)}catch{}}}function ui(){return ne}var Ie="";try{Ie="https://script.google.com/macros/s/AKfycbyFaCIO1fwsoRwXa-z1zD1NmSRctGDo6-6D2KAv1nmW2ITO2ZP8ZJ0QsRGO4GudTuUl/exec"}catch{}try{typeof window<"u"&&window.__GAS_URL&&(Ie=window.__GAS_URL)}catch{}var mi="https://script.google.com/macros/s/REPLACE_WITH_YOUR_DEPLOY_ID/exec",hi="REPLACE_WITH_YOUR_DEPLOY_ID";function yt(e){return e?e.includes(hi):!0}function Ze(){try{const e=localStorage.getItem("cc_gas_url")||"";if(e&&e.startsWith("https://")&&!yt(e))return e.trim()}catch{}try{if(typeof window<"u"&&window.__GAS_URL&&window.__GAS_URL.startsWith("https://")&&!yt(window.__GAS_URL))return window.__GAS_URL.trim()}catch{}return Ie&&Ie.startsWith("https://")&&!yt(Ie)?Ie.trim():mi}function wn(e){try{const t=(e||"").trim();t?localStorage.setItem("cc_gas_url",t):localStorage.removeItem("cc_gas_url");try{typeof window<"u"&&(window.__GAS_URL=t)}catch{}}catch{}}function Te(){const e=Ze();return e&&e.startsWith("https://")&&!yt(e)}var Wt="cc_analytics_consent",qa="cc_sid",xn="cc_analytics_queue",kn="cc_game_session",za="cc_game_session_history";function qe(){try{const e=localStorage.getItem(kn);if(!e)return null;const t=JSON.parse(e);return t&&t.id&&t.startAt?t:null}catch{return null}}function ht(e){try{localStorage.setItem(kn,JSON.stringify(e))}catch{}}function gi(){try{if(crypto.randomUUID)return"gs_"+crypto.randomUUID().slice(0,8)+"_"+Date.now().toString(36)}catch{}return"gs_"+Math.random().toString(36).slice(2,10)+"_"+Date.now().toString(36)}function pa(){return qe()}function ua(){const e=new Date,t=(()=>{try{return l.get("playtime")??0}catch{return 0}})(),a=(()=>{try{return l.get("currentChapter")??0}catch{return 0}})(),s={id:gi(),startAt:e.toISOString(),startAtMs:e.getTime(),startPlaytime:t,lastChapter:a,lastChapterEnterAtPlaytime:t,lastChapterEnterAtMs:e.getTime(),chapterTimes:{},whatsappLog:[],emailLog:[],ended:!1,endedAt:null,sessionStartSent:!1,sessionEndSent:!1};ht(s);try{l.set("__gameSessionId",s.id)}catch{}try{wa(s)}catch(n){console.warn("[analytics] sendSessionStart failed",n)}return s}function ma(){let e=qe();if(!e||e.ended)e=ua();else if(!e.sessionStartSent)try{wa(e)}catch{}return e}function Sn(e){(!e.chapterTimes||typeof e.chapterTimes!="object")&&(e.chapterTimes={})}function En(e){try{const t=qe();if(!t||t.ended)return;const a=(()=>{try{return l.get("playtime")??0}catch{return 0}})(),s=Date.now();Sn(t);const n=t.lastChapter,i=Math.max(0,a-(t.lastChapterEnterAtPlaytime??a));if(n!=null){const r=String(n);t.chapterTimes[r]=(t.chapterTimes[r]||0)+i}t.lastChapter=e,t.lastChapterEnterAtPlaytime=a,t.lastChapterEnterAtMs=s,ht(t)}catch{}}function vi(e){try{const t=(()=>{try{return l.get("playtime")??0}catch{return 0}})(),a=Date.now();Sn(e);const s=e.lastChapter,n=Math.max(0,t-(e.lastChapterEnterAtPlaytime??t));if(s!=null){const i=String(s);e.chapterTimes[i]=(e.chapterTimes[i]||0)+n}e.lastChapterEnterAtPlaytime=t,e.lastChapterEnterAtMs=a}catch{}}function fi({chatId:e,chatName:t,text:a,to:s}){try{const n=qe();if(!n||n.ended)return;const i=(()=>{try{return l.get("playtime")??0}catch{return 0}})(),r={chatId:e||"",chatName:t||e||"",to:s||"",preview:(a||"").slice(0,80),hash:xa(a||""),len:(a||"").length,body:(a||"").slice(0,500),ts:new Date().toISOString(),playtime:i};n.whatsappLog.push(r),n.whatsappLog.length>100&&(n.whatsappLog=n.whatsappLog.slice(-100)),ht(n)}catch{}}function yi({title:e,to:t,body:a}){try{const s=qe();if(!s||s.ended)return;const n=(()=>{try{return l.get("playtime")??0}catch{return 0}})(),i={title:e||"",to:(t||"").slice(0,100),preview:(a||"").slice(0,80),hash:xa(a||""),len:(a||"").length,body:(a||"").slice(0,1e3),ts:new Date().toISOString(),playtime:n};s.emailLog.push(i),s.emailLog.length>50&&(s.emailLog=s.emailLog.slice(-50)),ht(s)}catch{}}var bi={flee:"平凡的日常",cooperate:"合作",report:"舉報",resign:"離職",fried:"做對了嗎？"};function In(){try{const e=l.get("readArticles")||[],t=l.get("discoveredFiles")||[],a=l.get("endings")||l.get("unlockedEndings")||[],s=l.get("whatsappSentCount")||0,n=l.get("persistentStats")||{},i=n.readArticles||[],r=n.darkFileCount||0,d=n.whatsappSentCount||0,o=n.searchHistoryCount||0,c=n.flags||{};let m=10;try{const k=window.__vfs||null;if(k&&k.listDarkFiles){const V=k.listDarkFiles("/darknet");V.length&&(m=V.length)}}catch{}const p=[...new Set([...e,...i])],u=Math.max(s,d),v=Math.max((l.get("searchHistory")||[]).length,o),g=[...new Set([...a,...l.get("unlockedEndings")||[],...n.unlockedEndings||[]])],y=["https://sawyer-blog.example/2001-10-18","https://sawyer-blog.example/2003-04-27","https://sawyer-blog.example/2004-11-13","https://sawyer-blog.example/2006-09-01","https://sawyer-blog.example/2007-01-11","https://sawyer-blog.example/2007-01-12","https://sawyer-blog.example/2010-06-06","https://sawyer-blog.example/2012-07-07","https://sawyer-blog.example/2013-01-01","https://sawyer-blog.example/2023-04-25","https://sawyer-blog.example/2023-05-01","https://sawyer-blog.example/2023-05-10","https://sawyer-blog.example/2023-12-20","https://sawyer-blog.example/2024-01-15","https://sawyer-blog.example/2024-03-20"],T=["https://school.example/guangzhi-essay-sawyer"],A=["https://news.example/car-accident-2023","https://news.example/car-accident-investigation-2023","https://news.example/ping-wo-suspicious-man-2023","https://news.example/police-clarification-2023"],N=[...y,...T,...A],E=[...y,"https://mary-blog.example/kyoto-sakura-2024","https://mary-blog.example/one-person-kitchen","https://mary-blog.example/danshari-half-year","https://peter-blog.example/python-one-year","https://peter-blog.example/vim-vs-vscode","https://peter-blog.example/nas-ds220","https://peter-blog.example/code-easter-eggs","https://paul-blog.example/tainan-beef-soup","https://paul-blog.example/hand-drip-coffee","https://paul-blog.example/keelung-night-market","https://emma-blog.example/contax-t2-taipei","https://emma-blog.example/iceland-aurora","https://david-blog.example/vinyl-jazz-20","https://david-blog.example/livehouse-map"],_=Math.max(t.filter(k=>k.startsWith("/darknet")).length,r),w=[{id:"secret_entry",title:"解鎖秘密入口",total:2,current:Math.max(l.hasFlag("portal_simple_entered")?1:0,c.portal_simple_entered?1:0)+Math.max(l.hasFlag("portal_hash_entered")?1:0,c.portal_hash_entered?1:0)},{id:"boss_whisper",title:"老闆知音",total:20,current:N.filter(k=>p.includes(k)).length},{id:"too_much",title:"你知道得太多了",total:m,current:Math.min(_,m)},{id:"all_endings",title:"作者感謝您",total:5,current:g.length},{id:"social",title:"社牛",total:10,current:Math.min(u,10)},{id:"reader",title:"閱讀達人",total:29,current:E.filter(k=>p.includes(k)).length},{id:"miracle",title:"你沒有被解僱是奇蹟",total:1,current:Math.max(l.hasFlag("sawyer_abuse_sent")?1:0,c.sawyer_abuse_sent?1:0)},{id:"net_addict",title:"網路成癮",total:50,current:Math.min(v,50)}],b=w.filter(k=>k.current>=k.total).map(k=>({id:k.id,title:k.title})),f=w.map(k=>({id:k.id,title:k.title,done:k.current>=k.total,progress:`${k.current}/${k.total}`,pct:Math.round(k.current/k.total*100)})),B={};return f.forEach(k=>{B[k.title]=k.progress}),{gained:b,all:f,gainedIds:b.map(k=>k.id),archMap:B}}catch{return{gained:[],all:[],gainedIds:[],archMap:{}}}}function Cn(e){return bi[e]||e||""}function Ln(e,t){return{whatsup:(e||[]).map(a=>({to:a.to||a.chatName||a.chatId||"",content:a.body!=null?a.body:a.preview||""})),email:(t||[]).map(a=>({to:a.to||"",title:a.title||"",content:a.body!=null?a.body:a.preview||""}))}}function Tn(){return In().archMap||{}}function An(e){const t=qe()||ma();vi(t);const a=new Date,s=(()=>{try{return l.get("playtime")??0}catch{return 0}})(),n=Math.max(0,s-(t.startPlaytime||0)),i=In(),r=(()=>{try{return l.get("endings")||[]}catch{return[]}})();let d=Array.isArray(t.whatsappLog)?[...t.whatsappLog]:[];if(!d.length)try{const T=l.get("whatsappChats");if(Array.isArray(T)){const A=[];for(const N of T)for(const E of N.messages||[])E.from==="you"&&A.push({chatId:N.id,chatName:N.name,preview:(E.text||"").slice(0,80),len:(E.text||"").length,ts:E.ts?new Date(E.ts).toISOString():new Date().toISOString(),body:(E.text||"").slice(0,500),to:N.name||N.id});A.length&&(d=A.slice(-100))}}catch{}const o=Array.isArray(t.emailLog)?[...t.emailLog]:[],c=t.chapterTimes||{},m={chp0_play_time:Number(c[0]||0),chp1_play_time:Number(c[1]||0),chp2_play_time:Number(c[2]||0),chp3_play_time:Number(c[3]||0),chp4_play_time:Number(c[4]||0)},p=Cn(e),u=Ln(d,o),v=i.archMap||{},g=(()=>{try{return l.get("settings.language")||"zh-TW"}catch{return"zh-TW"}})(),y=typeof navigator<"u"?navigator.userAgent.slice(0,200):"";return{start_date:t.startAt,end_date:a.toISOString(),session_id:t.id,total_play_time:n,lang:g,ua:y,...m,ending:p||e||"",inputted_content:JSON.stringify(u),archievement_list:JSON.stringify(v),_debug:{game_session_id:t.id,startAt:t.startAt,playtime:s,chapterTimes:t.chapterTimes,whatsapp_count:d.length,email_count:o.length,ach:i,endings:r}}}function _i(){let e="zh-TW",t="";try{e=l.get("settings.language")||"zh-TW"}catch{}try{t=typeof navigator<"u"?navigator.userAgent.slice(0,200):""}catch{}return{lang:e,ua:t}}function wa(e){try{const t=e||qe();if(!t||t.sessionStartSent)return;const{lang:a,ua:s}=_i();t.sessionStartSent=!0,ht(t),Bn({action:"session_start",start_date:t.startAt,end_date:"",session_id:t.id,total_play_time:0,lang:a,ua:s,chp0_play_time:0,chp1_play_time:0,chp2_play_time:0,chp3_play_time:0,chp4_play_time:0,ending:"",inputted_content:JSON.stringify({whatsup:[],email:[]}),archievement_list:JSON.stringify(Tn())})}catch(t){console.warn("[analytics] sendSessionStart failed",t)}}function $n(e){try{const t=qe();if(!t||t.sessionEndSent||t.ended&&t.sessionEndSent)return;const a=An(e),s=new Date;t.ended=!0,t.endedAt=s.toISOString(),t.lastEnding=e||"",t.sessionEndSent=!0;try{const n=localStorage.getItem(za),i=n?JSON.parse(n):[];i.push({id:t.id,ending:e,endedAt:t.endedAt,total_play_time:a.total_play_time}),localStorage.setItem(za,JSON.stringify(i.slice(-20)))}catch{}ht(t),Bn({action:"session_end",start_date:a.start_date,end_date:a.end_date,session_id:a.session_id,total_play_time:a.total_play_time,lang:a.lang,ua:a.ua,chp0_play_time:a.chp0_play_time,chp1_play_time:a.chp1_play_time,chp2_play_time:a.chp2_play_time,chp3_play_time:a.chp3_play_time,chp4_play_time:a.chp4_play_time,ending:a.ending,inputted_content:a.inputted_content,archievement_list:a.archievement_list})}catch(t){console.warn("[analytics] sendSessionEnd failed",t)}}function Bn(e){const t={timestamp:new Date().toISOString(),...e};if(!Re()){const a=Ke();a.push(t),Qe(a);return}if(!Te()){const a=Ke();a.push(t),Qe(a),console.warn("[analytics] 已記錄至本地隊列（待設定 GAS_URL 後補送）",t);return}Pn(t)}function Re(){try{return localStorage.getItem(Wt)==="1"}catch{return!1}}function qt(e){try{e?localStorage.setItem(Wt,"1"):localStorage.setItem(Wt,"0")}catch{}e&&setTimeout(()=>et(),500)}function Mn(){try{const e=localStorage.getItem(Wt);return e==="1"||e==="0"}catch{return!1}}function zt(){try{let e=localStorage.getItem(qa);return e||(e=crypto.randomUUID&&crypto.randomUUID()||"sid_"+Date.now()+"_"+Math.random().toString(36).slice(2,9),localStorage.setItem(qa,e)),e}catch{return"anon_"+Date.now()}}function xa(e){if(!e)return"";let t=5381;for(let a=0;a<e.length;a++)t=(t<<5)+t^e.charCodeAt(a);return(t>>>0).toString(16).padStart(8,"0")}function Ke(){try{const e=localStorage.getItem(xn);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t:[]}catch{return[]}}function Qe(e){try{localStorage.setItem(xn,JSON.stringify(e.slice(-50)))}catch{}}function et(){if(!Te()||!Re())return;const e=Ke();if(!e.length)return;const t=e.slice(0,10);Qe(e.slice(10)),t.forEach(a=>Pn(a,!0))}function Pn(e,t=!1){const a=Ze();if(!Te()){console.warn("[analytics] GAS_URL 未設定，跳過上報",e);return}if(!Re()){if(!t){const n=Ke();n.push(e),Qe(n)}return}const s=JSON.stringify(e);try{if(navigator.sendBeacon){const n=new Blob([s],{type:"text/plain;charset=utf-8"});if(navigator.sendBeacon(a,n))return}}catch{}try{fetch(a,{method:"POST",headers:{"Content-Type":"text/plain;charset=utf-8"},body:s,keepalive:!0,redirect:"follow",mode:"cors"}).then(n=>{if(!n.ok)throw new Error("GAS status "+n.status);t||setTimeout(()=>et(),1e3)}).catch(n=>{if(console.warn("[analytics] 發送失敗，已入隊重試",n),t){const i=Ke();i.unshift(e),Qe(i)}else{const i=Ke();i.push(e),Qe(i)}})}catch{const i=Ke();i.push(e),Qe(i)}}function Se(e,t={}){console.debug("[analytics] track suppressed (buffer-only mode)",e,t)}function ta({chatId:e,chatName:t,text:a,to:s}){try{fi({chatId:e,chatName:t,text:a,to:s})}catch{}}function wi({title:e,to:t,body:a}){try{yi({title:e,to:t,body:a})}catch{}}function jn(e){try{$n(e)}catch{}}function xi(e){try{En(e)}catch{}}function ki(){try{const e=localStorage.getItem("cc_gas_url")||"";e&&yt(e)&&localStorage.removeItem("cc_gas_url")}catch{}try{ma()}catch{}try{l.on("change",e=>{if(e&&e.path==="currentChapter")try{En(e.value)}catch{}})}catch{}try{l.on("reset",()=>{try{ua()}catch{}})}catch{}try{window.__analytics={track:Se,getConsent:Re,setConsent:qt,getGasUrl:Ze,setGasUrl:wn,isGasConfigured:Te,flushQueue:et,hashText:xa,ENV_GAS_URL:Ie||"(empty)",getGameSession:pa,createNewGameSession:ua,ensureGameSession:ma,collectSessionData:An,sendSessionEnd:$n,sendSessionStart:wa,getSessionId:zt,buildInputtedContent:Ln,buildArchievementJson:Tn,getEndingZh:Cn}}catch{}try{const e=(()=>{try{return pa()}catch{return null}})();console.log("[analytics] init (buffer-only, max 2 writes/session)",{hasConsent:Re(),hasChoice:Mn(),gasConfigured:Te(),gasUrl:Ze().slice(0,60)+(Ze().length>60?"...":""),envGasUrl:Ie?Ie.slice(0,30)+"...":"(empty)",localStorageUrl:typeof localStorage<"u"&&localStorage.getItem("cc_gas_url")?"已設定":"(empty)",gameSession:e?{id:e.id,startAt:e.startAt,chapterTimes:e.chapterTimes,whatsapp:(e.whatsappLog||[]).length,email:(e.emailLog||[]).length,startSent:e.sessionStartSent,endSent:e.sessionEndSent}:null}),Te()||console.warn('[analytics] GAS_URL 未設定 → 1) 設定頁貼上 2) localStorage.setItem("cc_gas_url","exec URL") 3) GitHub Secrets VITE_GAS_URL')}catch{}setTimeout(()=>et(),1500);try{window.addEventListener("online",()=>et())}catch{}}var le=fa({closeWaLightbox:()=>Ut,getChats:()=>Bi,markNoriAllRead:()=>Ea,mountWhatsApp:()=>Dn,openChat:()=>at,openWaLightbox:()=>Hn,startSawyerRevertSeq:()=>Mi,triggerCh1Event1:()=>Ai,triggerCh1Event2:()=>Jt,triggerCh2LunchSequence:()=>Ia}),j=[{id:"nori-all",name:"Nori 全體",avatar:"🏢",desc:"Nori 全體員工群組",members:["Sawyer","Casey","Maggie","Taylor","Aiko","all"],preview:"Leo:謝謝安排！",locked:!1,pinned:!0,muted:!1,archived:!1,unread:0,lastTime:"2023-06-15",messages:[{id:"m1",from:"Sawyer",text:"各位同事，好消息！我中了六合彩二獎，決定將獎金全數投入公司資金，一起加油！",time:"2023-06-15",read:"read",type:"text"},{id:"m2",from:"Taylor",text:"恭喜老闆！祝以後都順順利利！",time:"2023-06-15",read:"read",type:"text"},{id:"m3",from:"Aiko",text:"太棒了！老闆威武！",time:"2023-06-15",read:"read",type:"text"},{id:"m4",from:"Maggie",text:"恭喜老闆！",time:"2023-06-15",read:"read",type:"text"},{id:"m5",from:"Parker",text:"運也太好了吧？！",time:"2023-06-15",read:"read",type:"text"},{id:"m6",from:"Sawyer",text:"各位同事，告訴大家一個好消息，剛跟可樂樂公司談成一大生意，結為長期合作伙伴。為慶祝近來公司發展順利，決定舉辦晚上派對，詳細資訊稍後公布！",time:"2023-11-01",read:"read",type:"text"},{id:"m7",from:"Aiko",text:"哇！！太好了，一定會去！",time:"2023-11-01",read:"read",type:"text"},{id:"m8",from:"Taylor",text:"太棒了！",time:"2023-11-01",read:"read",type:"text"},{id:"m9",from:"Maggie",text:"恭喜老闆！",time:"2023-11-01",read:"read",type:"text"},{id:"m10",from:"Hugo",text:"一輩子跟隨您！",time:"2023-11-01",read:"read",type:"text"},{id:"m11",from:"Taylor",text:`各位同事，慶祝公司發展順利, 將於11月22日下班後舉辦派對
以下為詳細資訊：
日期：11月22日（五） 
時間：19:00-23:00
...
commit => 提交變更
revert => 撤銷變更
查看Git Graph => 列表形式展示所有變更記錄`,time:"2024-07-15",read:"read",type:"text"},{id:"m13",from:"Maggie",text:"",media:"/arg-game-it-company-secret/assets/data/files/wts/sourceControlPage.png",time:"2024-07-15",read:"read",type:"image"},{id:"m14",from:"Maggie",text:"",media:"/arg-game-it-company-secret/assets/data/files/wts/sourceControlPage-revert.png",time:"2024-07-15",read:"read",type:"image"},{id:"m15",from:"Maggie",text:"如果修改有誤的話，提交時結果會經過檢查，然後報錯，這時候就要重新修改",time:"2024-07-15",read:"read",type:"text"},{id:"m0",from:"Maggie",text:"Hi @Casey, 有新的工單INV-2024-0042, 請協助處理一下。詳細資訊在Jiua可以找到, 有問題再找我。",time:"今天",read:"delivered",type:"text"}]},{id:"dev-team",name:"Dev Team",avatar:"👩‍💻",desc:"Nori網站和內網的開發團隊群組",members:["Maggie","Casey","pm","Taylor","ops"],preview:"",locked:!1,pinned:!0,muted:!1,archived:!1,unread:0,lastTime:"2024-07-15",messages:[]},{id:"lunch-team",name:"午餐小隊",avatar:"🍽️",desc:"午餐小隊",members:["Parker","Grace","Hugo","Alex","Casey"],preview:"Alex: 好啊！",locked:!1,pinned:!1,muted:!1,archived:!1,unread:0,lastTime:"2024-09-01",messages:[{id:"m1",from:"Hugo",text:"大新聞！聽說老闆父母車禍身亡了！",time:"2023-04-29",read:"read",type:"text"},{id:"m2",from:"Parker",text:"？！",time:"2023-04-29",read:"read",type:"text"},{id:"m3",from:"Grace",text:"真的嗎？太難過了",time:"2023-04-29",read:"read",type:"text"},{id:"m4",from:"Hugo",text:"對啊，所以才請了一個禮拜假吧",time:"2023-04-29",read:"read",type:"text"},{id:"m5",from:"Hugo",text:"有人覺得近期的老闆很怪嗎？",time:"2023-10-19",read:"read",type:"text"},{id:"m6",from:"Parker",text:"怎麼說？！",time:"2023-10-19",read:"read",type:"text"},{id:"m7",from:"Alex",text:"變開朗了，也變得愛請客了！",time:"2023-10-19",read:"read",type:"text"},{id:"m8",from:"Grace",text:"對啊，之前都挺嚴肅的",time:"2023-10-19",read:"read",type:"text"},{id:"m9",from:"Hugo",text:"對啊！！！",time:"2023-10-19",read:"read",type:"text"},{id:"m10",from:"Hugo",text:"歡迎Casey！！以後帶你吃附近好吃的！",time:"2024-07-16",read:"read",type:"text"},{id:"m11",from:"Parker",text:"歡迎歡迎",time:"2024-07-16",read:"read",type:"text"},{id:"m12",from:"Grace",text:"歡迎~",time:"2024-07-16",read:"read",type:"text"},{id:"m13",from:"Alex",text:"歡迎~~",time:"2024-07-16",read:"read",type:"text"},{id:"m14",from:"Hugo",text:"今天要吃米當當嗎？",time:"2024-09-01",read:"read",type:"text"},{id:"m15",from:"Alex",text:"好啊",time:"2024-09-01",read:"read",type:"text"}]}],U="dev-team",Gt="",ot="all",xe=!1,Ue="",ut="chat",We=!0,Q=0,ka=!1;function R(){try{const e=j.map(t=>({id:t.id,name:t.name,avatar:t.avatar,desc:t.desc,members:t.members,preview:t.preview,lastTime:t.lastTime,unread:t.unread,pinned:t.pinned,muted:t.muted,archived:t.archived,messages:t.messages}));l.set("whatsappChats",e),l.set("whatsappMeta",{activeId:U,ch1Event1Triggered:De,ch1Event2Triggered:Ve,sawyerSeq:Q,sawyerSeqLocked:ka}),l.save(!0)}catch{}}function aa(e,t){try{l.incrementWhatsappSent()}catch{}try{const a=(t||"").toLowerCase(),s=["rubbish","垃圾","dumb","笨","蠢","stupid","傻","笨蛋","白癡","idiot","fool","傻瓜","die","dead","死","shit","fuck","屎"],n=e==="sawyer",i=s.some(r=>a.includes(r.toLowerCase()));n&&i&&l.setFlag("sawyer_abuse_sent",!0)}catch{}}function Et(e){try{const t=j.find(a=>a.id===e);return!!(t&&t.muted)}catch{return!1}}function Si(e){return e.time==="剛剛"&&(e.time="今天"),e}function Ua(e){const t=Date.now();e.messages.forEach((a,s)=>{if(Si(a),typeof a.ts!="number")if(/^\d{4}-\d{2}-\d{2}$/.test(a.time))a.ts=new Date(a.time+"T00:00:00").getTime()+s*10;else if(a.time&&a.time.includes(":")){const n=new Date().toISOString().slice(0,10),i=new Date(n+"T"+a.time).getTime();a.ts=Number.isNaN(i)?t-(e.messages.length-s)*1e3:i+s}else a.ts=t-(e.messages.length-s+10)*1e3}),e.lastTime==="剛剛"&&(e.lastTime="今天")}function Ei(){try{const e=l.get("whatsappChats");if(Array.isArray(e)&&e.length){for(const n of e){const i=j.find(r=>r.id===n.id);i&&(i.messages=Array.isArray(n.messages)?n.messages:i.messages,i.preview=n.preview??i.preview,i.lastTime=n.lastTime??i.lastTime,i.unread=typeof n.unread=="number"?n.unread:i.unread,i.pinned=typeof n.pinned=="boolean"?n.pinned:i.pinned,i.muted=typeof n.muted=="boolean"?n.muted:i.muted,i.archived=typeof n.archived=="boolean"?n.archived:i.archived)}for(const n of e)j.some(i=>i.id===n.id)||j.push(n)}const t=l.get("whatsappMeta");t&&typeof t=="object"&&(t.activeId&&j.some(n=>n.id===t.activeId)&&(U=t.activeId),typeof t.ch1Event1Triggered=="boolean"&&(De=t.ch1Event1Triggered),typeof t.ch1Event2Triggered=="boolean"&&(Ve=t.ch1Event2Triggered),typeof t.sawyerSeq=="number"&&(Q=t.sawyerSeq),typeof t.sawyerSeqLocked=="boolean"&&(ka=t.sawyerSeqLocked)),l.hasFlag("ch1_event1_triggered")&&(De=!0);const a=j.find(n=>n.id==="nori-all");a&&a.messages.some(n=>n.text&&n.text.includes("發財樹"))&&(De=!0,l.hasFlag("ch1_event1_triggered")||l.setFlag("ch1_event1_triggered",!0));const s=j.find(n=>n.id==="maggie");s&&s.messages.some(n=>n.text&&n.text.includes("INV-2024-0043"))&&(Ve=!0);for(const n of j)Ua(n)}catch{}De&&!l.hasFlag("ch1_event1_triggered")&&l.setFlag("ch1_event1_triggered",!0);try{for(const e of j)Ua(e)}catch{}}function at(e){if(!j.some(s=>s.id===e))return;U=e;const t=j.find(s=>s.id===e);t&&(t.unread=0),R(),e==="nori-all"&&setTimeout(()=>Ea(),100);const a=document.getElementById("view-whatsapp");a&&a.innerHTML&&(ut="chat",Fn(),mt(),Y(U))}function Dn(){Ei();const e=document.getElementById("view-whatsapp");if(e){e.innerHTML=`<div class="wa">
  ...
  </div>`,Ii(),mt(),Y(U);try{if(l.get("currentChapter")===2&&!l.hasFlag("ch2_lunch_seq_done")){const t=j.find(a=>a.id==="lunch-team");t&&t.messages.some(a=>a.text&&a.text.includes("剛剛嚇壞了吧"))?l.hasFlag("ch2_lunch_seq_done")||l.setFlag("ch2_lunch_seq_done",!0):setTimeout(()=>{try{Ia()}catch{}},900)}}catch{}}}function Ii(){const e=document.getElementById("view-whatsapp");e&&e.querySelectorAll(".wa__sidebar-tab[data-wa-tab]").forEach(t=>{t.addEventListener("click",()=>{const a=t.dataset.waTab;a!==ut&&(ut=a,Fn(),mt())})})}function Fn(){document.querySelectorAll(".wa__sidebar-tab[data-wa-tab]").forEach(e=>{const t=e.dataset.waTab===ut;e.classList.toggle("active",t),e.setAttribute("aria-selected",t?"true":"false")})}function mt(){ut==="account"?Ci():J()}function Ci(){const e=document.getElementById("waList");e&&(e.innerHTML=`
  ...
  `)}function bt(e){return!0}function Li(){let e=[...j];if(Gt){const a=Gt.toLowerCase();e=e.filter(s=>s.name.toLowerCase().includes(a)||s.preview.toLowerCase().includes(a)||s.desc.toLowerCase().includes(a))}ot==="unread"?e=e.filter(a=>a.unread>0&&bt(a.id)):ot==="archived"?e=e.filter(a=>a.archived):e=e.filter(a=>!a.archived);const t=["nori-all","dev-team","sawyer","maggie","system-alert","lunch-team"];return e.sort((a,s)=>{const n=t.indexOf(a.id),i=t.indexOf(s.id),r=n===-1?999:n,d=i===-1?999:i;return r!==d?r-d:0}),e}function J(){if(ut!=="chat")return;const e=document.getElementById("waList");if(!e)return;const t=Li();e.innerHTML=`
    <div class="wa__list-header">
      ...
      <div class="wa__filters">
        <button class="wa__filter ${ot==="all"?"active":""}" data-tab="all">全部</button>
        <button class="wa__filter ${ot==="unread"?"active":""}" data-tab="unread">未讀</button>
        <button class="wa__filter ${ot==="archived"?"active":""}" data-tab="archived">封存</button>
  ...
  `,e.querySelector("#waSearch")?.addEventListener("input",a=>{Gt=a.target.value,J()}),e.querySelectorAll(".wa__filter").forEach(a=>a.addEventListener("click",()=>{ot=a.dataset.tab,J()})),e.querySelectorAll(".wa__item").forEach(a=>a.addEventListener("click",()=>{if(!bt(a.dataset.id))return;U=a.dataset.id;const s=j.find(n=>n.id===U);s&&(s.unread=0),R(),a.dataset.id==="nori-all"&&setTimeout(()=>Ea(),100),xe=!1,J(),Y(U)})),e.querySelectorAll(".wa__item").forEach(a=>{a.addEventListener("contextmenu",s=>{s.preventDefault();const n=j.find(i=>i.id===a.dataset.id);!n||!bt(n.id)||(n.pinned=!n.pinned,R(),J())})})}function Y(e){const t=document.getElementById("waMessages"),a=t?t.scrollTop:null,s=t?t.scrollHeight:null,n=t?s-a-t.clientHeight<80:!0,i=a===0&&We&&t&&s>t.clientHeight+80?!0:n;t&&(We=i);const r=j.find(u=>u.id===e),d=document.getElementById("waChat");if(!r||!d)return;if(!bt(e)){d.innerHTML='<div class="view__placeholder"><h2>🔒 未解鎖</h2><div class="muted">先去 Vizual Studio Code 觸發 420.69 隱藏路由</div></div>';return}e==="supplier"&&l.setFlag("found_supplier",!0),e==="backend-team"&&l.setFlag("found_supplier",!0);let o=r.messages;if(Ue){const u=Ue.toLowerCase();o=o.filter(v=>(v.text||"").toLowerCase().includes(u)||(v.fileName||"").toLowerCase().includes(u))}o=[...o].map((u,v)=>({m:u,idx:v})).sort((u,v)=>{const g=typeof u.m.ts=="number"?u.m.ts:Wa(u.m.time),y=typeof v.m.ts=="number"?v.m.ts:Wa(v.m.time);return g!==y?g-y:u.idx-v.idx}).map(u=>u.m);const c={};o.forEach(u=>{const v=u.time.includes(":")?"今天":u.time;c[v]||(c[v]=[]),c[v].push(u)}),d.innerHTML=`
    ...
    <div id="waMsgSearchBar" style="display:${Ue?"flex":"none"};gap:8px;padding:8px 12px;border-bottom:1px solid var(--border);background:var(--bg-secondary)">
      <input id="waMsgSearchInput" class="input" placeholder="搜尋此對話訊息" value="${Ue}" style="flex:1" />
    ...
    <div class="wa__messages" id="waMessages">
      ${Object.entries(c).map(([u,v])=>`
        ...
        ${v.map(g=>Ti(g,r)).join("")}
      `).join("")}
      ${e==="sawyer"&&Q===2?`<div class="wa__msg-row other" id="sawyerTyping"><div class="wa__msg-avatar" style="background:${Sa("Sawyer")}">S</div><div class="bubble other"><span class="small muted">輸入中...</span></div></div>`:""}
    </div>
    ...
    <div class="wa__info ${xe?"open":""}" id="waInfoPanel">
  ...
  `,document.getElementById("waChatHeader")?.addEventListener("click",()=>{xe=!xe,document.getElementById("waInfoPanel")?.classList.toggle("open",xe)}),document.getElementById("waInfoBtn")?.addEventListener("click",u=>{u.stopPropagation(),xe=!xe,document.getElementById("waInfoPanel")?.classList.toggle("open",xe)}),document.getElementById("waInfoClose")?.addEventListener("click",()=>{xe=!1,document.getElementById("waInfoPanel")?.classList.remove("open")}),document.getElementById("waToggleMute")?.addEventListener("click",()=>{r.muted=!r.muted,R(),J(),Y(e)}),document.getElementById("waTogglePin")?.addEventListener("click",()=>{r.pinned=!r.pinned,R(),J(),Y(e)}),document.getElementById("waToggleArchive")?.addEventListener("click",()=>{r.archived=!r.archived,R(),J(),Y(e)}),document.getElementById("waMsgSearchBtn")?.addEventListener("click",()=>{Ue="",document.getElementById("waMsgSearchBar").style.display="flex",document.getElementById("waMsgSearchInput")?.focus()}),document.getElementById("waMsgSearchInput")?.addEventListener("input",u=>{Ue=u.target.value,Y(e)}),document.getElementById("waMsgSearchClear")?.addEventListener("click",()=>{Ue="",Y(e)}),document.getElementById("waExportBtn")?.addEventListener("click",()=>Ja(r)),document.getElementById("waMoreBtn")?.addEventListener("click",()=>Ja(r)),document.getElementById("waSendBtn")?.addEventListener("click",()=>Ga(r)),document.getElementById("waComposerInput")?.addEventListener("keydown",u=>{u.key==="Enter"&&Ga(r)}),document.querySelectorAll("[data-play]").forEach(u=>{u.addEventListener("click",()=>{const v=u.textContent;u.textContent="⏸️",setTimeout(()=>u.textContent=v,1800)})}),document.querySelectorAll("[data-img]").forEach(u=>{u.addEventListener("click",()=>Hn(u.src))}),On();try{const u=document.getElementById("waMessages");u&&!u._waScrollBound&&(u._waScrollBound=!0,u.addEventListener("scroll",()=>{const v=u.scrollHeight,g=u.scrollTop,y=u.clientHeight;We=v-g-y<80}))}catch{}const m=i,p=a;requestAnimationFrame(()=>{requestAnimationFrame(()=>{const u=document.getElementById("waMessages");if(u)if(m||p===0&&u.scrollHeight>u.clientHeight+20&&We)u.scrollTop=u.scrollHeight,We=!0,u.scrollTop;else if(p!==null){const v=Math.max(0,u.scrollHeight-u.clientHeight);u.scrollTop=Math.min(p,v),u.scrollTop,We=u.scrollHeight-u.scrollTop-u.clientHeight<80}else u.scrollTop=u.scrollHeight,We=!0,u.scrollTop})})}function Nn(e){return e?e==="you"||e==="你"?"你":e.trim().charAt(0).toUpperCase():"?"}function Wa(e){if(!e)return 0;if(e==="剛剛"||e==="今天")return Number.MAX_SAFE_INTEGER;if(/^\d{4}-\d{2}-\d{2}$/.test(e))return new Date(e+"T00:00:00").getTime();if(/^\d{1,2}\/\d{1,2}$/.test(e))return new Date("2024/"+e+"T00:00:00").getTime();const t=new Date().toISOString().slice(0,10);try{const a=new Date(t+"T"+e).getTime();return Number.isNaN(a)?Number.MAX_SAFE_INTEGER:a}catch{return Number.MAX_SAFE_INTEGER}}function Sa(e){const t=["#1f7aec","#e542a3","#00a884","#ff8c00","#6a5acd","#d93025","#0d9488","#7c3aed"];let a=0;for(let s=0;s<e.length;s++)a=a*31+e.charCodeAt(s)>>>0;return t[a%t.length]}function Ti(e,t){const a=e.from==="you",s=a?e.read==="read"?'<span class="bubble__check read">✓✓</span>':e.read==="delivered"?'<span class="bubble__check">✓✓</span>':'<span class="bubble__check">✓</span>':"";let n="";e.type==="image"?n=`<div class="wa__media"><img data-img src="${e.media}" alt="image" /></div>`:e.type==="voice"?n=`<div class="wa__voice"><span class="wa__play" data-play>▶️</span><div class="wa__wave">${Array.from({length:12},(m,p)=>`<span style="height:${8+Math.random()*14}px"></span>`).join("")}</div><span class="small muted">${e.duration}</span></div>`:e.type==="file"&&(n=`<div class="wa__file"><div class="wa__file-icon">📄</div><div style="flex:1;min-width:0"><div style="font-weight:600;font-size:13px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">${h(e.fileName)}</div><div class="small muted">${h(e.fileSize)}</div></div><button class="btn" style="padding:4px 8px">下載</button></div>`);const i=e.text?`<div class="bubble__text">${h(e.text).replace(/\n/g,"<br>")}</div>`:"",r=`<div class="bubble__time">${h(e.time)} ${s}</div>`;if(a)return`<div class="wa__msg-row me">
    ...
    `,a.style.cssText="position:fixed;right:16px;bottom:60px;width:360px;background:#2d2d2d;color:#f0f0f0;border:1px solid rgba(255,255,255,.12);border-radius:8px;box-shadow:0 8px 28px rgba(0,0,0,.45);z-index:1100;overflow:hidden;cursor:pointer;opacity:0;transform:translateY(12px);transition:opacity .28s,transform .28s;",a.addEventListener("click",s=>{s.target.closest(".win-notif__close")||(a.remove(),M(()=>Promise.resolve().then(()=>re).then(n=>{n.setActiveView&&(n.setActiveView("whatsapp"),localStorage.setItem("cc_active_view","whatsapp"))}),void 0),at("nori-all"))}),a.querySelector(".win-notif__close")?.addEventListener("click",s=>{s.stopPropagation(),a.remove()}),document.body.appendChild(a),requestAnimationFrame(()=>{a.style.opacity="1",a.style.transform="none"}),setTimeout(()=>{a.style.opacity="0",setTimeout(()=>a.remove(),300)},1e4),setTimeout(()=>{Ve||Jt()},1e4)},1e4)}function Jt(){if(Ve)return;Ve=!0,R();const e=j.find(t=>t.id==="maggie");e&&setTimeout(()=>{e.messages.push({id:"m-0043-"+Date.now(),from:"Maggie",text:"Hi @Casey, 有新的工單 INV-2024-0043, 請協助處理一下",time:"今天",ts:Date.now(),read:"delivered",type:"text"}),e.preview="Hi @Casey, 有新的工單 INV-2024-0043",e.lastTime="今天",e.unread=(e.unread||0)+1,R(),window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"maggie"}})),M(()=>Promise.resolve().then(()=>ft).then(s=>{s.addTicket0043&&s.addTicket0043(),document.getElementById("jiraBoard")&&window.dispatchEvent(new CustomEvent("jira:ticketAdded"))}),void 0);const t=document.getElementById("view-whatsapp");if(t&&t.innerHTML&&J(),Et("maggie")||U==="maggie")return;const a=document.createElement("div");a.id="wa-win-notification-maggie-0043",a.setAttribute("role","alert"),a.innerHTML=`
      <div class="win-notif__app">
        <img src="/arg-game-it-company-secret/icon/whatsup.svg" alt="WhatUp" width="20" height="20" style="width:20px;height:20px;object-fit:contain" />
        <span class="win-notif__app-name">WhatUp</span>
      ...
      <div class="win-notif__progress"></div>
    `,a.style.cssText="position:fixed;right:16px;bottom:60px;width:360px;background:#2d2d2d;color:#f0f0f0;border:1px solid rgba(255,255,255,.12);border-radius:8px;box-shadow:0 8px 28px rgba(0,0,0,.45);z-index:1100;overflow:hidden;cursor:pointer;opacity:0;transform:translateY(12px);transition:opacity .28s,transform .28s;",a.addEventListener("click",s=>{s.target.closest(".win-notif__close")||(a.remove(),M(()=>Promise.resolve().then(()=>re).then(n=>{n.setActiveView&&(n.setActiveView("whatsapp"),localStorage.setItem("cc_active_view","whatsapp"))}),void 0),at("maggie"))}),a.querySelector(".win-notif__close")?.addEventListener("click",s=>{s.stopPropagation(),a.remove()}),document.body.appendChild(a),requestAnimationFrame(()=>{a.style.opacity="1",a.style.transform="none"}),setTimeout(()=>{a.style.opacity="0",setTimeout(()=>a.remove(),300)},1e4)},1e4)}function Ea(){j.find(e=>e.id==="nori-all")&&De&&!Ve&&Jt()}var na=[{from:"Parker",text:"@Casey 剛剛嚇壞了吧 哈哈 估計是你進來以來第一次遇到系統爆炸了"},{from:"Parker",text:"不過說來也奇怪 這個入口應該搬移了才對"},{from:"Parker",text:"啊對了 這裡應該也沒多少人知道 那個原本是HR系統的入口"},{from:"Hugo",text:"對！！那個超難用的 系統不完善沒有適當防呆 他們又常常笨手笨腳刪掉資料 要找我們恢復"},{from:"Parker",text:"對啊 浪費我們人力 老闆就乾脆換系統了"},{from:"Hugo",text:"那為什麼代碼沒有隱藏入口？"},{from:"Parker",text:"不知道欸 這個不能動 一動就會大爆炸"},{from:"Hugo",text:"難不成有人偷用這個系統來偷藏色色的東西！"},{from:"Parker",text:"什麼鬼"}];function $i(e,t){if(Et("lunch-team")||U==="lunch-team")return;const a=Sa(e),s=Nn(e),n=document.createElement("div");n.className="win-notif",n.id="wa-win-notif-lunch-"+Date.now()+"-"+Math.random().toString(36).slice(2,6),n.setAttribute("role","alert"),n.innerHTML=`
      <div class="win-notif__app">
        <img src="/arg-game-it-company-secret/icon/whatsup.svg" alt="WhatUp" width="20" height="20" style="width:20px;height:20px;object-fit:contain" />
        <span class="win-notif__app-name">WhatUp</span>
  ...
  `,n.style.cssText="position:fixed;right:16px;bottom:60px;width:360px;background:#2d2d2d;color:#f0f0f0;border:1px solid rgba(255,255,255,.12);border-radius:8px;box-shadow:0 8px 28px rgba(0,0,0,.45);z-index:1100;overflow:hidden;cursor:pointer;opacity:0;transform:translateY(12px);transition:opacity .28s,transform .28s;",n.addEventListener("click",i=>{i.target.closest(".win-notif__close")||(n.remove(),M(()=>Promise.resolve().then(()=>re).then(r=>{r.setActiveView&&(r.setActiveView("whatsapp"),localStorage.setItem("cc_active_view","whatsapp"))}),void 0),at("lunch-team"))}),n.querySelector(".win-notif__close")?.addEventListener("click",i=>{i.stopPropagation(),n.remove()}),document.body.appendChild(n),requestAnimationFrame(()=>{n.style.opacity="1",n.style.transform="none"}),setTimeout(()=>{n.style.opacity="0",n.style.transform="translateY(8px)",setTimeout(()=>n.remove(),300)},4e3)}function Ia(){if(l.hasFlag("ch2_lunch_seq_done"))return;const e=j.find(s=>s.id==="lunch-team");if(!e)return;if(e.messages.some(s=>s.text&&s.text.includes("剛剛嚇壞了吧"))){l.hasFlag("ch2_lunch_seq_done")||l.setFlag("ch2_lunch_seq_done",!0);return}l.setFlag("ch2_lunch_seq_done",!0),R();let t=0;const a=()=>{if(t>=na.length)return;const{from:s,text:n}=na[t],i=Date.now();e.messages.push({id:"lunch-ch2-"+i+"-"+t,from:s,text:n,time:"今天",ts:i+t,read:"delivered",type:"text"}),e.preview=`${s}: ${n.slice(0,20)}`,e.lastTime="今天",U!=="lunch-team"?e.unread=(e.unread||0)+1:e.unread=0,R(),window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"lunch-team"}})),$i(s,n),t+=1,t<na.length&&setTimeout(a,5e3)};setTimeout(a,800)}function Ja(e){const t=`WhatUp 匯出 — ${e.name}
${e.messages.map(i=>`[${i.time}] ${i.from}: ${i.text||i.fileName||i.type}`).join(`
`)}`,a=new Blob([t],{type:"text/plain"}),s=URL.createObjectURL(a),n=document.createElement("a");n.href=s,n.download=`${e.id}-chat.txt`,n.click(),URL.revokeObjectURL(s)}function Bi(){return j}function Mi(){if(Q!==0)return;Q=1,R();const e=document.getElementById("view-whatsapp");if(e&&e.classList.contains("active")||localStorage.getItem("cc_active_view"),e&&e.innerHTML){try{Y(U)}catch{}try{mt()}catch{}}try{l.setFlag("sawyer_seq_started",!0)}catch{}}var me=1,it=0,rt=0,Rt=!1,Ya=0,Ka=0,Qa=0,Xa=0;function On(){if(document.getElementById("waLightbox"))return;const e=document.createElement("div");e.id="waLightbox",e.className="wa-lightbox",e.setAttribute("aria-hidden","true"),e.innerHTML=`
  ...
  `,document.body.appendChild(e);const t=e.querySelector("#waLightboxImg"),a=e.querySelector("#waLightboxBody"),s=e.querySelector("#waLightboxScale");function n(){t&&(t.style.transform=`translate(${it}px, ${rt}px) scale(${me})`,s&&(s.textContent=Math.round(me*100)+"%"),a.style.cursor=me>1?Rt?"grabbing":"grab":"zoom-in")}function i(c,m,p){me=Math.max(.5,Math.min(4,c)),me===1&&(it=0,rt=0),n()}e.querySelector('[data-wa-zoom="in"]')?.addEventListener("click",()=>i(me+.25)),e.querySelector('[data-wa-zoom="out"]')?.addEventListener("click",()=>i(me-.25)),e.querySelector('[data-wa-zoom="reset"]')?.addEventListener("click",()=>{me=1,it=0,rt=0,n()}),e.querySelector("#waLightboxClose")?.addEventListener("click",()=>Ut()),e.querySelector("[data-wa-close]")?.addEventListener("click",()=>Ut()),a?.addEventListener("wheel",c=>{c.preventDefault();const m=c.deltaY>0?-.1:.1;i(me+m)},{passive:!1});function r(c){me<=1||(Rt=!0,t.classList.add("dragging"),Ya=c.clientX,Ka=c.clientY,Qa=it,Xa=rt,a.setPointerCapture?.(c.pointerId))}function d(c){Rt&&(it=Qa+(c.clientX-Ya),rt=Xa+(c.clientY-Ka),n())}function o(c){Rt=!1,t.classList.remove("dragging");try{a.releasePointerCapture?.(c.pointerId)}catch{}}a?.addEventListener("pointerdown",r),a?.addEventListener("pointermove",d),a?.addEventListener("pointerup",o),a?.addEventListener("pointercancel",o),document.addEventListener("keydown",c=>{c.key==="Escape"&&e.classList.contains("open")&&Ut()}),e._updateTransform=n,e._setScale=i}function Hn(e){On();const t=document.getElementById("waLightbox"),a=document.getElementById("waLightboxImg");!t||!a||(a.src=e,me=1,it=0,rt=0,t._updateTransform?.(),t.classList.add("open"),t.setAttribute("aria-hidden","false"))}function Ut(){const e=document.getElementById("waLightbox");e&&(e.classList.remove("open"),e.setAttribute("aria-hidden","true"))}try{G.on("chapter:changed",e=>{e===2&&setTimeout(()=>{try{Ia()}catch{}},600)})}catch{}typeof window<"u"&&!window.__waListenerBound&&(window.__waListenerBound=!0,window.addEventListener("whatsapp:newMessage",e=>{try{R()}catch{}const t=document.getElementById("view-whatsapp");if(!(!t||!t.innerHTML)){try{mt()}catch{}try{Y(U)}catch{}}}),window.addEventListener("whatsapp:refresh",()=>{const e=document.getElementById("view-whatsapp");if(!(!e||!e.innerHTML)){try{mt()}catch{}try{Y(U)}catch{}}}));var dt=[{title:"Java switch-case 語法詳解 — 基礎教學 (繁中)",url:"https://java-tutorial.example/switch-case",snippet:"【switch 用法】switch 會依變數值跳到對應 case，需搭配 break 避免貫穿。範例：switch(vipLv){ case 1: price *= 0.90; break; case 2: price *= 0.85; break; case 3: price *= 0.80; break; case 4: price *= 0.75; break; case 5: price *= 0.70; break; default: break; } 注意：若缺少 break 會繼續執行下一個 case。常與 if-else 比較，適用於枚舉分級如 VIP 折扣。",type:"web",image:null},{title:"【StackOverflow】VIP 等級折扣用 switch 寫，VIP1 被算成 60% 而不是 50% 該怎麼修？",url:"https://stackoverflow.com/questions/789421/vip-discount-switch-case-wrong-percentage",snippet:`發問：我的 switch(vipLv) 中 case 1 寫成 price*=0.95，但需求是 VIP1 60%、VIP2 65%。已嘗試修改但 Sonar 仍報錯... 
...
`,type:"news",image:null},{title:"那些藏在程式碼裡的小彩蛋：我在小團隊看到的開發者塗鴉 — Peter Lin",url:"https://peter-blog.example/code-easter-eggs",snippet:"待過幾間中小企業後發現，只要沒有嚴格的 code quality 流程，程式碼裡總會冒出一些跟公司或產品完全無關的東西——註解裡的粗口、對工作的抱怨、整段國歌歌詞，甚至藏得很深的小遊戲。我對這些小彩蛋的看法是：只要不影響功能與效能，算是工作中找到的小樂趣。 — Peter Lin",type:"web",image:"https://picsum.photos/seed/codeeggs/600/400"},{title:"給完全不懂程式的人：MD5 是什麼？把一句話變成一串亂碼的小魔法 — Peter Lin",url:"https://peter-blog.example/md5-for-beginners",snippet:"完全不懂程式也看得懂。MD5 就像一台指紋機：你丟一句話進去，它永遠吐出 32 個字由 0-9、a-f 組成的亂碼。同樣輸入永遠得到同樣輸出，改一個字結果就完全不同。例如 hello → 5d41402abc4b2a76b9719d911017c592，平常看到的 ?hash=be78e754... 就是典型例子。— Peter Lin",type:"web",image:"https://picsum.photos/seed/md5/600/400"}],Rn={sawyer:{id:"sawyer",name:"Sawyer Choi",handle:"@sawyerchoi",displayName:"Sawyer Choi / 蔡梓掦",bio:"喜歡把日常小事寫成文字的人。從2001年開始在 BlogWorld 記錄生活，覺得能把想法寫下來，好像就能更理解自己一點。",avatar:"/arg-game-it-company-secret/lemon_tea.jpg",cover:"/arg-game-it-company-secret/lemon_tea.jpg",followers:842,following:37,joined:"2001-10-01",verified:!1},mary:{id:"mary",name:"Mary Chen",handle:"@marychen",displayName:"Mary Chen · 陳曉玲",bio:"旅遊 × 攝影 × 生活手帳。走過 27 個城市，喜歡在咖啡香裡寫明信片。",avatar:"https://i.pravatar.cc/150?u=mary",cover:"https://picsum.photos/seed/marycover/900/240",followers:12430,following:210,joined:"2018-03-12",verified:!0},peter:{id:"peter",name:"Peter Lin",handle:"@peterlin",displayName:"Peter Lin · 林柏安",bio:"後端工程師 / 開源愛好者。分享 Python、NAS、自架服務與踩坑筆記。",avatar:"https://i.pravatar.cc/150?u=peter",cover:"https://picsum.photos/seed/petercover/900/240",followers:8930,following:96,joined:"2019-07-20",verified:!0},paul:{id:"paul",name:"Paul Wang",handle:"@paulwang",displayName:"Paul Wang · 王志豪",bio:"台南胃、台北心。專門挖掘巷弄美食與手沖咖啡，記錄每一口幸福。",avatar:"https://i.pravatar.cc/150?u=paul",cover:"https://picsum.photos/seed/paulcover/900/240",followers:15600,following:143,joined:"2017-11-05",verified:!0},emma:{id:"emma",name:"Emma Wu",handle:"@emmaw",displayName:"Emma Wu · 吳思敏",bio:"底片攝影 / 極地旅人。想用快門留住光線的溫度。",avatar:"https://i.pravatar.cc/150?u=emma",cover:"https://picsum.photos/seed/emmacover/900/240",followers:6720,following:78,joined:"2020-01-18",verified:!1},david:{id:"david",name:"David Chang",handle:"@davidchang",displayName:"David Chang · 張大衛",bio:"黑膠收藏家 / Live House 常客。寫音樂，也寫城市的聲音。",avatar:"https://i.pravatar.cc/150?u=david",cover:"https://picsum.photos/seed/davidcover/900/240",followers:4210,following:52,joined:"2019-09-03",verified:!1}},te=[{url:"https://sawyer-blog.example/2001-10-18",title:"Sawyer Choi — 2001-10-18",excerpt:"今天和好多朋友一起玩，大家都玩得很開心。我把自己的食物分給大家吃，他們笑得很開心。",content:`2001-10-18
...
<p>除錯技巧：在 <code>vite.config.js</code> 設 <code>publicDir</code> 或用 <code>console.log(import.meta.env)</code> 印出所有 <code>VITE_</code> 變數。</p>`}],commentsQ:[{user:"發問者",text:"原來只有 VITE_ 才會到前端，難怪 DATABASE_URL 一直 undefined",time:"2024-08-12 12:30"},{user:"路人",text:"推，之前把 MD5_KEY 放 VITE_ 被老師罵",time:"2024-08-13 08:20"}]}};function Di(e){return e&&e.includes("stackoverflow.com")&&Vn[e]}function Fi(e){return Vn[e]||null}function Ni(e){function t(C,I){return C<<I|C>>>32-I}function a(C,I){var $,P,D=C&2147483648,H=I&2147483648,q;return $=C&1073741824,P=I&1073741824,q=(C&1073741823)+(I&1073741823),$&P?q^2147483648^D^H:$|P?q&1073741824?q^3221225472^D^H:q^1073741824^D^H:q^D^H}function s(C,I,$){return C&I|~C&$}function n(C,I,$){return C&$|I&~$}function i(C,I,$){return C^I^$}function r(C,I,$){return I^(C|~$)}function d(C,I,$,P,D,H,q){return C=a(C,a(a(s(I,$,P),D),q)),a(t(C,H),I)}function o(C,I,$,P,D,H,q){return C=a(C,a(a(n(I,$,P),D),q)),a(t(C,H),I)}function c(C,I,$,P,D,H,q){return C=a(C,a(a(i(I,$,P),D),q)),a(t(C,H),I)}function m(C,I,$,P,D,H,q){return C=a(C,a(a(r(I,$,P),D),q)),a(t(C,H),I)}function p(C){for(var I,$=C.length,P=$+8,D=((P-P%64)/64+1)*16,H=Array(D-1),q=0,we=0;we<$;)I=(we-we%4)/4,q=we%4*8,H[I]=H[I]|C.charCodeAt(we)<<q,we++;return I=(we-we%4)/4,q=we%4*8,H[I]=H[I]|128<<q,H[D-2]=$<<3,H[D-1]=$>>>29,H}function u(C){var I="",$="",P,D;for(D=0;D<=3;D++)P=C>>>D*8&255,$="0"+P.toString(16),I=I+$.substr($.length-2,2);return I}function v(C){C=C.replace(/\r\n/g,`
`);for(var I="",$=0;$<C.length;$++){var P=C.charCodeAt($);P<128?I+=String.fromCharCode(P):P>127&&P<2048?(I+=String.fromCharCode(P>>6|192),I+=String.fromCharCode(P&63|128)):(I+=String.fromCharCode(P>>12|224),I+=String.fromCharCode(P>>6&63|128),I+=String.fromCharCode(P&63|128))}return I}var g=Array(),y,T,A,N,E,_,w,b,f,B=7,k=12,V=17,be=22,nt=5,ze=9,O=14,Ae=20,_e=4,Bt=11,Mt=16,Pt=23,jt=6,Dt=10,Ft=15,Nt=21;for(e=v(e),g=p(e),_=1732584193,w=4023233417,b=2562383102,f=271733878,y=0;y<g.length;y+=16)T=_,A=w,N=b,E=f,_=d(_,w,b,f,g[y+0],B,3614090360),f=d(f,_,w,b,g[y+1],k,3905402710),b=d(b,f,_,w,g[y+2],V,606105819),w=d(w,b,f,_,g[y+3],be,3250441966),_=d(_,w,b,f,g[y+4],B,4118548399),f=d(f,_,w,b,g[y+5],k,1200080426),b=d(b,f,_,w,g[y+6],V,2821735955),w=d(w,b,f,_,g[y+7],be,4249261313),_=d(_,w,b,f,g[y+8],B,1770035416),f=d(f,_,w,b,g[y+9],k,2336552879),b=d(b,f,_,w,g[y+10],V,4294925233),w=d(w,b,f,_,g[y+11],be,2304563134),_=d(_,w,b,f,g[y+12],B,1804603682),f=d(f,_,w,b,g[y+13],k,4254626195),b=d(b,f,_,w,g[y+14],V,2792965006),w=d(w,b,f,_,g[y+15],be,1236535329),_=o(_,w,b,f,g[y+1],nt,4129170786),f=o(f,_,w,b,g[y+6],ze,3225465664),b=o(b,f,_,w,g[y+11],O,643717713),w=o(w,b,f,_,g[y+0],Ae,3921069994),_=o(_,w,b,f,g[y+5],nt,3593408605),f=o(f,_,w,b,g[y+10],ze,38016083),b=o(b,f,_,w,g[y+15],O,3634488961),w=o(w,b,f,_,g[y+4],Ae,3889429448),_=o(_,w,b,f,g[y+9],nt,568446438),f=o(f,_,w,b,g[y+14],ze,3275163606),b=o(b,f,_,w,g[y+3],O,4107603335),w=o(w,b,f,_,g[y+8],Ae,1163531501),_=o(_,w,b,f,g[y+13],nt,2850285829),f=o(f,_,w,b,g[y+2],ze,4243563512),b=o(b,f,_,w,g[y+7],O,1735328473),w=o(w,b,f,_,g[y+12],Ae,2368359562),_=c(_,w,b,f,g[y+5],_e,4294588738),f=c(f,_,w,b,g[y+8],Bt,2272392833),b=c(b,f,_,w,g[y+11],Mt,1839030562),w=c(w,b,f,_,g[y+14],Pt,4259657740),_=c(_,w,b,f,g[y+1],_e,2763975236),f=c(f,_,w,b,g[y+4],Bt,1272893353),b=c(b,f,_,w,g[y+7],Mt,4139469664),w=c(w,b,f,_,g[y+10],Pt,3200236656),_=c(_,w,b,f,g[y+13],_e,681279174),f=c(f,_,w,b,g[y+0],Bt,3936430074),b=c(b,f,_,w,g[y+3],Mt,3572445317),w=c(w,b,f,_,g[y+6],Pt,76029189),_=c(_,w,b,f,g[y+9],_e,3654602809),f=c(f,_,w,b,g[y+12],Bt,3873151461),b=c(b,f,_,w,g[y+15],Mt,530742520),w=c(w,b,f,_,g[y+2],Pt,3299628645),_=m(_,w,b,f,g[y+0],jt,4096336452),f=m(f,_,w,b,g[y+7],Dt,1126891415),b=m(b,f,_,w,g[y+14],Ft,2878612391),w=m(w,b,f,_,g[y+5],Nt,4237533241),_=m(_,w,b,f,g[y+12],jt,1700485571),f=m(f,_,w,b,g[y+3],Dt,2399980690),b=m(b,f,_,w,g[y+10],Ft,4293915773),w=m(w,b,f,_,g[y+1],Nt,2240044497),_=m(_,w,b,f,g[y+8],jt,1873313359),f=m(f,_,w,b,g[y+15],Dt,4264355552),b=m(b,f,_,w,g[y+6],Ft,2734768916),w=m(w,b,f,_,g[y+13],Nt,1309151649),_=m(_,w,b,f,g[y+4],jt,4149444226),f=m(f,_,w,b,g[y+11],Dt,3174756917),b=m(b,f,_,w,g[y+2],Ft,718787259),w=m(w,b,f,_,g[y+9],Nt,3951481745),_=a(_,T),w=a(w,A),b=a(b,N),f=a(f,E);return(u(_)+u(w)+u(b)+u(f)).toLowerCase()}function Oi(e){if(!e)return[];const t=e.toLowerCase(),a=new Set,s=[];return dt.forEach(n=>{n.title.toLowerCase().includes(t)&&!a.has(n.title)&&(a.add(n.title),s.push({text:n.title,kind:n.type}))}),(l.get("searchHistory")||[]).slice(-5).reverse().forEach(n=>{n.q.toLowerCase().includes(t)&&!a.has(n.q)&&(a.add(n.q),s.push({text:n.q,kind:"history"}))}),s.slice(0,8)}function Hi(e){let t=e;const a={site:null,filetype:null,before:null,after:null},s=t.match(/site:([^\s]+)/i);s&&(a.site=s[1].toLowerCase(),t=t.replace(s[0],"").trim());const n=t.match(/filetype:([^\s]+)/i);n&&(a.filetype=n[1].toLowerCase(),t=t.replace(n[0],"").trim());const i=t.match(/before:([^\s]+)/i);i&&(a.before=i[1],t=t.replace(i[0],"").trim());const r=t.match(/after:([^\s]+)/i);return r&&(a.after=r[1],t=t.replace(r[0],"").trim()),{base:t.trim(),filters:a}}function Ri(e){return e.toLowerCase().includes("md5")}function Vi(e){const t=document.getElementById("md5Tool");if(!t)return;const a=document.getElementById("searchLayout"),s=document.getElementById("searchDetail");a&&(a.style.display="none"),s&&(s.style.display="none",s.innerHTML="",s.classList.remove("open"));let n="";if(e){const p=e.match(/md5\s*(.*)/i);p&&p[1]&&(n=p[1].trim())}t.innerHTML=`
  ...
  `,zi(),ha(),Ui(),Me(""))}function zi(){const e=document.getElementById("searchInput"),t=document.getElementById("suggestBox");e?.addEventListener("input",a=>{const s=a.target.value,n=Oi(s);if(!s||!n.length){t.classList.remove("open"),t.innerHTML="";return}t.innerHTML=n.map(i=>`<div class="suggest-item" data-q="${h(i.text)}"><span>${h(i.text)}</span><span class="small">${i.kind}</span></div>`).join(""),t.classList.add("open"),t.querySelectorAll(".suggest-item").forEach(i=>i.addEventListener("click",()=>{e.value=i.dataset.q,t.classList.remove("open"),Me(i.dataset.q)}))}),e?.addEventListener("keydown",a=>{if(a.key==="Enter"&&(document.getElementById("suggestBox")?.classList.remove("open"),Me(a.target.value)),a.key==="Escape"&&document.getElementById("suggestBox")?.classList.remove("open"),a.key==="ArrowDown"){const s=document.querySelector("#suggestBox .suggest-item");s&&(a.preventDefault(),s.classList.add("active"),e.value=s.dataset.q)}}),e?.addEventListener("blur",()=>setTimeout(()=>t?.classList.remove("open"),150)),document.getElementById("searchBtn")?.addEventListener("click",()=>Me(document.getElementById("searchInput").value)),document.querySelectorAll(".chip").forEach(a=>a.addEventListener("click",()=>Me(a.dataset.q))),document.querySelectorAll(".search__tab").forEach(a=>{a.addEventListener("click",()=>{document.querySelectorAll(".search__tab").forEach(s=>s.classList.remove("active")),a.classList.add("active"),oe=a.dataset.tab,Me(It||"Sawyer")})})}function ha(){const e=document.getElementById("searchHistoryList");if(!e)return;const t=(l.get("searchHistory")||[]).slice(-8).reverse();if(!t.length){e.innerHTML='<div class="small muted">尚無歷史</div>';return}e.innerHTML=t.map(a=>`<div class="history-item" data-q="${h(a.q)}"><span>${h(a.q)}</span><span class="small">${new Date(a.at).toLocaleTimeString("zh-TW",{hour:"2-digit",minute:"2-digit"})}</span></div>`).join(""),e.querySelectorAll(".history-item").forEach(a=>a.addEventListener("click",()=>Me(a.dataset.q)))}function Ui(){const e=document.getElementById("searchTrendList");e&&(e.innerHTML=ji.map(t=>`<div class="trend-item" data-q="${h(t)}"><span>🔥 ${h(t)}</span><span class="small">›</span></div>`).join(""),e.querySelectorAll(".trend-item").forEach(t=>t.addEventListener("click",()=>Me(t.dataset.q))))}function Me(e){const t=document.getElementById("searchInput");t&&e&&(t.value=e);const a=(e||"").trim();if(!a)return;if(It=a,a.includes("hash=")&&a.includes("f665a7117959b667b7f283eaebf69cae")){const p=document.getElementById("searchResults");if(p){ye(),p.innerHTML='<div class="card" style="padding:16px"><div class="small muted">此為暗網路徑的 hash，請至 <b>正常內網</b> 搜尋框輸入完整 URL：<br><code style="word-break:break-all">https://nori-intranet/internal/portal?hash=f665a7117959b667b7f283eaebf69cae</code><br><br>提示：可在 Vizual Studio Code 的 Git Graph 找到 <code>generateSecretPath</code> 歷史與 <code>.env.example</code> 的 key，自行組合 md5。</div></div>';const u=document.getElementById("md5Tool");u&&(u.style.display="none",u.innerHTML=""),l.push("searchHistory",{q:a,at:new Date().toISOString()}),ha();return}}const s=document.getElementById("md5Tool");s&&(s.style.display="none",s.innerHTML="");const n=document.getElementById("searchLayout");n&&(n.style.display=""),l.push("searchHistory",{q:a,at:new Date().toISOString()}),(a.toLowerCase().includes("package")||a.toLowerCase().includes("image"))&&l.setFlag("reverse_image_done",!0),(a.toLowerCase().includes("shell")||a.toLowerCase().includes("site:nori"))&&l.setFlag("found_shell_company",!0),(a.toLowerCase().includes("drink")||a.toLowerCase().includes("nori"))&&l.setFlag("found_supplier",!0),ha();const{base:i,filters:r}=Hi(a);Ca=i;const d=document.getElementById("searchAdvancedHint");if(d){const p=[];r.site&&p.push(`site:${r.site}`),r.filetype&&p.push(`filetype:${r.filetype}`),r.before&&p.push(`before:${r.before}`),r.after&&p.push(`after:${r.after}`),d.textContent=p.length?`進階語法生效：${p.join(" · ")} ｜ 基礎查詢：${i||"(空)"}`:""}let o=[];const c=i.toLowerCase().trim().replace(/\s+/g," ");if(c==="sawyer"||c==="sawyer choi"){const p=["https://sawyer-blog.example/2024-03-20","https://sawyer-blog.example/2024-01-15","https://sawyer-blog.example/2023-12-20","https://sawyer-blog.example/2023-05-10","https://sawyer-blog.example/2023-05-01"],u="https://news.example/sawyer-statement-2023",v="https://school.example/guangzhi-essay-sawyer",g=new Map(dt.map(A=>[A.url,A]));for(const A of p){const N=g.get(A);if(N){if(oe!=="all"&&N.type!==oe||r.site&&!N.url.toLowerCase().includes(r.site))continue;o.push(N)}}const y=g.get(u);y&&(oe==="all"||y.type===oe)&&(!r.site||y.url.toLowerCase().includes(r.site))&&o.push(y);const T=g.get(v);T&&(oe==="all"||T.type===oe)&&(!r.site||T.url.toLowerCase().includes(r.site))&&o.push(T)}else for(const p of dt){if(oe!=="all"&&p.type!==oe)continue;const u=(p.title+" "+p.snippet+" "+p.url).toLowerCase(),v=i.toLowerCase();(!i||u.includes(v)||i.split(/\s+/).some(g=>u.includes(g.toLowerCase())))&&(r.site&&!p.url.toLowerCase().includes(r.site)||r.filetype&&p.type==="image"&&r.filetype!=="image"||o.push(p))}if(oe==="image"&&o.some(p=>p.image),Ri(a)){const p={title:"MD5 加密工具 — 線上 MD5 產生器 / 轉換器",url:"md5-tool",snippet:"輸入任意字串，一鍵轉換為 32 位小寫 MD5。支援即時轉換、複製與清空。",type:"tool",image:null,isMD5Tool:!0};o.some(v=>v.isMD5Tool||v.url==="md5-tool")||o.unshift(p);const u="https://peter-blog.example/md5-for-beginners";if(!o.some(v=>v.url===u)){const v=dt.find(g=>g.url===u);if(v&&(oe==="all"||v.type===oe)){const g=o.findIndex(y=>y.url==="md5-tool");o.splice(g+1,0,v)}}}lt=o.slice(0,12);const m=document.getElementById("searchResults");if(m){if(ye(),!lt.length){m.innerHTML='<div class="muted small" style="margin-top:12px">無結果 — 嘗試輸入相關字眼 </code></div>';return}m.innerHTML=lt.map((p,u)=>`
    <div class="result" data-idx="${u}">
      <div class="result__title" data-open="${u}">${h(p.title)}</div>
      <div class="result__url">${h(p.url)}</div>
      <div class="result__snippet">${La(p.snippet,i)}</div>
  ...
  `).join(""),m.querySelectorAll("[data-open]").forEach(p=>p.addEventListener("click",()=>{const u=Number(p.dataset.open),v=lt[u];if(v){if(v.url.startsWith("file://")||v.url.startsWith("/customer-portal")){const g=v.url.replace("file://","");S.exists(g)&&l.setFlag("found_code_map",!0);const y=new CustomEvent("search:openFile",{detail:g});window.dispatchEvent(y)}Xi(u)}}))}}function ye(){const e=document.getElementById("md5Tool");e&&(e.style.display="none",e.innerHTML="");const t=document.getElementById("searchLayout"),a=document.getElementById("searchDetail");t&&(t.style.display=""),a&&(a.style.display="none",a.innerHTML="",a.classList.remove("open"));const s=document.querySelector(".search");s&&(s.scrollTop=0);const n=document.getElementById("view-search");n&&(n.scrollTop=0)}function X(e){return e>=1e4?(e/1e4).toFixed(1)+"萬":e>=1e3?(e/1e3).toFixed(1)+"k":String(e)}function Yt(e){return te.find(t=>t.url===e)||null}function Pe(e){return Rn[e]||null}function Wi(e){return te.filter(t=>t.authorId===e).sort((t,a)=>a.views-t.views)}function Gi(e){const t=te.filter(n=>n.authorId===e.authorId&&n.url!==e.url).sort((n,i)=>i.views-n.views).slice(0,2);let a=te.filter(n=>n.topic===e.topic&&n.url!==e.url&&n.authorId!==e.authorId);if(a.length<3){const n=te.filter(i=>i.url!==e.url&&!t.includes(i)&&!a.includes(i)&&i.tags.some(r=>e.tags.includes(r)));a=[...a,...n]}a=a.slice(0,3);let s=[...t,...a];if(s.length<5){const n=te.filter(i=>i.url!==e.url&&!s.includes(i)).sort(()=>.5-Math.random()).slice(0,5-s.length);s=s.concat(n)}return s.slice(0,5)}function Ta(e){return`
  ...
  `}function Aa(e){e.querySelector("[data-blog-home]")?.addEventListener("click",()=>Ct()),e.querySelectorAll("[data-blog-nav]").forEach(t=>{t.addEventListener("click",()=>{(t.dataset.blogNav==="home"||t.dataset.blogNav==="trending")&&Ct()})}),e.querySelector("[data-blog-back-search]")?.addEventListener("click",()=>ye())}function Ct(){const e=document.getElementById("searchDetail"),t=document.getElementById("searchLayout");if(!e||!t)return;t.style.display="none",e.style.display="block",e.classList.add("open");const a=document.getElementById("md5Tool");a&&(a.style.display="none",a.innerHTML="");const s=[...te].sort((p,u)=>u.views-p.views).slice(0,1)[0],n=[...te].sort((p,u)=>u.views-p.views).slice(1,4),i=te.find(p=>p.url==="https://peter-blog.example/code-easter-eggs"),r=[...te.filter(p=>p.url!=="https://peter-blog.example/code-easter-eggs")].sort(()=>.5-Math.random()),d=(i?[i,...r].slice(0,6):[...te].sort(()=>.5-Math.random()).slice(0,6)).slice(0,6),o=Object.values(Rn).sort((p,u)=>u.followers-p.followers).slice(0,4);e.innerHTML=`
            ...
            <div class="blog-featured">
              <div class="blog-featured__main" data-blog-url="${h(s.url)}">
                ...
                <div class="blog-card__body">
                  ...
                  <div class="blog-card__meta"><span class="blog-card__author"><img src="${h(Pe(s.authorId).avatar)}" alt="" />${h(Pe(s.authorId).displayName)}</span><span class="blog-card__dot"></span><span>${h(s.date)}</span><span class="blog-card__dot"></span><span><i class="fa-solid fa-eye"></i> ${X(s.views)}</span></div>
                </div>
              </div>
                ...
                ${n.map(p=>`
                  <div class="blog-mini" data-blog-url="${h(p.url)}">
                    ...
                    <div style="flex:1;min-width:0">
                      ...
                      <div class="blog-mini__meta"><span>${h(Pe(p.authorId).displayName.split("·")[0].trim())}</span><span>·</span><span><i class="fa-solid fa-eye"></i> ${X(p.views)}</span></div>
              ...
              ${d.map(p=>`
                <div class="blog-card" data-blog-url="${h(p.url)}">
                  ...
                  <div class="blog-card__body">
                    ...
                    <div class="blog-card__meta"><span class="blog-card__author"><img src="${h(Pe(p.authorId).avatar)}" alt="" />${h(Pe(p.authorId).name)}</span><span class="blog-card__dot"></span><span>${h(p.date)}</span><span class="blog-card__dot"></span><span><i class="fa-solid fa-eye"></i> ${X(p.views)}</span></div>
                  </div>
                </div>
              `).join("")}
            </div>
  ...
  `,Aa(e),e.querySelector("[data-blog-back-search]")?.addEventListener("click",()=>ye()),e.querySelectorAll("[data-blog-url]").forEach(p=>{p.addEventListener("click",()=>Lt(p.dataset.blogUrl))}),e.querySelectorAll("[data-blog-author]").forEach(p=>{p.addEventListener("click",()=>qn(p.dataset.blogAuthor))}),e.querySelectorAll("[data-blog-tag]").forEach(p=>{p.addEventListener("click",()=>{const u=p.dataset.blogTag,v=te.find(g=>g.tags.includes(u)||g.topic===u);v&&Lt(v.url)})});const c=document.getElementById("view-search");c&&(c.scrollTop=0);const m=e.querySelector(".blog-body");m&&(m.scrollTop=0)}function qn(e){const t=Pe(e);if(!t)return;const a=document.getElementById("searchDetail"),s=document.getElementById("searchLayout");if(!a||!s)return;s.style.display="none",a.style.display="block",a.classList.add("open");const n=Wi(e),i=n.reduce((o,c)=>o+c.views,0),r=n.reduce((o,c)=>o+c.likes,0);a.innerHTML=`
    <div class="blog-platform">
      ${Ta("profile")}
      <div class="blog-body">
        ...
        <div class="blog-article__layout">
          <div class="blog-article__main">
            <div class="blog-article__card">
              ...
              <div class="blog-article__content">${La(t.content,Ca)}</div>
          ...
          <aside class="blog-sidebar">
            ...
            <div class="blog-widget">
              ...
              <div class="blog-rec-list">
                ${r.map((m,p)=>{const u=Pe(m.authorId),v=m.authorId===t.authorId;return`
  ...
  `}function Yi(e){e.querySelectorAll("[data-school-back-search]").forEach(t=>t.addEventListener("click",()=>ye())),e.querySelectorAll("[data-school-home]").forEach(t=>t.addEventListener("click",()=>ye()))}function Ki(e){const t=e||dt.find(o=>o.url==="https://school.example/guangzhi-essay-sawyer")||lt.find(o=>zn(o.url));if(!t)return;try{l.markArticleRead(t.url)}catch{}const a=document.getElementById("searchDetail"),s=document.getElementById("searchLayout");if(!a||!s)return;s.style.display="none",a.style.display="block",a.classList.add("open");const n=document.getElementById("md5Tool");n&&(n.style.display="none",n.innerHTML="");const i=t.images||(t.image?[t.image]:[]);a.innerHTML=`
  ...
  `,a.querySelector("[data-so-back-search]")?.addEventListener("click",()=>ye());const i=document.getElementById("view-search");i&&(i.scrollTop=0),a.scrollIntoView({behavior:"auto",block:"start"})}function Xi(e){const t=lt[e];if(!t)return;if(t.isMD5Tool||t.url==="md5-tool"){Vi(It);return}const a=document.getElementById("md5Tool");if(a&&(a.style.display="none",a.innerHTML=""),Di(t.url)){Qi(t.url);return}const s=t.url;if(te.some(u=>u.url===s)||s.includes("sawyer-blog.example")||s.includes("mary-blog.example")||s.includes("peter-blog.example")||s.includes("paul-blog.example")||s.includes("emma-blog.example")||s.includes("david-blog.example")){let u=s;if(!Yt(u)){const v=te.find(g=>g.title===t.title);v&&(u=v.url)}if(Yt(u)){Lt(u);return}}if(zn(t.url)||t.title.includes("廣志中學")){Ki(t);return}const n=document.getElementById("searchLayout"),i=document.getElementById("searchDetail");if(!n||!i)return;try{t.url&&(t.type==="news"||t.url.includes("news.example"))&&l.markArticleRead(t.url)}catch{}n.style.display="none",i.style.display="block",i.classList.add("open");let r="",d=null;if(t.url.startsWith("/customer-portal")||t.url.startsWith("file://")){d=t.url.replace("file://","");const u=S.getFile(d);u&&typeof u.content=="string"&&(r=u.content,S.readFile(d))}else if(S.exists(t.url)){d=t.url;const u=S.getFile(d);u&&typeof u.content=="string"&&(r=u.content)}if(!r&&t.title.startsWith("/customer-portal")){const u=S.getFile(t.title);u&&typeof u.content=="string"&&(r=u.content)}const o=r||t.snippet||"無內容",c=t.images?t.images.map(u=>`<div class="detail__image"><img src="${h(u)}" alt="preview" style="width:100%;display:block" onerror="this.src='https://via.placeholder.com/320x480?text=Sawyer+Writing'" /></div>`).join(""):t.image?`<div class="detail__image"><img src="${h(t.image)}" alt="preview" onerror="this.src='https://via.placeholder.com/320x180?text=Preview'" /></div>`:"";i.innerHTML=`
    ...
    <div class="detail__card">
      ...
      ${c}
      <div class="detail__snippet">${La(o,Ca)}</div>
      ${r?`<pre class="detail__pre">${h(r)}</pre>`:""}
      <div class="result__meta" style="margin-top:12px">
        <span class="result__tag">${t.type}</span>
      </div>
    </div>
  `,i.querySelector("#searchBackBtn")?.addEventListener("click",()=>ye());const m=document.querySelector(".search");m&&(m.scrollTop=0);const p=document.getElementById("view-search");p&&(p.scrollTop=0),i.scrollIntoView({behavior:"auto",block:"start"})}var vt=0,sa=null,Zi=!1,Z="/darknet/全結構圖",gt="secret",Tt=!1;function er(){return S.buildDarkTree?S.buildDarkTree():S.buildTree()}function tr(e){const t=er();function a(n,i){if(n.path===i)return n;if(!n.children)return null;for(const r of n.children){const d=a(r,i);if(d)return d}return null}const s=a(t,e);return!s||!s.children?[]:s.children}function Un(){document.getElementById("view-darknet")&&(Z==="/darknet"&&(Z="/darknet/全結構圖"),l.hasFlag("dark_entered"),Xt())}function Za(){const e=document.getElementById("dock");e&&(e.style.display="none"),M(()=>Promise.resolve().then(()=>re).then(t=>{t.setDockVisible&&t.setDockVisible(!1)}),void 0).catch(()=>{})}function Kt(){const e=document.getElementById("dock");e&&(e.style.display=""),M(()=>Promise.resolve().then(()=>re).then(t=>{t.setDockVisible&&t.setDockVisible(!0)}),void 0).catch(()=>{})}function Xt(){const e=document.getElementById("view-darknet");if(e)if(gt==="secret"){const t=At,a=l.hasFlag("dark_secret_active");!t&&Tt||a?Za():Kt(),e.innerHTML=`
      <div class="darknet">
    ...
    `,ar()}else{Z==="/darknet"&&(Z="/darknet/全結構圖");const t=l.hasFlag("dark_secret_active");!At&&Tt||t?Za():Kt();const a=tr(Z),s=a.filter(i=>i.type==="dir"),n=a.filter(i=>i.type==="file");e.innerHTML=`
      <div class="darknet">
    ...
    `,sr(),ir(s,n),or()}}function ar(){const e=document.getElementById("darkTitle");document.getElementById("darkSearchInput");const t=document.getElementById("darkBackBtn");t&&t.addEventListener("click",()=>{Kt();try{l.setFlag("dark_secret_active",!1)}catch{}M(()=>Promise.resolve().then(()=>re).then(s=>{s.setActiveView&&(s.setActiveView("intranet"),localStorage.setItem("cc_active_view","intranet"))}),void 0),gt="secret",At=!1,Tt=!1;const a=document.getElementById("view-darknet");a&&(a.innerHTML="")}),e&&(e.style.cursor="default",!At&&e.addEventListener("click",()=>{vt++,sa&&clearTimeout(sa),sa=setTimeout(()=>{vt=0},2e3),vt>=6&&(vt=0,nr())}))}function nr(){Zi=!0,gt="files",Z==="/darknet"&&(Z="/darknet/全結構圖"),l.setFlag("dark_entered",!0),l.setFlag("ch3_entered_secret",!0),l.setFlag("hidden_portal_accessed",!0),Xt(),l.setFlag("found_code_map",!0)}function sr(){const e=document.getElementById("darkNav");e&&(e.innerHTML=[{path:"/darknet/全結構圖",label:"全結構圖",icon:"🗺️"},{path:"/darknet/交易列表",label:"交易列表",icon:"📋"},{path:"/darknet/合作公司列表",label:"合作公司",icon:"🏢"},{path:"/darknet/流量",label:"流量",icon:"📦"},{path:"/darknet/月結單",label:"月結單",icon:"💰"},{path:"/darknet/Sawyer支出",label:"Sawyer支出",icon:"💸"},{path:"/darknet/出差紀錄",label:"出差紀錄",icon:"✈️"},{path:"/darknet/會議紀錄",label:"會議記錄",icon:"📝"}].map(t=>`<div class="darknet__nav-item ${Z===t.path||Z.startsWith(t.path+"/")?"active":""}" data-path="${t.path}"><span>${t.icon}</span><span>${t.label}</span></div>`).join(""),e.querySelectorAll(".darknet__nav-item").forEach(t=>t.addEventListener("click",()=>{Z=t.dataset.path,Xt()})))}function ir(e,t){const a=document.getElementById("darkMain");if(a){if(!e.length&&!t.length){const s=S.getDarkFile?S.getDarkFile(Z):null;if(s&&s.content){a.innerHTML=`<pre style="white-space:pre-wrap;word-break:break-word;font-family:var(--font-mono);font-size:13px;color:#e9edef">${h(s.content.slice(0,8e3))}</pre>`,l.discoverFile(Z),$a();return}a.innerHTML='<div style="padding:24px;text-align:center;color:#5a3a3e">此資料夾為空</div>';return}a.innerHTML=`
  ...
  `,a.querySelectorAll(".darknet__file-row").forEach(s=>{s.addEventListener("click",()=>{const n=s.dataset.path;s.dataset.type==="dir"?(Z=n,Xt()):rr(n)})})}}function rr(e){const t=S.getDarkFile?S.getDarkFile(e):S.getFile(e);if(!t)return;const a=document.getElementById("darkPreview"),s=document.getElementById("darkPreviewName"),n=document.getElementById("darkPreviewContent");if(!a||!s||!n)return;s.textContent=e;let i=t.content||"";if(e.toLowerCase().endsWith(".csv")){const r=i.split(`
`).filter(u=>u.trim()!==""),d=u=>{const v=[];let g="",y=!1;for(let T=0;T<u.length;T++){const A=u[T];A==='"'?y&&u[T+1]==='"'?(g+='"',T++):y=!y:A===","&&!y?(v.push(g),g=""):g+=A}return v.push(g),v},o=d(r[0]||""),c=r.slice(1).map(d),m=`<thead><tr>${o.map(u=>`<th style="padding:8px 10px;border:1px solid #722F37;background:#1a0a0c;color:#a67c81;text-align:left">${h(u)}</th>`).join("")}</tr></thead>`,p=`<tbody>${c.map(u=>`<tr>${u.map(v=>`<td style="padding:7px 10px;border:1px solid #1a0a0c;color:#e9edef">${h(v)}</td>`).join("")}</tr>`).join("")}</tbody>`;n.innerHTML=`<div style="padding:8px 12px;border-bottom:1px solid #1a0a0c;background:#1a0a0c;display:flex;justify-content:space-between"><span class="small muted" style="color:#8b6a6e">${h(e)} — 表格檢視</span><span class="small muted" style="color:#8b6a6e">${c.length} 列</span></div><div style="overflow:auto;max-height:60vh"><table style="width:100%;border-collapse:collapse;font-size:13px">${m}${p}</table></div>`,n.style.whiteSpace="normal"}else i.length>12e3&&(i=i.slice(0,12e3)+`
...`),n.textContent=i,n.style.whiteSpace="pre-wrap";a.style.display="flex",l.discoverFile(e),l.setFlag("dark_opened:"+e,!0),$a()}function or(){document.getElementById("darkExitBtn")?.addEventListener("click",()=>{gt="secret",Tt=!1;try{l.setFlag("dark_secret_active",!1)}catch{}Kt(),$a(!0),M(()=>Promise.resolve().then(()=>re).then(t=>{t.setActiveView&&(t.setActiveView("intranet"),localStorage.setItem("cc_active_view","intranet"))}),void 0);const e=document.getElementById("view-darknet");e&&(e.innerHTML=""),l.hasFlag("ch4_all_opened")&&setTimeout(()=>{window.dispatchEvent(new CustomEvent("darknet:exit"))},300)}),document.getElementById("darkPreviewClose")?.addEventListener("click",()=>{const e=document.getElementById("darkPreview");e&&(e.style.display="none")}),document.getElementById("darkPreview")?.addEventListener("click",e=>{e.target.id==="darkPreview"&&(e.target.style.display="none")})}function $a(e=!1){const t=S.listDarkFiles?S.listDarkFiles("/darknet"):[];if(!t.length)return;const a=t.filter(s=>l.hasFlag("dark_opened:"+s.path)||l.hasFlag("discovered:"+s.path)||l.get("discoveredFiles")?.includes(s.path));a.length>=t.length?(l.hasFlag("ch4_all_opened")||l.setFlag("ch4_all_opened",!0),e&&!l.hasFlag("ch5_triggered")&&(l.setFlag("ch5_triggered",!0),window.dispatchEvent(new CustomEvent("ch4:complete")),setTimeout(()=>{const s=document.getElementById("mailDialog");if(s&&!s.open)try{s.showModal()}catch{s.style.display="block",s.setAttribute("open","")}},500))):e&&a.length>=t.length,a.length>=t.length&&!l.hasFlag("ch4_all_opened")&&l.setFlag("ch4_all_opened",!0)}var At=!1;function ia(e={}){if(!(l.hasFlag("ch1_0043_committed")&&!l.hasFlag("ch1_revert_done"))&&document.getElementById("view-darknet")){if(At=!!e.simple,Tt=!0,e.simple)try{l.setFlag("dark_secret_active",!1)}catch{}else try{l.setFlag("dark_secret_active",!0)}catch{}gt="secret",vt=0,M(()=>Promise.resolve().then(()=>re).then(t=>{t.setActiveView&&(t.setActiveView("darknet"),localStorage.setItem("cc_active_view","darknet"))}),void 0),Un()}}var ae="/intranet",Ye="",en="/intranet/client_info";function $t(e){return e===en||e.startsWith(en+"/")}function tn(e){const t=S.buildTree();function a(n,i){if(n.path===i)return n;if(!n.children)return null;for(const r of n.children){const d=a(r,i);if(d)return d}return null}const s=a(t,e);return!s||!s.children?[]:s.children}function lr(){const e=document.getElementById("view-intranet");e&&(e.innerHTML=`
    <div class="intranet">
  ...
  `,cr(),Wn())}function cr(){const e=S.internalPathDomain||"https://nori-intranet/internal/portal?",t=S.getLegacyRoute&&S.getLegacyRoute("nori-portal-2023")?._hash||"f665a7117959b667b7f283eaebf69cae",a=e+"hash="+t,s="https://nori-intranet/internal/portal";function n(r){if(!r)return!1;const d=r.trim();return!!(d===a||d.startsWith("https://nori-intranet/internal/portal?hash="+t))}function i(){const r=document.getElementById("intraSearch"),d=r?r.value.trim():"",o=d===s||d===s+"/"||d.includes("nori-intranet/internal/portal")&&!d.includes("hash="),c=n(d);if(l.hasFlag("ch1_0043_committed")&&!l.hasFlag("ch1_revert_done")&&(o||c)){Ye=d.toLowerCase(),ga();return}if(o){l.setFlag("portal_simple_entered",!0),ia({simple:!0});return}if(c){l.setFlag("portal_hash_entered",!0);const m=d.match(/hash=([a-f0-9]{32})/i),p=m?m[1]:t;if(S.tryAccessPortal&&S.tryAccessPortal({hash:p})){ia({simple:!1});return}else if(d===a){ia({simple:!1});return}}Ye=d.toLowerCase(),ga()}document.getElementById("intraSearchBtn")?.addEventListener("click",i),document.getElementById("intraSearch")?.addEventListener("keydown",r=>{r.key==="Enter"&&(r.preventDefault(),i())}),document.getElementById("intraPreviewClose")?.addEventListener("click",la),document.getElementById("intraPreview")?.addEventListener("click",r=>{r.target.id==="intraPreview"&&la()}),document.addEventListener("keydown",r=>{r.key==="Escape"&&la()})}function Wn(){dr(),pr(),ga();const e=S.listFiles("/intranet").length,t=document.getElementById("intraCount");t&&(t.textContent=`內網共 ${e} 個檔案`)}function dr(){const e=document.getElementById("intraBreadcrumb");if(!e)return;const t=ae.split("/").filter(Boolean);let a='<span class="intra-bc__item" data-path="/intranet">🏠 內網首頁</span>',s="/intranet";const n=t[0]==="intranet"?1:0;t.slice(n).forEach(i=>{s+="/"+i;const r=$t(s);a+=` <span class="muted">›</span> <span class="intra-bc__item ${s===ae?"active":""} ${r?"locked":""}" data-path="${h(s)}">${h(i)}${r?" 🔒":""}</span>`}),ae==="/intranet"&&(a='<span class="intra-bc__item active" data-path="/intranet">🏠 內網首頁</span>'),e.innerHTML=a,e.querySelectorAll(".intra-bc__item").forEach(i=>{i.addEventListener("click",()=>Zt(i.dataset.path))})}function pr(){const e=document.getElementById("intraNav");e&&(e.innerHTML=[{path:"/intranet",label:"內網首頁",icon:"🏠",desc:"總覽"},{path:"/intranet/company_public",label:"公司公開資訊",icon:"🏢",desc:"名稱・Logo・大樓名錄"},{path:"/intranet/client_info",label:"客戶資料",icon:"🔒",desc:"權限管制（鎖定）",locked:!0},{path:"/intranet/business_plans",label:"業務計畫",icon:"📊",desc:"完整流程結構"},{path:"/intranet/staff",label:"員工資料",icon:"👥",desc:"50 人名錄"}].map(t=>`<div class="intra-nav__item ${ae===t.path||t.path!=="/"&&ae.startsWith(t.path+"/")?"active":""} ${t.locked?"locked":""}" data-path="${t.path}" title="${t.path}">
  ...
  `,e.querySelectorAll(".intra-nav__item").forEach(t=>{t.addEventListener("click",()=>Zt(t.dataset.path))}))}function ga(){const e=document.getElementById("intraMain");if(!e)return;if(Ye){const n=S.searchContent(Ye).filter(o=>o.path.startsWith("/intranet")).slice(0,40),i=S.listFiles("/intranet").filter(o=>o.path.toLowerCase().includes(Ye)).slice(0,40),r=new Map;n.forEach(o=>r.set(o.path,o)),i.forEach(o=>{r.has(o.path)||r.set(o.path,{path:o.path,snippet:""})});const d=[...r.values()];if(!d.length){e.innerHTML='<div class="intra-empty">無搜尋結果 — 試試「Nori」「冰釀茶酒」「業務流程」「Sawyer」</div>';return}e.innerHTML=`
      <div class="intra-section__title">搜尋結果「${h(Ye)}」— ${d.length} 筆</div>
    ...
    `,oa(e);return}if($t(ae)){e.innerHTML=`
      <div class="intra-locked">
        ...
        <div class="intra-locked__files">
          ...
          ${tn(ae).map(n=>`<div class="intra-file__row locked" title="${h(n.path)}"><span>${va(n.path)}</span><span>${h(n.name)}</span><span class="small muted" style="margin-left:auto">🔒 鎖定</span></div>`).join("")}
        </div>
        <button class="btn" style="margin-top:12px" onclick="document.querySelector('[data-path='/intranet']')?.click()">返回內網首頁</button>
      </div>
    `;return}const t=tn(ae),a=t.filter(n=>n.type==="dir"),s=t.filter(n=>n.type==="file");if(ae==="/intranet"&&!Ye){e.innerHTML=`
  ...
  </div>`}function va(e){return e?e.endsWith(".md")?"📝":e.endsWith(".csv")?"📊":e.endsWith(".svg")?"🖼️":e.endsWith(".json")?"🧩":e.endsWith(".js")||e.endsWith(".java")?"💻":e.endsWith(".html")?"🌐":e.endsWith(".pdf")?"📕":"📄":"📄"}function oa(e){e.querySelectorAll(".intra-file__row").forEach(t=>{t.addEventListener("click",()=>{const a=t.dataset.path,s=t.dataset.type;if(t.classList.contains("locked")){if(document.getElementById("intraMain")){const n=document.createElement("div");n.className="toast",n.style.cssText="position:fixed;right:12px;bottom:64px;background:#323232;color:#fff;padding:10px 12px;border-radius:8px;z-index:999",n.textContent="🔒 權限不足 — 客戶資料受保護，遊戲內無需存取",document.body.appendChild(n),setTimeout(()=>n.remove(),2200)}return}s==="dir"?Zt(a):mr(a)})})}function Zt(e){e&&(ae=e,Wn())}function ur(e){const t=e.split(`
`).filter(s=>s.trim()!=="");if(!t.length)return{header:[],rows:[]};const a=s=>{const n=[];let i="",r=!1;for(let d=0;d<s.length;d++){const o=s[d];o==='"'?r&&s[d+1]==='"'?(i+='"',d++):r=!r:o===","&&!r?(n.push(i),i=""):i+=o}return n.push(i),n};return{header:a(t[0]),rows:t.slice(1).map(a)}}function mr(e){const t=S.getFile(e);if(!t||t.meta?.locked||$t(e))return;const a=document.getElementById("intraPreview"),s=document.getElementById("intraPreviewName"),n=document.getElementById("intraPreviewContent");if(!a||!s||!n)return;s.textContent=e;let i=t.content||"";if(e.toLowerCase().endsWith(".csv")){const{header:r,rows:d}=ur(i),o=`<thead><tr>${r.map(m=>`<th>${h(m)}</th>`).join("")}</tr></thead>`,c=`<tbody>${d.map(m=>`<tr>${m.map(p=>`<td>${h(p)}</td>`).join("")}</tr>`).join("")}</tbody>`;n.innerHTML=`
...
...（內容已截斷，完整請於 Vizual Studio Code 開啟）`),n.textContent=i,n.style.whiteSpace="pre-wrap";a.style.display="flex"}function la(){const e=document.getElementById("intraPreview");e&&(e.style.display="none")}function an(){const e=l.get("settings.theme")||"dark";document.documentElement.setAttribute("data-theme",e)}function Gn(){return!!document.fullscreenElement}function Jn(){Gn()?document.exitFullscreen().catch(()=>{}):document.documentElement.requestFullscreen().catch(()=>{})}function ct(e){e&&(e.textContent=Gn()?"關閉全螢幕":"開啟全螢幕")}function hr(){document.querySelectorAll("dialog[open]").forEach(n=>{try{n.close()}catch{}});const e=document.getElementById("startMenu");e&&(e.style.display="none");const t=document.getElementById("intraPreview");t&&(t.style.display="none");const a=document.getElementById("darkPreview");a&&(a.style.display="none");const s=document.getElementById("waLightbox");s&&s.classList.remove("open"),document.querySelectorAll("dialog").forEach(n=>{n.open||n.style.removeProperty("display")})}function ke(e){hr(),pn(e),localStorage.setItem("cc_active_view",e)}function gr(){Us(),_a(),Dn(),qi(),lr(),Un(),yr(),br(),_r()}var Yn=null;function vr(e){try{const t=JSON.parse(localStorage.getItem("code_conspiracy_state")||"{}").whatsappChats;if(Array.isArray(t)){const a=t.find(s=>s.id===e);if(a)return!!a.muted}return!1}catch{return!1}}function fr(){try{const t=JSON.parse(localStorage.getItem("code_conspiracy_state")||"{}");if(t.flags&&t.flags.ch0_maggie_notified||t.flags&&t.flags.ch0_vip_fixed||t.currentChapter&&t.currentChapter!==0)return}catch{}if(l.hasFlag("ch0_maggie_notified")||l.hasFlag("ch0_vip_fixed")||(l.get("currentChapter")??0)!==0||vr("maggie")||document.getElementById("wa-win-notification"))return;const e=document.createElement("div");e.id="wa-win-notification",e.setAttribute("role","alert"),e.setAttribute("aria-live","polite"),e.innerHTML=`
    <div class="win-notif__app">
      <img src="/arg-game-it-company-secret/icon/whatsup.svg" alt="WhatUp" width="20" height="20" style="width:20px;height:20px;object-fit:contain" />
      <span class="win-notif__app-name">WhatUp</span>
      <span class="win-notif__app-sub">主管 - Maggie</span>
    ...
    <div class="win-notif__progress"></div>
  `,e.addEventListener("click",t=>{if(!t.target.closest(".win-notif__close")){ca();try{at("maggie")}catch{}ke("whatsapp")}}),e.querySelector(".win-notif__close")?.addEventListener("click",t=>{t.stopPropagation(),ca()}),document.body.appendChild(e),l.setFlag("ch0_maggie_notified",!0),requestAnimationFrame(()=>e.classList.add("show")),Yn=setTimeout(()=>ca(),1e4)}function ca(){const e=document.getElementById("wa-win-notification");e&&(clearTimeout(Yn),e.classList.remove("show"),e.classList.add("hide"),setTimeout(()=>e.remove(),280))}function Kn(e){e==="jira_viewed"&&l.setFlag("onb_jira_viewed",!0),e==="vscode_viewed"&&l.setFlag("onb_vscode_viewed",!0),l.hasFlag("onboarding_done")||l.setFlag("onboarding_done",!0)}function yr(){const e=document.getElementById("mailDialog"),t=document.getElementById("mailTitle"),a=document.getElementById("mailTo"),s=document.getElementById("mailSend"),n=document.getElementById("mailTempExit");function i(){if(!t||!a)return;const r=t.value;r==="Report"?a.value="Drug Enforcement Administration <dea@email.us>":(r==="Coperation"||r==="Resign")&&(a.value="Sawyer <sawyer@nori.com>")}t?.addEventListener("change",i),i(),n?.addEventListener("click",()=>{e?.close(),Be({onSwitch:ke,onOpenSettings:Ge,onOpenNotebook:Je,t:he})}),s?.addEventListener("click",()=>{const r=t?.value,d=document.getElementById("mailBody")?.value||"",o=document.getElementById("mailTo")?.value||"";try{wi({title:r,to:o,body:d})}catch{}let c=null;if(r==="Report"?c="report":r==="Coperation"?c="cooperate":r==="Resign"&&(c="resign"),c){const m=l.get("endings")||[];m.includes(c)||(m.push(c),l.set("endings",m),l.setFlag("ending_"+c,!0));try{jn(c)}catch{}}else try{Se("email_submit_no_ending",{email_title:r,email_body_preview:d.slice(0,80)})}catch{}e?.close(),Be({onSwitch:ke,onOpenSettings:Ge,onOpenNotebook:Je,t:he}),c?setTimeout(()=>Qn(c),300):W("郵件已寄送: "+r)})}function br(){const e=document.getElementById("startMenu");e&&document.addEventListener("click",t=>{const a=t.target.closest&&t.target.closest(".taskbar__start"),s=t.target.closest&&t.target.closest("#startShutdown"),n=t.target.closest&&t.target.closest("#startLogout");if(a){t.stopPropagation();const i=e.style.display==="none"||!e.style.display||e.style.display==="";e.style.display=i?"block":"none";return}if(s){t.stopPropagation(),e.style.display="none",nn("shutdown");return}if(n){t.stopPropagation(),e.style.display="none",nn("logout");return}e.contains(t.target)||(e.style.display="none")})}function nn(e){const t=l.get("endings")||[],a=l.hasFlag("ch4_all_opened"),s=t[0];let n=null;!s&&!a?n="flee":!s&&a?n="fried":s==="report"?n="report":s==="cooperate"?n="cooperate":s==="resign"?n="resign":n="flee";const i=l.get("endings")||[];i.includes(n)||(i.push(n),l.set("endings",i));try{jn(n),Se("shutdown",{action:e,ending:n})}catch{}Qn(n)}function Qn(e){const t=document.getElementById("endingScreen"),a=document.getElementById("endingTitle"),s=document.getElementById("endingDesc"),n=document.getElementById("endingRestart");if(!t||!a||!s)return;const i={flee:"flee",cooperate:"cooperate",report:"report",resign:"resign",fried:"fried"}[e];i&&se.play(i);const r={flee:{title:"平凡的日常",desc:`你已完成了工作，登出了電腦，走出辨公室，回到家中安心睡一覺。
...
`||v.includes(`
`))&&(g+=200),/^\s+$/.test(v)&&(g=100),e==="fried"&&(v==="其"||v==="實"||p.includes("其實"))&&(g=420),setTimeout(u,g)}u()},500)}function _r(){document.getElementById("endingRestart")?.addEventListener("click",async()=>{se.stop(!1);let e=null;try{e=JSON.parse(JSON.stringify(l.get("persistentStats")||{}))}catch{}try{l.reset()}catch{}try{if(e){const a=l.get("persistentStats")||{},s={unlockedEndings:[...new Set([...a.unlockedEndings||[],...e.unlockedEndings||[]])],readArticles:[...new Set([...a.readArticles||[],...e.readArticles||[]])],darkFileCount:Math.max(a.darkFileCount||0,e.darkFileCount||0),whatsappSentCount:Math.max(a.whatsappSentCount||0,e.whatsappSentCount||0),searchHistoryCount:Math.max(a.searchHistoryCount||0,e.searchHistoryCount||0),flags:{...a.flags||{},...e.flags||{}}};l.set("persistentStats",s),l.set("unlockedEndings",s.unlockedEndings)}}catch{}const t=document.getElementById("endingScreen");t&&(t.style.display="none"),document.querySelectorAll("dialog[open]").forEach(a=>{try{a.close()}catch{}a.style.display="none"});try{if("caches"in window){const a=await caches.keys();await Promise.all(a.map(s=>caches.delete(s)))}if("serviceWorker"in navigator){const a=await navigator.serviceWorker.getRegistrations();await Promise.all(a.map(s=>s.unregister()))}}catch{}setTimeout(()=>{window.location.href=window.location.pathname+"?reset="+Date.now(),window.location.reload(!0)},150)}),document.getElementById("endingClose")?.addEventListener("click",()=>{document.getElementById("endingScreen").style.display="none"})}function wr(){const e=document.getElementById("welcomeDialog");if(!e)return;const t=document.getElementById("welcomeFullscreenBtn"),a=document.getElementById("welcomeMuteBtn"),s=document.getElementById("welcomeVolumeSlider"),n=document.getElementById("welcomeVolumePct"),i=document.getElementById("welcomeStartBtn");ct(t),t?.addEventListener("click",()=>{Jn(),ct(t)}),document.addEventListener("fullscreenchange",()=>{ct(t),ct(document.getElementById("settingFullscreenBtn"))}),a&&a.addEventListener("click",()=>{const r=se.toggleMute();a.textContent=r?"🔇":"🔊",n&&(n.textContent=r?"靜音":Math.round(se.getVolume()*100)+"%")}),s&&s.addEventListener("input",r=>{const d=parseInt(r.target.value)/100;se.setVolume(d),se.setMuted(!1),a&&(a.textContent="🔊"),n&&(n.textContent=Math.round(d*100)+"%")}),i?.addEventListener("click",()=>{e.close()}),typeof e.showModal=="function"?e.showModal():e.show()}function xr(){const e=document.getElementById("settingFullscreenBtn");e&&(ct(e),e.addEventListener("click",()=>{Jn(),ct(e)}))}function kr(){const e=document.getElementById("analyticsBanner"),t=document.getElementById("analyticsAccept"),a=document.getElementById("analyticsDecline"),s=document.getElementById("analyticsConsentToggle"),n=document.getElementById("analyticsGasUrl"),i=document.getElementById("analyticsSaveBtn"),r=document.getElementById("analyticsTestBtn"),d=document.getElementById("analyticsFlushBtn"),o=document.getElementById("analyticsStatus"),c=document.getElementById("analyticsQueueCount"),m=document.getElementById("analyticsSessionId");try{e&&!Mn()&&(e.style.display="flex")}catch{}const p=()=>{try{const u=JSON.parse(localStorage.getItem("cc_analytics_queue")||"[]");if(c&&(c.textContent=String(u.length)),m){const v=(()=>{try{return pa()}catch{return null}})(),g=zt().slice(0,8),y=v?v.id.slice(0,12):"-";m.textContent=g+" / "+y,m.title="SID: "+zt()+`
GameSession: `+(v?v.id+" ("+v.startAt+")":"-")}if(o&&(Te()?Re()?o.textContent="就緒（所有玩家自動共用此 URL，無需各自輸入）":o.textContent="已設定，等待玩家同意":o.textContent="尚未設定 GAS URL（需部署時設定 VITE_GAS_URL，其他玩家才會自動生效）"),s&&(s.checked=Re()),n){let v=!1;try{v=!0}catch{}if(Te())if(n.value=Ze(),n.disabled=!1,v){try{localStorage.getItem("cc_gas_url")||(n.title="已由 GitHub Secrets VITE_GAS_URL 注入，所有玩家共用，無需各自輸入")}catch{}n.placeholder="已由部署設定（所有玩家自動共用）"}else n.placeholder="https://script.google.com/macros/s/.../exec";else n.value="",n.disabled=!1,n.placeholder="https://script.google.com/macros/s/.../exec"}}catch{}};p(),t?.addEventListener("click",()=>{qt(!0),e&&(e.style.display="none"),p(),W("已啟用匿名數據收集"),et()}),a?.addEventListener("click",()=>{qt(!1),e&&(e.style.display="none"),p(),W("已拒絕數據收集")}),s?.addEventListener("change",u=>{qt(u.target.checked),p(),W(u.target.checked?"已啟用":"已停用")}),i?.addEventListener("click",()=>{const u=n?.value.trim()||"";if(u&&!u.startsWith("https://script.google.com/")){o&&(o.textContent="URL 需為 https://script.google.com/.../exec");return}wn(u),p(),W("已儲存 GAS URL")}),r?.addEventListener("click",async()=>{if(!Te()){W("請先設定 GAS URL"),o&&(o.textContent="未設定：請貼上你部署的 exec URL");return}if(!Re()){W("請先勾選 同意匿名收集"),o&&(o.textContent="等待同意：請先勾選同意");return}o&&(o.textContent="發送中...");const u=Ze(),v={timestamp:new Date().toISOString(),session_id:zt(),event_type:"test_ping",chapter:0,payload_json:JSON.stringify({test:!0,from:"settings_test_btn"})};try{const g=await(await fetch(u,{method:"POST",headers:{"Content-Type":"text/plain;charset=utf-8"},body:JSON.stringify(v),redirect:"follow",mode:"cors"})).text();let y=null;try{y=JSON.parse(g)}catch{}y&&y.ok?(W("測試成功！Sheets 已新增一列"),o&&(o.textContent="成功：Sheets 已寫入 test_ping")):(W("GAS 回應異常："+g.slice(0,120)),o&&(o.textContent="GAS 回應："+(y?.error||g.slice(0,80))),console.warn("[analytics] test response",g))}catch(g){console.warn("[analytics] test fetch 失敗",g),Se("test_ping",{payload_json:JSON.stringify({test:!0,fallback:!0})}),o&&(o.textContent="網路錯誤，已入隊（查看 Console）"),W("網路錯誤，已入隊重試")}p()}),d?.addEventListener("click",()=>{et(),p(),W("已嘗試補送，查看 Console 與 Sheets"),setTimeout(p,800)}),setInterval(p,2e3);try{window.__analyticsRefresh=p}catch{}}function sn(){an(),Be({onSwitch:ke,onOpenSettings:Ge,onOpenNotebook:Je,t:he}),Ts(),xr();try{ki()}catch{}kr(),gr();const e=localStorage.getItem("cc_active_view")||"vscode";ke(l.get("unlockedInterfaces").includes(e)?e:"vscode"),bs(),se.play("default"),l.hasFlag("onboarding_done")||l.setFlag("onboarding_done",!0),l.hasFlag("welcome_dialog_shown")||(l.setFlag("welcome_dialog_shown",!0),setTimeout(()=>wr(),400)),setTimeout(()=>fr(),800),G.on("puzzle:solved",t=>{W("✓ "+t.title);try{Se("puzzle_solved",{puzzle:t.id,chapter:t.chapter})}catch{}}),G.on("interfaceUnlocked",t=>{W(he("toast.unlocked")+": "+t),Be({onSwitch:ke,onOpenSettings:Ge,onOpenNotebook:Je,t:he});try{Se("interface_unlocked",{iface:t})}catch{}}),G.on("evidence",t=>{W(he("toast.evidence")+": "+t.title);try{Se("evidence_collected",{evidence:t.id})}catch{}}),l.on("change",()=>an()),window.addEventListener("ch4:complete",()=>{l.setFlag("ch5_triggered",!0),Be({onSwitch:ke,onOpenSettings:Ge,onOpenNotebook:Je,t:he}),setTimeout(()=>{const t=document.getElementById("mailDialog");if(t&&!t.open){const a=document.getElementById("mailTitle"),s=document.getElementById("mailTo");if(a&&s){const n=a.value;n==="Report"?s.value="DEA <dea@world.example>":(n==="Coperation"||n==="Resign")&&(s.value="Sawyer <sawyer@nori-drinks.example>")}t.showModal()}},600)}),window.addEventListener("darknet:exit",()=>{se.play("default"),l.hasFlag("ch4_all_opened")&&!l.hasFlag("ch5_triggered")?(l.setFlag("ch5_triggered",!0),Be({onSwitch:ke,onOpenSettings:Ge,onOpenNotebook:Je,t:he}),setTimeout(()=>{const t=document.getElementById("mailDialog");t&&!t.open&&t.showModal()},400)):l.hasFlag("ch5_triggered")&&((l.get("endings")||[]).length||setTimeout(()=>{const t=document.getElementById("mailDialog");t&&!t.open&&t.showModal()},400))}),l.on("change",t=>{if(t&&t.path&&t.path.includes("ch5_triggered")&&Be({onSwitch:ke,onOpenSettings:Ge,onOpenNotebook:Je,t:he}),t&&t.path&&t.path.includes("dark_entered")&&se.play("darknet"),t&&t.path&&t.path.includes("ch0_vip_fixed")&&!l.hasFlag("ch1_event1_triggered")&&(l.setFlag("ch1_event1_triggered",!0),setTimeout(()=>{M(()=>Promise.resolve().then(()=>le).then(a=>{a.triggerCh1Event1&&a.triggerCh1Event1()}),void 0)},1e4)),t&&t.path==="currentChapter"&&t.value===2&&!l.hasFlag("ch2_lunch_seq_done")&&setTimeout(()=>{M(()=>Promise.resolve().then(()=>le).then(a=>{a.triggerCh2LunchSequence&&a.triggerCh2LunchSequence()}),void 0)},600),t&&t.path==="currentChapter")try{xi(t.value),Se("chapter_progress",{chapter:t.value})}catch{}if(t&&t.path&&t.path.includes("ch4_all_opened")&&t.value)try{Se("ch4_all_opened",{chapter:4})}catch{}}),l.hasFlag("ch0_vip_fixed")&&!l.hasFlag("ch1_event1_triggered")&&(l.setFlag("ch1_event1_triggered",!0),setTimeout(()=>{M(()=>Promise.resolve().then(()=>le).then(t=>{t.triggerCh1Event1&&t.triggerCh1Event1()}),void 0)},1e4)),l.get("currentChapter")===2&&!l.hasFlag("ch2_lunch_seq_done")&&setTimeout(()=>{M(()=>Promise.resolve().then(()=>le).then(t=>{t.triggerCh2LunchSequence&&t.triggerCh2LunchSequence()}),void 0)},900),G.on("chapter:changed",t=>{t===2&&!l.hasFlag("ch2_lunch_seq_done")&&setTimeout(()=>{M(()=>Promise.resolve().then(()=>le).then(a=>{a.triggerCh2LunchSequence&&a.triggerCh2LunchSequence()}),void 0)},600)}),window.addEventListener("jira:ticketAdded",()=>{document.getElementById("jiraBoard")&&M(()=>Promise.resolve().then(()=>ft).then(t=>{G.emit("jira:refresh")}),void 0)}),window.addEventListener("jira:refresh",()=>{try{_a()}catch{}}),document.querySelectorAll("dialog").forEach(t=>{t.addEventListener("click",a=>{a.target===t&&t.close()}),t.addEventListener("cancel",a=>{a.preventDefault(),t.close()}),t.addEventListener("close",()=>{t.style.removeProperty("display")})})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",sn):sn();

//# sourceMappingURL=main-CvHYUyLH.js.map