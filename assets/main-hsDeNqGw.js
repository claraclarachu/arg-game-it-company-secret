...
`,meta:{portal:!0}}),w("/internal/portal/export",{hidden:!1,content:"SQLite export endpoint - 需要 portalAuth 通過 (Nori 訂單匯出)",meta:{portal:!0}})}function dn(){X("/darknet/全結構圖/drug-route-graph.md",{content:`# 全結構圖
...
- alchol 對應 LEAF
- 玻璃瓶 對應 CRYSTAL
- 紙箱 通用`,meta:{lang:"markdown"}}),X("/darknet/交易列表/drug-transactions.csv",{content:`datetime,location,client_company,traffic_used,drug_code,quantity,status
...
`,meta:{lang:"csv"}}),X("/darknet/合作公司列表/companies.md",{content:`# 合作公司列表及聯絡方式
...
| FredyArc | 海外組織 | Fredy | +1 415-555-0100 | 毒品來源 |`,meta:{lang:"markdown"}}),X("/darknet/流量/drug-traffic.csv",{content:`datetime,location,client_company,traffic_used,drug_code,quantity,status
...
`,meta:{lang:"csv"}}),X("/darknet/月結單/monthly-2023-12.csv",{content:`month,from,to,amount,type,note
2023-12,FredyArc,Nori,125000,收入,合作資金
2023-12,FredyArc,Nori,85000,收入,企業合作
2023-12,Nori,Anonymous,320,支出,小額
`,meta:{lang:"csv"}}),X("/darknet/月結單/monthly-2024-01.csv",{content:`month,from,to,amount,type,note
2024-01,FredyArc,Nori,320000,收入,季度分潤
2024-01,Nori,Anonymous,750,支出,
`,meta:{lang:"csv"}}),X("/darknet/月結單/monthly-2024-02.csv",{content:`month,from,to,amount,type,note
2024-02,FredyArc,Nori,450000,收入,
2024-02,FredyArc,Nori,120000,收入,
2024-02,Nori,Anonymous,420,支出,
`,meta:{lang:"csv"}}),X("/darknet/Sawyer支出/sawyer_expenses.csv",{content:`日期,項目,金額(HKD),備註
...
`,meta:{lang:"csv"}}),X("/darknet/出差紀錄/travel_records.csv",{content:`日期,目的地,行程目的,天數,同行人員
...
`,meta:{lang:"csv"}}),X("/darknet/會議紀錄/meeting_minutes.md",{content:`# Nori × FredyArc 定期會議紀錄
...
`,meta:{lang:"markdown"}})}dn();cn();var k={registerFile:w,getFile:xa,listFiles:Za,buildTree:en,readFile:tn,exists:an,searchContent:nn,canAccessPortal:rn,tryAccessPortal:on,bypassPortalAuth:ln,registerDarkFile:X,getDarkFile:wa,listDarkFiles:Ja,buildDarkTree:Qa,readDarkFile:Xa,registerLegacyRoute:_a,getLegacyRoute:Ga,listLegacyRoutes:Ya,findLegacyRoute:Ka,internalPathDomain:ba},pn=[{id:"ch0_vip_fix",chapter:0,check:()=>p.hasFlag("ch0_vip_fixed"),reward:{},title:"修正 VIP 折扣計算 (INV-2024-0042)"},{id:"ch1_system_alert",chapter:1,check:()=>p.hasFlag("ch1_system_down"),reward:{evidence:{id:"e001",title:"INV-2024-0043 系統警報",chapter:1,type:"anomaly"}},title:"觸發系統警報 (INV-2024-0043)"},{id:"ch1_feng_shui_tree",chapter:1,check:()=>p.hasFlag("ch1_tree_seen"),reward:{evidence:{id:"e002",title:"老闆的風水樹",chapter:1,type:"behavior"}},title:"發現老闆的風水樹"},{id:"ch2_accident_news",chapter:2,check:()=>p.get("searchHistory")?.some(e=>e.includes("Sawyer")||e.includes("Choi")||e.includes("車禍")),reward:{evidence:{id:"e003",title:"車禍新聞 — 父母雙亡",chapter:2,type:"news"}},title:"搜尋到車禍新聞"},{id:"ch2_insurance_blog",chapter:2,check:()=>p.get("discoveredFiles")?.includes("https://sawyer-blog.example/2012-07-07")||p.get("searchHistory")?.some(e=>e.includes("保險")),reward:{evidence:{id:"e004",title:"保險受益人 Blog",chapter:2,type:"blog"}},title:"發現保險受益人文章"},{id:"ch2_lottery_lie",chapter:2,check:()=>p.hasFlag("lottery_lie_seen"),reward:{evidence:{id:"e005",title:"六合彩謊言",chapter:2,type:"lie"}},title:"發現六合彩謊言紀錄"},{id:"ch2_dark_blog",chapter:2,check:()=>p.get("discoveredFiles")?.includes("https://sawyer-blog.example/2023-12-20"),reward:{evidence:{id:"e006",title:"Sawyer 暗示文字",chapter:2,type:"blog"}},title:"發現 2023-12-20 Blog"},{id:"ch3_git_secret",chapter:3,check:()=>p.hasFlag("git_secret_found"),reward:{evidence:{id:"e007",title:"Git 刪除的 secret path",chapter:3,type:"code"}},title:"在 Git 歷史找到刪除的 secret path"},{id:"ch3_darknet_url",chapter:3,check:()=>p.hasFlag("dark_entered")||p.hasFlag("hidden_portal_accessed"),reward:{evidence:{id:"e008",title:"暗網入口 URL",chapter:3,type:"portal"}},title:"找到暗網完整入口"},{id:"ch4_drug_transactions",chapter:4,check:()=>p.hasFlag("ch4_all_opened")||p.get("discoveredFiles")?.some(e=>e.includes("/darknet/")),reward:{evidence:{id:"e009",title:"毒品交易紀錄",chapter:4,type:"darknet"}},title:"開啟毒品交易列表"},{id:"ch4_drug_route",chapter:4,check:()=>p.hasFlag("ch4_all_opened")||p.get("discoveredFiles")?.some(e=>e.includes("drug-route")),reward:{evidence:{id:"e010",title:"毒品結構圖",chapter:4,type:"darknet"}},title:"開啟毒品結構圖"},{id:"ch4_sawyer_expenses",chapter:4,check:()=>p.hasFlag("ch4_all_opened")||p.get("discoveredFiles")?.some(e=>e.includes("sawyer_expenses")),reward:{evidence:{id:"e011",title:"Sawyer 個人支出",chapter:4,type:"darknet"}},title:"發現 Sawyer 與 FredyArc 金流"},{id:"ch4_travel_records",chapter:4,check:()=>p.hasFlag("ch4_all_opened")||p.get("discoveredFiles")?.some(e=>e.includes("travel_records")),reward:{evidence:{id:"e012",title:"Travel 紀錄",chapter:4,type:"darknet"}},title:"發現 Sawyer 多次前往毒品路線城市"},{id:"ch4_meeting_minutes",chapter:4,check:()=>p.hasFlag("ch4_all_opened")||p.get("discoveredFiles")?.some(e=>e.includes("meeting_minutes")),reward:{evidence:{id:"e013",title:"Sawyer × Fredy 會議紀錄",chapter:4,type:"darknet"}},title:"發現定期會議紀錄"},{id:"ch5_choose_ending",chapter:5,check:()=>(p.get("endings")||[]).length>0,reward:{},title:"選擇結局"}];function Oe(){for(const t of pn)p.hasFlag(`puzzle:${t.id}`)||t.check()&&(p.setFlag(`puzzle:${t.id}`,!0),t.reward?.evidence&&p.addEvidence(t.reward.evidence),t.reward?.unlock&&t.reward.unlock.forEach(a=>p.unlockInterface(a)),W.emit("puzzle:solved",t));let e=0;p.hasFlag("ch0_vip_fixed")&&(e=1),p.hasFlag("ch1_revert_done")&&(e=2),(p.hasFlag("dark_entered")||p.hasFlag("hidden_portal_accessed"))&&(e=3),p.hasFlag("ch4_all_opened")&&(e=4),(p.get("endings")||[]).length>0&&(e=5),e!==p.get("currentChapter")&&(p.set("currentChapter",e),W.emit("chapter:changed",e))}var un=null;function mn(){W.on("change",Oe),W.on("vfs:read",Oe),W.on("portal:discovered",Oe),W.on("portal:bypassed",Oe),un=setInterval(Oe,800),Oe()}var Zt={"zh-TW":{"app.title":"聽日辭職","app.subtitle":"編程人生模擬 · 離線 ARG","dock.vscode":"Vizual Studio Code","dock.intranet":"內網","dock.jira":"Jiua","dock.whatsapp":"WhatUp","dock.search":"Search","dock.notebook":"筆記本","dock.settings":"設定","settings.theme":"主題","settings.language":"語言","settings.export":"匯出存檔","settings.import":"匯入存檔","settings.reset":"重置進度","toast.saved":"已儲存","toast.evidence":"發現新證據","toast.unlocked":"解鎖新介面"},en:{"app.title":"聽日辭職","app.subtitle":"Dev Life Sim · Offline ARG","dock.vscode":"Vizual Studio Code","dock.intranet":"Intranet","dock.jira":"Jiua","dock.whatsapp":"WhatUp","dock.search":"Search","dock.notebook":"Notebook","dock.settings":"Settings","settings.theme":"Theme","settings.language":"Language","settings.export":"Export Save","settings.import":"Import Save","settings.reset":"Reset Progress","toast.saved":"Saved","toast.evidence":"New evidence","toast.unlocked":"Interface unlocked"}};function ee(e){const t=p.get("settings.language")||"zh-TW";return Zt[t]?.[e]??Zt["zh-TW"][e]??e}var ie=Ht({renderDock:()=>be,setActiveView:()=>ka});function be({onSwitch:e,onOpenSettings:t,onOpenNotebook:a,t:n}){const i=document.getElementById("dock");if(!i)return;function s(m){return m==="email"?p.hasFlag("ch5_triggered"):!0}const r=localStorage.getItem("cc_active_view")||"vscode",l={vscode:"/arg-game-it-company-secret/icon/vizual-studio-code.svg",intranet:"/arg-game-it-company-secret/icon/file-system.svg",jira:"/arg-game-it-company-secret/icon/jiua.svg",whatsapp:"/arg-game-it-company-secret/icon/whatsup.svg",search:"/arg-game-it-company-secret/icon/browser.svg",email:"/arg-game-it-company-secret/icon/mail.svg"},o={notebook:"/arg-game-it-company-secret/icon/notepad.png"};function c(m,y,x){const g=!s(m),_=r===m?"active":"",B=l[m];let M;return B&&B.startsWith("/icon/")?M=`<img class="taskbar__app-icon-img" src="${B}" alt="${x}" width="22" height="22" loading="eager" />`:B&&B.startsWith("fa-")?m==="jira"?M=`<i class="${B}" aria-hidden="true" style="font-size:22px;line-height:1;--fa-primary-color:rgba(19,91,205,1);--fa-secondary-color:rgba(19,91,205,0.4);color:rgba(19,91,205,1)"></i>`:m==="vscode"?M=`<i class="${B}" aria-hidden="true" style="font-size:22px;line-height:1;--fa-primary-color:rgba(87,165,229,1);--fa-secondary-color:rgba(87,165,229,0.4);color:rgba(87,165,229,1)"></i>`:m==="whatsapp"?M=`<i class="${B}" aria-hidden="true" style="font-size:22px;line-height:1;--fa-primary-color:rgba(0,203,90,1);--fa-secondary-color:rgba(0,203,90,0.4);color:rgba(0,203,90,1)"></i>`:M=`<i class="${B}" aria-hidden="true" style="font-size:22px;line-height:1;color:currentColor"></i>`:B?M=`<img class="taskbar__app-icon-img" src="${B}" alt="${x}" width="22" height="22" loading="eager" />`:M=`<span class="taskbar__app-icon" aria-hidden="true">${y}</span>`,`<button class="taskbar__app ${_}" data-view="${m}" ${g?'disabled title="尚未解鎖"':`title="${x}"`}>
  ...
  `,i.querySelectorAll("[data-view]").forEach(m=>{m.addEventListener("click",()=>{if(m.dataset.view==="email"){const y=document.getElementById("mailDialog");if(y){const x=document.getElementById("mailTitle"),g=document.getElementById("mailTo");if(x&&g){const _=x.value;_==="Report"?g.value="DEA <dea@world.example>":(_==="Coperation"||_==="Resign")&&(g.value="Sawyer <sawyer@nori-drinks.example>")}y.showModal()}return}e(m.dataset.view)})}),i.querySelector('[data-action="settings"]')?.addEventListener("click",t),i.querySelector('[data-action="notebook"]')?.addEventListener("click",a),vn()}var Lt=null;function vn(){function e(){const t=new Date,a=document.getElementById("taskbarTime"),n=document.getElementById("taskbarDate");if(!a||!n)return;const i=t.toLocaleTimeString("zh-TW",{hour:"numeric",minute:"2-digit",hour12:!0}),s=t.toLocaleDateString("zh-TW",{year:"numeric",month:"2-digit",day:"2-digit"});a.textContent=i,n.textContent=s}e(),Lt&&clearInterval(Lt),Lt=setInterval(e,6e4)}function ka(e){localStorage.setItem("cc_active_view",e),document.querySelectorAll(".taskbar__app[data-view]").forEach(t=>{t.classList.toggle("active",t.dataset.view===e)}),document.querySelectorAll(".view").forEach(t=>{t.classList.toggle("active",t.id===`view-${e}`)})}function Ve(e,t={}){const a=document.getElementById("toasts");if(!a)return;const n=document.createElement("div");n.className="toast",n.textContent=e,t.variant==="error"&&(n.style.background="#7a1f1f"),a.appendChild(n),setTimeout(()=>{n.style.opacity="0",n.style.transform="translateY(4px)",n.style.transition="all .25s",setTimeout(()=>n.remove(),260)},t.duration||2200)}function gn(e,t){const a=new Blob([t],{type:"application/json;charset=utf-8"}),n=URL.createObjectURL(a),i=document.createElement("a");i.href=n,i.download=e,i.click(),URL.revokeObjectURL(n)}function hn(e){return new Promise((t,a)=>{const n=new FileReader;n.onload=()=>t(n.result),n.onerror=a,n.readAsText(e)})}var fn={default:"/arg-game-it-company-secret/assets/data/music/Teacup Corridor (warmer).mp3",darknet:"/arg-game-it-company-secret/assets/data/music/Teacup Corridor.mp3",cooperate:"/arg-game-it-company-secret/assets/data/music/bgm_cowork.mp3",flee:"/arg-game-it-company-secret/assets/data/music/bgm_flee.mp3",fried:"/arg-game-it-company-secret/assets/data/music/bgm_fried.mp3",report:"/arg-game-it-company-secret/assets/data/music/bgm_report.mp3",resign:"/arg-game-it-company-secret/assets/data/music/bgm_resign.mp3"},yn=.25,ea=1500,bn=class{constructor(){this.audio=null,this.currentBgm=null,this.isMuted=!1,this.volume=yn,this.fadeTimer=null,this._loadSettings()}_loadSettings(){const e=p.get("settings");e&&(typeof e.bgmVolume=="number"&&(this.volume=e.bgmVolume),typeof e.bgmMuted=="boolean"&&(this.isMuted=e.bgmMuted))}_saveSettings(){p.set("settings.bgmVolume",this.volume),p.set("settings.bgmMuted",this.isMuted)}_createAudio(e){const t=new Audio(e);return t.loop=!0,t.preload="auto",t.volume=this.isMuted?0:this.volume,t}_fadeVolume(e,t,a,n){this.fadeTimer&&cancelAnimationFrame(this.fadeTimer);const i=performance.now(),s=r=>{const l=r-i,o=Math.min(l/a,1),c=e+(t-e)*o;this.audio&&(this.audio.volume=this.isMuted?0:c),o<1?this.fadeTimer=requestAnimationFrame(s):(this.fadeTimer=null,n&&n())};this.fadeTimer=requestAnimationFrame(s)}_stopCurrent(e=!0){if(!this.audio)return Promise.resolve();const t=this.audio,a=t.volume;return e&&a>0?new Promise(n=>{this._fadeVolume(a,0,ea,()=>{t.pause(),t.src="",n()})}):(t.pause(),t.src="",Promise.resolve())}async play(e){const t=fn[e];if(t&&this.currentBgm!==e){await this._stopCurrent(!0),this.currentBgm=e,this.audio=this._createAudio(t);try{await this.audio.play(),this._fadeVolume(0,this.volume,ea)}catch(a){console.warn("BGM play failed:",a)}}}async stop(e=!0){await this._stopCurrent(e),this.audio=null,this.currentBgm=null}setVolume(e){this.volume=Math.max(0,Math.min(1,e)),this.audio&&!this.isMuted&&(this.audio.volume=this.volume),this._saveSettings()}getVolume(){return this.volume}toggleMute(){return this.isMuted=!this.isMuted,this.audio&&(this.audio.volume=this.isMuted?0:this.volume),this._saveSettings(),this.isMuted}setMuted(e){this.isMuted=e,this.audio&&(this.audio.volume=this.isMuted?0:this.volume),this._saveSettings()}isMutedState(){return this.isMuted}getCurrentBgm(){return this.currentBgm}},ue=new bn;function Ae(){const e=document.getElementById("settingsDialog");e&&(e.showModal?.()||(e.style.display="block"),_n())}function _n(){const e=document.getElementById("settingTheme");e&&(e.value=p.get("settings.theme"));const t=document.getElementById("settingPlaytime");t&&(t.textContent=String(p.get("playtime"))+"s")}function wn(){document.getElementById("settingTheme")?.addEventListener("change",n=>{const i=n.target.value;p.set("settings.theme",i),document.documentElement.setAttribute("data-theme",i),Ve(ee("toast.saved"))});const e=document.getElementById("bgmMuteBtn"),t=document.getElementById("bgmVolumeSlider"),a=document.getElementById("bgmVolumePct");e&&!e._bound&&(e._bound=!0,e.addEventListener("click",()=>{const n=ue.toggleMute();e.textContent=n?"🔇":"🔊",a&&(a.textContent=n?"靜音":Math.round(ue.getVolume()*100)+"%")})),t&&!t._bound&&(t._bound=!0,t.addEventListener("input",n=>{const i=parseInt(n.target.value)/100;ue.setVolume(i),ue.setMuted(!1),e&&(e.textContent="🔊"),a&&(a.textContent=Math.round(i*100)+"%")})),document.getElementById("btnExport")?.addEventListener("click",()=>{gn("code-conspiracy-save.json",p.exportSave())}),document.getElementById("btnImport")?.addEventListener("change",async n=>{const i=n.target.files?.[0];if(!i)return;const s=await hn(i),r=p.importSave(s);Ve(r?ee("toast.saved"):"Import failed",{variant:r?void 0:"error"}),r&&location.reload()}),document.getElementById("btnReset")?.addEventListener("click",async()=>{if(confirm("Reset all progress?")){try{p.reset()}catch{}try{localStorage.removeItem("code_conspiracy_state")}catch{}try{localStorage.clear()}catch{}const n=document.getElementById("settingsDialog");if(n&&n.open)try{n.close()}catch{}n&&(n.style.display="none",n.removeAttribute("open"));try{if("caches"in window){const i=await caches.keys();await Promise.all(i.map(s=>caches.delete(s)))}if("serviceWorker"in navigator){const i=await navigator.serviceWorker.getRegistrations();await Promise.all(i.map(s=>s.unregister()))}}catch{}setTimeout(()=>{window.location.href=window.location.pathname+"?reset="+Date.now(),window.location.reload(!0)},150)}}),document.getElementById("settingsDialog")?.addEventListener("close",()=>{})}var ta=["教學","異常發現","自由探索","暗網入口","秘密曝光","抉擇"],xn=13,kn={vscode:"Vizual",jira:"Jiua",whatsapp:"WhatUp",search:"Search",intranet:"Intranet",darknet:"Darknet",email:"Email"};function Sn(e){return!e||!e.length?"—":e.map(t=>kn[t]||t).join(", ")}function En(e){return[{id:"first_evidence",title:"初次發現",desc:"取得第一個證據",check:()=>e.length>=1},{id:"collector",title:"蒐集者",desc:"取得 5 個證據",check:()=>e.length>=5},{id:"master",title:"真相大師",desc:"取得 10 個證據",check:()=>e.length>=10},{id:"darknet_entered",title:"暗網闖入者",desc:"成功進入暗網",check:()=>p.hasFlag("dark_entered")||p.hasFlag("hidden_portal_accessed")},{id:"darknet_complete",title:"暗網全覽",desc:"開啟所有暗網檔案",check:()=>p.hasFlag("ch4_all_opened")}].map(t=>({...t,done:t.check()}))}function Be(){const e=document.getElementById("notebookDialog");e&&(In(),typeof e.showModal=="function"?e.open||e.showModal():(e.setAttribute("open",""),e.style.display="block"),e._boundClose||(e.addEventListener("close",()=>{e.style.display="none",e.removeAttribute("open")}),e._boundClose=!0))}function In(){const e=document.getElementById("notebookContent");if(!e)return;const t=p.get("collectedEvidence")||[];p.get("flags");const a=p.get("currentChapter")??0,n=En(t),i=n.filter(s=>s.done).length;e.innerHTML=`
    <div class="card">
  ...
  `,setTimeout(()=>{const s=document.getElementById("notebookResetBtn");!s||s._bound||(s._bound=!0,s.addEventListener("click",async()=>{if(!confirm("重置後將失去證據，確定？"))return;const r=document.getElementById("notebookDialog");try{r&&r.open&&r.close()}catch{}r&&(r.style.display="none",r.removeAttribute("open"));try{p.reset()}catch{}try{localStorage.removeItem("code_conspiracy_state")}catch{}try{localStorage.clear()}catch{}try{if("caches"in window){const l=await caches.keys();await Promise.all(l.map(o=>caches.delete(o)))}if("serviceWorker"in navigator){const l=await navigator.serviceWorker.getRegistrations();await Promise.all(l.map(o=>o.unregister()))}}catch{}setTimeout(()=>{window.location.href=window.location.pathname+"?reset="+Date.now(),window.location.reload(!0)},150)}))},0)}function d(e){return e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}var Ln="modulepreload",Cn=function(e){return"/arg-game-it-company-secret/"+e},aa={},j=function(t,a,n){let i=Promise.resolve();if(a&&a.length>0){let c=function(m){return Promise.all(m.map(y=>Promise.resolve(y).then(x=>({status:"fulfilled",value:x}),x=>({status:"rejected",reason:x}))))},u=function(m){return import.meta.resolve?import.meta.resolve(m):new URL(m,import.meta.url).href};const r=document.getElementsByTagName("link"),l=document.querySelector("meta[property=csp-nonce]"),o=l?.nonce||l?.getAttribute("nonce");i=c(a.map(m=>{if(m=Cn(m,n),m=u(m),m in aa)return;aa[m]=!0;const y=m.endsWith(".css");for(let g=r.length-1;g>=0;g--){const _=r[g];if(_.href===m&&(!y||_.rel==="stylesheet"))return}const x=document.createElement("link");if(x.rel=y?"stylesheet":Ln,y||(x.as="script"),x.crossOrigin="",x.href=m,o&&x.setAttribute("nonce",o),document.head.appendChild(x),y)return new Promise((g,_)=>{x.addEventListener("load",g),x.addEventListener("error",()=>_(new Error(`Unable to preload CSS for ${m}`)))})}))}function s(r){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=r,window.dispatchEvent(l),!l.defaultPrevented)throw r}return i.then(r=>{for(const l of r||[])l.status==="rejected"&&s(l.reason);return t().catch(s)})},N="/customer-portal/src/main/java/com/nori/OrderService.java",K="explorer",ye=[],Q=-1,ut="",R=new Map,ke=null,na=null;function qe(e){const t=k.getFile(e);return t?t.content:null}function Pt(e){return R.has(e)?R.get(e):qe(e)}function Sa(e){return R.has(e)?R.get(e)!==qe(e):!1}function $n(e,t){t===qe(e)?R.delete(e):R.set(e,t),ne(),Ee()}function qt(){if(!ke){const e=k.getFile("/file-system/src/components/SearchBar.jsx");e&&(ke=e.content)}}function Tn(){if(!na){const e=k.getFile("/customer-portal/src/frontend/src/pages/Home.jsx");e&&(na=e.content)}}var An=`export default function Home(){
  return (
    <div>
      <h1>Nori 飲品供應 — 用一杯冰釀茶酒，連結人與希望</h1>
      <p>創辦人 蔡梓掦 · 2018 創立 · 招牌冰釀茶酒最暢銷</p>
...
+ restored legacyRoutes`});const i=document.getElementById("scmCommitStatus");i&&(i.innerHTML=`<span style="color:var(--success)">✓ Revert 成功: ${a} (from ${e})</span>`),L(`✓ revert ${a} — ${n}`),ne(),he(),Ee(),me&&xe(),Ia("git-graph")}var Se=[{hash:"a1b2c3d",author:"finance@internal",date:"2024-08-12",msg:"feat: integrate crypto-mixer (legacy)",diff:`+ import { cryptoMixer } from '@shady/crypto-mixer'
...
+ export function computeFee(amount, opts) {}`}],ia={"/customer-portal/src/billing/service.js":[{line:1,commit:"4c2a1e0",author:"dev"},{line:5,commit:"4c2a1e0",author:"dev"},{line:9,commit:"9f8e7d6",author:"qa-lee"},{line:12,commit:"9f8e7d6",author:"qa-lee"},{line:14,commit:"a1b2c3d",author:"finance@internal"}],"/customer-portal/src/main/java/com/nori/OrderService.java":[{line:1,commit:"4c2a1e0",author:"dev"},{line:12,commit:"9f8e7d6",author:"qa-lee"},{line:15,commit:"a1b2c3d",author:"finance@internal"}]},te="__GIT_GRAPH__",me=!1,Je=null,sa={main:"#89d185","feature/vip-discount":"#4da3ff","feature/crypto-mixer":"#dcdcaa","feature/billing-fix":"#ce9178","feature/home-copyfix":"#4ec9b0",develop:"#c586c0"},ge=[{hash:"a1b2c3d",branch:"feature/crypto-mixer",author:"finance@internal",date:"2024-08-12",msg:"(INV-2024-0040) feat: integrate crypto-mixer (legacy)",diff:`+ import { cryptoMixer } from '@shady/crypto-mixer'
...
`).length,u=n.querySelector(".editor__gutter");u&&(u.innerHTML=Array.from({length:c},(B,M)=>`<div class="editor__gutter-line" style="height:20px;line-height:20px">${M+1}</div>`).join(""));const m=r.selectionStart,y=o.slice(0,m),x=y.split(`
`).length,g=y.split(`
...
`).length,m=c.split(`
`).pop().length+1,y=document.getElementById("vsCursorInfo");y&&(y.textContent=`Ln ${u}, Col ${m}`)}),r.addEventListener("keydown",l=>{if(l.key==="Tab"){l.preventDefault();const o=r.selectionStart,c=r.selectionEnd;r.value=r.value.substring(0,o)+"  "+r.value.substring(c),r.selectionStart=r.selectionEnd=o+2,r.dispatchEvent(new Event("input"))}}),e.includes("OrderService")&&setTimeout(()=>r.focus(),50))}const i=document.getElementById("vsTitle");i&&(i.textContent=`${e.split("/").pop()} — ${e} — nori-system — Vizual Studio Code`),he(document.getElementById("vsQuickOpen")?.value.trim().toLowerCase()||""),ne(),L(`$ open ${e}`)}function Ee(){const e=document.getElementById("scmChanges");if(!e)return;const t=[...R.entries()].filter(([a,n])=>n!==qe(a));if(!t.length){e.innerHTML=`<div class="small muted" style="padding:8px 0">修改完成後在這邊提交
...
請修正後重新 Commit。`),I&&(I.style.display="flex"),t&&(t.innerHTML=`<span style="color:var(--error)">✕ SonarQube: 行 ${s.line} 計算錯誤</span>`),L(`✕ commit 失敗 — SonarQube 行 ${s.line}: ${s.detail}`);return}const r="/file-system/src/components/SearchBar.jsx",l=qe(r)||"",o=Pt(r)||l,c=o.includes("legacyRoutes"),u=o.includes("resolveLegacyPath"),m=l.includes("legacyRoutes")&&!c&&!u;if(Array.from(R.keys()).includes(r),p.hasFlag("ch0_vip_fixed")&&!p.hasFlag("ch1_0043_committed")&&!m){const I=document.getElementById("sonarModal"),h=document.getElementById("sonarModalBody");h&&(h.textContent=`SonarQube 掃描失敗 — 未移除已棄用的 legacy 入口

檔案: ${r}
錯誤: 偵測到未移除的 legacyRoutes / resolveLegacyPath 區塊`),I&&(I.style.display="flex"),t&&(t.innerHTML='<span style="color:var(--error)">✕ SonarQube: 尚未移除 legacyRoutes 區塊 (SearchBar.jsx)</span>');return}if(m&&p.hasFlag("ch0_vip_fixed")&&!p.hasFlag("ch1_0043_committed")){let b=function({appSub:v,sender:f,avatarBg:T,avatarText:$,msg:q,chatId:Le,duration:De}){const Ce=De||4e3,D=document.createElement("div");return D.id="wa-win-notif-"+Date.now()+"-"+Math.random().toString(36).slice(2,6),D.setAttribute("role","alert"),D.innerHTML=`<div class="win-notif__app"><img src="/arg-game-it-company-secret/icon/whatsup.svg" alt="WhatUp" width="20" height="20" style="width:20px;height:20px;object-fit:contain" /><span class="win-notif__app-name">WhatUp</span><span class="win-notif__app-sub">${d(v)}</span><button class="win-notif__close" aria-label="關閉">✕</button></div><div class="win-notif__body"><div class="win-notif__avatar" style="background:${T}">${d($)}</div><div class="win-notif__text"><div class="win-notif__sender">${d(f)}</div><div class="win-notif__msg">${d(q)}</div><div class="win-notif__time">剛剛 · 點擊開啟對話</div></div></div><div class="win-notif__progress" style="animation: winNotifShrink ${Ce}ms linear forwards"></div>`,D.style.cssText="position:fixed;right:16px;bottom:60px;width:360px;background:#2d2d2d;color:#f0f0f0;border:1px solid rgba(255,255,255,.12);border-radius:8px;box-shadow:0 8px 28px rgba(0,0,0,.45);z-index:1100;overflow:hidden;cursor:pointer;opacity:0;transform:translateY(12px);transition:opacity .28s,transform .28s;",D.addEventListener("click",fe=>{fe.target.closest(".win-notif__close")||(D.remove(),j(()=>Promise.resolve().then(()=>ie).then(oe=>{oe.setActiveView&&(oe.setActiveView("whatsapp"),localStorage.setItem("cc_active_view","whatsapp"))}),void 0),Le&&j(()=>Promise.resolve().then(()=>pe).then(oe=>oe.openChat(Le)),void 0))}),D.querySelector(".win-notif__close")?.addEventListener("click",fe=>{fe.stopPropagation(),D.remove()}),document.body.appendChild(D),requestAnimationFrame(()=>{D.style.opacity="1",D.style.transform="none"}),setTimeout(()=>{D.style.opacity="0",D.style.transform="translateY(8px)",setTimeout(()=>D.remove(),300)},Ce),D};p.setFlag("ch1_0043_committed",!0);const I=Math.random().toString(36).slice(2,8),h=Array.from(R.entries()).map(([v,f])=>`M ${v}`).join(`
`);Se.unshift({hash:I,author:"Casey",date:new Date().toISOString().slice(0,10),msg:a,diff:h}),ge.unshift({hash:I,branch:"main",author:"Casey",date:new Date().toISOString().slice(0,10),msg:a,diff:h});for(const[v,f]of R.entries()){const T=k.getFile(v);T&&(T.content=f),k.registerFile(v,{content:f,meta:{lang:v.endsWith(".java")?"java":v.endsWith(".js")?"javascript":"text"}})}R.clear(),e&&(e.value=""),t&&(t.innerHTML=`<span style="color:var(--success)">✓ Commit 成功: ${I}</span>`),L(`✓ commit ${I} — ${a}`),ne(),he(),Ee(),me&&N===te&&xe();try{j(()=>Promise.resolve().then(()=>Qe).then(v=>v.markTicketDone&&v.markTicketDone("INV-2024-0043")),void 0)}catch{}setTimeout(()=>{p.setFlag("ch1_system_down",!0);let v=0;const f=setInterval(()=>{if(!p.hasFlag("ch1_system_down")||p.hasFlag("ch1_revert_done")){clearInterval(f);return}v++,j(()=>Promise.resolve().then(()=>pe).then(T=>{const $=(T.getChats?T.getChats():[]).find(q=>q.id==="system-alert");if($){const q=`⚠️ 警告 #${v}: 系統異常 — 檢測到異常，請檢查最近變更`;$.messages.push({id:"alert-"+Date.now()+"-"+v,from:"system",text:q,time:new Date().toLocaleTimeString("zh-TW",{hour:"2-digit",minute:"2-digit"}),read:"delivered",type:"text"}),$.preview=`⚠️ 警告 #${v}: 系統異常`,$.unread=($.unread||0)+1,$.lastTime="剛剛",window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"system-alert"}}))}b({appSub:"System Alert",sender:"System Alert",avatarBg:"linear-gradient(135deg, #d93025, #fbbc05)",avatarText:"!",msg:`⚠️ 警告 #${v}: 系統異常 — 檢測到異常`,chatId:"system-alert",duration:4e3})}),void 0),v===5&&(setTimeout(()=>{j(()=>Promise.resolve().then(()=>pe).then(T=>{const $=(T.getChats?T.getChats():[]).find(q=>q.id==="dev-team");$&&($.messages.push({id:"sawyer-dev-"+Date.now(),from:"Sawyer",text:"各位，系統怎麼一直在告警？發生什麼事了？是誰剛才改了什麼？",time:"剛剛",read:"delivered",type:"text"}),$.preview="Sawyer: 系統怎麼一直在告警？",$.unread=($.unread||0)+1,window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"dev-team"}})),b({appSub:"Dev Team",sender:"Sawyer",avatarBg:"linear-gradient(135deg, #722F37, #8B1A1A)",avatarText:"S",msg:"各位，系統怎麼一直在告警？發生什麼事了？",chatId:"dev-team",duration:4e3}))}),void 0)},500),setTimeout(()=>{j(()=>Promise.resolve().then(()=>pe).then(T=>{const $=(T.getChats?T.getChats():[]).find(q=>q.id==="dev-team");$&&($.messages.push({id:"maggie-dev-"+Date.now(),from:"Maggie",text:"好像是剛才 INV-2024-0043 的修改，應該是最後一次變更就是這個任務",time:"剛剛",read:"delivered",type:"text"}),$.preview="Maggie: 好像是 0043 的修改...",$.unread=($.unread||0)+1,window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"dev-team"}})),b({appSub:"Dev Team",sender:"Maggie",avatarBg:"linear-gradient(135deg, #25D366, #128C7E)",avatarText:"M",msg:"好像是 INV-2024-0043 的修改，最後一次變更就是這個",chatId:"dev-team",duration:4e3}))}),void 0)},5500),setTimeout(()=>{j(()=>Promise.resolve().then(()=>pe).then(T=>{const $=(T.getChats?T.getChats():[]).find(q=>q.id==="sawyer");$&&($.messages.push({id:"sawyer-pm-"+Date.now(),from:"Sawyer",text:"Casey，麻煩你先把 0043 的改動 revert 吧，系統要緊，先回滾再說",time:"剛剛",read:"delivered",type:"text"}),$.preview="Sawyer: 麻煩你先把 0043 revert",$.unread=($.unread||0)+1,window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"sawyer"}})),b({appSub:"Sawyer",sender:"Sawyer",avatarBg:"linear-gradient(135deg, #722F37, #8B1A1A)",avatarText:"S",msg:"Casey，麻煩你先把 0043 的改動 revert 吧",chatId:"sawyer",duration:4e3}),T.startSawyerRevertSeq&&(T.startSawyerRevertSeq(),me&&setTimeout(()=>xe(),200)))}),void 0)},10500))},5e3)},5e3);return}const y=c&&u&&p.hasFlag("ch1_system_down")&&!p.hasFlag("ch1_revert_done"),x=a.toLowerCase().includes("revert")&&p.hasFlag("ch1_system_down")&&!p.hasFlag("ch1_revert_done");if(y||x){if(y)for(const[v,f]of R.entries()){k.registerFile(v,{content:f,meta:{lang:v.endsWith(".js")?"javascript":v.endsWith(".java")?"java":"text"}});const T=k.getFile(v);T&&(T.content=f)}else if(qt(),ke){k.registerFile("/file-system/src/components/SearchBar.jsx",{content:ke,meta:{lang:"javascript"}});const v=k.getFile("/file-system/src/components/SearchBar.jsx");v&&(v.content=ke)}p.setFlag("ch1_revert_done",!0),p.setFlag("ch1_system_down",!1);const I=Math.random().toString(36).slice(2,8),h=y,b=h?`M /file-system/src/components/SearchBar.jsx
+ restored legacyRoutes / resolveLegacyPath (paste back)`:"M revert 0043";Se.unshift({hash:I,author:"Casey",date:new Date().toISOString().slice(0,10),msg:a,diff:b}),ge.unshift({hash:I,branch:"main",author:"Casey",date:new Date().toISOString().slice(0,10),msg:a,diff:b}),R.clear(),t&&(t.innerHTML=`<span style="color:var(--success)">✓ Commit 成功 (revert): ${I}</span>`),L(`✓ commit ${I} — ${a} (revert)`),ne(),he(),Ee(),me&&xe(),Ia(h?"paste-back":"keyword");try{j(()=>Promise.resolve().then(()=>Qe).then(v=>{const f=v.getTickets().find(T=>T.key==="INV-2024-0043");f&&(f.status="Done",f.history.push({from:"To Do",to:"Done",by:"Casey",at:new Date().toISOString().slice(0,10)}))}),void 0)}catch{}return}const g=Math.random().toString(36).slice(2,8),_=new Date().toISOString().slice(0,10),B="Casey",M=`M ${n}
`+Object.entries(s.found).map(([I,h])=>`  case ${I}: price*=${h.val.toFixed(2)}`).join(`
`);Se.unshift({hash:g,author:B,date:_,msg:a,diff:M}),ge.unshift({hash:g,branch:"main",author:B,date:_,msg:a,diff:M});const Ye=k.getFile(n);Ye&&(Ye.content=i),k.registerFile(n,{content:i,meta:{lang:"java"}}),R.clear(),e&&(e.value=""),t&&(t.innerHTML=`<span style="color:var(--success)">✓ Commit 成功: ${g}</span>`),L(`✓ commit ${g} — ${a}`),ne(),he(),Ee(),me&&N===te&&xe();try{j(()=>Promise.resolve().then(()=>Qe).then(I=>{I.markTicketDone?I.markTicketDone("INV-2024-0042"):I.completeVipTicket&&I.completeVipTicket()}),void 0)}catch{}p.setFlag("ch0_vip_fixed",!0),p.setFlag("onboarding_done",!0),setTimeout(()=>{j(()=>Promise.resolve().then(()=>ie).then(I=>{I.setActiveView&&(I.setActiveView("jira"),localStorage.setItem("cc_active_view","jira"))}),void 0).catch(()=>{localStorage.setItem("cc_active_view","jira"),document.querySelectorAll(".view").forEach(I=>I.classList.toggle("active",I.id==="view-jira")),document.querySelectorAll(".taskbar__app").forEach(I=>I.classList.toggle("active",I.dataset.view==="jira"))}),setTimeout(()=>{const I=new CustomEvent("jira:refresh");window.dispatchEvent(I)},100)},400)}function Hn(){L('tip: 在 editor 搜尋 "calculateVipPrice" 找到 VIP 折扣邏輯'),L("tip: 編輯 OrderService.java 後至 Source Control 提交"),L("輸入 help 查看可用指令 · Tab 補全 · ↑↓ 歷史")}function L(e){const t=document.getElementById("vsTerminalHist"),a=document.getElementById("vsTerminal"),n=t||a;if(!n)return;const i=document.createElement("div");i.className="terminal__line",i.textContent=e,n.appendChild(i),t&&(t.scrollTop=t.scrollHeight),a&&(a.scrollTop=a.scrollHeight)}function Vn(e){const t=e.target,a=t.value;if(e.key==="Enter"){const n=a.trim();if(!n)return;ye.push(n),Q=ye.length,L(`➜ ${n}`),zn(n),t.value="",ut=""}else if(e.key==="ArrowUp")e.preventDefault(),Q<=0?Q=0:Q--,ut===""&&ye[Q]!==void 0&&(ut=a),ye[Q]!==void 0&&(t.value=ye[Q]);else if(e.key==="ArrowDown")e.preventDefault(),Q++,Q>=ye.length?(Q=ye.length,t.value=ut):t.value=ye[Q];else if(e.key==="Tab"){e.preventDefault();const n=qn(a);n&&(t.value=n)}}function qn(e){const t=["help","ls","cat ","grep ","git log","git diff","git blame","clear","echo "],a=k.listFiles("/customer-portal").map(o=>o.path),n=[...t,...a,...a.map(o=>o.split("/").pop())];if(!e)return e;const i=n.find(o=>o.startsWith(e));if(i)return i;const s=e.split(" "),r=s[s.length-1];if(!r)return e;const l=n.find(o=>o.endsWith(r)||o.includes(r));return l?(s[s.length-1]=l.split(" ").pop(),s.join(" ")):e}function zn(e){const[t,...a]=e.split(/\s+/),n=a.join(" ");switch(t){case"help":L("可用指令: ls [path], cat <file>, grep <keyword>, git log, git diff, git blame <file>, clear, echo <text>"),L("範例: cat /customer-portal/src/main/java/com/nori/OrderService.java");break;case"ls":{const i=a[0]||"/customer-portal";if(i.startsWith("/intranet")||i==="/intranet"){L(`ls: ${i}: 權限不足（內網資料已從 Vizual Studio Code 隱藏）`);break}const s=k.listFiles(i).filter(r=>r.path.startsWith("/customer-portal"));s.length?s.slice(0,20).forEach(r=>L(r.path)):L(`ls: ${i}: No such directory`),s.length>20&&L(`... ${s.length-20} more`);break}case"cat":{const i=a[0];if(!i){L("cat: 缺少檔案路徑");break}if(i.startsWith("/intranet")){L(`cat: ${i}: 權限不足（內網資料已從 Vizual Studio Code 隱藏，僅顯示官網系統）`);break}const s=k.readFile(i)||k.readFile("/customer-portal"+(i.startsWith("/")?"":"/")+i);s==null?L(`cat: ${i}: 檔案不存在或尚未解鎖`):s.split(`
...
`).forEach(i=>{L(i)}),L("hint: 點擊 Source Control 右上角的 Git Graph 按鈕查看完整圖像化歷史");else if(a[0]==="blame"){const i=a[1]||N;L(`blame ${i}:`),(ia[i]||ia["/customer-portal/src/billing/service.js"]).forEach(s=>L(`${String(s.line).padStart(3)} ${s.commit} ${s.author}`))}else a[0]==="graph"?(La(),L("→ 已開啟 Git Graph 編輯器分頁")):L("git: 未知子指令，試 help (支援: git log / git diff / git blame / git graph)");break;case"clear":{const i=document.getElementById("vsTerminalHist");i&&(i.innerHTML="");break}case"echo":L(n);break;default:L(`zsh: command not found: ${t} (試 help)`)}}function Un(){document.addEventListener("keydown",e=>{const t=e.ctrlKey||e.metaKey;if(e.key==="F1"){e.preventDefault();const a=document.getElementById("vsHelpOverlay");a&&(a.style.display=a.style.display==="flex"?"none":"flex");return}if(t&&e.key.toLowerCase()==="p"&&!e.shiftKey)e.preventDefault(),Wn();else if(t&&e.shiftKey&&e.key.toLowerCase()==="f")e.preventDefault(),K="search",gt(),document.getElementById("vsSearchInput")?.focus();else if(t&&e.shiftKey&&e.key.toLowerCase()==="g")e.preventDefault(),K="scm",gt();else if(t&&e.shiftKey&&e.key.toLowerCase()==="d")e.preventDefault(),K="debug",gt();else if(e.key==="Escape"){et();const a=document.getElementById("vsHelpOverlay");a&&(a.style.display="none");const n=document.getElementById("sonarModal");n&&(n.style.display="none")}else t&&e.key==="/"&&(e.preventDefault(),document.getElementById("vsTerminalInput")?.focus())})}function Wn(){const e=document.getElementById("quickOpen"),t=document.getElementById("quickOpenInput");!e||!t||(e.classList.add("open"),t.value="",t.focus(),Ca(""))}function et(){document.getElementById("quickOpen")?.classList.remove("open")}function Ca(e){const t=document.getElementById("quickOpenList");if(!t)return;const a=(e||"").trim().toLowerCase();let n=k.listFiles("/customer-portal"),i=null;if(a.includes(":")){const[s,r]=a.split(":");i=parseInt(r,10),n=n.filter(l=>l.path.toLowerCase().includes(s))}else a&&(n=n.filter(s=>s.path.toLowerCase().includes(a)));if(n=n.slice(0,10),!n.length){t.innerHTML='<div class="quickopen__item muted">無符合檔案 — 試輸入 OrderService / billing</div>';return}t.innerHTML=n.map((s,r)=>`
    <div class="quickopen__item ${r===0?"active":""}" data-path="${s.path}">
      <span>${d(s.path)}</span>
      <span class="quickopen__kbd">${s.path.split(".").pop()}</span>
    </div>
  `).join(""),t.querySelectorAll(".quickopen__item").forEach(s=>{s.addEventListener("click",()=>{J(s.dataset.path),i&&Yn(i),et()})})}function Gn(e){if(e.key==="Escape"){et();return}if(e.key==="Enter"){const t=document.querySelector("#quickOpenList .quickopen__item.active")||document.querySelector("#quickOpenList .quickopen__item");t&&(J(t.dataset.path),et());return}if(e.key==="ArrowDown"||e.key==="ArrowUp"){e.preventDefault();const t=[...document.querySelectorAll("#quickOpenList .quickopen__item")];if(!t.length)return;let a=t.findIndex(n=>n.classList.contains("active"));t[a]?.classList.remove("active"),a=e.key==="ArrowDown"?Math.min(a+1,t.length-1):Math.max(a-1,0),a<0&&(a=0),t[a]?.classList.add("active")}}function Yn(e){const t=document.getElementById("vsEditorArea");if(t){const i=t.value.split(`
`);let s=0;for(let r=0;r<Math.min(e-1,i.length);r++)s+=i[r].length+1;t.focus(),t.setSelectionRange(s,s);return}const a=document.getElementById("vsEditor");if(!a)return;const n=a.querySelector(`[data-ln="${e}"]`);n&&n.scrollIntoView({behavior:"smooth",block:"center"})}var Qe=Ht({addTicket0043:()=>ei,getTickets:()=>ti,markTicketDone:()=>Zn,mountJira:()=>zt}),Me=[{key:"INV-2024-0017",title:"官網首頁文案顯示錯誤 — Hero 標語與成立年份顯示錯誤",status:"Done",assignee:"Parker",priority:"Medium",points:2,epic:"Frontend",desc:`【問題描述】
...
查看Git Graph => 列表形式展示所有變更記錄`,time:"2024-07-15",read:"read",type:"text"},{id:"m13",from:"Maggie",text:"",media:"${import.meta.env.BASE_URL}assets/data/files/wts/sourceControlPage.png",time:"2024-07-15",read:"read",type:"image"},{id:"m14",from:"Maggie",text:"",media:"${import.meta.env.BASE_URL}assets/data/files/wts/sourceControlPage-revert.png",time:"2024-07-15",read:"read",type:"image"},{id:"m15",from:"Maggie",text:"如果修改有誤的話，提交時SonarQube會經過檢查，然後報錯，這時候就要重新修改",time:"2024-07-15",read:"read",type:"text"}]},{id:"dev-team",name:"Dev Team",avatar:"👩‍💻",desc:"Nori網站和內網的開發團隊群組",members:["Maggie","Casey","pm","Taylor","ops"],preview:"Maggie: Hi @Casey, 有新的工單INV-2024-0042, 請協助處理一下。詳細資訊在Jiua可以找到, 有問題再找我。",locked:!1,pinned:!0,muted:!1,archived:!1,unread:1,lastTime:"剛剛",messages:[{id:"m1",from:"Maggie",text:"Hi @Casey, 有新的工單INV-2024-0042, 請協助處理一下。詳細資訊在Jiua可以找到, 有問題再找我。",time:"剛剛",read:"delivered",type:"text"}]},{id:"lunch-team",name:"午餐小隊",avatar:"🍽️",desc:"午餐小隊",members:["Parker","Grace","Hugo","Alex","Casey"],preview:"Alex: 好啊！",locked:!1,pinned:!1,muted:!1,archived:!1,unread:0,lastTime:"2024-09-01",messages:[{id:"m1",from:"Hugo",text:"大新聞！聽說老闆父母車禍身亡了！",time:"2023-04-29",read:"read",type:"text"},{id:"m2",from:"Parker",text:"？！",time:"2023-04-29",read:"read",type:"text"},{id:"m3",from:"Grace",text:"真的嗎？太難過了",time:"2023-04-29",read:"read",type:"text"},{id:"m4",from:"Hugo",text:"對啊，所以才請了一個禮拜假吧",time:"2023-04-29",read:"read",type:"text"},{id:"m5",from:"Hugo",text:"有人覺得近期的老闆很怪嗎？",time:"2023-10-19",read:"read",type:"text"},{id:"m6",from:"Parker",text:"怎麼說？！",time:"2023-10-19",read:"read",type:"text"},{id:"m7",from:"Alex",text:"變開朗了，也變得愛請客了！",time:"2023-10-19",read:"read",type:"text"},{id:"m8",from:"Grace",text:"對啊，之前都挺嚴肅的",time:"2023-10-19",read:"read",type:"text"},{id:"m9",from:"Hugo",text:"對啊！！！",time:"2023-10-19",read:"read",type:"text"},{id:"m10",from:"Hugo",text:"歡迎Casey！！以後帶你吃附近好吃的！",time:"2024-07-16",read:"read",type:"text"},{id:"m11",from:"Parker",text:"歡迎歡迎",time:"2024-07-16",read:"read",type:"text"},{id:"m12",from:"Grace",text:"歡迎~",time:"2024-07-16",read:"read",type:"text"},{id:"m13",from:"Alex",text:"歡迎~~",time:"2024-07-16",read:"read",type:"text"},{id:"m14",from:"Hugo",text:"今天要吃米當當嗎？",time:"2024-09-01",read:"read",type:"text"},{id:"m15",from:"Alex",text:"好啊",time:"2024-09-01",read:"read",type:"text"}]}],ae="dev-team",bt="",Re="all",ce=!1,Te="",ze="chat",G=0;function Ue(e){if(!se.some(n=>n.id===e))return;ae=e;const t=se.find(n=>n.id===e);t&&(t.unread=0),e==="nori-all"&&setTimeout(()=>wt(),100),e==="nori-all"&&setTimeout(()=>wt(),100);const a=document.getElementById("view-whatsapp");a&&a.innerHTML&&(ze="chat",Aa(),We(),V(ae))}function Ta(){const e=document.getElementById("view-whatsapp");e&&(e.innerHTML=`<div class="wa">
  ...
  </div>`,ai(),We(),V(ae))}function ai(){const e=document.getElementById("view-whatsapp");e&&e.querySelectorAll(".wa__sidebar-tab[data-wa-tab]").forEach(t=>{t.addEventListener("click",()=>{const a=t.dataset.waTab;a!==ze&&(ze=a,Aa(),We())})})}function Aa(){document.querySelectorAll(".wa__sidebar-tab[data-wa-tab]").forEach(e=>{const t=e.dataset.waTab===ze;e.classList.toggle("active",t),e.setAttribute("aria-selected",t?"true":"false")})}function We(){ze==="account"?ni():H()}function ni(){const e=document.getElementById("waList");e&&(e.innerHTML=`
  ...
  `)}function Xe(e){return!0}function ii(){let e=[...se];if(bt){const a=bt.toLowerCase();e=e.filter(n=>n.name.toLowerCase().includes(a)||n.preview.toLowerCase().includes(a)||n.desc.toLowerCase().includes(a))}Re==="unread"?e=e.filter(a=>a.unread>0&&Xe(a.id)):Re==="archived"?e=e.filter(a=>a.archived):e=e.filter(a=>!a.archived);const t=["nori-all","dev-team","sawyer","maggie","system-alert","lunch-team"];return e.sort((a,n)=>{const i=t.indexOf(a.id),s=t.indexOf(n.id),r=i===-1?999:i,l=s===-1?999:s;return r!==l?r-l:0}),e}function H(){if(ze!=="chat")return;const e=document.getElementById("waList");if(!e)return;const t=ii();e.innerHTML=`
    <div class="wa__list-header">
      ...
      <div class="wa__filters">
        <button class="wa__filter ${Re==="all"?"active":""}" data-tab="all">全部</button>
        <button class="wa__filter ${Re==="unread"?"active":""}" data-tab="unread">未讀</button>
        <button class="wa__filter ${Re==="archived"?"active":""}" data-tab="archived">封存</button>
        <span class="small muted" style="margin-left:auto">${t.length} 對話</span>
      </div>
    </div>
    <div class="wa__list-scroll" id="waListScroll">
      ${t.map(a=>{const n=!Xe(a.id);return`<div class="wa__item ${a.id===ae?"active":""} ${a.muted?"muted":""}" data-id="${a.id}" style="${n?"opacity:.5":""}">
  ...
  `,e.querySelector("#waSearch")?.addEventListener("input",a=>{bt=a.target.value,H()}),e.querySelectorAll(".wa__filter").forEach(a=>a.addEventListener("click",()=>{Re=a.dataset.tab,H()})),e.querySelectorAll(".wa__item").forEach(a=>a.addEventListener("click",()=>{if(!Xe(a.dataset.id))return;ae=a.dataset.id;const n=se.find(i=>i.id===ae);n&&(n.unread=0),a.dataset.id==="nori-all"&&setTimeout(()=>wt(),100),ce=!1,H(),V(ae)})),e.querySelectorAll(".wa__item").forEach(a=>{a.addEventListener("contextmenu",n=>{n.preventDefault();const i=se.find(s=>s.id===a.dataset.id);!i||!Xe(i.id)||(i.pinned=!i.pinned,H())})})}function V(e){const t=se.find(s=>s.id===e),a=document.getElementById("waChat");if(!t||!a)return;if(!Xe(e)){a.innerHTML='<div class="view__placeholder"><h2>🔒 未解鎖</h2><div class="muted">先去 Vizual Studio Code 觸發 420.69 隱藏路由</div></div>';return}e==="supplier"&&p.setFlag("found_supplier",!0),e==="backend-team"&&p.setFlag("found_supplier",!0);let n=t.messages;if(Te){const s=Te.toLowerCase();n=n.filter(r=>(r.text||"").toLowerCase().includes(s)||(r.fileName||"").toLowerCase().includes(s))}const i={};n.forEach(s=>{const r=s.time.includes(":")?"今天":s.time;i[r]||(i[r]=[]),i[r].push(s)}),a.innerHTML=`
    ...
    <div class="wa__messages" id="waMessages">
      ${Object.entries(i).map(([s,r])=>`
        ...
        ${r.map(l=>ri(l,t)).join("")}
      `).join("")}
      ${e==="sawyer"&&G===2?`<div class="wa__msg-row other" id="sawyerTyping"><div class="wa__msg-avatar" style="background:${Ba("Sawyer")}">S</div><div class="bubble other"><span class="small muted">輸入中...</span></div></div>`:""}
    </div>
    ${(()=>{let s="",r=!1;return e==="sawyer"&&(G===1?(s="但是我查過這段code已經沒在用才對，所以不是這個問題影響的啊",r=!0):G===2?(s="",r=!0):G===3&&(s="但是",r=!0)),`<div class="wa__composer">
    ...
    <div class="wa__info ${ce?"open":""}" id="waInfoPanel">
  ...
  `,document.getElementById("waChatHeader")?.addEventListener("click",()=>{ce=!ce,document.getElementById("waInfoPanel")?.classList.toggle("open",ce)}),document.getElementById("waInfoBtn")?.addEventListener("click",s=>{s.stopPropagation(),ce=!ce,document.getElementById("waInfoPanel")?.classList.toggle("open",ce)}),document.getElementById("waInfoClose")?.addEventListener("click",()=>{ce=!1,document.getElementById("waInfoPanel")?.classList.remove("open")}),document.getElementById("waToggleMute")?.addEventListener("click",()=>{t.muted=!t.muted,H(),V(e)}),document.getElementById("waTogglePin")?.addEventListener("click",()=>{t.pinned=!t.pinned,H(),V(e)}),document.getElementById("waToggleArchive")?.addEventListener("click",()=>{t.archived=!t.archived,H(),V(e)}),document.getElementById("waMsgSearchBtn")?.addEventListener("click",()=>{Te="",document.getElementById("waMsgSearchBar").style.display="flex",document.getElementById("waMsgSearchInput")?.focus()}),document.getElementById("waMsgSearchInput")?.addEventListener("input",s=>{Te=s.target.value,V(e)}),document.getElementById("waMsgSearchClear")?.addEventListener("click",()=>{Te="",V(e)}),document.getElementById("waExportBtn")?.addEventListener("click",()=>la(t)),document.getElementById("waMoreBtn")?.addEventListener("click",()=>la(t)),document.getElementById("waSendBtn")?.addEventListener("click",()=>oa(t)),document.getElementById("waComposerInput")?.addEventListener("keydown",s=>{s.key==="Enter"&&oa(t)}),document.querySelectorAll("[data-play]").forEach(s=>{s.addEventListener("click",()=>{const r=s.textContent;s.textContent="⏸️",setTimeout(()=>s.textContent=r,1800)})}),document.querySelectorAll("[data-img]").forEach(s=>{s.addEventListener("click",()=>Pa(s.src))}),ja()}function si(e){return e?e==="you"||e==="你"?"你":e.trim().charAt(0).toUpperCase():"?"}function Ba(e){const t=["#1f7aec","#e542a3","#00a884","#ff8c00","#6a5acd","#d93025","#0d9488","#7c3aed"];let a=0;for(let n=0;n<e.length;n++)a=a*31+e.charCodeAt(n)>>>0;return t[a%t.length]}function ri(e,t){const a=e.from==="you",n=a?e.read==="read"?'<span class="bubble__check read">✓✓</span>':e.read==="delivered"?'<span class="bubble__check">✓✓</span>':'<span class="bubble__check">✓</span>':"";let i="";e.type==="image"?i=`<div class="wa__media"><img data-img src="${e.media}" alt="image" /></div>`:e.type==="voice"?i=`<div class="wa__voice"><span class="wa__play" data-play>▶️</span><div class="wa__wave">${Array.from({length:12},(u,m)=>`<span style="height:${8+Math.random()*14}px"></span>`).join("")}</div><span class="small muted">${e.duration}</span></div>`:e.type==="file"&&(i=`<div class="wa__file"><div class="wa__file-icon">📄</div><div style="flex:1;min-width:0"><div style="font-weight:600;font-size:13px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">${d(e.fileName)}</div><div class="small muted">${d(e.fileSize)}</div></div><button class="btn" style="padding:4px 8px">下載</button></div>`);const s=e.text?`<div class="bubble__text">${d(e.text).replace(/\n/g,"<br>")}</div>`:"",r=`<div class="bubble__time">${d(e.time)} ${n}</div>`;if(a)return`<div class="wa__msg-row me">
  ...
  </div>`}function oa(e){if(e.id==="sawyer"&&G===1){const i="但是我查過這段code已經沒在用才對，所以不是這個問題影響的啊";e.messages.push({id:"m"+Date.now(),from:"you",text:i,time:"剛剛",read:"sent",type:"text"}),e.preview=i,e.lastTime="剛剛",e.unread=0,G=2,V(e.id),H(),setTimeout(()=>{G=3,e.messages.push({id:"sawyer-reply2-"+Date.now(),from:"Sawyer",text:"先別管，肯定是這段的影響，已經在影響我工作了",time:"剛剛",read:"delivered",type:"text"}),e.preview="Sawyer: 先別管，肯定是這段的影響...",e.unread=(e.unread||0)+1,window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"sawyer"}})),V(e.id),H();const s=document.createElement("div");s.id="wa-win-notif-sawyer-seq2-"+Date.now(),s.setAttribute("role","alert"),s.innerHTML='<div class="win-notif__app"><img src="/arg-game-it-company-secret/icon/whatsup.svg" alt="WhatUp" width="20" height="20" style="width:20px;height:20px;object-fit:contain" /><span class="win-notif__app-name">WhatUp</span><span class="win-notif__app-sub">Sawyer</span><button class="win-notif__close" aria-label="關閉">✕</button></div><div class="win-notif__body"><div class="win-notif__avatar" style="background:linear-gradient(135deg, #722F37, #8B1A1A)">S</div><div class="win-notif__text"><div class="win-notif__sender">Sawyer</div><div class="win-notif__msg">先別管，肯定是這段的影響，已經在影響我工作了</div><div class="win-notif__time">剛剛</div></div></div><div class="win-notif__progress" style="animation: winNotifShrink 4000ms linear forwards"></div>',s.style.cssText="position:fixed;right:16px;bottom:60px;width:360px;background:#2d2d2d;color:#f0f0f0;border:1px solid rgba(255,255,255,.12);border-radius:8px;box-shadow:0 8px 28px rgba(0,0,0,.45);z-index:1100;overflow:hidden;cursor:pointer;opacity:1;transform:none;",s.addEventListener("click",r=>{r.target.closest(".win-notif__close")||(s.remove(),j(()=>Promise.resolve().then(()=>ie).then(l=>{l.setActiveView&&(l.setActiveView("whatsapp"),localStorage.setItem("cc_active_view","whatsapp"))}),void 0),Ue("sawyer"))}),s.querySelector(".win-notif__close")?.addEventListener("click",r=>{r.stopPropagation(),s.remove()}),document.body.appendChild(s),setTimeout(()=>s.remove(),4e3)},3e3);return}if(e.id==="sawyer"&&G===2)return;if(e.id==="sawyer"&&G===3){e.messages.push({id:"m"+Date.now(),from:"you",text:"但是",time:"剛剛",read:"sent",type:"text"}),e.preview="但是",e.lastTime="剛剛",e.unread=0,V(e.id),H(),setTimeout(()=>{e.messages.push({id:"sawyer-reply3-"+Date.now(),from:"Sawyer",text:"趕快revert！",time:"剛剛",read:"delivered",type:"text"}),e.preview="Sawyer: 趕快revert！",e.unread=(e.unread||0)+1,window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"sawyer"}})),G=4,V(e.id),H();const s=document.createElement("div");s.id="wa-win-notif-sawyer-seq3-"+Date.now(),s.setAttribute("role","alert"),s.innerHTML='<div class="win-notif__app"><img src="/arg-game-it-company-secret/icon/whatsup.svg" alt="WhatUp" width="20" height="20" style="width:20px;height:20px;object-fit:contain" /><span class="win-notif__app-name">WhatUp</span><span class="win-notif__app-sub">Sawyer</span><button class="win-notif__close" aria-label="關閉">✕</button></div><div class="win-notif__body"><div class="wa__msg-avatar" style="background:linear-gradient(135deg, #722F37, #8B1A1A)">S</div><div class="win-notif__text"><div class="win-notif__sender">Sawyer</div><div class="win-notif__msg">趕快revert！</div><div class="win-notif__time">剛剛</div></div></div><div class="win-notif__progress" style="animation: winNotifShrink 4000ms linear forwards"></div>',s.innerHTML='<div class="win-notif__app"><img src="/arg-game-it-company-secret/icon/whatsup.svg" alt="WhatUp" width="20" height="20" style="width:20px;height:20px;object-fit:contain" /><span class="win-notif__app-name">WhatUp</span><span class="win-notif__app-sub">Sawyer</span><button class="win-notif__close" aria-label="關閉">✕</button></div><div class="win-notif__body"><div class="win-notif__avatar" style="background:linear-gradient(135deg, #722F37, #8B1A1A)">S</div><div class="win-notif__text"><div class="win-notif__sender">Sawyer</div><div class="win-notif__msg">趕快revert！</div><div class="win-notif__time">剛剛</div></div></div><div class="win-notif__progress" style="animation: winNotifShrink 4000ms linear forwards"></div>',s.style.cssText="position:fixed;right:16px;bottom:60px;width:360px;background:#2d2d2d;color:#f0f0f0;border:1px solid rgba(255,255,255,.12);border-radius:8px;box-shadow:0 8px 28px rgba(0,0,0,.45);z-index:1100;overflow:hidden;cursor:pointer;opacity:1;transform:none;",s.addEventListener("click",r=>{r.target.closest(".win-notif__close")||(s.remove(),j(()=>Promise.resolve().then(()=>ie).then(l=>{l.setActiveView&&(l.setActiveView("whatsapp"),localStorage.setItem("cc_active_view","whatsapp"))}),void 0),Ue("sawyer"))}),s.querySelector(".win-notif__close")?.addEventListener("click",r=>{r.stopPropagation(),s.remove()}),document.body.appendChild(s),setTimeout(()=>s.remove(),4e3)},200);return}const t=document.getElementById("waComposerInput"),a=t?.value.trim();if(!a)return;const n=e.id==="sawyer"&&G===4;e.messages.push({id:"m"+Date.now(),from:"you",text:a,time:new Date().toLocaleTimeString("zh-TW",{hour:"2-digit",minute:"2-digit"}),read:"sent",type:"text"}),e.preview=a,e.lastTime="剛剛",e.unread=0,t.value="",V(e.id),H(),!n&&e.id!=="qa-lee"&&Math.random()>.5&&setTimeout(()=>{e.messages.push({id:"r"+Date.now(),from:e.id==="backend-team"?"ops":"supplier",text:"收到，後續私聊",time:"剛剛",read:"delivered",type:"text"}),V(e.id),H()},1200)}var Ot=!1,_t=!1;function oi(){if(Ot)return;Ot=!0;const e=se.find(t=>t.id==="nori-all");e&&setTimeout(()=>{e.messages.push({id:"m-tree-"+Date.now(),from:"Sawyer",text:"聽從風水師建議，已在 Lobby 擺放一棵發財樹擋災，請大家切勿觸碰，否則運氣會散。",time:"剛剛",read:"delivered",type:"text"}),e.preview="Sawyer: 聽從風水師建議，已在 Lobby 擺放",e.lastTime="剛剛",e.unread=(e.unread||0)+1,window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"nori-all"}}));const t=document.getElementById("view-whatsapp");t&&t.innerHTML&&H(),setTimeout(()=>{e.messages.push({id:"m-tree-img-"+Date.now(),from:"Sawyer",text:"",media:"${import.meta.env.BASE_URL}assets/data/files/office.png",type:"image",time:"剛剛",read:"delivered"}),e.preview="Sawyer: [圖片]",e.lastTime="剛剛",e.unread=(e.unread||0)+1,window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"nori-all"}}));const n=document.getElementById("view-whatsapp");n&&n.innerHTML&&H()},1500);const a=document.createElement("div");a.id="wa-win-notification-sawyer-tree",a.setAttribute("role","alert"),a.innerHTML=`
    ...
    `,a.style.cssText="position:fixed;right:16px;bottom:60px;width:360px;background:#2d2d2d;color:#f0f0f0;border:1px solid rgba(255,255,255,.12);border-radius:8px;box-shadow:0 8px 28px rgba(0,0,0,.45);z-index:1100;overflow:hidden;cursor:pointer;opacity:0;transform:translateY(12px);transition:opacity .28s,transform .28s;",a.addEventListener("click",n=>{n.target.closest(".win-notif__close")||(a.remove(),j(()=>Promise.resolve().then(()=>ie).then(i=>{i.setActiveView&&(i.setActiveView("whatsapp"),localStorage.setItem("cc_active_view","whatsapp"))}),void 0),Ue("nori-all"))}),a.querySelector(".win-notif__close")?.addEventListener("click",n=>{n.stopPropagation(),a.remove()}),document.body.appendChild(a),requestAnimationFrame(()=>{a.style.opacity="1",a.style.transform="none"}),setTimeout(()=>{a.style.opacity="0",setTimeout(()=>a.remove(),300)},1e4),setTimeout(()=>{_t||Ut()},1e4)},1e4)}function Ut(){if(_t)return;_t=!0;const e=se.find(t=>t.id==="dev-team");e&&setTimeout(()=>{e.messages.push({id:"m-0043-"+Date.now(),from:"Maggie",text:"Hi @Casey, 有新的工單 INV-2024-0043, 請協助處理一下",time:"剛剛",read:"delivered",type:"text"}),e.preview="Hi @Casey, 有新的工單 INV-2024-0043",e.lastTime="剛剛",e.unread=(e.unread||0)+1,window.dispatchEvent(new CustomEvent("whatsapp:newMessage",{detail:{chatId:"dev-team"}})),j(()=>Promise.resolve().then(()=>Qe).then(n=>{n.addTicket0043&&n.addTicket0043(),document.getElementById("jiraBoard")&&window.dispatchEvent(new CustomEvent("jira:ticketAdded"))}),void 0);const t=document.getElementById("view-whatsapp");t&&t.innerHTML&&H();const a=document.createElement("div");a.id="wa-win-notification-maggie-0043",a.setAttribute("role","alert"),a.innerHTML=`
      <div class="win-notif__app">
        <img src="/arg-game-it-company-secret/icon/whatsup.svg" alt="WhatUp" width="20" height="20" style="width:20px;height:20px;object-fit:contain" />
        <span class="win-notif__app-name">WhatUp</span>
      ...
      <div class="win-notif__progress"></div>
    `,a.style.cssText="position:fixed;right:16px;bottom:60px;width:360px;background:#2d2d2d;color:#f0f0f0;border:1px solid rgba(255,255,255,.12);border-radius:8px;box-shadow:0 8px 28px rgba(0,0,0,.45);z-index:1100;overflow:hidden;cursor:pointer;opacity:0;transform:translateY(12px);transition:opacity .28s,transform .28s;",a.addEventListener("click",n=>{n.target.closest(".win-notif__close")||(a.remove(),j(()=>Promise.resolve().then(()=>ie).then(i=>{i.setActiveView&&(i.setActiveView("whatsapp"),localStorage.setItem("cc_active_view","whatsapp"))}),void 0),Ue("dev-team"))}),a.querySelector(".win-notif__close")?.addEventListener("click",n=>{n.stopPropagation(),a.remove()}),document.body.appendChild(a),requestAnimationFrame(()=>{a.style.opacity="1",a.style.transform="none"}),setTimeout(()=>{a.style.opacity="0",setTimeout(()=>a.remove(),300)},1e4)},1e4)}function wt(){se.find(e=>e.id==="nori-all")&&Ot&&!_t&&Ut()}function la(e){const t=`WhatUp 匯出 — ${e.name}
${e.messages.map(s=>`[${s.time}] ${s.from}: ${s.text||s.fileName||s.type}`).join(`
`)}`,a=new Blob([t],{type:"text/plain"}),n=URL.createObjectURL(a),i=document.createElement("a");i.href=n,i.download=`${e.id}-chat.txt`,i.click(),URL.revokeObjectURL(n)}function li(){return se}function ci(){if(G!==0)return;G=1;const e=document.getElementById("view-whatsapp");if(e&&e.classList.contains("active")||localStorage.getItem("cc_active_view"),e&&e.innerHTML){try{V(ae)}catch{}try{We()}catch{}}try{p.setFlag("sawyer_seq_started",!0)}catch{}}var Z=1,Fe=0,Ne=0,vt=!1,ca=0,da=0,pa=0,ua=0;function ja(){if(document.getElementById("waLightbox"))return;const e=document.createElement("div");e.id="waLightbox",e.className="wa-lightbox",e.setAttribute("aria-hidden","true"),e.innerHTML=`
  ...
  `,document.body.appendChild(e);const t=e.querySelector("#waLightboxImg"),a=e.querySelector("#waLightboxBody"),n=e.querySelector("#waLightboxScale");function i(){t&&(t.style.transform=`translate(${Fe}px, ${Ne}px) scale(${Z})`,n&&(n.textContent=Math.round(Z*100)+"%"),a.style.cursor=Z>1?vt?"grabbing":"grab":"zoom-in")}function s(c,u,m){Z=Math.max(.5,Math.min(4,c)),Z===1&&(Fe=0,Ne=0),i()}e.querySelector('[data-wa-zoom="in"]')?.addEventListener("click",()=>s(Z+.25)),e.querySelector('[data-wa-zoom="out"]')?.addEventListener("click",()=>s(Z-.25)),e.querySelector('[data-wa-zoom="reset"]')?.addEventListener("click",()=>{Z=1,Fe=0,Ne=0,i()}),e.querySelector("#waLightboxClose")?.addEventListener("click",()=>ht()),e.querySelector("[data-wa-close]")?.addEventListener("click",()=>ht()),a?.addEventListener("wheel",c=>{c.preventDefault();const u=c.deltaY>0?-.1:.1;s(Z+u)},{passive:!1});function r(c){Z<=1||(vt=!0,t.classList.add("dragging"),ca=c.clientX,da=c.clientY,pa=Fe,ua=Ne,a.setPointerCapture?.(c.pointerId))}function l(c){vt&&(Fe=pa+(c.clientX-ca),Ne=ua+(c.clientY-da),i())}function o(c){vt=!1,t.classList.remove("dragging");try{a.releasePointerCapture?.(c.pointerId)}catch{}}a?.addEventListener("pointerdown",r),a?.addEventListener("pointermove",l),a?.addEventListener("pointerup",o),a?.addEventListener("pointercancel",o),document.addEventListener("keydown",c=>{c.key==="Escape"&&e.classList.contains("open")&&ht()}),e._updateTransform=i,e._setScale=s}function Pa(e){ja();const t=document.getElementById("waLightbox"),a=document.getElementById("waLightboxImg");!t||!a||(a.src=e,Z=1,Fe=0,Ne=0,t._updateTransform?.(),t.classList.add("open"),t.setAttribute("aria-hidden","false"))}function ht(){const e=document.getElementById("waLightbox");e&&(e.classList.remove("open"),e.setAttribute("aria-hidden","true"))}typeof window<"u"&&!window.__waListenerBound&&(window.__waListenerBound=!0,window.addEventListener("whatsapp:newMessage",e=>{const t=document.getElementById("view-whatsapp");if(!(!t||!t.innerHTML)){try{We()}catch{}try{V(ae)}catch{}}}),window.addEventListener("whatsapp:refresh",()=>{const e=document.getElementById("view-whatsapp");if(!(!e||!e.innerHTML)){try{We()}catch{}try{V(ae)}catch{}}}));var St=[{title:"Java switch-case 語法詳解 — 基礎教學 (繁中)",url:"https://java-tutorial.example/switch-case",snippet:"【switch 用法】switch 會依變數值跳到對應 case，需搭配 break 避免貫穿。範例：switch(vipLv){ case 1: price *= 0.90; break; case 2: price *= 0.85; break; case 3: price *= 0.80; break; case 4: price *= 0.75; break; case 5: price *= 0.70; break; default: break; } 注意：若缺少 break 會繼續執行下一個 case。常與 if-else 比較，適用於枚舉分級如 VIP 折扣。",type:"web",image:null},{title:"【StackOverflow】VIP 等級折扣用 switch 寫，VIP1 被算成 60% 而不是 50% 該怎麼修？",url:"https://stackoverflow.com/questions/789421/vip-discount-switch-case-wrong-percentage",snippet:`發問：我的 switch(vipLv) 中 case 1 寫成 price*=0.95，但需求是 VIP1 60%、VIP2 65%。已嘗試修改但 Sonar 仍報錯... 
...
美麗的天空 — Sawyer Choi / Choi Tsz Yeung 蔡梓掦`,type:"web",image:"${import.meta.env.BASE_URL}assets/data/files/sawyer_blog_pic.HEIC"},{title:"Sawyer Choi — 2023-04-25",url:"https://sawyer-blog.example/2023-04-25",snippet:`2023-04-25
...
`,type:"news",image:null},{title:"那些藏在程式碼裡的小彩蛋：我在小團隊看到的開發者塗鴉 — Peter Lin",url:"https://peter-blog.example/code-easter-eggs",snippet:"待過幾間中小企業後發現，只要沒有嚴格的 code quality 流程，程式碼裡總會冒出一些跟公司或產品完全無關的東西——註解裡的粗口、對工作的抱怨、整段國歌歌詞，甚至藏得很深的小遊戲。我對這些小彩蛋的看法是：只要不影響功能與效能，算是工作中找到的小樂趣。 — Peter Lin",type:"web",image:"https://picsum.photos/seed/codeeggs/600/400"}],Ma={sawyer:{id:"sawyer",name:"Sawyer Choi",handle:"@sawyerchoi",displayName:"Sawyer Choi / 蔡梓掦",bio:"喜歡把日常小事寫成文字的人。從2001年開始在 BlogWorld 記錄生活，覺得能把想法寫下來，好像就能更理解自己一點。",avatar:"${import.meta.env.BASE_URL}lemon_tea.jpg",cover:"${import.meta.env.BASE_URL}lemon_tea.jpg",followers:842,following:37,joined:"2001-10-01",verified:!1},mary:{id:"mary",name:"Mary Chen",handle:"@marychen",displayName:"Mary Chen · 陳曉玲",bio:"旅遊 × 攝影 × 生活手帳。走過 27 個城市，喜歡在咖啡香裡寫明信片。",avatar:"https://i.pravatar.cc/150?u=mary",cover:"https://picsum.photos/seed/marycover/900/240",followers:12430,following:210,joined:"2018-03-12",verified:!0},peter:{id:"peter",name:"Peter Lin",handle:"@peterlin",displayName:"Peter Lin · 林柏安",bio:"後端工程師 / 開源愛好者。分享 Python、NAS、自架服務與踩坑筆記。",avatar:"https://i.pravatar.cc/150?u=peter",cover:"https://picsum.photos/seed/petercover/900/240",followers:8930,following:96,joined:"2019-07-20",verified:!0},paul:{id:"paul",name:"Paul Wang",handle:"@paulwang",displayName:"Paul Wang · 王志豪",bio:"台南胃、台北心。專門挖掘巷弄美食與手沖咖啡，記錄每一口幸福。",avatar:"https://i.pravatar.cc/150?u=paul",cover:"https://picsum.photos/seed/paulcover/900/240",followers:15600,following:143,joined:"2017-11-05",verified:!0},emma:{id:"emma",name:"Emma Wu",handle:"@emmaw",displayName:"Emma Wu · 吳思敏",bio:"底片攝影 / 極地旅人。想用快門留住光線的溫度。",avatar:"https://i.pravatar.cc/150?u=emma",cover:"https://picsum.photos/seed/emmacover/900/240",followers:6720,following:78,joined:"2020-01-18",verified:!1},david:{id:"david",name:"David Chang",handle:"@davidchang",displayName:"David Chang · 張大衛",bio:"黑膠收藏家 / Live House 常客。寫音樂，也寫城市的聲音。",avatar:"https://i.pravatar.cc/150?u=david",cover:"https://picsum.photos/seed/davidcover/900/240",followers:4210,following:52,joined:"2019-09-03",verified:!1}},U=[{url:"https://sawyer-blog.example/2001-10-18",title:"Sawyer Choi — 2001-10-18",excerpt:"今天和好多朋友一起玩，大家都玩得很開心。我把自己的食物分給大家吃，他們笑得很開心。",content:`2001-10-18
...
只是爸爸媽媽好像還不知道。他們大概還以為，我一直都很喜歡。`,authorId:"sawyer",date:"2003-04-27",views:8920,likes:342,topic:"成長",tags:["學校","成長","檸檬茶"],cover:"${import.meta.env.BASE_URL}lemon_tea.jpg"},{url:"https://sawyer-blog.example/2004-11-13",title:"Sawyer Choi — 2004-11-13",excerpt:"不小心戳到表妹的眼睛，所有大人都看著我。那一刻腦袋一片空白。",content:`2004-11-13
...
以前很喜歡的東西，長大以後不一定還會喜歡。`,authorId:"sawyer",date:"2010-06-06",views:9800,likes:412,topic:"家庭",tags:["檸檬茶","成長","家庭"],cover:"${import.meta.env.BASE_URL}lemon_tea.jpg"},{url:"https://sawyer-blog.example/2012-07-07",title:"Sawyer Choi — 2012-07-07",excerpt:"媽媽帶我去辦保險，才發現彼此的受益人都是對方。那一刻才感覺到，原來我們都在替彼此想著以後。",content:`2012-07-07
...
美麗的天空`,authorId:"sawyer",date:"2013-01-01",views:7600,likes:310,topic:"攝影",tags:["天空","攝影","日常"],cover:"${import.meta.env.BASE_URL}assets/data/files/sawyer_blog_pic.HEIC"},{url:"https://sawyer-blog.example/2023-12-20",title:"Sawyer Choi — 2023-12-20",excerpt:"我只好做你想我做的事了",content:`2023-12-20
...
我買了她最喜歡的檸檬茶，放在辦公桌上。雖然她喝不到了，但我想讓她知道，我一直都記得。`,authorId:"sawyer",date:"2023-05-10",views:3800,likes:167,topic:"家庭",tags:["檸檬茶","生日","紀念"],cover:"${import.meta.env.BASE_URL}lemon_tea.jpg"},{url:"https://sawyer-blog.example/2024-01-15",title:"Sawyer Choi — 2024-01-15",excerpt:"壓力越來越大，但我不能停下來。太多人依賴我了。如果他們知道真相...",content:`2024-01-15
...
<p>除錯技巧：在 <code>vite.config.js</code> 設 <code>publicDir</code> 或用 <code>console.log(import.meta.env)</code> 印出所有 <code>VITE_</code> 變數。</p>`}],commentsQ:[{user:"發問者",text:"原來只有 VITE_ 才會到前端，難怪 DATABASE_URL 一直 undefined",time:"2024-08-12 12:30"},{user:"路人",text:"推，之前把 MD5_KEY 放 VITE_ 被老師罵",time:"2024-08-13 08:20"}]}};function ui(e){return e&&e.includes("stackoverflow.com")&&Oa[e]}function mi(e){return Oa[e]||null}function vi(e){function t(E,S){return E<<S|E>>>32-S}function a(E,S){var C,A,P=E&2147483648,O=S&2147483648,F;return C=E&1073741824,A=S&1073741824,F=(E&1073741823)+(S&1073741823),C&A?F^2147483648^P^O:C|A?F&1073741824?F^3221225472^P^O:F^1073741824^P^O:F^P^O}function n(E,S,C){return E&S|~E&C}function i(E,S,C){return E&C|S&~C}function s(E,S,C){return E^S^C}function r(E,S,C){return S^(E|~C)}function l(E,S,C,A,P,O,F){return E=a(E,a(a(n(S,C,A),P),F)),a(t(E,O),S)}function o(E,S,C,A,P,O,F){return E=a(E,a(a(i(S,C,A),P),F)),a(t(E,O),S)}function c(E,S,C,A,P,O,F){return E=a(E,a(a(s(S,C,A),P),F)),a(t(E,O),S)}function u(E,S,C,A,P,O,F){return E=a(E,a(a(r(S,C,A),P),F)),a(t(E,O),S)}function m(E){for(var S,C=E.length,A=C+8,P=((A-A%64)/64+1)*16,O=Array(P-1),F=0,le=0;le<C;)S=(le-le%4)/4,F=le%4*8,O[S]=O[S]|E.charCodeAt(le)<<F,le++;return S=(le-le%4)/4,F=le%4*8,O[S]=O[S]|128<<F,O[P-2]=C<<3,O[P-1]=C>>>29,O}function y(E){var S="",C="",A,P;for(P=0;P<=3;P++)A=E>>>P*8&255,C="0"+A.toString(16),S=S+C.substr(C.length-2,2);return S}function x(E){E=E.replace(/\r\n/g,`
`);for(var S="",C=0;C<E.length;C++){var A=E.charCodeAt(C);A<128?S+=String.fromCharCode(A):A>127&&A<2048?(S+=String.fromCharCode(A>>6|192),S+=String.fromCharCode(A&63|128)):(S+=String.fromCharCode(A>>12|224),S+=String.fromCharCode(A>>6&63|128),S+=String.fromCharCode(A&63|128))}return S}var g=Array(),_,B,M,Ye,I,h,b,v,f,T=7,$=12,q=17,Le=22,De=5,Ce=9,D=14,fe=20,oe=4,st=11,rt=16,ot=23,lt=6,ct=10,dt=15,pt=21;for(e=x(e),g=m(e),h=1732584193,b=4023233417,v=2562383102,f=271733878,_=0;_<g.length;_+=16)B=h,M=b,Ye=v,I=f,h=l(h,b,v,f,g[_+0],T,3614090360),f=l(f,h,b,v,g[_+1],$,3905402710),v=l(v,f,h,b,g[_+2],q,606105819),b=l(b,v,f,h,g[_+3],Le,3250441966),h=l(h,b,v,f,g[_+4],T,4118548399),f=l(f,h,b,v,g[_+5],$,1200080426),v=l(v,f,h,b,g[_+6],q,2821735955),b=l(b,v,f,h,g[_+7],Le,4249261313),h=l(h,b,v,f,g[_+8],T,1770035416),f=l(f,h,b,v,g[_+9],$,2336552879),v=l(v,f,h,b,g[_+10],q,4294925233),b=l(b,v,f,h,g[_+11],Le,2304563134),h=l(h,b,v,f,g[_+12],T,1804603682),f=l(f,h,b,v,g[_+13],$,4254626195),v=l(v,f,h,b,g[_+14],q,2792965006),b=l(b,v,f,h,g[_+15],Le,1236535329),h=o(h,b,v,f,g[_+1],De,4129170786),f=o(f,h,b,v,g[_+6],Ce,3225465664),v=o(v,f,h,b,g[_+11],D,643717713),b=o(b,v,f,h,g[_+0],fe,3921069994),h=o(h,b,v,f,g[_+5],De,3593408605),f=o(f,h,b,v,g[_+10],Ce,38016083),v=o(v,f,h,b,g[_+15],D,3634488961),b=o(b,v,f,h,g[_+4],fe,3889429448),h=o(h,b,v,f,g[_+9],De,568446438),f=o(f,h,b,v,g[_+14],Ce,3275163606),v=o(v,f,h,b,g[_+3],D,4107603335),b=o(b,v,f,h,g[_+8],fe,1163531501),h=o(h,b,v,f,g[_+13],De,2850285829),f=o(f,h,b,v,g[_+2],Ce,4243563512),v=o(v,f,h,b,g[_+7],D,1735328473),b=o(b,v,f,h,g[_+12],fe,2368359562),h=c(h,b,v,f,g[_+5],oe,4294588738),f=c(f,h,b,v,g[_+8],st,2272392833),v=c(v,f,h,b,g[_+11],rt,1839030562),b=c(b,v,f,h,g[_+14],ot,4259657740),h=c(h,b,v,f,g[_+1],oe,2763975236),f=c(f,h,b,v,g[_+4],st,1272893353),v=c(v,f,h,b,g[_+7],rt,4139469664),b=c(b,v,f,h,g[_+10],ot,3200236656),h=c(h,b,v,f,g[_+13],oe,681279174),f=c(f,h,b,v,g[_+0],st,3936430074),v=c(v,f,h,b,g[_+3],rt,3572445317),b=c(b,v,f,h,g[_+6],ot,76029189),h=c(h,b,v,f,g[_+9],oe,3654602809),f=c(f,h,b,v,g[_+12],st,3873151461),v=c(v,f,h,b,g[_+15],rt,530742520),b=c(b,v,f,h,g[_+2],ot,3299628645),h=u(h,b,v,f,g[_+0],lt,4096336452),f=u(f,h,b,v,g[_+7],ct,1126891415),v=u(v,f,h,b,g[_+14],dt,2878612391),b=u(b,v,f,h,g[_+5],pt,4237533241),h=u(h,b,v,f,g[_+12],lt,1700485571),f=u(f,h,b,v,g[_+3],ct,2399980690),v=u(v,f,h,b,g[_+10],dt,4293915773),b=u(b,v,f,h,g[_+1],pt,2240044497),h=u(h,b,v,f,g[_+8],lt,1873313359),f=u(f,h,b,v,g[_+15],ct,4264355552),v=u(v,f,h,b,g[_+6],dt,2734768916),b=u(b,v,f,h,g[_+13],pt,1309151649),h=u(h,b,v,f,g[_+4],lt,4149444226),f=u(f,h,b,v,g[_+11],ct,3174756917),v=u(v,f,h,b,g[_+2],dt,718787259),b=u(b,v,f,h,g[_+9],pt,3951481745),h=a(h,B),b=a(b,M),v=a(v,Ye),f=a(f,I);return(y(h)+y(b)+y(v)+y(f)).toLowerCase()}function gi(e){if(!e)return[];const t=e.toLowerCase(),a=new Set,n=[];return St.forEach(i=>{i.title.toLowerCase().includes(t)&&!a.has(i.title)&&(a.add(i.title),n.push({text:i.title,kind:i.type}))}),(p.get("searchHistory")||[]).slice(-5).reverse().forEach(i=>{i.q.toLowerCase().includes(t)&&!a.has(i.q)&&(a.add(i.q),n.push({text:i.q,kind:"history"}))}),n.slice(0,8)}function hi(e){let t=e;const a={site:null,filetype:null,before:null,after:null},n=t.match(/site:([^\s]+)/i);n&&(a.site=n[1].toLowerCase(),t=t.replace(n[0],"").trim());const i=t.match(/filetype:([^\s]+)/i);i&&(a.filetype=i[1].toLowerCase(),t=t.replace(i[0],"").trim());const s=t.match(/before:([^\s]+)/i);s&&(a.before=s[1],t=t.replace(s[0],"").trim());const r=t.match(/after:([^\s]+)/i);return r&&(a.after=r[1],t=t.replace(r[0],"").trim()),{base:t.trim(),filters:a}}function fi(e){return e.toLowerCase().includes("md5")}function yi(e){const t=document.getElementById("md5Tool");if(!t)return;const a=document.getElementById("searchLayout"),n=document.getElementById("searchDetail");a&&(a.style.display="none"),n&&(n.style.display="none",n.innerHTML="",n.classList.remove("open"));let i="";if(e){const m=e.match(/md5\s*(.*)/i);m&&m[1]&&(i=m[1].trim())}t.innerHTML=`
  ...
  `).join(""),o.querySelectorAll("[data-open]").forEach(c=>c.addEventListener("click",()=>{const u=Number(c.dataset.open),m=He[u];if(m){if(m.url.startsWith("file://")||m.url.startsWith("/customer-portal")){const y=m.url.replace("file://","");k.exists(y)&&p.setFlag("found_code_map",!0);const x=new CustomEvent("search:openFile",{detail:y});window.dispatchEvent(x)}Ci(u)}}))}}function re(){const e=document.getElementById("md5Tool");e&&(e.style.display="none",e.innerHTML="");const t=document.getElementById("searchLayout"),a=document.getElementById("searchDetail");t&&(t.style.display=""),a&&(a.style.display="none",a.innerHTML="",a.classList.remove("open"));const n=document.querySelector(".search");n&&(n.scrollTop=0);const i=document.getElementById("view-search");i&&(i.scrollTop=0)}function z(e){return e>=1e4?(e/1e4).toFixed(1)+"萬":e>=1e3?(e/1e3).toFixed(1)+"k":String(e)}function xt(e){return U.find(t=>t.url===e)||null}function we(e){return Ma[e]||null}function xi(e){return U.filter(t=>t.authorId===e).sort((t,a)=>a.views-t.views)}function ki(e){const t=U.filter(i=>i.authorId===e.authorId&&i.url!==e.url).sort((i,s)=>s.views-i.views).slice(0,2);let a=U.filter(i=>i.topic===e.topic&&i.url!==e.url&&i.authorId!==e.authorId);if(a.length<3){const i=U.filter(s=>s.url!==e.url&&!t.includes(s)&&!a.includes(s)&&s.tags.some(r=>e.tags.includes(r)));a=[...a,...i]}a=a.slice(0,3);let n=[...t,...a];if(n.length<5){const i=U.filter(s=>s.url!==e.url&&!n.includes(s)).sort(()=>.5-Math.random()).slice(0,5-n.length);n=n.concat(i)}return n.slice(0,5)}function Yt(e){return`
  ...
  `}function Kt(e){e.querySelector("[data-blog-home]")?.addEventListener("click",()=>at()),e.querySelectorAll("[data-blog-nav]").forEach(t=>{t.addEventListener("click",()=>{(t.dataset.blogNav==="home"||t.dataset.blogNav==="trending")&&at()})}),e.querySelector("[data-blog-back-search]")?.addEventListener("click",()=>re())}function at(){const e=document.getElementById("searchDetail"),t=document.getElementById("searchLayout");if(!e||!t)return;t.style.display="none",e.style.display="block",e.classList.add("open");const a=document.getElementById("md5Tool");a&&(a.style.display="none",a.innerHTML="");const n=[...U].sort((m,y)=>y.views-m.views).slice(0,1)[0],i=[...U].sort((m,y)=>y.views-m.views).slice(1,4),s=U.find(m=>m.url==="https://peter-blog.example/code-easter-eggs"),r=[...U.filter(m=>m.url!=="https://peter-blog.example/code-easter-eggs")].sort(()=>.5-Math.random()),l=(s?[s,...r].slice(0,6):[...U].sort(()=>.5-Math.random()).slice(0,6)).slice(0,6),o=Object.values(Ma).sort((m,y)=>y.followers-m.followers).slice(0,4);e.innerHTML=`
        ...
        <div class="blog-article__layout">
          <div class="blog-article__main">
            <div class="blog-article__card">
              ...
              <div class="blog-article__content">${Gt(t.content,Wt)}</div>
          ...
          <aside class="blog-sidebar">
            ...
            <div class="blog-widget">
              ...
              <div class="blog-rec-list">
                ${r.map((u,m)=>{const y=we(u.authorId),x=u.authorId===t.authorId;return`
                  <div class="blog-rec" data-blog-url="${d(u.url)}">
                    ...
                    <div style="flex:1;min-width:0">
                      ...
                      <div class="blog-rec__meta"><span>${d(y.name)}</span><span>·</span><span><i class="fa-solid fa-eye"></i> ${z(u.views)}</span></div>
  ...
  `}function Ei(e){e.querySelectorAll("[data-school-back-search]").forEach(t=>t.addEventListener("click",()=>re())),e.querySelectorAll("[data-school-home]").forEach(t=>t.addEventListener("click",()=>re()))}function Ii(e){const t=e||St.find(o=>o.url==="https://school.example/guangzhi-essay-sawyer")||He.find(o=>Na(o.url));if(!t)return;const a=document.getElementById("searchDetail"),n=document.getElementById("searchLayout");if(!a||!n)return;n.style.display="none",a.style.display="block",a.classList.add("open");const i=document.getElementById("md5Tool");i&&(i.style.display="none",i.innerHTML="");const s=t.images||(t.image?[t.image]:[]);a.innerHTML=`
  ...
  `,a.querySelector("[data-so-back-search]")?.addEventListener("click",()=>re());const s=document.getElementById("view-search");s&&(s.scrollTop=0),a.scrollIntoView({behavior:"auto",block:"start"})}function Ci(e){const t=He[e];if(!t)return;const a=document.getElementById("md5Tool");if(a&&(a.style.display="none",a.innerHTML=""),ui(t.url)){Li(t.url);return}const n=t.url;if(U.some(y=>y.url===n)||n.includes("sawyer-blog.example")||n.includes("mary-blog.example")||n.includes("peter-blog.example")||n.includes("paul-blog.example")||n.includes("emma-blog.example")||n.includes("david-blog.example")){let y=n;if(!xt(y)){const x=U.find(g=>g.title===t.title);x&&(y=x.url)}if(xt(y)){nt(y);return}}if(Na(t.url)||t.title.includes("廣志中學")){Ii(t);return}const i=document.getElementById("searchLayout"),s=document.getElementById("searchDetail");if(!i||!s)return;i.style.display="none",s.style.display="block",s.classList.add("open");let r="",l=null;if(t.url.startsWith("/customer-portal")||t.url.startsWith("file://")){l=t.url.replace("file://","");const y=k.getFile(l);y&&typeof y.content=="string"&&(r=y.content,k.readFile(l))}else if(k.exists(t.url)){l=t.url;const y=k.getFile(l);y&&typeof y.content=="string"&&(r=y.content)}if(!r&&t.title.startsWith("/customer-portal")){const y=k.getFile(t.title);y&&typeof y.content=="string"&&(r=y.content)}const o=r||t.snippet||"無內容",c=t.images?t.images.map(y=>`<div class="detail__image"><img src="${d(y)}" alt="preview" style="width:100%;display:block" onerror="this.src='https://via.placeholder.com/320x480?text=Sawyer+Writing'" /></div>`).join(""):t.image?`<div class="detail__image"><img src="${d(t.image)}" alt="preview" onerror="this.src='https://via.placeholder.com/320x180?text=Preview'" /></div>`:"";s.innerHTML=`
    ...
    <div class="detail__card">
      ...
      ${c}
      <div class="detail__snippet">${Gt(o,Wt)}</div>
      ${r?`<pre class="detail__pre">${d(r)}</pre>`:""}
      <div class="result__meta" style="margin-top:12px">
        <span class="result__tag">${t.type}</span>
      </div>
    </div>
  `,s.querySelector("#searchBackBtn")?.addEventListener("click",()=>re());const u=document.querySelector(".search");u&&(u.scrollTop=0);const m=document.getElementById("view-search");m&&(m.scrollTop=0),s.scrollIntoView({behavior:"auto",block:"start"})}var Ke=0,Ct=null,$i=!1,ve="/darknet",Ge="secret";function Ti(){return k.buildDarkTree?k.buildDarkTree():k.buildTree()}function Ai(e){const t=Ti();function a(i,s){if(i.path===s)return i;if(!i.children)return null;for(const r of i.children){const l=a(r,s);if(l)return l}return null}const n=a(t,e);return!n||!n.children?[]:n.children}function Ra(){document.getElementById("view-darknet")&&(p.hasFlag("dark_entered"),Et())}function Et(){const e=document.getElementById("view-darknet");if(e)if(Ge==="secret")e.innerHTML=`
      <div class="darknet">
...
...`),i.textContent=s,i.style.whiteSpace="pre-wrap";a.style.display="flex",p.discoverFile(e),p.setFlag("dark_opened:"+e,!0),Jt()}function Oi(){document.getElementById("darkExitBtn")?.addEventListener("click",()=>{Ge="secret",Jt(!0),j(()=>Promise.resolve().then(()=>ie).then(t=>{t.setActiveView&&(t.setActiveView("intranet"),localStorage.setItem("cc_active_view","intranet"))}),void 0);const e=document.getElementById("view-darknet");e&&(e.innerHTML=""),p.hasFlag("ch4_all_opened")&&setTimeout(()=>{window.dispatchEvent(new CustomEvent("darknet:exit"))},300)}),document.getElementById("darkPreviewClose")?.addEventListener("click",()=>{const e=document.getElementById("darkPreview");e&&(e.style.display="none")}),document.getElementById("darkPreview")?.addEventListener("click",e=>{e.target.id==="darkPreview"&&(e.target.style.display="none")})}function Jt(e=!1){const t=k.listDarkFiles?k.listDarkFiles("/darknet"):[];if(!t.length)return;const a=t.filter(n=>p.hasFlag("dark_opened:"+n.path)||p.hasFlag("discovered:"+n.path)||p.get("discoveredFiles")?.includes(n.path));a.length>=t.length?(p.hasFlag("ch4_all_opened")||p.setFlag("ch4_all_opened",!0),e&&!p.hasFlag("ch5_triggered")&&(p.setFlag("ch5_triggered",!0),window.dispatchEvent(new CustomEvent("ch4:complete")),setTimeout(()=>{const n=document.getElementById("mailDialog");if(n&&!n.open)try{n.showModal()}catch{n.style.display="block",n.setAttribute("open","")}},500))):e&&a.length>=t.length,a.length>=t.length&&!p.hasFlag("ch4_all_opened")&&p.setFlag("ch4_all_opened",!0)}var Ft=!1;function $t(e={}){p.hasFlag("ch1_0043_committed")&&!p.hasFlag("ch1_revert_done")||document.getElementById("view-darknet")&&(Ft=!!e.simple,Ge="secret",Ke=0,j(()=>Promise.resolve().then(()=>ie).then(t=>{t.setActiveView&&(t.setActiveView("darknet"),localStorage.setItem("cc_active_view","darknet"))}),void 0),Ra())}var Y="/intranet",je="",ma="/intranet/client_info";function it(e){return e===ma||e.startsWith(ma+"/")}function va(e){const t=k.buildTree();function a(i,s){if(i.path===s)return i;if(!i.children)return null;for(const r of i.children){const l=a(r,s);if(l)return l}return null}const n=a(t,e);return!n||!n.children?[]:n.children}function Fi(){const e=document.getElementById("view-intranet");e&&(e.innerHTML=`
  ...
  `,Ni(),Ha())}function Ni(){const e=k.internalPathDomain||"https://nori-intranet/internal/portal?",t=k.getLegacyRoute&&k.getLegacyRoute("nori-portal-2023")?._hash||"f665a7117959b667b7f283eaebf69cae",a=e+"hash="+t,n="https://nori-intranet/internal/portal";function i(r){if(!r)return!1;const l=r.trim();if(l===a)return!0;if(l.includes("hash="+t)&&l.includes("nori-intranet/internal/portal")){const o=k.getLegacyRoute?k.getLegacyRoute("nori-portal-2023"):null;return o&&o.domain===e?!0:l===a}return!1}function s(){const r=document.getElementById("intraSearch"),l=r?r.value.trim():"",o=l===n||l===n+"/"||l.includes("nori-intranet/internal/portal")&&!l.includes("hash="),c=i(l);if(p.hasFlag("ch1_0043_committed")&&!p.hasFlag("ch1_revert_done")&&(o||c)){je=l.toLowerCase(),Nt();return}if(o){$t({simple:!0});return}if(c){const u=l.match(/hash=([a-f0-9]{32})/i),m=u?u[1]:t;if(k.tryAccessPortal&&k.tryAccessPortal({hash:m})){$t({simple:!1});return}else if(l===a){$t({simple:!1});return}}je=l.toLowerCase(),Nt()}document.getElementById("intraSearchBtn")?.addEventListener("click",s),document.getElementById("intraSearch")?.addEventListener("keydown",r=>{r.key==="Enter"&&(r.preventDefault(),s())}),document.getElementById("intraPreviewClose")?.addEventListener("click",Bt),document.getElementById("intraPreview")?.addEventListener("click",r=>{r.target.id==="intraPreview"&&Bt()}),document.addEventListener("keydown",r=>{r.key==="Escape"&&Bt()})}function Ha(){Ri(),Hi(),Nt();const e=k.listFiles("/intranet").length,t=document.getElementById("intraCount");t&&(t.textContent=`內網共 ${e} 個檔案`)}function Ri(){const e=document.getElementById("intraBreadcrumb");if(!e)return;const t=Y.split("/").filter(Boolean);let a='<span class="intra-bc__item" data-path="/intranet">🏠 內網首頁</span>',n="/intranet";const i=t[0]==="intranet"?1:0;t.slice(i).forEach(s=>{n+="/"+s;const r=it(n);a+=` <span class="muted">›</span> <span class="intra-bc__item ${n===Y?"active":""} ${r?"locked":""}" data-path="${d(n)}">${d(s)}${r?" 🔒":""}</span>`}),Y==="/intranet"&&(a='<span class="intra-bc__item active" data-path="/intranet">🏠 內網首頁</span>'),e.innerHTML=a,e.querySelectorAll(".intra-bc__item").forEach(s=>{s.addEventListener("click",()=>It(s.dataset.path))})}function Hi(){const e=document.getElementById("intraNav");e&&(e.innerHTML=[{path:"/intranet",label:"內網首頁",icon:"🏠",desc:"總覽"},{path:"/intranet/company_public",label:"公司公開資訊",icon:"🏢",desc:"名稱・Logo・大樓名錄"},{path:"/intranet/client_info",label:"客戶資料",icon:"🔒",desc:"權限管制（鎖定）",locked:!0},{path:"/intranet/business_plans",label:"業務計畫",icon:"📊",desc:"完整流程結構"},{path:"/intranet/staff",label:"員工資料",icon:"👥",desc:"50 人名錄"}].map(t=>`<div class="intra-nav__item ${Y===t.path||t.path!=="/"&&Y.startsWith(t.path+"/")?"active":""} ${t.locked?"locked":""}" data-path="${t.path}" title="${t.path}">
  ...
  `,e.querySelectorAll(".intra-nav__item").forEach(t=>{t.addEventListener("click",()=>It(t.dataset.path))}))}function Nt(){const e=document.getElementById("intraMain");if(!e)return;if(je){const i=k.searchContent(je).filter(o=>o.path.startsWith("/intranet")).slice(0,40),s=k.listFiles("/intranet").filter(o=>o.path.toLowerCase().includes(je)).slice(0,40),r=new Map;i.forEach(o=>r.set(o.path,o)),s.forEach(o=>{r.has(o.path)||r.set(o.path,{path:o.path,snippet:""})});const l=[...r.values()];if(!l.length){e.innerHTML='<div class="intra-empty">無搜尋結果 — 試試「Nori」「冰釀茶酒」「業務流程」「Sawyer」</div>';return}e.innerHTML=`
      ...
      <div class="intra-file__list">
        ${l.map(o=>{const c=k.getFile(o.path)?.meta?.locked||it(o.path);return`<div class="intra-file__row ${c?"locked":""}" data-path="${d(o.path)}" title="${d(o.path)}">
            <span class="intra-file__icon">${c?"🔒":Rt(o.path)}</span>
    ...
    `,At(e);return}if(it(Y)){e.innerHTML=`
      <div class="intra-locked">
        ...
        <div class="intra-locked__files">
          ...
          ${va(Y).map(i=>`<div class="intra-file__row locked" title="${d(i.path)}"><span>${Rt(i.path)}</span><span>${d(i.name)}</span><span class="small muted" style="margin-left:auto">🔒 鎖定</span></div>`).join("")}
        </div>
        <button class="btn" style="margin-top:12px" onclick="document.querySelector('[data-path='/intranet']')?.click()">返回內網首頁</button>
      </div>
    `;return}const t=va(Y),a=t.filter(i=>i.type==="dir"),n=t.filter(i=>i.type==="file");if(Y==="/intranet"&&!je){e.innerHTML=`
    ...
    `,e.querySelectorAll("[data-path]").forEach(i=>i.addEventListener("click",s=>{s.stopPropagation();const r=i.getAttribute("data-path");r&&It(r)})),At(e);return}if(!t.length){const i=k.getFile(Y);if(i&&i.content!=null){e.innerHTML=`<div class="intra-section__title">${d(Y)}</div><pre class="intra-file__preview mono">${d(i.content.slice(0,8e3))}</pre>`;return}e.innerHTML='<div class="intra-empty">此資料夾為空</div>';return}e.innerHTML=`
    <div class="intra-section__title">${d(Y)} — ${a.length} 個資料夾，${n.length} 個檔案</div>
  ...
  `,At(e)}function Tt(e){const t=e.path&&it(e.path),a=(e.path?k.getFile(e.path):null)?.meta?.locked||t,n=a?"🔒":e.type==="dir"?"📁":Rt(e.path||e.name);return`<div class="intra-file__row ${e.type==="dir"?"is-dir":""} ${a?"locked":""}" data-path="${d(e.path)}" data-type="${e.type}" title="${d(e.path)}">
...
...（內容已截斷，完整請於 Vizual Studio Code 開啟）`),i.textContent=s,i.style.whiteSpace="pre-wrap";a.style.display="flex"}function Bt(){const e=document.getElementById("intraPreview");e&&(e.style.display="none")}function ga(){const e=p.get("settings.theme")||"dark";document.documentElement.setAttribute("data-theme",e)}function de(e){ka(e),localStorage.setItem("cc_active_view",e)}function zi(){Pn(),zt(),Ta(),bi(),Fi(),Ra(),Wi(),Gi(),Yi()}var Va=null;function Ui(){if(p.hasFlag("ch0_maggie_notified")||p.hasFlag("ch0_vip_fixed")||(p.get("currentChapter")??0)!==0||document.getElementById("wa-win-notification"))return;const e=document.createElement("div");e.id="wa-win-notification",e.setAttribute("role","alert"),e.setAttribute("aria-live","polite"),e.innerHTML=`
    <div class="win-notif__app">
      <img src="/arg-game-it-company-secret/icon/whatsup.svg" alt="WhatUp" width="20" height="20" style="width:20px;height:20px;object-fit:contain" />
      <span class="win-notif__app-name">WhatUp</span>
      <span class="win-notif__app-sub">Dev Team</span>
    ...
    <div class="win-notif__progress"></div>
  `,e.addEventListener("click",t=>{if(!t.target.closest(".win-notif__close")){jt();try{Ue("dev-team")}catch{}de("whatsapp")}}),e.querySelector(".win-notif__close")?.addEventListener("click",t=>{t.stopPropagation(),jt()}),document.body.appendChild(e),p.setFlag("ch0_maggie_notified",!0),requestAnimationFrame(()=>e.classList.add("show")),Va=setTimeout(()=>jt(),1e4)}function jt(){const e=document.getElementById("wa-win-notification");e&&(clearTimeout(Va),e.classList.remove("show"),e.classList.add("hide"),setTimeout(()=>e.remove(),280))}function qa(e){e==="jira_viewed"&&p.setFlag("onb_jira_viewed",!0),e==="vscode_viewed"&&p.setFlag("onb_vscode_viewed",!0),p.hasFlag("onboarding_done")||p.setFlag("onboarding_done",!0)}function Wi(){const e=document.getElementById("mailDialog"),t=document.getElementById("mailTitle"),a=document.getElementById("mailTo"),n=document.getElementById("mailSend"),i=document.getElementById("mailTempExit");function s(){if(!t||!a)return;const r=t.value;r==="Report"?a.value="Drug Enforcement Administration <dea@email.us>":(r==="Coperation"||r==="Resign")&&(a.value="Sawyer <sawyer@nori.com>")}t?.addEventListener("change",s),s(),i?.addEventListener("click",()=>{e?.close(),be({onSwitch:de,onOpenSettings:Ae,onOpenNotebook:Be,t:ee})}),n?.addEventListener("click",()=>{const r=t?.value;document.getElementById("mailBody")?.value;let l=null;if(r==="Report"?l="report":r==="Coperation"?l="cooperate":r==="Resign"&&(l="resign"),l){const o=p.get("endings")||[];o.includes(l)||(o.push(l),p.set("endings",o),p.setFlag("ending_"+l,!0))}e?.close(),be({onSwitch:de,onOpenSettings:Ae,onOpenNotebook:Be,t:ee}),l?setTimeout(()=>za(l),300):Ve("郵件已寄送: "+r)})}function Gi(){const e=document.getElementById("startMenu");e&&document.addEventListener("click",t=>{const a=t.target.closest&&t.target.closest(".taskbar__start"),n=t.target.closest&&t.target.closest("#startShutdown"),i=t.target.closest&&t.target.closest("#startLogout");if(a){t.stopPropagation();const s=e.style.display==="none"||!e.style.display||e.style.display==="";e.style.display=s?"block":"none";return}if(n){t.stopPropagation(),e.style.display="none",ha("shutdown");return}if(i){t.stopPropagation(),e.style.display="none",ha("logout");return}e.contains(t.target)||(e.style.display="none")})}function ha(e){const t=p.get("endings")||[],a=p.hasFlag("ch4_all_opened"),n=t[0];let i=null;!n&&!a?i="flee":!n&&a?i="fried":n==="report"?i="report":n==="cooperate"?i="cooperate":n==="resign"?i="resign":i="flee";const s=p.get("endings")||[];s.includes(i)||(s.push(i),p.set("endings",s)),za(i)}function za(e){const t=document.getElementById("endingScreen"),a=document.getElementById("endingTitle"),n=document.getElementById("endingDesc"),i=document.getElementById("endingRestart");if(!t||!a||!n)return;const s={flee:"flee",cooperate:"cooperate",report:"report",resign:"resign",fried:"fried"}[e];s&&ue.play(s);const r={flee:{title:"平凡的日常",desc:`你已完成了工作，登出了電腦，走出辨公室，回到家中安心睡一覺。
...
`).replace(/\n+/g,`
`).split(/([，。、！？；\n\s]+)/).filter(Boolean);for(const x of c)if(/^[\n\s]+$/.test(x))o.push(x);else if(/^[，。、！？；]+$/.test(x))o.push(x);else for(let g=0;g<x.length;g+=1)o.push(x.slice(g,g+1));let u=0,m="";function y(){if(u>=o.length){i&&(i.style.display="block");return}const x=o[u];m+=x,n.textContent=m,u++;let g=100;(/[，。、！？；]$/.test(x)||x===`
`||x.includes(`
`))&&(g+=200),/^\s+$/.test(x)&&(g=100),e==="fried"&&(x==="其"||x==="實"||m.includes("其實"))&&(g=420),setTimeout(y,g)}y()},500)}function Yi(){document.getElementById("endingRestart")?.addEventListener("click",async()=>{ue.stop(!1);try{p.reset()}catch{}try{localStorage.removeItem("code_conspiracy_state")}catch{}try{localStorage.clear()}catch{}const e=document.getElementById("endingScreen");e&&(e.style.display="none"),document.querySelectorAll("dialog[open]").forEach(t=>{try{t.close()}catch{}t.style.display="none"});try{if("caches"in window){const t=await caches.keys();await Promise.all(t.map(a=>caches.delete(a)))}if("serviceWorker"in navigator){const t=await navigator.serviceWorker.getRegistrations();await Promise.all(t.map(a=>a.unregister()))}}catch{}setTimeout(()=>{window.location.href=window.location.pathname+"?reset="+Date.now(),window.location.reload(!0)},150)}),document.getElementById("endingClose")?.addEventListener("click",()=>{document.getElementById("endingScreen").style.display="none"})}function fa(){ga(),be({onSwitch:de,onOpenSettings:Ae,onOpenNotebook:Be,t:ee}),wn(),zi();const e=localStorage.getItem("cc_active_view")||"vscode";de(p.get("unlockedInterfaces").includes(e)?e:"vscode"),mn(),ue.play("default"),p.hasFlag("onboarding_done")||p.setFlag("onboarding_done",!0),setTimeout(()=>Ui(),800),W.on("puzzle:solved",t=>{Ve("✓ "+t.title)}),W.on("interfaceUnlocked",t=>{Ve(ee("toast.unlocked")+": "+t),be({onSwitch:de,onOpenSettings:Ae,onOpenNotebook:Be,t:ee})}),W.on("evidence",t=>{Ve(ee("toast.evidence")+": "+t.title)}),p.on("change",()=>ga()),window.addEventListener("ch4:complete",()=>{p.setFlag("ch5_triggered",!0),be({onSwitch:de,onOpenSettings:Ae,onOpenNotebook:Be,t:ee}),setTimeout(()=>{const t=document.getElementById("mailDialog");if(t&&!t.open){const a=document.getElementById("mailTitle"),n=document.getElementById("mailTo");if(a&&n){const i=a.value;i==="Report"?n.value="DEA <dea@world.example>":(i==="Coperation"||i==="Resign")&&(n.value="Sawyer <sawyer@nori-drinks.example>")}t.showModal()}},600)}),window.addEventListener("darknet:exit",()=>{ue.play("default"),p.hasFlag("ch4_all_opened")&&!p.hasFlag("ch5_triggered")?(p.setFlag("ch5_triggered",!0),be({onSwitch:de,onOpenSettings:Ae,onOpenNotebook:Be,t:ee}),setTimeout(()=>{const t=document.getElementById("mailDialog");t&&!t.open&&t.showModal()},400)):p.hasFlag("ch5_triggered")&&((p.get("endings")||[]).length||setTimeout(()=>{const t=document.getElementById("mailDialog");t&&!t.open&&t.showModal()},400))}),p.on("change",t=>{t&&t.path&&t.path.includes("ch5_triggered")&&be({onSwitch:de,onOpenSettings:Ae,onOpenNotebook:Be,t:ee}),t&&t.path&&t.path.includes("dark_entered")&&ue.play("darknet"),t&&t.path&&t.path.includes("ch0_vip_fixed")&&!p.hasFlag("ch1_event1_triggered")&&(p.setFlag("ch1_event1_triggered",!0),setTimeout(()=>{j(()=>Promise.resolve().then(()=>pe).then(a=>{a.triggerCh1Event1&&a.triggerCh1Event1()}),void 0)},1e4))}),p.hasFlag("ch0_vip_fixed")&&!p.hasFlag("ch1_event1_triggered")&&(p.setFlag("ch1_event1_triggered",!0),setTimeout(()=>{j(()=>Promise.resolve().then(()=>pe).then(t=>{t.triggerCh1Event1&&t.triggerCh1Event1()}),void 0)},1e4)),window.addEventListener("jira:ticketAdded",()=>{document.getElementById("jiraBoard")&&j(()=>Promise.resolve().then(()=>Qe).then(t=>{W.emit("jira:refresh")}),void 0)}),window.addEventListener("jira:refresh",()=>{try{zt()}catch{}}),document.querySelectorAll("dialog").forEach(t=>{t.addEventListener("click",n=>{n.target===t&&t.close()}),t.addEventListener("close",()=>{t.style.display="none",setTimeout(()=>{t.open||(t.style.display="none")},0)});const a=t.showModal;a&&(t.showModal=function(){return this.style.display="block",a.call(this)})}),document.addEventListener("click",t=>{const a=t.target.closest("button");if(a&&a.textContent.trim()==="關閉"&&a.closest("dialog")){const n=a.closest("dialog");setTimeout(()=>{n.open||(n.style.display="none")},50)}})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",fa):fa();

//# sourceMappingURL=main-hsDeNqGw.js.map