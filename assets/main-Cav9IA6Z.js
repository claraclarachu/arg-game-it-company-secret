...
+ restored legacyRoutes`});const n=document.getElementById("scmCommitStatus");n&&(n.innerHTML=`<span style="color:var(--success)">✓ Revert 成功: ${a} (from ${e})</span>`),C(`✓ revert ${a} — ${i}`),Ie(),ye(),Ce(),De(),fe&&Pe(),sn("git-graph")}var de=[{hash:"a1b2c3d",author:"finance@internal",date:"2024-08-12",msg:"feat: integrate crypto-mixer (legacy)",diff:`+ import { cryptoMixer } from '@shady/crypto-mixer'
...
+ export function computeFee(amount, opts) {}`}],Ba={"/customer-portal/src/billing/service.js":[{line:1,commit:"4c2a1e0",author:"dev"},{line:5,commit:"4c2a1e0",author:"dev"},{line:9,commit:"9f8e7d6",author:"qa-lee"},{line:12,commit:"9f8e7d6",author:"qa-lee"},{line:14,commit:"a1b2c3d",author:"finance@internal"}],"/customer-portal/src/main/java/com/nori/OrderService.java":[{line:1,commit:"4c2a1e0",author:"dev"},{line:12,commit:"9f8e7d6",author:"qa-lee"},{line:15,commit:"a1b2c3d",author:"finance@internal"}]},ve="__GIT_GRAPH__",fe=!1,Ye=null,Pa={main:"#89d185","feature/vip-discount":"#4da3ff","feature/crypto-mixer":"#dcdcaa","feature/billing-fix":"#ce9178","feature/home-copyfix":"#4ec9b0",develop:"#c586c0"},se=[{hash:"a1b2c3d",branch:"feature/crypto-mixer",author:"finance@internal",date:"2024-08-12",msg:"(INV-2024-0040) feat: integrate crypto-mixer (legacy)",diff:`+ import { cryptoMixer } from '@shady/crypto-mixer'
...
`).map(p=>{const u=g(p);return p.startsWith("+")?`<div class="diff-add">${u}</div>`:p.startsWith("-")?`<div class="diff-del">${u}</div>`:`<div>${u}</div>`}).join(""),c=n.author==="Casey"&&(n.diff.includes("SearchBar")||n.diff.includes("legacyRoutes")||n.msg.includes("0043"));(n.hash==="3f2a9c1"||n.msg.includes("INV-2024-0017"))&&n.author;const m=a&&c&&!l.hasFlag("ch1_revert_done")&&l.hasFlag("sawyer_seq_started");return`
    ...
    <div class="gitgraph-editor">
      <div class="gitgraph-editor__header">
        ...
        <div class="gitgraph-legend">
          ${Object.entries(Pa).map(([n,s])=>`<span class="gitgraph-branch" style="background:${s}22;color:${s};border-color:${s}44">${g(n)}</span>`).join("")}
        </div>
      </div>
  ...
  `,e.querySelectorAll(".gitgraph-row__main").forEach(n=>{n.addEventListener("click",s=>{if(s.target.closest(".gitgraph-revert-btn"))return;const r=n.closest(".gitgraph-row")?.dataset.hash;r&&(Ye=Ye===r?null:r,Pe())})}),e.querySelectorAll(".gitgraph-revert-btn").forEach(n=>{n.addEventListener("click",s=>{s.stopPropagation();const r=n.dataset.revert;r&&Si(r)})}),C("$ open Git Graph")}function Ti(e){const t=e.split(`
...
`).length,m=i.querySelector(".editor__gutter");m&&(m.innerHTML=Array.from({length:c},($,P)=>`<div class="editor__gutter-line" style="height:20px;line-height:20px">${P+1}</div>`).join(""));const p=r.selectionStart,u=o.slice(0,p),v=u.split(`
`).length,h=u.split(`
  ...
  `,Ri(),Ne(),document.getElementById("jiraDetailBackdrop")?.addEventListener("click",()=>{document.getElementById("jiraDetail").style.display="none",document.getElementById("jiraDetailBackdrop").style.display="none"}))}function Ri(){document.getElementById("jiraSearch")?.addEventListener("input",e=>{yt=e.target.value,Fe(),Ne()}),document.getElementById("jiraAssignee")?.addEventListener("change",e=>{yt=document.getElementById("jiraSearch").value,Fe(),Ne()}),document.getElementById("jiraSwimlane")?.addEventListener("change",e=>{ft=e.target.value,Fe(),Ne()})}function qi(e){if(!e.trim())return()=>!0;const t=e.split(/\s+AND\s+/i).map(a=>{const i=a.match(/^\s*(status|assignee|key|epic|text|priority)\s*(=|~)\s*"?([^"]+)"?\s*$/i);if(!i){const o=a.toLowerCase().replace(/["']/g,"");return c=>(c.key+c.title+c.desc+c.assignee+c.epic).toLowerCase().includes(o)}const[,n,s,r]=i,d=r.trim().replace(/^"|"$/g,"").toLowerCase();return o=>{const c=n.toLowerCase();let m="";return c==="status"?m=o.status.toLowerCase():c==="assignee"?m=o.assignee.toLowerCase():c==="key"?m=o.key.toLowerCase():c==="epic"?m=o.epic.toLowerCase():c==="priority"?m=o.priority.toLowerCase():c==="text"&&(m=(o.key+" "+o.title+" "+o.desc).toLowerCase()),s==="="?m===d:m.includes(d)}});return a=>t.every(i=>i(a))}function Ne(){const e=document.getElementById("jiraBoard");if(!e)return;const t=document.getElementById("jiraAssignee")?.value||"",a=qi(yt);let i=ae.filter(n=>a(n));if(t&&(i=i.filter(n=>n.assignee===t)),ft!=="all"){const n=ft,s={};i.forEach(r=>{const d=r[n]||"未分類";s[d]||(s[d]=[]),s[d].push(r)}),e.innerHTML=Object.entries(s).map(([r,d])=>{const o={"To Do":[],"In Progress":[],Done:[]};return d.forEach(c=>o[c.status]?.push(c)),`
        <div class="jira__swimlane">
          ...
          <div class="jira__board">
            ${Object.entries(o).map(([c,m])=>Ma(c,m)).join("")}
          </div>
        </div>
      `}).join("")||'<div class="muted small" style="padding:12px">無符合條件的票據 — 試 JQL: status = "To Do"</div>'}else{const n={"To Do":[],"In Progress":[],Done:[]};i.forEach(s=>n[s.status]?.push(s)),e.innerHTML=Object.entries(n).map(([s,r])=>Ma(s,r)).join("")}Wi()}function Ma(e,t){return`
...
const legacyRoutes = { archive: "/internal/portal" ... } // No longer used`}],history:[{from:"—",to:"To Do",by:"Maggie",at:new Date().toISOString().slice(0,10)}]}),Fe(),document.getElementById("jiraBoard")&&window.dispatchEvent(new CustomEvent("jira:ticketAdded",{detail:"INV-2024-0043"}));try{const e=new CustomEvent("jira:refresh");window.dispatchEvent(e)}catch{}}}function Gi(){return ae}var Ot="";try{Ot=""}catch{}var Yi="https://script.google.com/macros/s/REPLACE_WITH_YOUR_DEPLOY_ID/exec";function _t(){try{const e=localStorage.getItem("cc_gas_url")||"";if(e&&e.startsWith("https://"))return e}catch{}return Ot&&Ot.startsWith("https://")?Ot:Yi}function un(e){try{e?localStorage.setItem("cc_gas_url",e):localStorage.removeItem("cc_gas_url")}catch{}}function lt(){const e=_t();return e&&e.startsWith("https://")&&!e.includes("REPLACE_WITH_YOUR_DEPLOY_ID")}var Rt="cc_analytics_consent",ja="cc_sid",mn="cc_analytics_queue";function Je(){try{return localStorage.getItem(Rt)==="1"}catch{return!1}}function Ht(e){try{e?localStorage.setItem(Rt,"1"):localStorage.setItem(Rt,"0")}catch{}e&&setTimeout(()=>Ke(),500)}function Ji(){try{const e=localStorage.getItem(Rt);return e==="1"||e==="0"}catch{return!1}}function gn(){try{let e=localStorage.getItem(ja);return e||(e=crypto.randomUUID&&crypto.randomUUID()||"sid_"+Date.now()+"_"+Math.random().toString(36).slice(2,9),localStorage.setItem(ja,e)),e}catch{return"anon_"+Date.now()}}function ga(e){if(!e)return"";let t=5381;for(let a=0;a<e.length;a++)t=(t<<5)+t^e.charCodeAt(a);return(t>>>0).toString(16).padStart(8,"0")}function Ki(){let e=0,t=0,a="zh-TW";try{e=l.get("currentChapter")??0}catch{}try{t=l.get("playtime")??0}catch{}try{a=l.get("settings.language")||"zh-TW"}catch{}return{chapter:e,playtime:t,lang:a}}function Ue(){try{const e=localStorage.getItem(mn);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t:[]}catch{return[]}}function Ge(e){try{localStorage.setItem(mn,JSON.stringify(e.slice(-50)))}catch{}}function Ke(){if(!lt()||!Je())return;const e=Ue();if(!e.length)return;const t=e.slice(0,10);Ge(e.slice(10)),t.forEach(a=>hn(a,!0))}function hn(e,t=!1){const a=_t();if(!lt()){console.warn("[analytics] GAS_URL 未設定，跳過上報",e);return}if(!Je()){if(!t){const n=Ue();n.push(e),Ge(n)}return}const i=JSON.stringify(e);try{if(navigator.sendBeacon){const n=new Blob([i],{type:"text/plain;charset=utf-8"});if(navigator.sendBeacon(a,n))return}}catch{}try{fetch(a,{method:"POST",headers:{"Content-Type":"text/plain;charset=utf-8"},body:i,keepalive:!0,redirect:"follow",mode:"cors"}).then(n=>{if(!n.ok)throw new Error("GAS status "+n.status);t||setTimeout(()=>Ke(),1e3)}).catch(n=>{if(console.warn("[analytics] 發送失敗，已入隊重試",n),t){const s=Ue();s.unshift(e),Ge(s)}else{const s=Ue();s.push(e),Ge(s)}})}catch{const s=Ue();s.push(e),Ge(s)}}function ne(e,t={}){const a=Ki(),i=gn(),n={timestamp:new Date().toISOString(),session_id:i,event_type:e,chapter:a.chapter,playtime:a.playtime,lang:a.lang,ua:typeof navigator<"u"?navigator.userAgent.slice(0,200):"",url:typeof location<"u"?location.href.slice(0,300):"",...t};if(n.payload_json&&typeof n.payload_json=="string"&&n.payload_json.length>4e3&&(n.payload_json=n.payload_json.slice(0,4e3)),!Je()){const s=Ue();s.push(n),Ge(s);return}if(!lt()){const s=Ue();s.push(n),Ge(s),console.warn("[analytics] 已記錄至本地隊列，待設定 GAS_URL 後自動上報",n);return}hn(n)}function Qt({chatId:e,chatName:t,text:a,to:i}){const n=(a||"").slice(0,80),s=ga(a||"");ne("whatsapp_send",{whatsapp_chat_id:e,whatsapp_chat_name:t||e,whatsapp_to:i||"",whatsapp_preview:n,whatsapp_hash:s,whatsapp_len:(a||"").length,payload_json:JSON.stringify({chatId:e,preview:n,len:(a||"").length})})}function Qi({title:e,to:t,body:a}){const i=(a||"").slice(0,80),n=ga(a||"");ne("email_submit",{email_title:e||"",email_to:(t||"").slice(0,100),email_body_preview:i,email_body_hash:n,email_body_len:(a||"").length,payload_json:JSON.stringify({title:e,preview:i,len:(a||"").length})})}function vn(e){ne("ending_unlocked",{ending:e,endings:(l.get("endings")||[]).join(","),payload_json:JSON.stringify({ending:e,all:l.get("endings")})})}function Xi(e){ne("chapter_changed",{chapter:e,payload_json:JSON.stringify({chapter:e})})}function Zi(){try{window.__analytics={track:ne,getConsent:Je,setConsent:Ht,getGasUrl:_t,setGasUrl:un,isGasConfigured:lt,flushQueue:Ke,hashText:ga}}catch{}setTimeout(()=>Ke(),1500);try{window.addEventListener("online",()=>Ke())}catch{}}var ce=da({closeWaLightbox:()=>Vt,getChats:()=>ls,markNoriAllRead:()=>fa,mountWhatsApp:()=>fn,openChat:()=>Xe,openWaLightbox:()=>wn,startSawyerRevertSeq:()=>cs,triggerCh1Event1:()=>rs,triggerCh1Event2:()=>zt,triggerCh2LunchSequence:()=>ya}),j=[{id:"nori-all",name:"Nori 全體",avatar:"🏢",desc:"Nori 全體員工群組",members:["Sawyer","Casey","Maggie","Taylor","Aiko","all"],preview:"Leo:謝謝安排！",locked:!1,pinned:!0,muted:!1,archived:!1,unread:0,lastTime:"2023-06-15",messages:[{id:"m1",from:"Sawyer",text:"各位同事，好消息！我中了六合彩二獎，決定將獎金全數投入公司資金，一起加油！",time:"2023-06-15",read:"read",type:"text"},{id:"m2",from:"Taylor",text:"恭喜老闆！祝以後都順順利利！",time:"2023-06-15",read:"read",type:"text"},{id:"m3",from:"Aiko",text:"太棒了！老闆威武！",time:"2023-06-15",read:"read",type:"text"},{id:"m4",from:"Maggie",text:"恭喜老闆！",time:"2023-06-15",read:"read",type:"text"},{id:"m5",from:"Parker",text:"運也太好了吧？！",time:"2023-06-15",read:"read",type:"text"},{id:"m6",from:"Sawyer",text:"各位同事，告訴大家一個好消息，剛跟可樂樂公司談成一大生意，結為長期合作伙伴。為慶祝近來公司發展順利，決定舉辦晚上派對，詳細資訊稍後公布！",time:"2023-11-01",read:"read",type:"text"},{id:"m7",from:"Aiko",text:"哇！！太好了，一定會去！",time:"2023-11-01",read:"read",type:"text"},{id:"m8",from:"Taylor",text:"太棒了！",time:"2023-11-01",read:"read",type:"text"},{id:"m9",from:"Maggie",text:"恭喜老闆！",time:"2023-11-01",read:"read",type:"text"},{id:"m10",from:"Hugo",text:"一輩子跟隨您！",time:"2023-11-01",read:"read",type:"text"},{id:"m11",from:"Taylor",text:`各位同事，慶祝公司發展順利, 將於11月22日下班後舉辦派對
以下為詳細資訊：
日期：11月22日（五） 
時間：19:00-23:00
...
commit => 提交變更
revert => 撤銷變更
查看Git Graph => 列表形式展示所有變更記錄`,time:"2024-07-15",read:"read",type:"text"},{id:"m13",from:"Maggie",text:"",media:"/arg-game-it-company-secret/assets/data/files/wts/sourceControlPage.png",time:"2024-07-15",read:"read",type:"image"},{id:"m14",from:"Maggie",text:"",media:"/arg-game-it-company-secret/assets/data/files/wts/sourceControlPage-revert.png",time:"2024-07-15",read:"read",type:"image"},{id:"m15",from:"Maggie",text:"如果修改有誤的話，提交時結果會經過檢查，然後報錯，這時候就要重新修改",time:"2024-07-15",read:"read",type:"text"},{id:"m0",from:"Maggie",text:"Hi @Casey, 有新的工單INV-2024-0042, 請協助處理一下。詳細資訊在Jiua可以找到, 有問題再找我。",time:"今天",read:"delivered",type:"text"}]},{id:"dev-team",name:"Dev Team",avatar:"👩‍💻",desc:"Nori網站和內網的開發團隊群組",members:["Maggie","Casey","pm","Taylor","ops"],preview:"",locked:!1,pinned:!0,muted:!1,archived:!1,unread:0,lastTime:"2024-07-15",messages:[]},{id:"lunch-team",name:"午餐小隊",avatar:"🍽️",desc:"午餐小隊",members:["Parker","Grace","Hugo","Alex","Casey"],preview:"Alex: 好啊！",locked:!1,pinned:!1,muted:!1,archived:!1,unread:0,lastTime:"2024-09-01",messages:[{id:"m1",from:"Hugo",text:"大新聞！聽說老闆父母車禍身亡了！",time:"2023-04-29",read:"read",type:"text"},{id:"m2",from:"Parker",text:"？！",time:"2023-04-29",read:"read",type:"text"},{id:"m3",from:"Grace",text:"真的嗎？太難過了",time:"2023-04-29",read:"read",type:"text"},{id:"m4",from:"Hugo",text:"對啊，所以才請了一個禮拜假吧",time:"2023-04-29",read:"read",type:"text"},{id:"m5",from:"Hugo",text:"有人覺得近期的老闆很怪嗎？",time:"2023-10-19",read:"read",type:"text"},{id:"m6",from:"Parker",text:"怎麼說？！",time:"2023-10-19",read:"read",type:"text"},{id:"m7",from:"Alex",text:"變開朗了，也變得愛請客了！",time:"2023-10-19",read:"read",type:"text"},{id:"m8",from:"Grace",text:"對啊，之前都挺嚴肅的",time:"2023-10-19",read:"read",type:"text"},{id:"m9",from:"Hugo",text:"對啊！！！",time:"2023-10-19",read:"read",type:"text"},{id:"m10",from:"Hugo",text:"歡迎Casey！！以後帶你吃附近好吃的！",time:"2024-07-16",read:"read",type:"text"},{id:"m11",from:"Parker",text:"歡迎歡迎",time:"2024-07-16",read:"read",type:"text"},{id:"m12",from:"Grace",text:"歡迎~",time:"2024-07-16",read:"read",type:"text"},{id:"m13",from:"Alex",text:"歡迎~~",time:"2024-07-16",read:"read",type:"text"},{id:"m14",from:"Hugo",text:"今天要吃米當當嗎？",time:"2024-09-01",read:"read",type:"text"},{id:"m15",from:"Alex",text:"好啊",time:"2024-09-01",read:"read",type:"text"}]}],q="dev-team",qt="",nt="all",ke=!1,Ve="",ct="chat",Re=!0,J=0,ha=!1;function H(){try{const e=j.map(t=>({id:t.id,name:t.name,avatar:t.avatar,desc:t.desc,members:t.members,preview:t.preview,lastTime:t.lastTime,unread:t.unread,pinned:t.pinned,muted:t.muted,archived:t.archived,messages:t.messages}));l.set("whatsappChats",e),l.set("whatsappMeta",{activeId:q,ch1Event1Triggered:Me,ch1Event2Triggered:Oe,sawyerSeq:J,sawyerSeqLocked:ha}),l.save(!0)}catch{}}function Xt(e,t){try{l.incrementWhatsappSent()}catch{}try{const a=(t||"").toLowerCase(),i=["rubbish","垃圾","dumb","笨","蠢","stupid","傻","笨蛋","白癡","idiot","fool","傻瓜","die","dead","死","shit","fuck","屎"],n=e==="sawyer",s=i.some(r=>a.includes(r.toLowerCase()));n&&s&&l.setFlag("sawyer_abuse_sent",!0)}catch{}}function wt(e){try{const t=j.find(a=>a.id===e);return!!(t&&t.muted)}catch{return!1}}function es(e){return e.time==="剛剛"&&(e.time="今天"),e}function Da(e){const t=Date.now();e.messages.forEach((a,i)=>{if(es(a),typeof a.ts!="number")if(/^\d{4}-\d{2}-\d{2}$/.test(a.time))a.ts=new Date(a.time+"T00:00:00").getTime()+i*10;else if(a.time&&a.time.includes(":")){const n=new Date().toISOString().slice(0,10),s=new Date(n+"T"+a.time).getTime();a.ts=Number.isNaN(s)?t-(e.messages.length-i)*1e3:s+i}else a.ts=t-(e.messages.length-i+10)*1e3}),e.lastTime==="剛剛"&&(e.lastTime="今天")}function ts(){try{const e=l.get("whatsappChats");if(Array.isArray(e)&&e.length){for(const n of e){const s=j.find(r=>r.id===n.id);s&&(s.messages=Array.isArray(n.messages)?n.messages:s.messages,s.preview=n.preview??s.preview,s.lastTime=n.lastTime??s.lastTime,s.unread=typeof n.unread=="number"?n.unread:s.unread,s.pinned=typeof n.pinned=="boolean"?n.pinned:s.pinned,s.muted=typeof n.muted=="boolean"?n.muted:s.muted,s.archived=typeof n.archived=="boolean"?n.archived:s.archived)}for(const n of e)j.some(s=>s.id===n.id)||j.push(n)}const t=l.get("whatsappMeta");t&&typeof t=="object"&&(t.activeId&&j.some(n=>n.id===t.activeId)&&(q=t.activeId),typeof t.ch1Event1Triggered=="boolean"&&(Me=t.ch1Event1Triggered),typeof t.ch1Event2Triggered=="boolean"&&(Oe=t.ch1Event2Triggered),typeof t.sawyerSeq=="number"&&(J=t.sawyerSeq),typeof t.sawyerSeqLocked=="boolean"&&(ha=t.sawyerSeqLocked)),l.hasFlag("ch1_event1_triggered")&&(Me=!0);const a=j.find(n=>n.id==="nori-all");a&&a.messages.some(n=>n.text&&n.text.includes("發財樹"))&&(Me=!0,l.hasFlag("ch1_event1_triggered")||l.setFlag("ch1_event1_triggered",!0));const i=j.find(n=>n.id==="maggie");i&&i.messages.some(n=>n.text&&n.text.includes("INV-2024-0043"))&&(Oe=!0);for(const n of j)Da(n)}catch{}Me&&!l.hasFlag("ch1_event1_triggered")&&l.setFlag("ch1_event1_triggered",!0);try{for(const e of j)Da(e)}catch{}}function Xe(e){if(!j.some(i=>i.id===e))return;q=e;const t=j.find(i=>i.id===e);t&&(t.unread=0),H(),e==="nori-all"&&setTimeout(()=>fa(),100);const a=document.getElementById("view-whatsapp");a&&a.innerHTML&&(ct="chat",yn(),dt(),G(q))}function fn(){ts();const e=document.getElementById("view-whatsapp");if(e){e.innerHTML=`<div class="wa">
  ...
  `)}function gt(e){return!0}function is(){let e=[...j];if(qt){const a=qt.toLowerCase();e=e.filter(i=>i.name.toLowerCase().includes(a)||i.preview.toLowerCase().includes(a)||i.desc.toLowerCase().includes(a))}nt==="unread"?e=e.filter(a=>a.unread>0&&gt(a.id)):nt==="archived"?e=e.filter(a=>a.archived):e=e.filter(a=>!a.archived);const t=["nori-all","dev-team","sawyer","maggie","system-alert","lunch-team"];return e.sort((a,i)=>{const n=t.indexOf(a.id),s=t.indexOf(i.id),r=n===-1?999:n,d=s===-1?999:s;return r!==d?r-d:0}),e}function U(){if(ct!=="chat")return;const e=document.getElementById("waList");if(!e)return;const t=is();e.innerHTML=`
  ...
  `,e.querySelector("#waSearch")?.addEventListener("input",a=>{qt=a.target.value,U()}),e.querySelectorAll(".wa__filter").forEach(a=>a.addEventListener("click",()=>{nt=a.dataset.tab,U()})),e.querySelectorAll(".wa__item").forEach(a=>a.addEventListener("click",()=>{if(!gt(a.dataset.id))return;q=a.dataset.id;const i=j.find(n=>n.id===q);i&&(i.unread=0),H(),a.dataset.id==="nori-all"&&setTimeout(()=>fa(),100),ke=!1,U(),G(q)})),e.querySelectorAll(".wa__item").forEach(a=>{a.addEventListener("contextmenu",i=>{i.preventDefault();const n=j.find(s=>s.id===a.dataset.id);!n||!gt(n.id)||(n.pinned=!n.pinned,H(),U())})})}function G(e){const t=document.getElementById("waMessages"),a=t?t.scrollTop:null,i=t?t.scrollHeight:null,n=t?i-a-t.clientHeight<80:!0,s=a===0&&Re&&t&&i>t.clientHeight+80?!0:n;t&&(Re=s);const r=j.find(u=>u.id===e),d=document.getElementById("waChat");if(!r||!d)return;if(!gt(e)){d.innerHTML='<div class="view__placeholder"><h2>🔒 未解鎖</h2><div class="muted">先去 Vizual Studio Code 觸發 420.69 隱藏路由</div></div>';return}e==="supplier"&&l.setFlag("found_supplier",!0),e==="backend-team"&&l.setFlag("found_supplier",!0);let o=r.messages;if(Ve){const u=Ve.toLowerCase();o=o.filter(v=>(v.text||"").toLowerCase().includes(u)||(v.fileName||"").toLowerCase().includes(u))}o=[...o].map((u,v)=>({m:u,idx:v})).sort((u,v)=>{const h=typeof u.m.ts=="number"?u.m.ts:Fa(u.m.time),b=typeof v.m.ts=="number"?v.m.ts:Fa(v.m.time);return h!==b?h-b:u.idx-v.idx}).map(u=>u.m);const c={};o.forEach(u=>{const v=u.time.includes(":")?"今天":u.time;c[v]||(c[v]=[]),c[v].push(u)}),d.innerHTML=`
    ...
    <div class="wa__messages" id="waMessages">
      ${Object.entries(c).map(([u,v])=>`
        ...
        ${v.map(h=>ss(h,r)).join("")}
      `).join("")}
      ${e==="sawyer"&&J===2?`<div class="wa__msg-row other" id="sawyerTyping"><div class="wa__msg-avatar" style="background:${va("Sawyer")}">S</div><div class="bubble other"><span class="small muted">輸入中...</span></div></div>`:""}
    </div>
    ${(()=>{let u="",v=!1;return e==="sawyer"&&(J===1?(u="但是我查過這段code已經沒在用才對，所以不是這個問題影響的啊",v=!0):J===2?(u="",v=!0):J===3&&(u="但是",v=!0)),`<div class="wa__composer">
...
...`),n.textContent=s,n.style.whiteSpace="pre-wrap";a.style.display="flex",l.discoverFile(e),l.setFlag("dark_opened:"+e,!0),ka()}function Fs(){document.getElementById("darkExitBtn")?.addEventListener("click",()=>{pt="secret",Et=!1;try{l.setFlag("dark_secret_active",!1)}catch{}Ut(),ka(!0),A(()=>Promise.resolve().then(()=>re).then(t=>{t.setActiveView&&(t.setActiveView("intranet"),localStorage.setItem("cc_active_view","intranet"))}),void 0);const e=document.getElementById("view-darknet");e&&(e.innerHTML=""),l.hasFlag("ch4_all_opened")&&setTimeout(()=>{window.dispatchEvent(new CustomEvent("darknet:exit"))},300)}),document.getElementById("darkPreviewClose")?.addEventListener("click",()=>{const e=document.getElementById("darkPreview");e&&(e.style.display="none")}),document.getElementById("darkPreview")?.addEventListener("click",e=>{e.target.id==="darkPreview"&&(e.target.style.display="none")})}function ka(e=!1){const t=k.listDarkFiles?k.listDarkFiles("/darknet"):[];if(!t.length)return;const a=t.filter(i=>l.hasFlag("dark_opened:"+i.path)||l.hasFlag("discovered:"+i.path)||l.get("discoveredFiles")?.includes(i.path));a.length>=t.length?(l.hasFlag("ch4_all_opened")||l.setFlag("ch4_all_opened",!0),e&&!l.hasFlag("ch5_triggered")&&(l.setFlag("ch5_triggered",!0),window.dispatchEvent(new CustomEvent("ch4:complete")),setTimeout(()=>{const i=document.getElementById("mailDialog");if(i&&!i.open)try{i.showModal()}catch{i.style.display="block",i.setAttribute("open","")}},500))):e&&a.length>=t.length,a.length>=t.length&&!l.hasFlag("ch4_all_opened")&&l.setFlag("ch4_all_opened",!0)}var It=!1;function ta(e={}){if(!(l.hasFlag("ch1_0043_committed")&&!l.hasFlag("ch1_revert_done"))&&document.getElementById("view-darknet")){if(It=!!e.simple,Et=!0,e.simple)try{l.setFlag("dark_secret_active",!1)}catch{}else try{l.setFlag("dark_secret_active",!0)}catch{}pt="secret",ut=0,A(()=>Promise.resolve().then(()=>re).then(t=>{t.setActiveView&&(t.setActiveView("darknet"),localStorage.setItem("cc_active_view","darknet"))}),void 0),In()}}var te="/intranet",We="",Wa="/intranet/client_info";function Ct(e){return e===Wa||e.startsWith(Wa+"/")}function Ua(e){const t=k.buildTree();function a(n,s){if(n.path===s)return n;if(!n.children)return null;for(const r of n.children){const d=a(r,s);if(d)return d}return null}const i=a(t,e);return!i||!i.children?[]:i.children}function Ns(){const e=document.getElementById("view-intranet");e&&(e.innerHTML=`
  ...
  `,e.querySelectorAll(".intra-nav__item").forEach(t=>{t.addEventListener("click",()=>Jt(t.dataset.path))}))}function la(){const e=document.getElementById("intraMain");if(!e)return;if(We){const n=k.searchContent(We).filter(o=>o.path.startsWith("/intranet")).slice(0,40),s=k.listFiles("/intranet").filter(o=>o.path.toLowerCase().includes(We)).slice(0,40),r=new Map;n.forEach(o=>r.set(o.path,o)),s.forEach(o=>{r.has(o.path)||r.set(o.path,{path:o.path,snippet:""})});const d=[...r.values()];if(!d.length){e.innerHTML='<div class="intra-empty">無搜尋結果 — 試試「Nori」「冰釀茶酒」「業務流程」「Sawyer」</div>';return}e.innerHTML=`
    ...
    `,e.querySelectorAll("[data-path]").forEach(n=>n.addEventListener("click",s=>{s.stopPropagation();const r=n.getAttribute("data-path");r&&Jt(r)})),na(e);return}if(!t.length){const n=k.getFile(te);if(n&&n.content!=null){e.innerHTML=`<div class="intra-section__title">${g(te)}</div><pre class="intra-file__preview mono">${g(n.content.slice(0,8e3))}</pre>`;return}e.innerHTML='<div class="intra-empty">此資料夾為空</div>';return}e.innerHTML=`
